...
class GenerateTaskDslTest : TestBase() {
    ...
    private val buildGradleRemoteSpec = """
        plugins {
          id 'org.openapi.generator'
        }
        openApiGenerate {
            generatorName = "kotlin"
            inputSpec = "https://petstore.swagger.io/v2/swagger.yaml"
            outputDir = file("build/kotlin").absolutePath
            apiPackage = "org.openapitools.example.api"
            invokerPackage = "org.openapitools.example.invoker"
            modelPackage = "org.openapitools.example.model"
    ...
    @Test
    fun `openApiGenerate should create an expected file structure from DSL config with a remote spec`() {
        // Arrange
        withProject(buildGradleRemoteSpec)
        ...
        listOf(
            ...
            "build/kotlin/docs/ApiResponse.md",
            "build/kotlin/docs/Category.md",
            "build/kotlin/docs/Order.md",
            "build/kotlin/docs/Pet.md",
            "build/kotlin/docs/PetApi.md",
            "build/kotlin/docs/StoreApi.md",
            "build/kotlin/docs/Tag.md",
            "build/kotlin/docs/User.md",
            "build/kotlin/docs/UserApi.md",
            "build/kotlin/README.md",
            "build/kotlin/build.gradle",
            "build/kotlin/.openapi-generator/FILES",
            "build/kotlin/.openapi-generator/VERSION",
            "build/kotlin/settings.gradle",
            "build/kotlin/src/main/kotlin/org/openapitools/example/model/ApiResponse.kt",
            "build/kotlin/src/main/kotlin/org/openapitools/example/model/Category.kt",
            "build/kotlin/src/main/kotlin/org/openapitools/example/model/Order.kt",
            "build/kotlin/src/main/kotlin/org/openapitools/example/model/Pet.kt",
            "build/kotlin/src/main/kotlin/org/openapitools/example/model/Tag.kt",
            "build/kotlin/src/main/kotlin/org/openapitools/example/model/User.kt",
            "build/kotlin/src/main/kotlin/org/openapitools/example/api/PetApi.kt",
            "build/kotlin/src/main/kotlin/org/openapitools/example/api/StoreApi.kt",
            "build/kotlin/src/main/kotlin/org/openapitools/example/api/UserApi.kt",
    ...
    fun `openApiGenerate should used up-to-date instead of regenerate`() {
        ...
        // Assert
        assertFalse(
            resultFirstRun.output.contains("Task :openApiGenerate UP-TO-DATE"),
            "First run should not be up-to-date"
        )
        assertTrue(
            resultSecondRun.output.contains("Task :openApiGenerate UP-TO-DATE"),
            "Task of second run should be up-to-date"
        )
    }
    ...
    fun `openApiGenerate should use cache instead of regenerate`() {
        ...
        assertFalse(
            resultSecondRun.output.contains("No history is available."),
            "Task of second run should be from cache"
        )
        assertTrue(
            resultSecondRun.output.contains("has been removed."),
            "Task of second run should detect cache changes for untracked files"
        )
        assertTrue(
            resultThirdRun.output.contains("Skipping task ':openApiGenerate' as it is up-to-date."),
            "Task of third run should not require rebuild"
        )
    }
    ...
    fun `openApiValidate should fail on invalid spec`() {
        ...
        // Assert
        assertTrue(
            result.output.contains("issues with the specification"),
            "Unexpected/no message presented to the user for an invalid spec."
        )
        assertEquals(
            TaskOutcome.FAILED, result.task(":openApiGenerate")?.outcome,
    ...
    """.trimIndent(), projectFiles
        ...
        // Assert
        assertTrue(
            result.output.contains("validation has been explicitly disabled"),
            "Unexpected/no message presented to the user for an invalid spec."
        )
        assertEquals(
            TaskOutcome.SUCCESS, result.task(":openApiGenerate")?.outcome,
    ...
    """.trimIndent(), projectFiles
        ...
        assertTrue(
            result.output.contains("HandlebarsException"),
            "Stack should expose an exception for missing templates."
        )
