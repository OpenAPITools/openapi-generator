...
public final class GeneratorSettings implements Serializable {
     ...
     *
     * <p>This option is often used to circumvent compilation issues where models match keywords.
     *
     * <p>Example:
     *
     * <p>Suffix <code>Gen</code> applied to <code>Object</code> results in a generated class named
     * <code>ObjectGen</code>.
     *
     ...
     * <p>Example:
     *
     * <p>Prefix <code>My</code> applied to <code>Object</code> results in a generated class named
     * <code>MyObject</code>.
     *
    ...
    /**
     * Gets the group id for generated sources which support this concept (e.g. Java and pom.xml,
     * Scala and SBT/Gradle/pom).
     *
     * @return the group id
     */
    ...
    /**
     * Gets artifact id for generated sources which support this concept (e.g. Java and pom.xml,
     * Scala and SBT/Gradle/pom).
     *
    ...
    /**
     * Gets artifact version for generated sources which support this concept (e.g. Java and
     * pom.xml, Scala and SBT/Gradle/pom).
     *
    ...
    /**
     * Gets instantiation types mappings. These allow for customizing the defaults provided by a
     * built-in generator.
     *
     * <p>For example, "array" to "ArrayList" applied to the Java generator will cause all array
     * properties to be instantiated as ArrayList.
     *
     * <p>This option differs from {@link GeneratorSettings#getTypeMappings()} in that values
     * provided here are generally used for type construction (what is applied to "new").
     *
     ...
     *
     * <p>For example, "array" to "List" applied to the Java generator will cause all variable
     * assignments for array properties to be of type <code>List</code>.
     *
     * <p>This option differs from {@link GeneratorSettings#getInstantiationTypes()} in that values
     * provided here are variable reference types rather than concrete instantiation types.
     *
     ...
     *
     * <p>Use import mappings, for example, when you want to "bring your own models" from another
     * location.
     *
     * @return the import mappings
     * @see <a
     *     href="https://openapi-generator.tech/docs/customization#bringing-your-own-models">Bringing
     *     your own models</a>
     */
    ...
    /**
     * Gets inline schema name defaults between an inline schema naming convention and the default
     * values.
     *
    ...
    /**
     * Gets language specific primitives. These are in addition to the "base" primitives defined in
     * a generator.
     *
     * <p>In general, a primitive defined here will indicate to the generator:
     *
     * <p>- models with these types don't require an import - model names not included here require
     * imports and likely indicate a model reference
     *
     * <p>There may be generator-specific implementation details which differ slightly.
     *
    ...
    /**
     * Gets reserved word mappings. Values defined here define how a reserved word should be
     * escaped.
     *
     * <p>If no mapping is present, the mapping is generally automatically applied to a default with
     * prefixed underscore (<code>_name</code>). Note that some languages don't support identifiers
     * beginning with a prefix, in which case the generator applies a more appropriate prefix.
     *
    ...
    /**
     * Gets server variable. Values defined here will be attempted to be replaced within a templated
     * server object.
     *
     ...
     *
     * <p>Generally used by git_push.sh in generated sources which support it. This value may also
     * be used by templates in maven style references, READMEs, or other documentation.
     *
     * @return the git host
     */
     ...
     *
     * <p>e.g. codegen_csharp_api_client, defaults to
    ...
    private GeneratorSettings(Builder builder) {
        ...
        languageSpecificPrimitives =
                Collections.unmodifiableSet(builder.languageSpecificPrimitives);
    ...
    public static final class Builder {
        ...
        /**
         * Sets the {@code generatorName} and returns a reference to this Builder so that the
        ...
        /**
         * Sets the {@code apiPackage} and returns a reference to this Builder so that the methods
        ...
        /**
         * Sets the {@code modelPackage} and returns a reference to this Builder so that the methods
         * can be chained together.
         *
        ...
        /**
         * Sets the {@code invokerPackage} and returns a reference to this Builder so that the
         * methods can be chained together.
         *
        ...
        /**
         * Sets the {@code packageName} and returns a reference to this Builder so that the methods
         * can be chained together.
         *
        ...
        /**
         * Sets the {@code apiNameSuffix} and returns a reference to this Builder so that the
         * methods can be chained together.
         *
        ...
        /**
         * Sets the {@code modelNamePrefix} and returns a reference to this Builder so that the
         * methods can be chained together.
         *
        ...
        /**
         * Sets the {@code modelNameSuffix} and returns a reference to this Builder so that the
         * methods can be chained together.
         *
        ...
        /**
         * Sets the {@code groupId} and returns a reference to this Builder so that the methods can
         * be chained together.
         *
        ...
        /**
         * Sets the {@code artifactId} and returns a reference to this Builder so that the methods
         * can be chained together.
         *
        ...
        /**
         * Sets the {@code artifactVersion} and returns a reference to this Builder so that the
         * methods can be chained together.
         *
        ...
        /**
         * Sets the {@code library} and returns a reference to this Builder so that the methods can
         * be chained together.
         *
        ...
        /**
         * Sets the {@code instantiationTypes} and returns a reference to this Builder so that the
         * methods can be chained together.
         *
        ...
        /**
         * Sets a single {@code instantiationTypes} and returns a reference to this Builder so that
        ...
        /**
         * Sets the {@code serverVariables} and returns a reference to this Builder so that the
         * methods can be chained together.
         *
        ...
        /**
         * Sets the {@code typeMappings} and returns a reference to this Builder so that the methods
         * can be chained together.
         *
        ...
        /**
         * Sets the {@code additionalProperties} and returns a reference to this Builder so that the
         * methods can be chained together.
         *
        ...
        /**
         * Sets the {@code schemaMappings} and returns a reference to this Builder so that the
         * methods can be chained together.
         *
        ...
        /**
         * Sets a single {@code schemaMappings} and returns a reference to this Builder so that the
         * methods can be chained together.
         *
        ...
        /**
         * Sets the {@code importMappings} and returns a reference to this Builder so that the
         * methods can be chained together.
         *
        ...
        /**
         * Sets a single {@code importMappings} and returns a reference to this Builder so that the
         * methods can be chained together.
         *
        ...
        /**
         * Sets the {@code inlineSchemaNameDefaults} and returns a reference to this Builder so that
         * the methods can be chained together.
         *
        ...
        /**
         * Sets a single {@code inlineSchemaNameDefaults} and returns a reference to this Builder so
        ...
        /**
         * Sets the {@code inlineSchemaNameMappings} and returns a reference to this Builder so that
         * the methods can be chained together.
         *
        ...
        /**
         * Sets a single {@code inlineSchemaNameMappings} and returns a reference to this Builder so
         * that the methods can be chained together.
         *
        ...
        /**
         * Sets the {@code openapiNormalizer} and returns a reference to this Builder so that the
         * methods can be chained together.
         *
        ...
        /**
         * Sets a single {@code openapiNormalizer} and returns a reference to this Builder so that
         * the methods can be chained together.
         *
        ...
        /**
         * Sets the {@code languageSpecificPrimitives} and returns a reference to this Builder so
         * that the methods can be chained together.
         *
        ...
        /**
         * Sets a single {@code languageSpecificPrimitives} and returns a reference to this Builder
        ...
        /**
         * Sets the {@code reservedWordsMappings} and returns a reference to this Builder so that
         * the methods can be chained together.
         *
        ...
        /**
         * Sets a single {@code reservedWordsMappings} and returns a reference to this Builder so
         * that the methods can be chained together.
         *
        ...
        /**
         * Sets a single {@code serverVariables} and returns a reference to this Builder so that the
         * methods can be chained together.
         *
         * @param key A key for some server variable
         * @param value The value of some server variable to be replaced in a templated server
         *     object.
         * @return a reference to this Builder
         */
        ...
        /**
         * Sets the {@code gitHost} and returns a reference to this Builder so that the methods can
         * be chained together.
         *
        ...
        /**
         * Sets the {@code gitUserId} and returns a reference to this Builder so that the methods
         * can be chained together.
         *
        ...
        /**
         * Sets the {@code gitRepoId} and returns a reference to this Builder so that the methods
         * can be chained together.
         *
        ...
        /**
         * Sets the {@code releaseNote} and returns a reference to this Builder so that the methods
         * can be chained together.
         *
        ...
        /**
         * Sets the {@code httpUserAgent} and returns a reference to this Builder so that the
         * methods can be chained together.
         *
         ...
         *
         * @return a {@code GeneratorSettings} built with parameters of this {@code
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(getGeneratorName(), that.getGeneratorName())
                ...
                && Objects.equals(
                        getLanguageSpecificPrimitives(), that.getLanguageSpecificPrimitives())
