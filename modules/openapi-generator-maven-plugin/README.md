...
| `testOutput` |  `openapi.generator.maven.plugin.testOutput` | target output path for models and APIs tests (default is `${project.build.directory}/generated-test-sources/openapi`. Can also be set globally through the `openapi.generator.maven.plugin.testOutput` property). Non-default `output` overrides default `testOutput`
