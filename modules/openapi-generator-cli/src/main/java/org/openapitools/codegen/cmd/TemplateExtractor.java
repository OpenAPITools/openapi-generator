...
class TemplateExtractor {
    private final Logger LOGGER = LoggerFactory.getLogger(TemplateExtractor.class);
    ...
    TemplateExtractor(String generatorName, String library, String output, boolean verbose) {
