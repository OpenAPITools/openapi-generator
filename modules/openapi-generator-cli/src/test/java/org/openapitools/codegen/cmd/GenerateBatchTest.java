...
public class GenerateBatchTest {
    ...
    private static final String JAXRS_DATELIB_J8_YAML_INCLUDE_JSON =
            "jaxrs-datelib-j8-yaml-include.json";
    private static final String JAXRS_DATELIB_J8_JSON_INCLUDE_YAML =
            "jaxrs-datelib-j8-json-include.yaml";
    ...
    private static final String JAXRS_DATELIB_J8_NESTED_PROPERTY_MERGE_YAML =
            "jaxrs-datelib-j8-nested-property-merge.yaml";
    ...
    public void testDeserializerWithJsonInclude(String file) throws IOException {
        ...
        Set<Map.Entry<String, Object>> actualSet =
                generatorSettings.getAdditionalProperties().entrySet();
    ...
    public void testInvalidDeserializerWithIncludeOption() {
        // JSON is valid YAML, but not the other way around, so we can't load a YAML include from a
        // JSON config
    ...
    private File getIncludesDir() {
        // The includes directory would be "batch" under resources here, as everything is relative
        // to this directory.
