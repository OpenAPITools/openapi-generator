...
public class GraphQLNodeJSExpressServerCodegen extends AbstractGraphQLCodegen
    ...
    public GraphQLNodeJSExpressServerCodegen() {
        ...
        cliOptions.add(
                new CliOption(
                                ...
                                "GraphQL Node.js Express server package name (convention: lowercase).")
                        .defaultValue("openapi3graphql-server"));
        cliOptions.add(
                new CliOption(
                                CodegenConstants.PACKAGE_VERSION,
                                "GraphQL Node.js Express server package version.")
                        .defaultValue("1.0.0"));
        cliOptions.add(
                new CliOption(
    ...
    public void processOpts() {
        ...
        supportingFiles.add(
                new SupportingFile("schema.graphql.mustache", supportFolder, "schema.graphql"));
        ...
        supportingFiles.add(
                new SupportingFile("package.json.mustache", supportFolder, "package.json"));
    ...
    public String getTypeDeclaration(Schema p) {
        if (ModelUtils.isArraySchema(p)) {
            ...
            // IMPORTANT NOTE we add the braces within template because there we have the
        ...
        // IMPORTANT NOTE Not using the supertype invocation, because we want to UpperCamelize the
        // type:
