...
public class Swift5Codegen extends DefaultCodegen implements CodegenConfig {
    ...
    public static final String ONLY_PLAIN_INTERFACE = "onlyPlainInterface";
    ...
    protected boolean onlyPlainInterface = true;
    ...
    /**
     * Constructor for the 5 language codegen module.
     */
    public Swift5Codegen() {
        ...
        cliOptions.add(new CliOption(RESPONSE_AS,
                "Optionally use libraries to manage response.  Currently "
                        ...
                        + " are available."));
        cliOptions.add(new CliOption(ONLY_PLAIN_INTERFACE, 
                "Only generate APIs and Models without no API Client and dependencies"));
