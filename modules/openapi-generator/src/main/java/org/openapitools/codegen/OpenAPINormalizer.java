...
public class OpenAPINormalizer {
    ...
    /**
     * Check if unwrapping oneOf is not relevant.
     *
     * @return true if unwrapping of OneOf must be skipped
     */
    protected boolean skipUnwrapOneOf(Schema schema) {
