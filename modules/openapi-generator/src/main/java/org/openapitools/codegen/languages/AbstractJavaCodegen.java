...
public abstract class AbstractJavaCodegen extends DefaultCodegen implements CodegenConfig,
    ...
    protected void updateModelForComposedSchema(CodegenModel m, Schema schema, Map<String, Schema> allDefinitions)
    {
       ...
       if(schema.getOneOf() != null && !schema.getOneOf().isEmpty()  ) {
           ...
           if (Boolean.TRUE.equals(additionalProperties.get("useOneOfPojo"))) {
               m.vars = varsOrigin;
    ...
    public void processOpts() {
        ...
        // -----------------------------------------------------------------
        if (additionalProperties.containsKey("useOneOfPojo")) {
            Boolean flag = Boolean.valueOf(additionalProperties.get("useOneOfPojo").toString());
            additionalProperties.put("useOneOfPojo", flag);
        } else {
            additionalProperties.put("useOneOfPojo", Boolean.FALSE);
        }
        if (null != defaultDocumentationProvider()) {
