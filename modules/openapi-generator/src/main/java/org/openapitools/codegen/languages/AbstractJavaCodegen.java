...
public abstract class AbstractJavaCodegen extends DefaultCodegen implements CodegenConfig,
    ...
    public static final String DISCRIMINATOR_FIELD_IGNORE = "disableDiscriminatorFieldIgnore";
    ...
    public AbstractJavaCodegen() {
        ...
        cliOptions.add(CliOption.newBoolean(DISCRIMINATOR_FIELD_IGNORE, "Ignore discriminator field allOf, oneOf for Jackson serialization", disableDiscriminatorFieldIgnore));
    ...
    public void processOpts() {
        ...
        convertPropertyToBooleanAndWriteBack(DISCRIMINATOR_FIELD_IGNORE, this::setDisableDiscriminatorFieldIgnore);
