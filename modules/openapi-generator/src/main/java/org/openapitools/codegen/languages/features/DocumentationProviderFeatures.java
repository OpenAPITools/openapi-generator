...
/**
 * The DocumentationProvider Features support to additional properties to select the documentation
 * provider and the annotation library to use during code generation.
 *
...
public interface DocumentationProviderFeatures {
    ...
    /**
     * Define the default documentation Provider for CliOpts processing. A NULL return value will
     * disable the documentation provider support. Override in subclasses to customize.
     *
    ...
    /**
     * Define the List of supported documentation Provider for CliOpts processing. Override in
    ...
    /**
     * Define the list of supported annotation libraries for CliOpts processing. Override in
     * subclasses to customize.
     *
    ...
    enum DocumentationProvider {
        NONE(
                "withoutDocumentationProvider",
                "Do not publish an OpenAPI specification.",
                AnnotationLibrary.NONE,
                AnnotationLibrary.values()),
    ...
    enum AnnotationLibrary {
        ...
        MICROPROFILE(
                "microprofileAnnotationLibrary",
                "Annotate Model and Api using the Microprofile annotations.");
