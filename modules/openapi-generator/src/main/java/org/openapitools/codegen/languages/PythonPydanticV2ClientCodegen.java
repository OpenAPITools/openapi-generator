...
public class PythonPydanticV2ClientCodegen extends AbstractPythonPydanticV2Codegen implements CodegenConfig {
    private final Logger LOGGER = LoggerFactory.getLogger(PythonPydanticV2ClientCodegen.class);
    ...
    public PythonPydanticV2ClientCodegen() {
        super();
        ...
        embeddedTemplateDir = templateDir = "python-pydantic-v2";
