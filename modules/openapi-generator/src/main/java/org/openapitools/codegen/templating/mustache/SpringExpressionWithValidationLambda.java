...
public class SpringExpressionWithValidationLambda implements Mustache.Lambda {

  private final boolean openApiNullable;
  private final boolean useOptional;

  public SpringExpressionWithValidationLambda(boolean openApiNullable, boolean useOptional) {
