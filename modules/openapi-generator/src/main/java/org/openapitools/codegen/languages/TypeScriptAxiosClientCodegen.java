...
public class TypeScriptAxiosClientCodegen extends AbstractTypeScriptClientCodegen {
    ...
    public static final String WITH_IMPORT_URL = "withImportUrl";
    ...
    public TypeScriptAxiosClientCodegen() {
        ...
        this.cliOptions.add(new CliOption(WITH_IMPORT_URL, "Setting this property to true adds imports from 'url' to the generated code for NodeJS support", SchemaTypeUtil.BOOLEAN_TYPE).defaultValue(Boolean.FALSE.toString()));
