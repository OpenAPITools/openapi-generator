...
class OpenApiParameterValidations extends GenericValidator<ParameterWrapper> {
     ...
     * Raise this for awareness to the user.
     *
     * @param parameter Any spec doc parameter. The method will handle {@link HeaderParameter}
     *     evaluation.
     * @return {@link ValidationRule.Pass} if the check succeeds, otherwise {@link
     *     ValidationRule.Fail} with details "[key] contains an underscore."
     */
