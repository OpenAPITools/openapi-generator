...
public class GoAfterShipClientCodegen extends AbstractGoCodegen {
    ...
    public GoAfterShipClientCodegen() {
        ...
        outputFolder = "generated-code/go-aftership";
        embeddedTemplateDir = templateDir = "go-aftership";
        usesOptionals = false;
    ...
    public void processOpts() {
        ...
        supportingFiles.add(new SupportingFile("client.mustache", "", "client.gen.go"));
        supportingFiles.add(new SupportingFile("response.mustache", "", "response.gen.go"));
        supportingFiles.add(new SupportingFile("utils.mustache", "", "utils.gen.go"));
    }
    ...
    public String toApiFilename(String name) {
        return super.toApiFilename(name)+".gen";
    }

    @Override
    public String toModelFilename(String name) {
        return super.toModelFilename(name)+".gen";
    }
}
