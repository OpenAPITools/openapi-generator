...
public class TitlecaseLambda implements Mustache.Lambda {
    ...
    /**
     * Constructs a new instance of {@link TitlecaseLambda}, which will convert all text in a space
     * delimited string to title-case.
     */
    ...
    /**
     * Constructs a new instance of {@link TitlecaseLambda}, splitting on the specified delimiter
     * and converting each word to title-case.
     *
     * <p>NOTE: passing {@code null} results in a title-casing the first word only.
     *
