...
public class TypeScriptFetchWebClientCodegen extends AbstractTypeScriptClientCodegen {
    ...
    public TypeScriptFetchWebClientCodegen() {
        super();
        ...
        outputFolder = "generated-code/typescript-fetch-web";
        embeddedTemplateDir = templateDir = "typescript-fetch-web";
    ...
    class ExtendedCodegenParameter extends CodegenParameter {
        ...
        public boolean itemsAreUniqueId() {
            return TypeScriptFetchWebClientCodegen.itemsAreUniqueId(this.items);
        }

        public boolean itemsAreNullable() {
            return TypeScriptFetchWebClientCodegen.itemsAreNullable(this.items);
        }

        public String getItemsDataType() {
            return TypeScriptFetchWebClientCodegen.getItemsDataType(this.items);
        }
