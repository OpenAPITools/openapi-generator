...
public class CLibcurlClientCodegen extends DefaultCodegen implements CodegenConfig {
    ...
    public void processOpts() {
        ...
        supportingFiles.add(
                new SupportingFile("uncrustify-rules.cfg.mustache", "", "uncrustify-rules.cfg"));
        ...
        supportingFiles.add(
                new SupportingFile("keyValuePair.h.mustache", "include", "keyValuePair.h"));
        ...
        // external folder
        supportingFiles.add(
                new SupportingFile("cJSON.licence.mustache", "external", "cJSON.licence"));
    ...
    public String toExampleValue(Schema schema) {
        ...
        if (ModelUtils.isDateSchema(schema)) {
            ...
            if (StringUtils.isNotBlank(schema.getPattern()))
                return "\"a\""; // I cheat here, since it would be too complicated to generate a
            // string from a regexp
            int len = 0;
    ...
    public String toModelImport(String name) {
        ...
        } else return "#include \"" + "../model/" + name + ".h\"";
    }
    ...
    public void postProcess() {
        ...
        System.out.println(
                "# Please support their work directly \uD83D\uDE4F                                        #");
        System.out.println(
