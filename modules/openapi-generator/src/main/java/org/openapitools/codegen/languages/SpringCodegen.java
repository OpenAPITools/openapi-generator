                ...
                while (parentCodegenModel != null) {
                    for (final CodegenProperty property : parentCodegenModel.vars) {
                        ...
                        if (!propertyHash.containsKey(property.name)) {
                            ...
                            Set<String> imports = parentVar.getImports(true, this.importBaseType, instantiationTypes, typeMapping).stream().filter(Objects::nonNull).collect(Collectors.toSet());
