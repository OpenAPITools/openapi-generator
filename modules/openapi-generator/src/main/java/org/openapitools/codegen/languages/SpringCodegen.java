...
public class SpringCodegen extends AbstractJavaCodegen
    ...
    public static final String USE_SEALED_INTERFACES = "useSealedInterfaces";
    ...
    @Setter protected boolean useSealedInterfaces = false;
    ...
    public SpringCodegen() {
        ...
        cliOptions.add(CliOption.newBoolean(USE_SEALED_INTERFACES,
                "Whether to generate sealed interfaces for `oneOf` definitions. Will also mark all models as `final`."));
    ...
    public void processOpts() {
        ...
        convertPropertyToBooleanAndWriteBack(USE_SEALED_INTERFACES, this::setUseSealedInterfaces);
