...
public enum VendorExtension {
    ...
    X_JAVA_CONSTRAINT("x-java-constraint", ExtensionLevel.MODEL, "Add custom BeanValidation Annotation to parameters. Can be used with customValidationAnnotationsPackage configOption", null),
