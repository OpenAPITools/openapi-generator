...
public class JavaClientCodegen extends AbstractJavaCodegen
    ...
    public JavaClientCodegen() {
        ...
        cliOptions.add(CliOption.newBoolean(USE_SEALED_ONE_OF_INTERFACES, "Generate the oneOf interfaces as sealed. Only supported for WebClient and RestClient.", this.useSealedOneOfInterfaces));
