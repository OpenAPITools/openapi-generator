...
public abstract class Rule {
     ...
     * the project root.
     *
     * <p>NOTE: It is not possible to re-include a file if a parent directory of that file is
     * excluded.
     *
    ...
    public static Rule create(String definition) {
        ...
        try {
            ...
            if (result.size() == 0) {
                ...
                directoryOnly =
                        IgnoreLineParser.Token.DIRECTORY_MARKER.equals(
                                result.get(result.size() - 1).getToken());
