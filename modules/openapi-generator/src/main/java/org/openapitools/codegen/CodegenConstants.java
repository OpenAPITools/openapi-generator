...
public class CodegenConstants {
    ...
    public static final String RESOLVE_INLINE_ENUMS = "resolveInlineEnums";
    public static final String RESOLVE_INLINE_ENUMS_DESC = "Enable promotion of enum models defined inline to their own schemas which are then referenced in their original location.";
