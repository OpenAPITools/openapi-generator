...
public class CodegenConstants {
    ...
    public static final String MODULE_NAME_DESC =
    ...
    public static final String PYTHON_ATTR_NONE_IF_UNSET_DESC =
            "when accessing unset attribute, return `None` instead of raising `ApiAttributeError`";

    public static final String WITH_GO_CODEGEN_COMMENT = "withGoCodegenComment";
    public static final String WITH_GO_CODEGEN_COMMENT_DESC =
    ...
    public static final String WITH_AWSV4_SIGNATURE_COMMENT_DESC =
            "whether to include AWS v4 signature support";

    public static final String IS_GO_SUBMODULE = "isGoSubmodule";
    public static final String IS_GO_SUBMODULE_DESC =
    ...
    public static final String SORT_MODEL_PROPERTIES_BY_REQUIRED_FLAG =
            "sortModelPropertiesByRequiredFlag";
    public static final String SORT_MODEL_PROPERTIES_BY_REQUIRED_FLAG_DESC =
            "Sort model properties to place required parameters before optional parameters.";

    public static final String PREPEND_FORM_OR_BODY_PARAMETERS = "prependFormOrBodyParameters";
    public static final String PREPEND_FORM_OR_BODY_PARAMETERS_DESC =
    ...
    public static final String PACKAGE_NAME_DESC =
    ...
    public static final String OPTIONAL_CONDITIONAL_SERIALIZATION_DESC =
    ...
    public static final String PARAM_NAMING_DESC =
    ...
    public static final String NULLABLE_REFERENCE_TYPES_DESC =
            "Use nullable annotations in the project. Only supported on C# 8 / ASP.NET Core 3.1 or newer.";

    public static final String TEMPLATING_ENGINE = "templatingEngine";
    public static final String TEMPLATING_ENGINE_DESC =
            "The templating engine plugin to use: \"mustache\" (default) or \"handlebars\" (beta)";

    public static enum PARAM_NAMING_TYPE {
        camelCase,
        PascalCase,
        snake_case,
        original
    ...
    // Allow different language generators to offer an option of serialization library. Each
    // language specific
    // Codegen constants should define a description and provide proper input validation for the
    // value of serializationLibrary
    ...
    public static final String API_NAME_PREFIX_DESC =
    ...
    public static final String API_NAME_SUFFIX_DESC =
    ...
    public static final String ENUM_NAME_SUFFIX_DESC =
            "Suffix that will be appended to all enum names.";

    public static final String ENUM_VALUE_SUFFIX = "enumValueSuffix";
    public static final String ENUM_VALUE_SUFFIX_DESC =
            "Suffix that will be appended to all enum values. Note: For clients this may impact serialization and deserialization of enum values.";
    ...
    public static final String SOURCECODEONLY_GENERATION_DESC =
    ...
    public static final String CASE_INSENSITIVE_RESPONSE_HEADERS_DESC =
    ...
    public static final String VIRTUAL_SERVICE_DESC =
            "Generate Spring boot rest service as virtual service with Virtualan";
    ...
    public static final String REMOVE_OPERATION_ID_PREFIX_DELIMITER =
            "removeOperationIdPrefixDelimiter";
    public static final String REMOVE_OPERATION_ID_PREFIX_DELIMITER_DESC =
    ...
    public static final String REMOVE_OPERATION_ID_PREFIX_COUNT_DESC =
    ...
    public static final String SKIP_OPERATION_EXAMPLE_DESC =
    ...
    public static final String PARENT_ARTIFACT_ID_DESC =
    ...
    public static final String PARENT_VERSION_DESC =
    ...
    public static final String ENABLE_POST_PROCESS_FILE_DESC =
    ...
    public static final String GENERATE_ALIAS_AS_MODEL_DESC =
    ...
    public static final String USE_COMPARE_NET_OBJECTS_DESC =
    ...
    public static final String EXCEPTION_ON_FAILURE_DESC =
            "Throw an exception on non success response codes";
    ...
    public static final String REMOVE_ENUM_VALUE_PREFIX_DESC =
            "Remove the common prefix of enum values";

    public static final String SKIP_ONEOF_ANYOF_GETTER = "skipOneOfAnyOfGetter";
    public static final String SKIP_ONEOF_ANYOF_GETTER_DESC =
            "Skip the generation of getter for sub-schemas in oneOf/anyOf models.";

    public static final String LEGACY_DISCRIMINATOR_BEHAVIOR = "legacyDiscriminatorBehavior";
    public static final String LEGACY_DISCRIMINATOR_BEHAVIOR_DESC =
    ...
    public static final String USE_SINGLE_REQUEST_PARAMETER_DESC =
    ...
    public static final String DISALLOW_ADDITIONAL_PROPERTIES_IF_NOT_PRESENT =
    ...
    public static final String USE_ONEOF_DISCRIMINATOR_LOOKUP_DESC =
    ...
    public static final String INIT_REQUIRED_VARS_DESC =
            "If set to true then the required variables are included as positional arguments in __init__ and _from_openapi_data methods. Note: this can break some composition use cases. To learn more read PR #8802.";

    public static final String ERROR_OBJECT_TYPE = "errorObjectType";

    public static final String NON_COMPLIANT_USE_DISCR_IF_COMPOSITION_FAILS =
