...
public class CodegenConstants {
    ...
    public static final String ALLOW_UNSUPPORTED_V310_SPEC = "allowUnsupportedV310Spec";
    public static final String ALLOW_UNSUPPORTED_V310_SPEC_MSG =
    ...
    public static final String ALLOW_UNSUPPORTED_V310_SPEC_DESC =
            "If false (default), then generation will only continue when spec versions are < 3.1.0 " +
            "If true, generation will proceed if the input spec's version is >= 3.1.0. " + ALLOW_UNSUPPORTED_V310_SPEC_MSG;
