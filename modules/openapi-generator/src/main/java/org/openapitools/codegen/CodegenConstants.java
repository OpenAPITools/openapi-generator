...
public class CodegenConstants {
    ...
    public static final String LEGACY_GO_ENUM_NAMING = "legacyGoEnumNaming";
    public static final String LEGACY_GO_ENUM_NAMING_DESC = "whether to use legacy enum prefixes and suffixes which are shorter but subject to namespace collisions";
