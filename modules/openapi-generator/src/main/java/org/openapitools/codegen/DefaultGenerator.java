...
public class DefaultGenerator implements Generator {
        ...
        for (Map.Entry<String, String> configModelTestTemplateFilesEntry : config.modelTestTemplateFiles().entrySet()) {
            ...
            if (generateModelTests) {
                ...
                if (modelTestFile.exists()) {
                    ...
                    File written = processTemplateToTestFile(models, templateName, filename, generateModelTests, CodegenConstants.MODEL_TESTS);
                    if (written != null) {
                        files.add(written);
                ...
                */
                ...
                for (String templateName : config.apiTestTemplateFiles().keySet()) {
                    ...
                    if (apiTestFile.exists()) {
                        ...
                        File written = processTemplateToTestFile(operation, templateName, filename, generateApiTests, CodegenConstants.API_TESTS);
                        if (written != null) {
                            files.add(written);
                            if (config.isEnablePostProcessFile() && !dryRun) {
    ...
    private File processTemplateToFile(Map<String, Object> templateData, String templateName, String outputFilename, boolean shouldGenerate, String skippedByOption) throws IOException {
    ...
    private File processTemplateToTestFile(Map<String, Object> templateData, String templateName, String outputFilename, boolean shouldGenerate, String skippedByOption) throws IOException {
        return processTemplateToFile(templateData, templateName, outputFilename, shouldGenerate, skippedByOption, this.config.getTestOutputDir());
    }
    private File processTemplateToFile(Map<String, Object> templateData, String templateName, String outputFilename, boolean shouldGenerate, String skippedByOption, String outputDir) throws IOException {
