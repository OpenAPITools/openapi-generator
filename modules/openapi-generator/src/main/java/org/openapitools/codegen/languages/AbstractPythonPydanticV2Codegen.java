...
public abstract class AbstractPythonPydanticV2Codegen extends DefaultCodegen implements CodegenConfig {
    private final Logger LOGGER = LoggerFactory.getLogger(AbstractPythonPydanticV2Codegen.class);
    ...
    public AbstractPythonPydanticV2Codegen() {
        super();
