...
public class CSharpRestSharpClientCodegen extends AbstractCSharpCodegen {
    ...
    private final Logger LOGGER = LoggerFactory.getLogger(CSharpRestSharpClientCodegen.class);
    ...
    public CSharpRestSharpClientCodegen() {
        super();
        ...
        embeddedTemplateDir = templateDir = "csharp-restsharp";
        ...
        addOption(CSharpRestSharpClientCodegen.OPERATION_PARAMETER_SORTING_KEY,
                "One of legacy, alphabetical, default.",
                this.operationParameterSorting.toString().toLowerCase(Locale.ROOT));

        addOption(CSharpRestSharpClientCodegen.MODEL_PROPERTY_SORTING_KEY,
                "One of legacy, alphabetical, default.",
                this.modelPropertySorting.toString().toLowerCase(Locale.ROOT));

        addOption(CSharpRestSharpClientCodegen.USE_INT_FOR_TIMEOUT,
    ...
    public void processOpts() {
        ...
        if (additionalProperties.containsKey(CSharpRestSharpClientCodegen.OPERATION_PARAMETER_SORTING_KEY)) {
            setOperationParameterSorting((String) additionalProperties.get(CSharpRestSharpClientCodegen.OPERATION_PARAMETER_SORTING_KEY));
        }

        if (additionalProperties.containsKey(CSharpRestSharpClientCodegen.MODEL_PROPERTY_SORTING_KEY)) {
            setModelPropertySorting((String) additionalProperties.get(CSharpRestSharpClientCodegen.MODEL_PROPERTY_SORTING_KEY));
        }
