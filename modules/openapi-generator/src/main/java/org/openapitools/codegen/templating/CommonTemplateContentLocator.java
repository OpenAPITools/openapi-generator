...
public class CommonTemplateContentLocator implements TemplatePathLocator {
    ...
    /**
     * Constructs a new instance of {@link CommonTemplateContentLocator} defaulting to _common
     * resource location.
     */
    public CommonTemplateContentLocator() {}

    /**
     * Constructs a new instance of {@link CommonTemplateContentLocator} for a targeted common
     * location.
     *
    ...
    public String getFullTemplatePath(String relativeTemplateFile) {
        if (StringUtils.isNotEmpty(relativeTemplateFile)) {
            ...
            URL url =
                    this.getClass()
                            .getClassLoader()
                            .getResource(TemplateManager.getCPResourcePath(loc));
            if (url != null) {
                return loc;
            }
        }
