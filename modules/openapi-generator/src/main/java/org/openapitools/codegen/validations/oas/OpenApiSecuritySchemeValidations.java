...
/**
 * A standalone instance for evaluating rules and recommendations related to OAS {@link
 * SecurityScheme}
 */
class OpenApiSecuritySchemeValidations extends GenericValidator<SecuritySchemeWrapper> {
     ...
     * @return <code>true</code> if the check succeeds (header does not have an underscore, e.g.
     *     'api_key')
     */
    private static ValidationRule.Result apacheNginxHeaderCheck(
            SecuritySchemeWrapper securitySchemeWrapper) {
