...
public class CodegenModel implements IJsonSchemaValidationProperties {
    ...
    public boolean isString, isInteger, isLong, isNumber, isNumeric, isFloat, isDouble, isDate, isDateTime, isShortInteger;
    ...
    public int hashCode() {
        return Objects.hash(getParent(), getParentSchema(), getInterfaces(), getAllParents(), getParentModel(),
                ...
                isDate, isDateTime, isNull, hasValidation, isShortInteger,
