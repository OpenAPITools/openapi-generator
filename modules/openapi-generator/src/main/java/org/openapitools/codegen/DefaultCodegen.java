...
public class DefaultCodegen implements CodegenConfig {
    ...
    */
    ...
    private void registerMustacheLambdas() {
        // Subclasses may re-register a lambda name already added by a parent's
        // addMustacheLambdas() (e.g. to override its behavior); keep the most
        // derived definition instead of failing on the duplicate key.
        ImmutableMap<String, Lambda> lambdas = addMustacheLambdas().buildKeepingLast();
...
//        }
    ...
    protected List<EnumVarMap> buildEnumVars(List<Object> values, String dataType, List<Object> rawValues) {
        ...
        for (int i = 0; i < values.size(); i++) {
            ...
            String rawEnumValue = String.valueOf(value);
            enumVar.enumVar(finalEnumName, toEnumValue(rawEnumValue, dataType), isDataTypeString(dataType));
            enumVar.setEnumValueRaw(rawEnumValue);
    ...
    private void injectEnumUnknownDefaultCase(List<EnumVarMap> enumVars, String dataType) {
        ...
        enumVar.setEnumValueRaw(enumValue);
