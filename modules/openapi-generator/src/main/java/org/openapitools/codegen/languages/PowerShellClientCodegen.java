...
public class PowerShellClientCodegen extends DefaultCodegen implements CodegenConfig {
    ...
    public PowerShellClientCodegen() {
        ...
        verbMappings.put("Close", List.of());
        verbMappings.put("Copy", Arrays.asList("Duplicate", "Clone", "Replicate", "Sync"));
        verbMappings.put("Enter", List.of("PushInto"));
        verbMappings.put("Exit", List.of("PopOut"));
        verbMappings.put("Find", List.of());
        verbMappings.put("Format", List.of());
        verbMappings.put("Get", Arrays.asList("Read", "Open", "Cat", "Type", "Dir", "Obtain", "Dump", "Acquire", "Examine", "Find", "Search"));
        verbMappings.put("Hide", List.of("Block"));
        verbMappings.put("Join", Arrays.asList("Combine", "Unite", "Connect", "Associate"));
        verbMappings.put("Lock", List.of("RestrictSecure"));
        ...
        verbMappings.put("Open", List.of());
        verbMappings.put("Optimize", List.of());
        verbMappings.put("Pop", List.of());
        verbMappings.put("Push", List.of());
        verbMappings.put("Redo", List.of());
        verbMappings.put("Remove", Arrays.asList("Clear", "Cut", "Dispose", "Discard", "Erase"));
        verbMappings.put("Rename", List.of("Change"));
        verbMappings.put("Reset", List.of());
        verbMappings.put("Search", List.of("FindLocate"));
        verbMappings.put("Select", List.of("FindLocate"));
        verbMappings.put("Set", Arrays.asList("Write", "Reset", "Assign", "Configure"));
        verbMappings.put("Show", List.of("DisplayProduce"));
        verbMappings.put("Skip", List.of("BypassJump"));
        verbMappings.put("Split", List.of("parate"));
        verbMappings.put("Step", List.of());
        verbMappings.put("Switch", List.of());
        verbMappings.put("Undo", List.of());
        verbMappings.put("Unlock", Arrays.asList("Release", "Unrestrict", "Unsecure"));
        verbMappings.put("Watch", List.of());

        // communication
        verbMappings.put("Connect", List.of("JoinTelnet"));
        verbMappings.put("Disconnect", List.of("BreakLogoff"));
        ...
        verbMappings.put("Write", List.of("PutPrint"));

        // data
        verbMappings.put("Backup", Arrays.asList(" Save", " Burn", " Replicate", "Sync"));
        verbMappings.put("Checkpoint", List.of("  Diff"));
        verbMappings.put("Compare", List.of("  Diff"));
        verbMappings.put("Compress", List.of("  Compact"));
        ...
        verbMappings.put("Dismount", List.of(" UnmountUnlink"));
        verbMappings.put("Edit", Arrays.asList(" Change", " Update", "Modify"));
        verbMappings.put("Expand", List.of(" ExplodeUncompress"));
        verbMappings.put("Export", List.of(" ExtractBackup"));
        verbMappings.put("Group", Arrays.asList(" Aggregate", " Arrange", " Associate", "Correlate"));
        verbMappings.put("Import", List.of(" BulkLoadLoad"));
        verbMappings.put("Initialize", Arrays.asList(" Erase", " Init", " Renew", " Rebuild", " Reinitialize", "Setup"));
        verbMappings.put("Limit", List.of("  Quota"));
        verbMappings.put("Merge", List.of(" CombineJoin"));
        verbMappings.put("Mount", List.of(" Connect"));
        verbMappings.put("Out", List.of());
        ...
        // diagnostic
        verbMappings.put("Debug", List.of("Diagnose"));
        verbMappings.put("Measure", Arrays.asList("Calculate", "Determine", "Analyze"));
        verbMappings.put("Ping", List.of());
        verbMappings.put("Repair", List.of("FixRestore"));
        verbMappings.put("Resolve", List.of("ExpandDetermine"));
        ...
        // lifecycle
        verbMappings.put("Approve", List.of());
        verbMappings.put("Assert", List.of("Certify"));
        verbMappings.put("Build", List.of());
        verbMappings.put("Complete", List.of());
        ...
        verbMappings.put("Deploy", List.of());
        verbMappings.put("Disable", List.of("HaltHide"));
        verbMappings.put("Enable", List.of("StartBegin"));
        verbMappings.put("Install", List.of("Setup"));
        verbMappings.put("Invoke", List.of("RunStart"));
        verbMappings.put("Register", List.of());
        verbMappings.put("Request", List.of());
        verbMappings.put("Restart", List.of("Recycle"));
        verbMappings.put("Resume", List.of());
        verbMappings.put("Start", Arrays.asList("Launch", "Initiate", "Boot"));
        verbMappings.put("Stop", Arrays.asList("End", "Kill", "Terminate", "Cancel"));
        verbMappings.put("Submit", List.of("Post"));
        verbMappings.put("Suspend", List.of("Pause"));
        verbMappings.put("Uninstall", List.of());
        verbMappings.put("Unregister", List.of("Remove"));
        verbMappings.put("Wait", List.of("SleepPause"));

        // security
        verbMappings.put("Block", Arrays.asList("Prevent", "Limit", "Deny"));
        verbMappings.put("Grant", List.of("AllowEnable"));
        verbMappings.put("Protect", Arrays.asList("Encrypt", "Safeguard", "Seal"));
        verbMappings.put("Revoke", List.of("RemoveDisable"));
        verbMappings.put("Unblock", List.of("ClearAllow"));
        verbMappings.put("Unprotect", List.of("DecryptUnseal"));

        // other
        verbMappings.put("Use", List.of());
