// CrystalApiRouting.java
package org.openapitools.codegen.languages.crystal;

import java.util.*;
import org.openapitools.codegen.utils.StringUtils;

/** Pure routing logic for the Crystal generator: path -> (namespace, resource, action). */
public final class CrystalApiRouting {
    private CrystalApiRouting() {}
