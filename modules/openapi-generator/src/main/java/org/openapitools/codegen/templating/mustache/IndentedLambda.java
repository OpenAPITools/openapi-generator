 ...
 *
 * <p>Generator authors may add helpers for explicitly adding prefixed spaces which fragments won't
 * be aware of.
 *
 * <p>Register:
 *
...
public class IndentedLambda implements Mustache.Lambda {
    ...
    /**
     * Constructs a new instance of {@link IndentedLambda}, with customized indent count and
     * intention character
     *
    ...
    public void execute(Template.Fragment fragment, Writer writer) throws IOException {
        ...
        String prefixedIndention =
                StringUtils.repeat(new String(Character.toChars(spaceCode)), prefixSpaceCount);
        StringBuilder sb = new StringBuilder();
        String[] lines = text.split(System.lineSeparator());
        for (int i = 0; i < lines.length; i++) {
            String line = lines[i];
            // Mustache will apply correct indentation to the first line of a template (to match
            ...
            // We've split on the system's line separator. We don't want to add an additional
            // trailing line.
            if (i < lines.length - 1) {
