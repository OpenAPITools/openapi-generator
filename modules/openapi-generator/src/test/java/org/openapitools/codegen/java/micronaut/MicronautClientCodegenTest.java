...
public class MicronautClientCodegenTest extends AbstractMicronautCodegenTest {
    ...
    public void doConfigureAuthParam() {
        ...
        assertFileContains(
                outputPath + "/src/main/java/org/openapitools/api/PetApi.java", "@Authorization");
    }
    ...
    public void doUseValidationParam() {
        ...
        // Files are not generated
        assertFileContains(
                outputPath + "/src/main/java/org/openapitools/api/PetApi.java", "@Valid");
        assertFileContains(
                outputPath + "/src/main/java/org/openapitools/api/PetApi.java", "@NotNull");
    }
    ...
    public void doGenerateForMaven() {
        ...
        codegen.additionalProperties()
                .put(
                        JavaMicronautClientCodegen.OPT_BUILD,
    ...
    public void doGenerateForTestJUnit() {
        ...
        codegen.additionalProperties()
                .put(
                        JavaMicronautClientCodegen.OPT_TEST,
    ...
    public void doGenerateForTestSpock() {
        ...
        assertFileContains(
                outputPath + "src/test/groovy/org/openapitools/api/PetApiSpec.groovy",
                "PetApiSpec",
                "@MicronautTest");
    }
    ...
    public void doGenerateRequiredPropertiesInConstructor() {
        JavaMicronautClientCodegen codegen = new JavaMicronautClientCodegen();
        codegen.additionalProperties()
                .put(JavaMicronautClientCodegen.OPT_REQUIRED_PROPERTIES_IN_CONSTRUCTOR, "true");
        String outputPath =
                generateFiles(
    ...
    public void doNotGenerateRequiredPropertiesInConstructor() {
        JavaMicronautClientCodegen codegen = new JavaMicronautClientCodegen();
        codegen.additionalProperties()
                .put(JavaMicronautClientCodegen.OPT_REQUIRED_PROPERTIES_IN_CONSTRUCTOR, "false");
        String outputPath =
                generateFiles(
                        codegen, PETSTORE_PATH, CodegenConstants.MODELS, CodegenConstants.APIS);
    ...
    public void doGenerateMultipleContentTypes() {
        ...
        String outputPath =
                generateFiles(
                        codegen,
                        "src/test/resources/3_0/micronaut/content-type.yaml",
                        CodegenConstants.APIS);

        // body and response content types should be properly annotated using @Consumes and
        // @Produces micronaut annotations
        String apiPath = outputPath + "src/main/java/org/openapitools/api/";
        assertFileContains(
                apiPath + "DefaultApi.java",
                "@Consumes({\"application/vnd.oracle.resource+json; type=collection\", \"application/vnd.oracle.resource+json; type=error\"})");
        assertFileContains(
                apiPath + "DefaultApi.java",
                "@Produces({\"application/vnd.oracle.resource+json; type=singular\"})");
    }
    ...
    public void doGenerateOauth2InApplicationConfig() {
        ...
        String outputPath =
                generateFiles(
                        codegen,
                        "src/test/resources/3_0/micronaut/oauth2.yaml",
                        CodegenConstants.SUPPORTING_FILES);
    ...
    public void testAdditionalClientTypeAnnotations() {
        ...
        codegen.additionalProperties()
                .put(
                        JavaMicronautClientCodegen.ADDITIONAL_CLIENT_TYPE_ANNOTATIONS,
        ...
        assertFileContains(
                outputPath + "/src/main/java/org/openapitools/api/PetApi.java",
                "MyAdditionalAnnotation1(1,${param1})");
        assertFileContains(
                outputPath + "/src/main/java/org/openapitools/api/PetApi.java",
                "MyAdditionalAnnotation2(2,${param2})");
    }
    ...
    public void testDefaultAuthorizationFilterPattern() {
        ...
        assertFileContains(
                outputPath + "/src/main/java/org/openapitools/auth/AuthorizationFilter.java",
    ...
    public void testAuthorizationFilterPattern() {
        ...
        codegen.additionalProperties().put(JavaMicronautClientCodegen.OPT_CONFIGURE_AUTH, "true");
        codegen.additionalProperties()
                .put(JavaMicronautClientCodegen.AUTHORIZATION_FILTER_PATTERN, "pet/**");
        String outputPath =
                generateFiles(
                        codegen,
                        PETSTORE_PATH,
    ...
    public void testConfigureClientId() {
        ...
        assertFileContains(
                outputPath + "/src/main/java/org/openapitools/api/PetApi.java",
                "@Client( id = \"unit-test\", path = \"${openapi-micronaut-client-base-path}\")");
    }
