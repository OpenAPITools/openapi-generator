...
public class KotlinReservedWordsTest {
    final OpenAPI openAPI =
            TestUtils.parseFlattenSpec("src/test/resources/3_0/kotlin/reserved_words.yaml");
    ...
    public void testReservedWordsAsParameters(String reservedWord) {
        ...
        Parameter current =
                operation.getParameters().stream()
                        .filter(x -> reservedWord.equals(x.getName()))
                        .findFirst()
                        .get();
    ...
    public void testReservedWordsAsProperties(String reservedWord) {
        ...
        CodegenProperty property =
                codegen.fromProperty(
                        reservedWord, (Schema) linked.getProperties().get(reservedWord));
    ...
    public void reservedWordsInGeneratedCode() throws Exception {
        ...
        OpenAPI openAPI =
                TestUtils.parseFlattenSpec(
                        "src/test/resources/bugs/issue_11304_kotlin_backticks_reserved_words.yaml");
        ...
        assertFileContains(
                Paths.get(resultSourcePath.getAbsolutePath() + baseApiPackage + "DefaultApi.kt"),
