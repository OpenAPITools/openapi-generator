...
public class HaskellYesodServerOptionsTest extends AbstractOptionsTest {
    ...
    private HaskellYesodServerCodegen clientCodegen =
            mock(HaskellYesodServerCodegen.class, mockSettings);
    ...
    protected void verifyOptions() {
        ...
        verify(clientCodegen)
                .setApiModuleName(HaskellYesodServerOptionsProvider.API_MODULE_NAME_VALUE);
        verify(clientCodegen)
                .setEnumUnknownDefaultCase(
                        Boolean.parseBoolean(
                                HaskellYesodServerOptionsProvider.ENUM_UNKNOWN_DEFAULT_CASE_VALUE));
    }
}
