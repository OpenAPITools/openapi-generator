...
public class KotlinJvmVolleyModelCodegenTest {
    ...
    public void modelsWithRoomModels() throws IOException {
        ...
        codegen.additionalProperties()
                .put(
                        ...
                        AbstractKotlinCodegen.SERIALIZATION_LIBRARY_TYPE.gson.name());

        String outputPath = checkModel(codegen, false);

        assertFileContains(
                Paths.get(outputPath + "/src/main/java/models/room/BigDogRoomModel.kt"),
                "toApiModel()");
        assertFileContains(
                Paths.get(outputPath + "/src/main/java/models/BigDog.kt"), "toRoomModel()");
    }
    ...
    private String checkModel(AbstractKotlinCodegen codegen, boolean mutable, String... props)
            throws IOException {
    ...
    private String generateModels(AbstractKotlinCodegen codegen, String fileName, boolean mutable)
            throws IOException {
        ...
        OpenAPI openAPI =
                new OpenAPIParser().readLocation(fileName, null, new ParseOptions()).getOpenAPI();
