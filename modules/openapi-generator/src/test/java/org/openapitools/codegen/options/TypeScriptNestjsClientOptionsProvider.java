...
public class TypeScriptNestjsClientOptionsProvider implements OptionsProvider {
    ...
    public Map<String, String> createOptions() {
        ...
        return builder.put(CodegenConstants.SORT_PARAMS_BY_REQUIRED_FLAG, SORT_PARAMS_VALUE)
                ...
                .put(
                        AbstractTypeScriptClientCodegen.NULL_SAFE_ADDITIONAL_PROPS,
                        NULL_SAFE_ADDITIONAL_PROPS_VALUE)
                ...
                // .put(TypeScriptNestjsClientCodegen.USE_SINGLE_REQUEST_PARAMETER,
