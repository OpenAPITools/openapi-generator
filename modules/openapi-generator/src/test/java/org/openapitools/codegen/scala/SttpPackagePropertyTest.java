...
public class SttpPackagePropertyTest {
    ...
    public void shouldUseDefaultPackageNameIfAdditionalPropertiesAreEmpty() {
        ScalaSttpClientCodegen.PackageProperty property =
                new ScalaSttpClientCodegen.PackageProperty();
        Map<String, Object> additionalProperties = new HashMap<>();
        property.updateAdditionalProperties(additionalProperties);

        Assert.assertEquals(
                ScalaSttpClientCodegen.DEFAULT_PACKAGE_NAME + ".api",
                additionalProperties.get(CodegenConstants.API_PACKAGE));
        Assert.assertEquals(
                ScalaSttpClientCodegen.DEFAULT_PACKAGE_NAME + ".model",
                additionalProperties.get(CodegenConstants.MODEL_PACKAGE));
        Assert.assertEquals(
                ScalaSttpClientCodegen.DEFAULT_PACKAGE_NAME + ".core",
    ...
    public void shouldUseCustomMainPackageNameIfProvided() {
        ...
        Assert.assertEquals(
                customPackageName + ".api", additionalProperties.get(CodegenConstants.API_PACKAGE));
        Assert.assertEquals(
                customPackageName + ".model",
                additionalProperties.get(CodegenConstants.MODEL_PACKAGE));
        Assert.assertEquals(
                customPackageName + ".core",
                additionalProperties.get(CodegenConstants.INVOKER_PACKAGE));
    }
    ...
    public void shouldAllowToMixCustomPackages() {
        ...
        Assert.assertEquals(
                otherCustomPackageName, additionalProperties.get(CodegenConstants.API_PACKAGE));
        Assert.assertEquals(
                customPackageName + ".model",
                additionalProperties.get(CodegenConstants.MODEL_PACKAGE));
        Assert.assertEquals(
