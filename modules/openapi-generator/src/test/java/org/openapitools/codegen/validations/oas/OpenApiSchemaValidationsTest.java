...
public class OpenApiSchemaValidationsTest {
    @Test(
            ...
            description = "default oneOf with sibling properties recommendation")
    public void testDefaultRecommendationOneOfWithSiblingProperties(
            Schema schema, boolean matches) {
    ...
    @Test(
            dataProvider = "apacheNginxRecommendationExpectations",
            description =
                    "disable oneOf with sibling properties recommendation via turning off recommendations")
    public void testOneOfWithSiblingPropertiesDisabledRecommendations(
            Schema schema, boolean matches) {
        RuleConfiguration config = new RuleConfiguration();
    ...
    @Test(
            dataProvider = "apacheNginxRecommendationExpectations",
            description =
                    "disable oneOf with sibling properties recommendation via turning off rule")
    ...
    private ComposedSchema getOneOfSample(boolean withProperties) {
        ...
        if (withProperties) {
            schema.addProperties(
                    "other", new ArraySchema().items(new Schema().$ref("#/definitions/Other")));
        }
