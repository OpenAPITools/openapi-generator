...
public class MicronautServerCodegenTest extends AbstractMicronautCodegenTest {
    ...
    public void testInitialConfigValues() throws Exception {
        ...
        Assertions.assertEquals(codegen.apiPackage(), "org.openapitools.controller");
        Assertions.assertEquals(codegen.additionalProperties().get(CodegenConstants.API_PACKAGE), "org.openapitools.controller");
        Assertions.assertEquals(codegen.additionalProperties().get(JavaMicronautServerCodegen.OPT_CONTROLLER_PACKAGE), "org.openapitools.controller");
