...
public class MicronautServerCodegenTest extends AbstractMicronautCodegenTest {
    protected static String ROLES_EXTENSION_TEST_PATH =
            "src/test/resources/3_0/micronaut/roles-extension-test.yaml";
    protected static String MULTI_TAGS_TEST_PATH =
            "src/test/resources/3_0/micronaut/multi-tags-test.yaml";
    ...
    public void testInitialConfigValues() throws Exception {
        ...
        Assert.assertEquals(
                ...
                "org.openapitools.controller");
        Assert.assertEquals(
                codegen.additionalProperties()
                        .get(JavaMicronautServerCodegen.OPT_CONTROLLER_PACKAGE),
                "org.openapitools.controller");
    ...
    public void testApiAndModelFilesPresent() {
        ...
        codegen.additionalProperties()
                .put(JavaMicronautServerCodegen.OPT_CONTROLLER_PACKAGE, "org.test.test.controller");
        String outputPath =
                generateFiles(
                        codegen,
                        PETSTORE_PATH,
    ...
    public void doUseValidationParam() {
        ...
        assertFileContains(
                outputPath + "/src/main/java/org/openapitools/controller/PetController.java",
                "@Valid");
        assertFileContains(
                outputPath + "/src/main/java/org/openapitools/controller/PetController.java",
                "@NotNull");
    ...
    public void doGenerateForMaven() {
        ...
        codegen.additionalProperties()
                .put(
                        JavaMicronautServerCodegen.OPT_BUILD,
                        JavaMicronautServerCodegen.OPT_BUILD_MAVEN);
        String outputPath =
                generateFiles(codegen, PETSTORE_PATH, CodegenConstants.SUPPORTING_FILES);
    ...
    public void doGenerateForTestJUnit() {
        ...
        codegen.additionalProperties()
                .put(
                        JavaMicronautServerCodegen.OPT_TEST,
        ...
        assertFileExists(
                outputPath + "src/test/java/org/openapitools/controller/PetControllerTest.java");
        assertFileContains(
                outputPath + "src/test/java/org/openapitools/controller/PetControllerTest.java",
                "PetControllerTest",
                "@MicronautTest");
    ...
    public void doGenerateForTestSpock() {
        ...
        assertFileExists(
                outputPath
                        + "src/test/groovy/org/openapitools/controller/PetControllerSpec.groovy");
        assertFileContains(
                outputPath + "src/test/groovy/org/openapitools/controller/PetControllerSpec.groovy",
                "PetControllerSpec",
                "@MicronautTest");
    }
    ...
    public void doGenerateRequiredPropertiesInConstructor() {
        JavaMicronautServerCodegen codegen = new JavaMicronautServerCodegen();
        codegen.additionalProperties()
                .put(JavaMicronautServerCodegen.OPT_REQUIRED_PROPERTIES_IN_CONSTRUCTOR, "true");
        String outputPath =
                generateFiles(
                        codegen, PETSTORE_PATH, CodegenConstants.MODELS, CodegenConstants.APIS);

        // Constructor should have properties
        String modelPath = outputPath + "src/main/java/org/openapitools/model/";
        assertFileContains(
                modelPath + "Pet.java", "public Pet(String name, List<String> photoUrls)");
    ...
    public void doNotGenerateRequiredPropertiesInConstructor() {
        JavaMicronautServerCodegen codegen = new JavaMicronautServerCodegen();
        codegen.additionalProperties()
                .put(JavaMicronautServerCodegen.OPT_REQUIRED_PROPERTIES_IN_CONSTRUCTOR, "false");
        String outputPath =
                generateFiles(
                        codegen, PETSTORE_PATH, CodegenConstants.MODELS, CodegenConstants.APIS);
    ...
    public void testExtraAnnotations() throws Exception {
        ...
        String outputPath =
                generateFiles(
                        codegen, "src/test/resources/3_0/issue_11772.yml", CodegenConstants.MODELS);
    ...
    public void generateAuthRolesWithExtension() {
        ...
        String controllerPath = outputPath + "src/main/java/org/openapitools/controller/";
        assertFileContainsRegex(
                controllerPath + "BooksController.java", "IS_ANONYMOUS[^;]{0,100}bookSearchGet");
        assertFileContainsRegex(
                controllerPath + "BooksController.java",
                "@Secured\\(\\{\"admin\"\\}\\)[^;]{0,100}createBook");
        assertFileContainsRegex(
                controllerPath + "BooksController.java", "IS_ANONYMOUS[^;]{0,100}getBook");
        assertFileContainsRegex(
                controllerPath + "BooksController.java", "IS_AUTHENTICATED[^;]{0,100}reserveBook");

        assertFileContainsRegex(
                controllerPath + "ReviewsController.java",
                "IS_AUTHENTICATED[^;]{0,100}bookSendReviewPost");
        assertFileContainsRegex(
                controllerPath + "ReviewsController.java",
                "IS_ANONYMOUS[^;]{0,100}bookViewReviewsGet");

        assertFileContainsRegex(
                controllerPath + "UsersController.java", "IS_ANONYMOUS[^;]{0,100}getUserProfile");
        assertFileContainsRegex(
                controllerPath + "UsersController.java",
                "IS_AUTHENTICATED[^;]{0,100}updateProfile");
    }
    ...
    public void doGenerateMonoWrapHttpResponse() {
        ...
        codegen.additionalProperties()
                .put(JavaMicronautServerCodegen.OPT_WRAP_IN_HTTP_RESPONSE, "true");
        String outputPath =
                generateFiles(
                        codegen, PETSTORE_PATH, CodegenConstants.MODELS, CodegenConstants.APIS);
    ...
    public void doGenerateMono() {
        ...
        codegen.additionalProperties().put(JavaMicronautServerCodegen.OPT_REACTIVE, "true");
        codegen.additionalProperties()
                .put(JavaMicronautServerCodegen.OPT_WRAP_IN_HTTP_RESPONSE, "false");
        String outputPath =
                generateFiles(
                        codegen, PETSTORE_PATH, CodegenConstants.MODELS, CodegenConstants.APIS);
    ...
    public void doGenerateOperationOnlyForFirstTag() {
        ...
        assertFileContains(
                controllerPath + "AuthorsController.java",
                "authorSearchGet",
                "getAuthor",
                "getAuthorBooks");
        assertFileContains(
    ...
    public void doRepeatOperationForAllTags() {
        JavaMicronautServerCodegen codegen = new JavaMicronautServerCodegen();
        codegen.additionalProperties()
                .put(JavaMicronautServerCodegen.OPT_GENERATE_OPERATION_ONLY_FOR_FIRST_TAG, "false");
        String outputPath =
                generateFiles(
                        codegen,
                        MULTI_TAGS_TEST_PATH,
        ...
        assertFileContains(
                ...
                "getAuthorBooks");
        assertFileContains(
                controllerPath + "SearchController.java", "authorSearchGet", "bookSearchGet");
    }
}
