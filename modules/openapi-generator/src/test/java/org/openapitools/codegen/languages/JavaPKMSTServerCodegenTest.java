...
public class JavaPKMSTServerCodegenTest {
    ...
    public void testUseOneOfInterfaceOptionGeneratesInterface() throws IOException {
        ...
        assertFileContains(Paths.get(outputPath + "/src/main/java/com/prokarma/pkmst/model/Foo.java"), "public class Foo implements FooRefOrValue");
        assertFileContains(Paths.get(outputPath + "/src/main/java/com/prokarma/pkmst/model/FooRef.java"), "public class FooRef implements FooRefOrValue");
        assertFileContains(Paths.get(outputPath + "/src/main/java/com/prokarma/pkmst/model/FooRefOrValue.java"), "public interface FooRefOrValue");
    }
}
