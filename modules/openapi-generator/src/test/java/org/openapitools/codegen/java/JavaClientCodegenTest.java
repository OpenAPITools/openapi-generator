...
public class JavaClientCodegenTest {
    ...
    public void arraysInRequestBody() throws Exception {
        ...
        CodegenParameter codegenParameter1 = codegen.fromRequestBody(body1 , new HashSet<String>(), null, openAPI);
        ...
        CodegenParameter codegenParameter2 = codegen.fromRequestBody(body2 , new HashSet<String>(), null, openAPI);
        ...
        CodegenParameter codegenParameter3 = codegen.fromRequestBody(body3 , new HashSet<String>(), null, openAPI);
    ...
    public void testFreeFormObjects() {
        ...
        CodegenModel cm1 = codegen.fromModel("MapTest1", test1, openAPI);
        ...
        CodegenModel cm2 = codegen.fromModel("MapTest2", test2, openAPI);
        ...
        CodegenModel cm3 = codegen.fromModel("MapTest3", test3, openAPI);
        ...
        CodegenModel cm = codegen.fromModel("OtherObj", other, openAPI);
