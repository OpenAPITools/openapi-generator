...
public class CSharpModelTest {
    ...
    public void assertOuterEnumIsString() {
        ...
        // this issue has not been found yet in version 2
        // Assert.assertEquals(outerEnumVarsIsString(new CSharpRestSharpClientCodegen(), 2, false), true);
        // Assert.assertEquals(outerEnumVarsIsString(new CSharpRestSharpClientCodegen(), 2, true), true);
