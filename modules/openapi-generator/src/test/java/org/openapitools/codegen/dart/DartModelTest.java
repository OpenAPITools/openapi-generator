...
public class DartModelTest {
    ...
    public static Object[] enumVarNames() {
        return new Object[] {
                ...
                new EnumVarName("_hello", "hello_", "String"),
                new EnumVarName("_double", "double_", "String"),
                new EnumVarName("_123hello", "n123hello_", "String"),
                new EnumVarName("_5FOO", "n5fOO_", "String"),
                new EnumVarName("_FOO", "FOO_", "String"),
                new EnumVarName("_$foo", "dollarFoo_", "String"),
                new EnumVarName("_$_foo_", "dollarFoo_", "String"),
