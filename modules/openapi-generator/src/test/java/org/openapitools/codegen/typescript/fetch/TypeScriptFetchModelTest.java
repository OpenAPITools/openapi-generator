...
public class TypeScriptFetchModelTest {
    ...
    public void simpleModelTest() {
        ...
        Assertions.assertEquals(property4.dataType, "Date");
        ...
        Assertions.assertEquals(property5.defaultValue, "undefined");
    ...
    public void enumArrayModelTest() {
        ...
        Assertions.assertEquals(prope.datatypeWithEnum, "Array<ArrayEnumEnum>");
        Assertions.assertEquals(prope.enumName, "ArrayEnumEnum");
    ...
    public void enumModelValueTest() {
        ...
        codegen.updateCodegenPropertyEnum(prope);
        Assertions.assertEquals(prope.datatypeWithEnum, "EnumIntegerEnum");
        Assertions.assertEquals(prope.enumName, "EnumIntegerEnum");
        Assertions.assertTrue(prope.isEnum);
    ...
    public void testNullSafeAdditionalProps() {
        ...
        Assertions.assertEquals(codegen.getTypeDeclaration(model), "{ [key: string]: string | undefined; }");
    }
    ...
    public void testWithoutNullSafeAdditionalProps() {
        ...
        Assertions.assertEquals(codegen.getTypeDeclaration(model), "{ [key: string]: string; }");
    }
    ...
    public void testNestedReadonlySchemas() {
        ...
        Assertions.assertEquals(schemaBefore.keySet(), Sets.newHashSet("club", "owner"));
    }
