...
public abstract class JavaJaxrsBaseTest {
    ...
    public void generateJsonAnnotationForPolymorphism() throws IOException {
        ...
        OpenAPI openAPI =
                new OpenAPIParser()
                        .readLocation(
                                "src/test/resources/3_0/generic.yaml", null, new ParseOptions())
                        .getOpenAPI();
        ...
        String jsonSubType =
                "@JsonSubTypes({\n"
                        ...
                        + "})";
        assertFileContains(
                Paths.get(outputPath + "/src/gen/java/org/openapitools/model/Animal.java"),
                jsonTypeInfo,
                jsonSubType);
    }
    ...
    public void doNotAddDefaultValueDocumentationForContainers() throws IOException {
        ...
        OpenAPI openAPI =
                new OpenAPIParser()
                        .readLocation(
                                "src/test/resources/3_0/arrayParameter.yaml",
                                null,
                                new ParseOptions())
                        .getOpenAPI();
        codegen.setOutputDir(output.getAbsolutePath());
        ...
        assertFileNotContains(
                Paths.get(outputPath + "/src/gen/java/org/openapitools/api/ExamplesApi.java"),
                "DefaultValue");
    }
    ...
    public void addDefaultValueDocumentationForNonContainers() throws IOException {
        ...
        openAPI.getComponents()
                .getParameters()
                .get("operationsQueryParam")
                .setSchema(new StringSchema()._default("default"));
        codegen.setOutputDir(output.getAbsolutePath());
    ...
    public void testAddOperationToGroupUseTagsTrue() throws IOException {
        ...
        MockDefaultGenerator.WrittenTemplateBasedFile tag0File =
                TestUtils.getTemplateBasedFile(
                        generator, output, "src/gen/java/org/openapitools/api/Tag0Api.java");
        ...
        MockDefaultGenerator.WrittenTemplateBasedFile tag1File =
                TestUtils.getTemplateBasedFile(
                        generator, output, "src/gen/java/org/openapitools/api/Tag1Api.java");
        ...
        MockDefaultGenerator.WrittenTemplateBasedFile tag2File =
                TestUtils.getTemplateBasedFile(
                        generator, output, "src/gen/java/org/openapitools/api/Tag2Api.java");
        ...
        MockDefaultGenerator.WrittenTemplateBasedFile defaultFile =
                TestUtils.getTemplateBasedFile(
                        generator, output, "src/gen/java/org/openapitools/api/DefaultApi.java");
        ...
        MockDefaultGenerator.WrittenTemplateBasedFile group4File =
                TestUtils.getTemplateBasedFile(
                        generator, output, "src/gen/java/org/openapitools/api/Group4Api.java");
        ...
        MockDefaultGenerator.WrittenTemplateBasedFile group5File =
                TestUtils.getTemplateBasedFile(
                        generator, output, "src/gen/java/org/openapitools/api/Group5Api.java");
    ...
    public void testAddOperationToGroupUseTagsFalse() throws Exception {
        ...
        MockDefaultGenerator.WrittenTemplateBasedFile group1File =
                TestUtils.getTemplateBasedFile(
                        generator, output, "src/gen/java/org/openapitools/api/Group1Api.java");
        ...
        MockDefaultGenerator.WrittenTemplateBasedFile group2File =
                TestUtils.getTemplateBasedFile(
                        generator, output, "src/gen/java/org/openapitools/api/Group2Api.java");
        ...
        MockDefaultGenerator.WrittenTemplateBasedFile group3File =
                TestUtils.getTemplateBasedFile(
                        generator, output, "src/gen/java/org/openapitools/api/Group3Api.java");
        ...
        MockDefaultGenerator.WrittenTemplateBasedFile group6File =
                TestUtils.getTemplateBasedFile(
                        generator, output, "src/gen/java/org/openapitools/api/Group6Api.java");
