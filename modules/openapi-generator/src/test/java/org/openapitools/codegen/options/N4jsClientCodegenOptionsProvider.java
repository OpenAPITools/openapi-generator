...
public class N4jsClientCodegenOptionsProvider implements OptionsProvider {
    ...
    public Map<String, String> createOptions() {
        ...
        return builder.put(
                        N4jsClientCodegen.CHECK_REQUIRED_PARAMS_NOT_NULL,
                        CHECK_REQUIRED_PARAMS_NOT_NULL__VALUE)
                .put(
                        N4jsClientCodegen.CHECK_SUPERFLUOUS_BODY_PROPS,
                        CHECK_SUPERFLUOUS_BODY_PROPS__VALUE)
                .put(
                        N4jsClientCodegen.GENERATE_DEFAULT_API_EXECUTER,
                        GENERATE_DEFAULT_API_EXECUTER__VALUE)
