...
public class EscapeDoubleQuoteLambdaTest {

    @Test
    public void escapesDoubleQuotesAsFragmentStreams() throws Exception {
        ...
        new EscapeDoubleQuoteLambda().execute(fragment, output);

        assertEquals(output.toString(), "\\\"alpha\\\"be\\\"tagamma\\\"");
    }
