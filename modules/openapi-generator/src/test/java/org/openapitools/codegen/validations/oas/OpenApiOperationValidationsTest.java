...
public class OpenApiOperationValidationsTest {
    ...
    public Object[][] getOrHeadWithBodyExpectations() {
        return new Object[][] {
            ...
            {PathItem.HttpMethod.GET, "opWithRef", "#/components/schemas/Animal", null, true},
            {
                ...
                "opWithContent",
                null,
                new Content().addMediaType("a", new MediaType()),
                true
            },
    ...
    public void testGetOrHeadWithBody(
                        ...
                        .filter(
                                invalid ->
                                        "API GET/HEAD defined with request body"
                                                .equals(invalid.getRule().getDescription()))
        ...
        if (shouldTriggerFailure) {
            ...
            Assert.assertEquals(
                    warnings.size(), 0, "Expected warnings not to include recommendation.");
        }
    }

    @Test(dataProvider = "getOrHeadWithBodyExpectations")
    public void testGetOrHeadWithBodyWithDisabledRecommendations(
            PathItem.HttpMethod method,
            String operationId,
            String ref,
            Content content,
    ...
    @Test(dataProvider = "getOrHeadWithBodyExpectations")
    public void testGetOrHeadWithBodyWithDisabledRule(
            PathItem.HttpMethod method,
            String operationId,
            String ref,
            Content content,
