...
public class BashClientOptionsProvider implements OptionsProvider {
    ...
    public Map<String, String> createOptions() {
        ...
        return builder.put(BashClientCodegen.CURL_OPTIONS, CURL_OPTIONS)
                ...
                .put(
                        BashClientCodegen.HOST_ENVIRONMENT_VARIABLE_NAME,
                        HOST_ENVIRONMENT_VARIABLE_NAME)
                .put(
                        BashClientCodegen.BASIC_AUTH_ENVIRONMENT_VARIABLE_NAME,
                        BASIC_AUTH_ENVIRONMENT_VARIABLE_NAME)
                .put(
                        BashClientCodegen.APIKEY_AUTH_ENVIRONMENT_VARIABLE_NAME,
