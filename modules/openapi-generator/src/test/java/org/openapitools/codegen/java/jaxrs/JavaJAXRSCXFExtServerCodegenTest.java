...
//        assertEquals(codegen.getInvokerPackage(), "org.openapitools.api");
        ...
        // NOT WRITTEN BACK assertEquals(additionalProperties.get(CodegenConstants.MODEL_PACKAGE), "org.openapitools.model");
//        assertEquals(codegen.modelPackage(), "org.openapitools.model");
        ...
        // Options processed by AbstractJavaCodegen
        // NOT WRITTEN BACK assertEquals(additionalProperties.get(CodegenConstants.ARTIFACT_DESCRIPTION), "OpenAPI Java");
...
//        assertEquals(additionalProperties.get(AbstractJavaJAXRSServerCodegen.SERVER_PORT), "8082");
    ...
    public void testSettersForConfigValues() throws Exception {
        // the comment below a description of #18715.
