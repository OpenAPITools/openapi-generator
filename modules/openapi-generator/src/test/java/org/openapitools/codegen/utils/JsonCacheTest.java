...
public class JsonCacheTest {
    public static class TestObject {
        @JsonProperty public boolean booleanField;
        @JsonProperty public double doubleField;
        @JsonProperty public float floatField;
        @JsonProperty public int intField;
        @JsonProperty public long longField;
        @JsonProperty public short shortField;
        @JsonProperty public String stringField;
        ...
        public String toString() {
            return "TestObject [booleanField="
                    + booleanField
                    + ", doubleField="
                    + doubleField
                    + ", floatField="
    ...
    private static final SimpleDateFormat ISO8601_DATETIME_FORMAT_JAVA =
    ...
    static {
        ...
        try {
            ...
            IllegalArgumentException t =
                    e instanceof IllegalArgumentException // split
    ...
    public void testAddBigDecimal() throws Exception {
        ...
        assertEquals(
                1,
                cache.get("/array/0"),
                "Array element at index 0 incorrect after add(path, value);");
        assertEquals(
                value,
        ...
        assertEquals(
                "2",
                cache.get("/array/2"),
                "Array element at index 2 incorrect after add(path, value);");
        ...
        assertEquals(
                ...
                "Array size incorrect after add(path, value)");
        assertEquals(
                null,
    ...
    public void testAddDateTimeThreeTen() throws Exception {
        testAddDate0(
                DATETIME_OFFSET_STR, org.threeten.bp.OffsetDateTime.parse(DATETIME_OFFSET_STR));
    }
    ...
    public void testAddDouble() throws Exception {
        ...
        assertEquals(
                6.2D,
                cache.getDouble("/object/nestedArray/5"),
                Double.MIN_VALUE,
                "Array element at index 1 incorrect after add(path, value);");
    }
    ...
    public void testAddFloat() throws Exception {
        ...
        assertEquals(
                6.2F,
                cache.getFloat("/object/nestedArray/5"),
                Float.MIN_VALUE,
                "Array element at index 1 incorrect after add(path, value);");
    }
    ...
    public void testDelete() throws Exception {
        ...
        assertEquals(
                "2",
                cache.getString("/array/1"),
                "Array element at index 1 incorrect after delete;");
        assertEquals(
                4.0D,
                cache.getDouble("/array/2"),
                Double.MIN_VALUE,
                "Array element at index 2 incorrect after delete;");

        cache.delete("/object/nestedArray/2");
        assertEquals(
                3, cache.size("/object/nestedArray"), "Array size incorrect after delete element;");
        assertEquals(
                "b",
                cache.getString("/object/nestedArray/1"),
                "Array element at index 1 incorrect after delete;");
        assertEquals(
                "d",
                cache.getString("/object/nestedArray/2"),
                "Array element at index 2 incorrect after delete;");
        ...
        assertEquals(
                true,
                cache.getBoolean("/0"),
                "Failed to set root array element 0 when root is null;");
        ...
        assertEquals(
                ...
                cache.getDouble("/1"),
                Double.MIN_VALUE,
                "Failed to set root array element 1;");

        cache.set("/2", "a string element");
        assertEquals(
                "a string element", cache.getString("/2"), "Failed to set root array element 2;");
        ...
        try {
            ...
            assertFalse(
                    cache.exists("/astring"),
                    "setting a non-numeric property on an array worked!;");
        }
    }
    ...
    public void testGet() throws Exception {
        ...
        assertEquals(
                true,
                cache.get("/object/nestedBoolean"),
                "nested boolean get() returned incorrect result;");
        assertEquals(
                2.72,
                cache.get("/object/nestedNumber"),
                "nested number get() returned incorrect result;");
        assertEquals(
                "a nested string",
        ...
        assertEquals(
                4,
                cache.size("/object/nestedArray"),
                "nested array size() returned incorrect result;");
        assertEquals(
                "a",
                cache.get("/object/nestedArray/0"),
                "nested array get element returned incorrect result;");
        assertEquals(
                "d",
                cache.get("/object/nestedArray/3"),
                "nested array get element returned incorrect result;");
        ...
        assertEquals(
                true,
                cache.get("/testObjects/0/booleanField"),
                "test object 0 booleanField is incorrect;");
        assertEquals(
                1,
                cache.get("/testObjects/0/shortField"),
                "test object 0 shortField is incorrect;");
        assertEquals(
                2, cache.get("/testObjects/0/intField"), "test object 0 intField is incorrect;");
        assertEquals(
                3, cache.get("/testObjects/0/longField"), "test object 0 longField is incorrect;");
        assertEquals(
                1.23,
                cache.get("/testObjects/0/floatField"),
                "test object 0 floatField is incorrect;");
        assertEquals(
                4.56,
                cache.get("/testObjects/0/doubleField"),
                "test object 0 doubleField is incorrect;");
        assertEquals(
                "a test string field",
        ...
        assertEquals(
                false,
                cache.get("/testObjects/1/booleanField"),
                "test object 1 booleanField is incorrect;");
        assertEquals(
                4,
                cache.get("/testObjects/1/shortField"),
                "test object 1 shortField is incorrect;");
        assertEquals(
                5, cache.get("/testObjects/1/intField"), "test object 1 intField is incorrect;");
        assertEquals(
                6, cache.get("/testObjects/1/longField"), "test object 1 longField is incorrect;");
        assertEquals(
                8.23,
                cache.get("/testObjects/1/floatField"),
                "test object 1 floatField is incorrect;");
        assertEquals(
                9.56,
                cache.get("/testObjects/1/doubleField"),
                "test object 1 doubleField is incorrect;");
        assertEquals(
                "another test string field",
    ...
    public void testGetBigDecimalWithDefault() throws Exception {
        ...
        assertFalse(
                root.isDirty(), "cache should not be dirty after getBigDecimal(path, default);");
        ...
        assertTrue(
                root.isDirty(),
                "cache should be dirty after getBigDecimal(nonExistentPath, default);");
    ...
    public void testGetBigInteger() throws Exception {
        ...
        assertEquals(
                bi3,
                cache.getBigInteger("/number"),
                "getBigInteger(path) returned incorrect result;");
        assertEquals(
                bi2,
    ...
    public void testGetBigIntegerWithDefault() throws Exception {
        ...
        assertFalse(
                root.isDirty(), "cache should not be dirty after getBigInteger(path, default);");
        ...
        assertTrue(
                root.isDirty(),
                "cache should be dirty after getBigInteger(nonExistentPath, default);");
    ...
    public void testGetBoolean() throws Exception {
        assertEquals(
                true, cache.getBoolean("/boolean"), "getBoolean(path) returned incorrect result;");
        assertEquals(
                true,
    ...
    public void testGetBooleanWithDefault() throws Exception {
        assertEquals(
                true,
                cache.getBoolean("/boolean", false),
                "getBoolean(path, default) returned incorrect result;");
        assertEquals(
                true,
        ...
        assertTrue(
                root.isDirty(),
                "cache should be dirty after getBoolean(nonExistentPath, default);");
    ...
    public void testGetDateWithDefault() throws Exception {
        ...
        assertTrue(
                root.isDirty(), "cache should be dirty after getDate(nonExistentPath, default);");
    ...
    public void testGetDouble() throws Exception {
        assertEquals(
                3.14D,
                cache.getDouble("/number"),
                Double.MIN_VALUE,
                "getDouble(path) returned incorrect result;");
        assertEquals(
                2.72D,
                cache.getDouble("/object/nestedNumber"),
                Double.MIN_VALUE,
    ...
    public void testGetDoubleWithDefault() throws Exception {
        assertEquals(
                3.14D,
                cache.getDouble("/number", 7.77D),
                Double.MIN_VALUE,
                "getDouble(path, default) returned incorrect result;");
        assertEquals(
                2.72D,
                cache.getDouble("/object/nestedNumber", 8.88D),
                Double.MIN_VALUE,
                "getDouble(nestedPath, default) returned incorrect result;");
        assertFalse(root.isDirty(), "cache should not be dirty after getDouble(path, default);");

        assertEquals(
                7.77D,
                cache.getDouble("/nonExistentNumber", 7.77D),
                Double.MIN_VALUE,
                "getDouble(nonExistentPath, default) returned incorrect result;");
        assertEquals(
                8.88D,
                cache.getDouble("/object/nonExistentNestedNumber", 8.88D),
                Double.MIN_VALUE,
                "getDouble(nonExistentNestedPath, default) returned incorrect result;");
        assertTrue(
                root.isDirty(), "cache should be dirty after getDouble(nonExistentPath, default);");

        assertEquals(
                7.77D,
                cache.getDouble("/nonExistentNumber"),
                Double.MIN_VALUE,
                "getDouble(path) returned incorrect result after update;");
        assertEquals(
                8.88D,
                cache.getDouble("/object/nonExistentNestedNumber"),
                Double.MIN_VALUE,
                "getDouble(nestedPath) returned incorrect result after update;");
    }
    ...
    public void testGetFloat() throws Exception {
        assertEquals(
                3.14F,
                cache.getFloat("/number"),
                Float.MIN_VALUE,
                "getFloat(path) returned incorrect result;");
        assertEquals(
                2.72F,
                cache.getFloat("/object/nestedNumber"),
                Float.MIN_VALUE,
                "nested getFloat(nestedPath) returned incorrect result;");
    ...
    public void testGetFloatWithDefault() throws Exception {
        assertEquals(
                3.14F,
                cache.getFloat("/number", 7.77F),
                Float.MIN_VALUE,
                "getFloat(path, default) returned incorrect result;");
        assertEquals(
                2.72F,
                cache.getFloat("/object/nestedNumber", 8.88F),
                Float.MIN_VALUE,
                "nested getFloat(nestedPath, default) returned incorrect result;");
        assertFalse(root.isDirty(), "cache should not be dirty after getFloat(path, default);");

        assertEquals(
                7.77F,
                cache.getFloat("/nonExistentNumber", 7.77F),
                Float.MIN_VALUE,
                "getFloat(nonExistentPath, default) returned incorrect result;");
        assertEquals(
                8.88F,
                cache.getFloat("/object/nonExistentNestedNumber", 8.88F),
                Float.MIN_VALUE,
                "nested getFloat(nonExistentNestedPath, default) returned incorrect result;");
        assertTrue(
                root.isDirty(), "cache should be dirty after getFloat(nonExistentPath, default);");

        assertEquals(
                7.77F,
                cache.getFloat("/nonExistentNumber"),
                Float.MIN_VALUE,
                "getFloat(path) returned incorrect result after update;");
        assertEquals(
                8.88F,
                cache.getFloat("/object/nonExistentNestedNumber"),
                Float.MIN_VALUE,
                "nested getFloat(nestedPath) returned incorrect result after update;");
    }
    ...
    public void testGetInt() throws Exception {
        ...
        assertEquals(
                2,
                cache.getInt("/object/nestedNumber"),
                "getInt(nestedPath) returned incorrect result;");
    ...
    public void testGetIntWithDefault() throws Exception {
        assertEquals(
                3, cache.getInt("/number", 5), "getInt(path, default) returned incorrect result;");
        assertEquals(
                4,
                cache.getInt("/object/nestedNumber"),
                2,
        ...
        assertEquals(
                5,
                cache.getInt("/nonExistentNumber"),
                "getInt(path) returned incorrect result after update;");
        assertEquals(
                4,
    ...
    public void testGetLocalDateWithDefault() throws Exception {
        ...
        assertTrue(
                root.isDirty(),
                "cache should be dirty after getLocalDate(nonExistentPath, default);");
        ...
        assertEquals(
                defaultDate,
                cache.getObject(
                        "/object/nonExistentNestedLocalDate", org.joda.time.LocalDate.class),
    ...
    public void testGetLong() throws Exception {
        ...
        assertEquals(
                2L,
                cache.getLong("/object/nestedNumber"),
                "getLong(nestedPath) returned incorrect result;");
    ...
    public void testGetLongWithDefault() throws Exception {
        assertEquals(
                3L,
                cache.getLong("/number", 5L),
                "getLong(path, default) returned incorrect result;");
        assertEquals(
                2L,
        ...
        assertTrue(
                root.isDirty(), "cache should be dirty after getLong(nonExistentPath, default);");
    ...
    public void testGetNumber() throws Exception {
        ...
        assertTrue(
                nestedNumber instanceof Double, "getNumber(nestedPath) returned incorrect type;");
        assertEquals(
                2.72D, nestedNumber, "nested getNumber(nestedPath) returned incorrect result;");
    ...
    public void testGetNumberWithDefault() throws Exception {
        assertEquals(
                3.14D,
                cache.getNumber("/number", 7.77D),
                "getNumber(path, default) returned incorrect result;");
        assertEquals(
                2.72D,
        ...
        assertTrue(
                root.isDirty(), "cache should be dirty after getNumber(nonExistentPath, default);");
    ...
    public void testGetObjects() throws Exception {
        ...
        assertEquals(
                TEST_OBJECT_0,
                testObjects.get(0),
                "getObjects(path, type) returned incorrect result;");
        assertEquals(
                TEST_OBJECT_1,
                testObjects.get(1),
                "getObjects(path, type) returned incorrect result;");
    ...
    public void testGetObjectsWithDefault() throws Exception {
        ...
        List<TestObject> testObjects =
                cache.getObjects("/testObjects", TestObject.class, defaultValue);
        assertEquals(
                TEST_OBJECT_0,
                testObjects.get(0),
        ...
        assertFalse(
                root.isDirty(),
                "cache should not be dirty after getObjects(path, type, defaultValue);");
        ...
        assertTrue(
                root.isDirty(),
                "cache should be dirty after getObjects(nonExistentPath, type, defaultValue);");
    ...
    public void testGetObjectWithDefault() throws Exception {
        ...
        assertTrue(
                root.isDirty(), "cache should be dirty after getObject(nonExistentPath, default);");
    ...
    public void testGetShortWithDefault() throws Exception {
        assertEquals(
                3,
                cache.getShort("/number", (short) 5),
                "getShort(path, default) returned incorrect result;");
        assertEquals(
                2,
        ...
        assertTrue(
                root.isDirty(), "cache should be dirty after getShort(nonExistentPath, default);");

        assertEquals(
                5,
                cache.getShort("/nonExistentNumber"),
                "getShort(path) returned incorrect result after update;");
        assertEquals(
                4,
    ...
    public void testGetString() throws Exception {
        assertEquals(
                "a string",
                cache.getString("/string"),
                "getString(path) returned incorrect result;");
        assertEquals(
                "a nested string",
    ...
    public void testGetStringWithDefault() throws Exception {
        ...
        assertTrue(
                root.isDirty(), "cache should be dirty after getString(nonExistentPath, default);");
    ...
    public void testMerge() throws Exception {
        ...
        ByteArrayInputStream in =
                new ByteArrayInputStream(incoming.getBytes(StandardCharsets.UTF_8));

        root.mergePolicy(MergePolicy.NO_MERGE).load(in);
        assertFalse(
                root.isDirty(), "cache should not be dirty after second load() in NO_MERGE mode");
        assertEquals(1, root.size(""), "root size incorrect after second load() in NO_MERGE mode;");
        assertEquals(
                8, cache.size(""), "cache size incorrect after second load() in NO_MERGE mode;");
        testGet();

        in.reset();
        root.mergePolicy(MergePolicy.KEEP_EXISTING).load(in);
        assertTrue(
                root.isDirty(), "cache should be dirty after second load() in KEEP_EXISTING mode");
        assertEquals(
                2, root.size(""), "root size incorrect after second load() in KEEP_EXISTING mode;");
        assertEquals(
                8,
                cache.size(""),
                "cache size incorrect after second load() in KEEP_EXISTING mode;");
        assertFalse(
                cache.exists("/anotherString"),
        ...
        assertEquals(
                ...
                "added root property not merged in KEEP_EXISTING mode");
        assertEquals(4, cache.size("/array"), "added array elements merged in KEEP_EXISTING mode");
        assertEquals(
                4,
                cache.size("/object/nestedArray"),
                "added array elements merged in KEEP_EXISTING mode");
        testGet();
        ...
        assertTrue(
                root.isDirty(),
                "cache should be dirty after second load() in MERGE_RECURSIVE mode");
        assertEquals(
                2,
                root.size(""),
                "root size incorrect after second load() in MERGE_RECURSIVE mode;");
        assertEquals(
                10,
                root.get("/JsonCacheMerge/number"),
                "added root property not merged in MERGE_RECURSIVE mode");
        assertEquals(
                "another string",
        ...
        assertEquals(
                7,
                cache.size("/array"),
                "added child array elements not merged in MERGE_RECURSIVE mode");
        assertEquals(
        ...
        assertTrue(
                root.isDirty(),
                "cache should be dirty after second load() in OVERWRITE_EXISTING mode");
        assertEquals(
                false,
                cache.get("/boolean"),
        ...
        assertFalse(
                cache.exists("/number"),
                "existing number not deleted by load() in OVERWRITE_EXISTING mode;");
        assertEquals(
                "a different string",
                cache.get("/string"),
        ...
        assertEquals(
                7, cache.size("/array"), "added array size incorrect in OVERWRITE_EXISTING mode;");
        assertEquals(
                3,
                cache.size("/object"),
                "added object size incorrect in OVERWRITE_EXISTING mode;");
        assertEquals(
                "a different nested string",
                cache.get("/object/nestedString"),
    ...
    public void testSet() throws Exception {
        ...
        assertEquals(
                "another string", cache.get("/string"), "string get() returned incorrect result;");
    ...
    public void testSetBigDecimal() throws Exception {
        ...
        assertEquals(
                bd628,
                cache.getBigDecimal("/number"),
                "getBigInteger() returned incorrect result;");
    ...
    public void testSetBigInteger() throws Exception {
        ...
        assertEquals(
                bi4, cache.getBigInteger("/number"), "getBigInteger() returned incorrect result;");
    ...
    public void testSetBoolean() throws Exception {
        ...
        assertEquals(
                false,
                cache.getBoolean("/object/nestedBoolean"),
                "nested getBoolean returned incorrect result;");
    ...
    public void testSetDate() throws Exception {
        ...
        assertEquals(
                date,
                cache.getObject("/dateTimeZ", Date.class),
                "getDate() returned incorrect result;");
    ...
    private void testSetDate0(String dateStr, Object date) throws CacheException {
        ...
        assertEquals(
                date,
                cache.getObject("/dateStr", date.getClass()),
                "getObject(\"/dateStr\", "
                        + date.getClass().getName()
                        + ".class) returned incorrect result;");
        cache.set("/date", date);
        assertEquals(
                date,
                cache.getObject("/dateStr", date.getClass()),
    ...
    public void testSetDouble() throws Exception {
        ...
        assertEquals(
                ...
                cache.getDouble("/number"),
                Double.MIN_VALUE,
                "getDouble() returned incorrect result;");
    ...
    public void testSetFloat() throws Exception {
        ...
        assertEquals(
                ...
                cache.getFloat("/number"),
                Float.MIN_VALUE,
                "getFloat() returned incorrect result;");
    ...
    public void testSetInt() throws Exception {
        ...
        assertEquals(
                22,
                cache.getInt("/object/nestedNumber"),
                "nested getInt() returned incorrect result;");
    ...
    public void testSetLong() throws Exception {
        ...
        assertEquals(
                32L,
                cache.getLong("/object/nestedNumber"),
                "nested getLong() returned incorrect result;");
    ...
    public void testSetNumber() throws Exception {
        ...
        assertEquals(
                1.618D,
                cache.getNumber("/object/nestedNumber"),
                "nested getNumber() returned incorrect result;");
    ...
    public void testSetObject() throws Exception {
        ...
        assertEquals(
                "a replacement string", cache.getString("/string"), "set(Object) did not work;");
    ...
    public void testSetShort() throws Exception {
        ...
        assertEquals(
                12,
                cache.getShort("/object/nestedNumber"),
                "nested getShort() returned incorrect result;");
    ...
    public void testSetString() throws Exception {
        ...
        assertEquals(
                "a different string",
                cache.getString("/string"),
                "getString returned incorrect result;");
    ...
    public void testSetWithMissingAncestors() throws Exception {
        JsonPointer ptr =
                JsonPointer.compile("/nonExistentArray/0/nonExistentObject/stringProperty");
