...
public class JavaPlayFrameworkCodegenTest {
    ...
    public void testInitialConfigValues() throws Exception {
        ...
        Assert.assertEquals(
                codegen.additionalProperties().get(CodegenConstants.MODEL_PACKAGE), "apimodels");
        Assert.assertEquals(codegen.apiPackage(), "controllers");
        Assert.assertEquals(
                codegen.additionalProperties().get(CodegenConstants.API_PACKAGE), "controllers");
        ...
        Assert.assertEquals(
                codegen.additionalProperties().get(JavaPlayFrameworkCodegen.BASE_PACKAGE),
                "org.openapitools");
        Assert.assertEquals(codegen.getConfigPackage(), "org.openapitools.configuration");
        Assert.assertEquals(
                codegen.additionalProperties().get(JavaPlayFrameworkCodegen.CONFIG_PACKAGE),
    ...
    public void testAdditionalPropertiesPutForConfigValues() throws Exception {
        ...
        codegen.additionalProperties()
                .put(JavaPlayFrameworkCodegen.BASE_PACKAGE, "xyz.yyyyy.bbbb.base");
        codegen.additionalProperties()
                .put(JavaPlayFrameworkCodegen.CONFIG_PACKAGE, "xyz.yyyyy.cccc.config");
