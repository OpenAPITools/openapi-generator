...
public class DynamicSettingsTest {
    ...
    public void tesDynamicSettingsWithDynamicProperties() throws Exception {
        ...
        assertEquals(
                generatorSettings.getAdditionalProperties().get("releaseNote"), "Minor update");
    }
    ...
    public void testFullConfigWithFilesMap() throws JsonProcessingException {
        ...
        Map<String, TemplateDefinition> mapped =
                files.stream()
                        .collect(
                                Collectors.toMap(
        ...
        assertEquals(
                mapped.get("README.mustache").getTemplateType(), TemplateFileType.SupportingFiles);
        ...
        assertEquals(
                mapped.get("additional/README.mustache").getTemplateFile(),
                "additional/README.mustache");
        assertEquals(mapped.get("additional/README.mustache").getFolder(), "additional");
        assertEquals(
                mapped.get("additional/README.mustache").getDestinationFilename(), "README.md");
        assertEquals(
                mapped.get("additional/README.mustache").getTemplateType(),
        ...
        assertEquals(
                mapped.get("custom/api_doc.mustache").getTemplateFile(), "custom/api_doc.mustache");
        ...
        assertEquals(
                mapped.get("custom/api_doc.mustache").getTemplateType(), TemplateFileType.APIDocs);

        assertEquals(
                mapped.get("custom/api_test.mustache").getTemplateFile(),
        ...
        assertEquals(
                mapped.get("custom/api_test.mustache").getTemplateType(),
                TemplateFileType.APITests);

        assertEquals(
                mapped.get("custom/model.mustache").getTemplateFile(), "custom/model.mustache");
        ...
        assertEquals(
                mapped.get("custom/model_doc.mustache").getTemplateFile(),
                "custom/model_doc.mustache");
        ...
        assertEquals(
                mapped.get("custom/model_doc.mustache").getTemplateType(),
                TemplateFileType.ModelDocs);

        assertEquals(
                mapped.get("custom/model_test.mustache").getTemplateFile(),
        ...
        assertEquals(
                mapped.get("custom/model_test.mustache").getTemplateType(),
                TemplateFileType.ModelTests);

        assertEquals(
                mapped.get("additional/build.mustache").getTemplateFile(),
                "additional/build.mustache");
        assertEquals(mapped.get("additional/build.mustache").getFolder(), "build");
        assertEquals(
                mapped.get("additional/build.mustache").getDestinationFilename(), "build.gradle");
        assertEquals(
                mapped.get("additional/build.mustache").getTemplateType(),
                TemplateFileType.SupportingFiles);
