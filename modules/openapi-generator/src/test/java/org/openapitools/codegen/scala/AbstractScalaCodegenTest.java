...
public class AbstractScalaCodegenTest {
    ...
    private final AbstractScalaCodegen fakeScalaCodegen =
            new AbstractScalaCodegenTest.P_AbstractScalaCodegen();
    ...
    public void convertVarNameCamelCase() {
        ...
        Assert.assertEquals(
                ...
                fakeScalaCodegen.getModelPropertyNaming());
    ...
    public void convertVarNamePascalCase() {
        fakeScalaCodegen.setModelPropertyNaming(
    ...
    public void convertVarNameOriginalCase() {
        ...
        Assert.assertEquals(fakeScalaCodegen.toVarName("Name"), "Name");
        Assert.assertEquals(
                fakeScalaCodegen.toVarName("name-sanitized-to-underscore"),
                "name_sanitized_to_underscore");
        Assert.assertEquals(fakeScalaCodegen.toVarName("user_name"), "user_name");
        Assert.assertEquals(fakeScalaCodegen.toVarName("user|name"), "user_name");
        Assert.assertEquals(fakeScalaCodegen.toVarName("uSername"), "uSername");
        Assert.assertEquals(fakeScalaCodegen.toVarName("USERNAME"), "USERNAME");
    ...
    public void checkScalaTypeImportMapping() {
        Assert.assertEquals(
                fakeScalaCodegen.importMapping().get("Seq"),
                "scala.collection.immutable.Seq",
                "Seq is immutable collection");
        Assert.assertEquals(
                fakeScalaCodegen.importMapping().get("Set"),
                "scala.collection.immutable.Set",
                "Set is immutable collection");
        Assert.assertFalse(
                fakeScalaCodegen.importMapping().containsKey("List"),
                "List is a Scala type and must not be imported");
        Assert.assertFalse(
                fakeScalaCodegen.importMapping().containsKey("BigDecimal"),
                "BigDecimal is a Scala type and must not be imported");
        Assert.assertFalse(
                fakeScalaCodegen.importMapping().containsKey("BigInt"),
    ...
    void checkTypeDeclarationWithByteString() {
        ...
        Assert.assertEquals(
                fakeScalaCodegen.getTypeDeclaration(byteArraySchema),
                "Array[Byte]",
    ...
    void checkTypeDeclarationWithStringToArrayModelMapping() {
        ...
        fakeScalaCodegen.setOpenAPI(
                new OpenAPI()
                        .components(new Components().addSchemas("NestedArray", nestedArraySchema)));

        ModelUtils.setGenerateAliasAsModel(false);
        Assert.assertEquals(
                fakeScalaCodegen.getTypeDeclaration(mapSchema), "Map[String, List[String]]");

        ModelUtils.setGenerateAliasAsModel(true);
        Assert.assertEquals(
                fakeScalaCodegen.getTypeDeclaration(mapSchema), "Map[String, NestedArray]");
    }
}
