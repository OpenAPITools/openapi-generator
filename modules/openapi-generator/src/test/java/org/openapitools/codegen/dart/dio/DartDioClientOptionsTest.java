...
public class DartDioClientOptionsTest extends AbstractOptionsTest {
    ...
    protected void verifyOptions() {
        ...
        verify(clientCodegen).setLibrary(DartDioClientCodegen.NETWORKING_LIBRARY_DEFAULT);
        verify(clientCodegen).setSerializationLibrary(DartDioClientCodegen.SERIALIZATION_LIBRARY_DEFAULT);
