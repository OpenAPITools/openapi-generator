...
public class SpringCodegenTest {
    ...
    public void shouldAddValidAnnotationIntoCollectionWhenBeanValidationIsEnabled_issue14723() throws IOException {
        ...
        JavaFileAssert.assertThat(files.get("MyDto.java"))
              .isNormalClass()
              .hasImports("javax.validation.Valid")
              .hasProperty("nullableDtos")
              .withType( "JsonNullable<Set<@Valid MyDto2>>" )
              .toType()
              .hasProperty("dtos")
              .withType( "Set<@Valid MyDto2>" )
              .toType()
              .hasProperty("listNullableDtos")
              .withType( "JsonNullable<List<@Valid MyDto2>>" )
              .toType()
              .hasProperty("listDtos")
              .withType( "List<@Valid MyDto2>" )
              .toType()
              .hasProperty("nullableStrings")
              .withType( "JsonNullable<Set<@Valid String>>" )
              .toType()
              .hasProperty("strings")
              .withType( "Set<@Valid String>" )
              .toType()
              .hasProperty("nullableInts")
              .withType( "JsonNullable<Set<@Valid Integer>>" )
              .toType()
              .hasProperty("ints")
              .withType( "Set<@Valid Integer>" );
    }
