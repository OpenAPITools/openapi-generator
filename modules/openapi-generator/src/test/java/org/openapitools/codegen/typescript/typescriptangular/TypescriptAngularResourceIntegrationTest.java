...
public class TypescriptAngularResourceIntegrationTest extends AbstractIntegrationTest {
    ...
    protected CodegenConfig getCodegenConfig() {
        TypeScriptAngularClientCodegen config = new TypeScriptAngularClientCodegen();
        Map<String, Object> additionalProperties = config.additionalProperties();
        additionalProperties.put(TypeScriptAngularClientCodegen.USE_HTTP_RESOURCE, Boolean.TRUE.toString());
        return config;
    }
    ...
    protected IntegrationTestPathsConfig getIntegrationTestPathsConfig() {
        return new IntegrationTestPathsConfig("typescript/resource");
    }
