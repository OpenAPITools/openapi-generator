...
public class SerializerUtilsTest {
    ...
    private OpenAPI createCompleteExample() {
        ...
        openAPI.setExternalDocs(
                new ExternalDocumentation().url("http://abcdef.com").description("a-description"));
        openAPI.setServers(
                Arrays.asList(
        ...
        openAPI.setSecurity(
                Arrays.asList(
                        new SecurityRequirement()
                                .addList("some_auth", Arrays.asList("write", "read"))));
        openAPI.setTags(
                Arrays.asList(
        ...
        openAPI.setExtensions(
                new LinkedHashMap<>()); // required because swagger-core is using HashMap instead of
    ...
    private OpenAPI createMinimalExample() {
        ...
        openAPI.setServers(Arrays.asList(new Server().url("http://www.server1.com")));
        openAPI.path(
                "/ping/pong",
                new PathItem()
                        .get(
