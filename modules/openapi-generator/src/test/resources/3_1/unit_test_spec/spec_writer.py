...
class ExclusionReason:
    v310_feature_not_supported_yet = 'v3.1.0 feature is not supported yet by openapi-generator'
...
FILEPATH_TO_EXCLUDED_CASE_AND_REASON = {
    ...
    (json_schema_test_draft, 'minLength.json'): {
        'minLength validation with a decimal': ExclusionReason.swagger_parser_min_length_bug,
    },
    ...
    (json_schema_test_draft, 'ref.json'): {
        ...
        'ref applies alongside sibling keywords': ExclusionReason.v310_feature_not_supported_yet,
        'simple URN base URI with $ref via the URN': ExclusionReason.v310_feature_not_supported_yet,
        'simple URN base URI with JSON pointer': ExclusionReason.v310_feature_not_supported_yet,
        'URN base URI with NSS': ExclusionReason.v310_feature_not_supported_yet,
        'URN base URI with r-component': ExclusionReason.v310_feature_not_supported_yet,
        'URN base URI with q-component': ExclusionReason.v310_feature_not_supported_yet,
        'URN base URI with f-component': ExclusionReason.v310_feature_not_supported_yet,
        'URN base URI with URN and JSON pointer ref': ExclusionReason.v310_feature_not_supported_yet,
        'URN base URI with URN and anchor ref': ExclusionReason.v310_feature_not_supported_yet,
        'ref creates new scope when adjacent to keywords': ExclusionReason.v310_feature_not_supported_yet,
        'order of evaluation: $id and $ref': ExclusionReason.v310_feature_not_supported_yet,
    ...
    (json_schema_test_draft, 'refRemote.json'): {
        ...
        'retrieved nested refs resolve relative to their URI not $id': ExclusionReason.v310_feature_not_supported_yet,
        'remote ref with ref to defs': ExclusionReason.v310_feature_not_supported_yet,
        'Location-independent identifier in remote ref': ExclusionReason.v310_feature_not_supported_yet,
        'remote HTTP ref with different $id': ExclusionReason.v310_feature_not_supported_yet,
        'remote HTTP ref with different URN $id': ExclusionReason.v310_feature_not_supported_yet,
        'remote HTTP ref with nested absolute ref': ExclusionReason.v310_feature_not_supported_yet,
    },
...
FILEPATH_TO_EXCLUDE_REASON = {
    ...
    (json_schema_test_draft, 'anchor.json'): ExclusionReason.v310_feature_not_supported_yet,
    (json_schema_test_draft, 'boolean_schema.json'): ExclusionReason.v310_feature_not_supported_yet,
    (json_schema_test_draft, 'const.json'): ExclusionReason.v310_feature_not_supported_yet,
    (json_schema_test_draft, 'contains.json'): ExclusionReason.v310_feature_not_supported_yet,
    (json_schema_test_draft, 'content.json'): ExclusionReason.v310_feature_not_supported_yet,
    (json_schema_test_draft, 'dependentRequired.json'): ExclusionReason.v310_feature_not_supported_yet,
    (json_schema_test_draft, 'dependentSchemas.json'): ExclusionReason.v310_feature_not_supported_yet,
    (json_schema_test_draft, 'dynamicRef.json'): ExclusionReason.v310_feature_not_supported_yet,
    (json_schema_test_draft, 'if-then-else.json'): ExclusionReason.v310_feature_not_supported_yet,
    (json_schema_test_draft, 'maxContains.json'): ExclusionReason.v310_feature_not_supported_yet,
    (json_schema_test_draft, 'patternProperties.json'): ExclusionReason.v310_feature_not_supported_yet,
    (json_schema_test_draft, 'prefixItems.json'): ExclusionReason.v310_feature_not_supported_yet,
    (json_schema_test_draft, 'propertyNames.json'): ExclusionReason.v310_feature_not_supported_yet,
    (json_schema_test_draft, 'unevaluatedItems.json'): ExclusionReason.v310_feature_not_supported_yet,
    (json_schema_test_draft, 'unevaluatedProperties.json'): ExclusionReason.v310_feature_not_supported_yet,
    (json_schema_test_draft, 'vocabulary.json'): ExclusionReason.v310_feature_not_supported_yet,
}
