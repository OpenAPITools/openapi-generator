...
[Master](https://github.com/OpenAPITools/openapi-generator/tree/master) (`7.26.0`):
...
[<img align="left" src="https://openapi-generator.tech/img/companies/betterfollowers.png" width="128" height="128">](https://betterfollowers.com/?utm_source=openapi-generator&utm_medium=sponsorship&utm_campaign=oss-sponsorship)
...
| --------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ | ------------------------------------------------- |
| 7.26.0 (upcoming minor release) [SNAPSHOT](https://github.com/OpenAPITools/openapi-generator/wiki/FAQ#how-to-test-with-the-latest-master-of-openapi-generator) | 24.09.2026   | Minor release with breaking changes (with fallback) |
| [7.25.0](https://github.com/OpenAPITools/openapi-generator/releases/tag/v7.25.0) (latest stable release)                                                    | 24.08.2026   | Minor release with breaking changes (with fallback) |
...
JAR location: `https://repo1.maven.org/maven2/org/openapitools/openapi-generator-cli/7.25.0/openapi-generator-cli-7.25.0.jar`
...
```sh
openapi-generator-cli version-manager set 7.25.0
```
...
<!-- RELEASE_VERSION -->
You can also download the JAR (latest release) directly from [maven.org](https://repo1.maven.org/maven2/org/openapitools/openapi-generator-cli/7.25.0/openapi-generator-cli-7.25.0.jar)
<!-- /RELEASE_VERSION -->
...
| Python                | @cbornet (2017/09) @tomplus (2018/10) @krjakbrjak (2023/02) @fa0311 (2023/10) |
...
| TypeScript            | @TiFu (2017/07) @taxpon (2017/07) @sebastianhaas (2017/07) @kenisteward (2017/07) @Vrolijkx (2017/09) @macjohnny (2018/01) @topce (2018/10) @akehir (2019/07) @petejohansonxo (2019/11) @amakhrov (2020/02) @davidgamero (2022/03) @mkusaka (2022/04) @joscha (2024/10) @KannaKim (2026/07) |
