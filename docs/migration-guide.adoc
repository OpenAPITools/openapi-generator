...
It is written to help migration by indicating the most impacting changes.
...
A new option is introduced to specify the prefix of boolean getters: `booleanGetterPrefix`.
Possible values:
