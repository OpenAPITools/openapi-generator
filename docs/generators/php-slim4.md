...
|dependencyContainer|Slim uses an optional dependency container to prepare, manage, and inject application dependencies. Slim supports containers that implement PSR-11 like PHP-DI. Ref: http://www.slimframework.com/docs/v4/concepts/di.html|<dl><dt>**php-di**</dt><dd>Generate Slim with php-di/php-di dependency container. https://php-di.org</dd><dt>**none**</dt><dd>Generate Slim without dependency container</dd></dl>|php-di|
