...
|legacyAdditionalPropertiesBehavior|If false, the 'additionalProperties' implementation is compliant with the OAS and JSON schema specifications. This is the default value.
