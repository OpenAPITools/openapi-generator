...
|apiPackage|Package name of generated API classes.| |{{packageName}}.apis|
|modelPackage|Package name of generated model classes.| |{{packageName}}.models|
|packageName|Package name of all classes.| |org.openapitools.client|
