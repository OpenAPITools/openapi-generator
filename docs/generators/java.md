...
|oapiAnnotationLib|Choose the OpenAPI annotation library to use.|<dl><dt>**swagger2**</dt><dd>Use Swagger 2 annotation library</dd><dt>**none**</dt><dd>Don't use any annotation library</dd></dl>|swagger2|
