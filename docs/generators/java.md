...
|exposeResponseHeaders|Property used by feign client to expose the response headers on the API. It wraps the response type on a class that contains both the headers and the deserialized body.| |false|
