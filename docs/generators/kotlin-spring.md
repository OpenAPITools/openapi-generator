...
|nullableRequiredForBeanValidation|Generate required model properties as nullable constructor parameters so Bean Validation can catch missing values instead of Jackson throwing MissingKotlinParameterException.| |false|
