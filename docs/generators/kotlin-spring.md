...
|generateGenericResponseEntity|Select when to use ResponseEntity&lt;*&gt; for generated API methods. Ignored when useResponseEntity=false.|<dl><dt>**NEVER**</dt><dd>Keep the declared response body type.</dd><dt>**ALWAYS**</dt><dd>Use ResponseEntity&lt;*&gt; for all generated API methods.</dd></dl>|NEVER|
