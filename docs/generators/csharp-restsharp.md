---
title: Documentation for the csharp-restsharp Generator
---
...
| -------- | ----- | ----- |
| generator name | csharp-restsharp | pass this to the generate command after -g |
