...
|artifactId|artifactId in generated pom.xml. This also becomes part of the generated library's filename| |caskgen|
...
|gitRepoId|Git repo ID, e.g. openapi-generator.| |caskgen|
|gitUserId|Git user ID, e.g. openapitools.| |aaron|
