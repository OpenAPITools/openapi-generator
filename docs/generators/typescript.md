...
|importFileExtension|The file extension to use for imports. Setting a value may be required when using Node.js ECMAScript module resolution.| |'.ts' for Deno, blank otherwise|
