---
title: Config Options for java-micronaut-server
sidebar_label: java-micronaut-server
---
...
|controllerPackage|The package in which controllers will be generated| |org.openapitools.controller|
