...
|initRequiredVars|If set to false the original beaviour of required vars will be used and if set to true the older beaviour of required vars will be used (behaviour prior to PR #8802)| |false|
