...
|serializationLibrary|Serialization library, by default uses custom generator|<dl><dt>**custom**</dt><dd>Use custom generator as serialization library</dd><dt>**json_serializable**</dt><dd>Use json_serializable as serialization library</dd></dl>|custom|
