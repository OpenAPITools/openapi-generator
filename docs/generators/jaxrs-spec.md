...
|jackson|Whether to generate Jackson annotations.| |true|
...
|useTypesafeResponses|Generates typesafe responses when used together with option interfaceOnly.| |false|
