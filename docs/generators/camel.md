...
|camelRestComponent|name of the Camel component to use as the REST consumer|netty-http, jetty, platform-http, servlet, undertow|servlet|
|camelRestBindingMode|binding mode to be used by the REST consumer|auto, off, json, xml, json_xml|auto|
...
|interfaceOnly|Whether to generate only API Rest Definitions stubs without the server files.| |false|
...
|oas3|Use OAS 3 Swagger annotations instead of OAS 2 annotations| |true|
