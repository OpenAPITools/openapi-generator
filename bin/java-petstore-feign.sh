...
mkdir -p samples/client/petstore/java/feign/src/test/java/org/openapitools/client && cp CI/samples.ci/client/petstore/java/test-manual/common/StringUtilTest.java $_