...
cp CI/samples.ci/client/petstore/java/test/StringUtilTest.java  samples/client/petstore/java/jersey2-java8/src/test/java/org/openapitools/client/StringUtilTest.java