...
mkdir -p samples/client/petstore/java/jersey2-java8/src/test/java/org/openapitools/client && cp CI/samples.ci/client/petstore/java/test-manual/common/StringUtilTest.java $_
mkdir -p samples/client/petstore/java/jersey2-java8/src/test/java/org/openapitools/client && cp CI/samples.ci/client/petstore/java/test-manual/jersey2/ApiClientTest.java $_
mkdir -p samples/client/petstore/java/jersey2-java8/src/test/java/org/openapitools/client && cp CI/samples.ci/client/petstore/java/test-manual/common/ConfigurationTest.java $_
