set executable="./modules/swagger-codegen-cli/target/swagger-codegen-cli.jar"

If Not Exist %executable% (
  mvn clean package
)

set JAVA_OPTS="%JAVA_OPST% -XX:MaxPermSize=256M -Xmx1024M -DloggerPath=conf/log4j.properties"
