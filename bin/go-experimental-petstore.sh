...
ags="generate -t modules/openapi-generator/src/main/resources/mustache/$GENERATOR -i $SPEC -g $GENERATOR -o $STUB_DIR --additional-properties packageName=petstore $@"
