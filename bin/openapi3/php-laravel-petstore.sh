...
ags="generate -t $SCRIPT_DIR/../../modules/openapi-generator/src/main/resources/mustache/php-laravel -i $SCRIPT_DIR/../../modules/openapi-generator/src/test/resources/3_0/petstore.yaml -g php-laravel -o $TARGET_DIR $@"
