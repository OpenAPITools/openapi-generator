...
ags="generate -t $SCRIPT_DIR/../../modules/openapi-generator/src/main/resources/mustache/php-symfony -i $SCRIPT_DIR/../../modules/openapi-generator/src/test/resources/3_0/petstore.yaml -g php-symfony -o $TARGET_DIR $@"
