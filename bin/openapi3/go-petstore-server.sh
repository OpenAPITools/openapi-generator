...
ags="generate -t modules/openapi-generator/src/main/resources/mustache/go-server -i $SPEC -g $GENERATOR -o $STUB_DIR --additional-properties packageName=petstoreserver,hideGenerationTimestamp=true $@"
