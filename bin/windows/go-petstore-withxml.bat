...
set ags=generate -t modules\openapi-generator\src\main\resources\mustache\go -i %SPEC% -g %GENERATOR% -o %STUB_DIR% --additional-properties packageName=petstore,withXml=true
