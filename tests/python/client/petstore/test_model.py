...
from petstore_client import InnerDictWithProperty
...
class ModelTests(unittest.TestCase):
    ...
    def test_cat(self):
        self.cat = petstore_client.Cat(className="cat")
    ...
    def test_oneof_schema_2_validator(self):
        new_color = petstore_client.Color()
    ...
    def test_oneOf_array_of_integers(self):
        ...
        # test from_josn
        json_str = '[12,34,56]'
        p = petstore_client.Color.from_json(json_str)
        self.assertEqual(p.actual_instance, [12, 34, 56])

        try:
            p = petstore_client.Color.from_json('[2342112,0,0,0]')
        except ValueError as e:
            self.assertTrue("Input should be less than or equal to 255" in str(e))
        ...
        # test nullable
        p = petstore_client.Color.from_json(None)
        self.assertEqual(p.actual_instance, None)

    def test_oneof_enum_string(self):
        enum_string1 = petstore_client.EnumString1('a')
        # test from_json
        oneof_enum = petstore_client.OneOfEnumString.from_json('"a"')
        # test from_dict
        oneof_enum = petstore_client.OneOfEnumString.from_dict("a")
        nested = petstore_client.WithNestedOneOf(size = 1, nested_oneof_enum_string = oneof_enum)
        # test to_json
        self.assertEqual(nested.to_json(), '{"size": 1, "nested_oneof_enum_string": "a"}')
        # test from_json
        nested = petstore_client.WithNestedOneOf.from_json('{"size": 1, "nested_oneof_enum_string": "c"}')
        self.assertEqual(nested.to_json(), '{"size": 1, "nested_oneof_enum_string": "c"}')
        # test from_dict
        nested = petstore_client.WithNestedOneOf.from_dict({"size": 1, "nested_oneof_enum_string": "c"})
        # test to_dict
        self.assertEqual(nested.to_dict(), {"size": 1, "nested_oneof_enum_string": "c"})
        # invalid enum value
        try:
            nested2 = petstore_client.WithNestedOneOf.from_json('{"size": 1, "nested_oneof_enum_string": "e"}')
        except ValueError as e:
            self.assertTrue("'e' is not a valid EnumString1, 'e' is not a valid EnumString" in str(e))

        # test the constructor
        enum_string1 = petstore_client.EnumString1('a')
        constructor1 = petstore_client.OneOfEnumString(actual_instance=enum_string1)
        self.assertEqual(constructor1.actual_instance, enum_string1)
        constructor2 = petstore_client.OneOfEnumString(enum_string1)
        self.assertEqual(constructor2.actual_instance, enum_string1)
        constructor3 = petstore_client.OneOfEnumString()
        self.assertEqual(constructor3.actual_instance, None)

    def test_anyOf_array_of_integers(self):
        # test new Color 
        new_color = petstore_client.AnyOfColor()
        self.assertEqual("null", new_color.to_json())
        self.assertEqual(None, new_color.actual_instance)
        ...
        # test from_josn
        json_str = '[12,34,56]'
        p = petstore_client.AnyOfColor.from_json(json_str)
        self.assertEqual(p.actual_instance, [12, 34,56])

        try:
            p = petstore_client.AnyOfColor.from_json('[2342112,0,0,0]')
        except ValueError as e:
            self.assertIn("Input should be less than or equal to 255", str(e))

    def test_oneOf(self):
        # test new Pig
        bp = petstore_client.BasquePig.from_dict({"className": "BasquePig", "color": "red"})
        new_pig = petstore_client.Pig()
        self.assertEqual("null", new_pig.to_json())
        self.assertEqual(None, new_pig.actual_instance)
        new_pig2 = petstore_client.Pig(actual_instance=bp)
        self.assertEqual('{"className": "BasquePig", "color": "red"}', new_pig2.to_json())
        new_pig3 = petstore_client.Pig(bp)
        self.assertEqual('{"className": "BasquePig", "color": "red"}', new_pig3.to_json())
        try:
            new_pig4 = petstore_client.Pig(bp, actual_instance=bp)
        except ValueError as e:
            self.assertTrue("If position argument is used, keyword argument cannot be used.", str(e))
        try:
            new_pig5 = petstore_client.Pig(bp, bp)
        except ValueError as e:
        ...
        p = petstore_client.Pig.from_json(json_str)
        self.assertIsInstance(p.actual_instance, petstore_client.BasquePig)

        # test from_dict
        json_dict = {"className": "BasquePig", "color": "red"}
        p = petstore_client.Pig.from_dict(json_dict)
        self.assertIsInstance(p.actual_instance, petstore_client.BasquePig)

        # test init
        basque_pig = p.actual_instance
        pig2 = petstore_client.Pig(actual_instance=basque_pig)
        self.assertIsInstance(pig2.actual_instance, petstore_client.BasquePig)

        # test failed init
        try:
            pig3 = petstore_client.Pig(actual_instance="123")
        ...
        # failure
        try:
            p2 = petstore_client.Pig.from_json("1")
            self.assertTrue(False)  # this line shouldn't execute
        ...
        nested = petstore_client.WithNestedOneOf(size = 1, nested_pig = p)
        self.assertEqual(nested.to_json(), '{"size": 1, "nested_pig": {"className": "BasquePig", "color": "red"}}')

        nested_json = nested.to_json()
        nested2 = petstore_client.WithNestedOneOf.from_json(nested_json)
        self.assertEqual(nested2.to_json(), nested_json)

    def test_anyOf(self):
        # test new AnyOfPig
        new_anypig = petstore_client.AnyOfPig()
        self.assertEqual("null", new_anypig.to_json())
        self.assertEqual(None, new_anypig.actual_instance)

        # test from_json
        json_str = '{"className": "BasquePig", "color": "red"}'
        p = petstore_client.AnyOfPig.from_json(json_str)
        self.assertIsInstance(p.actual_instance, petstore_client.BasquePig)

        # test from_dict
        json_dict = {"className": "BasquePig", "color": "red"}
        p = petstore_client.AnyOfPig.from_dict(json_dict)
        self.assertIsInstance(p.actual_instance, petstore_client.BasquePig)

        # test init
        basque_pig = p.actual_instance
        pig2 = petstore_client.AnyOfPig(actual_instance=basque_pig)
        self.assertIsInstance(pig2.actual_instance, petstore_client.BasquePig)

        # test failed init
        try:
            pig3 = petstore_client.AnyOfPig(actual_instance="123")
            self.assertTrue(False)  # this line shouldn't execute
        except ValueError as e:
        ...
        # failure
        try:
            p2 = petstore_client.AnyOfPig.from_json("1")
            self.assertTrue(False)  # this line shouldn't execute
        except ValueError as e:
    ...
    def test_list(self):
        ...
        kw = {"123-list": 123}
        try:
            l3 = petstore_client.ListClass(**kw)
            self.assertTrue(False)  # this line shouldn't execute
            breakpoint()
        except ValueError as e:
            #   var_123_list
        ...
        kw = {"123-list": "bulldog"}
        l = petstore_client.ListClass(**kw)
        self.assertEqual(l.to_json(), '{"123-list": "bulldog"}')
        self.assertEqual(l.to_dict(), {'123-list': 'bulldog'})
        l2 = petstore_client.ListClass.from_json(l.to_json())
        self.assertEqual(l2.var_123_list, 'bulldog')

        self.assertTrue(isinstance(l2, petstore_client.ListClass))

    def test_enum_ref_property(self):
        # test enum ref property
        # test to_json
        d = petstore_client.OuterObjectWithEnumProperty(value=petstore_client.OuterEnumInteger.NUMBER_1)
        self.assertEqual(d.to_json(), '{"value": 1}')
        d2 = petstore_client.OuterObjectWithEnumProperty(value=petstore_client.OuterEnumInteger.NUMBER_1, str_value=petstore_client.OuterEnum.DELIVERED)
        self.assertEqual(d2.to_json(), '{"str_value": "delivered", "value": 1}')
        # test from_json (round trip)
        d3 = petstore_client.OuterObjectWithEnumProperty.from_json(d2.to_json())
        self.assertEqual(d3.str_value, petstore_client.OuterEnum.DELIVERED)
        self.assertEqual(d3.value, petstore_client.OuterEnumInteger.NUMBER_1)
        self.assertEqual(d3.to_json(), '{"str_value": "delivered", "value": 1}')
        d4 = petstore_client.OuterObjectWithEnumProperty(value=petstore_client.OuterEnumInteger.NUMBER_1, str_value=None)
        self.assertEqual(d4.to_json(), '{"value": 1, "str_value": null}')
        d5 = petstore_client.OuterObjectWithEnumProperty(value=petstore_client.OuterEnumInteger.NUMBER_1)
    ...
    def test_valdiator(self):
        ...
        a = petstore_client.FormatTest(number=123.45, byte=bytes("string", 'utf-8'), date="2013-09-17", password="testing09876")
        try:
    ...
    def test_constraints(self):
        ...
        color = petstore_client.Color(oneof_schema_1_validator=rgb)
        self.assertEqual(rgb, color.oneof_schema_1_validator)

        color = petstore_client.Color(oneof_schema_2_validator=rgba)
        self.assertEqual(rgba, color.oneof_schema_2_validator)

        color = petstore_client.Color(oneof_schema_3_validator=hex_color)
        self.assertEqual(hex_color, color.oneof_schema_3_validator)

        try:
            petstore_client.Color(oneof_schema_1_validator=rgba)
            self.fail("invalid validation")
        except ValidationError as e:
            self.assertIn("List should have at most 3 items after validation, not 4", str(e))

        try:
            petstore_client.Color(oneof_schema_2_validator=rgb)
            self.fail("invalid validation")
        except ValidationError as e:
            self.assertIn("List should have at least 4 items after validation, not 3", str(e))

        try:
            petstore_client.Color(oneof_schema_3_validator="too long string")
            self.fail("invalid validation")
        except ValidationError as e:
            self.assertIn("String should have at most 7 characters", str(e))

    def test_object_id(self):
        pet_ap = petstore_client.Pet(name="test name", photoUrls=["string"])
        pet_ap2 = petstore_client.Pet(name="test name", photoUrls=["string"])
        self.assertNotEqual(id(pet_ap), id(pet_ap2))

        pet_ap3 = petstore_client.Pet.from_dict(pet_ap.to_dict())
        pet_ap4 = petstore_client.Pet.from_dict(pet_ap.to_dict())
    ...
    def test_additional_properties(self):
        ...
        pet_ap2 = petstore_client.Pet.from_dict(pet_ap_dict)
    ...
    def test_nullable(self):
        h = petstore_client.HealthCheckResult(NullableMessage="Not none")
    ...
    def test_inline_enum_default(self):
        enum_test = petstore_client.EnumTest(enum_string_required="lower")
    ...
    def test_object_with_optional_dict(self):
        ...
        a = petstore_client.ParentWithOptionalDict.from_dict({})
        self.assertFalse(a is None)

        b = petstore_client.ParentWithOptionalDict.from_dict({"optionalDict": {"key": {"aProperty": {"a": "b"}}}})
    ...
    def test_object_with_dict_of_dict_of_object(self):
        ...
        a = petstore_client.Parent.from_dict(d)
        self.assertEqual(a.to_dict(), d)

    def test_eum_class(self):
        a = petstore_client.EnumClass("-efg")
    ...
    def test_map_of_array_of_model(self):
        ...
        a2 = petstore_client.MapOfArrayOfModel.from_dict(a.to_dict())
        self.assertEqual(a.to_dict(), a2.to_dict())

    def test_array_of_array_of_model(self):
        a = petstore_client.ArrayOfArrayOfModel()
        t = petstore_client.Tag(id=123, name="tag name")
        ...
        a2 = petstore_client.ArrayOfArrayOfModel.from_dict(a.to_dict())
        self.assertEqual(a.to_dict(), a2.to_dict())

    def test_object_with_additional_properties(self):
        a = petstore_client.ObjectToTestAdditionalProperties()
...
class TestUnnamedDictWithAdditionalStringListProperties:
    def test_empty_dict(self):
        a = petstore_client.UnnamedDictWithAdditionalStringListProperties(dict_property={})
        assert a.to_dict() == {"dictProperty": {}}

    def test_empty_list(self):
        a = petstore_client.UnnamedDictWithAdditionalStringListProperties(dict_property={"b": []})
        assert a.to_dict() == {"dictProperty": {"b": []}}

    def test_single_string_item(self):
        a = petstore_client.UnnamedDictWithAdditionalStringListProperties(dict_property={"b": ["c"]})
        assert a.to_dict() == {"dictProperty": {"b": ["c"]}}

class TestUnnamedDictWithAdditionalModelListProperties:
    def test_empty_dict(self):
        a = petstore_client.UnnamedDictWithAdditionalModelListProperties(dict_property={})
        assert a.to_dict() == {"dictProperty": {}}

    def test_empty_list(self):
        a = petstore_client.UnnamedDictWithAdditionalModelListProperties(dict_property={"b": []})
        assert a.to_dict() == {"dictProperty": {"b": []}}

    def test_single_string_item(self):
        value = {"b": [petstore_client.CreatureInfo(name="creature_name")]}
        a = petstore_client.UnnamedDictWithAdditionalModelListProperties(dict_property=value)
