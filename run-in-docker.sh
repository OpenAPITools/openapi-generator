...
docker run --rm -it \
        ...
        -e MAVEN_OPTS="-Dmaven.compile.fork=true -Dmaven.test.skip=true -Dmaven.javadoc.skip=true -Dhttps.protocols=TLSv1.2 -Dmaven.repo.local=/var/maven/.m2/repository -Dorg.slf4j.simpleLogger.log.org.apache.maven.cli.transfer.Slf4jMavenTransferListener=WARN -Dorg.slf4j.simpleLogger.showDateTime=true -Djava.awt.headless=true -Djacoco.skip=true" \
        -u "$(id -u):$(id -g)" \
        -v "${PWD}:/gen" \
