...
open class HeaderApiStubs(protected val objectMapper: ObjectMapper) {
    ...
    fun testHeaderIntegerBooleanStringEnums(configurer: MappingBuilder.() -> MappingBuilder = { this }): TestHeaderIntegerBooleanStringEnumsStubBuilder =
        TestHeaderIntegerBooleanStringEnumsStubBuilder(get("/header/integer/boolean/string/enums")
            .configurer()
        )

    inner class TestHeaderIntegerBooleanStringEnumsStubBuilder(private val stub: MappingBuilder) {
