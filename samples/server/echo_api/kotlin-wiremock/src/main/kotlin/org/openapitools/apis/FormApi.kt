...
open class FormApiStubs(protected val objectMapper: ObjectMapper) {

    fun testFormIntegerBooleanString(configurer: MappingBuilder.() -> MappingBuilder = { this }): TestFormIntegerBooleanStringStubBuilder =
        TestFormIntegerBooleanStringStubBuilder(post("/form/integer/boolean/string")
            .configurer()
        )

    inner class TestFormIntegerBooleanStringStubBuilder(private val stub: MappingBuilder) {
    ...
    fun testFormOneof(configurer: MappingBuilder.() -> MappingBuilder = { this }): TestFormOneofStubBuilder =
        TestFormOneofStubBuilder(post("/form/oneof")
            .configurer()
        )

    inner class TestFormOneofStubBuilder(private val stub: MappingBuilder) {
