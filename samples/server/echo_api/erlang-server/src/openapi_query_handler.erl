...
allowed_methods(Req, State = #state{operation_id = 'TestEnumRefString'}) ->
    {[<<"GET">>], Req, State};

allowed_methods(Req, State = #state{operation_id = 'TestQueryDatetimeDateString'}) ->
    {[<<"GET">>], Req, State};

allowed_methods(Req, State = #state{operation_id = 'TestQueryIntegerBooleanString'}) ->
    {[<<"GET">>], Req, State};

allowed_methods(Req, State = #state{operation_id = 'TestQueryStyleDeepObjectExplodeTrueObject'}) ->
    {[<<"GET">>], Req, State};

allowed_methods(Req, State = #state{operation_id = 'TestQueryStyleDeepObjectExplodeTrueObjectAllOf'}) ->
    {[<<"GET">>], Req, State};

allowed_methods(Req, State = #state{operation_id = 'TestQueryStyleFormExplodeFalseArrayInteger'}) ->
    {[<<"GET">>], Req, State};

allowed_methods(Req, State = #state{operation_id = 'TestQueryStyleFormExplodeFalseArrayString'}) ->
    {[<<"GET">>], Req, State};

allowed_methods(Req, State = #state{operation_id = 'TestQueryStyleFormExplodeTrueArrayString'}) ->
    {[<<"GET">>], Req, State};

allowed_methods(Req, State = #state{operation_id = 'TestQueryStyleFormExplodeTrueObject'}) ->
    {[<<"GET">>], Req, State};

allowed_methods(Req, State = #state{operation_id = 'TestQueryStyleFormExplodeTrueObjectAllOf'}) ->
    {[<<"GET">>], Req, State};
...
valid_content_headers(Req0, #state{operation_id = 'TestEnumRefString'} = State) ->
    Headers = [],
    {Result, Req} = validate_headers(Headers, Req0),
    {Result, Req, State};

valid_content_headers(Req0, #state{operation_id = 'TestQueryDatetimeDateString'} = State) ->
    Headers = [],
    {Result, Req} = validate_headers(Headers, Req0),
    {Result, Req, State};

valid_content_headers(Req0, #state{operation_id = 'TestQueryIntegerBooleanString'} = State) ->
    Headers = [],
    {Result, Req} = validate_headers(Headers, Req0),
    {Result, Req, State};

valid_content_headers(Req0, #state{operation_id = 'TestQueryStyleDeepObjectExplodeTrueObject'} = State) ->
    Headers = [],
    {Result, Req} = validate_headers(Headers, Req0),
    {Result, Req, State};

valid_content_headers(Req0, #state{operation_id = 'TestQueryStyleDeepObjectExplodeTrueObjectAllOf'} = State) ->
    Headers = [],
    {Result, Req} = validate_headers(Headers, Req0),
    {Result, Req, State};

valid_content_headers(Req0, #state{operation_id = 'TestQueryStyleFormExplodeFalseArrayInteger'} = State) ->
    Headers = [],
    {Result, Req} = validate_headers(Headers, Req0),
    {Result, Req, State};

valid_content_headers(Req0, #state{operation_id = 'TestQueryStyleFormExplodeFalseArrayString'} = State) ->
    Headers = [],
    {Result, Req} = validate_headers(Headers, Req0),
    {Result, Req, State};

valid_content_headers(Req0, #state{operation_id = 'TestQueryStyleFormExplodeTrueArrayString'} = State) ->
    Headers = [],
    {Result, Req} = validate_headers(Headers, Req0),
    {Result, Req, State};

valid_content_headers(Req0, #state{operation_id = 'TestQueryStyleFormExplodeTrueObject'} = State) ->
    Headers = [],
    {Result, Req} = validate_headers(Headers, Req0),
    {Result, Req, State};

valid_content_headers(Req0, #state{operation_id = 'TestQueryStyleFormExplodeTrueObjectAllOf'} = State) ->
    Headers = [],
    {Result, Req} = validate_headers(Headers, Req0),
    {Result, Req, State};
