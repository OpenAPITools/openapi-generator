...
allowed_methods(Req, State = #state{operation_id = 'TestsPathString{pathString}Integer{pathInteger}{enumNonrefStringPath}{enumRefStringPath}'}) ->
    {[<<"GET">>], Req, State};
...
valid_content_headers(Req0, #state{operation_id = 'TestsPathString{pathString}Integer{pathInteger}{enumNonrefStringPath}{enumRefStringPath}'} = State) ->
    Headers = [],
