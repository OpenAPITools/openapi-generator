...
allowed_methods(Req, State = #state{operation_id = 'TestHeaderIntegerBooleanStringEnums'}) ->
    {[<<"GET">>], Req, State};
...
valid_content_headers(Req0, #state{operation_id = 'TestHeaderIntegerBooleanStringEnums'} = State) ->
    Headers = ["integer_header","boolean_header","string_header","enum_nonref_string_header","enum_ref_string_header"],
