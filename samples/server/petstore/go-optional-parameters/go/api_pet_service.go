...
func (s *PetApiService) FindPetsByProperties(ctx context.Context, isAvailable bool, tags []string) (ImplResponse, error) {
	// TODO - update FindPetsByProperties with the required logic for this service method.
	// Add api_pet_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("FindPetsByProperties method not implemented")
}
