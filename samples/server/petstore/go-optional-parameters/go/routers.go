...
// parseStringArrayParameter parses a string parameter containing array of values to []string.
func parseStringArrayParameter(param, delim string, required bool) ([]string, error) {
	if param == "" {
		if required {
			return nil, errors.New(errMsgRequiredMissing)
		}
	...
	return strings.Split(param, delim), nil
}
