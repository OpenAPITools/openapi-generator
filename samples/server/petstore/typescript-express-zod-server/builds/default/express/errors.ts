...
export function isMethodNotAllowed(error: any): error is MethodNotAllowedError {
  return typeof error === "object" && error !== null && error.code === "METHOD_NOT_ALLOWED";
}
...
export function isValidationErrors(error: any): error is ValidationErrorsError {
  return typeof error === "object" && error !== null && error.code === "VALIDATION_ERRORS";
}
...
export function isHandledException(error: any): error is HandledExceptionError {
  return typeof error === "object" && error !== null && error.code === "HANDLED_EXCEPTION";
}
...
export function isUnhandledException(
  ...
  return typeof error === "object" && error !== null && error.code === "UNHANDLED_EXCEPTION";
}
