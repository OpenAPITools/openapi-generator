...
pub mod responses {
    ...
    lazy_static! {
        /// Create Mime objects for the response content types for 123Test@$%SpecialTags
        pub static ref 123_TEST@__%SPECIAL_TAGS_SUCCESSFUL_OPERATION: Mime = "application/json".parse().unwrap();
    }
    ...
    lazy_static! {
        /// Create Mime objects for the response content types for TestMixedPropertiesAndAdditionalProperties
        pub static ref TEST_MIXED_PROPERTIES_AND_ADDITIONAL_PROPERTIES_SUCCESSFUL_OPERATION: Mime = "*/*".parse().unwrap();
    }
    ...
    lazy_static! {
        /// Create Mime objects for the response content types for UploadFileWithRequiredFile
        pub static ref UPLOAD_FILE_WITH_REQUIRED_FILE_SUCCESSFUL_OPERATION: Mime = "application/json".parse().unwrap();
    }
...
pub mod requests {
    ...
    lazy_static! {
        /// Create Mime objects for the request content types for 123Test@$%SpecialTags
        pub static ref 123_TEST@__%SPECIAL_TAGS: Mime = "application/json".parse().unwrap();
    }

    lazy_static! {
        /// Create Mime objects for the request content types for CreateXmlItem
        pub static ref CREATE_XML_ITEM: Mime = "application/xml".parse().unwrap();
    }
    ...
    lazy_static! {
        /// Create Mime objects for the request content types for TestBodyWithFileSchema
        pub static ref TEST_BODY_WITH_FILE_SCHEMA: Mime = "application/json".parse().unwrap();
    }
    ...
    lazy_static! {
        /// Create Mime objects for the request content types for TestMixedPropertiesAndAdditionalProperties
        pub static ref TEST_MIXED_PROPERTIES_AND_ADDITIONAL_PROPERTIES: Mime = "application/json".parse().unwrap();
    }
    ...
    lazy_static! {
        /// Create Mime objects for the request content types for UploadFileWithRequiredFile
        pub static ref UPLOAD_FILE_WITH_REQUIRED_FILE: Mime = "multipart/form-data".parse().unwrap();
    }
