...
pub struct AdditionalPropertiesAnyType {
    #[serde(rename = "name")]
...
impl AdditionalPropertiesAnyType {
    pub fn new() -> AdditionalPropertiesAnyType {
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[cfg_attr(feature = "conversion", derive(LabelledGeneric))]
pub struct AdditionalPropertiesArray {
    #[serde(rename = "name")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub name: Option<String>,
...
impl AdditionalPropertiesArray {
    pub fn new() -> AdditionalPropertiesArray {
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[cfg_attr(feature = "conversion", derive(LabelledGeneric))]
pub struct AdditionalPropertiesBoolean {
    #[serde(rename = "name")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub name: Option<String>,
...
impl AdditionalPropertiesBoolean {
    pub fn new() -> AdditionalPropertiesBoolean {
...
pub struct AdditionalPropertiesClass {
    #[serde(rename = "map_string")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub map_string: Option<HashMap<String, String>>,

    #[serde(rename = "map_number")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub map_number: Option<HashMap<String, f64>>,

    #[serde(rename = "map_integer")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub map_integer: Option<HashMap<String, i32>>,

    #[serde(rename = "map_boolean")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub map_boolean: Option<HashMap<String, bool>>,

    #[serde(rename = "map_array_integer")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub map_array_integer: Option<HashMap<String, Vec<i32>>>,

    #[serde(rename = "map_array_anytype")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub map_array_anytype: Option<HashMap<String, Vec<object>>>,

    #[serde(rename = "map_map_string")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub map_map_string: Option<HashMap<String, HashMap<String, String>>>,

    #[serde(rename = "map_map_anytype")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub map_map_anytype: Option<HashMap<String, HashMap<String, object>>>,

    #[serde(rename = "anytype_1")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub anytype_1: Option<Object>,

    #[serde(rename = "anytype_2")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub anytype_2: Option<Object>,

    #[serde(rename = "anytype_3")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub anytype_3: Option<Object>,
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[cfg_attr(feature = "conversion", derive(LabelledGeneric))]
pub struct AdditionalPropertiesInteger {
    #[serde(rename = "name")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub name: Option<String>,
...
impl AdditionalPropertiesInteger {
    pub fn new() -> AdditionalPropertiesInteger {
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[cfg_attr(feature = "conversion", derive(LabelledGeneric))]
pub struct AdditionalPropertiesNumber {
    #[serde(rename = "name")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub name: Option<String>,
...
impl AdditionalPropertiesNumber {
    pub fn new() -> AdditionalPropertiesNumber {
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[cfg_attr(feature = "conversion", derive(LabelledGeneric))]
pub struct AdditionalPropertiesString {
    #[serde(rename = "name")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub name: Option<String>,
...
impl AdditionalPropertiesString {
    pub fn new() -> AdditionalPropertiesString {
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[cfg_attr(feature = "conversion", derive(LabelledGeneric))]
pub struct FileSchemaTestClass {
    #[serde(rename = "file")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub file: Option<models::File>,
...
impl FileSchemaTestClass {
    pub fn new() -> FileSchemaTestClass {
        FileSchemaTestClass {
            file: None,
            files: None,
        }
...
pub struct MapTest {
    ...
    #[serde(rename = "direct_map")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub direct_map: Option<HashMap<String, bool>>,

    #[serde(rename = "indirect_map")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub indirect_map: Option<HashMap<String, bool>>,
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[cfg_attr(feature = "conversion", derive(LabelledGeneric))]
pub struct TypeHolderDefault {
    #[serde(rename = "string_item")]
    pub string_item: String,

    #[serde(rename = "number_item")]
    pub number_item: f64,

    #[serde(rename = "integer_item")]
    pub integer_item: isize,

    #[serde(rename = "bool_item")]
    pub bool_item: bool,

    #[serde(rename = "array_item")]
    pub array_item: Vec<i32>,

}

impl TypeHolderDefault {
    pub fn new(number_item: f64, integer_item: isize, array_item: Vec<i32>, ) -> TypeHolderDefault {
        TypeHolderDefault {
            string_item: "what".to_string(),
...
impl TypeHolderExample {
    pub fn new(string_item: String, number_item: f64, float_item: f32, integer_item: isize, bool_item: bool, array_item: Vec<i32>, ) -> TypeHolderExample {
        TypeHolderExample {
...
#[cfg_attr(feature = "conversion", derive(LabelledGeneric))]
pub struct XmlItem {
    #[serde(rename = "attribute_string")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub attribute_string: Option<String>,

    #[serde(rename = "attribute_number")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub attribute_number: Option<f64>,

    #[serde(rename = "attribute_integer")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub attribute_integer: Option<isize>,

    #[serde(rename = "attribute_boolean")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub attribute_boolean: Option<bool>,

    #[serde(rename = "wrapped_array")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub wrapped_array: Option<Vec<i32>>,

    #[serde(rename = "name_string")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub name_string: Option<String>,

    #[serde(rename = "name_number")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub name_number: Option<f64>,

    #[serde(rename = "name_integer")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub name_integer: Option<isize>,

    #[serde(rename = "name_boolean")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub name_boolean: Option<bool>,

    #[serde(rename = "name_array")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub name_array: Option<Vec<i32>>,

    #[serde(rename = "name_wrapped_array")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub name_wrapped_array: Option<Vec<i32>>,

    #[serde(rename = "prefix_string")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub prefix_string: Option<String>,

    #[serde(rename = "prefix_number")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub prefix_number: Option<f64>,

    #[serde(rename = "prefix_integer")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub prefix_integer: Option<isize>,

    #[serde(rename = "prefix_boolean")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub prefix_boolean: Option<bool>,

    #[serde(rename = "prefix_array")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub prefix_array: Option<Vec<i32>>,

    #[serde(rename = "prefix_wrapped_array")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub prefix_wrapped_array: Option<Vec<i32>>,

    #[serde(rename = "namespace_string")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub namespace_string: Option<String>,

    #[serde(rename = "namespace_number")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub namespace_number: Option<f64>,

    #[serde(rename = "namespace_integer")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub namespace_integer: Option<isize>,

    #[serde(rename = "namespace_boolean")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub namespace_boolean: Option<bool>,

    #[serde(rename = "namespace_array")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub namespace_array: Option<Vec<i32>>,

    #[serde(rename = "namespace_wrapped_array")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub namespace_wrapped_array: Option<Vec<i32>>,

    #[serde(rename = "prefix_ns_string")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub prefix_ns_string: Option<String>,

    #[serde(rename = "prefix_ns_number")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub prefix_ns_number: Option<f64>,

    #[serde(rename = "prefix_ns_integer")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub prefix_ns_integer: Option<isize>,

    #[serde(rename = "prefix_ns_boolean")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub prefix_ns_boolean: Option<bool>,

    #[serde(rename = "prefix_ns_array")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub prefix_ns_array: Option<Vec<i32>>,

    #[serde(rename = "prefix_ns_wrapped_array")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub prefix_ns_wrapped_array: Option<Vec<i32>>,
...
impl XmlItem {
    pub fn new() -> XmlItem {
        XmlItem {
            ...
            attribute_integer: None,
            attribute_boolean: None,
            wrapped_array: None,
            name_string: None,
            name_number: None,
            name_integer: None,
            name_boolean: None,
            name_array: None,
            name_wrapped_array: None,
            prefix_string: None,
            prefix_number: None,
            prefix_integer: None,
            prefix_boolean: None,
            prefix_array: None,
            prefix_wrapped_array: None,
            namespace_string: None,
            namespace_number: None,
            namespace_integer: None,
            namespace_boolean: None,
            namespace_array: None,
            namespace_wrapped_array: None,
            prefix_ns_string: None,
            prefix_ns_number: None,
            prefix_ns_integer: None,
            prefix_ns_boolean: None,
            prefix_ns_array: None,
            prefix_ns_wrapped_array: None,
        }
    }
}
...
impl XmlItem {
    ...
    #[allow(dead_code)]
    pub const NAMESPACE: &'static str = "http://a.com/schema";
}
