...
pub enum 123Test@$%SpecialTagsResponse {
...
#[derive(Debug, PartialEq)]
pub enum CreateXmlItemResponse {
    /// successful operation
    SuccessfulOperation
}
...
#[derive(Debug, PartialEq)]
pub enum TestBodyWithFileSchemaResponse {
    /// Success
    Success
}
...
#[derive(Debug, PartialEq)]
pub enum TestGroupParametersResponse {
    /// Someting wrong
    SometingWrong
}
...
#[derive(Debug, PartialEq)]
pub enum TestMixedPropertiesAndAdditionalPropertiesResponse {
    /// successful operation
    SuccessfulOperation
    (models::MixedPropertiesAndAdditionalPropertiesClass)
}

#[derive(Debug, PartialEq)]
pub enum TestQueryParameterCollectionFormatResponse {
    /// Success
    Success
}
...
#[derive(Debug, PartialEq)]
pub enum UploadFileWithRequiredFileResponse {
    /// successful operation
    SuccessfulOperation
    (models::ApiResponse)
}
...
pub trait Api<C> {
    ...
    fn 123_test@__%special_tags(&self, body: models::Client, context: &C) -> Box<Future<Item=123Test@$%SpecialTagsResponse, Error=ApiError>>;

    /// creates an XmlItem
    fn create_xml_item(&self, xml_item: models::XmlItem, context: &C) -> Box<Future<Item=CreateXmlItemResponse, Error=ApiError>>;
    ...
    fn test_body_with_file_schema(&self, body: models::FileSchemaTestClass, context: &C) -> Box<Future<Item=TestBodyWithFileSchemaResponse, Error=ApiError>>;
    ...
    fn test_group_parameters(&self, required_string_group: i32, required_boolean_group: bool, required_int64_group: i64, string_group: Option<i32>, boolean_group: Option<bool>, int64_group: Option<i64>, context: &C) -> Box<Future<Item=TestGroupParametersResponse, Error=ApiError>>;
    ...
    fn test_mixed_properties_and_additional_properties(&self, param: models::MixedPropertiesAndAdditionalPropertiesClass, context: &C) -> Box<Future<Item=TestMixedPropertiesAndAdditionalPropertiesResponse, Error=ApiError>>;


    fn test_query_parameter_collection_format(&self, pipe: &Vec<String>, ioutil: &Vec<String>, http: &Vec<String>, url: &Vec<String>, context: &Vec<String>, context: &C) -> Box<Future<Item=TestQueryParameterCollectionFormatResponse, Error=ApiError>>;
    ...
    fn upload_file_with_required_file(&self, pet_id: i64, required_file: swagger::ByteArray, additional_metadata: Option<String>, context: &C) -> Box<Future<Item=UploadFileWithRequiredFileResponse, Error=ApiError>>;
...
pub trait ApiNoContext {
    ...
    /// To test special tags
    fn 123_test@__%special_tags(&self, body: models::Client) -> Box<Future<Item=123Test@$%SpecialTagsResponse, Error=ApiError>>;

    /// creates an XmlItem
    fn create_xml_item(&self, xml_item: models::XmlItem) -> Box<Future<Item=CreateXmlItemResponse, Error=ApiError>>;
    ...
    fn test_body_with_file_schema(&self, body: models::FileSchemaTestClass) -> Box<Future<Item=TestBodyWithFileSchemaResponse, Error=ApiError>>;
    ...
    /// Fake endpoint to test group parameters (optional)
    fn test_group_parameters(&self, required_string_group: i32, required_boolean_group: bool, required_int64_group: i64, string_group: Option<i32>, boolean_group: Option<bool>, int64_group: Option<i64>) -> Box<Future<Item=TestGroupParametersResponse, Error=ApiError>>;
    ...
    /// test mixed properties and additionalProperties
    fn test_mixed_properties_and_additional_properties(&self, param: models::MixedPropertiesAndAdditionalPropertiesClass) -> Box<Future<Item=TestMixedPropertiesAndAdditionalPropertiesResponse, Error=ApiError>>;


    fn test_query_parameter_collection_format(&self, pipe: &Vec<String>, ioutil: &Vec<String>, http: &Vec<String>, url: &Vec<String>, context: &Vec<String>) -> Box<Future<Item=TestQueryParameterCollectionFormatResponse, Error=ApiError>>;
    ...
    /// uploads an image (required)
    fn upload_file_with_required_file(&self, pet_id: i64, required_file: swagger::ByteArray, additional_metadata: Option<String>) -> Box<Future<Item=UploadFileWithRequiredFileResponse, Error=ApiError>>;
...
impl<'a, T: Api<C>, C> ApiNoContext for ContextWrapper<'a, T, C> {
    ...
    /// To test special tags
    fn 123_test@__%special_tags(&self, body: models::Client) -> Box<Future<Item=123Test@$%SpecialTagsResponse, Error=ApiError>> {
        self.api().123_test@__%special_tags(body, &self.context())
    }

    /// creates an XmlItem
    fn create_xml_item(&self, xml_item: models::XmlItem) -> Box<Future<Item=CreateXmlItemResponse, Error=ApiError>> {
        self.api().create_xml_item(xml_item, &self.context())
    }
    ...
    fn test_body_with_file_schema(&self, body: models::FileSchemaTestClass) -> Box<Future<Item=TestBodyWithFileSchemaResponse, Error=ApiError>> {
        self.api().test_body_with_file_schema(body, &self.context())
    }
    ...
    /// Fake endpoint to test group parameters (optional)
    fn test_group_parameters(&self, required_string_group: i32, required_boolean_group: bool, required_int64_group: i64, string_group: Option<i32>, boolean_group: Option<bool>, int64_group: Option<i64>) -> Box<Future<Item=TestGroupParametersResponse, Error=ApiError>> {
        self.api().test_group_parameters(required_string_group, required_boolean_group, required_int64_group, string_group, boolean_group, int64_group, &self.context())
    }
    ...
    /// test mixed properties and additionalProperties
    fn test_mixed_properties_and_additional_properties(&self, param: models::MixedPropertiesAndAdditionalPropertiesClass) -> Box<Future<Item=TestMixedPropertiesAndAdditionalPropertiesResponse, Error=ApiError>> {
        self.api().test_mixed_properties_and_additional_properties(param, &self.context())
    }


    fn test_query_parameter_collection_format(&self, pipe: &Vec<String>, ioutil: &Vec<String>, http: &Vec<String>, url: &Vec<String>, context: &Vec<String>) -> Box<Future<Item=TestQueryParameterCollectionFormatResponse, Error=ApiError>> {
        self.api().test_query_parameter_collection_format(pipe, ioutil, http, url, context, &self.context())
    }
    ...
    /// uploads an image (required)
    fn upload_file_with_required_file(&self, pet_id: i64, required_file: swagger::ByteArray, additional_metadata: Option<String>) -> Box<Future<Item=UploadFileWithRequiredFileResponse, Error=ApiError>> {
        self.api().upload_file_with_required_file(pet_id, required_file, additional_metadata, &self.context())
    }
