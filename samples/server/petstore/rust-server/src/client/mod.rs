...
use {Api,
     123Test@$%SpecialTagsResponse,
     CreateXmlItemResponse,
     FakeOuterBooleanSerializeResponse,
     FakeOuterCompositeSerializeResponse,
     FakeOuterNumberSerializeResponse,
     FakeOuterStringSerializeResponse,
     TestBodyWithFileSchemaResponse,
     TestBodyWithQueryParamsResponse,
     TestClientModelResponse,
     TestEndpointParametersResponse,
     TestEnumParametersResponse,
     TestGroupParametersResponse,
     TestInlineAdditionalPropertiesResponse,
     TestJsonFormDataResponse,
     TestMixedPropertiesAndAdditionalPropertiesResponse,
     TestQueryParameterCollectionFormatResponse,
     ...
     UploadFileResponse,
     UploadFileWithRequiredFileResponse,
     DeleteOrderResponse,
...
impl<F, C> Api<C> for Client<F> where
    ...
    fn 123_test@__%special_tags(&self, param_body: models::Client, context: &C) -> Box<Future<Item=123Test@$%SpecialTagsResponse, Error=ApiError>> {
        let mut uri = format!(
        ...
        request.headers_mut().set(ContentType(mimetypes::requests::123_TEST@__%SPECIAL_TAGS.clone()));
            ...
            match response.status().as_u16() {
                200 => {
                    ...
                    Box::new(
                        ...
                        .map(move |body| {
                            123Test@$%SpecialTagsResponse::SuccessfulOperation(body)
                        })
    ...
    fn create_xml_item(&self, param_xml_item: models::XmlItem, context: &C) -> Box<Future<Item=CreateXmlItemResponse, Error=ApiError>> {
        let mut uri = format!(
            "{}/v2/fake/create_xml_item",
            self.base_path
        );
        ...
        // Body parameter
        let body = param_xml_item.to_xml();
        request.set_body(body);

        request.headers_mut().set(ContentType(mimetypes::requests::CREATE_XML_ITEM.clone()));
            ...
            match response.status().as_u16() {
                200 => {
                    ...
                    Box::new(
                        ...
                        future::ok(
                            CreateXmlItemResponse::SuccessfulOperation
                        )
                    ) as Box<Future<Item=_, Error=_>>
                },
                code => {
    ...
    fn test_body_with_file_schema(&self, param_body: models::FileSchemaTestClass, context: &C) -> Box<Future<Item=TestBodyWithFileSchemaResponse, Error=ApiError>> {
        let mut uri = format!(
        ...
        request.headers_mut().set(ContentType(mimetypes::requests::TEST_BODY_WITH_FILE_SCHEMA.clone()));
            ...
            match response.status().as_u16() {
                200 => {
                    ...
                    Box::new(
                        ...
                        future::ok(
                            TestBodyWithFileSchemaResponse::Success
                        )
                    ) as Box<Future<Item=_, Error=_>>
                },
                code => {
    ...
    fn test_group_parameters(&self, param_required_string_group: i32, param_required_boolean_group: bool, param_required_int64_group: i64, param_string_group: Option<i32>, param_boolean_group: Option<bool>, param_int64_group: Option<i64>, context: &C) -> Box<Future<Item=TestGroupParametersResponse, Error=ApiError>> {
        let mut uri = format!(
            "{}/v2/fake",
            self.base_path
        );
        ...
        let mut query_string = self::url::form_urlencoded::Serializer::new("".to_owned());
        query_string.append_pair("required_string_group", &param_required_string_group.to_string());
        query_string.append_pair("required_int64_group", &param_required_int64_group.to_string());

        if let Some(string_group) = param_string_group {
            query_string.append_pair("string_group", &string_group.to_string());
        }
        if let Some(int64_group) = param_int64_group {
            query_string.append_pair("int64_group", &int64_group.to_string());
        }
        ...
        // Header parameters
        header! { (RequestRequiredBooleanGroup, "required_boolean_group") => [bool] }
        request.headers_mut().set(RequestRequiredBooleanGroup(param_required_boolean_group));
        header! { (RequestBooleanGroup, "boolean_group") => [bool] }
        param_boolean_group.map(|header| request.headers_mut().set(RequestBooleanGroup(header)));
        Box::new(self.client_service.call(request)
                             .map_err(|e| ApiError(format!("No response received: {}", e)))
                             .and_then(|mut response| {
            match response.status().as_u16() {
                400 => {
                    ...
                    Box::new(
                        ...
                        future::ok(
                            TestGroupParametersResponse::SometingWrong
                        )
                    ) as Box<Future<Item=_, Error=_>>
                },
                code => {
    ...
    fn test_mixed_properties_and_additional_properties(&self, param_param: models::MixedPropertiesAndAdditionalPropertiesClass, context: &C) -> Box<Future<Item=TestMixedPropertiesAndAdditionalPropertiesResponse, Error=ApiError>> {
        let mut uri = format!(
            "{}/v2/fake/body-mixedPropertiesAndAdditionalProperties",
            self.base_path
        );
        ...
        request.headers_mut().set(ContentType(mimetypes::requests::TEST_MIXED_PROPERTIES_AND_ADDITIONAL_PROPERTIES.clone()));
                    ...
                    Box::new(
                        ...
                        str::from_utf8(&body)
                                             ...
                                             .and_then(|body|
                                                 ...
                                                 serde_json::from_str::<models::MixedPropertiesAndAdditionalPropertiesClass>(body)
                                                     .map_err(|e| e.into())
                                             )

                                 )
                        .map(move |body| {
                            TestMixedPropertiesAndAdditionalPropertiesResponse::SuccessfulOperation(body)
                        })
                    ) as Box<Future<Item=_, Error=_>>
                },
                code => {
    ...
    fn test_query_parameter_collection_format(&self, param_pipe: &Vec<String>, param_ioutil: &Vec<String>, param_http: &Vec<String>, param_url: &Vec<String>, param_context: &Vec<String>, context: &C) -> Box<Future<Item=TestQueryParameterCollectionFormatResponse, Error=ApiError>> {
        let mut uri = format!(
        ...
        let mut query_string = self::url::form_urlencoded::Serializer::new("".to_owned());
        query_string.append_pair("pipe", &param_pipe.join(","));
        query_string.append_pair("ioutil", &param_ioutil.join(","));
        query_string.append_pair("http", &param_http.join(","));
        query_string.append_pair("url", &param_url.join(","));
        query_string.append_pair("context", &param_context.join(","));
            ...
            match response.status().as_u16() {
                200 => {
                    ...
                    Box::new(
                        ...
                        future::ok(
                            TestQueryParameterCollectionFormatResponse::Success
                        )
                    ) as Box<Future<Item=_, Error=_>>
                },
                code => {
    ...
    fn upload_file_with_required_file(&self, param_pet_id: i64, param_required_file: swagger::ByteArray, param_additional_metadata: Option<String>, context: &C) -> Box<Future<Item=UploadFileWithRequiredFileResponse, Error=ApiError>> {
        let mut uri = format!(
        ...
        let required_file_str = match serde_json::to_string(&param_required_file) {
            Ok(str) => str,
            Err(e) => return Box::new(futures::done(Err(ApiError(format!("Unable to parse required_file to string: {}", e))))),
        };

        let required_file_vec = required_file_str.as_bytes().to_vec();

        let required_file_mime = mime::Mime::from_str("application/json").expect("impossible to fail to parse");

        let required_file_cursor = Cursor::new(required_file_vec);

        multipart.add_stream("required_file",  required_file_cursor,  None as Option<&str>, Some(required_file_mime));  
            ...
            match response.status().as_u16() {
                200 => {
                    ...
                    Box::new(
                        ...
                        .map(move |body| {
                            UploadFileWithRequiredFileResponse::SuccessfulOperation(body)
                        })
                    ) as Box<Future<Item=_, Error=_>>
                },
                code => {
