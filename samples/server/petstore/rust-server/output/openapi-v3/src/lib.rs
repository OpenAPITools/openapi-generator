...
pub trait Api<C> {
    ...
    fn xml_other_put(&self, another_xml_array: Option<models::AnotherXmlArray>, context: &C) -> Box<Future<Item=XmlOtherPutResponse, Error=ApiError>>;

    /// Post an array
    fn xml_post(&self, xml_array: Option<models::XmlArray>, context: &C) -> Box<Future<Item=XmlPostResponse, Error=ApiError>>;
...
pub trait ApiNoContext {
    ...
    fn xml_other_put(&self, another_xml_array: Option<models::AnotherXmlArray>) -> Box<Future<Item=XmlOtherPutResponse, Error=ApiError>>;

    /// Post an array
    fn xml_post(&self, xml_array: Option<models::XmlArray>) -> Box<Future<Item=XmlPostResponse, Error=ApiError>>;
