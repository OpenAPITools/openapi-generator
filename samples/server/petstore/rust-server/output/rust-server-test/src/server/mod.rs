                     ...
                     Ok(body) => {
                                ...
                                let param_nested_response: Option<models::DummyPutRequest> = if !body.is_empty() {
                                    ...
                                    match serde_ignored::deserialize(deserializer, |path| {
                                        ...
                                        Err(e) => return Ok(Response::builder()
                                                        ...
                                                        .body(body_from_string(format!("Couldn't parse body parameter nested_response - doesn't match schema: {}", e)))
                                ...
                                let param_nested_response = match param_nested_response {
                                    ...
                                    None => return Ok(Response::builder()
                                                        .status(StatusCode::BAD_REQUEST)
                                                        .body(body_from_str("Missing required body parameter nested_response"))
                     ...
                     Ok(body) => {
                                let param_body: Option<String> = if !body.is_empty() {
                                    match String::from_utf8(body.to_vec()) {
                                        ...
                                        Err(e) => return Ok(Response::builder()
                                                        .status(StatusCode::BAD_REQUEST)
                                                        .body(body_from_string(format!("Couldn't parse body parameter body - not valid UTF-8: {}", e)))
                     ...
                     Ok(body) => {
                                let param_value: Option<String> = if !body.is_empty() {
                                    match String::from_utf8(body.to_vec()) {
                                        ...
                                        Err(e) => return Ok(Response::builder()
                                                        .status(StatusCode::BAD_REQUEST)
                                                        .body(body_from_string(format!("Couldn't parse body parameter value - not valid UTF-8: {}", e)))
                                ...
                                let param_value = match param_value {
                                    ...
                                    None => return Ok(Response::builder()
                                                        .status(StatusCode::BAD_REQUEST)
                                                        .body(body_from_str("Missing required body parameter value"))
                     ...
                     Ok(body) => {
                                ...
                                let param_value: Option<serde_json::Value> = if !body.is_empty() {
                                    ...
                                    match serde_ignored::deserialize(deserializer, |path| {
                                        ...
                                        Err(e) => return Ok(Response::builder()
                                                        .status(StatusCode::BAD_REQUEST)
                                                        .body(body_from_string(format!("Couldn't parse body parameter value - doesn't match schema: {}", e)))
