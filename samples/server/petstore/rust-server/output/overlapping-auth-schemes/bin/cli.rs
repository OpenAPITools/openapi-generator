...
#[derive(Parser, Debug)]
#[clap(
    name = "overlapping auth schemes test",
    version = "1.0",
    about = "CLI access to overlapping auth schemes test"
)]
struct Cli {
    #[clap(subcommand)]
    operation: Operation,
    ...
    #[arg(env = "OVERLAPPING_AUTH_SCHEMES_BEARER_TOKEN", hide_env = true)]
    bearer_token: Option<String>,

    /// API key for authentication
    #[arg(long, env = "OVERLAPPING_AUTH_SCHEMES_API_KEY", hide_env = true)]
