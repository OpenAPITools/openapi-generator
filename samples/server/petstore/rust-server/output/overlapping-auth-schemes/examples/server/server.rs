//! Main library entry point for overlapping_auth_schemes implementation.
...
use overlapping_auth_schemes::models;
...
pub async fn create(addr: &str, https: bool) {
    ...
    #[allow(unused_mut)]
    let mut service =
        overlapping_auth_schemes::server::context::MakeAddContext::<_, EmptyContext>::new(
            service
        );
...
use overlapping_auth_schemes::{
    Api,
    PingGetResponse,
};
use overlapping_auth_schemes::server::MakeService;
use std::error::Error;
