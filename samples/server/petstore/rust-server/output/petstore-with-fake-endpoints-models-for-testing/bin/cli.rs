...
enum Operation {
    ...
    TestEnumParameters {
        ...
        #[clap(value_parser = parse_json::<Vec<models::TestEnumParametersEnumQueryStringArrayParameterInner>>, long)]
        enum_query_string_array: Option<Vec<models::TestEnumParametersEnumQueryStringArrayParameterInner>>,
        /// Query parameter enum test (string)
        #[clap(value_parser = parse_json::<models::TestEnumParametersEnumQueryStringParameter>)]
