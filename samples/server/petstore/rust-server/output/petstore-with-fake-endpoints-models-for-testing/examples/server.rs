...
pub use petstore_with_fake_endpoints_models_for_testing::models as models;

mod server_lib;

use petstore_with_fake_endpoints_models_for_testing::Service;
...
async fn main() {
    ...
    if matches.is_present("https") {
        let acceptor = petstore_with_fake_endpoints_models_for_testing::server::tls::acceptor(
            &addr,
