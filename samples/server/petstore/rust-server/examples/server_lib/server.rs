...
impl<C> Api<C> for Server<C> where C: Has<XSpanIdString>{
    ...
    fn 123_test@__%special_tags(&self, body: models::Client, context: &C) -> Box<Future<Item=123Test@$%SpecialTagsResponse, Error=ApiError>> {
        ...
        println!("123_test@__%special_tags({:?}) - X-Span-ID: {:?}", body, context.get().0.clone());
    ...
    fn create_xml_item(&self, xml_item: models::XmlItem, context: &C) -> Box<Future<Item=CreateXmlItemResponse, Error=ApiError>> {
        let context = context.clone();
        println!("create_xml_item({:?}) - X-Span-ID: {:?}", xml_item, context.get().0.clone());
        Box::new(futures::failed("Generic failure".into()))
    }
    ...
    fn test_body_with_file_schema(&self, body: models::FileSchemaTestClass, context: &C) -> Box<Future<Item=TestBodyWithFileSchemaResponse, Error=ApiError>> {
        let context = context.clone();
        println!("test_body_with_file_schema({:?}) - X-Span-ID: {:?}", body, context.get().0.clone());
        Box::new(futures::failed("Generic failure".into()))
    }
    ...
    fn test_enum_parameters(&self, enum_header_string_array: Option<&Vec<String>>, enum_header_string: Option<String>, enum_query_string_array: Option<&Vec<String>>, enum_query_string: Option<String>, enum_query_integer: Option<i32>, enum_query_double: Option<f64>, enum_form_string_array: Option<&Vec<String>>, enum_form_string: Option<String>, context: &C) -> Box<Future<Item=TestEnumParametersResponse, Error=ApiError>> {
        let context = context.clone();
        println!("test_enum_parameters({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", enum_header_string_array, enum_header_string, enum_query_string_array, enum_query_string, enum_query_integer, enum_query_double, enum_form_string_array, enum_form_string, context.get().0.clone());
        Box::new(futures::failed("Generic failure".into()))
    }
    ...
    fn test_group_parameters(&self, required_string_group: i32, required_boolean_group: bool, required_int64_group: i64, string_group: Option<i32>, boolean_group: Option<bool>, int64_group: Option<i64>, context: &C) -> Box<Future<Item=TestGroupParametersResponse, Error=ApiError>> {
        let context = context.clone();
        println!("test_group_parameters({}, {}, {}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", required_string_group, required_boolean_group, required_int64_group, string_group, boolean_group, int64_group, context.get().0.clone());
        Box::new(futures::failed("Generic failure".into()))
    }
    ...
    fn test_mixed_properties_and_additional_properties(&self, param: models::MixedPropertiesAndAdditionalPropertiesClass, context: &C) -> Box<Future<Item=TestMixedPropertiesAndAdditionalPropertiesResponse, Error=ApiError>> {
        let context = context.clone();
        println!("test_mixed_properties_and_additional_properties({:?}) - X-Span-ID: {:?}", param, context.get().0.clone());
        Box::new(futures::failed("Generic failure".into()))
    }
    ...
    fn test_query_parameter_collection_format(&self, pipe: &Vec<String>, ioutil: &Vec<String>, http: &Vec<String>, url: &Vec<String>, context: &Vec<String>, context: &C) -> Box<Future<Item=TestQueryParameterCollectionFormatResponse, Error=ApiError>> {
        let context = context.clone();
        println!("test_query_parameter_collection_format({:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", pipe, ioutil, http, url, context, context.get().0.clone());
        Box::new(futures::failed("Generic failure".into()))
    }
    ...
    fn upload_file_with_required_file(&self, pet_id: i64, required_file: swagger::ByteArray, additional_metadata: Option<String>, context: &C) -> Box<Future<Item=UploadFileWithRequiredFileResponse, Error=ApiError>> {
        let context = context.clone();
        println!("upload_file_with_required_file({}, {:?}, {:?}) - X-Span-ID: {:?}", pet_id, required_file, additional_metadata, context.get().0.clone());
        Box::new(futures::failed("Generic failure".into()))
    }
