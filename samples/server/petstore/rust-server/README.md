...
- API version: 1.0.0
- Build date: 2019-09-23T12:38:18.378+02:00[Europe/Prague]
...
```
cargo run --example client 123Test@$%SpecialTags
cargo run --example client CreateXmlItem
...
cargo run --example client TestBodyWithFileSchema
...
cargo run --example client TestGroupParameters
cargo run --example client TestInlineAdditionalProperties
cargo run --example client TestJsonFormData
cargo run --example client TestMixedPropertiesAndAdditionalProperties
cargo run --example client TestQueryParameterCollectionFormat
...
cargo run --example client UploadFileWithRequiredFile
...
------------- | ------------- | -------------
[**123_test_@#$%_special_tags**](docs/another_fake_api.md#123_test_@#$%_special_tags) | **PATCH** /another-fake/dummy | To test special tags
[**createXmlItem**](docs/fake_api.md#createXmlItem) | **POST** /fake/create_xml_item | creates an XmlItem
...
[**testBodyWithFileSchema**](docs/fake_api.md#testBodyWithFileSchema) | **PUT** /fake/body-with-file-schema | 
...
[**testGroupParameters**](docs/fake_api.md#testGroupParameters) | **DELETE** /fake | Fake endpoint to test group parameters (optional)
...
[**testMixedPropertiesAndAdditionalProperties**](docs/fake_api.md#testMixedPropertiesAndAdditionalProperties) | **POST** /fake/body-mixedPropertiesAndAdditionalProperties | test mixed properties and additionalProperties
[**testQueryParameterCollectionFormat**](docs/fake_api.md#testQueryParameterCollectionFormat) | **PUT** /fake/test-query-paramters | 
...
[**uploadFileWithRequiredFile**](docs/pet_api.md#uploadFileWithRequiredFile) | **POST** /fake/{petId}/uploadImageWithRequiredFile | uploads an image (required)
