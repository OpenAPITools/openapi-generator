...
public class AnotherFakeApi  {
   ...
   public AnotherFakeApi(@Context ServletConfig servletContext) {
    ...
    public Response call123testSpecialTags(@ApiParam(value = "to test uuid example value" ,required=true)@HeaderParam("uuid_test") UUID uuidTest,@ApiParam(value = "client model", required = true) @NotNull 
