...
public abstract class FakeApiService {
    ...
    public abstract Response testEndpointEnumsLengthOne( @NotNull Integer queryInteger, @NotNull String queryString,String pathString,Integer pathInteger, @NotNull Double headerNumber,SecurityContext securityContext) throws NotFoundException;
