...
public abstract class FakeApiService {
    ...
    public abstract Response testEndpointParameters(BigDecimal number,Double _double,String patternWithoutDelimiter,byte[] _byte,Integer _integer,Integer int32,Long int64,Float _float,String _string,FormDataBodyPart binaryBodypart,LocalDate _date,OffsetDateTime _dateTime,String password,String paramCallback,SecurityContext securityContext) throws NotFoundException;
