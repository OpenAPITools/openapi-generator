...
public class ObjectWithUniqueItems {
  ...
  */
  ...
  public static class Builder {
    ...
    private ObjectWithUniqueItems instance;

    public Builder() {
      this(new ObjectWithUniqueItems());
    }

    protected Builder(ObjectWithUniqueItems instance) {
      this.instance = instance;
    }

    public ObjectWithUniqueItems.Builder nullSet(Set<String> nullSet) {
      this.instance.nullSet(nullSet);
      return this;
    }
    public ObjectWithUniqueItems.Builder notNullSet(Set<String> notNullSet) {
      this.instance.notNullSet(notNullSet);
      return this;
    }
    public ObjectWithUniqueItems.Builder nullList(List<String> nullList) {
      this.instance.nullList(nullList);
      return this;
    }
    public ObjectWithUniqueItems.Builder notNullList(List<String> notNullList) {
      this.instance.notNullList(notNullList);
      return this;
    }
    public ObjectWithUniqueItems.Builder notNullDateField(OffsetDateTime notNullDateField) {
      this.instance.notNullDateField(notNullDateField);
      return this;
    }
    public ObjectWithUniqueItems.Builder nullDateField(OffsetDateTime nullDateField) {
      this.instance.nullDateField(nullDateField);
      return this;
    }
    /**
    * returns a built ObjectWithUniqueItems instance.
    *
    * The builder is not reusable (NullPointerException)
    */
    public ObjectWithUniqueItems build() {
      try {
  ...
  */
  public static ObjectWithUniqueItems.Builder builder() {
    return new ObjectWithUniqueItems.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public ObjectWithUniqueItems.Builder toBuilder() {
    ObjectWithUniqueItems.Builder builder = new ObjectWithUniqueItems.Builder();
    builder.instance.setNullSet(nullSet);
    builder.instance.setNotNullSet(notNullSet);
    builder.instance.setNullList(nullList);
    builder.instance.setNotNullList(notNullList);
    builder.instance.setNotNullDateField(notNullDateField);
    builder.instance.setNullDateField(nullDateField);
    return builder;
  }
