...
/** ApiResponseData a data transfer object, primarily for simple json serialisation. It has no
  * validation - there may be nulls, values out of range, etc
  */
