...
public interface StoreApi {
    ...
    ResponseEntity<Void> deleteOrder( @ApiParam(value = "ID of the order that needs to be deleted", required=true, example="orderId_example") @PathVariable("order_id") String orderId);
    ...
    ResponseEntity<Order> getOrderById(@Min(1L) @Max(5L)  @ApiParam(value = "ID of pet that needs to be fetched", required=true, example="56") @PathVariable("order_id") Long orderId);
