...
public class NullableClass extends HashMap<String, Object> implements Serializable {
  private @Valid Integer integerProp;
  private @Valid BigDecimal numberProp;
  private @Valid Boolean booleanProp;
  private @Valid String stringProp;
  private @Valid LocalDate dateProp;
  private @Valid Date datetimeProp;
  private @Valid List<Object> arrayNullableProp = null;
  private @Valid List<Object> arrayAndItemsNullableProp = null;
  private @Valid List<Object> arrayItemsNullable = null;
  private @Valid Map<String, Object> objectNullableProp = null;
  private @Valid Map<String, Object> objectAndItemsNullableProp = null;
  private @Valid Map<String, Object> objectItemsNullable = null;
