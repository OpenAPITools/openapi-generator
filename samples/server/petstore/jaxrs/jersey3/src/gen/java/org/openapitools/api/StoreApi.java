...
public class StoreApi  {
   ...
   public StoreApi(@Context ServletConfig servletContext) {
    ...
    @Operation(summary = "Delete purchase order by ID", description = "", 
        responses = {
...
//    
    ...
    @Operation(summary = "Returns pet inventories by status", description = "", 
        responses = {
...
//    
    ...
    @Operation(summary = "Find purchase order by ID", description = "", 
        responses = {
...
//    
    ...
    @Operation(summary = "Place an order for a pet", description = "", 
        responses = {
            @ApiResponse(responseCode = "200", description = "successful operation", content = @Content(schema = @Schema(implementation = Order.class))),
            @ApiResponse(responseCode = "400", description = "Invalid Order", content = @Content(schema = @Schema(implementation = Void.class))),
            }
    , tags={ "store", }) 
//    ==> Previous Swagger1 annotations <== RESOLVED WITH THE ABOVE FOR SWAGGER 2.X   
