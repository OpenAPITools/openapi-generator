...
public class UserApi  {
   ...
   public UserApi(@Context ServletConfig servletContext) {
    ...
    public Response createUsersWithArrayInput(@Schema(description = "List of user object", required = true) @NotNull  List<@Valid User> user,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response createUsersWithListInput(@Schema(description = "List of user object", required = true) @NotNull  List<@Valid User> user,@Context SecurityContext securityContext)
    throws NotFoundException {
