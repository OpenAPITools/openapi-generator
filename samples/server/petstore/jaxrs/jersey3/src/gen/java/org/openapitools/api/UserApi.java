...
public class UserApi  {
   ...
   public UserApi(@Context ServletConfig servletContext) {
    ...
    public Response createUser(@Schema(description = "Created user object", required = true) @NotNull 
 User user,@Context SecurityContext securityContext)
    ...
    public Response createUsersWithArrayInput(@Schema(description = "List of user object", required = true) @NotNull @Valid 
 List<@Valid User> user,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response createUsersWithListInput(@Schema(description = "List of user object", required = true) @NotNull @Valid 
 List<@Valid User> user,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response deleteUser(@Schema(description= "The name that needs to be deleted", required = true) @PathParam("username") @NotNull 
 String username,@Context SecurityContext securityContext)
    ...
    public Response getUserByName(@Schema(description= "The name that needs to be fetched. Use user1 for testing.", required = true) @PathParam("username") @NotNull 
 String username,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response loginUser(@Schema(description = "The user name for login") @QueryParam("username") @NotNull 
 String username,@Schema(description = "The password for login in clear text") @QueryParam("password") @NotNull 
 String password,@Context SecurityContext securityContext)
    ...
    public Response updateUser(@Schema(description= "name that need to be deleted", required = true) @PathParam("username") @NotNull 
 String username,@Schema(description = "Updated user object", required = true) @NotNull 
 User user,@Context SecurityContext securityContext)
    throws NotFoundException {
