...
//    
    ...
    @Operation(summary = "Logs user into the system", description = "", 
        responses = {
            ...
            @ApiResponse(responseCode = "400", description = "Invalid username/password supplied", content = @Content(schema = @Schema(implementation = Void.class))),
            }
    , tags={ "user", }) 
//    ==> Previous Swagger1 annotations <== RESOLVED WITH THE ABOVE FOR SWAGGER 2.X   
...
//    ==> Previous Swagger1 annotations <== HOW TO DEAL WITH THIS PART?
//    
    public Response loginUser(@Schema(description = "The user name for login", required = true) @QueryParam("username") @NotNull  String username,@Schema(description = "The password for login in clear text", required = true) @QueryParam("password") @NotNull  String password,@Context SecurityContext securityContext)
    throws NotFoundException {
...
//    
    ...
    @Operation(summary = "Updated user", description = "", 
        responses = {
            @ApiResponse(responseCode = "400", description = "Invalid user supplied", content = @Content(schema = @Schema(implementation = Void.class))),
            @ApiResponse(responseCode = "404", description = "User not found", content = @Content(schema = @Schema(implementation = Void.class))),
            }
    , tags={ "user", }) 
//    ==> Previous Swagger1 annotations <== RESOLVED WITH THE ABOVE FOR SWAGGER 2.X   
