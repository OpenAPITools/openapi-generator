...
public class UserApi  {
   ...
   public UserApi(@Context ServletConfig servletContext) {
    ...
    public Response createUsersWithArrayInput(@ApiParam(value = "List of user object", required = true) @NotNull @Valid @Valid  List<@Valid User> body,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response createUsersWithListInput(@ApiParam(value = "List of user object", required = true) @NotNull @Valid @Valid  List<@Valid User> body,@Context SecurityContext securityContext)
    throws NotFoundException {
