...
Error::Error(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value Error::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Error::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Error");
    }
...
boost::json::object Error::toJsonObject_internal() const
{
...
{
    {
        ...
        if (CodeIt != object.end()) {
            ...
            try {
                ...
                throw std::invalid_argument(
                    "Decode failed for 'code' in Error: " + std::string(ex.what()));
            }
            }
        } else {
            throw std::invalid_argument("Required field 'code' not found in Error");
        }
    }
    {
        ...
        if (MessageIt != object.end()) {
            ...
            try {
                ...
                throw std::invalid_argument(
                    "Decode failed for 'message' in Error: " + std::string(ex.what()));
            }
            }
        } else {
            throw std::invalid_argument("Required field 'message' not found in Error");
        }
    }
}

std::int32_t Error::getCode() const
{
    return m_Code;
}

void Error::setCode(std::int32_t value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Error>>>::toJsonValue(data));
}
...
void createModelVectorFromJsonString(std::vector<std::shared_ptr<Error>>& vec, const std::string& json)
{
    ...
    org::openapitools::server::model::detail::schema_validation::requireModelConvertibleJson(exactJson);
    org::openapitools::server::model::detail::schema_validation::ExactInstanceScope exactScope(exactJson);
    vec = JsonValueConverter<std::vector<std::shared_ptr<Error>>>::fromJsonValue(exactJson.value);
}
