...
{
    org::openapitools::server::model::detail::schema_validation::ExactJsonValue exactJson = org::openapitools::server::model::detail::schema_validation::parseExactJson(jsonString);
...
boost::json::object Pet::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_TagIsSet) {
            object["tag"] = JsonValueConverter<std::string>::toJsonValue(getTag());
        }
        if (m_StatusIsSet) {
...
void Pet::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    m_StatusIsSet = false;
    {
        ...
        if (IdIt != object.end()) {
            ...
            throw std::invalid_argument("Required field 'id' not found in Pet");
        }
    }
    {
    ...
    {
        const auto TagIt = object.find("tag");
        if (TagIt != object.end()) {
            if (!TagIt->value().is_null()) {
            try {
                setTag(JsonValueConverter<std::string>::fromJsonValue(TagIt->value()));
            } catch (std::exception const& ex) {
                throw std::invalid_argument(
                    "Decode failed for 'tag' in Pet: " + std::string(ex.what()));
            }
            }
        }
    }
...
std::string Pet::getTag() const
{
    return m_Tag;
}

void Pet::setTag(std::string value)
{
...
{
    org::openapitools::server::model::detail::schema_validation::ExactJsonValue exactJson = org::openapitools::server::model::detail::schema_validation::parseExactJson(json);
    org::openapitools::server::model::detail::schema_validation::requireModelConvertibleJson(exactJson);
    org::openapitools::server::model::detail::schema_validation::ExactInstanceScope exactScope(exactJson);
