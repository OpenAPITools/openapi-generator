...
class UserApiController(@Autowired(required = true) val service: UserApiService) {
    ...
    fun createUsersWithArrayInput(@Parameter(description = "List of user object", required = true) @Valid @RequestBody body: List<User>): ResponseEntity<Unit> {
    ...
    fun createUsersWithListInput(@Parameter(description = "List of user object", required = true) @Valid @RequestBody body: List<User>): ResponseEntity<Unit> {
    ...
    fun updateUser(@Parameter(description = "name that need to be deleted", required = true) @PathVariable("username") username: String,@Parameter(description = "Updated user object", required = true) @Valid @RequestBody body: User): ResponseEntity<Unit> {
