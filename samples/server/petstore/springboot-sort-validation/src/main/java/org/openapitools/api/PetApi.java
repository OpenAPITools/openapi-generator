...
public interface PetApi {
    ...
    default ResponseEntity<List<Pet>> findPetsAutoDetectedWithSort(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "[ { \"name\" : \"name\", \"id\" : 0, \"status\" : \"status\" }, { \"name\" : \"name\", \"id\" : 0, \"status\" : \"status\" } ]";
    ...
    default ResponseEntity<List<Pet>> findPetsNonPaginatedWithSortEnum(
         @Valid @RequestParam(value = "sort", required = false) @Nullable String sort
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
    ...
    default ResponseEntity<List<Pet>> findPetsWithAllDefaults(
    ...
    default ResponseEntity<List<Pet>> findPetsWithMixedSortDefaults(
    ...
    default ResponseEntity<List<Pet>> findPetsWithPageAndSizeConstraint(
    ...
    default ResponseEntity<List<Pet>> findPetsWithPageSizeDefaultsOnly(
    ...
    default ResponseEntity<List<Pet>> findPetsWithRefSort(
    ...
    default ResponseEntity<List<Pet>> findPetsWithSizeConstraint(
    ...
    default ResponseEntity<List<Pet>> findPetsWithSortDefaultAsc(
    ...
    default ResponseEntity<List<Pet>> findPetsWithSortDefaultOnly(
    ...
    default ResponseEntity<List<Pet>> findPetsWithSortEnum(
         @Valid @RequestParam(value = "status", required = false) @Nullable String status,
    ...
    default ResponseEntity<List<Pet>> findPetsWithoutSortEnum(
