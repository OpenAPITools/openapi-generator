...
public class EnumConverterConfiguration {
    ...
    Converter<String, PetSort> petSortConverter() {
        return new Converter<String, PetSort>() {
            @Override
    ...
    Converter<String, PetSortEnum> petSortEnumConverter() {
        return new Converter<String, PetSortEnum>() {
            @Override
