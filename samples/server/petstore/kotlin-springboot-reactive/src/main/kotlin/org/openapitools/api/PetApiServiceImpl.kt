...
class PetApiServiceImpl : PetApiService {
    ...
    override suspend fun uploadFile(petId: kotlin.Long, additionalMetadata: kotlin.String?, file: org.springframework.http.codec.multipart.FilePart?): ModelApiResponse {
        TODO("Implement me")
    }
}
