...
/*builder*/
  ...
  this.instance = new  Order();
    ...
    this.instance.petId = Optional.ofNullable(petId);
    return this;
    }
    ...
    this.instance.quantity = Optional.ofNullable(quantity);
    return this;
    }
    ...
    public Order.Builder shipDate(Optional<Date> shipDate) {
    this.instance.shipDate = Optional.ofNullable(shipDate);
    return this;
    }
    ...
    this.instance.complete = Optional.ofNullable(complete);
    return this;
    }
