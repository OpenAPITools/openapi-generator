...
public interface FakeApi {
    ...
    default ResponseEntity<Void> testAdditionalPropertiesReference(
        @Parameter(name = "request_body", description = "request body", required = true) @NotNull @RequestBody Map<String, Object> requestBody
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    default ResponseEntity<Void> testInlineAdditionalProperties(
        @Parameter(name = "request_body", description = "request body", required = true) @NotNull @RequestBody Map<String, String> requestBody
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
