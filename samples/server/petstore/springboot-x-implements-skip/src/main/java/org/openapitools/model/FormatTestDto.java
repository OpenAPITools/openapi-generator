...
public class FormatTestDto {
  ...
  public FormatTestDto decimal(@Nullable BigDecimal decimal) {
  ...
  public FormatTestDto patternWithDigits(@Nullable String patternWithDigits) {
  ...
  public FormatTestDto patternWithDigitsAndDelimiter(@Nullable String patternWithDigitsAndDelimiter) {
