...
public interface FakeApi {
     ...
     */
    @Operation(summary = "creates an XmlItem", operationId = "createXmlItem", tags={ "fake", })
    @ApiResponses(value = { 
    ...
    ResponseEntity<Void> testBodyWithQueryParams(@NotNull @Parameter(description = "", required = true) @Valid @RequestParam(value = "query", required = true) String query,@Parameter(description = "" ,required=true )  @Valid @RequestBody User body);
     ...
     */
    @Operation(summary = "Fake endpoint to test group parameters (optional)", operationId = "testGroupParameters", tags={ "fake", })
    @ApiResponses(value = { 
