...
,@QueryParam("query_1")   String query1
...
@FormParam(value = "callback")  String paramCallback) {
    ...
    public Response testEnumParameters(@HeaderParam("enum_header_string_array")   List<String> enumHeaderStringArray
...
,@HeaderParam("required_boolean_group") @NotNull   Boolean requiredBooleanGroup
,@QueryParam("required_int64_group") @NotNull   Long requiredInt64Group
,@QueryParam("string_group")   Integer stringGroup
,@HeaderParam("boolean_group")   Boolean booleanGroup
,@QueryParam("int64_group")   Long int64Group
) {
        return Response.ok().entity("magic!").build();
    }
...
,@QueryParam("language")   Map<String, String> language
    ...
    public Response uploadFileWithRequiredFile(@PathParam("petId") Long petId
,
