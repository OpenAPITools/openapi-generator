...
Generated by OpenAPI Generator 4.1.3-SNAPSHOT.
...
The server builds as a fat jar with a main entrypoint. To start the service, run `java -jar ./build/libs/kotlin-petstore-server.jar`.

You may also run in docker:

```
docker build -t kotlin-petstore-server .
docker run -p 8080:8080 kotlin-petstore-server
```
