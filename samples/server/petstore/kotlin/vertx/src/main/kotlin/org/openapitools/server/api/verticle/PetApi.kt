...
interface PetApi  {
    ...
    /* uploadFile
     * uploads an image */
    suspend fun uploadFile(petId:Long?,additionalMetadata:String?,file:kotlin.collections.List<java.io.File>?,context:OperationRequest):Response<ModelApiResponse>
    companion object {
