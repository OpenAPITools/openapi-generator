...
class PetApiController(@Autowired(required = true) val service: PetApiService) {
    ...
    fun getImage(
        @ApiParam(value = "ID of pet to get image", required = true) @PathVariable("petId") petId: kotlin.Long
    ...
    fun uploadFile(
        ...
        @ApiParam(value = "file detail") @Valid @RequestPart("image", required = true) image: org.springframework.web.multipart.MultipartFile,
    ...
    fun uploadMultipleFile(
        @ApiParam(value = "ID of pet to update", required = true) @PathVariable("petId") petId: kotlin.Long,
        @ApiParam(value = "file detail") @Valid @RequestPart("images", required = true) images: Array<org.springframework.web.multipart.MultipartFile>,
        @ApiParam(value = "Additional data to pass to server") @Valid @RequestParam(value = "additionalMetadata", required = false) additionalMetadata: kotlin.String?
    ): ResponseEntity<ModelApiResponse> {
