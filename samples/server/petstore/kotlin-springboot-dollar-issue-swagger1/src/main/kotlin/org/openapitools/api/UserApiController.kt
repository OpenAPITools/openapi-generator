...
class UserApiController(@Autowired(required = true) val service: UserApiService) {
    ...
    fun logoutUserOptions(): ResponseEntity<Unit> {
        return ResponseEntity(service.logoutUserOptions(), HttpStatus.valueOf(200))
    }
    ...
    companion object {
        ...
        const val PATH_LOGOUT_USER_OPTIONS: String = "/user/logout"
