...
class PetApiTest {
    ...
    /**
     * To test PetApiController.getImage
     *
     * @throws ApiException
     *          if the Api call fails
     */
    ...
    fun getImageTest() {
        ...
        val response: ResponseEntity<org.springframework.core.io.Resource> = api.getImage(petId)
    ...
    fun uploadFileTest() {
        ...
        val response: ResponseEntity<ModelApiResponse> = api.uploadFile(petId, image, additionalMetadata)

        // TODO: test validations
    }

    /**
     * To test PetApiController.uploadMultipleFile
     *
     * @throws ApiException
     *          if the Api call fails
     */
    @Test
    fun uploadMultipleFileTest() {
        val petId: kotlin.Long = TODO()
        val images: Array<org.springframework.web.multipart.MultipartFile> = TODO()
        val additionalMetadata: kotlin.String? = TODO()
        
        val response: ResponseEntity<ModelApiResponse> = api.uploadMultipleFile(petId, images, additionalMetadata)
