...
class PetApi(implicit val swagger: Swagger) extends ScalatraServlet
  ...
  val findPetsByStatusOperation = (apiOperation[List[Pet]]("findPetsByStatus")
    ...
    parameters(queryParam[List[String]]("status").description("").defaultValue(new ListBuffer[String]() ))
  )
  ...
  val findPetsByTagsOperation = (apiOperation[List[Pet]]("findPetsByTags")
    ...
    parameters(queryParam[List[String]]("tags").description("").defaultValue(new ListBuffer[String]() ), queryParam[Int]("maxCount").description("").optional)
  )
  ...
  get("/pet/findByTags", operation(findPetsByTagsOperation)) {
    ...
    //println("tags: " + tags)
            val maxCount = params.getAs[Int]("maxCount")
