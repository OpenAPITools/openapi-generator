...
@JsonPropertyOrder({
    MixedPropertiesAndAdditionalPropertiesClassDto.JSON_PROPERTY_UUID,
    MixedPropertiesAndAdditionalPropertiesClassDto.JSON_PROPERTY_DATE_TIME,
    MixedPropertiesAndAdditionalPropertiesClassDto.JSON_PROPERTY_MAP
})
