...
public interface UserApiControllerImpInterface {
    ...
    CompletionStage<User> getUserByName(Request request, String username) throws Exception;

    CompletionStage<String> loginUser(Request request, @NotNull String username, @NotNull String password) throws Exception;
