...
data class Order(
    ...
    @ApiModelProperty(example = "null", value = "")
    @field:JsonProperty("petId") val petId: kotlin.Long,

    @ApiModelProperty(example = "null", value = "")
    @field:JsonProperty("quantity") val quantity: kotlin.Int,

    @ApiModelProperty(example = "null", value = "")
    @field:JsonProperty("shipDate") val shipDate: java.time.OffsetDateTime,

    @ApiModelProperty(example = "null", value = "Order Status")
    @field:JsonProperty("status") val status: Order.Status,
