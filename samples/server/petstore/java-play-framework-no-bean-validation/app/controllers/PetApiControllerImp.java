...
public class PetApiControllerImp implements PetApiControllerImpInterface {
    ...
    @Override
    public List<Pet> findPetsByStatus(Request request, List<String> status) throws Exception {
        //Do your magic!!!
        return new ArrayList<Pet>();
    }

    @Override
    public List<Pet> findPetsByTags(Request request, List<String> tags) throws Exception {
        //Do your magic!!!
        return new ArrayList<Pet>();
    }
