...
public interface FakeApi {
    ...
    @RequestMapping(value = "/fake/body-mixedPropertiesAndAdditionalProperties",
        ...
        consumes = { "application/json" },
        method = RequestMethod.POST)
    default ResponseEntity<MixedPropertiesAndAdditionalPropertiesClass> testMixedPropertiesAndAdditionalProperties(@ApiParam(value = "request body" ,required=true )  @Valid @RequestBody MixedPropertiesAndAdditionalPropertiesClass param) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("*/*"))) {
