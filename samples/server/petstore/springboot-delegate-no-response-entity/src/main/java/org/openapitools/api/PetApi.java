...
public interface PetApi {
    ...
    default List<Pet> findPetsByStatus(
        @ApiParam(value = "Status values that need to be considered for filter", required = true, allowableValues = "available, pending, sold") @RequestParam(value = "status") @Deprecated @NotNull List<StatusEnum> status
    ) {
