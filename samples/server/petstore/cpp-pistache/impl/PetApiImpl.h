...
public:
    ...
    void find_pets_by_tags(const Pistache::Optional<std::vector<std::string>> &tags, const Pistache::Optional<int32_t> &maxCount, Pistache::Http::ResponseWriter &response);
