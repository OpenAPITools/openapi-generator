...
public abstract class FakeService implements Service {
     ...
     * @param response the server response
     */
    abstract void handleFakeBigDecimalMap(ServerRequest request, ServerResponse response);
    ...
    void testAdditionalPropertiesReference(ServerRequest request, ServerResponse response) { 
        Single.create(request.content().as(new GenericType<Map<String, Object>>() { }))
            .thenAccept(requestBody -> {
                ValidatorUtils.checkNonNull(requestBody);

                                 handleTestAdditionalPropertiesReference(request, response, requestBody);
            })
            .exceptionally(throwable -> handleError(request, response, throwable));
    }
     ...
     */
    abstract void handleTestAdditionalPropertiesReference(ServerRequest request, ServerResponse response, String requestBody);
    ...
    void testBodyWithBinary(ServerRequest request, ServerResponse response) { 
        Single.create(request.content().as(new GenericType<InputStream>() { }))
            .thenAccept(body -> {
                ValidatorUtils.checkNonNull(body);
    ...
    void testInlineFreeformAdditionalProperties(ServerRequest request, ServerResponse response, TestInlineFreeformAdditionalPropertiesRequest testInlineFreeformAdditionalPropertiesRequest) { 
        Single.create(Single.empty())
            .thenAccept(val -> {
                ValidatorUtils.checkNonNull(testInlineFreeformAdditionalPropertiesRequest);

                                 handleTestInlineFreeformAdditionalProperties(request, response, testInlineFreeformAdditionalPropertiesRequest);
            })
            .exceptionally(throwable -> handleError(request, response, throwable));
    }
     ...
     * @param testInlineFreeformAdditionalPropertiesRequest request body 
     */
    abstract void handleTestInlineFreeformAdditionalProperties(ServerRequest request, ServerResponse response, TestInlineFreeformAdditionalPropertiesRequest testInlineFreeformAdditionalPropertiesRequest);
    ...
    void testNullable(ServerRequest request, ServerResponse response, ChildWithNullable childWithNullable) { 
        Single.create(Single.empty())
            .thenAccept(val -> {
                ValidatorUtils.checkNonNull(childWithNullable);

                                 handleTestNullable(request, response, childWithNullable);
            })
            .exceptionally(throwable -> handleError(request, response, throwable));
    }
     ...
     * @param childWithNullable request body 
     */
    abstract void handleTestNullable(ServerRequest request, ServerResponse response, ChildWithNullable childWithNullable);
        ...
        Single.create(request.content().as(new GenericType<Map<String, String>>() { }))
            .thenAccept(requestBody -> {
                ValidatorUtils.checkNonNull(requestBody);
                                 ...
                                 handleTestStringMapReference(request, response, requestBody);
            })
            .exceptionally(throwable -> handleError(request, response, throwable));
    }
     ...
     * @param requestBody request body 
     */
    abstract void handleTestStringMapReference(ServerRequest request, ServerResponse response, String requestBody);
