...
public abstract class UserService implements Service {
    ...
    void createUsersWithArrayInput(ServerRequest request, ServerResponse response) { 
        Single.create(request.content().as(new GenericType<List<@Valid User>>() { }))
            .thenAccept(user -> {
                ValidatorUtils.checkNonNull(user);
     ...
     */
    abstract void handleCreateUsersWithArrayInput(ServerRequest request, ServerResponse response, List<@Valid User> user);
     ...
     * @param user List of user object 
     */
    abstract void handleCreateUsersWithListInput(ServerRequest request, ServerResponse response, List<@Valid User> user);
