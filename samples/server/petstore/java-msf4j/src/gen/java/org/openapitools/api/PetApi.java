...
,@ApiParam(value = "" )@HeaderParam("api_key") String apiKey
    ...
    public Response findPetsByTags(@ApiParam(value = "Tags to filter by",required=true, defaultValue="new LinkedHashSet<>()") @DefaultValue("new LinkedHashSet<>()") @QueryParam("tags") Set<String> tags
)
    throws NotFoundException {
