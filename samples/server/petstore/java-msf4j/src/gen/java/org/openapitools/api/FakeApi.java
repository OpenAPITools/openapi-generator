...
public class FakeApi  {
   private final FakeApiService delegate = FakeApiServiceFactory.getFakeApi();
    ...
    public Response fakeOuterNumberSerialize(@ApiParam(value = "Input number as post body" ) Number body
)
    throws NotFoundException {
...
,@ApiParam(value = "" ,required=true) User body
    ...
    public Response testEndpointParameters(@ApiParam(value = "None", required=true)  @FormParam("number")  Number number
