...
,@ApiParam(value = "Form parameter enum test (string array)", allowableValues=">, $", defaultValue="EnumFormStringArrayEnum.DOLLAR")  @DefaultValue("EnumFormStringArrayEnum.DOLLAR") @FormParam("enum_form_string_array")  List<String> enumFormStringArray
