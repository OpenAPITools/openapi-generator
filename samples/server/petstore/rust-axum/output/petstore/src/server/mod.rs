...
where
    ...
    A: apis::pet::Pet<E, Claims = C> + apis::store::Store<E, Claims = C> + apis::user::User<E, Claims = C> + apis::ApiKeyAuthHeader<Claims = C> + Send + Sync + 'static,
    ...
    C: Send + Sync + 'static,
{
    ...
    Router::new()
        ...
        .route("/v2/user/login",
            get(login_user::<I, A, E, C>)
        )
        .route("/v2/user/logout",
            get(logout_user::<I, A, E, C>)
        )
        .route("/v2/user/{username}",
            delete(delete_user::<I, A, E, C>).get(get_user_by_name::<I, A, E, C>).put(update_user::<I, A, E, C>)
        )
        .with_state(api_impl)
}
