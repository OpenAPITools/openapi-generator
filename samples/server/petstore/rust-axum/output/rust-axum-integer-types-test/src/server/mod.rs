...
where
  ...
  let result = api_impl.as_ref().get_integers(
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::default::GetIntegersResponse::Status200_OK
                                                    (body)
                                                => {
