    ...
    A: Api,
{
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                AnyOfGetResponse::Status200_Success
                                                    (body)
                                                => {
                                                ...
                                                AnyOfGetResponse::Status201_AlternateSuccess
                                                    (body)
                                                => {
                                                ...
                                                AnyOfGetResponse::Status202_AnyOfSuccess
                                                    (body)
                                                => {
    ...
    A: Api,
{
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                MergePatchJsonGetResponse::Status200_Merge
                                                    (body)
                                                => {
                                                  ...
                                                  let mut response = response.status(200);
                                                  {
                                                    ...
                                                    response_headers.insert(
                                                        CONTENT_TYPE,
                                                        HeaderValue::from_str("application/merge-patch+json").map_err(|e| { error!(error = ?e); StatusCode::INTERNAL_SERVER_ERROR })?);
                                                  }
    ...
    A: Api,
{
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                MultigetGetResponse::Status200_JSONRsp
                                                    (body)
                                                => {
                                                ...
                                                MultigetGetResponse::Status201_XMLRsp
                                                    (body)
                                                => {
                                                ...
                                                MultigetGetResponse::Status202_OctetRsp
                                                    (body)
                                                => {
                                                ...
                                                MultigetGetResponse::Status203_StringRsp
                                                    (body)
                                                => {
                                                ...
                                                MultigetGetResponse::Status204_DuplicateResponseLongText
                                                    (body)
                                                => {
                                                ...
                                                MultigetGetResponse::Status205_DuplicateResponseLongText
                                                    (body)
                                                => {
                                                ...
                                                MultigetGetResponse::Status206_DuplicateResponseLongText
                                                    (body)
                                                => {
    ...
    A: Api,
{
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                OneOfGetResponse::Status200_Success
                                                    (body)
                                                => {
    ...
    A: Api,
{
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                ParamgetGetResponse::Status200_JSONRsp
                                                    (body)
                                                => {
    ...
    A: Api,
{
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                Rfc7807GetResponse::Status204_OK
                                                    (body)
                                                => {
                                                ...
                                                Rfc7807GetResponse::Status404_NotFound
                                                    (body)
                                                => {
                                                ...
                                                Rfc7807GetResponse::Status406_NotAcceptable
                                                    (body)
                                                => {
    ...
    A: Api,
{
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                UuidGetResponse::Status200_DuplicateResponseLongText
                                                    (body)
                                                => {
    ...
    A: Api,
{
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                XmlOtherPostResponse::Status201_OK
                                                    (body)
                                                => {
    ...
    A: Api,
{
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                GetRepoInfoResponse::Status200_OK
                                                    (body)
                                                => {
