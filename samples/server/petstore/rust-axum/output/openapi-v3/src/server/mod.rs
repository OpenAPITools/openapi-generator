...
where
    ...
    A: apis::default::Default<E> + apis::info_repo::InfoRepo<E> + apis::repo::Repo<E> + Send + Sync + 'static,
...
where
  ...
  let result = api_impl.as_ref().any_of_get(
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::default::AnyOfGetResponse::Status200_Success
                                                    (body)
                                                => {
                                                ...
                                                apis::default::AnyOfGetResponse::Status201_AlternateSuccess
                                                    (body)
                                                => {
                                                let mut response = Response::builder();
                                                ...
                                                apis::default::AnyOfGetResponse::Status202_AnyOfSuccess
                                                    (body)
                                                => {
                                                let mut response = Response::builder();
...
fn callback_with_header_post_validation(
  ...
  models::CallbackWithHeaderPostQueryParams,
), ValidationErrors>
{
  query_params.validate()?;
...
where
  ...
  let result = api_impl.as_ref().callback_with_header_post(
...
where
  ...
  let result = api_impl.as_ref().complex_query_param_get(
...
fn enum_in_path_path_param_get_validation(
  ...
  models::EnumInPathPathParamGetPathParams,
), ValidationErrors>
{
...
where
    ...
    E: std::fmt::Debug + Send + Sync + 'static,
      ...
      let validation =
    enum_in_path_path_param_get_validation(
        path_params,
    )
  ;
  ...
  let result = api_impl.as_ref().enum_in_path_path_param_get(
...
fn examples_test_validation(
  ...
  models::ExamplesTestQueryParams,
), ValidationErrors>
{
  query_params.validate()?;
...
where
  ...
  let result = api_impl.as_ref().examples_test(
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::default::ExamplesTestResponse::Status200_OK
                                                    (body)
                                                => {
                                                let mut response = Response::builder();
                                                  let mut response = response.status(200);
...
where
  ...
  let result = api_impl.as_ref().form_test(
...
fn get_with_boolean_parameter_validation(
  ...
  models::GetWithBooleanParameterQueryParams,
), ValidationErrors>
{
  query_params.validate()?;
...
where
  ...
  let result = api_impl.as_ref().get_with_boolean_parameter(
...
where
    ...
    E: std::fmt::Debug + Send + Sync + 'static,
      ...
      let validation =
    json_complex_query_param_get_validation(
        query_params,
    )
  ;
  ...
  let result = api_impl.as_ref().json_complex_query_param_get(
...
where
    ...
    let header_params = {
                ...
                let header_x_header = match header_x_header {
                    Some(v) => match header::IntoHeaderValue::<String>::try_from((*v).clone()) {
                        ...
                        Err(err) => {
                            return Response::builder()
                                        .status(StatusCode::BAD_REQUEST)
                                        .body(Body::from(format!("Invalid header X-Header - {err}"))).map_err(|e| { error!(error = ?e); StatusCode::INTERNAL_SERVER_ERROR });
                    ...
                    None => {
                        return Response::builder()
                                        .status(StatusCode::BAD_REQUEST)
                                        .body(Body::from("Missing required header X-Header")).map_err(|e| { error!(error = ?e); StatusCode::INTERNAL_SERVER_ERROR });
                    }
                };
      ...
      let validation =
    mandatory_request_header_get_validation(
        header_params,
    )
  ;
  ...
  let result = api_impl.as_ref().mandatory_request_header_get(
...
#[tracing::instrument(skip_all)]
fn merge_patch_json_get_validation(
) -> std::result::Result<(
), ValidationErrors>
{
...
where
  ...
  let result = api_impl.as_ref().merge_patch_json_get(
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::default::MergePatchJsonGetResponse::Status200_Merge
                                                    (body)
                                                => {
                                                let mut response = Response::builder();
                                                  let mut response = response.status(200);
...
where
  ...
  let result = api_impl.as_ref().multiget_get(
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::default::MultigetGetResponse::Status200_JSONRsp
                                                    (body)
                                                => {
                                                let mut response = Response::builder();
                                                  let mut response = response.status(200);
                                                ...
                                                apis::default::MultigetGetResponse::Status201_XMLRsp
                                                    (body)
                                                => {
                                                let mut response = Response::builder();
                                                  let mut response = response.status(201);
                                                ...
                                                apis::default::MultigetGetResponse::Status202_OctetRsp
                                                    (body)
                                                => {
                                                let mut response = Response::builder();
                                                  let mut response = response.status(202);
                                                ...
                                                apis::default::MultigetGetResponse::Status203_StringRsp
                                                    (body)
                                                => {
                                                let mut response = Response::builder();
                                                ...
                                                apis::default::MultigetGetResponse::Status204_DuplicateResponseLongText
                                                    (body)
                                                => {
                                                let mut response = Response::builder();
                                                  let mut response = response.status(204);
                                                ...
                                                apis::default::MultigetGetResponse::Status205_DuplicateResponseLongText
                                                    (body)
                                                => {
                                                let mut response = Response::builder();
                                                ...
                                                apis::default::MultigetGetResponse::Status206_DuplicateResponseLongText
                                                    (body)
                                                => {
                                                let mut response = Response::builder();
...
#[tracing::instrument(skip_all)]
fn multiple_auth_scheme_get_validation(
) -> std::result::Result<(
), ValidationErrors>
{
...
where
    ...
    E: std::fmt::Debug + Send + Sync + 'static,
      ...
      let validation =
    multiple_auth_scheme_get_validation(
    )
  ;
  ...
  let result = api_impl.as_ref().multiple_auth_scheme_get(
...
#[tracing::instrument(skip_all)]
async fn multiple_path_params_with_very_long_path_to_test_formatting_path_param_a_path_param_b_get<I, A, E>(
  method: Method,
  TypedHeader(host): TypedHeader<Host>,
  cookies: CookieJar,
  Path(path_params): Path<models::MultiplePathParamsWithVeryLongPathToTestFormattingPathParamAPathParamBGetPathParams>,
 State(api_impl): State<I>,
) -> Result<Response, StatusCode>
where
    I: AsRef<A> + Send + Sync,
  ...
  let result = api_impl.as_ref().multiple_path_params_with_very_long_path_to_test_formatting_path_param_a_path_param_b_get(
...
where
    ...
    E: std::fmt::Debug + Send + Sync + 'static,
      ...
      let validation =
    multiple_response_content_types_validation(
          body,
    )
  ;
  ...
  let result = api_impl.as_ref().multiple_response_content_types(
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::default::MultipleResponseContentTypesResponse::Status201_Created
                                                    (body)
                                                => {
                                                let mut response = Response::builder();
                                                  let mut response = response.status(201);
                                                ...
                                                apis::default::MultipleResponseContentTypesResponse::Status403_Forbidden
                                                    (body)
                                                => {
                                                let mut response = Response::builder();
...
where
  ...
  let result = api_impl.as_ref().one_of_get(
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::default::OneOfGetResponse::Status200_Success
                                                    (body)
                                                => {
                                                let mut response = Response::builder();
                                                  let mut response = response.status(200);
...
#[tracing::instrument(skip_all)]
fn override_server_get_validation(
) -> std::result::Result<(
), ValidationErrors>
{
...
where
    ...
    E: std::fmt::Debug + Send + Sync + 'static,
      ...
      let validation =
    override_server_get_validation(
    )
  ;
  ...
  let result = api_impl.as_ref().override_server_get(
...
where
  ...
  let result = api_impl.as_ref().paramget_get(
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::default::ParamgetGetResponse::Status200_JSONRsp
                                                    (body)
                                                => {
                                                let mut response = Response::builder();
                                                  let mut response = response.status(200);
...
fn query_example_get_validation(
  ...
  models::QueryExampleGetQueryParams,
), ValidationErrors>
{
  query_params.validate()?;
...
where
  ...
  let result = api_impl.as_ref().query_example_get(
...
#[tracing::instrument(skip_all)]
fn readonly_auth_scheme_get_validation(
) -> std::result::Result<(
), ValidationErrors>
{
...
where
    ...
    E: std::fmt::Debug + Send + Sync + 'static,
      ...
      let validation =
    readonly_auth_scheme_get_validation(
    )
  ;
  ...
  let result = api_impl.as_ref().readonly_auth_scheme_get(
...
where
    ...
    E: std::fmt::Debug + Send + Sync + 'static,
      ...
      let validation =
    register_callback_post_validation(
        query_params,
    )
  ;
  ...
  let result = api_impl.as_ref().register_callback_post(
...
where
    ...
    E: std::fmt::Debug + Send + Sync + 'static,
      ...
      let validation =
    required_binary_stream_put_validation(
          body,
    )
  ;
  ...
  let result = api_impl.as_ref().required_binary_stream_put(
...
where
    ...
    E: std::fmt::Debug + Send + Sync + 'static,
      ...
      let validation =
    required_octet_stream_put_validation(
          body,
    )
  ;
  ...
  let result = api_impl.as_ref().required_octet_stream_put(
...
#[tracing::instrument(skip_all)]
fn responses_with_headers_get_validation(
) -> std::result::Result<(
), ValidationErrors>
{
...
where
  ...
  let result = api_impl.as_ref().responses_with_headers_get(
...
where
  ...
  let result = api_impl.as_ref().rfc7807_get(
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::default::Rfc7807GetResponse::Status204_OK
                                                    (body)
                                                => {
                                                let mut response = Response::builder();
                                                  let mut response = response.status(204);
                                                ...
                                                apis::default::Rfc7807GetResponse::Status404_NotFound
                                                    (body)
                                                => {
                                                let mut response = Response::builder();
                                                ...
                                                apis::default::Rfc7807GetResponse::Status406_NotAcceptable
                                                    (body)
                                                => {
                                                let mut response = Response::builder();
...
where
                ...
                let header_x_header_one = match header_x_header_one {
                    Some(v) => match header::IntoHeaderValue::<bool>::try_from((*v).clone()) {
                        ...
                        Err(err) => {
                            return Response::builder()
                                        .status(StatusCode::BAD_REQUEST)
                                        .body(Body::from(format!("Invalid header x-header-one - {err}"))).map_err(|e| { error!(error = ?e); StatusCode::INTERNAL_SERVER_ERROR });
                ...
                let header_x_header_two = match header_x_header_two {
                    Some(v) => match header::IntoHeaderValue::<bool>::try_from((*v).clone()) {
                        ...
                        Err(err) => {
                            return Response::builder()
                                        .status(StatusCode::BAD_REQUEST)
                                        .body(Body::from(format!("Invalid header x-header-two - {err}"))).map_err(|e| { error!(error = ?e); StatusCode::INTERNAL_SERVER_ERROR });
  ...
  let result = api_impl.as_ref().two_first_letter_headers(
...
fn untyped_property_get_validation(
        ...
        Option<models::ObjectUntypedProps>,
), ValidationErrors>
{
...
where
    ...
    E: std::fmt::Debug + Send + Sync + 'static,
      ...
      let validation =
    untyped_property_get_validation(
          body,
    )
  ;
  ...
  let result = api_impl.as_ref().untyped_property_get(
...
where
  ...
  let result = api_impl.as_ref().uuid_get(
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::default::UuidGetResponse::Status200_DuplicateResponseLongText
                                                    (body)
                                                => {
                                                let mut response = Response::builder();
                                                  let mut response = response.status(200);
...
where
  ...
  let result = api_impl.as_ref().xml_extra_post(
...
where
  ...
  let result = api_impl.as_ref().xml_other_post(
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::default::XmlOtherPostResponse::Status201_OK
                                                    (body)
                                                => {
                                                let mut response = Response::builder();
                                                  let mut response = response.status(201);
...
where
  ...
  let result = api_impl.as_ref().xml_other_put(
...
where
  ...
  let result = api_impl.as_ref().xml_post(
...
where
  ...
  let result = api_impl.as_ref().xml_put(
...
where
  ...
  let result = api_impl.as_ref().get_repo_info(
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::info_repo::GetRepoInfoResponse::Status200_OK
                                                    (body)
                                                => {
                                                let mut response = Response::builder();
                                                  let mut response = response.status(200);
...
where
  ...
  let result = api_impl.as_ref().create_repo(
