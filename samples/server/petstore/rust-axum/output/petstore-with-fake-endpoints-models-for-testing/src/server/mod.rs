    ...
    A: Api + 'static,
{
    ...
    Router::new()
        .route("/v2/another-fake/dummy",
            patch(test_special_tags::<I, A>)
        )
        .route("/v2/fake",
            get(test_enum_parameters::<I, A>).patch(test_client_model::<I, A>).post(test_endpoint_parameters::<I, A>)
        )
    ...
    A: Api,
{
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                TestSpecialTagsResponse::Status200_SuccessfulOperation
                                                    (body)
                                                => {
    ...
    A: Api,
{
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                FakeOuterBooleanSerializeResponse::Status200_OutputBoolean
                                                    (body)
                                                => {
    ...
    A: Api,
{
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                FakeOuterCompositeSerializeResponse::Status200_OutputComposite
                                                    (body)
                                                => {
    ...
    A: Api,
{
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                FakeOuterNumberSerializeResponse::Status200_OutputNumber
                                                    (body)
                                                => {
    ...
    A: Api,
{
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                FakeOuterStringSerializeResponse::Status200_OutputString
                                                    (body)
                                                => {
    ...
    A: Api,
{
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                TestClientModelResponse::Status200_SuccessfulOperation
                                                    (body)
                                                => {
    ...
    A: Api,
{
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                TestClassnameResponse::Status200_SuccessfulOperation
                                                    (body)
                                                => {
    ...
    A: Api,
{
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                FindPetsByStatusResponse::Status200_SuccessfulOperation
                                                    (body)
                                                => {
    ...
    A: Api,
{
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                FindPetsByTagsResponse::Status200_SuccessfulOperation
                                                    (body)
                                                => {
    ...
    A: Api,
{
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                GetPetByIdResponse::Status200_SuccessfulOperation
                                                    (body)
                                                => {
    ...
    A: Api,
{
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                UploadFileResponse::Status200_SuccessfulOperation
                                                    (body)
                                                => {
    ...
    A: Api,
{
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                GetInventoryResponse::Status200_SuccessfulOperation
                                                    (body)
                                                => {
    ...
    A: Api,
{
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                GetOrderByIdResponse::Status200_SuccessfulOperation
                                                    (body)
                                                => {
    ...
    A: Api,
{
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                PlaceOrderResponse::Status200_SuccessfulOperation
                                                    (body)
                                                => {
    ...
    A: Api,
{
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                GetUserByNameResponse::Status200_SuccessfulOperation
                                                    (body)
                                                => {
