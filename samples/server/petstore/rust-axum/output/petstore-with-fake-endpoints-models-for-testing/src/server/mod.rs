...
where
    ...
    A: apis::another_fake::AnotherFake<E> + apis::fake::Fake<E, Claims = C> + apis::fake_classname_tags123::FakeClassnameTags123<E> + apis::pet::Pet<E, Claims = C> + apis::store::Store<E, Claims = C> + apis::user::User<E> + apis::ApiKeyAuthHeader<Claims = C> + apis::ApiAuthBasic<Claims = C> + Send + Sync + 'static,
    ...
    C: Send + Sync + 'static,
{
    ...
    Router::new()
        ...
        .route("/v2/fake",
            get(test_enum_parameters::<I, A, E, C>).patch(test_client_model::<I, A, E, C>).post(test_endpoint_parameters::<I, A, E, C>)
        )
        .route("/v2/fake/body-with-query-params",
            put(test_body_with_query_params::<I, A, E, C>)
        )
        .route("/v2/fake/hyphenParam/{hyphen_param}",
        ...
        .route("/v2/fake/operation-with-numeric-id",
        ...
        .route("/v2/user/login",
            get(login_user::<I, A, E>)
        )
        .route("/v2/user/logout",
            get(logout_user::<I, A, E>)
        )
        .route("/v2/user/{username}",
            delete(delete_user::<I, A, E>).get(get_user_by_name::<I, A, E>).put(update_user::<I, A, E>)
        )
        .with_state(api_impl)
}
...
where
  ...
  let result = api_impl.as_ref().test_special_tags(
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::another_fake::TestSpecialTagsResponse::Status200_SuccessfulOperation
                                                    (body)
                                                => {
...
where
  ...
  let result = api_impl.as_ref().call123example(
...
where
    ...
    E: std::fmt::Debug + Send + Sync + 'static,
      ...
      #[allow(clippy::redundant_closure)]
      let validation = tokio::task::spawn_blocking(move ||
    fake_outer_boolean_serialize_validation(
          body,
    )
  ).await.unwrap();
  ...
  let result = api_impl.as_ref().fake_outer_boolean_serialize(
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::fake::FakeOuterBooleanSerializeResponse::Status200_OutputBoolean
                                                    (body)
                                                => {
                                                let mut response = Response::builder();
                                                  let mut response = response.status(200);
...
where
    ...
    E: std::fmt::Debug + Send + Sync + 'static,
      ...
      #[allow(clippy::redundant_closure)]
      let validation = tokio::task::spawn_blocking(move ||
    fake_outer_composite_serialize_validation(
          body,
    )
  ).await.unwrap();
  ...
  let result = api_impl.as_ref().fake_outer_composite_serialize(
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::fake::FakeOuterCompositeSerializeResponse::Status200_OutputComposite
                                                    (body)
                                                => {
                                                let mut response = Response::builder();
                                                  let mut response = response.status(200);
...
where
    ...
    E: std::fmt::Debug + Send + Sync + 'static,
      ...
      #[allow(clippy::redundant_closure)]
      let validation = tokio::task::spawn_blocking(move ||
    fake_outer_number_serialize_validation(
          body,
    )
  ).await.unwrap();
  ...
  let result = api_impl.as_ref().fake_outer_number_serialize(
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::fake::FakeOuterNumberSerializeResponse::Status200_OutputNumber
                                                    (body)
                                                => {
                                                let mut response = Response::builder();
                                                  let mut response = response.status(200);
...
where
    ...
    E: std::fmt::Debug + Send + Sync + 'static,
      ...
      #[allow(clippy::redundant_closure)]
      let validation = tokio::task::spawn_blocking(move ||
    fake_outer_string_serialize_validation(
          body,
    )
  ).await.unwrap();
  ...
  let result = api_impl.as_ref().fake_outer_string_serialize(
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::fake::FakeOuterStringSerializeResponse::Status200_OutputString
                                                    (body)
                                                => {
                                                let mut response = Response::builder();
                                                  let mut response = response.status(200);
...
#[tracing::instrument(skip_all)]
fn fake_response_with_numerical_description_validation(
) -> std::result::Result<(
), ValidationErrors>
{
...
where
  ...
  let result = api_impl.as_ref().fake_response_with_numerical_description(
...
where
  ...
  let result = api_impl.as_ref().hyphen_param(
...
fn test_body_with_query_params_validation(
  ...
  models::TestBodyWithQueryParamsQueryParams,
        models::User,
), ValidationErrors>
{
...
where
    ...
    E: std::fmt::Debug + Send + Sync + 'static,
      ...
      #[allow(clippy::redundant_closure)]
      let validation = tokio::task::spawn_blocking(move ||
    test_body_with_query_params_validation(
        query_params,
          body,
    )
  ).await.unwrap();
  ...
  let result = api_impl.as_ref().test_body_with_query_params(
...
where
  ...
  let result = api_impl.as_ref().test_client_model(
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::fake::TestClientModelResponse::Status200_SuccessfulOperation
                                                    (body)
                                                => {
                                                let mut response = Response::builder();
                                                  let mut response = response.status(200);
...
fn test_endpoint_parameters_validation(
        ...
        models::TestEndpointParametersRequest,
), ValidationErrors>
{
...
where
    ...
    let Some(claims) = claims else {
      ...
      #[allow(clippy::redundant_closure)]
      let validation = tokio::task::spawn_blocking(move ||
    test_endpoint_parameters_validation(
          body,
    )
  ).await.unwrap();
  ...
  let result = api_impl.as_ref().test_endpoint_parameters(
...
where
    ...
    // Header parameters
    let header_params = {
                let header_enum_header_string_array = headers.get(HeaderName::from_static("enum_header_string_array"));
                ...
                let header_enum_header_string_array = match header_enum_header_string_array {
                    Some(v) => match header::IntoHeaderValue::<Vec<String>>::try_from((*v).clone()) {
                        ...
                        Err(err) => {
                            return Response::builder()
                                        .status(StatusCode::BAD_REQUEST)
                                        .body(Body::from(format!("Invalid header enum_header_string_array - {err}"))).map_err(|e| { error!(error = ?e); StatusCode::INTERNAL_SERVER_ERROR });
                ...
                let header_enum_header_string = match header_enum_header_string {
                    Some(v) => match header::IntoHeaderValue::<String>::try_from((*v).clone()) {
                        ...
                        Err(err) => {
                            return Response::builder()
                                        .status(StatusCode::BAD_REQUEST)
                                        .body(Body::from(format!("Invalid header enum_header_string - {err}"))).map_err(|e| { error!(error = ?e); StatusCode::INTERNAL_SERVER_ERROR });
      ...
      #[allow(clippy::redundant_closure)]
      let validation = tokio::task::spawn_blocking(move ||
    test_enum_parameters_validation(
        header_params,
        query_params,
          body,
    )
  ...
  let result = api_impl.as_ref().test_enum_parameters(
...
where
  ...
  let result = api_impl.as_ref().test_inline_additional_properties(
...
where
    ...
    E: std::fmt::Debug + Send + Sync + 'static,
      ...
      #[allow(clippy::redundant_closure)]
      let validation = tokio::task::spawn_blocking(move ||
    test_json_form_data_validation(
          body,
    )
  ).await.unwrap();
  ...
  let result = api_impl.as_ref().test_json_form_data(
...
where
  ...
  let result = api_impl.as_ref().test_classname(
...
where
    ...
    // Authentication
    let claims_in_header = api_impl.as_ref().extract_claims_from_header(&headers, "api_key").await;
    let claims = None
              .or(claims_in_header)
          ;
    let Some(claims) = claims else {
...
where
    ...
    E: std::fmt::Debug + Send + Sync + 'static,
      ...
      #[allow(clippy::redundant_closure)]
      let validation = tokio::task::spawn_blocking(move ||
    create_users_with_array_input_validation(
          body,
    )
  ).await.unwrap();
