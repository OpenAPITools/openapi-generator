...
where
  ...
  let result = api_impl.as_ref().foo(
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::default::FooResponse::Status200_Re
                                                    (body)
                                                => {
...
where
  ...
  let result = api_impl.as_ref().i211431(
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::default::I211431Response::Status200_Re
                                                    (body)
                                                => {
                                                let mut response = Response::builder();
                                                  let mut response = response.status(200);
...
where
  ...
  let result = api_impl.as_ref().i211432(
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::default::I211432Response::Status200_Re
                                                    (body)
                                                => {
                                                let mut response = Response::builder();
                                                  let mut response = response.status(200);
...
where
  ...
  let result = api_impl.as_ref().i211433(
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::default::I211433Response::Status200_Re
                                                    (body)
                                                => {
                                                let mut response = Response::builder();
                                                  let mut response = response.status(200);
