...
public interface PetApi {
    ...
    default ResponseEntity<Void> addPet(
        @ApiParam(value = "Pet object that needs to be added to the store", required = true) @RequestBody @NotNull @Valid PetDto petDto
    ) {
    ...
    @ApiResponses({
        @ApiResponse(code = 200, message = "successful operation", response = PetDto.class, responseContainer = "array"),
    ...
    default ResponseEntity<List<PetDto>> findPetsByStatus(
        @ApiParam(value = "Status values that need to be considered for filter", required = true, allowableValues = "available, pending, sold") @RequestParam(value = "status") @NotNull List<StatusEnum> status
    ) {
