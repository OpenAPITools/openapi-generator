...
public interface UserApi {
    ...
    default ResponseEntity<String> loginUser(
        ...
        return getDelegate().loginUser(username, password, someValue, someHeaderValue, headers, principal, mapper);
    }
    ...
    default ResponseEntity<Void> logoutUser(
        ...
        return getDelegate().logoutUser( somePropertyValue, someHeaderValue, headers, principal, mapper);
    }
