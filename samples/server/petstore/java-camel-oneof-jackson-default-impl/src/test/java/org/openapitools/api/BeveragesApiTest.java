...
public class BeveragesApiTest {
    private static final String API_URL = "http://127.0.0.1:8080/api/v1";

    @Test
    public void createBeverageTestJson() throws Exception {
        String contentType = "application/json";
        String accept = "application/json";
        String url = API_URL + "/beverages";
        ...
        String requestBody = "{ \"beverageType\" : \"beverageType\" }";
    ...
    @Test
    public void createBeverageTestXml() throws Exception {
