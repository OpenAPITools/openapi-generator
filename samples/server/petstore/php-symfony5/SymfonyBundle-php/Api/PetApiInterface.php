...
interface PetApiInterface
{
     ...
     *
     * @param  int $petId  ID of pet to update (required)
     * @param  UploadedFile $requiredFile  file to upload (required)
     * @param  string $additionalMetadata  Additional data to pass to server (optional)
     * @param  integer $responseCode     The HTTP response code to return
     * @param  array   $responseHeaders  Additional HTTP headers to return with the response ()
     *
     ...
     *
     */
    public function uploadFileWithRequiredFile($petId, UploadedFile $requiredFile, $additionalMetadata = null, &$responseCode, array &$responseHeaders);
}
