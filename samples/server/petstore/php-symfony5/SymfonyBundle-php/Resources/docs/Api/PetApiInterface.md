...
[**uploadFileWithRequiredFile**](PetApiInterface.md#uploadFileWithRequiredFile) | **POST** /fake/{petId}/uploadImageWithRequiredFile | uploads an image (required)
...
class PetApi implements PetApiInterface
{
    ...
    /**
     * Implementation of PetApiInterface#uploadFileWithRequiredFile
     */
    public function uploadFileWithRequiredFile($petId, UploadedFile $requiredFile, $additionalMetadata = null)
    {
        // Implement the operation ...
    }
...
------------- | ------------- | ------------- | -------------
 **petId** | **int**| ID of pet to update |
 **requiredFile** | **UploadedFile****UploadedFile**| file to upload |
 **additionalMetadata** | **string**| Additional data to pass to server | [optional]
