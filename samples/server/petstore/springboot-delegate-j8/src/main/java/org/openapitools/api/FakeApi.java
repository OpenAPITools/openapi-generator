...
public interface FakeApi {
    ...
    default ResponseEntity<Void> testEndpointParameters(
        ...
        @ApiParam(value = "None") @Valid @RequestParam(value = "integer", required = false) Integer _integer,
        ...
        @ApiParam(value = "None") @Valid @RequestParam(value = "string", required = false) String _string,
        @ApiParam(value = "None") @RequestPart(value = "binary", required = false) MultipartFile binary,
        @ApiParam(value = "None") @Valid @RequestParam(value = "date", required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate _date,
        @ApiParam(value = "None") @Valid @RequestParam(value = "dateTime", required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) OffsetDateTime _dateTime,
        ...
        return getDelegate().testEndpointParameters(number, _double, patternWithoutDelimiter, _byte, _integer, int32, int64, _float, _string, binary, _date, _dateTime, password, paramCallback);
    }
