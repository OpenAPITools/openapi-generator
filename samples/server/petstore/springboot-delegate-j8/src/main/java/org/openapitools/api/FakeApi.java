...
public interface FakeApi {
    ...
    default ResponseEntity<Void> testBodyWithFileSchema(
        @ApiParam(value = "", required = true) @NotNull @Valid @RequestBody FileSchemaTestClass fileSchemaTestClass
    ) {
    ...
    default ResponseEntity<Void> testBodyWithQueryParams(
        ...
        @ApiParam(value = "", required = true) @NotNull @Valid @RequestBody User user
    ) {
    ...
    default ResponseEntity<Void> testNullable(
        @ApiParam(value = "request body", required = true) @NotNull @Valid @RequestBody ChildWithNullable childWithNullable
    ) {
