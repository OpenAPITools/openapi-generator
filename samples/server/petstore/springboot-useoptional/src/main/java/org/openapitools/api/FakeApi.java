...
public interface FakeApi {
    ...
    default ResponseEntity<Void> testEnumParameters(
        ...
        @ApiParam(value = "Header parameter enum test (string)", allowableValues = "_abc, -efg, (xyz)", defaultValue = "-efg") @RequestHeader(value = "enum_header_string", required = false) Optional<EnumHeaderStringEnum> enumHeaderString,
    ...
    default ResponseEntity<Void> testGroupParameters(
        ...
        @ApiParam(value = "String in group parameters") @Valid @RequestParam(value = "string_group", required = false) Optional<> stringGroup,
        @ApiParam(value = "Boolean in group parameters") @RequestHeader(value = "boolean_group", required = false) Optional<> booleanGroup,
        @ApiParam(value = "Integer in group parameters") @Valid @RequestParam(value = "int64_group", required = false) Optional<> int64Group
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
