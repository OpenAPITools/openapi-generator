...
public interface PetApi {
    ...
    default ResponseEntity<Void> deletePet( @ApiParam(value = "Pet id to delete", required=true, example="56") @PathVariable("petId") Long petId, @ApiParam(value = "", example="apiKey_example") @RequestHeader(value="api_key", required=false) Optional<String> apiKey) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
