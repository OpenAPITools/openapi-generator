...
public interface PetApiControllerImpInterface {
    ...
    default Result findPetsByTagsHttp(Http.Request request, @NotNull Set<String> tags) throws Exception {
    ...
    default Result uploadFileWithRequiredFileHttp(Http.Request request, Long petId, Http.MultipartFormData.FilePart requiredFile, String additionalMetadata) throws Exception {
