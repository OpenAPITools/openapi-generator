...
public class PetApiControllerImp implements PetApiControllerImpInterface {
    ...
    @Override
    public Set<Pet> findPetsByTags(Request request, @NotNull Set<String> tags) throws Exception {
        //Do your magic!!!
    ...
    @Override
    public ModelApiResponse uploadFileWithRequiredFile(Request request, Long petId, Http.MultipartFormData.FilePart requiredFile, String additionalMetadata) throws Exception {
        //Do your magic!!!
        return new ModelApiResponse();
    }
