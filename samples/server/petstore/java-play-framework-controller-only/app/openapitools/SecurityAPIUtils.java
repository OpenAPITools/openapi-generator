...
public class SecurityAPIUtils {
	...
	// Online validation
	private HashMap<String, String> tokenIntrospectEndpoints = new HashMap<String, String>();
	private final String clientId;
	private final String clientSecret;

	// Offline validation
	private HashMap<String, String> jwksEndpoints = new HashMap<String, String>();
	...
	public boolean isRequestTokenValid(Http.Request request, String securityMethodName) throws Exception {
