...
pub trait Api<C: Send + Sync> {
    ...
    async fn test_enum_parameters(
        ...
        enum_query_string_array: Option<&Vec<models::TestEnumParametersEnumQueryStringArrayParameterInner>>,
        enum_query_string: Option<models::TestEnumParametersEnumQueryStringParameter>,
