...
use JMS\Serializer\Vistor\DeserializationVisitorInterface;
...
class StrictJsonDeserializationVisitor implements DeserializationVisitorInterface
{
    ...
    {
        return $this->jsonDeserializationVisitor->startVisitingObject($metadata, $object, $type);
    }
    ...
    {
        return $this->jsonDeserializationVisitor->endVisitingObject($metadata, $object, $type);
    }
