...
use OpenAPI\Server\Service\StrictJsonDeserializationVisitorFactory;
...
class JmsSerializer implements SerializerInterface
{
    ...
    public function __construct()
    {
        $this->serializer = SerializerBuilder::create()
            ->setDeserializationVisitor('json', new StrictJsonDeserializationVisitorFactory(new JsonDeserializationVisitorFactory()))
