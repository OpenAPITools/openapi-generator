...
@Parameter(name = "Pet object that needs to be added to the store", required = true )   @Valid @org.springframework.web.bind.annotation.RequestBody @RequestBody Pet body) {
    ...
    default ResponseEntity<Void> deletePet(@Parameter(name = "petId", description = "Pet id to delete", required = true) @PathVariable("petId") Long petId
...
@Parameter(description = "") @RequestHeader(value = "api_key", required = false) String apiKey
    ...
    default ResponseEntity<Set<Pet>> findPetsByTags(@NotNull @Parameter(name = "tags", description = "Tags to filter by", required = true) @Valid @RequestParam(value = "tags", required = true) Set<String> tags
    ...
    default ResponseEntity<Pet> getPetById(@Parameter(name = "petId", description = "ID of pet to return", required = true) @PathVariable("petId") Long petId
...
@Parameter(name = "Pet object that needs to be added to the store", required = true )   @Valid @org.springframework.web.bind.annotation.RequestBody @RequestBody Pet body) {
    ...
    default ResponseEntity<Void> updatePetWithForm(@Parameter(name = "petId", description = "ID of pet that needs to be updated", required = true) @PathVariable("petId") Long petId
...
@Parameter(name = "status", description = "Updated status of the pet") @Valid @RequestPart(value = "status", required = false) String status) {
    ...
    default ResponseEntity<ModelApiResponse> uploadFile(@Parameter(name = "petId", description = "ID of pet to update", required = true) @PathVariable("petId") Long petId
...
@Parameter(name = "file", description = "file to upload") @Valid @RequestPart(value = "file", required = false) MultipartFile file) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
