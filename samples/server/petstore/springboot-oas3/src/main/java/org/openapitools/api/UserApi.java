...
@Parameter(name = "Created user object", required = true )   @Valid @org.springframework.web.bind.annotation.RequestBody @RequestBody User body) {
...
@Parameter(name = "List of user object", required = true )   @Valid @org.springframework.web.bind.annotation.RequestBody @RequestBody List<User> body) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
...
@Parameter(name = "List of user object", required = true )   @Valid @org.springframework.web.bind.annotation.RequestBody @RequestBody List<User> body) {
    ...
    default ResponseEntity<String> loginUser(@NotNull @Parameter(name = "username", description = "The user name for login", required = true) @Valid @RequestParam(value = "username", required = true) String username
...
@Parameter(name = "Updated user object", required = true )   @Valid @org.springframework.web.bind.annotation.RequestBody @RequestBody User body) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
