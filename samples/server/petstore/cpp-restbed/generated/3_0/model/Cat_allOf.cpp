...
std::string Cat_allOf::toJsonString(bool prettyJson /* = false */)
{
...
boost::property_tree::ptree Cat_allOf::toPropertyTree()
{
    return toPropertyTree_internal();
}

void Cat_allOf::fromPropertyTree(boost::property_tree::ptree const& pt)
{
    fromPropertyTree_internal(pt);
}

std::string Cat_allOf::toJsonString_internal(bool prettyJson)
{
	std::stringstream ss;
...
void Cat_allOf::fromJsonString_internal(std::string const& jsonString)
{
...
ptree Cat_allOf::toPropertyTree_internal()
{
	ptree pt;
	ptree tmp_node;
...
void Cat_allOf::fromPropertyTree_internal(ptree const &pt)
{
	ptree tmp_node;
