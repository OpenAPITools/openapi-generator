...
std::string ClassModel::toJsonString(bool prettyJson /* = false */)
{
...
boost::property_tree::ptree ClassModel::toPropertyTree()
{
    return toPropertyTree_internal();
}

void ClassModel::fromPropertyTree(boost::property_tree::ptree const& pt)
{
    fromPropertyTree_internal(pt);
}

std::string ClassModel::toJsonString_internal(bool prettyJson)
{
	std::stringstream ss;
...
void ClassModel::fromJsonString_internal(std::string const& jsonString)
{
...
ptree ClassModel::toPropertyTree_internal()
{
	ptree pt;
	ptree tmp_node;
...
void ClassModel::fromPropertyTree_internal(ptree const &pt)
{
	ptree tmp_node;
