...
std::string HealthCheckResult::toJsonString(bool prettyJson /* = false */)
{
...
boost::property_tree::ptree HealthCheckResult::toPropertyTree()
{
    return toPropertyTree_internal();
}

void HealthCheckResult::fromPropertyTree(boost::property_tree::ptree const& pt)
{
    fromPropertyTree_internal(pt);
}

std::string HealthCheckResult::toJsonString_internal(bool prettyJson)
{
	std::stringstream ss;
...
void HealthCheckResult::fromJsonString_internal(std::string const& jsonString)
{
...
ptree HealthCheckResult::toPropertyTree_internal()
{
	ptree pt;
	ptree tmp_node;
...
void HealthCheckResult::fromPropertyTree_internal(ptree const &pt)
{
	ptree tmp_node;
