...
std::string OuterEnumDefaultValue::toJsonString(bool prettyJson /* = false */)
{
...
boost::property_tree::ptree OuterEnumDefaultValue::toPropertyTree()
{
    return toPropertyTree_internal();
}

void OuterEnumDefaultValue::fromPropertyTree(boost::property_tree::ptree const& pt)
{
    fromPropertyTree_internal(pt);
}

std::string OuterEnumDefaultValue::toJsonString_internal(bool prettyJson)
{
	std::stringstream ss;
...
void OuterEnumDefaultValue::fromJsonString_internal(std::string const& jsonString)
{
...
ptree OuterEnumDefaultValue::toPropertyTree_internal()
{
	ptree pt;
	ptree tmp_node;
	return pt;
...
void OuterEnumDefaultValue::fromPropertyTree_internal(ptree const &pt)
{
	ptree tmp_node;
}
