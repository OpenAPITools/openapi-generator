...
std::string OuterObjectWithEnumProperty::toJsonString(bool prettyJson /* = false */)
{
...
boost::property_tree::ptree OuterObjectWithEnumProperty::toPropertyTree()
{
    return toPropertyTree_internal();
}

void OuterObjectWithEnumProperty::fromPropertyTree(boost::property_tree::ptree const& pt)
{
    fromPropertyTree_internal(pt);
}

std::string OuterObjectWithEnumProperty::toJsonString_internal(bool prettyJson)
{
	std::stringstream ss;
...
void OuterObjectWithEnumProperty::fromJsonString_internal(std::string const& jsonString)
{
...
ptree OuterObjectWithEnumProperty::toPropertyTree_internal()
{
	ptree pt;
	ptree tmp_node;
	return pt;
...
void OuterObjectWithEnumProperty::fromPropertyTree_internal(ptree const &pt)
{
	ptree tmp_node;
}

std::shared_ptr<OuterEnumInteger> OuterObjectWithEnumProperty::getValue() const
{
    return m_Value;
}

void OuterObjectWithEnumProperty::setValue(std::shared_ptr<OuterEnumInteger> value)
{
	m_Value = value;
}
