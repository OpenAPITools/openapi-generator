...
std::string EnumClass::toJsonString(bool prettyJson /* = false */)
{
...
boost::property_tree::ptree EnumClass::toPropertyTree()
{
    return toPropertyTree_internal();
}

void EnumClass::fromPropertyTree(boost::property_tree::ptree const& pt)
{
    fromPropertyTree_internal(pt);
}

std::string EnumClass::toJsonString_internal(bool prettyJson)
{
	std::stringstream ss;
...
void EnumClass::fromJsonString_internal(std::string const& jsonString)
{
...
ptree EnumClass::toPropertyTree_internal()
{
	ptree pt;
	ptree tmp_node;
	return pt;
...
void EnumClass::fromPropertyTree_internal(ptree const &pt)
{
	ptree tmp_node;
}
