...
std::string OuterEnumInteger::toJsonString(bool prettyJson /* = false */)
{
...
boost::property_tree::ptree OuterEnumInteger::toPropertyTree()
{
    return toPropertyTree_internal();
}

void OuterEnumInteger::fromPropertyTree(boost::property_tree::ptree const& pt)
{
    fromPropertyTree_internal(pt);
}

std::string OuterEnumInteger::toJsonString_internal(bool prettyJson)
{
	std::stringstream ss;
...
void OuterEnumInteger::fromJsonString_internal(std::string const& jsonString)
{
...
ptree OuterEnumInteger::toPropertyTree_internal()
{
	ptree pt;
	ptree tmp_node;
	return pt;
...
void OuterEnumInteger::fromPropertyTree_internal(ptree const &pt)
{
	ptree tmp_node;
}
