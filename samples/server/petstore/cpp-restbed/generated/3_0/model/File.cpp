...
std::string File::toJsonString(bool prettyJson /* = false */)
{
...
boost::property_tree::ptree File::toPropertyTree()
{
    return toPropertyTree_internal();
}

void File::fromPropertyTree(boost::property_tree::ptree const& pt)
{
    fromPropertyTree_internal(pt);
}

std::string File::toJsonString_internal(bool prettyJson)
{
	std::stringstream ss;
...
void File::fromJsonString_internal(std::string const& jsonString)
{
...
ptree File::toPropertyTree_internal()
{
	ptree pt;
	ptree tmp_node;
...
void File::fromPropertyTree_internal(ptree const &pt)
{
	ptree tmp_node;
