...
{ 
    ...
    public sealed class StoreModule : NancyModule
    {
        ...
        { 
            ...
            Post["/store/order", true] = async (parameters, ct) =>
            {
                ...
                return await service.PlaceOrder(Context, order);
            };
        }
    }
    ...
    public interface StoreService
    {
        ...
        /// <returns>Order</returns>
        Task<Order> PlaceOrder(NancyContext context, Order order);
    }
    ...
    public abstract class AbstractStoreService: StoreService
    {
        ...
        public virtual Task<Order> PlaceOrder(NancyContext context, Order order)
        {
        ...
        protected abstract Task<Order> PlaceOrder(Order order);
    }
