...
{ 
    ...
    public sealed class PetModule : NancyModule
    {
        ...
        { 
            Post["/pet", true] = async (parameters, ct) =>
            {
                ...
                await service.AddPet(Context, pet);
            ...
            Put["/pet", true] = async (parameters, ct) =>
            {
                ...
                await service.UpdatePet(Context, pet);
                return new Response { ContentType = ""};
            };
    ...
    public interface PetService
    {
        ...
        /// <returns></returns>
        Task AddPet(NancyContext context, Pet pet);
        ...
        /// <param name="pet">Pet object that needs to be added to the store</param>
        /// <returns></returns>
        Task UpdatePet(NancyContext context, Pet pet);
    ...
    {
        public virtual Task AddPet(NancyContext context, Pet pet)
        {
            return AddPet(pet);
        }
        ...
        public virtual Task UpdatePet(NancyContext context, Pet pet)
        {
        ...
        protected abstract Task AddPet(Pet pet);
        ...
        protected abstract Task UpdatePet(Pet pet);
