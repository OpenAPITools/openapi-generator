...
public class FooApi  {
   ...
   public FooApi(@Context ServletConfig servletContext) {
    ...
    @io.swagger.annotations.ApiOperation(value = "", notes = "", response = FooInlineResponseDefault.class, tags={  })
    @io.swagger.annotations.ApiResponses(value = {
        @io.swagger.annotations.ApiResponse(code = 200, message = "response", response = FooInlineResponseDefault.class)
    })
