...
public class StoreApi  {
   ...
   public StoreApi(@Context ServletConfig servletContext) {
    ...
    public Response placeOrder(@ApiParam(value = "order placed for purchasing the pet", required = true) @NotNull  Order order,@Context SecurityContext securityContext)
    throws NotFoundException {
