...
public class FakeApi  {
   ...
   public FakeApi(@Context ServletConfig servletContext) {
    ...
    public Response fakeHttpSignatureTest(@ApiParam(value = "Pet object that needs to be added to the store", required = true) @NotNull 
 Pet pet,@ApiParam(value = "query parameter") @QueryParam("query_1") 
 String query1,@ApiParam(value = "header parameter" )@HeaderParam("header_1") String header1,@Context SecurityContext securityContext)
    throws NotFoundException {
 ...
 OuterComposite outerComposite,@Context SecurityContext securityContext)
    throws NotFoundException {
 ...
 String body,@Context SecurityContext securityContext)
    ...
    public Response fakePropertyEnumIntegerSerialize(@ApiParam(value = "Input enum (int) as post body", required = true) @NotNull 
 OuterObjectWithEnumProperty outerObjectWithEnumProperty,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response testAdditionalPropertiesReference(@ApiParam(value = "request body", required = true) @NotNull @Valid 
 Map<String, Object> requestBody,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response testBodyWithBinary(@ApiParam(value = "image to upload", required = true) @NotNull 
 File body,@Context SecurityContext securityContext)
    throws NotFoundException {
 ...
 FileSchemaTestClass fileSchemaTestClass,@Context SecurityContext securityContext)
    throws NotFoundException {
 ...
 User user,@Context SecurityContext securityContext)
    throws NotFoundException {
 ...
 Map<String, String> requestBody,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response testInlineFreeformAdditionalProperties(@ApiParam(value = "request body", required = true) @NotNull 
 TestInlineFreeformAdditionalPropertiesRequest testInlineFreeformAdditionalPropertiesRequest,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response testNullable(@ApiParam(value = "request body", required = true) @NotNull 
 ChildWithNullable childWithNullable,@Context SecurityContext securityContext)
    throws NotFoundException {
 ...
 List<String> context,@ApiParam(value = "", required = true) @QueryParam("allowEmpty") @NotNull 
 String allowEmpty,@ApiParam(value = "") @QueryParam("language") @Valid 
 Map<String, String> language,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response testStringMapReference(@ApiParam(value = "request body", required = true) @NotNull @Valid 
 Map<String, String> requestBody,@Context SecurityContext securityContext)
    throws NotFoundException {
