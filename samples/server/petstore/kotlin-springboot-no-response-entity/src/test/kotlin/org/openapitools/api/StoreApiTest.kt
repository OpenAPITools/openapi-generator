...
class StoreApiTest {
    ...
    fun deleteOrderTest() {
        ...
        val response: Unit = api.deleteOrder(orderId)
    ...
    fun getInventoryTest() {
        ...
        val response: Map<String, kotlin.Int> = api.getInventory()
    ...
    fun getOrderByIdTest() {
        ...
        val response: Order = api.getOrderById(orderId)
    ...
    fun placeOrderTest() {
        ...
        val response: Order = api.placeOrder(body)
