...
@ApiParam(value = "Pet object that needs to be added to the store", required = true )   @Valid@org.springframework.web.bind.annotation.RequestBody @RequestBody Mono<Pet> body, @springfox.documentation.annotations.ApiIgnore final ServerWebExchange exchange) {
