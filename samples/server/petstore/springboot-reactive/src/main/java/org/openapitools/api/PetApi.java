...
public interface PetApi {
    ...
    default Mono<ResponseEntity<Void>> addPet(@ApiParam(value = "Pet object that needs to be added to the store", required = true) @Valid @RequestBody Mono<Pet> body
...
,@ApiParam(value = "") @RequestHeader(value = "api_key", required = false) String apiKey,  final ServerWebExchange exchange) {
...
,  final ServerWebExchange exchange) {
    ...
    default Mono<ResponseEntity<Void>> updatePet(@ApiParam(value = "Pet object that needs to be added to the store", required = true) @Valid @RequestBody Mono<Pet> body
,  final ServerWebExchange exchange) {
