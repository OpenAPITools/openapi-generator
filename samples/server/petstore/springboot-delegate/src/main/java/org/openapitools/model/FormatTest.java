...
public class FormatTest {
   ...
   */
  public FormatTest(Integer _integer, Integer int32, Long int64, BigDecimal number, Float _float, Double _double, String _string, byte[] _byte, org.springframework.core.io.Resource binary, LocalDate _date, OffsetDateTime _dateTime, UUID _uuid, String password, BigDecimal _bigDecimal) {
