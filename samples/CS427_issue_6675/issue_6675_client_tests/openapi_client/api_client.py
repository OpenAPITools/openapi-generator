...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.example  # this is an instance of the class Endpoint
        api_instance.example()  # this invokes api_instance.example.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.example.callable or self.callable in this class
