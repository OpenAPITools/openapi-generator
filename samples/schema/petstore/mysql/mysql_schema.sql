...
--
-- Table structure for table `_foo_inline_response_default` generated from model 'UnderscorefooUnderscoreinlineUnderscoreresponseUnderscoredefault'
--

CREATE TABLE IF NOT EXISTS `_foo_inline_response_default` (
