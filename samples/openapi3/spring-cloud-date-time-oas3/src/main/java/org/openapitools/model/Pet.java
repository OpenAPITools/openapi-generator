...
public class Pet {
  ...
  private OffsetDateTime lastFeed = OffsetDateTime.parse("1973-12-19T17:09:57+05:30[Asia/Calcutta]", java.time.format.DateTimeFormatter.ISO_ZONED_DATE_TIME.withZone(java.time.ZoneId.systemDefault()));
