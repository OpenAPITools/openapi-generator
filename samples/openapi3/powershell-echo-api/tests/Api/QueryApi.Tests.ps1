...
Describe -tag 'PSOpenAPITools' -name 'QueryApi' {
    ...
    Context 'Test-QueryStyleJsonSerializationObject' {
        It 'Test Test-QueryStyleJsonSerializationObject' {
            #$TestResult = Test-QueryStyleJsonSerializationObject -JsonSerializedObjectRefStringQuery "TEST_VALUE" -JsonSerializedObjectArrayRefStringQuery "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
