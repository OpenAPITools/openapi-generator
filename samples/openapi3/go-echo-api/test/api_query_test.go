...
func Test_openapi_QueryAPIService(t *testing.T) {
	...
	t.Run("Test QueryAPIService TestQueryStyleJsonSerializationObject", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.QueryAPI.TestQueryStyleJsonSerializationObject(context.Background()).Execute()
