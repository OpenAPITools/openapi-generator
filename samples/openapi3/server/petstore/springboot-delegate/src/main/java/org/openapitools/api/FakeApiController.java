...
public class FakeApiController implements FakeApi {
     ...
     * @see FakeApi#fakeHealthGet
     */
    public ResponseEntity<HealthCheckResult> fakeHealthGet() {
        return delegate.fakeHealthGet();
    }
     ...
     * @return The instance started successfully (status code 200)
     * @see FakeApi#fakeHttpSignatureTest
     */
    public ResponseEntity<Void> fakeHttpSignatureTest(@Parameter(description = "Pet object that needs to be added to the store" ,required=true )  @Valid @RequestBody Pet pet,@Parameter(description = "query parameter") @Valid @RequestParam(value = "query_1", required = false) String query1,@Parameter(description = "header parameter" ) @RequestHeader(value="header_1" , required=false) String header1) {
        return delegate.fakeHttpSignatureTest(pet, query1, header1);
    }
     ...
     */
    public ResponseEntity<OuterComposite> fakeOuterCompositeSerialize(@Parameter(description = "Input composite as post body"  )  @Valid @RequestBody(required = false) OuterComposite outerComposite) {
     ...
     */
    public ResponseEntity<Void> testBodyWithFileSchema(@Parameter(description = "" ,required=true )  @Valid @RequestBody FileSchemaTestClass fileSchemaTestClass) {
     ...
     */
    public ResponseEntity<Void> testBodyWithQueryParams(@NotNull @Parameter(description = "", required = true) @Valid @RequestParam(value = "query", required = true) String query,@Parameter(description = "" ,required=true )  @Valid @RequestBody User user) {
     ...
     */
    public ResponseEntity<Client> testClientModel(@Parameter(description = "client model" ,required=true )  @Valid @RequestBody Client client) {
     ...
     */
    public ResponseEntity<Void> testInlineAdditionalProperties(@Parameter(description = "request body" ,required=true )  @Valid @RequestBody Map<String, String> requestBody) {
