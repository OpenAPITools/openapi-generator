...
public class NullableClass extends HashMap<String, Object>  {
  ...
  private JsonNullable<LocalDateTime> datetimeProp = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<LocalDateTime> getDatetimeProp() {
    return datetimeProp;
  }

  public void setDatetimeProp(JsonNullable<LocalDateTime> datetimeProp) {
