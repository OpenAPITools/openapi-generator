...
public interface FakeApiDelegate {
     ...
     */
    default Mono<ResponseEntity<HealthCheckResult>> fakeHealthGet(ServerWebExchange exchange) {
     ...
     */
    default Mono<ResponseEntity<Void>> fakeHttpSignatureTest(Mono<Pet> pet,
        String query1,
        String header1,
