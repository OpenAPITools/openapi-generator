...
public class PetApiController implements PetApi {
     ...
     * @see PetApi#addPet
     */
    public Mono<ResponseEntity<Void>> addPet(
     ...
     */
    public Mono<ResponseEntity<Flux<Pet>>> findPetsByStatus(
     ...
     */
    public Mono<ResponseEntity<Flux<Pet>>> findPetsByTags(
     ...
     */
    public Mono<ResponseEntity<Void>> updatePet(
        @Parameter(name = "body", description = "Pet object that needs to be added to the store", required = true) @Valid @RequestBody Mono<Pet> body
    ) {
     ...
     */
    public Mono<ResponseEntity<Void>> updatePetWithForm(
     ...
     */
    public Mono<ResponseEntity<ModelApiResponse>> uploadFile(
