...
public interface FakeApi {
    ...
    default Mono<ResponseEntity<Void>> createXmlItem(@Parameter(name = "XmlItem", description = "XmlItem Body", required = true, schema = @Schema(description = "")) @Valid @RequestBody Mono<XmlItem> xmlItem
,  final ServerWebExchange exchange) {
    ...
    default Mono<ResponseEntity<Boolean>> fakeOuterBooleanSerialize(@Parameter(name = "body", description = "Input boolean as post body", schema = @Schema(description = "")) @Valid @RequestBody(required = false) Mono<Boolean> body
,  final ServerWebExchange exchange) {
    ...
    default Mono<ResponseEntity<OuterComposite>> fakeOuterCompositeSerialize(@Parameter(name = "body", description = "Input composite as post body", schema = @Schema(description = "")) @Valid @RequestBody(required = false) Mono<OuterComposite> body
,  final ServerWebExchange exchange) {
    ...
    default Mono<ResponseEntity<BigDecimal>> fakeOuterNumberSerialize(@Parameter(name = "body", description = "Input number as post body", schema = @Schema(description = "")) @Valid @RequestBody(required = false) Mono<BigDecimal> body
,  final ServerWebExchange exchange) {
    ...
    default Mono<ResponseEntity<String>> fakeOuterStringSerialize(@Parameter(name = "body", description = "Input string as post body", schema = @Schema(description = "")) @Valid @RequestBody(required = false) Mono<String> body
,  final ServerWebExchange exchange) {
    ...
    default Mono<ResponseEntity<Void>> testBodyWithFileSchema(@Parameter(name = "body", description = "", required = true, schema = @Schema(description = "")) @Valid @RequestBody Mono<FileSchemaTestClass> body
,  final ServerWebExchange exchange) {
    ...
    default Mono<ResponseEntity<Void>> testBodyWithQueryParams(@NotNull @Parameter(name = "query", description = "", required = true, schema = @Schema(description = "")) @Valid @RequestParam(value = "query", required = true) String query
...
,  final ServerWebExchange exchange) {
    ...
    default Mono<ResponseEntity<Client>> testClientModel(@Parameter(name = "body", description = "client model", required = true, schema = @Schema(description = "")) @Valid @RequestBody Mono<Client> body
,  final ServerWebExchange exchange) {
    ...
    default Mono<ResponseEntity<Void>> testEndpointParameters(  @Parameter(name = "number", description = "None", required = true, schema = @Schema(description = "")) @Valid @RequestPart(value = "number", required = true) BigDecimal number
...
,  final ServerWebExchange exchange) {
    ...
    default Mono<ResponseEntity<Void>> testGroupParameters(@NotNull @Parameter(name = "required_string_group", description = "Required String in group parameters", required = true, schema = @Schema(description = "")) @Valid @RequestParam(value = "required_string_group", required = true) Integer requiredStringGroup
...
,  final ServerWebExchange exchange) {
    ...
    default Mono<ResponseEntity<Void>> testInlineAdditionalProperties(@Parameter(name = "param", description = "request body", required = true, schema = @Schema(description = "")) @Valid @RequestBody Mono<Map<String, String>> param
,  final ServerWebExchange exchange) {
    ...
    default Mono<ResponseEntity<Void>> testJsonFormData(  @Parameter(name = "param", description = "field1", required = true, schema = @Schema(description = "")) @Valid @RequestPart(value = "param", required = true) String param
...
,  final ServerWebExchange exchange) {
    ...
    default Mono<ResponseEntity<Void>> testQueryParameterCollectionFormat(@NotNull @Parameter(name = "pipe", description = "", required = true, schema = @Schema(description = "")) @Valid @RequestParam(value = "pipe", required = true) List<String> pipe
...
,  final ServerWebExchange exchange) {
    ...
    default Mono<ResponseEntity<ModelApiResponse>> uploadFileWithRequiredFile( @Parameter(name = "petId", description = "ID of pet to update", required = true, schema = @Schema(description = "")) @PathVariable("petId") Long petId
,  
