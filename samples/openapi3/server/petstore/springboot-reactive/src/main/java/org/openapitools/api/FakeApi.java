...
public interface FakeApi {
    ...
    default Mono<ResponseEntity<HealthCheckResult>> fakeHealthGet(@ApiIgnore final ServerWebExchange exchange) {
        return getDelegate().fakeHealthGet(exchange);
    }
    ...
    default Mono<ResponseEntity<Void>> fakeHttpSignatureTest(@Parameter(description = "Pet object that needs to be added to the store" ,required=true )  @Valid @RequestBody Mono<Pet> pet,@Parameter(description = "query parameter") @Valid @RequestParam(value = "query_1", required = false) String query1,@Parameter(description = "header parameter" ) @RequestHeader(value="header_1" , required=false) String header1, @ApiIgnore final ServerWebExchange exchange) {
        return getDelegate().fakeHttpSignatureTest(pet, query1, header1, exchange);
    }
    ...
    default Mono<ResponseEntity<Boolean>> fakeOuterBooleanSerialize(@Parameter(description = "Input boolean as post body"  )  @Valid @RequestBody(required = false) Mono<Boolean> body, @ApiIgnore final ServerWebExchange exchange) {
    ...
    default Mono<ResponseEntity<OuterComposite>> fakeOuterCompositeSerialize(@Parameter(description = "Input composite as post body"  )  @Valid @RequestBody(required = false) Mono<OuterComposite> outerComposite, @ApiIgnore final ServerWebExchange exchange) {
    ...
    default Mono<ResponseEntity<BigDecimal>> fakeOuterNumberSerialize(@Parameter(description = "Input number as post body"  )  @Valid @RequestBody(required = false) Mono<BigDecimal> body, @ApiIgnore final ServerWebExchange exchange) {
    ...
    default Mono<ResponseEntity<String>> fakeOuterStringSerialize(@Parameter(description = "Input string as post body"  )  @Valid @RequestBody(required = false) Mono<String> body, @ApiIgnore final ServerWebExchange exchange) {
    ...
    default Mono<ResponseEntity<Void>> testBodyWithFileSchema(@Parameter(description = "" ,required=true )  @Valid @RequestBody Mono<FileSchemaTestClass> fileSchemaTestClass, @ApiIgnore final ServerWebExchange exchange) {
    ...
    default Mono<ResponseEntity<Void>> testBodyWithQueryParams(@NotNull @Parameter(description = "", required = true) @Valid @RequestParam(value = "query", required = true) String query,@Parameter(description = "" ,required=true )  @Valid @RequestBody Mono<User> user, @ApiIgnore final ServerWebExchange exchange) {
    ...
    default Mono<ResponseEntity<Client>> testClientModel(@Parameter(description = "client model" ,required=true )  @Valid @RequestBody Mono<Client> client, @ApiIgnore final ServerWebExchange exchange) {
    ...
    default Mono<ResponseEntity<Void>> testInlineAdditionalProperties(@Parameter(description = "request body" ,required=true )  @Valid @RequestBody Mono<Map<String, String>> requestBody, @ApiIgnore final ServerWebExchange exchange) {
    ...
    default Mono<ResponseEntity<Void>> testJsonFormData(@Parameter(description = "field1", required=true) @Valid @RequestPart(value = "param", required = true)  String param,@Parameter(description = "field2", required=true) @Valid @RequestPart(value = "param2", required = true)  String param2, @ApiIgnore final ServerWebExchange exchange) {
