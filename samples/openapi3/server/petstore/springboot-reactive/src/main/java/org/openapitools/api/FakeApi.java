...
public interface FakeApi {
    ...
    default Mono<ResponseEntity<Boolean>> fakeOuterBooleanSerialize(@Parameter(description = "Input boolean as post body"  )  @Valid @RequestBody(required = false) Mono<Boolean> body, ServerWebExchange exchange) {
    ...
    @RequestMapping(value = "/fake/outer/composite",
        ...
        consumes = { "application/json" },
        method = RequestMethod.POST)
    default Mono<ResponseEntity<OuterComposite>> fakeOuterCompositeSerialize(@Parameter(description = "Input composite as post body"  )  @Valid @RequestBody(required = false) Mono<OuterComposite> outerComposite, ServerWebExchange exchange) {
    ...
    @RequestMapping(value = "/fake/outer/number",
        ...
        consumes = { "application/json" },
        method = RequestMethod.POST)
    default Mono<ResponseEntity<BigDecimal>> fakeOuterNumberSerialize(@Parameter(description = "Input number as post body"  )  @Valid @RequestBody(required = false) Mono<BigDecimal> body, ServerWebExchange exchange) {
    ...
    @RequestMapping(value = "/fake/outer/string",
        ...
        consumes = { "application/json" },
        method = RequestMethod.POST)
    default Mono<ResponseEntity<String>> fakeOuterStringSerialize(@Parameter(description = "Input string as post body"  )  @Valid @RequestBody(required = false) Mono<String> body, ServerWebExchange exchange) {
    ...
    default Mono<ResponseEntity<Void>> testBodyWithFileSchema(@Parameter(description = "" ,required=true )  @Valid @RequestBody Mono<FileSchemaTestClass> fileSchemaTestClass, ServerWebExchange exchange) {
    ...
    @RequestMapping(value = "/fake/body-with-query-params",
        consumes = { "application/json" },
        method = RequestMethod.PUT)
    default Mono<ResponseEntity<Void>> testBodyWithQueryParams(@NotNull @Parameter(description = "", required = true) @Valid @RequestParam(value = "query", required = true) String query,@Parameter(description = "" ,required=true )  @Valid @RequestBody Mono<User> user, ServerWebExchange exchange) {
    ...
    default Mono<ResponseEntity<Client>> testClientModel(@Parameter(description = "client model" ,required=true )  @Valid @RequestBody Mono<Client> client, ServerWebExchange exchange) {
    ...
    @RequestMapping(value = "/fake/inline-additionalProperties",
        consumes = { "application/json" },
        method = RequestMethod.POST)
    default Mono<ResponseEntity<Void>> testInlineAdditionalProperties(@Parameter(description = "request body" ,required=true )  @Valid @RequestBody Mono<String> requestBody, ServerWebExchange exchange) {
    ...
    @RequestMapping(value = "/fake/jsonFormData",
        consumes = { "application/x-www-form-urlencoded" },
        method = RequestMethod.GET)
    default Mono<ResponseEntity<Void>> testJsonFormData(@Parameter(description = "field1", required=true) @Valid @RequestPart(value = "param", required = true)  String param,@Parameter(description = "field2", required=true) @Valid @RequestPart(value = "param2", required = true)  String param2, ServerWebExchange exchange) {
