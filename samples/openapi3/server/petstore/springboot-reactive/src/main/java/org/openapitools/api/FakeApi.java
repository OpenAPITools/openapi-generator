...
public interface FakeApi {
    ...
    default Mono<ResponseEntity<Void>> createXmlItem(@Parameter(description = "XmlItem Body" ,required=true )  @Valid @RequestBody Mono<XmlItem> xmlItem, ServerWebExchange exchange) {
    ...
    @RequestMapping(value = "/fake/outer/composite",
        produces = { "*/*" }, 
        method = RequestMethod.POST)
    default Mono<ResponseEntity<OuterComposite>> fakeOuterCompositeSerialize(@Parameter(description = "Input composite as post body"  )  @Valid @RequestBody(required = false) Mono<OuterComposite> body, ServerWebExchange exchange) {
    ...
    default Mono<ResponseEntity<Void>> testBodyWithFileSchema(@Parameter(description = "" ,required=true )  @Valid @RequestBody Mono<FileSchemaTestClass> body, ServerWebExchange exchange) {
    ...
    @RequestMapping(value = "/fake/body-with-query-params",
        consumes = { "application/json" },
        method = RequestMethod.PUT)
    default Mono<ResponseEntity<Void>> testBodyWithQueryParams(@NotNull @Parameter(description = "", required = true) @Valid @RequestParam(value = "query", required = true) String query,@Parameter(description = "" ,required=true )  @Valid @RequestBody Mono<User> body, ServerWebExchange exchange) {
    ...
    default Mono<ResponseEntity<Client>> testClientModel(@Parameter(description = "client model" ,required=true )  @Valid @RequestBody Mono<Client> body, ServerWebExchange exchange) {
    ...
    @RequestMapping(value = "/fake/inline-additionalProperties",
        consumes = { "application/json" },
        method = RequestMethod.POST)
    default Mono<ResponseEntity<Void>> testInlineAdditionalProperties(@Parameter(description = "request body" ,required=true )  @Valid @RequestBody Mono<String> param, ServerWebExchange exchange) {
