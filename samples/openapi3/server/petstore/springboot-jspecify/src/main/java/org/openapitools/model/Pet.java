...
public class Pet {
  ...
  public Pet(@JsonProperty("id") @Nullable Long id, @JsonProperty("category") @Nullable Category category, @JsonProperty("name") String name, @JsonProperty("photoUrls") List<String> photoUrls, @JsonProperty("tags") List<@Valid Tag> tags, @JsonProperty("status") @Nullable StatusEnum status) {
      this.id = id;
