...
public class Foo {
  ...
  @XmlElement(name = "dt")
  public Optional<java.time.Instant> getDt() {
    return dt;
  }

  @JsonProperty("dt")
  @JacksonXmlProperty(localName = "dt")
  public void setDt(Optional<java.time.Instant> dt) {
    this.dt = dt;
  }
  ...
  public Optional<java.math.BigDecimal> getNumber() {
    return number;
  }

  @JsonProperty("number")
  @JacksonXmlProperty(localName = "number")
  public void setNumber(Optional<java.math.BigDecimal> number) {
    this.number = number;
  }
