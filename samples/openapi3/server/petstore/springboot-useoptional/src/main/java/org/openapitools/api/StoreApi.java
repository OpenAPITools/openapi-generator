...
public interface StoreApi {
    ...
    default ResponseEntity<Void> deleteOrder(
        @Parameter(name = "order_id", description = "ID of the order that needs to be deleted", required = true) @PathVariable("order_id") {{{{datatypeWithEnum}}} orderId
    ) {
    ...
    default ResponseEntity<Order> getOrderById(
        @Min(1L) @Max(5L) @Parameter(name = "order_id", description = "ID of pet that needs to be fetched", required = true) @PathVariable("order_id") {{{{datatypeWithEnum}}} orderId
    ) {
