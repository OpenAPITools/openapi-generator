...
public interface AnotherFakeApi {
    ...
    default ResponseEntity<Client> call123testSpecialTags(@Parameter(name = "body", description = "client model", required = true, schema = @Schema(description = "")) @Valid @RequestBody Client body
) {
