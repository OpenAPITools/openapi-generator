...
func AssertUserConstraints(obj User) error {
    if obj.DeepSliceModel != nil {
     	if err := AssertRecurseInterfaceConstraints(*obj.DeepSliceModel, AssertTagConstraints); err != nil {
     		return err
     	}
    }
	if err := AssertRecurseInterfaceConstraints(obj.DeepSliceMap, AssertAnObjectConstraints); err != nil {
		return err
	}
	return nil
}
