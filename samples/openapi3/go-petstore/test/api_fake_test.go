...
func Test_petstore_FakeAPIService(t *testing.T) {
	...
	t.Run("Test FakeAPIService QueryArrayWithDefaultValues", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		httpRes, err := apiClient.FakeAPI.QueryArrayWithDefaultValues(context.Background()).Execute()
