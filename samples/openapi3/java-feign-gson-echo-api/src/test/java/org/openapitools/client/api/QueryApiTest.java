...
class QueryApiTest {
     ...
     */
    @Test
    void testQueryStyleJsonSerializationObjectTestQueryMap() {
        QueryApi.TestQueryStyleJsonSerializationObjectQueryParams queryParams = new QueryApi.TestQueryStyleJsonSerializationObjectQueryParams()
            .jsonSerializedObjectRefStringQuery(null)
            .jsonSerializedObjectArrayRefStringQuery(null);
        // String response = api.testQueryStyleJsonSerializationObject(queryParams);
