...
test_that("TestQueryStyleJsonSerializationObject", {
  # tests for TestQueryStyleJsonSerializationObject
  # base path: http://localhost:3000
  # Test query parameter(s)
  # Test query parameter(s)
  # @param json_serialized_object_ref_string_query Pet  (optional)
  # @param json_serialized_object_array_ref_string_query array[Pet]  (optional)
  # @return [character]
