# edu_sharing_client_api.CONNECTORV1Api
...
from edu_sharing_client_api.apis.tags import connectorv1_api
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    api_instance = connectorv1_api.CONNECTORV1Api(api_client)
