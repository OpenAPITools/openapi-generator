# edu_sharing_client_api.CONFIG v1Api

All URIs are relative to *http://localhost/edu-sharing/rest*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_config1**](CONFIG v1Api.md#get_config1) | **get** /config/v1/values | get repository config values
[**get_dynamic_value**](CONFIG v1Api.md#get_dynamic_value) | **get** /config/v1/dynamic/{key} | Get a config entry (appropriate rights for the entry are required)
[**get_language**](CONFIG v1Api.md#get_language) | **get** /config/v1/language | get override strings for the current language
[**get_language_defaults**](CONFIG v1Api.md#get_language_defaults) | **get** /config/v1/language/defaults | get all inital language strings for angular
[**get_variables**](CONFIG v1Api.md#get_variables) | **get** /config/v1/variables | get global config variables
[**set_dynamic_value**](CONFIG v1Api.md#set_dynamic_value) | **post** /config/v1/dynamic/{key} | Set a config entry (admin rights required)
...
from edu_sharing_client_api.apis.tags import config_v1_api
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    api_instance = config_v1_api.CONFIG v1Api(api_client)
    ...
    try:
        ...
        print("Exception when calling CONFIG v1Api->get_config1: %s\n" % e)
```
### Parameters
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling CONFIG v1Api->get_dynamic_value: %s\n" % e)
```
### Parameters
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling CONFIG v1Api->get_language: %s\n" % e)
```
### Parameters
This endpoint does not need any parameter.
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling CONFIG v1Api->get_language_defaults: %s\n" % e)
```
### Parameters
This endpoint does not need any parameter.
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling CONFIG v1Api->get_variables: %s\n" % e)
```
### Parameters
This endpoint does not need any parameter.
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling CONFIG v1Api->set_dynamic_value: %s\n" % e)
```
### Parameters
