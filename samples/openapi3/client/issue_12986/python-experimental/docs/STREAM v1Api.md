# edu_sharing_client_api.STREAM v1Api

All URIs are relative to *http://localhost/edu-sharing/rest*

Method | HTTP request | Description
------------- | ------------- | -------------
[**add_entry**](STREAM v1Api.md#add_entry) | **put** /stream/v1/add/{repository} | add a new stream object.
[**can_access**](STREAM v1Api.md#can_access) | **get** /stream/v1/access/{repository}/{node} | test
[**delete_entry**](STREAM v1Api.md#delete_entry) | **delete** /stream/v1/delete/{repository}/{entry} | delete a stream object
[**get_property_values**](STREAM v1Api.md#get_property_values) | **get** /stream/v1/properties/{repository}/{property} | Get top values for a property
[**search1**](STREAM v1Api.md#search1) | **post** /stream/v1/search/{repository} | Get the stream content for the current user with the given status.
[**update_entry**](STREAM v1Api.md#update_entry) | **put** /stream/v1/status/{repository}/{entry} | update status for a stream object and authority
...
from edu_sharing_client_api.apis.tags import stream_v1_api
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    api_instance = stream_v1_api.STREAM v1Api(api_client)
    ...
    try:
        ...
        print("Exception when calling STREAM v1Api->add_entry: %s\n" % e)
```
### Parameters
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling STREAM v1Api->can_access: %s\n" % e)
```
### Parameters
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling STREAM v1Api->delete_entry: %s\n" % e)
```
### Parameters
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling STREAM v1Api->get_property_values: %s\n" % e)
```
### Parameters
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling STREAM v1Api->search1: %s\n" % e)
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling STREAM v1Api->update_entry: %s\n" % e)
```
### Parameters
