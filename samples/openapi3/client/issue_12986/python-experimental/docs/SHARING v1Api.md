# edu_sharing_client_api.SHARING v1Api

All URIs are relative to *http://localhost/edu-sharing/rest*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_children1**](SHARING v1Api.md#get_children1) | **get** /sharing/v1/sharing/{repository}/{node}/{share}/children | Get all children of this share.
[**get_info**](SHARING v1Api.md#get_info) | **get** /sharing/v1/sharing/{repository}/{node}/{share} | Get general info of a share.
...
from edu_sharing_client_api.apis.tags import sharing_v1_api
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    api_instance = sharing_v1_api.SHARING v1Api(api_client)
    ...
    try:
        ...
        print("Exception when calling SHARING v1Api->get_children1: %s\n" % e)
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling SHARING v1Api->get_info: %s\n" % e)
