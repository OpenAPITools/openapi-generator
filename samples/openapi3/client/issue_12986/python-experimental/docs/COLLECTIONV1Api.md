# edu_sharing_client_api.COLLECTIONV1Api

All URIs are relative to *http://localhost/edu-sharing/rest*

Method | HTTP request | Description
------------- | ------------- | -------------
[**add_feedback_to_collection**](COLLECTIONV1Api.md#add_feedback_to_collection) | **post** /collection/v1/collections/{repository}/{collection}/feedback | Post feedback to collection.
...
[**get_feedback_of_collection**](COLLECTIONV1Api.md#get_feedback_of_collection) | **get** /collection/v1/collections/{repository}/{collection}/feedback | Get feedback of collection.
...
from edu_sharing_client_api.apis.tags import collectionv1_api
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    api_instance = collectionv1_api.COLLECTIONV1Api(api_client)
    ...
    try:
        ...
        print("Exception when calling COLLECTIONV1Api->add_feedback_to_collection: %s\n" % e)
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling COLLECTIONV1Api->get_feedback_of_collection: %s\n" % e)
```
### Parameters
