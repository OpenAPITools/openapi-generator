# edu_sharing_client_api.STATISTIC v1Api

All URIs are relative to *http://localhost/edu-sharing/rest*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get**](STATISTIC v1Api.md#get) | **post** /statistic/v1/facets/{context} | Get statistics of repository.
[**get_global_statistics**](STATISTIC v1Api.md#get_global_statistics) | **get** /statistic/v1/public | Get stats.
[**get_node_data**](STATISTIC v1Api.md#get_node_data) | **get** /statistic/v1/statistics/nodes/node/{id} | get the range of nodes which had tracked actions since a given timestamp
[**get_nodes_altered_in_range**](STATISTIC v1Api.md#get_nodes_altered_in_range) | **get** /statistic/v1/statistics/nodes/altered | get the range of nodes which had tracked actions since a given timestamp
[**get_statistics_node**](STATISTIC v1Api.md#get_statistics_node) | **post** /statistic/v1/statistics/nodes | get statistics for node actions
[**get_statistics_user**](STATISTIC v1Api.md#get_statistics_user) | **post** /statistic/v1/statistics/users | get statistics for user actions (login, logout)
...
from edu_sharing_client_api.apis.tags import statistic_v1_api
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    api_instance = statistic_v1_api.STATISTIC v1Api(api_client)
    ...
    try:
        ...
        print("Exception when calling STATISTIC v1Api->get: %s\n" % e)
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling STATISTIC v1Api->get_global_statistics: %s\n" % e)
```
### Parameters
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling STATISTIC v1Api->get_node_data: %s\n" % e)
```
### Parameters
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling STATISTIC v1Api->get_nodes_altered_in_range: %s\n" % e)
```
### Parameters
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling STATISTIC v1Api->get_statistics_node: %s\n" % e)
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling STATISTIC v1Api->get_statistics_user: %s\n" % e)
