# edu_sharing_client_api.RENDERING v1Api

All URIs are relative to *http://localhost/edu-sharing/rest*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_details_snippet**](RENDERING v1Api.md#get_details_snippet) | **get** /rendering/v1/details/{repository}/{node} | Get metadata of node.
[**get_details_snippet_with_parameters**](RENDERING v1Api.md#get_details_snippet_with_parameters) | **post** /rendering/v1/details/{repository}/{node} | Get metadata of node.
...
from edu_sharing_client_api.apis.tags import rendering_v1_api
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    api_instance = rendering_v1_api.RENDERING v1Api(api_client)
    ...
    try:
        ...
        print("Exception when calling RENDERING v1Api->get_details_snippet: %s\n" % e)
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling RENDERING v1Api->get_details_snippet_with_parameters: %s\n" % e)
