# edu_sharing_client_api.CONNECTOR v1Api

All URIs are relative to *http://localhost/edu-sharing/rest*

Method | HTTP request | Description
------------- | ------------- | -------------
[**list_connectors**](CONNECTOR v1Api.md#list_connectors) | **get** /connector/v1/connectors/{repository}/list | List all available connectors
...
from edu_sharing_client_api.apis.tags import connector_v1_api
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    api_instance = connector_v1_api.CONNECTOR v1Api(api_client)
    ...
    try:
        ...
        print("Exception when calling CONNECTOR v1Api->list_connectors: %s\n" % e)
```
### Parameters
