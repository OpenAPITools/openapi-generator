# edu_sharing_client_api.BULK v1Api

All URIs are relative to *http://localhost/edu-sharing/rest*

Method | HTTP request | Description
------------- | ------------- | -------------
[**find**](BULK v1Api.md#find) | **post** /bulk/v1/find | gets a given node
[**sync**](BULK v1Api.md#sync) | **put** /bulk/v1/sync/{group} | Create or update a given node
...
from edu_sharing_client_api.apis.tags import bulk_v1_api
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    api_instance = bulk_v1_api.BULK v1Api(api_client)
    ...
    try:
        ...
        print("Exception when calling BULK v1Api->find: %s\n" % e)
```
### Parameters
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling BULK v1Api->sync: %s\n" % e)
