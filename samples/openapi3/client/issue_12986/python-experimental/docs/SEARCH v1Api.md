# edu_sharing_client_api.SEARCH v1Api

All URIs are relative to *http://localhost/edu-sharing/rest*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_metdata**](SEARCH v1Api.md#get_metdata) | **get** /search/v1/metadata/{repository} | get nodes with metadata and collections
[**get_relevant_nodes**](SEARCH v1Api.md#get_relevant_nodes) | **get** /search/v1/relevant/{repository} | Get relevant nodes for the current user
[**load_save_search**](SEARCH v1Api.md#load_save_search) | **get** /search/v1/queries/load/{nodeId} | Load a saved search query.
[**save_search**](SEARCH v1Api.md#save_search) | **post** /search/v1/queries/{repository}/{metadataset}/{query}/save | Save a search query.
[**search**](SEARCH v1Api.md#search) | **post** /search/v1/queries/{repository}/{metadataset}/{query} | Perform queries based on metadata sets.
[**search_by_property**](SEARCH v1Api.md#search_by_property) | **get** /search/v1/custom/{repository} | Search for custom properties with custom values
[**search_contributor**](SEARCH v1Api.md#search_contributor) | **get** /search/v1/queries/{repository}/contributor | Search for contributors
[**search_facets**](SEARCH v1Api.md#search_facets) | **post** /search/v1/queries/{repository}/{metadataset}/{query}/facets | Search in facets.
[**search_fingerprint**](SEARCH v1Api.md#search_fingerprint) | **post** /search/v1/queries/{repository}/fingerprint/{nodeid} | Perform queries based on metadata sets.
...
from edu_sharing_client_api.apis.tags import search_v1_api
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    api_instance = search_v1_api.SEARCH v1Api(api_client)
    ...
    try:
        ...
        print("Exception when calling SEARCH v1Api->get_metdata: %s\n" % e)
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling SEARCH v1Api->get_relevant_nodes: %s\n" % e)
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling SEARCH v1Api->load_save_search: %s\n" % e)
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling SEARCH v1Api->save_search: %s\n" % e)
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling SEARCH v1Api->search: %s\n" % e)
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling SEARCH v1Api->search_by_property: %s\n" % e)
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling SEARCH v1Api->search_contributor: %s\n" % e)
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling SEARCH v1Api->search_facets: %s\n" % e)
```
### Parameters
...
with edu_sharing_client_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling SEARCH v1Api->search_fingerprint: %s\n" % e)
