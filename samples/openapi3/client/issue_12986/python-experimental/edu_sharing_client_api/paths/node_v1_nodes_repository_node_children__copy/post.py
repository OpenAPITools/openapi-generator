...
# query params
SourceSchema = StrSchema
WithChildrenSchema = BoolSchema
...
request_query_with_children = api_client.QueryParameter(
    name="withChildren",
    style=api_client.ParameterStyle.FORM,
    schema=WithChildrenSchema,
    required=True,
    explode=True,
)
# path params
...
class CreateChildByCopying(BaseApi):
    ...
    def create_child_by_copying(
        ...
        return self._create_child_by_copying(
