...
request_path_authority = api_client.PathParameter(
    name="authority",
...
class SetToolpermissions(BaseApi):
    ...
    def set_toolpermissions(
        ...
        return self._set_toolpermissions(
            body=body,
