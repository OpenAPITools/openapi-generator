...
# body param
SchemaForRequestBodyApplicationJson = GroupProfile


request_body_group_profile = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _change_group_profile(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_group_profile.serialize(body, content_type)
...
class ChangeGroupProfile(BaseApi):
    ...
    def change_group_profile(
        ...
        return self._change_group_profile(
            body=body,
