...
RequestOptionalQueryParams = typing.TypedDict(
    ...
    {
        'keepExisting': KeepExistingSchema,
    },
    total=False
)
...
request_query_keep_existing = api_client.QueryParameter(
    name="keepExisting",
    style=api_client.ParameterStyle.FORM,
    schema=KeepExistingSchema,
    explode=True,
)
...
class RefreshEduGroupCache(BaseApi):
    ...
    def refresh_edu_group_cache(
        ...
        return self._refresh_edu_group_cache(
