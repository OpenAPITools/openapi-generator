...
request_path_metadataset = api_client.PathParameter(
    name="metadataset",
    style=api_client.ParameterStyle.SIMPLE,
    schema=MetadatasetSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = Mds
