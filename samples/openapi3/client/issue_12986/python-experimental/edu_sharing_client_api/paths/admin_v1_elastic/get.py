...
request_query_dsl = api_client.QueryParameter(
    name="dsl",
    style=api_client.ParameterStyle.FORM,
    schema=DslSchema,
    explode=True,
)
SchemaFor200ResponseBodyApplicationJson = SearchResultElastic
...
class SearchByElasticDsl(BaseApi):
    ...
    def search_by_elastic_dsl(
        ...
        return self._search_by_elastic_dsl(
