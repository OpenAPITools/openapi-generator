...
request_path_job_class = api_client.PathParameter(
    name="jobClass",
    style=api_client.ParameterStyle.SIMPLE,
    schema=JobClassSchema,
    required=True,
)
# body param
