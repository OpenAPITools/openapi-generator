...
MajorSchema = Int32Schema
MinorSchema = Int32Schema
...
request_path_major = api_client.PathParameter(
    name="major",
    style=api_client.ParameterStyle.SIMPLE,
    schema=MajorSchema,
    required=True,
)
request_path_minor = api_client.PathParameter(
    name="minor",
    style=api_client.ParameterStyle.SIMPLE,
    schema=MinorSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = NodeVersionEntry
...
class GetVersionMetadata(BaseApi):
    ...
    def get_version_metadata(
        ...
        return self._get_version_metadata(
