...
# body param
SchemaForRequestBodyApplicationJson = Profile


request_body_profile = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = Mediacenter
...
class BaseApi(api_client.Api):
    ...
    def _create_mediacenter(
        ...
        if body is not unset:
            serialized_data = request_body_profile.serialize(body, content_type)
...
class CreateMediacenter(BaseApi):
    ...
    def create_mediacenter(
        ...
        return self._create_mediacenter(
            body=body,
