...
# query params
RemoveSchoolsFromMCSchema = BoolSchema
...
RequestOptionalQueryParams = typing.TypedDict(
    ...
    {
        'removeSchoolsFromMC': RemoveSchoolsFromMCSchema,
    },
    total=False
)
...
request_query_remove_schools_from_mc = api_client.QueryParameter(
    name="removeSchoolsFromMC",
    style=api_client.ParameterStyle.FORM,
    schema=RemoveSchoolsFromMCSchema,
    explode=True,
)
# body param
...
SchemaFor200ResponseBodyApplicationJson = McOrgConnectResult
...
class BaseApi(api_client.Api):
    ...
    def _import_mc_org_connections(
        self: api_client.Api,
        ...
        for parameter in (
            request_query_remove_schools_from_mc,
        ):
...
class ImportMcOrgConnections(BaseApi):
    ...
    def import_mc_org_connections(
        ...
        return self._import_mc_org_connections(
            body=body,
