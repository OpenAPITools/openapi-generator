...
SchemaFor200ResponseBodyApplicationJson = MediacentersImportResult
...
class ImportMediacenters(BaseApi):
    ...
    def import_mediacenters(
        ...
        return self._import_mediacenters(
            body=body,
