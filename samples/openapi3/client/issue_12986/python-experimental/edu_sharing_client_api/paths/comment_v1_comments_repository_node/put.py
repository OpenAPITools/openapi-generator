...
# query params
CommentReferenceSchema = StrSchema
...
RequestOptionalQueryParams = typing.TypedDict(
    ...
    {
        'commentReference': CommentReferenceSchema,
    },
    total=False
)
...
request_query_comment_reference = api_client.QueryParameter(
    name="commentReference",
    style=api_client.ParameterStyle.FORM,
    schema=CommentReferenceSchema,
    explode=True,
)
# path params
...
class BaseApi(api_client.Api):
    ...
    def _add_comment(
        ...
        for parameter in (
            request_query_comment_reference,
        ):
