...
# query params
CacheIndexSchema = Int32Schema
BeanSchema = StrSchema
...
request_query_cache_index = api_client.QueryParameter(
    name="cacheIndex",
    style=api_client.ParameterStyle.FORM,
    schema=CacheIndexSchema,
    explode=True,
)
request_query_bean = api_client.QueryParameter(
    name="bean",
    style=api_client.ParameterStyle.FORM,
    schema=BeanSchema,
    explode=True,
...
class RemoveCacheEntry(BaseApi):
    ...
    def remove_cache_entry(
        ...
        return self._remove_cache_entry(
