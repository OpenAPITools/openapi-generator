...
class ContentTypeSchema(
    ...
    @classmethod
    @property
    def TOOLPERMISSIONS(cls):
        return cls("TOOLPERMISSIONS")
    
    @classmethod
    @property
    def COLLECTION_PROPOSALS(cls):
        return cls("COLLECTION_PROPOSALS")
