...
SchemaFor200ResponseBodyApplicationJson = NodeLTIDeepLink
...
class BaseApi(api_client.Api):
    ...
    def _generate_deep_linking_response(
        self: api_client.Api,
...
class GenerateDeepLinkingResponse(BaseApi):
    ...
    def generate_deep_linking_response(
        ...
        return self._generate_deep_linking_response(
