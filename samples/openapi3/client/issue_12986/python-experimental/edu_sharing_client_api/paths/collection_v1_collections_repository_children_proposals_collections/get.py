...
request_query_fetch_counts = api_client.QueryParameter(
    name="fetchCounts",
    style=api_client.ParameterStyle.FORM,
    schema=FetchCountsSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = CollectionProposalEntries
...
class BaseApi(api_client.Api):
    ...
    def _get_collections_containing_proposals(
        self: api_client.Api,
...
class GetCollectionsContainingProposals(BaseApi):
    ...
    def get_collections_containing_proposals(
        ...
        return self._get_collections_containing_proposals(
