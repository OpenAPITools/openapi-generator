...
# body param
SchemaForRequestBodyApplicationJson = UserProfileAppAuth


request_body_user_profile_app_auth = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = AuthenticationToken
...
class BaseApi(api_client.Api):
    ...
    def _authenticate(
        ...
        if body is not unset:
            serialized_data = request_body_user_profile_app_auth.serialize(body, content_type)
