...
# query params
OpenidConfigurationSchema = StrSchema
RegistrationTokenSchema = StrSchema
...
request_query_openid_configuration = api_client.QueryParameter(
...
request_query_registration_token = api_client.QueryParameter(
    name="registration_token",
    style=api_client.ParameterStyle.FORM,
    schema=RegistrationTokenSchema,
    explode=True,
)
# path params
...
class BaseApi(api_client.Api):
    ...
    def _lti_registration_dynamic(
        ...
        for parameter in (
            request_query_openid_configuration,
            request_query_registration_token,
        ):
...
class LtiRegistrationDynamic(BaseApi):
    ...
    def lti_registration_dynamic(
        ...
        return self._lti_registration_dynamic(
