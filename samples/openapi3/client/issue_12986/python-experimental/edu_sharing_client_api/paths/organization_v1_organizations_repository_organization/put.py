...
request_query_eduscope = api_client.QueryParameter(
    name="eduscope",
    style=api_client.ParameterStyle.FORM,
    schema=EduscopeSchema,
    explode=True,
)
# path params
...
class CreateOrganizations(BaseApi):
    ...
    def create_organizations(
        ...
        return self._create_organizations(
