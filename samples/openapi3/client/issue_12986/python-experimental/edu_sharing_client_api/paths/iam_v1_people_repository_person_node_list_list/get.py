...
PersonSchema = StrSchema
ModelListSchema = StrSchema
...
request_path_person = api_client.PathParameter(
    name="person",
    style=api_client.ParameterStyle.SIMPLE,
    schema=PersonSchema,
    required=True,
)
request_path__list = api_client.PathParameter(
    name="list",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ModelListSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = NodeEntries
