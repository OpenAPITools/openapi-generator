...
# path params
AuthorityNameSchema = StrSchema
RequestRequiredPathParams = typing.TypedDict(
    'RequestRequiredPathParams',
    {
        'authorityName': AuthorityNameSchema,
    }
)
...
request_path_authority_name = api_client.PathParameter(
    name="authorityName",
    style=api_client.ParameterStyle.SIMPLE,
    schema=AuthorityNameSchema,
    required=True,
)
