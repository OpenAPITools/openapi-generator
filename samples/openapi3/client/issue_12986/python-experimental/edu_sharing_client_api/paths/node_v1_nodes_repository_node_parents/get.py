...
request_query_full_path = api_client.QueryParameter(
    name="fullPath",
    style=api_client.ParameterStyle.FORM,
    schema=FullPathSchema,
    explode=True,
)
# path params
...
SchemaFor200ResponseBodyApplicationJson = ParentEntries
