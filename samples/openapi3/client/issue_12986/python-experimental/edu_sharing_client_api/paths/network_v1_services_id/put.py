...
# body param
SchemaForRequestBodyApplicationJson = Service


request_body_service = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = StoredService
...
class BaseApi(api_client.Api):
    ...
    def _update_service(
        ...
        if body is not unset:
            serialized_data = request_body_service.serialize(body, content_type)
