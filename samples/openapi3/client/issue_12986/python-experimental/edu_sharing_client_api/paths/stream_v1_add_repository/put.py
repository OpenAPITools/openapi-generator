...
# body param
SchemaForRequestBodyApplicationJson = StreamEntryInput


request_body_stream_entry_input = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = StreamEntryInput
...
class BaseApi(api_client.Api):
    ...
    def _add_entry(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_stream_entry_input.serialize(body, content_type)
