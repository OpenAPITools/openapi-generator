...
# body param
SchemaForRequestBodyApplicationJson = UserProfileEdit


request_body_user_profile_edit = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _change_user_profile(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_user_profile_edit.serialize(body, content_type)
...
class ChangeUserProfile(BaseApi):
    ...
    def change_user_profile(
        ...
        return self._change_user_profile(
            body=body,
