...
# body param
SchemaForRequestBodyApplicationJson = SuggestionParam


request_body_suggestion_param = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _get_values(
        ...
        if body is not unset:
            serialized_data = request_body_suggestion_param.serialize(body, content_type)
