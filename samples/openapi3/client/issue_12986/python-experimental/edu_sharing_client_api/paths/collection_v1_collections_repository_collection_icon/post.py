...
SchemaFor200ResponseBodyApplicationJson = CollectionEntry
...
class BaseApi(api_client.Api):
    ...
    def _change_icon_of_collection(
        self: api_client.Api,
...
class ChangeIconOfCollection(BaseApi):
    ...
    def change_icon_of_collection(
        ...
        return self._change_icon_of_collection(
            body=body,
