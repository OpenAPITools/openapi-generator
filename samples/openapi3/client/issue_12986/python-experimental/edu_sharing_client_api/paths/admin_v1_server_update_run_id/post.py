...
request_query_execute = api_client.QueryParameter(
    name="execute",
...
class ServerUpdateList1(BaseApi):
    ...
    def server_update_list1(
        ...
        return self._server_update_list1(
