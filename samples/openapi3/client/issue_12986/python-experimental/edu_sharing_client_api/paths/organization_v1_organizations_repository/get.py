...
class SortAscendingSchema(
    ...
    _items = BoolSchema
OnlyMembershipsSchema = BoolSchema
...
RequestOptionalQueryParams = typing.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'onlyMemberships': OnlyMembershipsSchema,
    },
    total=False
)
...
request_query_only_memberships = api_client.QueryParameter(
    name="onlyMemberships",
    style=api_client.ParameterStyle.FORM,
    schema=OnlyMembershipsSchema,
    explode=True,
)
# path params
...
SchemaFor200ResponseBodyApplicationJson = OrganizationEntries
...
class BaseApi(api_client.Api):
    ...
    def _get_organizations(
        ...
        for parameter in (
            ...
            request_query_only_memberships,
        ):
