...
request_query_replace = api_client.QueryParameter(
    name="replace",
    style=api_client.ParameterStyle.FORM,
...
request_body_mds_query_criteria = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _save_search(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_mds_query_criteria.serialize(body, content_type)
