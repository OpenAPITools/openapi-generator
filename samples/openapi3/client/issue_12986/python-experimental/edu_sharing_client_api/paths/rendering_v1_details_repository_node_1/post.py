...
request_query_display_mode = api_client.QueryParameter(
    name="displayMode",
    style=api_client.ParameterStyle.FORM,
...
SchemaFor200ResponseBodyApplicationJson = RenderingDetailsEntry
...
class BaseApi(api_client.Api):
    ...
    def _get_details_snippet_with_parameters(
        self: api_client.Api,
...
class GetDetailsSnippetWithParameters(BaseApi):
    ...
    def get_details_snippet_with_parameters(
        ...
        return self._get_details_snippet_with_parameters(
            body=body,
