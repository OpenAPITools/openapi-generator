...
# query params
RecycleSchema = BoolSchema
ProtocolSchema = StrSchema
StoreSchema = StrSchema
...
request_query_recycle = api_client.QueryParameter(
    name="recycle",
