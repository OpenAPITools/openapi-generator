...
# path params
ReceiverSchema = StrSchema
TemplateSchema = StrSchema
...
request_path_receiver = api_client.PathParameter(
    name="receiver",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ReceiverSchema,
    required=True,
)
request_path_template = api_client.PathParameter(
    name="template",
    style=api_client.ParameterStyle.SIMPLE,
