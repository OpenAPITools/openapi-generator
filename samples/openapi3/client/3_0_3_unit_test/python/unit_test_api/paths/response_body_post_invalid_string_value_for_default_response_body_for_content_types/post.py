...
class PostInvalidStringValueForDefaultResponseBodyForContentTypes(BaseApi):
    ...
    def post_invalid_string_value_for_default_response_body_for_content_types(
        ...
        return self._post_invalid_string_value_for_default_response_body_for_content_types_oapg(
