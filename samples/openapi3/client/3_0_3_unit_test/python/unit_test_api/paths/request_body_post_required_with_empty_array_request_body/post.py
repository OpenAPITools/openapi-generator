...
class BaseApi(api_client.Api):
    ...
    def _post_required_with_empty_array_request_body_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_required_with_empty_array.serialize(body, content_type)
...
class PostRequiredWithEmptyArrayRequestBody(BaseApi):
    ...
    def post_required_with_empty_array_request_body(
        ...
        return self._post_required_with_empty_array_request_body_oapg(
            body=body,
