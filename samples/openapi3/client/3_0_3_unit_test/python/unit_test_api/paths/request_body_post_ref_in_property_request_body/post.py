...
class BaseApi(api_client.Api):
    ...
    def _post_ref_in_property_request_body_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_ref_in_property.serialize(body, content_type)
...
class PostRefInPropertyRequestBody(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def post_ref_in_property_request_body(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        stream: bool = False,
    ...
    def post_ref_in_property_request_body(
        ...
        return self._post_ref_in_property_request_body_oapg(
            body=body,
