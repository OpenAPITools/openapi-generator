...
class PostUniqueitemsFalseValidationResponseBodyForContentTypes(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def post_uniqueitems_false_validation_response_body_for_content_types(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def post_uniqueitems_false_validation_response_body_for_content_types(
        ...
        return self._post_uniqueitems_false_validation_response_body_for_content_types_oapg(
