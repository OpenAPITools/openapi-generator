...
class PostMaximumValidationWithUnsignedIntegerResponseBodyForContentTypes(BaseApi):
    ...
    def post_maximum_validation_with_unsigned_integer_response_body_for_content_types(
        ...
        return self._post_maximum_validation_with_unsigned_integer_response_body_for_content_types(
