...
class BaseApi(api_client.Api):
    ...
    def _post_ref_in_allof_request_body(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_ref_in_allof.serialize(body, content_type)
...
class PostRefInAllofRequestBody(BaseApi):
    ...
    def post_ref_in_allof_request_body(
        ...
        return self._post_ref_in_allof_request_body(
            body=body,
