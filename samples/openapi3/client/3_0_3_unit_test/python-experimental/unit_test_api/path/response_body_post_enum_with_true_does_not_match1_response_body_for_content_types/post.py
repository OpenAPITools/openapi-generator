...
class PostEnumWithTrueDoesNotMatch1ResponseBodyForContentTypes(BaseApi):
    ...
    def post_enum_with_true_does_not_match1_response_body_for_content_types(
        ...
        return self._post_enum_with_true_does_not_match1_response_body_for_content_types(
