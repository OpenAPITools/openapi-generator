...
class BaseApi(api_client.Api):
    ...
    def _post_anyof_with_one_empty_schema_request_body(
        self: api_client.Api,
        ...
        _fields = None
        _body = None
        serialized_data = request_body_anyof_with_one_empty_schema.serialize(body, content_type)
...
class PostAnyofWithOneEmptySchemaRequestBody(BaseApi):
    ...
    def post_anyof_with_one_empty_schema_request_body(
        ...
        return self._post_anyof_with_one_empty_schema_request_body(
            body=body,
