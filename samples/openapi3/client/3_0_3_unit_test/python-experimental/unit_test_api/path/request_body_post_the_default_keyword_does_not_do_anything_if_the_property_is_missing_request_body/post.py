...
class BaseApi(api_client.Api):
    ...
    def _post_the_default_keyword_does_not_do_anything_if_the_property_is_missing_request_body(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_the_default_keyword_does_not_do_anything_if_the_property_is_missing.serialize(body, content_type)
...
class PostTheDefaultKeywordDoesNotDoAnythingIfThePropertyIsMissingRequestBody(BaseApi):
    ...
    def post_the_default_keyword_does_not_do_anything_if_the_property_is_missing_request_body(
        ...
        return self._post_the_default_keyword_does_not_do_anything_if_the_property_is_missing_request_body(
            body=body,
