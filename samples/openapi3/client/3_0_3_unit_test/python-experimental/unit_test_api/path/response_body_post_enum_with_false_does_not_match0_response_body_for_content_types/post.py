...
class BaseApi(api_client.Api):
    ...
    def _post_enum_with_false_does_not_match0_response_body_for_content_types(
        self: api_client.Api,
...
class PostEnumWithFalseDoesNotMatch0ResponseBodyForContentTypes(BaseApi):
    ...
    def post_enum_with_false_does_not_match0_response_body_for_content_types(
        ...
        return self._post_enum_with_false_does_not_match0_response_body_for_content_types(
