...
class BaseApi(api_client.Api):
    ...
    def _post_maxproperties0_means_the_object_is_empty_response_body_for_content_types(
        self: api_client.Api,
...
class PostMaxproperties0MeansTheObjectIsEmptyResponseBodyForContentTypes(BaseApi):
    ...
    def post_maxproperties0_means_the_object_is_empty_response_body_for_content_types(
        ...
        return self._post_maxproperties0_means_the_object_is_empty_response_body_for_content_types(
