...
class BaseApi(api_client.Api):
    ...
    def _post_allof_combined_with_anyof_oneof_response_body_for_content_types(
        self: api_client.Api,
...
class PostAllofCombinedWithAnyofOneofResponseBodyForContentTypes(BaseApi):
    ...
    def post_allof_combined_with_anyof_oneof_response_body_for_content_types(
        ...
        return self._post_allof_combined_with_anyof_oneof_response_body_for_content_types(
