...
_path = '/responseBody/postMaximumValidationWithUnsignedIntegerResponseBodyForContentTypes'
_method = 'POST'
...
class PostMaximumValidationWithUnsignedIntegerResponseBodyForContentTypes(api_client.Api):
