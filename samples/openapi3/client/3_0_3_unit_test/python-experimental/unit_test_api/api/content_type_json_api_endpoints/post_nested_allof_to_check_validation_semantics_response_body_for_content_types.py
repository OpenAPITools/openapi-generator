...
_path = '/responseBody/postNestedAllofToCheckValidationSemanticsResponseBodyForContentTypes'
_method = 'POST'
...
class PostNestedAllofToCheckValidationSemanticsResponseBodyForContentTypes(api_client.Api):
