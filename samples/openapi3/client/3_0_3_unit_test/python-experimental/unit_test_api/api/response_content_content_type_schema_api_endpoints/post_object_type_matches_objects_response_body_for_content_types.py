...
_path = '/responseBody/postObjectTypeMatchesObjectsResponseBodyForContentTypes'
_method = 'POST'
...
class PostObjectTypeMatchesObjectsResponseBodyForContentTypes(api_client.Api):
