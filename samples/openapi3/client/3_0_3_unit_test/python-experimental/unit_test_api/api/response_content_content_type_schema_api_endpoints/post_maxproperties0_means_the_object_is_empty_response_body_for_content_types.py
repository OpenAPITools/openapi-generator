...
_path = '/responseBody/postMaxproperties0MeansTheObjectIsEmptyResponseBodyForContentTypes'
_method = 'POST'
...
class PostMaxproperties0MeansTheObjectIsEmptyResponseBodyForContentTypes(api_client.Api):
