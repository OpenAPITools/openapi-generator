...
_path = '/postTheDefaultKeywordDoesNotDoAnythingIfThePropertyIsMissingRequestBody'
_method = 'POST'
...
class PostTheDefaultKeywordDoesNotDoAnythingIfThePropertyIsMissingRequestBody(api_client.Api):
