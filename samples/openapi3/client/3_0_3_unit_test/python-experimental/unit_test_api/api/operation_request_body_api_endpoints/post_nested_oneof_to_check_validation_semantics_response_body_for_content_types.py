...
_path = '/responseBody/postNestedOneofToCheckValidationSemanticsResponseBodyForContentTypes'
_method = 'POST'
...
class PostNestedOneofToCheckValidationSemanticsResponseBodyForContentTypes(api_client.Api):
