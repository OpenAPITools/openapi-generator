...
_path = '/responseBody/postMinimumValidationWithSignedIntegerResponseBodyForContentTypes'
_method = 'POST'
...
class PostMinimumValidationWithSignedIntegerResponseBodyForContentTypes(api_client.Api):
