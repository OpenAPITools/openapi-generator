...
_path = '/responseBody/postObjectPropertiesValidationResponseBodyForContentTypes'
_method = 'POST'
...
class PostObjectPropertiesValidationResponseBodyForContentTypes(api_client.Api):
