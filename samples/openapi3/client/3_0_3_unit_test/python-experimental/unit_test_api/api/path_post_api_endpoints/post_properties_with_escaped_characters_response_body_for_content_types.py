...
_path = '/responseBody/postPropertiesWithEscapedCharactersResponseBodyForContentTypes'
_method = 'POST'
...
class PostPropertiesWithEscapedCharactersResponseBodyForContentTypes(api_client.Api):
