...
class BaseApi(api_client.Api):
    ...
    def _post_allof_combined_with_anyof_oneof_request_body(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_allof_combined_with_anyof_oneof.serialize(body, content_type)
...
class PostAllofCombinedWithAnyofOneofRequestBody(BaseApi):
    ...
    def post_allof_combined_with_anyof_oneof_request_body(
        ...
        return self._post_allof_combined_with_anyof_oneof_request_body(
            body=body,
