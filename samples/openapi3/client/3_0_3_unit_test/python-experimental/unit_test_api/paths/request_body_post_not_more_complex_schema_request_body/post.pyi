...
class SchemaForRequestBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        class not_schema(
            ...
            @typing.overload
            def __getitem__(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema]: ...
...
class PostNotMoreComplexSchemaRequestBody(BaseApi):
    ...
    def post_not_more_complex_schema_request_body(
        ...
        return self._post_not_more_complex_schema_request_body_oapg(
            body=body,
