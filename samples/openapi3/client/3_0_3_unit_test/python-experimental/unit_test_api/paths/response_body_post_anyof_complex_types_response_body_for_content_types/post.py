...
class BaseApi(api_client.Api):
    ...
    def _post_anyof_complex_types_response_body_for_content_types(
        self: api_client.Api,
...
class PostAnyofComplexTypesResponseBodyForContentTypes(BaseApi):
    ...
    def post_anyof_complex_types_response_body_for_content_types(
        ...
        return self._post_anyof_complex_types_response_body_for_content_types(
