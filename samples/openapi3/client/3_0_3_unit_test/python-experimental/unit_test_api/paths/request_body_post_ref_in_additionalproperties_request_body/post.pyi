...
class BaseApi(api_client.Api):
    ...
    def _post_ref_in_additionalproperties_request_body_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_ref_in_additionalproperties.serialize(body, content_type)
...
class PostRefInAdditionalpropertiesRequestBody(BaseApi):
    ...
    def post_ref_in_additionalproperties_request_body(
        ...
        return self._post_ref_in_additionalproperties_request_body_oapg(
            body=body,
