...
class BaseApi(api_client.Api):
    ...
    def _post_additionalproperties_are_allowed_by_default_response_body_for_content_types(
        self: api_client.Api,
...
class PostAdditionalpropertiesAreAllowedByDefaultResponseBodyForContentTypes(BaseApi):
    ...
    def post_additionalproperties_are_allowed_by_default_response_body_for_content_types(
        ...
        return self._post_additionalproperties_are_allowed_by_default_response_body_for_content_types(
