...
class BaseApi(api_client.Api):
    ...
    def _post_maxlength_validation_response_body_for_content_types(
        self: api_client.Api,
...
class PostMaxlengthValidationResponseBodyForContentTypes(BaseApi):
    ...
    def post_maxlength_validation_response_body_for_content_types(
        ...
        return self._post_maxlength_validation_response_body_for_content_types(
