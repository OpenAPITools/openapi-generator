...
class BaseApi(api_client.Api):
    ...
    def _post_anyof_with_one_empty_schema_response_body_for_content_types(
        self: api_client.Api,
...
class PostAnyofWithOneEmptySchemaResponseBodyForContentTypes(BaseApi):
    ...
    def post_anyof_with_one_empty_schema_response_body_for_content_types(
        ...
        return self._post_anyof_with_one_empty_schema_response_body_for_content_types(
