...
class BaseApi(api_client.Api):
    ...
    def _post_invalid_instance_should_not_raise_error_when_float_division_inf_response_body_for_content_types(
        self: api_client.Api,
...
class PostInvalidInstanceShouldNotRaiseErrorWhenFloatDivisionInfResponseBodyForContentTypes(BaseApi):
    ...
    def post_invalid_instance_should_not_raise_error_when_float_division_inf_response_body_for_content_types(
        ...
        return self._post_invalid_instance_should_not_raise_error_when_float_division_inf_response_body_for_content_types(
