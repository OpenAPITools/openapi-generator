...
class BaseApi(api_client.Api):
    ...
    def _post_minimum_validation_with_signed_integer_response_body_for_content_types(
        self: api_client.Api,
...
class PostMinimumValidationWithSignedIntegerResponseBodyForContentTypes(BaseApi):
