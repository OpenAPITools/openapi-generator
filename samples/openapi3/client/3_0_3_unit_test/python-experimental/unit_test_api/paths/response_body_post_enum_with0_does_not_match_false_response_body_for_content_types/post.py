...
class BaseApi(api_client.Api):
    ...
    def _post_enum_with0_does_not_match_false_response_body_for_content_types(
        self: api_client.Api,
...
class PostEnumWith0DoesNotMatchFalseResponseBodyForContentTypes(BaseApi):
    ...
    def post_enum_with0_does_not_match_false_response_body_for_content_types(
        ...
        return self._post_enum_with0_does_not_match_false_response_body_for_content_types(
