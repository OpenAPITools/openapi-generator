...
class BaseApi(api_client.Api):
    ...
    def _post_ref_in_anyof_response_body_for_content_types(
        self: api_client.Api,
...
class PostRefInAnyofResponseBodyForContentTypes(BaseApi):
    ...
    def post_ref_in_anyof_response_body_for_content_types(
        ...
        return self._post_ref_in_anyof_response_body_for_content_types(
