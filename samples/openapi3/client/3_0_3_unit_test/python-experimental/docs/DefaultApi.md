...
[**post_enum_with_false_does_not_match0_request_body**](DefaultApi.md#post_enum_with_false_does_not_match0_request_body) | **POST** /postEnumWithFalseDoesNotMatch0RequestBody | 
...
[**post_null_type_matches_only_the_null_object_request_body**](DefaultApi.md#post_null_type_matches_only_the_null_object_request_body) | **POST** /postNullTypeMatchesOnlyTheNullObjectRequestBody | 
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_maximum_validation_with_unsigned_integer_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_maxitems_validation_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_maxlength_validation_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_maxproperties0_means_the_object_is_empty_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_maxproperties_validation_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_minimum_validation_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_minimum_validation_with_signed_integer_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_minitems_validation_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_minlength_validation_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_minproperties_validation_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_nested_allof_to_check_validation_semantics_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_nested_anyof_to_check_validation_semantics_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_nested_items_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_nested_oneof_to_check_validation_semantics_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_not_more_complex_schema_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_not_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_nul_characters_in_strings_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_null_type_matches_only_the_null_object_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_number_type_matches_numbers_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_object_properties_validation_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_object_type_matches_objects_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_oneof_complex_types_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_oneof_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_oneof_with_base_schema_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_oneof_with_empty_schema_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_pattern_is_not_anchored_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_pattern_validation_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_properties_with_escaped_characters_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_property_named_ref_that_is_not_a_reference_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_ref_in_additionalproperties_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_ref_in_allof_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_ref_in_anyof_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_ref_in_items_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_ref_in_oneof_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_ref_in_property_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_required_default_validation_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_required_validation_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_required_with_empty_array_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_simple_enum_validation_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_string_type_matches_strings_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_uniqueitems_false_validation_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_uniqueitems_validation_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_uri_format_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_uri_reference_format_request_body: %s\n" % e)
```
### Parameters
...
with unit_test_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->post_uri_template_format_request_body: %s\n" % e)
```
### Parameters
