...
let test_enum_parameters enum_header_string_array enum_header_string enum_query_string_array enum_query_string enum_query_integer enum_query_double enum_form_string_array enum_form_string =
    ...
    let uri = Request.build_uri "/fake" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add_multi headers "enum_header_string_array" (List.map Enums.show_enum_form_string_array enum_header_string_array) in
    let headers = Cohttp.Header.add headers "enum_header_string" (Enums.show_enumclass enum_header_string) in
    let uri = Uri.add_query_param uri ("enum_query_string_array", List.map Enums.show_enum_form_string_array enum_query_string_array) in
    ...
    let body = Request.init_form_encoded_body () in
    let body = Request.add_form_encoded_body_params body ("enum_form_string_array", List.map Enums.show_enum_form_string_array enum_form_string_array) in
