...
export class PromisePetApi {
     ...
     */
    public addPetWithHttpInfo(pet: Pet, _options?: Configuration | PromiseMiddleware[]): Promise<HttpInfo<Pet>> {
     ...
     * @param pet Pet object that needs to be added to the store
     */
    public addPet(pet: Pet, _options?: Configuration | PromiseMiddleware[]): Promise<Pet> {
	let observableOptions: Configuration | undefined | Middleware[]
	if (Array.isArray(_options)){
		observableOptions = _options.map(m => new PromiseMiddlewareWrapper(m))
	}else{
     ...
     */
    public findPetsByTagsWithHttpInfo(tags: Array<string>, _options?: Configuration | PromiseMiddleware[]): Promise<HttpInfo<Array<Pet>>> {
	let observableOptions: Configuration | undefined | Middleware[]
	if (Array.isArray(_options)){
		observableOptions = _options.map(m => new PromiseMiddlewareWrapper(m))
	}else{
     ...
     * @param tags Tags to filter by
     */
    public findPetsByTags(tags: Array<string>, _options?: Configuration | PromiseMiddleware[]): Promise<Array<Pet>> {
	let observableOptions: Configuration | undefined | Middleware[]
	if (Array.isArray(_options)){
		observableOptions = _options.map(m => new PromiseMiddlewareWrapper(m))
	}else{
     ...
     * @param pet Pet object that needs to be added to the store
     */
    public updatePetWithHttpInfo(pet: Pet, _options?: Configuration | PromiseMiddleware[]): Promise<HttpInfo<Pet>> {
	let observableOptions: Configuration | undefined | Middleware[]
	if (Array.isArray(_options)){
		observableOptions = _options.map(m => new PromiseMiddlewareWrapper(m))
	}else{
     ...
     * @param pet Pet object that needs to be added to the store
     */
    public updatePet(pet: Pet, _options?: Configuration | PromiseMiddleware[]): Promise<Pet> {
	let observableOptions: Configuration | undefined | Middleware[]
	if (Array.isArray(_options)){
		observableOptions = _options.map(m => new PromiseMiddlewareWrapper(m))
	}else{
