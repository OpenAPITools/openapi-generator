...
export class PetApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async findPetsByTags(tags: Set<string>, _options?: ConfigurationOptions): Promise<RequestContext> {
	let _config = this.configuration;
	if (_options){
		_config = {
		    baseServer: _options.baseServer || _config.baseServer
     ...
     * @param additionalMetadata Additional data to pass to server
     */
    public async uploadFileWithRequiredFile(petId: number, requiredFile: HttpFile, additionalMetadata?: string, _options?: ConfigurationOptions): Promise<RequestContext> {
	let _config = this.configuration;
	if (_options){
		_config = {
		    baseServer: _options.baseServer || _config.baseServer
