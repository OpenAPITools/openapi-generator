...
module Request.Pet exposing (addPet, deletePet, findPetsByStatus, findPetsByTags, getPetById, updatePet, updatePetWithForm, uploadFile, uploadFileWithRequiredFile)
...
uploadFileWithRequiredFile : Int -> Http.Request ApiResponse
uploadFileWithRequiredFile petId =
    { method = "POST"
    , url = basePath ++ "/fake/" ++ String.fromInt petId ++ "/uploadImageWithRequiredFile"
    , headers = []
    , body = Http.emptyBody
    , expect = Http.expectJson ApiResponse.decoder
    , timeout = Just 30000
