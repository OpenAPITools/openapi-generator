...
public interface StoreApi {
    ...
    ResponseEntity<Order> placeOrder(@Parameter(name = "Order", description = "order placed for purchasing the pet", required = true, schema = @Schema(description = "")) @Valid @RequestBody Order order
);
