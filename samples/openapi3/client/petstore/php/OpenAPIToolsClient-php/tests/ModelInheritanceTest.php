...
use OpenAPITools\Client\Model\Animal;
use OpenAPITools\Client\Model\AnimalFarm;
use OpenAPITools\Client\Model\Cat;
use OpenAPITools\Client\Model\Dog;
...
class ModelInheritanceTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testArrayStuff()
    {
        ...
        foreach ($farm as $animal) {
            ...
            $this->assertInstanceOf('OpenAPITools\Client\Model\Animal', $animal);
        }
    }
}
