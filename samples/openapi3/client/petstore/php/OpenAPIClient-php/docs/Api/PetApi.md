...
[**replaceFileWithRequiredFile**](PetApi.md#replaceFileWithRequiredFile) | **PUT** /fake/{petId}/uploadImageWithRequiredFile | replaces an image (required)
...
# **replaceFileWithRequiredFile**
> \OpenAPI\Client\Model\ApiResponse replaceFileWithRequiredFile($pet_id, $required_file, $additional_metadata)
...
try {
    $result = $apiInstance->replaceFileWithRequiredFile($pet_id, $required_file, $additional_metadata);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling PetApi->replaceFileWithRequiredFile: ', $e->getMessage(), PHP_EOL;
}
?>
```
