...
class PetApi
{
    ...
    /**
     * Operation replaceFileWithRequiredFile
     *
     ...
     */
    public function replaceFileWithRequiredFile($pet_id, $required_file, $additional_metadata = null)
    {
        list($response) = $this->replaceFileWithRequiredFileWithHttpInfo($pet_id, $required_file, $additional_metadata);
        return $response;
    }

    /**
     * Operation replaceFileWithRequiredFileWithHttpInfo
     *
     * replaces an image (required)
     *
     * @param  int $pet_id ID of pet to update (required)
     ...
     */
    public function replaceFileWithRequiredFileWithHttpInfo($pet_id, $required_file, $additional_metadata = null)
    {
        $request = $this->replaceFileWithRequiredFileRequest($pet_id, $required_file, $additional_metadata);
    ...
    /**
     * Operation replaceFileWithRequiredFileAsync
     *
     * replaces an image (required)
     *
     * @param  int $pet_id ID of pet to update (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function replaceFileWithRequiredFileAsync($pet_id, $required_file, $additional_metadata = null)
    {
        return $this->replaceFileWithRequiredFileAsyncWithHttpInfo($pet_id, $required_file, $additional_metadata)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation replaceFileWithRequiredFileAsyncWithHttpInfo
     *
     * replaces an image (required)
     *
     * @param  int $pet_id ID of pet to update (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function replaceFileWithRequiredFileAsyncWithHttpInfo($pet_id, $required_file, $additional_metadata = null)
    {
        $returnType = '\OpenAPI\Client\Model\ApiResponse';
        $request = $this->replaceFileWithRequiredFileRequest($pet_id, $required_file, $additional_metadata);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function replaceFileWithRequiredFileRequest($pet_id, $required_file, $additional_metadata = null)
    {
        // verify the required parameter 'pet_id' is set
        if ($pet_id === null || (is_array($pet_id) && count($pet_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $pet_id when calling replaceFileWithRequiredFile'
            );
        }
        // verify the required parameter 'required_file' is set
        if ($required_file === null || (is_array($required_file) && count($required_file) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $required_file when calling replaceFileWithRequiredFile'
            );
        }
