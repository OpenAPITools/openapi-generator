...
class InlineObject2 implements ModelInterface, ArrayAccess
{
    ...
    public function setInteger($integer)
    {
        ...
        if (!is_null($integer) && ($integer > 100)) {
            throw new \InvalidArgumentException('invalid value for $integer when calling InlineObject2., must be smaller than or equal to 100.');
        }
        if (!is_null($integer) && ($integer < 10)) {
            throw new \InvalidArgumentException('invalid value for $integer when calling InlineObject2., must be bigger than or equal to 10.');
        }
    ...
    public function setInt32($int32)
    {
        ...
        if (!is_null($int32) && ($int32 > 200)) {
            throw new \InvalidArgumentException('invalid value for $int32 when calling InlineObject2., must be smaller than or equal to 200.');
        }
        if (!is_null($int32) && ($int32 < 20)) {
            throw new \InvalidArgumentException('invalid value for $int32 when calling InlineObject2., must be bigger than or equal to 20.');
        }
    ...
    public function setNumber($number)
    {
        ...
        if (($number > 543.2)) {
            throw new \InvalidArgumentException('invalid value for $number when calling InlineObject2., must be smaller than or equal to 543.2.');
        }
        if (($number < 32.1)) {
            throw new \InvalidArgumentException('invalid value for $number when calling InlineObject2., must be bigger than or equal to 32.1.');
        }
    ...
    public function setFloat($float)
    {
        ...
        if (!is_null($float) && ($float > 987.6)) {
            throw new \InvalidArgumentException('invalid value for $float when calling InlineObject2., must be smaller than or equal to 987.6.');
        }
    ...
    public function setDouble($double)
    {
        ...
        if (($double > 123.4)) {
            throw new \InvalidArgumentException('invalid value for $double when calling InlineObject2., must be smaller than or equal to 123.4.');
        }
        if (($double < 67.8)) {
            throw new \InvalidArgumentException('invalid value for $double when calling InlineObject2., must be bigger than or equal to 67.8.');
        }
    ...
    public function setString($string)
    {
        ...
        if (!is_null($string) && (!preg_match("/[a-z]/i", $string))) {
            throw new \InvalidArgumentException("invalid value for $string when calling InlineObject2., must conform to the pattern /[a-z]/i.");
        }
    ...
    public function setPatternWithoutDelimiter($pattern_without_delimiter)
    {
        ...
        if ((!preg_match("/^[A-Z].*/", $pattern_without_delimiter))) {
            throw new \InvalidArgumentException("invalid value for $pattern_without_delimiter when calling InlineObject2., must conform to the pattern /^[A-Z].*/.");
        }
    ...
    public function setPassword($password)
    {
        if (!is_null($password) && (mb_strlen($password) > 64)) {
            throw new \InvalidArgumentException('invalid length for $password when calling InlineObject2., must be smaller than or equal to 64.');
        }
        if (!is_null($password) && (mb_strlen($password) < 10)) {
            throw new \InvalidArgumentException('invalid length for $password when calling InlineObject2., must be bigger than or equal to 10.');
        }
