...
class Body3 implements ModelInterface, ArrayAccess
{
    ...
    public function setFloat($float)
    {
        ...
        if (!is_null($float) && ($float > 987.6)) {
            throw new \InvalidArgumentException('invalid value for $float when calling Body3., must be smaller than or equal to 987.6.');
        }
    ...
    public function setDouble($double)
    {
        ...
        if (($double > 123.4)) {
            throw new \InvalidArgumentException('invalid value for $double when calling Body3., must be smaller than or equal to 123.4.');
        }
        if (($double < 67.8)) {
            throw new \InvalidArgumentException('invalid value for $double when calling Body3., must be bigger than or equal to 67.8.');
        }
