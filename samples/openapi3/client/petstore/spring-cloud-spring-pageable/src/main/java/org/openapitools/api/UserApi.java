...
public interface UserApi {
    ...
    ResponseEntity<Void> createUser(
        @Parameter(name = "body", description = "Created user object", required = true) @RequestBody @NotNull @Valid User body
    );
    ...
    ResponseEntity<Void> createUsersWithArrayInput(
        @Parameter(name = "body", description = "List of user object", required = true) @RequestBody @NotNull List<@Valid User> body
    );
    ...
    ResponseEntity<Void> updateUser(
        ...
        @Parameter(name = "body", description = "Updated user object", required = true) @RequestBody @NotNull @Valid User body
    );
