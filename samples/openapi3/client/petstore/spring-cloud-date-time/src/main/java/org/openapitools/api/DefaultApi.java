...
public interface DefaultApi {
     ...
     * GET /thingy/{date}
     *
     * @param _date A date path parameter (required)
     * @param _dateTime A date-time query parameter (required)
    ...
    ResponseEntity<Void> get(
        @Parameter(name = "date", description = "A date path parameter", required = true, in = ParameterIn.PATH) @PathVariable("date") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate _date,
        @NotNull @Parameter(name = "dateTime", description = "A date-time query parameter", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "dateTime", required = true, defaultValue = "1973-12-19T03:39:57-08:00") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) OffsetDateTime _dateTime,
