    ...
    final exampleContext = ExampleContext();
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(FakeAnyOfWIthSameErasureGet200Response.canDeserialize(roundTripped, context), isTrue);

          final deserialized = FakeAnyOfWIthSameErasureGet200Response.deserialize(serialized, context);
