...
void main() {
  group(r'XmlItem', () {
    final reflection = XmlItem.$reflection;
    final exampleContext = ExampleContext();

      late XmlItem exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(XmlItem.canDeserialize(roundTripped, context), isTrue);

          final deserialized = XmlItem.deserialize(serialized, context);
