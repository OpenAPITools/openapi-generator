...
void main() {
  group(r'FakeOneOfWIthSameErasureGet200Response', () {
    final reflection = FakeOneOfWIthSameErasureGet200Response.$reflection;
    final exampleContext = ExampleContext();

      late FakeOneOfWIthSameErasureGet200Response exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(FakeOneOfWIthSameErasureGet200Response.canDeserialize(roundTripped, context), isTrue);

          final deserialized = FakeOneOfWIthSameErasureGet200Response.deserialize(serialized, context);
