...
void main() {
  group(r'FileSchemaTestClass', () {
    final reflection = FileSchemaTestClass.$reflection;
    final exampleContext = ExampleContext();

      late FileSchemaTestClass exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(FileSchemaTestClass.canDeserialize(roundTripped, context), isTrue);

          final deserialized = FileSchemaTestClass.deserialize(serialized, context);
