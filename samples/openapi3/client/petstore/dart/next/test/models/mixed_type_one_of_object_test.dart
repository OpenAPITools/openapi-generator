...
void main() {
  group(r'MixedTypeOneOfObject', () {
    final reflection = MixedTypeOneOfObject.$reflection;
    final exampleContext = ExampleContext();

      late MixedTypeOneOfObject exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(MixedTypeOneOfObject.canDeserialize(roundTripped, context), isTrue);

          final deserialized = MixedTypeOneOfObject.deserialize(serialized, context);
