...
void main() {
  group(r'PetsMulticontentTestPostRequest', () {
    final reflection = PetsMulticontentTestPostRequest.$reflection;
    final exampleContext = ExampleContext();

      late PetsMulticontentTestPostRequest exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(PetsMulticontentTestPostRequest.canDeserialize(roundTripped, context), isTrue);

          final deserialized = PetsMulticontentTestPostRequest.deserialize(serialized, context);
