...
void main() {
  group(r'ArrayOfInlineAllOf', () {
    final reflection = ArrayOfInlineAllOf.$reflection;
    final exampleContext = ExampleContext();

      late ArrayOfInlineAllOf exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(ArrayOfInlineAllOf.canDeserialize(roundTripped, context), isTrue);

          final deserialized = ArrayOfInlineAllOf.deserialize(serialized, context);
