...
void main() {
  group(r'Pet', () {
    final reflection = Pet.$reflection;
    final exampleContext = ExampleContext();

      late Pet exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(Pet.canDeserialize(roundTripped, context), isTrue);

          final deserialized = Pet.deserialize(serialized, context);
