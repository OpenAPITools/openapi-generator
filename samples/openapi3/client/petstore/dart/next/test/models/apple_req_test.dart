...
void main() {
  group(r'AppleReq', () {
    final reflection = AppleReq.$reflection;
    final exampleContext = ExampleContext();

      late AppleReq exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(AppleReq.canDeserialize(roundTripped, context), isTrue);

          final deserialized = AppleReq.deserialize(serialized, context);
