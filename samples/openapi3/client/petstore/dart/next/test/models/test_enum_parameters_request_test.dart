...
void main() {
  group(r'TestEnumParametersRequest', () {
    final reflection = TestEnumParametersRequest.$reflection;
    final exampleContext = ExampleContext();

      late TestEnumParametersRequest exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(TestEnumParametersRequest.canDeserialize(roundTripped, context), isTrue);

          final deserialized = TestEnumParametersRequest.deserialize(serialized, context);
