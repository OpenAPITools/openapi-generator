...
void main() {
  group(r'ReadOnlyFirst', () {
    final reflection = ReadOnlyFirst.$reflection;
    final exampleContext = ExampleContext();

      late ReadOnlyFirst exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(ReadOnlyFirst.canDeserialize(roundTripped, context), isTrue);

          final deserialized = ReadOnlyFirst.deserialize(serialized, context);
