...
void main() {
  group(r'ArrayOneOf', () {
    final reflection = ArrayOneOf.$reflection;
    final exampleContext = ExampleContext();

      late ArrayOneOf exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(ArrayOneOf.canDeserialize(roundTripped, context), isTrue);

          final deserialized = ArrayOneOf.deserialize(serialized, context);
