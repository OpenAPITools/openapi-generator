...
void main() {
  group(r'FreeFormObjectTestClassProperties', () {
    final reflection = FreeFormObjectTestClassProperties.$reflection;
    final exampleContext = ExampleContext();

      late FreeFormObjectTestClassProperties exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(FreeFormObjectTestClassProperties.canDeserialize(roundTripped, context), isTrue);

          final deserialized = FreeFormObjectTestClassProperties.deserialize(serialized, context);
