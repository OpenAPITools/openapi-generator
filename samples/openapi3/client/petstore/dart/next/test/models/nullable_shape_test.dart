...
void main() {
  group(r'NullableShape', () {
    final reflection = NullableShape.$reflection;
    final exampleContext = ExampleContext();

      late NullableShape exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(NullableShape.canDeserialize(roundTripped, context), isTrue);

          final deserialized = NullableShape.deserialize(serialized, context);
