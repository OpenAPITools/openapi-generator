...
void main() {
  group(r'FormatTest', () {
    final reflection = FormatTest.$reflection;
    final exampleContext = ExampleContext();

      late FormatTest exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(FormatTest.canDeserialize(roundTripped, context), isTrue);

          final deserialized = FormatTest.deserialize(serialized, context);
