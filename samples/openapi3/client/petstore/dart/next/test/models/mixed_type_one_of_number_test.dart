...
void main() {
  group(r'MixedTypeOneOfNumber', () {
    final reflection = MixedTypeOneOfNumber.$reflection;
    final exampleContext = ExampleContext();

      late MixedTypeOneOfNumber exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(MixedTypeOneOfNumber.canDeserialize(roundTripped, context), isTrue);

          final deserialized = MixedTypeOneOfNumber.deserialize(serialized, context);
