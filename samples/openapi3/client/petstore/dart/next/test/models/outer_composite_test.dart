...
void main() {
  group(r'OuterComposite', () {
    final reflection = OuterComposite.$reflection;
    final exampleContext = ExampleContext();

      late OuterComposite exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(OuterComposite.canDeserialize(roundTripped, context), isTrue);

          final deserialized = OuterComposite.deserialize(serialized, context);
