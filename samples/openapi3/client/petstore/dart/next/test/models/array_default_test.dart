...
void main() {
  group(r'ArrayDefault', () {
    final reflection = ArrayDefault.$reflection;
    final exampleContext = ExampleContext();

      late ArrayDefault exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(ArrayDefault.canDeserialize(roundTripped, context), isTrue);

          final deserialized = ArrayDefault.deserialize(serialized, context);
