...
void main() {
  group(r'TestJsonFormDataRequest', () {
    final reflection = TestJsonFormDataRequest.$reflection;
    final exampleContext = ExampleContext();

      late TestJsonFormDataRequest exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(TestJsonFormDataRequest.canDeserialize(roundTripped, context), isTrue);

          final deserialized = TestJsonFormDataRequest.deserialize(serialized, context);
