...
void main() {
  group(r'ModelWithOneOfAnyOfProperties', () {
    final reflection = ModelWithOneOfAnyOfProperties.$reflection;
    final exampleContext = ExampleContext();

      late ModelWithOneOfAnyOfProperties exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(ModelWithOneOfAnyOfProperties.canDeserialize(roundTripped, context), isTrue);

          final deserialized = ModelWithOneOfAnyOfProperties.deserialize(serialized, context);
