...
void main() {
  group(r'AllOfModelArrayAnyOfAllOfLinkListColumn1Value', () {
    final reflection = AllOfModelArrayAnyOfAllOfLinkListColumn1Value.$reflection;
    final exampleContext = ExampleContext();

      late AllOfModelArrayAnyOfAllOfLinkListColumn1Value exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(AllOfModelArrayAnyOfAllOfLinkListColumn1Value.canDeserialize(roundTripped, context), isTrue);

          final deserialized = AllOfModelArrayAnyOfAllOfLinkListColumn1Value.deserialize(serialized, context);
