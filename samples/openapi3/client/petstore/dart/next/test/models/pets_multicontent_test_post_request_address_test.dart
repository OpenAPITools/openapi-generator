...
void main() {
  group(r'PetsMulticontentTestPostRequestAddress', () {
    final reflection = PetsMulticontentTestPostRequestAddress.$reflection;
    final exampleContext = ExampleContext();

      late PetsMulticontentTestPostRequestAddress exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(PetsMulticontentTestPostRequestAddress.canDeserialize(roundTripped, context), isTrue);

          final deserialized = PetsMulticontentTestPostRequestAddress.deserialize(serialized, context);
