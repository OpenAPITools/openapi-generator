...
void main() {
  group(r'AllOfModelArrayAnyOfAllOfLinkListColumn1', () {
    ...
    final exampleContext = ExampleContext();
      ...
      late AllOfModelArrayAnyOfAllOfLinkListColumn1 exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(AllOfModelArrayAnyOfAllOfLinkListColumn1.canDeserialize(roundTripped, context), isTrue);

          final deserialized = AllOfModelArrayAnyOfAllOfLinkListColumn1.deserialize(serialized, context);
