...
void main() {
  group(r'GrandparentAnimal', () {
    final reflection = GrandparentAnimal.$reflection;
    final exampleContext = ExampleContext();

      late GrandparentAnimal exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(GrandparentAnimal.canDeserialize(roundTripped, context), isTrue);

          final deserialized = GrandparentAnimal.deserialize(serialized, context);
