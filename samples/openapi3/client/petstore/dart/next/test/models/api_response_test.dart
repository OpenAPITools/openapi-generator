...
void main() {
  group(r'ApiResponse', () {
    final reflection = ApiResponse.$reflection;
    final exampleContext = ExampleContext();

      late ApiResponse exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(ApiResponse.canDeserialize(roundTripped, context), isTrue);

          final deserialized = ApiResponse.deserialize(serialized, context);
