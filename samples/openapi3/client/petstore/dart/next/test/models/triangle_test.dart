...
void main() {
  group(r'Triangle', () {
    final reflection = Triangle.$reflection;
    final exampleContext = ExampleContext();

      late Triangle exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(Triangle.canDeserialize(roundTripped, context), isTrue);

          final deserialized = Triangle.deserialize(serialized, context);
