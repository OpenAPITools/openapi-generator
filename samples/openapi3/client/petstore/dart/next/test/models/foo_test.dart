...
void main() {
  group(r'Foo', () {
    final reflection = Foo.$reflection;
    final exampleContext = ExampleContext();

      late Foo exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(Foo.canDeserialize(roundTripped, context), isTrue);

          final deserialized = Foo.deserialize(serialized, context);
