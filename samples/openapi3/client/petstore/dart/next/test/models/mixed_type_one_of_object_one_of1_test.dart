...
void main() {
  group(r'MixedTypeOneOfObjectOneOf1', () {
    final reflection = MixedTypeOneOfObjectOneOf1.$reflection;
    final exampleContext = ExampleContext();

      late MixedTypeOneOfObjectOneOf1 exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(MixedTypeOneOfObjectOneOf1.canDeserialize(roundTripped, context), isTrue);

          final deserialized = MixedTypeOneOfObjectOneOf1.deserialize(serialized, context);
