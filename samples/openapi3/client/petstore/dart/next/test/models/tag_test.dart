...
void main() {
  group(r'Tag', () {
    final reflection = Tag.$reflection;
    final exampleContext = ExampleContext();

      late Tag exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(Tag.canDeserialize(roundTripped, context), isTrue);

          final deserialized = Tag.deserialize(serialized, context);
