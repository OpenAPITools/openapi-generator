...
void main() {
  group(r'TestEndpointParametersRequest', () {
    final reflection = TestEndpointParametersRequest.$reflection;
    final exampleContext = ExampleContext();

      late TestEndpointParametersRequest exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(TestEndpointParametersRequest.canDeserialize(roundTripped, context), isTrue);

          final deserialized = TestEndpointParametersRequest.deserialize(serialized, context);
