...
void main() {
  group(r'HasOnlyReadOnly', () {
    ...
    final exampleContext = ExampleContext();
      ...
      late HasOnlyReadOnly exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(HasOnlyReadOnly.canDeserialize(roundTripped, context), isTrue);

          final deserialized = HasOnlyReadOnly.deserialize(serialized, context);
