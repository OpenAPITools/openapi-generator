...
void main() {
  group(r'AllOfModelArrayAnyOfAllOfAttributesC', () {
    final reflection = AllOfModelArrayAnyOfAllOfAttributesC.$reflection;
    final exampleContext = ExampleContext();

      late AllOfModelArrayAnyOfAllOfAttributesC exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(AllOfModelArrayAnyOfAllOfAttributesC.canDeserialize(roundTripped, context), isTrue);

          final deserialized = AllOfModelArrayAnyOfAllOfAttributesC.deserialize(serialized, context);
