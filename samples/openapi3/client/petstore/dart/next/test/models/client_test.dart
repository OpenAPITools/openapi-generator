...
void main() {
  group(r'Client', () {
    final reflection = Client.$reflection;
    final exampleContext = ExampleContext();

      late Client exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(Client.canDeserialize(roundTripped, context), isTrue);

          final deserialized = Client.deserialize(serialized, context);
