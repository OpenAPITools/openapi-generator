...
void main() {
  group(r'HealthCheckResult', () {
    final reflection = HealthCheckResult.$reflection;
    final exampleContext = ExampleContext();

      late HealthCheckResult exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(HealthCheckResult.canDeserialize(roundTripped, context), isTrue);

          final deserialized = HealthCheckResult.deserialize(serialized, context);
