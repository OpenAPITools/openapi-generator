...
void main() {
  group(r'DeprecatedObject', () {
    final reflection = DeprecatedObject.$reflection;
    final exampleContext = ExampleContext();

      late DeprecatedObject exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(DeprecatedObject.canDeserialize(roundTripped, context), isTrue);

          final deserialized = DeprecatedObject.deserialize(serialized, context);
