...
void main() {
  group(r'GmFruit', () {
    final reflection = GmFruit.$reflection;
    final exampleContext = ExampleContext();

      late GmFruit exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(GmFruit.canDeserialize(roundTripped, context), isTrue);

          final deserialized = GmFruit.deserialize(serialized, context);
