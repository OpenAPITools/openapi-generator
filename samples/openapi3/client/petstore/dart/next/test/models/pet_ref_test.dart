...
void main() {
  group(r'PetRef', () {
    final reflection = PetRef.$reflection;
    final exampleContext = ExampleContext();

      late PetRef exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(PetRef.canDeserialize(roundTripped, context), isTrue);

          final deserialized = PetRef.deserialize(serialized, context);
