...
void main() {
  group(r'MixedTypeOneOfObjectOneOf', () {
    final reflection = MixedTypeOneOfObjectOneOf.$reflection;
    final exampleContext = ExampleContext();

      late MixedTypeOneOfObjectOneOf exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(MixedTypeOneOfObjectOneOf.canDeserialize(roundTripped, context), isTrue);

          final deserialized = MixedTypeOneOfObjectOneOf.deserialize(serialized, context);
