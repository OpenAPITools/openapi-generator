...
void main() {
  group(r'NewPetCategoryInlineAllofAllOfCategoryTag', () {
    ...
    final exampleContext = ExampleContext();
      ...
      late NewPetCategoryInlineAllofAllOfCategoryTag exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(NewPetCategoryInlineAllofAllOfCategoryTag.canDeserialize(roundTripped, context), isTrue);

          final deserialized = NewPetCategoryInlineAllofAllOfCategoryTag.deserialize(serialized, context);
