...
void main() {
  group(r'EquilateralTriangle', () {
    final reflection = EquilateralTriangle.$reflection;
    final exampleContext = ExampleContext();

      late EquilateralTriangle exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(EquilateralTriangle.canDeserialize(roundTripped, context), isTrue);

          final deserialized = EquilateralTriangle.deserialize(serialized, context);
