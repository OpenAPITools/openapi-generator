...
void main() {
  group(r'Quadrilateral', () {
    final reflection = Quadrilateral.$reflection;
    final exampleContext = ExampleContext();

      late Quadrilateral exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(Quadrilateral.canDeserialize(roundTripped, context), isTrue);

          final deserialized = Quadrilateral.deserialize(serialized, context);
