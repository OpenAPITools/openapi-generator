...
void main() {
  group(r'Apple', () {
    final reflection = Apple.$reflection;
    final exampleContext = ExampleContext();

      late Apple exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(Apple.canDeserialize(roundTripped, context), isTrue);

          final deserialized = Apple.deserialize(serialized, context);
