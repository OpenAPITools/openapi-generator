...
void main() {
  group(r'NewPet', () {
    final reflection = NewPet.$reflection;
    final exampleContext = ExampleContext();

      late NewPet exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(NewPet.canDeserialize(roundTripped, context), isTrue);

          final deserialized = NewPet.deserialize(serialized, context);
