...
void main() {
  group(r'UploadFileRequest', () {
    final reflection = UploadFileRequest.$reflection;
    final exampleContext = ExampleContext();

      late UploadFileRequest exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(UploadFileRequest.canDeserialize(roundTripped, context), isTrue);

          final deserialized = UploadFileRequest.deserialize(serialized, context);
