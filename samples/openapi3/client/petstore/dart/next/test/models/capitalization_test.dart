...
void main() {
  group(r'Capitalization', () {
    final reflection = Capitalization.$reflection;
    final exampleContext = ExampleContext();

      late Capitalization exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(Capitalization.canDeserialize(roundTripped, context), isTrue);

          final deserialized = Capitalization.deserialize(serialized, context);
