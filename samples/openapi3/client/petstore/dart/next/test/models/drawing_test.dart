...
void main() {
  group(r'Drawing', () {
    final reflection = Drawing.$reflection;
    final exampleContext = ExampleContext();

      late Drawing exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(Drawing.canDeserialize(roundTripped, context), isTrue);

          final deserialized = Drawing.deserialize(serialized, context);
