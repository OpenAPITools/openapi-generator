...
void main() {
  group(r'Value', () {
    final reflection = Value.$reflection;
    final exampleContext = ExampleContext();

      late Value exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(Value.canDeserialize(roundTripped, context), isTrue);

          final deserialized = Value.deserialize(serialized, context);
