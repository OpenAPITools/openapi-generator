...
void main() {
  group(r'Fruit', () {
    final reflection = Fruit.$reflection;
    final exampleContext = ExampleContext();

      late Fruit exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(Fruit.canDeserialize(roundTripped, context), isTrue);

          final deserialized = Fruit.deserialize(serialized, context);
