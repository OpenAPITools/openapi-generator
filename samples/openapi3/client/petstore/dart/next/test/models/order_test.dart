...
void main() {
  group(r'Order', () {
    final reflection = Order.$reflection;
    final exampleContext = ExampleContext();

      late Order exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(Order.canDeserialize(roundTripped, context), isTrue);

          final deserialized = Order.deserialize(serialized, context);
