...
void main() {
  group(r'ArrayOfArrayOfNumberOnly', () {
    final reflection = ArrayOfArrayOfNumberOnly.$reflection;
    final exampleContext = ExampleContext();

      late ArrayOfArrayOfNumberOnly exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(ArrayOfArrayOfNumberOnly.canDeserialize(roundTripped, context), isTrue);

          final deserialized = ArrayOfArrayOfNumberOnly.deserialize(serialized, context);
