...
void main() {
  group(r'EnumArrays', () {
    final reflection = EnumArrays.$reflection;
    final exampleContext = ExampleContext();

      late EnumArrays exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(EnumArrays.canDeserialize(roundTripped, context), isTrue);

          final deserialized = EnumArrays.deserialize(serialized, context);
