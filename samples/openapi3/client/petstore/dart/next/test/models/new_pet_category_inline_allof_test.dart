...
void main() {
  group(r'NewPetCategoryInlineAllof', () {
    final reflection = NewPetCategoryInlineAllof.$reflection;
    final exampleContext = ExampleContext();

      late NewPetCategoryInlineAllof exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(NewPetCategoryInlineAllof.canDeserialize(roundTripped, context), isTrue);

          final deserialized = NewPetCategoryInlineAllof.deserialize(serialized, context);
