...
void main() {
  group(r'PetComposition', () {
    final reflection = PetComposition.$reflection;
    final exampleContext = ExampleContext();

      late PetComposition exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(PetComposition.canDeserialize(roundTripped, context), isTrue);

          final deserialized = PetComposition.deserialize(serialized, context);
