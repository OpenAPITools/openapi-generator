...
void main() {
  group(r'TriangleInterface', () {
    final reflection = TriangleInterface.$reflection;
    final exampleContext = ExampleContext();

      late TriangleInterface exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(TriangleInterface.canDeserialize(roundTripped, context), isTrue);

          final deserialized = TriangleInterface.deserialize(serialized, context);
