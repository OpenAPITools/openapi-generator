...
void main() {
  group(r'Banana', () {
    final reflection = Banana.$reflection;
    final exampleContext = ExampleContext();

      late Banana exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(Banana.canDeserialize(roundTripped, context), isTrue);

          final deserialized = Banana.deserialize(serialized, context);
