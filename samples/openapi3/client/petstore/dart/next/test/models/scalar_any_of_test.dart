...
void main() {
  group(r'ScalarAnyOf', () {
    final reflection = ScalarAnyOf.$reflection;
    final exampleContext = ExampleContext();

      late ScalarAnyOf exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(ScalarAnyOf.canDeserialize(roundTripped, context), isTrue);

          final deserialized = ScalarAnyOf.deserialize(serialized, context);
