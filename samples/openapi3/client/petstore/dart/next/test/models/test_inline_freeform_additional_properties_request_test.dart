...
void main() {
  group(r'TestInlineFreeformAdditionalPropertiesRequest', () {
    final reflection = TestInlineFreeformAdditionalPropertiesRequest.$reflection;
    final exampleContext = ExampleContext();

      late TestInlineFreeformAdditionalPropertiesRequest exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(TestInlineFreeformAdditionalPropertiesRequest.canDeserialize(roundTripped, context), isTrue);

          final deserialized = TestInlineFreeformAdditionalPropertiesRequest.deserialize(serialized, context);
