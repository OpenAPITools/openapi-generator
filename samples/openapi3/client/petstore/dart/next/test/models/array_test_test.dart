...
void main() {
  group(r'ArrayTest', () {
    final reflection = ArrayTest.$reflection;
    final exampleContext = ExampleContext();

      late ArrayTest exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(ArrayTest.canDeserialize(roundTripped, context), isTrue);

          final deserialized = ArrayTest.deserialize(serialized, context);
