...
void main() {
  group(r'ComplexQuadrilateral', () {
    final reflection = ComplexQuadrilateral.$reflection;
    final exampleContext = ExampleContext();

      late ComplexQuadrilateral exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(ComplexQuadrilateral.canDeserialize(roundTripped, context), isTrue);

          final deserialized = ComplexQuadrilateral.deserialize(serialized, context);
