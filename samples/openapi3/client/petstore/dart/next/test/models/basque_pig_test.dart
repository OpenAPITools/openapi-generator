...
void main() {
  group(r'BasquePig', () {
    final reflection = BasquePig.$reflection;
    final exampleContext = ExampleContext();

      late BasquePig exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(BasquePig.canDeserialize(roundTripped, context), isTrue);

          final deserialized = BasquePig.deserialize(serialized, context);
