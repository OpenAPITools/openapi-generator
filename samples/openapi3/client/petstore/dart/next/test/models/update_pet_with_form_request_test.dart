...
void main() {
  group(r'UpdatePetWithFormRequest', () {
    final reflection = UpdatePetWithFormRequest.$reflection;
    final exampleContext = ExampleContext();

      late UpdatePetWithFormRequest exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(UpdatePetWithFormRequest.canDeserialize(roundTripped, context), isTrue);

          final deserialized = UpdatePetWithFormRequest.deserialize(serialized, context);
