...
void main() {
  group(r'AllOfModelArrayAnyOfAllOfAttributes', () {
    final reflection = AllOfModelArrayAnyOfAllOfAttributes.$reflection;
    final exampleContext = ExampleContext();

      late AllOfModelArrayAnyOfAllOfAttributes exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(AllOfModelArrayAnyOfAllOfAttributes.canDeserialize(roundTripped, context), isTrue);

          final deserialized = AllOfModelArrayAnyOfAllOfAttributes.deserialize(serialized, context);
