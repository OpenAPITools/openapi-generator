...
void main() {
  group(r'EnumStringDiscriminator', () {
    final reflection = EnumStringDiscriminator.$reflection;
    final exampleContext = ExampleContext();

      late EnumStringDiscriminator exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(EnumStringDiscriminator.canDeserialize(roundTripped, context), isTrue);

          final deserialized = EnumStringDiscriminator.deserialize(serialized, context);
