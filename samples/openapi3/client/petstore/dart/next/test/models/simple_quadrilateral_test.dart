...
void main() {
  group(r'SimpleQuadrilateral', () {
    final reflection = SimpleQuadrilateral.$reflection;
    final exampleContext = ExampleContext();

      late SimpleQuadrilateral exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(SimpleQuadrilateral.canDeserialize(roundTripped, context), isTrue);

          final deserialized = SimpleQuadrilateral.deserialize(serialized, context);
