...
void main() {
  group(r'SpecialModelName', () {
    final reflection = SpecialModelName.$reflection;
    final exampleContext = ExampleContext();

      late SpecialModelName exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(SpecialModelName.canDeserialize(roundTripped, context), isTrue);

          final deserialized = SpecialModelName.deserialize(serialized, context);
