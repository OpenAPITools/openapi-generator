...
void main() {
  group(r'Dog', () {
    final reflection = Dog.$reflection;
    final exampleContext = ExampleContext();

      late Dog exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(Dog.canDeserialize(roundTripped, context), isTrue);

          final deserialized = Dog.deserialize(serialized, context);
