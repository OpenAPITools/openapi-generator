...
void main() {
  group(r'ArrayOfNumberOnly', () {
    final reflection = ArrayOfNumberOnly.$reflection;
    final exampleContext = ExampleContext();

      late ArrayOfNumberOnly exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(ArrayOfNumberOnly.canDeserialize(roundTripped, context), isTrue);

          final deserialized = ArrayOfNumberOnly.deserialize(serialized, context);
