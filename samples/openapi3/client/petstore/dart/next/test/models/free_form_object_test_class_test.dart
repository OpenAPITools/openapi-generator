...
void main() {
  group(r'FreeFormObjectTestClass', () {
    final reflection = FreeFormObjectTestClass.$reflection;
    final exampleContext = ExampleContext();

      late FreeFormObjectTestClass exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(FreeFormObjectTestClass.canDeserialize(roundTripped, context), isTrue);

          final deserialized = FreeFormObjectTestClass.deserialize(serialized, context);
