...
void main() {
  group(r'$200Response', () {
    final reflection = $200Response.$reflection;
    final exampleContext = ExampleContext();

      late $200Response exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect($200Response.canDeserialize(roundTripped, context), isTrue);

          final deserialized = $200Response.deserialize(serialized, context);
