...
void main() {
  group(r'Animal', () {
    final reflection = Animal.$reflection;
    final exampleContext = ExampleContext();

      late Animal exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(Animal.canDeserialize(roundTripped, context), isTrue);

          final deserialized = Animal.deserialize(serialized, context);
