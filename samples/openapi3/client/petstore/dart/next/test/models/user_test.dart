...
void main() {
  group(r'User', () {
    final reflection = User.$reflection;
    final exampleContext = ExampleContext();

      late User exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(User.canDeserialize(roundTripped, context), isTrue);

          final deserialized = User.deserialize(serialized, context);
