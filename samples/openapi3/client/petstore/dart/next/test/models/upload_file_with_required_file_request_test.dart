...
void main() {
  group(r'UploadFileWithRequiredFileRequest', () {
    final reflection = UploadFileWithRequiredFileRequest.$reflection;
    final exampleContext = ExampleContext();

      late UploadFileWithRequiredFileRequest exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(UploadFileWithRequiredFileRequest.canDeserialize(roundTripped, context), isTrue);

          final deserialized = UploadFileWithRequiredFileRequest.deserialize(serialized, context);
