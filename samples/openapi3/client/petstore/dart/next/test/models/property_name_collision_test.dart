...
void main() {
  group(r'PropertyNameCollision', () {
    final reflection = PropertyNameCollision.$reflection;
    final exampleContext = ExampleContext();

      late PropertyNameCollision exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(PropertyNameCollision.canDeserialize(roundTripped, context), isTrue);

          final deserialized = PropertyNameCollision.deserialize(serialized, context);
