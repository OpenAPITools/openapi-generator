...
void main() {
  group(r'PetUsingAllOf', () {
    final reflection = PetUsingAllOf.$reflection;
    final exampleContext = ExampleContext();

      late PetUsingAllOf exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(PetUsingAllOf.canDeserialize(roundTripped, context), isTrue);

          final deserialized = PetUsingAllOf.deserialize(serialized, context);
