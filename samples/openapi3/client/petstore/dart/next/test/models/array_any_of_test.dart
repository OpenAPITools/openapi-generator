...
void main() {
  group(r'ArrayAnyOf', () {
    final reflection = ArrayAnyOf.$reflection;
    final exampleContext = ExampleContext();

      late ArrayAnyOf exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(ArrayAnyOf.canDeserialize(roundTripped, context), isTrue);

          final deserialized = ArrayAnyOf.deserialize(serialized, context);
