...
void main() {
  group(r'QuadrilateralInterface', () {
    ...
    final exampleContext = ExampleContext();
      ...
      late QuadrilateralInterface exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(QuadrilateralInterface.canDeserialize(roundTripped, context), isTrue);

          final deserialized = QuadrilateralInterface.deserialize(serialized, context);
