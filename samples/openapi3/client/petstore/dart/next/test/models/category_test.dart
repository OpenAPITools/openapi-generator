...
void main() {
  group(r'Category', () {
    final reflection = Category.$reflection;
    final exampleContext = ExampleContext();

      late Category exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(Category.canDeserialize(roundTripped, context), isTrue);

          final deserialized = Category.deserialize(serialized, context);
