...
void main() {
  group(r'Cat', () {
    final reflection = Cat.$reflection;
    final exampleContext = ExampleContext();

      late Cat exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(Cat.canDeserialize(roundTripped, context), isTrue);

          final deserialized = Cat.deserialize(serialized, context);
