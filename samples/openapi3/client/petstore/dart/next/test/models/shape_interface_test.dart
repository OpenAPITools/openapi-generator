...
void main() {
  group(r'ShapeInterface', () {
    final reflection = ShapeInterface.$reflection;
    final exampleContext = ExampleContext();

      late ShapeInterface exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(ShapeInterface.canDeserialize(roundTripped, context), isTrue);

          final deserialized = ShapeInterface.deserialize(serialized, context);
