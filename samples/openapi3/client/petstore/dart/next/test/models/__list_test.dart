...
void main() {
  group(r'$List', () {
    final reflection = $List.$reflection;
    final exampleContext = ExampleContext();

      late $List exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect($List.canDeserialize(roundTripped, context), isTrue);

          final deserialized = $List.deserialize(serialized, context);
