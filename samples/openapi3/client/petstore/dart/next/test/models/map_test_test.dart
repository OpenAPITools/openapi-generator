...
void main() {
  group(r'MapTest', () {
    final reflection = MapTest.$reflection;
    final exampleContext = ExampleContext();

      late MapTest exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(MapTest.canDeserialize(roundTripped, context), isTrue);

          final deserialized = MapTest.deserialize(serialized, context);
