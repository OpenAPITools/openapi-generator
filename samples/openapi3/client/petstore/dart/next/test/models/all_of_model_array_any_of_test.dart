...
void main() {
  group(r'AllOfModelArrayAnyOf', () {
    ...
    final exampleContext = ExampleContext();
      ...
      late AllOfModelArrayAnyOf exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(AllOfModelArrayAnyOf.canDeserialize(roundTripped, context), isTrue);

          final deserialized = AllOfModelArrayAnyOf.deserialize(serialized, context);
