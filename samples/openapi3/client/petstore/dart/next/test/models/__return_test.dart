...
void main() {
  group(r'$Return', () {
    final reflection = $Return.$reflection;
    final exampleContext = ExampleContext();

      late $Return exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect($Return.canDeserialize(roundTripped, context), isTrue);

          final deserialized = $Return.deserialize(serialized, context);
