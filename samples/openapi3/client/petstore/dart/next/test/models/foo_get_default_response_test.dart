...
void main() {
  group(r'FooGetDefaultResponse', () {
    final reflection = FooGetDefaultResponse.$reflection;
    final exampleContext = ExampleContext();

      late FooGetDefaultResponse exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(FooGetDefaultResponse.canDeserialize(roundTripped, context), isTrue);

          final deserialized = FooGetDefaultResponse.deserialize(serialized, context);
