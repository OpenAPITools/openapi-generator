...
void main() {
  group(r'ArrayOfInlineAllOfArrayAllofDogPropertyInner', () {
    final reflection = ArrayOfInlineAllOfArrayAllofDogPropertyInner.$reflection;
    final exampleContext = ExampleContext();

      late ArrayOfInlineAllOfArrayAllofDogPropertyInner exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(ArrayOfInlineAllOfArrayAllofDogPropertyInner.canDeserialize(roundTripped, context), isTrue);

          final deserialized = ArrayOfInlineAllOfArrayAllofDogPropertyInner.deserialize(serialized, context);
