...
void main() {
  group(r'BananaReq', () {
    final reflection = BananaReq.$reflection;
    final exampleContext = ExampleContext();

      late BananaReq exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(BananaReq.canDeserialize(roundTripped, context), isTrue);

          final deserialized = BananaReq.deserialize(serialized, context);
