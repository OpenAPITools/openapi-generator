...
void main() {
  group(r'PetWithRequiredTags', () {
    final reflection = PetWithRequiredTags.$reflection;
    final exampleContext = ExampleContext();

      late PetWithRequiredTags exampleInstance;
      setUp(() {
      ...
      parameterizedTest(
        ...
        (SerializationContext context) {
          ...
          expect(PetWithRequiredTags.canDeserialize(roundTripped, context), isTrue);

          final deserialized = PetWithRequiredTags.deserialize(serialized, context);
