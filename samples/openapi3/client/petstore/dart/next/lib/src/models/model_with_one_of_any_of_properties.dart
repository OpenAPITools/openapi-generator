...
///
mixin ModelWithOneOfAnyOfPropertiesMixin on $OpenApiObjectMixin {
  UndefinedWrapper<ArrayOneOf> get oneofProp;
  UndefinedWrapper<ArrayAnyOf> get anyofProp;
}

///
class ModelWithOneOfAnyOfProperties
    with $OpenApiObjectMixin, ModelWithOneOfAnyOfPropertiesMixin {
  @override
