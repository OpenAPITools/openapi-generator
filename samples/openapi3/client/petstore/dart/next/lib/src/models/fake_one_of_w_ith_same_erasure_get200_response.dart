...
///
mixin FakeOneOfWIthSameErasureGet200ResponseMixin on $OpenApiObjectMixin {
...
///
class FakeOneOfWIthSameErasureGet200Response
    with $OpenApiObjectMixin, FakeOneOfWIthSameErasureGet200ResponseMixin {
  @override
