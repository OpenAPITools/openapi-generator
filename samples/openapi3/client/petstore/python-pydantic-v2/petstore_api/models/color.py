...
class Color(BaseModel):
    ...
    """
    # data type: List[int]
    oneof_schema_1_validator: Optional[conlist(conint(strict=True, le=255, ge=0), max_length=3, min_length=3)] = Field(None, description="RGB three element array with values 0-255.")
    # data type: List[int]
    oneof_schema_2_validator: Optional[conlist(conint(strict=True, le=255, ge=0), max_length=4, min_length=4)] = Field(None, description="RGBA four element array with values 0-255.")
    # data type: str
