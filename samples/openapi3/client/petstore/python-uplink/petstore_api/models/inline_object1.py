...
__all__ = [
    'InlineObject1', 'InlineObject1Schema',
]


InlineObject1 = namedtuple('InlineObject1', field_names=['additional_metadata', 'file'])


class InlineObject1Schema(SchemaBase):
    """
    NOTE: This class is auto generated by OpenAPI Generator
    Ref: https://openapi-generator.tech
    Do not edit the class manually.
    """
    __model__ = InlineObject1

    additional_metadata = fields.String()
