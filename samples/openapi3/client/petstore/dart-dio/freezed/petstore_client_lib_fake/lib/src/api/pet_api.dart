...
class PetApi {
  ...
  /// Throws [DioException] if API call or serialization fails
    ...
    try {
                            ...
                            _responseData = _responseDataAsList.map<Pet>((dynamic e)=> Pet.fromJson(e as Map<String, dynamic>)).toList();
  ...
  @Deprecated('This operation has been deprecated')
    ...
    try {
                        final _responseDataAsSet = _response.data as List<dynamic>;
                            _responseData = _responseDataAsSet.map<Pet>((dynamic e)=> Pet.fromJson(e as Map<String, dynamic>)).toSet();
