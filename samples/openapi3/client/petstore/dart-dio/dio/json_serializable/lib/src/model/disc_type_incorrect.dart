...
class DiscTypeIncorrect {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is DiscTypeIncorrect &&
  ...
  factory DiscTypeIncorrect.fromJson(Map<String, dynamic> json) => _$DiscTypeIncorrectFromJson(json);
