...
class FakeApi {
  ...
  Future<Response<void>> fakeHttpSignatureTest({
    ...
    final _response = await rawApi.fakeHttpSignatureTest(
      ...
      header1: header1 == null
          ? null
          : _repository.serialize(header1, const TypeInfo(String)).toString(),
      body: _bodyData,
  ...
  Future<Response<OuterComposite>> fakeOuterCompositeSerialize({
    ...
    _bodyData = outerComposite == null
        ? null
        : _repository.serialize(outerComposite, const TypeInfo(OuterComposite));
  ...
  Future<Response<OuterObjectWithEnumProperty>>
    ...
    Object? _bodyData;
    _bodyData = _repository.serialize(outerObjectWithEnumProperty,
  ...
  Future<Response<void>> testBodyWithFileSchema({
    ...
    _bodyData = _repository.serialize(
        fileSchemaTestClass, const TypeInfo(FileSchemaTestClass));
  ...
  Future<Response<void>> testEndpointParameters({
    ...
    _bodyData = <String, dynamic>{
      ...
      if (binary != null)
        r'binary': encodeFormParameter(
            _repository, binary, const TypeInfo(MultipartFile)),
      if (date != null)
        r'date':
            encodeFormParameter(_repository, date, const TypeInfo(DateTime)),
      if (dateTime != null)
  ...
  Future<Response<void>> testEnumParameters({
    ...
    final _response = await rawApi.testEnumParameters(
      ...
      enumHeaderString: enumHeaderString == null
          ? null
          : _repository
              .serialize(enumHeaderString, const TypeInfo(String))
              .toString(),
      enumQueryStringArray: enumQueryStringArray == null
          ? null
          : encodeQueryParameter(
              _repository,
      ...
      enumQueryInteger: enumQueryInteger == null
          ? null
          : encodeQueryParameter(
              _repository,
              enumQueryInteger,
      ...
      enumQueryDouble: enumQueryDouble == null
          ? null
          : encodeQueryParameter(
              _repository,
              enumQueryDouble,
      ...
      enumQueryModelArray: enumQueryModelArray == null
          ? null
          : encodeQueryParameter(
              _repository,
              enumQueryModelArray,
  ...
  Future<Response<void>> testGroupParameters({
    ...
    final _response = await rawApi.testGroupParameters(
      ...
      requiredBooleanGroup: _repository
          .serialize(requiredBooleanGroup, const TypeInfo(bool))
          .toString(),
      ...
      booleanGroup: booleanGroup == null
          ? null
          : _repository
              .serialize(booleanGroup, const TypeInfo(bool))
              .toString(),
      int64Group: int64Group == null
          ? null
          : encodeQueryParameter(
              _repository,
              int64Group,
