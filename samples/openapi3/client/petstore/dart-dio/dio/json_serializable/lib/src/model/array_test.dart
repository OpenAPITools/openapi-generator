...
class ArrayTest {
  ...
  @JsonKey(name: r'array_of_string', required: false, includeIfNull: false)
  final List<String>? arrayOfString;

  @JsonKey(
      name: r'array_array_of_integer', required: false, includeIfNull: false)
  final List<List<int>>? arrayArrayOfInteger;

  @JsonKey(name: r'array_array_of_model', required: false, includeIfNull: false)
  ...
  factory ArrayTest.fromJson(Map<String, dynamic> json) =>
      _$ArrayTestFromJson(json);
