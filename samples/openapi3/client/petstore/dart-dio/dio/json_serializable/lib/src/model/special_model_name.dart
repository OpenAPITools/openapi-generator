...
class SpecialModelName {
  ...
  @JsonKey(
      name: r'$special[property.name]', required: false, includeIfNull: false)
  ...
  bool operator ==(Object other) =>
      ...
      other is SpecialModelName &&
          other.dollarSpecialLeftSquareBracketPropertyPeriodNameRightSquareBracket ==
  ...
  factory SpecialModelName.fromJson(Map<String, dynamic> json) =>
      _$SpecialModelNameFromJson(json);
