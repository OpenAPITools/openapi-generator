...
_responseData = rawData == null ? null : deserialize<FooBasicGetDefaultResponse, FooBasicGetDefaultResponse>(rawData, 'FooBasicGetDefaultResponse', growable: true);
  ...
  Future<Response<GigaOneOf>> list({ 
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<GigaOneOf, GigaOneOf>(rawData, 'GigaOneOf', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
  ...
  Future<Response<Fruit>> oneofGet({ 
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<Fruit, Fruit>(rawData, 'Fruit', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
...
_bodyData=jsonEncode(body);
  ...
  Future<Response<FruitVariant1>> variant1Get({ 
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<FruitVariant1, FruitVariant1>(rawData, 'FruitVariant1', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
  ...
  Future<Response<FruitAllOfDisc>> variant2Get({ 
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<FruitAllOfDisc, FruitAllOfDisc>(rawData, 'FruitAllOfDisc', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
