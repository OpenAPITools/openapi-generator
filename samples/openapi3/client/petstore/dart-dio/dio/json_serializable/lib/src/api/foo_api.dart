...
_responseData = rawData == null ? null : deserialize<FooRefOrValue, FooRefOrValue>(rawData, 'FooRefOrValue', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
  ...
  Future<Response<List<FooRefOrValue>>> getAllFoos({ 
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<List<FooRefOrValue>, FooRefOrValue>(rawData, 'List<FooRefOrValue>', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
