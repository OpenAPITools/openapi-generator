...
class FruitVariant1 {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FruitVariant1 &&
     other.color == color &&
     other.kind == kind;
  ...
  factory FruitVariant1.fromJson(Map<String, dynamic> json) => _$FruitVariant1FromJson(json);
