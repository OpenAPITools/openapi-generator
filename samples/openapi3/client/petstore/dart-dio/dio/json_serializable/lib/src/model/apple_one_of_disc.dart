...
class AppleOneOfDisc {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AppleOneOfDisc &&
     other.seeds == seeds &&
  ...
  factory AppleOneOfDisc.fromJson(Map<String, dynamic> json) => _$AppleOneOfDiscFromJson(json);
