...
class PizzaSpeziale {
  ...
  @JsonKey(name: r'toppings', required: false, includeIfNull: false)
  ...
  factory PizzaSpeziale.fromJson(Map<String, dynamic> json) =>
      _$PizzaSpezialeFromJson(json);
