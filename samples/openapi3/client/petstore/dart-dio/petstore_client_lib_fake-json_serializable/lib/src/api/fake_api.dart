...
class FakeApi {
  ...
  Future<Response<void>> testEndpointParameters({ 
    ...
    _bodyData = <String, dynamic>{
      ...
      if (binary != null) r'binary': _repository.encodeFormParameter(binary, const TypeInfo(MultipartFile)),
      if (date != null) r'date': _repository.encodeFormParameter(date, const TypeInfo(DateTime)),
