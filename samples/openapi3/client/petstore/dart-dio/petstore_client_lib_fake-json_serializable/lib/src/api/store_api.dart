...
class StoreApi {
  ...
  final StoreApiRaw _rawApi;
  final SerializationRepositoryBase _repository;

  const StoreApi(this._rawApi, this._repository);
  ...
  Future<Response<void>> deleteOrder({ 
    ...
    final _response = await _rawApi.deleteOrder(
      
      orderId: _repository.encodeStringParameter(orderId, const TypeInfo(String)),
  ...
  Future<Response<Map<String, int>>> getInventory({ 
    ...
    final _response = await _rawApi.getInventory(
  ...
  Future<Response<Order>> getOrderById({ 
    ...
    final _response = await _rawApi.getOrderById(
      
      orderId: _repository.encodeStringParameter(orderId, const TypeInfo(int)),
  ...
  Future<Response<Order>> placeOrder({ 
    ...
    final _response = await _rawApi.placeOrder(
