...
class FooApi {
  ...
  /// Throws [DioException] if API call or serialization fails
    ...
    try {
                            ...
                            _responseData = _responseDataAsList.map<FooRefOrValue>((dynamic e)=> FooRefOrValue.fromJson(e as Map<String, dynamic>)).toList();
