  ...
  Future<Response<FakeBigDecimalMap200Response>> fakeBigDecimalMap({ 
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(FakeBigDecimalMap200Response),
  ...
  Future<Response<void>> testEndpointParameters({ 
    ...
    try {
      _bodyData = <String, dynamic>{
        ...
        if (date != null) r'date': encodeQueryParameter(_serializers, date, const FullType(OffsetDate)),
        if (dateTime != null) r'dateTime': encodeQueryParameter(_serializers, dateTime, const FullType(OffsetDateTime)),
