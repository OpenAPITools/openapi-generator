...
RESTResponseType = httpx2.Response
...
class RESTClientObject:
    ...
    def __init__(self, configuration) -> None:
        ...
        self.pool_manager: Optional[httpx2.AsyncClient] = None
    ...
    async def request(
        ...
        if method in ['POST', 'PUT', 'PATCH', 'OPTIONS', 'DELETE']:
            if re.search('json', headers['Content-Type'], re.IGNORECASE):
                ...
                # Content-Type which generated by httpx2
    ...
    def _create_pool_manager(self) -> httpx2.AsyncClient:
        limits = httpx2.Limits(max_connections=self.maxsize)
