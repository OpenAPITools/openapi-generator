...
class TestPetApiTests(unittest.IsolatedAsyncioTestCase):
    ...
    @unittest.skip("TODO: httpx2: httpx2.AsyncClient.request always preloads content")
    async def test_add_pet_and_get_pet_by_id_without_preload_content(self):
        ...
        self.assertIsInstance(fetched, httpx2.Response)
    ...
    async def test_proxy(self):
        ...
        # the client library (httpx2) tried to use it.
        ...
        async with petstore_api.ApiClient(config) as client:
            ...
            with self.assertRaisesRegex(
                petstore_api.rest.httpx2.ConnectError,
