...
@XmlRootElement(name = "ShapeOrNull")
@XmlAccessorType(XmlAccessType.FIELD)
@JacksonXmlRootElement(localName = "ShapeOrNull")
        ...
        public ShapeOrNull deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            switch (discriminatorValue) {
                ...
                case "Triangle":
                    ...
                    return newShapeOrNull;
                default:
                    log.log(Level.WARNING, String.format(Locale.ROOT, "Failed to lookup discriminator value `%s` for ShapeOrNull. Possible values: Quadrilateral Triangle", discriminatorValue));
            }
