...
public class InlineObject3 {
  ...
  private OffsetDateTime dateTime = OffsetDateTime.parse("2010-02-01T01:20:10.111110-08:00[America/Los_Angeles]", java.time.format.DateTimeFormatter.ISO_ZONED_DATE_TIME.withZone(java.time.ZoneId.systemDefault()));
