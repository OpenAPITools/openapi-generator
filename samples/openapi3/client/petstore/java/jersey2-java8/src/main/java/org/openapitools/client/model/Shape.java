...
@JacksonXmlRootElement(localName = "Shape")
        ...
        public Shape deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            switch (discriminatorValue) {
                ...
                case "Triangle":
                    ...
                    return newShape;
                default:
                    log.log(Level.WARNING, String.format(Locale.ROOT, "Failed to lookup discriminator value `%s` for Shape. Possible values: Quadrilateral Triangle", discriminatorValue));
            }
            ...
            throw new IOException(String.format(Locale.ROOT, "Failed deserialization for Shape: %d classes match result, expected 1", match));
        }
