...
class EnumTest(object):
    ...
    def enum_string(self, enum_string):
        ...
        if enum_string not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def enum_string_required(self, enum_string_required):
        ...
        """
        if enum_string_required is None:  # noqa: E501
            raise ValueError("Invalid value for `enum_string_required`, must not be `None`")  # noqa: E501
        allowed_values = ["UPPER", "lower", ""]  # noqa: E501
        if enum_string_required not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def enum_integer(self, enum_integer):
        ...
        if enum_integer not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    def enum_number(self, enum_number):
        ...
        if enum_number not in allowed_values:  # noqa: E501
            raise ValueError(
