...
class FakeApi(object):
    ...
    def fake_any_type_request_body(self, body : Optional[Dict[str, Any]] = None, **kwargs) -> None:  # noqa: E501
        ...
        :rtype: None
        """
        return self.fake_any_type_request_body_with_http_info(body, **kwargs).data  # noqa: E501
    ...
    def fake_enum_ref_query_parameter(self, enum_ref : Annotated[Optional[EnumClass], Field(description="enum reference")] = None, **kwargs) -> None:  # noqa: E501
        ...
        :rtype: None
        """
        return self.fake_enum_ref_query_parameter_with_http_info(enum_ref, **kwargs).data  # noqa: E501
    ...
    def fake_health_get(self, **kwargs) -> HealthCheckResult:  # noqa: E501
        ...
        """
        return self.fake_health_get_with_http_info(**kwargs).data  # noqa: E501
    ...
    def fake_http_signature_test(self, pet : Annotated[Pet, Field(..., description="Pet object that needs to be added to the store")], query_1 : Annotated[Optional[StrictStr], Field(description="query parameter")] = None, header_1 : Annotated[Optional[StrictStr], Field(description="header parameter")] = None, **kwargs) -> None:  # noqa: E501
        ...
        :rtype: None
        """
        return self.fake_http_signature_test_with_http_info(pet, query_1, header_1, **kwargs).data  # noqa: E501
    ...
    def fake_outer_boolean_serialize(self, body : Annotated[Optional[StrictBool], Field(description="Input boolean as post body")] = None, **kwargs) -> bool:  # noqa: E501
        ...
        :rtype: bool
        """
        return self.fake_outer_boolean_serialize_with_http_info(body, **kwargs).data  # noqa: E501
    ...
    def fake_outer_composite_serialize(self, outer_composite : Annotated[Optional[OuterComposite], Field(description="Input composite as post body")] = None, **kwargs) -> OuterComposite:  # noqa: E501
        ...
        """
        return self.fake_outer_composite_serialize_with_http_info(outer_composite, **kwargs).data  # noqa: E501
    ...
    def fake_outer_number_serialize(self, body : Annotated[Optional[StrictFloat], Field(description="Input number as post body")] = None, **kwargs) -> float:  # noqa: E501
        ...
        :rtype: float
        """
        return self.fake_outer_number_serialize_with_http_info(body, **kwargs).data  # noqa: E501
    ...
    def fake_outer_string_serialize(self, body : Annotated[Optional[StrictStr], Field(description="Input string as post body")] = None, **kwargs) -> str:  # noqa: E501
        ...
        :rtype: str
        """
        return self.fake_outer_string_serialize_with_http_info(body, **kwargs).data  # noqa: E501
    ...
    def fake_property_enum_integer_serialize(self, outer_object_with_enum_property : Annotated[OuterObjectWithEnumProperty, Field(..., description="Input enum (int) as post body")], **kwargs) -> OuterObjectWithEnumProperty:  # noqa: E501
        ...
        """
        return self.fake_property_enum_integer_serialize_with_http_info(outer_object_with_enum_property, **kwargs).data  # noqa: E501
    ...
    def test_body_with_binary(self, body : Annotated[Optional[StrictStr], Field(..., description="image to upload")], **kwargs) -> None:  # noqa: E501
        ...
        :rtype: None
        """
        return self.test_body_with_binary_with_http_info(body, **kwargs).data  # noqa: E501

    @validate_arguments
    def test_body_with_binary_with_http_info(self, body : Annotated[Optional[StrictStr], Field(..., description="image to upload")], **kwargs) -> ApiResponse:  # noqa: E501
        """test_body_with_binary  # noqa: E501
    ...
    def test_body_with_file_schema(self, file_schema_test_class : FileSchemaTestClass, **kwargs) -> None:  # noqa: E501
        ...
        :rtype: None
        """
        return self.test_body_with_file_schema_with_http_info(file_schema_test_class, **kwargs).data  # noqa: E501
    ...
    def test_body_with_query_params(self, query : StrictStr, user : User, **kwargs) -> None:  # noqa: E501
        ...
        :rtype: None
        """
        return self.test_body_with_query_params_with_http_info(query, user, **kwargs).data  # noqa: E501
    ...
    def test_client_model(self, client : Annotated[Client, Field(..., description="client model")], **kwargs) -> Client:  # noqa: E501
        ...
        :rtype: Client
        """
        return self.test_client_model_with_http_info(client, **kwargs).data  # noqa: E501
    ...
    def test_date_time_query_parameter(self, date_time_query : datetime, str_query : StrictStr, **kwargs) -> None:  # noqa: E501
        ...
        :rtype: None
        """
        return self.test_date_time_query_parameter_with_http_info(date_time_query, str_query, **kwargs).data  # noqa: E501
    ...
    def test_endpoint_parameters(self, number : Annotated[confloat(le=543.2, ge=32.1, strict=True), Field(..., description="None")], double : Annotated[confloat(le=123.4, ge=67.8, strict=True), Field(..., description="None")], pattern_without_delimiter : Annotated[constr(strict=True), Field(..., description="None")], byte : Annotated[StrictStr, Field(..., description="None")], integer : Annotated[Optional[conint(strict=True, le=100, ge=10)], Field(description="None")] = None, int32 : Annotated[Optional[conint(strict=True, le=200, ge=20)], Field(description="None")] = None, int64 : Annotated[Optional[StrictInt], Field(description="None")] = None, float : Annotated[Optional[confloat(le=987.6, strict=True)], Field(description="None")] = None, string : Annotated[Optional[constr(strict=True)], Field(description="None")] = None, binary : Annotated[Optional[StrictStr], Field(description="None")] = None, var_date : Annotated[Optional[date], Field(description="None")] = None, date_time : Annotated[Optional[datetime], Field(description="None")] = None, password : Annotated[Optional[constr(strict=True, max_length=64, min_length=10)], Field(description="None")] = None, param_callback : Annotated[Optional[StrictStr], Field(description="None")] = None, **kwargs) -> None:  # noqa: E501
        ...
        :rtype: None
        """
        return self.test_endpoint_parameters_with_http_info(number, double, pattern_without_delimiter, byte, integer, int32, int64, float, string, binary, var_date, date_time, password, param_callback, **kwargs).data  # noqa: E501
    ...
    def test_group_parameters(self, required_string_group : Annotated[StrictInt, Field(..., description="Required String in group parameters")], required_boolean_group : Annotated[StrictBool, Field(..., description="Required Boolean in group parameters")], required_int64_group : Annotated[StrictInt, Field(..., description="Required Integer in group parameters")], string_group : Annotated[Optional[StrictInt], Field(description="String in group parameters")] = None, boolean_group : Annotated[Optional[StrictBool], Field(description="Boolean in group parameters")] = None, int64_group : Annotated[Optional[StrictInt], Field(description="Integer in group parameters")] = None, **kwargs) -> None:  # noqa: E501
        ...
        :rtype: None
        """
        return self.test_group_parameters_with_http_info(required_string_group, required_boolean_group, required_int64_group, string_group, boolean_group, int64_group, **kwargs).data  # noqa: E501
    ...
    def test_inline_additional_properties(self, request_body : Annotated[Dict[str, StrictStr], Field(..., description="request body")], **kwargs) -> None:  # noqa: E501
        ...
        :rtype: None
        """
        return self.test_inline_additional_properties_with_http_info(request_body, **kwargs).data  # noqa: E501
    ...
    def test_json_form_data(self, param : Annotated[StrictStr, Field(..., description="field1")], param2 : Annotated[StrictStr, Field(..., description="field2")], **kwargs) -> None:  # noqa: E501
        ...
        :rtype: None
        """
        return self.test_json_form_data_with_http_info(param, param2, **kwargs).data  # noqa: E501
    ...
    def test_query_parameter_collection_format(self, pipe : conlist(StrictStr), ioutil : conlist(StrictStr), http : conlist(StrictStr), url : conlist(StrictStr), context : conlist(StrictStr), allow_empty : StrictStr, language : Optional[Dict[str, StrictStr]] = None, **kwargs) -> None:  # noqa: E501
        ...
        :rtype: None
        """
        return self.test_query_parameter_collection_format_with_http_info(pipe, ioutil, http, url, context, allow_empty, language, **kwargs).data  # noqa: E501
