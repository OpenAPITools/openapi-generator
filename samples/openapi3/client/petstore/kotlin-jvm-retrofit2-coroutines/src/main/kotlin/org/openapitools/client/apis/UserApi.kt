...
interface UserApi {
    ...
    suspend fun createUsersWithArrayInput(@Body user: kotlin.collections.List<User>): Unit

    @POST("user/createWithList")
    suspend fun createUsersWithListInput(@Body user: kotlin.collections.List<User>): Unit
