...
class UuidWithPattern(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UuidWithPattern:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UuidWithPattern:
        """Create an instance of UuidWithPattern from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UuidWithPattern.parse_obj(obj)

        _obj = UuidWithPattern.parse_obj({
            "id": obj.get("id")
        })
