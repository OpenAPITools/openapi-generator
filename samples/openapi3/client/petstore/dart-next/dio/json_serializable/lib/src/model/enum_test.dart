...
class EnumTest {
  ...
  @JsonKey(name: r'enum_string', required: false, includeIfNull: false)
  final EnumTestEnumStringEnum? enumString;

  @JsonKey(name: r'enum_string_required', required: true, includeIfNull: false)
  final EnumTestEnumStringRequiredEnum enumStringRequired;

  @JsonKey(name: r'enum_integer', required: false, includeIfNull: false)
  final EnumTestEnumIntegerEnum? enumInteger;

  @JsonKey(name: r'enum_number', required: false, includeIfNull: false)
  final EnumTestEnumNumberEnum? enumNumber;

  @JsonKey(name: r'outerEnum', required: false, includeIfNull: false)
  final OuterEnum? outerEnum;

  @JsonKey(name: r'outerEnumInteger', required: false, includeIfNull: false)
  final OuterEnumInteger? outerEnumInteger;

  @JsonKey(
      name: r'outerEnumDefaultValue', required: false, includeIfNull: false)
  ...
  factory EnumTest.fromJson(Map<String, dynamic> json) =>
