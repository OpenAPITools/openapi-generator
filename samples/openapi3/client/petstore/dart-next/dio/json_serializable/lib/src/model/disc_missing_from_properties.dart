...
class DiscMissingFromProperties {
  ...
  bool operator ==(Object other) =>
      ...
      other is DiscMissingFromProperties && other.length == length;

  @override
  int get hashCode => length.hashCode;

  factory DiscMissingFromProperties.fromJson(Map<String, dynamic> json) =>
      _$DiscMissingFromPropertiesFromJson(json);
