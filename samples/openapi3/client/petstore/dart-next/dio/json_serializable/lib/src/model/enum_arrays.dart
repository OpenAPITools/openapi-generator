...
class EnumArrays {
  ...
  @JsonKey(name: r'just_symbol', required: false, includeIfNull: false)
  final EnumArraysJustSymbolEnum? justSymbol;

  @JsonKey(name: r'array_enum', required: false, includeIfNull: false)
  ...
  @override
  int get hashCode => justSymbol.hashCode + arrayEnum.hashCode;

  factory EnumArrays.fromJson(Map<String, dynamic> json) =>
      _$EnumArraysFromJson(json);
