...
class Capitalization {
  ...
  @JsonKey(name: r'smallCamel', required: false, includeIfNull: false)
  final String? smallCamel;

  @JsonKey(name: r'CapitalCamel', required: false, includeIfNull: false)
  final String? capitalCamel;

  @JsonKey(name: r'small_Snake', required: false, includeIfNull: false)
  final String? smallSnake;

  @JsonKey(name: r'Capital_Snake', required: false, includeIfNull: false)
  final String? capitalSnake;

  @JsonKey(name: r'SCA_ETH_Flow_Points', required: false, includeIfNull: false)
  final String? sCAETHFlowPoints;

  /// Name of the pet
  @JsonKey(name: r'ATT_NAME', required: false, includeIfNull: false)
  ...
  factory Capitalization.fromJson(Map<String, dynamic> json) =>
      _$CapitalizationFromJson(json);
