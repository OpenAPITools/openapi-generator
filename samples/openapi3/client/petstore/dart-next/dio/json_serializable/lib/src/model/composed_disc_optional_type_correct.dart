...
class ComposedDiscOptionalTypeCorrect {
  ...
  bool operator ==(Object other) =>
      ...
      other is ComposedDiscOptionalTypeCorrect && other.fruitType == fruitType;

  @override
  int get hashCode => fruitType.hashCode;

  factory ComposedDiscOptionalTypeCorrect.fromJson(Map<String, dynamic> json) =>
      _$ComposedDiscOptionalTypeCorrectFromJson(json);

  Map<String, dynamic> toJson() =>
      _$ComposedDiscOptionalTypeCorrectToJson(this);
