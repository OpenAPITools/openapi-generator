...
class MapTest {
  ...
  @JsonKey(name: r'map_map_of_string', required: false, includeIfNull: false)
  final Map<String, Map<String, String>>? mapMapOfString;

  @JsonKey(name: r'map_of_enum_string', required: false, includeIfNull: false)
  final Map<String, MapTestMapOfEnumStringEnum>? mapOfEnumString;

  @JsonKey(name: r'direct_map', required: false, includeIfNull: false)
  final Map<String, bool>? directMap;

  @JsonKey(name: r'indirect_map', required: false, includeIfNull: false)
  ...
  factory MapTest.fromJson(Map<String, dynamic> json) =>
      _$MapTestFromJson(json);
