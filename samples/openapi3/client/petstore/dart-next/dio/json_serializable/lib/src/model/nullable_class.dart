...
class NullableClass {
  ...
  @JsonKey(name: r'integer_prop', required: false, includeIfNull: false)
  final int? integerProp;

  @JsonKey(name: r'number_prop', required: false, includeIfNull: false)
  final num? numberProp;

  @JsonKey(name: r'boolean_prop', required: false, includeIfNull: false)
  final bool? booleanProp;

  @JsonKey(name: r'string_prop', required: false, includeIfNull: false)
  final String? stringProp;

  @JsonKey(name: r'date_prop', required: false, includeIfNull: false)
  final DateTime? dateProp;

  @JsonKey(name: r'datetime_prop', required: false, includeIfNull: false)
  final DateTime? datetimeProp;

  @JsonKey(name: r'array_nullable_prop', required: false, includeIfNull: false)
  ...
  @JsonKey(name: r'array_items_nullable', required: false, includeIfNull: false)
  final List<Object>? arrayItemsNullable;

  @JsonKey(name: r'object_nullable_prop', required: false, includeIfNull: false)
  ...
  @JsonKey(
      name: r'object_items_nullable', required: false, includeIfNull: false)
  ...
  factory NullableClass.fromJson(Map<String, dynamic> json) =>
      _$NullableClassFromJson(json);
