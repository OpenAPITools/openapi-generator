...
class FruitInlineInlineDiscOneOfOneOf {
  ...
  bool operator ==(Object other) =>
      ...
      other is FruitInlineInlineDiscOneOfOneOf && other.fruitType == fruitType;

  @override
  int get hashCode => fruitType.hashCode;

  factory FruitInlineInlineDiscOneOfOneOf.fromJson(Map<String, dynamic> json) =>
      _$FruitInlineInlineDiscOneOfOneOfFromJson(json);

  Map<String, dynamic> toJson() =>
      _$FruitInlineInlineDiscOneOfOneOfToJson(this);
