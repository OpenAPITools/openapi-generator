...
class FakeApi {
  ...
  Future<Response<HealthCheckResult>> fakeHealthGet({
    ...
    try {
      ...
      _responseData = rawResponse == null
          ? null
          : decodeResponse(
              _repository, rawResponse, const TypeInfo(HealthCheckResult));
  ...
  Future<Response<void>> fakeHttpSignatureTest({
    ...
    final _response = await rawApi.fakeHttpSignatureTest(
      query1: encodeQueryParameter(
        _repository,
        query1,
        const TypeInfo(String),
      ),
      header1:
          encodeStringParameter(_repository, header1, const TypeInfo(String)),
      body: _bodyData,
  ...
  Future<Response<bool>> fakeOuterBooleanSerialize({
    ...
    Object? _bodyData;
    _bodyData = encodeBodyParameter(_repository, body, const TypeInfo(bool));
    ...
    try {
      ...
      _responseData = rawResponse == null
          ? null
          : decodeResponse(_repository, rawResponse, const TypeInfo(bool));
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
  ...
  Future<Response<OuterComposite>> fakeOuterCompositeSerialize({
    ...
    _bodyData = encodeBodyParameter(
        _repository, outerComposite, const TypeInfo(OuterComposite));
    ...
    try {
      ...
      _responseData = rawResponse == null
          ? null
          : decodeResponse(
              _repository, rawResponse, const TypeInfo(OuterComposite));
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
  ...
  Future<Response<num>> fakeOuterNumberSerialize({
    ...
    Object? _bodyData;
    _bodyData = encodeBodyParameter(_repository, body, const TypeInfo(num));
    ...
    try {
      ...
      _responseData = rawResponse == null
          ? null
          : decodeResponse(_repository, rawResponse, const TypeInfo(num));
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
  ...
  Future<Response<String>> fakeOuterStringSerialize({
    ...
    Object? _bodyData;
    _bodyData = encodeBodyParameter(_repository, body, const TypeInfo(String));
  ...
  Future<Response<OuterObjectWithEnumProperty>>
    ...
    Object? _bodyData;
    _bodyData = encodeBodyParameter(_repository, outerObjectWithEnumProperty,
  ...
  Future<Response<void>> testBodyWithBinary({
    ...
    Object? _bodyData;
    _bodyData = encodeBodyParameter(
        _repository, body, const TypeInfo.nullable(MultipartFile));
  ...
  Future<Response<void>> testBodyWithFileSchema({
    ...
    Object? _bodyData;
    _bodyData = encodeBodyParameter(
        _repository, fileSchemaTestClass, const TypeInfo(FileSchemaTestClass));
  ...
  Future<Response<void>> testEndpointParameters({
    ...
    final _bodyMap = <String, dynamic>{
      if (integer != null)
        r'integer':
            encodeFormParameter(_repository, integer, const TypeInfo(int)),
      if (int32 != null)
        r'int32': encodeFormParameter(_repository, int32, const TypeInfo(int)),
      if (int64 != null)
        r'int64': encodeFormParameter(_repository, int64, const TypeInfo(int)),
      r'number': encodeFormParameter(_repository, number, const TypeInfo(num)),
      if (float != null)
        r'float':
            encodeFormParameter(_repository, float, const TypeInfo(double)),
      r'double':
          encodeFormParameter(_repository, double_, const TypeInfo(double)),
      if (string != null)
        r'string':
            encodeFormParameter(_repository, string, const TypeInfo(String)),
      r'pattern_without_delimiter': encodeFormParameter(
          _repository, patternWithoutDelimiter, const TypeInfo(String)),
      r'byte': encodeFormParameter(_repository, byte, const TypeInfo(String)),
      if (binary != null)
        r'binary':
            encodeFormParameter(_repository, binary, const TypeInfo(Uint8List)),
      if (date != null)
        r'date': encodeFormParameter(_repository, date, const TypeInfo(Date)),
      if (dateTime != null)
        r'dateTime': encodeFormParameter(
            _repository, dateTime, const TypeInfo(DateTime)),
      if (password != null)
        r'password':
            encodeFormParameter(_repository, password, const TypeInfo(String)),
      if (callback != null)
        r'callback':
            encodeFormParameter(_repository, callback, const TypeInfo(String)),
    };
    _bodyData = _bodyMap;
  ...
  Future<Response<void>> testEnumParameters({
    ...
    EnumFormStringEnum enumFormString = EnumFormStringEnum.efg,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
      ...
      if (enumFormStringArray != null)
        r'enum_form_string_array': encodeFormParameter(
            ...
            const TypeInfo(BuiltList, [
              const TypeInfo(InnerEnum),
            ])),
      if (enumFormString != null)
        r'enum_form_string': encodeFormParameter(
            _repository, enumFormString, const TypeInfo(EnumFormStringEnum)),
    };
    _bodyData = _bodyMap;

    final _response = await rawApi.testEnumParameters(
      enumHeaderStringArray: encodeStringParameter(
          _repository,
          enumHeaderStringArray,
          const TypeInfo(BuiltList, [
            const TypeInfo(EnumHeaderStringArrayEnum),
          ])),
      enumHeaderString: encodeStringParameter(
          _repository, enumHeaderString, const TypeInfo(EnumHeaderStringEnum)),
      enumQueryStringArray: encodeQueryParameter(
        _repository,
        enumQueryStringArray,
        const TypeInfo(BuiltList, [
          const TypeInfo(EnumQueryStringArrayEnum),
        ]),
        format: ListFormat.multi,
      ),
      enumQueryString: encodeQueryParameter(
        _repository,
        enumQueryString,
        const TypeInfo(EnumQueryStringEnum),
      ),
      enumQueryInteger: encodeQueryParameter(
        _repository,
        enumQueryInteger,
        const TypeInfo(EnumQueryIntegerEnum),
      ),
      enumQueryDouble: encodeQueryParameter(
        _repository,
        enumQueryDouble,
        const TypeInfo(EnumQueryDoubleEnum),
      ),
      enumQueryModelArray: encodeQueryParameter(
        _repository,
        enumQueryModelArray,
        const TypeInfo(BuiltList, [
  ...
  Future<Response<void>> testGroupParameters({
    ...
    final _response = await rawApi.testGroupParameters(
      requiredStringGroup: encodeQueryParameter(
        _repository,
        requiredStringGroup,
        const TypeInfo(int),
      ),
      requiredBooleanGroup: encodeStringParameter(
          _repository, requiredBooleanGroup, const TypeInfo(bool)),
      requiredInt64Group: encodeQueryParameter(
        _repository,
        requiredInt64Group,
        const TypeInfo(int),
      ),
      stringGroup: encodeQueryParameter(
        _repository,
        stringGroup,
        const TypeInfo(int),
      ),
      booleanGroup: encodeStringParameter(
          _repository, booleanGroup, const TypeInfo(bool)),
      int64Group: encodeQueryParameter(
        _repository,
        int64Group,
        const TypeInfo(int),
      ),
  ...
  Future<Response<void>> testJsonFormData({
    ...
    final _bodyMap = <String, dynamic>{
      ...
      r'param2':
          encodeFormParameter(_repository, param2, const TypeInfo(String)),
    };
    _bodyData = _bodyMap;
  ...
  Future<Response<void>> testEnumParameters({
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (enumQueryModelArray != null)
        r'enum_query_model_array': enumQueryModelArray,
    };
...
class EnumHeaderStringArrayEnum extends EnumClass {
  ...
  static const EnumHeaderStringArrayEnum greaterThan =
      _$enumHeaderStringArrayEnum_greaterThan;
  @BuiltValueEnumConst(wireName: r'$')
  static const EnumHeaderStringArrayEnum dollar =
      _$enumHeaderStringArrayEnum_dollar;
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const EnumHeaderStringArrayEnum unknownDefaultOpenApi =
      _$enumHeaderStringArrayEnum_unknownDefaultOpenApi;

  static Serializer<EnumHeaderStringArrayEnum> get serializer =>
      _$enumHeaderStringArrayEnumSerializer;

  const EnumHeaderStringArrayEnum._(String name) : super(name);

  static BuiltSet<EnumHeaderStringArrayEnum> get values =>
      _$enumHeaderStringArrayEnumValues;
  static EnumHeaderStringArrayEnum valueOf(String name) =>
      _$enumHeaderStringArrayEnumValueOf(name);
}
...
class EnumHeaderStringEnum extends EnumClass {
  ...
  static const EnumHeaderStringEnum leftParenthesisXyzRightParenthesis =
      _$enumHeaderStringEnum_leftParenthesisXyzRightParenthesis;

  /// Header parameter enum test (string)
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const EnumHeaderStringEnum unknownDefaultOpenApi =
      _$enumHeaderStringEnum_unknownDefaultOpenApi;

  static Serializer<EnumHeaderStringEnum> get serializer =>
      _$enumHeaderStringEnumSerializer;

  const EnumHeaderStringEnum._(String name) : super(name);

  static BuiltSet<EnumHeaderStringEnum> get values =>
      _$enumHeaderStringEnumValues;
  static EnumHeaderStringEnum valueOf(String name) =>
      _$enumHeaderStringEnumValueOf(name);
}

class EnumQueryStringArrayEnum extends EnumClass {
  @BuiltValueEnumConst(wireName: r'>')
  static const EnumQueryStringArrayEnum greaterThan =
      _$enumQueryStringArrayEnum_greaterThan;
  @BuiltValueEnumConst(wireName: r'$')
  static const EnumQueryStringArrayEnum dollar =
      _$enumQueryStringArrayEnum_dollar;
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const EnumQueryStringArrayEnum unknownDefaultOpenApi =
      _$enumQueryStringArrayEnum_unknownDefaultOpenApi;

  static Serializer<EnumQueryStringArrayEnum> get serializer =>
      _$enumQueryStringArrayEnumSerializer;

  const EnumQueryStringArrayEnum._(String name) : super(name);

  static BuiltSet<EnumQueryStringArrayEnum> get values =>
      _$enumQueryStringArrayEnumValues;
  static EnumQueryStringArrayEnum valueOf(String name) =>
      _$enumQueryStringArrayEnumValueOf(name);
}
...
class EnumQueryStringEnum extends EnumClass {
  ...
  /// Query parameter enum test (string)
  @BuiltValueEnumConst(wireName: r'(xyz)')
  static const EnumQueryStringEnum leftParenthesisXyzRightParenthesis =
      _$enumQueryStringEnum_leftParenthesisXyzRightParenthesis;

  /// Query parameter enum test (string)
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const EnumQueryStringEnum unknownDefaultOpenApi =
      _$enumQueryStringEnum_unknownDefaultOpenApi;

  static Serializer<EnumQueryStringEnum> get serializer =>
      _$enumQueryStringEnumSerializer;

  const EnumQueryStringEnum._(String name) : super(name);

  static BuiltSet<EnumQueryStringEnum> get values =>
      _$enumQueryStringEnumValues;
  static EnumQueryStringEnum valueOf(String name) =>
      _$enumQueryStringEnumValueOf(name);
}
...
class EnumQueryIntegerEnum extends EnumClass {
  ...
  static const EnumQueryIntegerEnum numberNegative2 =
      _$enumQueryIntegerEnum_numberNegative2;

  /// Query parameter enum test (double)
  @BuiltValueEnumConst(wireNumber: 11184809, fallback: true)
  static const EnumQueryIntegerEnum unknownDefaultOpenApi =
      _$enumQueryIntegerEnum_unknownDefaultOpenApi;

  static Serializer<EnumQueryIntegerEnum> get serializer =>
      _$enumQueryIntegerEnumSerializer;

  const EnumQueryIntegerEnum._(String name) : super(name);

  static BuiltSet<EnumQueryIntegerEnum> get values =>
      _$enumQueryIntegerEnumValues;
  static EnumQueryIntegerEnum valueOf(String name) =>
      _$enumQueryIntegerEnumValueOf(name);
}

class EnumQueryDoubleEnum extends EnumClass {
  /// Query parameter enum test (double)
  @BuiltValueEnumConst(wireName: r'1.1')
  static const EnumQueryDoubleEnum number1Period1 =
      _$enumQueryDoubleEnum_number1Period1;

  /// Query parameter enum test (double)
  @BuiltValueEnumConst(wireName: r'-1.2')
  static const EnumQueryDoubleEnum numberNegative1Period2 =
      _$enumQueryDoubleEnum_numberNegative1Period2;

  /// Query parameter enum test (double)
  @BuiltValueEnumConst(wireName: r'11184809', fallback: true)
  static const EnumQueryDoubleEnum unknownDefaultOpenApi =
      _$enumQueryDoubleEnum_unknownDefaultOpenApi;

  static Serializer<EnumQueryDoubleEnum> get serializer =>
      _$enumQueryDoubleEnumSerializer;

  const EnumQueryDoubleEnum._(String name) : super(name);

  static BuiltSet<EnumQueryDoubleEnum> get values =>
      _$enumQueryDoubleEnumValues;
  static EnumQueryDoubleEnum valueOf(String name) =>
      _$enumQueryDoubleEnumValueOf(name);
}
...
class EnumFormStringEnum extends EnumClass {
  ...
  /// Form parameter enum test (string)
  @BuiltValueEnumConst(wireName: r'(xyz)')
  static const EnumFormStringEnum leftParenthesisXyzRightParenthesis =
      _$enumFormStringEnum_leftParenthesisXyzRightParenthesis;

  /// Form parameter enum test (string)
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const EnumFormStringEnum unknownDefaultOpenApi =
      _$enumFormStringEnum_unknownDefaultOpenApi;

  static Serializer<EnumFormStringEnum> get serializer =>
      _$enumFormStringEnumSerializer;
  ...
  static EnumFormStringEnum valueOf(String name) =>
      _$enumFormStringEnumValueOf(name);
}
