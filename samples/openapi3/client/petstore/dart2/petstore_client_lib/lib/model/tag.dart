...
class Tag {
  ...
  static List<Tag> listFromJson(List<dynamic> json, {bool emptyIsNull = false, bool growable = false,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <Tag>[]
      : json.map((dynamic value) => Tag.fromJson(value)).toList(growable: growable);
