...
class PetApi {
  ...
  Future<Pet> addPet(Pet pet) async {
    ...
    if (response.body != null && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserialize(_decodeBodyBytes(response), 'Pet') as Pet;
        }
  ...
  Future<List<Pet>> findPetsByStatus(List<String> status) async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body != null && response.statusCode != HttpStatus.noContent) {
      return (await apiClient.deserialize(_decodeBodyBytes(response), 'List<Pet>') as List)
        .cast<Pet>()
  ...
  Future<ApiResponse> uploadFile(int petId, { String additionalMetadata, MultipartFile file }) async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body != null && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserialize(_decodeBodyBytes(response), 'ApiResponse') as ApiResponse;
        }
