...
class FakeApi {
  ...
  Future<HealthCheckResult> fakeHealthGet() async {
    ...
    if (response.body != null && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserialize(_decodeBodyBytes(response), 'HealthCheckResult') as HealthCheckResult;
        }
  ...
  Future<bool> fakeOuterBooleanSerialize({ bool body }) async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body != null && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserialize(_decodeBodyBytes(response), 'bool') as bool;
        }
  ...
  Future<OuterComposite> fakeOuterCompositeSerialize({ OuterComposite outerComposite }) async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body != null && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserialize(_decodeBodyBytes(response), 'OuterComposite') as OuterComposite;
        }
  ...
  Future<num> fakeOuterNumberSerialize({ num body }) async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body != null && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserialize(_decodeBodyBytes(response), 'num') as num;
        }
  ...
  Future<String> fakeOuterStringSerialize({ String body }) async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body != null && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserialize(_decodeBodyBytes(response), 'String') as String;
        }
  ...
  Future<OuterObjectWithEnumProperty> fakePropertyEnumIntegerSerialize(OuterObjectWithEnumProperty outerObjectWithEnumProperty) async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body != null && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserialize(_decodeBodyBytes(response), 'OuterObjectWithEnumProperty') as OuterObjectWithEnumProperty;
        }
  ...
  Future<ModelClient> testClientModel(ModelClient modelClient) async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body != null && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserialize(_decodeBodyBytes(response), 'ModelClient') as ModelClient;
        }
