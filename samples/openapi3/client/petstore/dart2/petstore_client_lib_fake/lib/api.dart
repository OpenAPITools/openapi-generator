...
part 'model/object_with_enum.dart';
part 'model/object_with_inline_enum.dart';
part 'model/object_with_inline_enum_default_value.dart';
...
part 'model/pet.dart';
part 'model/pet_empty_metadata.dart';
part 'model/pet_reaction_response.dart';
part 'model/pet_reaction_status.dart';
part 'model/pet_reactions_response.dart';
