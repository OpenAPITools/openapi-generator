...
class CatAllOf {
  ...
  static List<CatAllOf> listFromJson(List<dynamic> json, {bool emptyIsNull = false, bool growable = false,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <CatAllOf>[]
      : json.map((dynamic value) => CatAllOf.fromJson(value)).toList(growable: growable);
