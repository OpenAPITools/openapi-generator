...
class Animal {
  ...
  static List<Animal> listFromJson(List<dynamic> json, {bool emptyIsNull = false, bool growable = false,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <Animal>[]
      : json.map((dynamic value) => Animal.fromJson(value)).toList(growable: growable);
