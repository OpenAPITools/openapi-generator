...
class HealthCheckResult {
  ...
  static List<HealthCheckResult> listFromJson(List<dynamic> json, {bool emptyIsNull = false, bool growable = false,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <HealthCheckResult>[]
      : json.map((dynamic value) => HealthCheckResult.fromJson(value)).toList(growable: growable);
