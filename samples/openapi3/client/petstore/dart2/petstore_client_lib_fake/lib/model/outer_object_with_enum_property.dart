...
class OuterObjectWithEnumProperty {
  ...
  static List<OuterObjectWithEnumProperty> listFromJson(List<dynamic> json, {bool emptyIsNull = false, bool growable = false,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <OuterObjectWithEnumProperty>[]
      : json.map((dynamic value) => OuterObjectWithEnumProperty.fromJson(value)).toList(growable: growable);
