...
class DeprecatedObject {
  ...
  static List<DeprecatedObject> listFromJson(List<dynamic> json, {bool emptyIsNull = false, bool growable = false,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <DeprecatedObject>[]
      : json.map((dynamic value) => DeprecatedObject.fromJson(value)).toList(growable: growable);
