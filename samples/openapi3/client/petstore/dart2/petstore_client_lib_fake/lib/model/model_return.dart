...
class ModelReturn {
  ...
  static List<ModelReturn> listFromJson(List<dynamic> json, {bool emptyIsNull = false, bool growable = false,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <ModelReturn>[]
      : json.map((dynamic value) => ModelReturn.fromJson(value)).toList(growable: growable);
