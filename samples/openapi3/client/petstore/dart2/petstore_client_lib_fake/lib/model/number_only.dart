...
class NumberOnly {
  ...
  static List<NumberOnly> listFromJson(List<dynamic> json, {bool emptyIsNull = false, bool growable = false,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <NumberOnly>[]
      : json.map((dynamic value) => NumberOnly.fromJson(value)).toList(growable: growable);
