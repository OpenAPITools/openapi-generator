...
enum ObjectWithInlineEnumAttributeEnum {
  ...
  const ObjectWithInlineEnumAttributeEnum._(this._value);
  ...
  /// Returns the instance of [ObjectWithInlineEnumAttributeEnum] that was successfully decoded
  ...
  /// Returns a [List] containing instances of [ObjectWithInlineEnumAttributeEnum]
...
class ObjectWithInlineEnumAttributeEnumTypeTransformer {
  ...
  String encode(ObjectWithInlineEnumAttributeEnum data) => data._value;
  ...
  ObjectWithInlineEnumAttributeEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data is ObjectWithInlineEnumAttributeEnum) {
      return data;
    }
    if (data != null) {
      switch (data) {
