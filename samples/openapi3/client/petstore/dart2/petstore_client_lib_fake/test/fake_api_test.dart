...
void main() {
  ...
  group('tests for FakeApi', () {
    ...
    // 
    //
    //Future testAdditionalPropertiesReference(Map<String, Object> requestBody) async
    ...
    // To test enum parameters
    //
    //Future testEnumParameters({ List<String> enumHeaderStringArray, String enumHeaderString, List<String> enumQueryStringArray, String enumQueryString, int enumQueryInteger, double enumQueryDouble, List<EnumClass> enumQueryModelArray, List<String> enumFormStringArray, String enumFormString }) async
    ...
    // 
    //
    //Future testStringMapReference(Map<String, String> requestBody) async
