...
void main() {
  ...
  group('test NullableClass', () {
    ...
    // List<Map<String, dynamic>> arrayNullableProp (default value: const [])
    test('to test the property `arrayNullableProp`', () async {
      // TODO
    });

    // List<Map<String, dynamic>> arrayAndItemsNullableProp (default value: const [])
    test('to test the property `arrayAndItemsNullableProp`', () async {
      // TODO
    });

    // List<Map<String, dynamic>> arrayItemsNullable (default value: const [])
    test('to test the property `arrayItemsNullable`', () async {
      // TODO
    });

    // Map<String, dynamic> objectNullableProp (default value: const {})
    test('to test the property `objectNullableProp`', () async {
      // TODO
    });

    // Map<String, dynamic> objectAndItemsNullableProp (default value: const {})
    test('to test the property `objectAndItemsNullableProp`', () async {
      // TODO
    });

    // Map<String, dynamic> objectItemsNullable (default value: const {})
