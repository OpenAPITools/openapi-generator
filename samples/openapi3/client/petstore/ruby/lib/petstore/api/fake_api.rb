...
module Petstore
  class FakeApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [Resource]
    def resource_named_resource_test(opts = {})
      data, _status_code, _headers = resource_named_resource_test_with_http_info(opts)
      data
    end

    # @param [Hash] opts the optional parameters
    # @return [Array<(Resource, Integer, Hash)>] Resource data, response status code and response headers
    def resource_named_resource_test_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FakeApi.resource_named_resource_test ...'
      end
      # resource path
      local_var_path = '/fake/resource-named-resource-test'
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FakeApi#resource_named_resource_test\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
