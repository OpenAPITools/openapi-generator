# petstore_client_aiohttp.PetApi
...
# the API server.
#
# See petstore_client_aiohttp.signing for a list of all supported parameters.
from petstore_client_aiohttp import signing
import datetime

configuration = petstore_client_aiohttp.Configuration(
    host = "http://petstore.swagger.io:80/v2",
    signing_info = petstore_client_aiohttp.HttpSigningConfiguration(
        key_id = 'my-key-id',
        private_key_path = 'private_key.pem',
        private_key_passphrase = 'YOUR_PASSPHRASE',
        signing_scheme = petstore_client_aiohttp.signing.SCHEME_HS2019,
        signing_algorithm = petstore_client_aiohttp.signing.ALGORITHM_ECDSA_MODE_FIPS_186_3,
        hash_algorithm = petstore_client_aiohttp.signing.SCHEME_RSA_SHA256,
        signed_headers = [
                            petstore_client_aiohttp.signing.HEADER_REQUEST_TARGET,
                            petstore_client_aiohttp.signing.HEADER_CREATED,
                            petstore_client_aiohttp.signing.HEADER_EXPIRES,
                            petstore_client_aiohttp.signing.HEADER_HOST,
                            petstore_client_aiohttp.signing.HEADER_DATE,
                            petstore_client_aiohttp.signing.HEADER_DIGEST,
                            'Content-Type',
                            'Content-Length',
                            'User-Agent'
                         ],
...
async with petstore_client_aiohttp.ApiClient(configuration) as api_client:
    ...
    api_instance = petstore_client_aiohttp.PetApi(api_client)
    pet = petstore_client_aiohttp.Pet() # Pet | Pet object that needs to be added to the store
