# petstore_client_aiohttp.FakeApi
...
async with petstore_client_aiohttp.ApiClient(configuration) as api_client:
    ...
    api_instance = petstore_client_aiohttp.FakeApi(api_client)
...
async with petstore_client_aiohttp.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = petstore_client_aiohttp.FakeApi(api_client)
    enum_ref = petstore_client_aiohttp.EnumClass() # EnumClass | enum reference (optional)
...
async with petstore_client_aiohttp.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = petstore_client_aiohttp.FakeApi(api_client)
    outer_composite = petstore_client_aiohttp.OuterComposite() # OuterComposite | Input composite as post body (optional)
...
async with petstore_client_aiohttp.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = petstore_client_aiohttp.FakeApi(api_client)
    outer_object_with_enum_property = petstore_client_aiohttp.OuterObjectWithEnumProperty() # OuterObjectWithEnumProperty | Input enum (int) as post body
...
async with petstore_client_aiohttp.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = petstore_client_aiohttp.FakeApi(api_client)
    file_schema_test_class = petstore_client_aiohttp.FileSchemaTestClass() # FileSchemaTestClass | 
...
async with petstore_client_aiohttp.ApiClient(configuration) as api_client:
    ...
    user = petstore_client_aiohttp.User() # User | 
...
async with petstore_client_aiohttp.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = petstore_client_aiohttp.FakeApi(api_client)
    test_inline_freeform_additional_properties_request = petstore_client_aiohttp.TestInlineFreeformAdditionalPropertiesRequest() # TestInlineFreeformAdditionalPropertiesRequest | request body
