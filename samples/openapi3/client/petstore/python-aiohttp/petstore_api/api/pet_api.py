...
class PetApi:
    ...
    @validate_arguments
    async def add_pet(self, pet : Pet, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    async def add_pet_with_http_info(self, pet : Pet, **kwargs) -> ApiResponse:  # noqa: E501
        """Add a new pet to the store  # noqa: E501
    ...
    @validate_arguments
    async def delete_pet(self, pet_id : StrictInt, api_key : Optional[StrictStr] = None, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    async def delete_pet_with_http_info(self, pet_id : StrictInt, api_key : Optional[StrictStr] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Deletes a pet  # noqa: E501
    ...
    @validate_arguments
    async def find_pets_by_status(self, status : List[StrictStr], **kwargs) -> List[Pet]:  # noqa: E501
    ...
    @validate_arguments
    async def find_pets_by_status_with_http_info(self, status : List[StrictStr], **kwargs) -> ApiResponse:  # noqa: E501
        """Finds Pets by status  # noqa: E501
    ...
    @validate_arguments
    async def find_pets_by_tags(self, tags : Annotated[List[StrictStr], Field(unique_items=True)], **kwargs) -> List[Pet]:  # noqa: E501
    ...
    @validate_arguments
    async def find_pets_by_tags_with_http_info(self, tags : Annotated[List[StrictStr], Field(unique_items=True)], **kwargs) -> ApiResponse:  # noqa: E501
        """(Deprecated) Finds Pets by tags  # noqa: E501
    ...
    @validate_arguments
    async def update_pet(self, pet : Pet, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    async def update_pet_with_http_info(self, pet : Pet, **kwargs) -> ApiResponse:  # noqa: E501
        """Update an existing pet  # noqa: E501
    ...
    @validate_arguments
    async def update_pet_with_form(self, pet_id : StrictInt, name : Optional[StrictStr] = None, status : Optional[StrictStr] = None, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    async def upload_file(self, pet_id : StrictInt, additional_metadata : Optional[StrictStr] = None, file : Optional[Union[StrictBytes, StrictStr]] = None, **kwargs) -> ApiResponse:  # noqa: E501
    ...
    @validate_arguments
    async def upload_file_with_http_info(self, pet_id : StrictInt, additional_metadata : Optional[StrictStr] = None, file : Optional[Union[StrictBytes, StrictStr]] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """uploads an image  # noqa: E501
    ...
    @validate_arguments
    async def upload_file_with_required_file(self, pet_id : StrictInt, required_file : Union[StrictBytes, StrictStr], additional_metadata : Optional[StrictStr] = None, **kwargs) -> ApiResponse:  # noqa: E501
    ...
    @validate_arguments
    async def upload_file_with_required_file_with_http_info(self, pet_id : StrictInt, required_file : Union[StrictBytes, StrictStr], additional_metadata : Optional[StrictStr] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """uploads an image (required)  # noqa: E501
