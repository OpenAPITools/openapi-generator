...
from petstore_client_aiohttp.models.int_or_string import IntOrString  # noqa: E501
...
class TestIntOrString(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = petstore_client_aiohttp.models.int_or_string.IntOrString()  # noqa: E501
        if include_optional :
            return IntOrString(
            )
        else :
