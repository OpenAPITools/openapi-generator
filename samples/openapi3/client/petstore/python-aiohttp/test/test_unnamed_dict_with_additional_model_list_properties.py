...
from petstore_client_aiohttp.models.unnamed_dict_with_additional_model_list_properties import UnnamedDictWithAdditionalModelListProperties  # noqa: E501
    ...
    def make_instance(self, include_optional) -> UnnamedDictWithAdditionalModelListProperties:
        ...
        if include_optional:
            return UnnamedDictWithAdditionalModelListProperties(
                dict_property = {
                    'key' : [
                        petstore_client_aiohttp.models.creature_info.CreatureInfo(
                            name = '', )
                        ]
                    }
            )
