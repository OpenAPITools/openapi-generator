...
class Configuration:
    ...
    :param signing_info: Configuration parameters for the HTTP signature security scheme.
        Must be an instance of petstore_client_aiohttp.signing.HttpSigningConfiguration
...
conf = petstore_client_aiohttp.Configuration(
...
conf = petstore_client_aiohttp.Configuration(
    ...
    Note you can use the constants defined in the petstore_client_aiohttp.signing module, and you can
...
conf = petstore_client_aiohttp.Configuration(
    signing_info = petstore_client_aiohttp.signing.HttpSigningConfiguration(
        key_id =                 'my-key-id',
        private_key_path =       'rsa.pem',
        signing_scheme =         petstore_client_aiohttp.signing.SCHEME_HS2019,
        signing_algorithm =      petstore_client_aiohttp.signing.ALGORITHM_RSASSA_PSS,
        signed_headers =         [petstore_client_aiohttp.signing.HEADER_REQUEST_TARGET,
    ...
    def __init__(self, host=None,
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("petstore_client_aiohttp")
