...
type DefaultApi interface {
	...
	*/
	...
	FooGetExecute(r ApiFooGetRequest) (*FooInlineResponseDefault, *http.Response, error)
}
...
func (r ApiFooGetRequest) Execute() (*FooInlineResponseDefault, *http.Response, error) {
...
//  @return FooInlineResponseDefault
func (a *DefaultApiService) FooGetExecute(r ApiFooGetRequest) (*FooInlineResponseDefault, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *FooInlineResponseDefault
	)
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 404 {
			var v FooInlineResponseDefault
