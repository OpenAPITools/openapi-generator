...
func Test_petstore_DefaultAPIService(t *testing.T) {
	...
	t.Run("Test DefaultAPIService SomeOpsRequiringRefInt", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.DefaultAPI.SomeOpsRequiringRefInt(context.Background()).Execute()
