...
type ApiFakeHttpSignatureTestRequest struct {
	ctx _context.Context
	ApiService *FakeApiService
	pet *Pet
	query1 *string
...
func (r ApiFakeHttpSignatureTestRequest) Pet(pet Pet) ApiFakeHttpSignatureTestRequest {
	r.pet = &pet
	return r
}
func (r ApiFakeHttpSignatureTestRequest) Query1(query1 string) ApiFakeHttpSignatureTestRequest {
	r.query1 = &query1
	return r
}
func (r ApiFakeHttpSignatureTestRequest) Header1(header1 string) ApiFakeHttpSignatureTestRequest {
	r.header1 = &header1
	return r
}

func (r ApiFakeHttpSignatureTestRequest) Execute() (*_nethttp.Response, error) {
	return r.ApiService.FakeHttpSignatureTestExecute(r)
}

/*
 * FakeHttpSignatureTest test http signature authentication
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @return ApiFakeHttpSignatureTestRequest
 */
func (a *FakeApiService) FakeHttpSignatureTest(ctx _context.Context) ApiFakeHttpSignatureTestRequest {
	return ApiFakeHttpSignatureTestRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 * Execute executes the request
 */
func (a *FakeApiService) FakeHttpSignatureTestExecute(r ApiFakeHttpSignatureTestRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FakeApiService.FakeHttpSignatureTest")
	if err != nil {
		return nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/fake/http-signature-test"
	...
	if r.query1 != nil {
		localVarQueryParams.Add("query_1", parameterToString(*r.query1, ""))
	}
	// to determine the Content-Type header
	...
	if r.header1 != nil {
		localVarHeaderParams["header_1"] = parameterToString(*r.header1, "")
	}
	// body params
...
type ApiFakePropertyEnumIntegerSerializeRequest struct {
	ctx _context.Context
	ApiService *FakeApiService
	outerObjectWithEnumProperty *OuterObjectWithEnumProperty
}

func (r ApiFakePropertyEnumIntegerSerializeRequest) OuterObjectWithEnumProperty(outerObjectWithEnumProperty OuterObjectWithEnumProperty) ApiFakePropertyEnumIntegerSerializeRequest {
	r.outerObjectWithEnumProperty = &outerObjectWithEnumProperty
	return r
}

func (r ApiFakePropertyEnumIntegerSerializeRequest) Execute() (OuterObjectWithEnumProperty, *_nethttp.Response, error) {
	return r.ApiService.FakePropertyEnumIntegerSerializeExecute(r)
}

/*
 * FakePropertyEnumIntegerSerialize Method for FakePropertyEnumIntegerSerialize
 * Test serialization of enum (int) properties with examples
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @return ApiFakePropertyEnumIntegerSerializeRequest
 */
func (a *FakeApiService) FakePropertyEnumIntegerSerialize(ctx _context.Context) ApiFakePropertyEnumIntegerSerializeRequest {
	return ApiFakePropertyEnumIntegerSerializeRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *FakeApiService) FakePropertyEnumIntegerSerializeExecute(r ApiFakePropertyEnumIntegerSerializeRequest) (OuterObjectWithEnumProperty, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  OuterObjectWithEnumProperty
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FakeApiService.FakePropertyEnumIntegerSerialize")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/fake/property/enum-int"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	if r.outerObjectWithEnumProperty == nil {
		return localVarReturnValue, nil, reportError("outerObjectWithEnumProperty is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.outerObjectWithEnumProperty
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
