...
try:
    from petstore_api.models import apple_req
except ImportError:
    apple_req = sys.modules[
        'petstore_api.models.apple_req']
try:
    from petstore_api.models import banana_req
except ImportError:
...
class FruitReq(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(self, cultivar=nulltype.Null, length_cm=nulltype.Null, _check_type=True, _json_variable_naming=False, _path_to_item=(), _configuration=None, _visited_composed_classes=(), **kwargs):  # noqa: E501
