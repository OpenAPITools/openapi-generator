...
class QuadrilateralInterface(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, quadrilateral_type, _check_type=True, _json_variable_naming=False, _path_to_item=(), _configuration=None, _visited_composed_classes=(), **kwargs):  # noqa: E501
