...
class FakeApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __get_additional_properties_with_named_array_of_enums(
            self,
            **kwargs
        ):
            """Additional Properties with Named Array of Enums  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_additional_properties_with_named_array_of_enums(async_req=True)
            >>> result = thread.get()
            ...
            Returns:
                additional_properties_with_named_array_of_enums.AdditionalPropertiesWithNamedArrayOfEnums
                    If the method is called asynchronously, returns the request
                    thread.
            """
            kwargs['async_req'] = kwargs.get(
        ...
        self.get_additional_properties_with_named_array_of_enums = Endpoint(
            settings={
                'response_type': (additional_properties_with_named_array_of_enums.AdditionalPropertiesWithNamedArrayOfEnums,),
                'auth': [],
                'endpoint_path': '/fake/additional-properties-with-named-array-of-enums',
                'operation_id': 'get_additional_properties_with_named_array_of_enums',
                'http_method': 'GET',
                'servers': [],
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_additional_properties_with_named_array_of_enums
        )
