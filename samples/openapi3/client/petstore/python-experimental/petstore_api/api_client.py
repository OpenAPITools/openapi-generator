...
class ApiClient(object):
    ...
    def deserialize(self, response, response_cls, _check_type):
        ...
        deserialized_data = response_cls(received_data, _spec_property_naming=True, _configuration=self.configuration)
    ...
    def __validate_inputs(self, kwargs):
        ...
        for key, value in kwargs.items():
            ...
            if not isinstance(value, item_cls):
                kwargs[key] = item_cls(value, _configuration=self.api_client.configuration, _spec_property_naming=True)
