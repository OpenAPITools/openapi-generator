...
[**get_additional_properties_with_named_array_of_enums**](FakeApi.md#get_additional_properties_with_named_array_of_enums) | **GET** /fake/additional-properties-with-named-array-of-enums | Additional Properties with Named Array of Enums
...
# **get_additional_properties_with_named_array_of_enums**
> additional_properties_with_named_array_of_enums.AdditionalPropertiesWithNamedArrayOfEnums get_additional_properties_with_named_array_of_enums()

Additional Properties with Named Array of Enums
...
import petstore_api
from petstore_api.api import fake_api
from petstore_api.model import additional_properties_with_named_array_of_enums
from pprint import pprint
# Defining the host is optional and defaults to http://petstore.swagger.io:80/v2
# See configuration.py for a list of all supported configuration parameters.
configuration = petstore_api.Configuration(
...
with petstore_api.ApiClient() as api_client:
    ...
    try:
        # Additional Properties with Named Array of Enums
        api_response = api_instance.get_additional_properties_with_named_array_of_enums()
        pprint(api_response)
    except petstore_api.ApiException as e:
        print("Exception when calling FakeApi->get_additional_properties_with_named_array_of_enums: %s\n" % e)
```
...
[**additional_properties_with_named_array_of_enums.AdditionalPropertiesWithNamedArrayOfEnums**](AdditionalPropertiesWithNamedArrayOfEnums.md)
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | Got object with additional properties with named array of enums |  -  |
