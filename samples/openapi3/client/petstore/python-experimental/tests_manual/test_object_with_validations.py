...
class TestObjectWithValidations(unittest.TestCase):
    ...
    def test_ObjectWithValidations(self):
        ...
        with self.assertRaisesRegex(
            ...
            r"ObjectWithValidations is missing required input data in args or kwargs"
        ):
        ...
        with self.assertRaisesRegex(
            ...
            r"Invalid value `{'a': 'a'}`, number of properties must be greater than or equal to `2` at \('args\[0\]',\)"
        ):
