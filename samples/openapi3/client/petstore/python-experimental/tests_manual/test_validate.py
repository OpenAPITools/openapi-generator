...
class TestValidateResults(unittest.TestCase):
    def test_str_validate(self):
        ...
        path_to_schemas = StringWithValidation.validate_oapg(
    ...
    def test_number_validate(self):
        vm = ValidationMetadata()
        path_to_schemas = NumberWithValidations.validate_oapg(
    ...
    def test_str_enum_validate(self):
        vm = ValidationMetadata()
        path_to_schemas = StringEnum.validate_oapg("placed", validation_metadata=vm)
        assert path_to_schemas == {("args[0]",): {str, StringEnum}}

    def test_nullable_enum_validate(self):
        vm = ValidationMetadata()
        path_to_schemas = StringEnum.validate_oapg(NoneClass.NONE, validation_metadata=vm)
        assert path_to_schemas == {("args[0]",): {NoneClass, StringEnum}}

    def test_empty_list_validate(self):
        vm = ValidationMetadata()
        path_to_schemas = ArrayHoldingAnyType.validate_oapg((), validation_metadata=vm)
        assert path_to_schemas == {("args[0]",): {ArrayHoldingAnyType, tuple}}

    def test_list_validate(self):
        vm = ValidationMetadata()
        path_to_schemas = ArrayHoldingAnyType.validate_oapg(
    ...
    def test_empty_dict_validate(self):
        vm = ValidationMetadata()
        path_to_schemas = Foo.validate_oapg(frozendict.frozendict({}), validation_metadata=vm)
        assert path_to_schemas == {("args[0]",): {Foo, frozendict.frozendict}}

    def test_dict_validate(self):
        vm = ValidationMetadata()
        path_to_schemas = Foo.validate_oapg(
    ...
    def test_discriminated_dict_validate(self):
        vm = ValidationMetadata()
        path_to_schemas = Animal.validate_oapg(
    ...
    def test_bool_enum_validate(self):
        vm = ValidationMetadata()
        path_to_schemas = BooleanEnum.validate_oapg(BoolClass.TRUE, validation_metadata=vm)
        assert path_to_schemas == {("args[0]",): {BoolClass, BooleanEnum}}

    def test_oneof_composition_pig_validate(self):
        vm = ValidationMetadata()
        path_to_schemas = Pig.validate_oapg(
    ...
    def test_anyof_composition_gm_fruit_validate(self):
        vm = ValidationMetadata()
        path_to_schemas = GmFruit.validate_oapg(
...
class TestValidateCalls(unittest.TestCase):
    def test_empty_list_validate(self):
        ...
        with patch.object(
            Schema, "validate_oapg", return_value=return_value
        ) as mock_validate:
            ArrayHoldingAnyType([])
    ...
    def test_list_validate_direct_instantiation(self):
        ...
        with patch.object(Schema, "validate_oapg", side_effect=results) as mock_validate:
    ...
    def test_list_validate_direct_instantiation_cast_item(self):
        ...
        with patch.object(Schema, "validate_oapg", return_value=return_value) as mock_validate:
    ...
    def test_dict_validate_direct_instantiation(self):
        ...
        with patch.object(Schema, "validate_oapg", side_effect=call_results) as mock_validate:
            Foo(bar="a")
            calls = [
                call(
    ...
    def test_dict_validate_from_openapi_data_instantiation(self):
        ...
        with patch.object(Schema, "validate_oapg", side_effect=return_values) as mock_validate:
