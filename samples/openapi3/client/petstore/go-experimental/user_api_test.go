...
func TestCreateUser(t *testing.T) {
	...
	req := client.UserApi.CreateUserGetRequest(context.Background()).User(newUser)
...
func TestCreateUsersWithArrayInput(t *testing.T) {
	...
	req := client.UserApi.CreateUsersWithArrayInputGetRequest(context.Background()).User(newUsers)
...
func TestUpdateUser(t *testing.T) {
	...
	updateReq := client.UserApi.UpdateUserGetRequest(context.Background(), "gopher").User(newUser)
