...
func main() {
    order := openapiclient.Order{Id: int64(123), PetId: int64(123), Quantity: 123, ShipDate: "TODO", Status: openapiclient.OrderStatus{}, Complete: false} // Order | order placed for purchasing the pet
