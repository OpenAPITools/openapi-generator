...
const (
	ENUMARRAYSJUSTSYMBOL_ENUM_ARRAYS_JUST_SYMBOL_GREATER_THAN_OR_EQUAL_TO EnumArraysJustSymbol = ">="
	ENUMARRAYSJUSTSYMBOL_ENUM_ARRAYS_JUST_SYMBOL_DOLLAR EnumArraysJustSymbol = "$"
)
