...
func TestOAuth2(t *testing.T) {
	...
	addReq := client.PetApi.AddPetGetRequest(context.Background()).Pet(newPet)
...
func TestBasicAuth(t *testing.T) {
	...
	addReq := client.PetApi.AddPetGetRequest(auth).Pet(newPet)
	r, err := client.PetApi.AddPetExecute(addReq)
...
func TestAccessToken(t *testing.T) {
	...
	addReq := client.PetApi.AddPetGetRequest(nil).Pet(newPet)
	r, err := client.PetApi.AddPetExecute(addReq)
