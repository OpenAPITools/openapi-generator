...
# Unit tests for OpenapiClient::InlineResponseDefault
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InlineResponseDefault' do
  before do
    # run before each test
    @instance = OpenapiClient::InlineResponseDefault.new
  end
  ...
  describe 'test an instance of InlineResponseDefault' do
    it 'should create an instance of InlineResponseDefault' do
      expect(@instance).to be_instance_of(OpenapiClient::InlineResponseDefault)
    end
  end
