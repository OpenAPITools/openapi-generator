...
# Unit tests for OpenapiClient::SpecialModelName
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SpecialModelName' do
  before do
    # run before each test
    @instance = OpenapiClient::SpecialModelName.new
  end
  ...
  describe 'test an instance of SpecialModelName' do
    it 'should create an instance of SpecialModelName' do
      expect(@instance).to be_instance_of(OpenapiClient::SpecialModelName)
    end
  end
