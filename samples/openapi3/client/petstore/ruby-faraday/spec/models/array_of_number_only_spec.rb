...
# Unit tests for OpenapiClient::ArrayOfNumberOnly
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ArrayOfNumberOnly' do
  before do
    # run before each test
    @instance = OpenapiClient::ArrayOfNumberOnly.new
  end
  ...
  describe 'test an instance of ArrayOfNumberOnly' do
    it 'should create an instance of ArrayOfNumberOnly' do
      expect(@instance).to be_instance_of(OpenapiClient::ArrayOfNumberOnly)
    end
  end
