...
# Unit tests for OpenapiClient::FileSchemaTestClass
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'FileSchemaTestClass' do
  before do
    # run before each test
    @instance = OpenapiClient::FileSchemaTestClass.new
  end
  ...
  describe 'test an instance of FileSchemaTestClass' do
    it 'should create an instance of FileSchemaTestClass' do
      expect(@instance).to be_instance_of(OpenapiClient::FileSchemaTestClass)
    end
  end
