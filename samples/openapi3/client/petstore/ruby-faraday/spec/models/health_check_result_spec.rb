...
# Unit tests for OpenapiClient::HealthCheckResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'HealthCheckResult' do
  before do
    # run before each test
    @instance = OpenapiClient::HealthCheckResult.new
  end
  ...
  describe 'test an instance of HealthCheckResult' do
    it 'should create an instance of HealthCheckResult' do
      expect(@instance).to be_instance_of(OpenapiClient::HealthCheckResult)
    end
  end
