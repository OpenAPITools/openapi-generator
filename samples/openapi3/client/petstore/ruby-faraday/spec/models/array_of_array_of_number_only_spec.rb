...
# Unit tests for OpenapiClient::ArrayOfArrayOfNumberOnly
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ArrayOfArrayOfNumberOnly' do
  before do
    # run before each test
    @instance = OpenapiClient::ArrayOfArrayOfNumberOnly.new
  end
  ...
  describe 'test an instance of ArrayOfArrayOfNumberOnly' do
    it 'should create an instance of ArrayOfArrayOfNumberOnly' do
      expect(@instance).to be_instance_of(OpenapiClient::ArrayOfArrayOfNumberOnly)
    end
  end
