...
# Unit tests for OpenapiClient::Model200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Model200Response' do
  before do
    # run before each test
    @instance = OpenapiClient::Model200Response.new
  end
  ...
  describe 'test an instance of Model200Response' do
    it 'should create an instance of Model200Response' do
      expect(@instance).to be_instance_of(OpenapiClient::Model200Response)
    end
  end
