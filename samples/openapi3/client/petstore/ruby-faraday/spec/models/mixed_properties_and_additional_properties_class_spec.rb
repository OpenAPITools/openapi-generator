...
# Unit tests for OpenapiClient::MixedPropertiesAndAdditionalPropertiesClass
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'MixedPropertiesAndAdditionalPropertiesClass' do
  before do
    # run before each test
    @instance = OpenapiClient::MixedPropertiesAndAdditionalPropertiesClass.new
  end
  ...
  describe 'test an instance of MixedPropertiesAndAdditionalPropertiesClass' do
    it 'should create an instance of MixedPropertiesAndAdditionalPropertiesClass' do
      expect(@instance).to be_instance_of(OpenapiClient::MixedPropertiesAndAdditionalPropertiesClass)
    end
  end
