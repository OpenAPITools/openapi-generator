...
# Unit tests for OpenapiClient::AdditionalPropertiesClass
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AdditionalPropertiesClass' do
  before do
    # run before each test
    @instance = OpenapiClient::AdditionalPropertiesClass.new
  end
  ...
  describe 'test an instance of AdditionalPropertiesClass' do
    it 'should create an instance of AdditionalPropertiesClass' do
      expect(@instance).to be_instance_of(OpenapiClient::AdditionalPropertiesClass)
    end
  end
