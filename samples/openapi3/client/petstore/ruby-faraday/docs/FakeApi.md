...
api_instance = OpenapiClient::FakeApi.new
...
api_instance = OpenapiClient::FakeApi.new
opts = {
  outer_composite: OpenapiClient::OuterComposite.new # OuterComposite | Input composite as post body
}
...
api_instance = OpenapiClient::FakeApi.new
file_schema_test_class = OpenapiClient::FileSchemaTestClass.new # FileSchemaTestClass | 
