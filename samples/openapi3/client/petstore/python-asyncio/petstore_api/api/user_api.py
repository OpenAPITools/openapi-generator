...
class UserApi(object):
    ...
    if typing.TYPE_CHECKING:
        Tcreate_user_user: typing.TypeAlias = User
    else:
        Tcreate_user_user = Annotated[User, Field(..., description="Created user object")]

    @validate_arguments
    async def create_user(self, user : Tcreate_user_user, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    async def create_user_with_http_info(self, user : Annotated[User, Field(..., description="Created user object")], **kwargs) -> ApiResponse[None]:  # noqa: E501
        """Create user  # noqa: E501
    ...
    if typing.TYPE_CHECKING:
        Tcreate_users_with_array_input_user: typing.TypeAlias = List[User]
    else:
        Tcreate_users_with_array_input_user = Annotated[conlist(User), Field(..., description="List of user object")]

    @validate_arguments
    async def create_users_with_array_input(self, user : Tcreate_users_with_array_input_user, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    async def create_users_with_array_input_with_http_info(self, user : Annotated[conlist(User), Field(..., description="List of user object")], **kwargs) -> ApiResponse[None]:  # noqa: E501
        """Creates list of users with given input array  # noqa: E501
    ...
    if typing.TYPE_CHECKING:
        Tcreate_users_with_list_input_user: typing.TypeAlias = List[User]
    else:
        Tcreate_users_with_list_input_user = Annotated[conlist(User), Field(..., description="List of user object")]

    @validate_arguments
    async def create_users_with_list_input(self, user : Tcreate_users_with_list_input_user, **kwargs) -> None:  # noqa: E501
        """Creates list of users with given input array  # noqa: E501
    ...
    @validate_arguments
    async def create_users_with_list_input_with_http_info(self, user : Annotated[conlist(User), Field(..., description="List of user object")], **kwargs) -> ApiResponse[None]:  # noqa: E501
        """Creates list of users with given input array  # noqa: E501
    ...
    if typing.TYPE_CHECKING:
        Tdelete_user_username: typing.TypeAlias = str
    else:
        Tdelete_user_username = Annotated[StrictStr, Field(..., description="The name that needs to be deleted")]

    @validate_arguments
    async def delete_user(self, username : Tdelete_user_username, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    async def delete_user_with_http_info(self, username : Annotated[StrictStr, Field(..., description="The name that needs to be deleted")], **kwargs) -> ApiResponse[None]:  # noqa: E501
        """Delete user  # noqa: E501
    ...
    if typing.TYPE_CHECKING:
        Tget_user_by_name_username: typing.TypeAlias = str
    else:
        Tget_user_by_name_username = Annotated[StrictStr, Field(..., description="The name that needs to be fetched. Use user1 for testing.")]

    @validate_arguments
    async def get_user_by_name(self, username : Tget_user_by_name_username, **kwargs) -> User:  # noqa: E501
    ...
    @validate_arguments
    async def get_user_by_name_with_http_info(self, username : Annotated[StrictStr, Field(..., description="The name that needs to be fetched. Use user1 for testing.")], **kwargs) -> ApiResponse[User]:  # noqa: E501
        """Get user by user name  # noqa: E501
    ...
    if typing.TYPE_CHECKING:
        Tlogin_user_username: typing.TypeAlias = str
    else:
        Tlogin_user_username = Annotated[StrictStr, Field(..., description="The user name for login")]
    if typing.TYPE_CHECKING:
        Tlogin_user_password: typing.TypeAlias = str
    else:
        Tlogin_user_password = Annotated[StrictStr, Field(..., description="The password for login in clear text")]

    @validate_arguments
    async def login_user(self, username : Tlogin_user_username, password : Tlogin_user_password, **kwargs) -> str:  # noqa: E501
    ...
    @validate_arguments
    async def login_user_with_http_info(self, username : Annotated[StrictStr, Field(..., description="The user name for login")], password : Annotated[StrictStr, Field(..., description="The password for login in clear text")], **kwargs) -> ApiResponse[str]:  # noqa: E501
        """Logs user into the system  # noqa: E501
    ...
    @validate_arguments
    async def logout_user_with_http_info(self, **kwargs) -> ApiResponse[None]:  # noqa: E501
        """Logs out current logged in user session  # noqa: E501
    ...
    if typing.TYPE_CHECKING:
        Tupdate_user_username: typing.TypeAlias = str
    else:
        Tupdate_user_username = Annotated[StrictStr, Field(..., description="name that need to be deleted")]
    if typing.TYPE_CHECKING:
        Tupdate_user_user: typing.TypeAlias = User
    else:
        Tupdate_user_user = Annotated[User, Field(..., description="Updated user object")]

    @validate_arguments
    async def update_user(self, username : Tupdate_user_username, user : Tupdate_user_user, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    async def update_user_with_http_info(self, username : Annotated[StrictStr, Field(..., description="name that need to be deleted")], user : Annotated[User, Field(..., description="Updated user object")], **kwargs) -> ApiResponse[None]:  # noqa: E501
        """Updated user  # noqa: E501
