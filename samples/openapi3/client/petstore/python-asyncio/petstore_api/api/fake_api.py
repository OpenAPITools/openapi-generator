...
class FakeApi(object):
    ...
    if typing.TYPE_CHECKING:
        Tfake_any_type_request_body_body: typing.TypeAlias = Optional[object]
    else:
        Tfake_any_type_request_body_body = Optional[Dict[str, Any]]

    @validate_arguments
    async def fake_any_type_request_body(self, body : Tfake_any_type_request_body_body = None, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    async def fake_any_type_request_body_with_http_info(self, body : Optional[Dict[str, Any]] = None, **kwargs) -> ApiResponse[None]:  # noqa: E501
        """test any type request body  # noqa: E501
    ...
    if typing.TYPE_CHECKING:
        Tfake_enum_ref_query_parameter_enum_ref: typing.TypeAlias = Optional[EnumClass]
    else:
        Tfake_enum_ref_query_parameter_enum_ref = Annotated[Optional[EnumClass], Field(description="enum reference")]

    @validate_arguments
    async def fake_enum_ref_query_parameter(self, enum_ref : Tfake_enum_ref_query_parameter_enum_ref = None, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    async def fake_enum_ref_query_parameter_with_http_info(self, enum_ref : Annotated[Optional[EnumClass], Field(description="enum reference")] = None, **kwargs) -> ApiResponse[None]:  # noqa: E501
        """test enum reference query parameter  # noqa: E501
    ...
    @validate_arguments
    async def fake_health_get_with_http_info(self, **kwargs) -> ApiResponse[HealthCheckResult]:  # noqa: E501
        """Health check endpoint  # noqa: E501
    ...
    if typing.TYPE_CHECKING:
        Tfake_http_signature_test_pet: typing.TypeAlias = Pet
    else:
        Tfake_http_signature_test_pet = Annotated[Pet, Field(..., description="Pet object that needs to be added to the store")]
    if typing.TYPE_CHECKING:
        Tfake_http_signature_test_query_1: typing.TypeAlias = Optional[str]
    else:
        Tfake_http_signature_test_query_1 = Annotated[Optional[StrictStr], Field(description="query parameter")]
    if typing.TYPE_CHECKING:
        Tfake_http_signature_test_header_1: typing.TypeAlias = Optional[str]
    else:
        Tfake_http_signature_test_header_1 = Annotated[Optional[StrictStr], Field(description="header parameter")]

    @validate_arguments
    async def fake_http_signature_test(self, pet : Tfake_http_signature_test_pet, query_1 : Tfake_http_signature_test_query_1 = None, header_1 : Tfake_http_signature_test_header_1 = None, **kwargs) -> None:  # noqa: E501
    ...
    if typing.TYPE_CHECKING:
        Tfake_outer_boolean_serialize_body: typing.TypeAlias = Optional[bool]
    else:
        Tfake_outer_boolean_serialize_body = Annotated[Optional[StrictBool], Field(description="Input boolean as post body")]

    @validate_arguments
    async def fake_outer_boolean_serialize(self, body : Tfake_outer_boolean_serialize_body = None, **kwargs) -> bool:  # noqa: E501
    ...
    @validate_arguments
    async def fake_outer_boolean_serialize_with_http_info(self, body : Annotated[Optional[StrictBool], Field(description="Input boolean as post body")] = None, **kwargs) -> ApiResponse[bool]:  # noqa: E501
        """fake_outer_boolean_serialize  # noqa: E501
    ...
    if typing.TYPE_CHECKING:
        Tfake_outer_composite_serialize_outer_composite: typing.TypeAlias = Optional[OuterComposite]
    else:
        Tfake_outer_composite_serialize_outer_composite = Annotated[Optional[OuterComposite], Field(description="Input composite as post body")]

    @validate_arguments
    async def fake_outer_composite_serialize(self, outer_composite : Tfake_outer_composite_serialize_outer_composite = None, **kwargs) -> OuterComposite:  # noqa: E501
    ...
    @validate_arguments
    async def fake_outer_composite_serialize_with_http_info(self, outer_composite : Annotated[Optional[OuterComposite], Field(description="Input composite as post body")] = None, **kwargs) -> ApiResponse[OuterComposite]:  # noqa: E501
        """fake_outer_composite_serialize  # noqa: E501
    ...
    if typing.TYPE_CHECKING:
        Tfake_outer_number_serialize_body: typing.TypeAlias = Optional[float]
    else:
        Tfake_outer_number_serialize_body = Annotated[Optional[StrictFloat], Field(description="Input number as post body")]

    @validate_arguments
    async def fake_outer_number_serialize(self, body : Tfake_outer_number_serialize_body = None, **kwargs) -> float:  # noqa: E501
    ...
    @validate_arguments
    async def fake_outer_number_serialize_with_http_info(self, body : Annotated[Optional[StrictFloat], Field(description="Input number as post body")] = None, **kwargs) -> ApiResponse[float]:  # noqa: E501
        """fake_outer_number_serialize  # noqa: E501
    ...
    if typing.TYPE_CHECKING:
        Tfake_outer_string_serialize_body: typing.TypeAlias = Optional[str]
    else:
        Tfake_outer_string_serialize_body = Annotated[Optional[StrictStr], Field(description="Input string as post body")]

    @validate_arguments
    async def fake_outer_string_serialize(self, body : Tfake_outer_string_serialize_body = None, **kwargs) -> str:  # noqa: E501
    ...
    @validate_arguments
    async def fake_outer_string_serialize_with_http_info(self, body : Annotated[Optional[StrictStr], Field(description="Input string as post body")] = None, **kwargs) -> ApiResponse[str]:  # noqa: E501
        """fake_outer_string_serialize  # noqa: E501
    ...
    if typing.TYPE_CHECKING:
        Tfake_property_enum_integer_serialize_outer_object_with_enum_property: typing.TypeAlias = OuterObjectWithEnumProperty
    else:
        Tfake_property_enum_integer_serialize_outer_object_with_enum_property = Annotated[OuterObjectWithEnumProperty, Field(..., description="Input enum (int) as post body")]

    @validate_arguments
    async def fake_property_enum_integer_serialize(self, outer_object_with_enum_property : Tfake_property_enum_integer_serialize_outer_object_with_enum_property, **kwargs) -> OuterObjectWithEnumProperty:  # noqa: E501
    ...
    @validate_arguments
    async def fake_property_enum_integer_serialize_with_http_info(self, outer_object_with_enum_property : Annotated[OuterObjectWithEnumProperty, Field(..., description="Input enum (int) as post body")], **kwargs) -> ApiResponse[OuterObjectWithEnumProperty]:  # noqa: E501
        """fake_property_enum_integer_serialize  # noqa: E501
    ...
    if typing.TYPE_CHECKING:
        Ttest_body_with_binary_body: typing.TypeAlias = Optional[bytearray]
    else:
        Ttest_body_with_binary_body = Annotated[Optional[Union[StrictBytes, StrictStr]], Field(..., description="image to upload")]

    @validate_arguments
    async def test_body_with_binary(self, body : Ttest_body_with_binary_body, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    async def test_body_with_binary_with_http_info(self, body : Annotated[Optional[Union[StrictBytes, StrictStr]], Field(..., description="image to upload")], **kwargs) -> ApiResponse[None]:  # noqa: E501
        """test_body_with_binary  # noqa: E501
    ...
    if typing.TYPE_CHECKING:
        Ttest_body_with_file_schema_file_schema_test_class: typing.TypeAlias = FileSchemaTestClass
    else:
        Ttest_body_with_file_schema_file_schema_test_class = FileSchemaTestClass

    @validate_arguments
    async def test_body_with_file_schema(self, file_schema_test_class : Ttest_body_with_file_schema_file_schema_test_class, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    async def test_body_with_file_schema_with_http_info(self, file_schema_test_class : FileSchemaTestClass, **kwargs) -> ApiResponse[None]:  # noqa: E501
        """test_body_with_file_schema  # noqa: E501
    ...
    if typing.TYPE_CHECKING:
        Ttest_body_with_query_params_query: typing.TypeAlias = str
    else:
        Ttest_body_with_query_params_query = StrictStr
    if typing.TYPE_CHECKING:
        Ttest_body_with_query_params_user: typing.TypeAlias = User
    else:
        Ttest_body_with_query_params_user = User

    @validate_arguments
    async def test_body_with_query_params(self, query : Ttest_body_with_query_params_query, user : Ttest_body_with_query_params_user, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    async def test_body_with_query_params_with_http_info(self, query : StrictStr, user : User, **kwargs) -> ApiResponse[None]:  # noqa: E501
        """test_body_with_query_params  # noqa: E501
    ...
    if typing.TYPE_CHECKING:
        Ttest_client_model_client: typing.TypeAlias = Client
    else:
        Ttest_client_model_client = Annotated[Client, Field(..., description="client model")]

    @validate_arguments
    async def test_client_model(self, client : Ttest_client_model_client, **kwargs) -> Client:  # noqa: E501
    ...
    @validate_arguments
    async def test_client_model_with_http_info(self, client : Annotated[Client, Field(..., description="client model")], **kwargs) -> ApiResponse[Client]:  # noqa: E501
        """To test \"client\" model  # noqa: E501
    ...
    if typing.TYPE_CHECKING:
        Ttest_date_time_query_parameter_date_time_query: typing.TypeAlias = datetime
    else:
        Ttest_date_time_query_parameter_date_time_query = datetime
    if typing.TYPE_CHECKING:
        Ttest_date_time_query_parameter_str_query: typing.TypeAlias = str
    else:
        Ttest_date_time_query_parameter_str_query = StrictStr

    @validate_arguments
    async def test_date_time_query_parameter(self, date_time_query : Ttest_date_time_query_parameter_date_time_query, str_query : Ttest_date_time_query_parameter_str_query, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    async def test_date_time_query_parameter_with_http_info(self, date_time_query : datetime, str_query : StrictStr, **kwargs) -> ApiResponse[None]:  # noqa: E501
        """test_date_time_query_parameter  # noqa: E501
    ...
    if typing.TYPE_CHECKING:
        Ttest_endpoint_parameters_number: typing.TypeAlias = float
    else:
        Ttest_endpoint_parameters_number = Annotated[confloat(le=543.2, ge=32.1, strict=True), Field(..., description="None")]
    if typing.TYPE_CHECKING:
        Ttest_endpoint_parameters_double: typing.TypeAlias = float
    else:
        Ttest_endpoint_parameters_double = Annotated[confloat(le=123.4, ge=67.8, strict=True), Field(..., description="None")]
    if typing.TYPE_CHECKING:
        Ttest_endpoint_parameters_pattern_without_delimiter: typing.TypeAlias = str
    else:
        Ttest_endpoint_parameters_pattern_without_delimiter = Annotated[constr(strict=True), Field(..., description="None")]
    if typing.TYPE_CHECKING:
        Ttest_endpoint_parameters_byte: typing.TypeAlias = bytearray
    else:
        Ttest_endpoint_parameters_byte = Annotated[Union[StrictBytes, StrictStr], Field(..., description="None")]
    if typing.TYPE_CHECKING:
        Ttest_endpoint_parameters_integer: typing.TypeAlias = Optional[int]
    else:
        Ttest_endpoint_parameters_integer = Annotated[Optional[conint(strict=True, le=100, ge=10)], Field(description="None")]
    if typing.TYPE_CHECKING:
        Ttest_endpoint_parameters_int32: typing.TypeAlias = Optional[int]
    else:
        Ttest_endpoint_parameters_int32 = Annotated[Optional[conint(strict=True, le=200, ge=20)], Field(description="None")]
    if typing.TYPE_CHECKING:
        Ttest_endpoint_parameters_int64: typing.TypeAlias = Optional[int]
    else:
        Ttest_endpoint_parameters_int64 = Annotated[Optional[StrictInt], Field(description="None")]
    if typing.TYPE_CHECKING:
        Ttest_endpoint_parameters_float: typing.TypeAlias = Optional[float]
    else:
        Ttest_endpoint_parameters_float = Annotated[Optional[confloat(le=987.6, strict=True)], Field(description="None")]
    if typing.TYPE_CHECKING:
        Ttest_endpoint_parameters_string: typing.TypeAlias = Optional[str]
    else:
        Ttest_endpoint_parameters_string = Annotated[Optional[constr(strict=True)], Field(description="None")]
    if typing.TYPE_CHECKING:
        Ttest_endpoint_parameters_binary: typing.TypeAlias = Optional[bytearray]
    else:
        Ttest_endpoint_parameters_binary = Annotated[Optional[Union[StrictBytes, StrictStr]], Field(description="None")]
    if typing.TYPE_CHECKING:
        Ttest_endpoint_parameters_byte_with_max_length: typing.TypeAlias = Optional[bytearray]
    else:
        Ttest_endpoint_parameters_byte_with_max_length = Annotated[Optional[Union[conbytes(strict=True, max_length=64), constr(strict=True, max_length=64)]], Field(description="None")]
    if typing.TYPE_CHECKING:
        Ttest_endpoint_parameters_var_date: typing.TypeAlias = Optional[date]
    else:
        Ttest_endpoint_parameters_var_date = Annotated[Optional[date], Field(description="None")]
    if typing.TYPE_CHECKING:
        Ttest_endpoint_parameters_date_time: typing.TypeAlias = Optional[datetime]
    else:
        Ttest_endpoint_parameters_date_time = Annotated[Optional[datetime], Field(description="None")]
    if typing.TYPE_CHECKING:
        Ttest_endpoint_parameters_password: typing.TypeAlias = Optional[str]
    else:
        Ttest_endpoint_parameters_password = Annotated[Optional[constr(strict=True, max_length=64, min_length=10)], Field(description="None")]
    if typing.TYPE_CHECKING:
        Ttest_endpoint_parameters_param_callback: typing.TypeAlias = Optional[str]
    else:
        Ttest_endpoint_parameters_param_callback = Annotated[Optional[StrictStr], Field(description="None")]

    @validate_arguments
    async def test_endpoint_parameters(self, number : Ttest_endpoint_parameters_number, double : Ttest_endpoint_parameters_double, pattern_without_delimiter : Ttest_endpoint_parameters_pattern_without_delimiter, byte : Ttest_endpoint_parameters_byte, integer : Ttest_endpoint_parameters_integer = None, int32 : Ttest_endpoint_parameters_int32 = None, int64 : Ttest_endpoint_parameters_int64 = None, float : Ttest_endpoint_parameters_float = None, string : Ttest_endpoint_parameters_string = None, binary : Ttest_endpoint_parameters_binary = None, byte_with_max_length : Ttest_endpoint_parameters_byte_with_max_length = None, var_date : Ttest_endpoint_parameters_var_date = None, date_time : Ttest_endpoint_parameters_date_time = None, password : Ttest_endpoint_parameters_password = None, param_callback : Ttest_endpoint_parameters_param_callback = None, **kwargs) -> None:  # noqa: E501
    ...
    if typing.TYPE_CHECKING:
        Ttest_group_parameters_required_string_group: typing.TypeAlias = int
    else:
        Ttest_group_parameters_required_string_group = Annotated[StrictInt, Field(..., description="Required String in group parameters")]
    if typing.TYPE_CHECKING:
        Ttest_group_parameters_required_boolean_group: typing.TypeAlias = bool
    else:
        Ttest_group_parameters_required_boolean_group = Annotated[StrictBool, Field(..., description="Required Boolean in group parameters")]
    if typing.TYPE_CHECKING:
        Ttest_group_parameters_required_int64_group: typing.TypeAlias = int
    else:
        Ttest_group_parameters_required_int64_group = Annotated[StrictInt, Field(..., description="Required Integer in group parameters")]
    if typing.TYPE_CHECKING:
        Ttest_group_parameters_string_group: typing.TypeAlias = Optional[int]
    else:
        Ttest_group_parameters_string_group = Annotated[Optional[StrictInt], Field(description="String in group parameters")]
    if typing.TYPE_CHECKING:
        Ttest_group_parameters_boolean_group: typing.TypeAlias = Optional[bool]
    else:
        Ttest_group_parameters_boolean_group = Annotated[Optional[StrictBool], Field(description="Boolean in group parameters")]
    if typing.TYPE_CHECKING:
        Ttest_group_parameters_int64_group: typing.TypeAlias = Optional[int]
    else:
        Ttest_group_parameters_int64_group = Annotated[Optional[StrictInt], Field(description="Integer in group parameters")]

    @validate_arguments
    async def test_group_parameters(self, required_string_group : Ttest_group_parameters_required_string_group, required_boolean_group : Ttest_group_parameters_required_boolean_group, required_int64_group : Ttest_group_parameters_required_int64_group, string_group : Ttest_group_parameters_string_group = None, boolean_group : Ttest_group_parameters_boolean_group = None, int64_group : Ttest_group_parameters_int64_group = None, **kwargs) -> None:  # noqa: E501
    ...
    if typing.TYPE_CHECKING:
        Ttest_inline_additional_properties_request_body: typing.TypeAlias = Dict[str, str]
    else:
        Ttest_inline_additional_properties_request_body = Annotated[Dict[str, StrictStr], Field(..., description="request body")]

    @validate_arguments
    async def test_inline_additional_properties(self, request_body : Ttest_inline_additional_properties_request_body, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    async def test_inline_additional_properties_with_http_info(self, request_body : Annotated[Dict[str, StrictStr], Field(..., description="request body")], **kwargs) -> ApiResponse[None]:  # noqa: E501
        """test inline additionalProperties  # noqa: E501
    ...
    if typing.TYPE_CHECKING:
        Ttest_json_form_data_param: typing.TypeAlias = str
    else:
        Ttest_json_form_data_param = Annotated[StrictStr, Field(..., description="field1")]
    if typing.TYPE_CHECKING:
        Ttest_json_form_data_param2: typing.TypeAlias = str
    else:
        Ttest_json_form_data_param2 = Annotated[StrictStr, Field(..., description="field2")]

    @validate_arguments
    async def test_json_form_data(self, param : Ttest_json_form_data_param, param2 : Ttest_json_form_data_param2, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    async def test_json_form_data_with_http_info(self, param : Annotated[StrictStr, Field(..., description="field1")], param2 : Annotated[StrictStr, Field(..., description="field2")], **kwargs) -> ApiResponse[None]:  # noqa: E501
        """test json serialization of form data  # noqa: E501
    ...
    if typing.TYPE_CHECKING:
        Ttest_query_parameter_collection_format_pipe: typing.TypeAlias = List[str]
    else:
        Ttest_query_parameter_collection_format_pipe = conlist(StrictStr)
    if typing.TYPE_CHECKING:
        Ttest_query_parameter_collection_format_ioutil: typing.TypeAlias = List[str]
    else:
        Ttest_query_parameter_collection_format_ioutil = conlist(StrictStr)
    if typing.TYPE_CHECKING:
        Ttest_query_parameter_collection_format_http: typing.TypeAlias = List[str]
    else:
        Ttest_query_parameter_collection_format_http = conlist(StrictStr)
    if typing.TYPE_CHECKING:
        Ttest_query_parameter_collection_format_url: typing.TypeAlias = List[str]
    else:
        Ttest_query_parameter_collection_format_url = conlist(StrictStr)
    if typing.TYPE_CHECKING:
        Ttest_query_parameter_collection_format_context: typing.TypeAlias = List[str]
    else:
        Ttest_query_parameter_collection_format_context = conlist(StrictStr)
    if typing.TYPE_CHECKING:
        Ttest_query_parameter_collection_format_allow_empty: typing.TypeAlias = str
    else:
        Ttest_query_parameter_collection_format_allow_empty = StrictStr
    if typing.TYPE_CHECKING:
        Ttest_query_parameter_collection_format_language: typing.TypeAlias = Optional[Dict[str, str]]
    else:
        Ttest_query_parameter_collection_format_language = Optional[Dict[str, StrictStr]]

    @validate_arguments
    async def test_query_parameter_collection_format(self, pipe : Ttest_query_parameter_collection_format_pipe, ioutil : Ttest_query_parameter_collection_format_ioutil, http : Ttest_query_parameter_collection_format_http, url : Ttest_query_parameter_collection_format_url, context : Ttest_query_parameter_collection_format_context, allow_empty : Ttest_query_parameter_collection_format_allow_empty, language : Ttest_query_parameter_collection_format_language = None, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    async def test_query_parameter_collection_format_with_http_info(self, pipe : conlist(StrictStr), ioutil : conlist(StrictStr), http : conlist(StrictStr), url : conlist(StrictStr), context : conlist(StrictStr), allow_empty : StrictStr, language : Optional[Dict[str, StrictStr]] = None, **kwargs) -> ApiResponse[None]:  # noqa: E501
        """test_query_parameter_collection_format  # noqa: E501
