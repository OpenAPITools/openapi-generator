...
class StoreApi(object):
    ...
    if typing.TYPE_CHECKING:
        Tdelete_order_order_id: typing.TypeAlias = str
    else:
        Tdelete_order_order_id = Annotated[StrictStr, Field(..., description="ID of the order that needs to be deleted")]

    @validate_arguments
    async def delete_order(self, order_id : Tdelete_order_order_id, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    async def delete_order_with_http_info(self, order_id : Annotated[StrictStr, Field(..., description="ID of the order that needs to be deleted")], **kwargs) -> ApiResponse[None]:  # noqa: E501
        """Delete purchase order by ID  # noqa: E501
    ...
    @validate_arguments
    async def get_inventory_with_http_info(self, **kwargs) -> ApiResponse[Dict[str, int]]:  # noqa: E501
        """Returns pet inventories by status  # noqa: E501
    ...
    if typing.TYPE_CHECKING:
        Tget_order_by_id_order_id: typing.TypeAlias = int
    else:
        Tget_order_by_id_order_id = Annotated[conint(strict=True, le=5, ge=1), Field(..., description="ID of pet that needs to be fetched")]

    @validate_arguments
    async def get_order_by_id(self, order_id : Tget_order_by_id_order_id, **kwargs) -> Order:  # noqa: E501
    ...
    @validate_arguments
    async def get_order_by_id_with_http_info(self, order_id : Annotated[conint(strict=True, le=5, ge=1), Field(..., description="ID of pet that needs to be fetched")], **kwargs) -> ApiResponse[Order]:  # noqa: E501
        """Find purchase order by ID  # noqa: E501
    ...
    if typing.TYPE_CHECKING:
        Tplace_order_order: typing.TypeAlias = Order
    else:
        Tplace_order_order = Annotated[Order, Field(..., description="order placed for purchasing the pet")]

    @validate_arguments
    async def place_order(self, order : Tplace_order_order, **kwargs) -> Order:  # noqa: E501
    ...
    @validate_arguments
    async def place_order_with_http_info(self, order : Annotated[Order, Field(..., description="order placed for purchasing the pet")], **kwargs) -> ApiResponse[Order]:  # noqa: E501
        """Place an order for a pet  # noqa: E501
