...
class FakeClassnameTags123Api(object):
    ...
    if typing.TYPE_CHECKING:
        Ttest_classname_client: typing.TypeAlias = Client
    else:
        Ttest_classname_client = Annotated[Client, Field(..., description="client model")]

    @validate_arguments
    async def test_classname(self, client : Ttest_classname_client, **kwargs) -> Client:  # noqa: E501
    ...
    @validate_arguments
    async def test_classname_with_http_info(self, client : Annotated[Client, Field(..., description="client model")], **kwargs) -> ApiResponse[Client]:  # noqa: E501
        """To test class name in snake case  # noqa: E501
