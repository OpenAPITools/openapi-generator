...
class PetApi(object):
    ...
    if typing.TYPE_CHECKING:
        Tadd_pet_pet: typing.TypeAlias = Pet
    else:
        Tadd_pet_pet = Annotated[Pet, Field(..., description="Pet object that needs to be added to the store")]

    @validate_arguments
    async def add_pet(self, pet : Tadd_pet_pet, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    async def add_pet_with_http_info(self, pet : Annotated[Pet, Field(..., description="Pet object that needs to be added to the store")], **kwargs) -> ApiResponse[None]:  # noqa: E501
        """Add a new pet to the store  # noqa: E501
    ...
    if typing.TYPE_CHECKING:
        Tdelete_pet_pet_id: typing.TypeAlias = int
    else:
        Tdelete_pet_pet_id = Annotated[StrictInt, Field(..., description="Pet id to delete")]
    if typing.TYPE_CHECKING:
        Tdelete_pet_api_key: typing.TypeAlias = Optional[str]
    else:
        Tdelete_pet_api_key = Optional[StrictStr]

    @validate_arguments
    async def delete_pet(self, pet_id : Tdelete_pet_pet_id, api_key : Tdelete_pet_api_key = None, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    async def delete_pet_with_http_info(self, pet_id : Annotated[StrictInt, Field(..., description="Pet id to delete")], api_key : Optional[StrictStr] = None, **kwargs) -> ApiResponse[None]:  # noqa: E501
        """Deletes a pet  # noqa: E501
    ...
    if typing.TYPE_CHECKING:
        Tfind_pets_by_status_status: typing.TypeAlias = List[str]
    else:
        Tfind_pets_by_status_status = Annotated[conlist(StrictStr), Field(..., description="Status values that need to be considered for filter")]

    @validate_arguments
    async def find_pets_by_status(self, status : Tfind_pets_by_status_status, **kwargs) -> List[Pet]:  # noqa: E501
    ...
    @validate_arguments
    async def find_pets_by_status_with_http_info(self, status : Annotated[conlist(StrictStr), Field(..., description="Status values that need to be considered for filter")], **kwargs) -> ApiResponse[List[Pet]]:  # noqa: E501
        """Finds Pets by status  # noqa: E501
    ...
    if typing.TYPE_CHECKING:
        Tfind_pets_by_tags_tags: typing.TypeAlias = List[str]
    else:
        Tfind_pets_by_tags_tags = Annotated[conlist(StrictStr, unique_items=True), Field(..., description="Tags to filter by")]

    @validate_arguments
    async def find_pets_by_tags(self, tags : Tfind_pets_by_tags_tags, **kwargs) -> List[Pet]:  # noqa: E501
    ...
    @validate_arguments
    async def find_pets_by_tags_with_http_info(self, tags : Annotated[conlist(StrictStr, unique_items=True), Field(..., description="Tags to filter by")], **kwargs) -> ApiResponse[List[Pet]]:  # noqa: E501
        """(Deprecated) Finds Pets by tags  # noqa: E501
    ...
    if typing.TYPE_CHECKING:
        Tget_pet_by_id_pet_id: typing.TypeAlias = int
    else:
        Tget_pet_by_id_pet_id = Annotated[StrictInt, Field(..., description="ID of pet to return")]

    @validate_arguments
    async def get_pet_by_id(self, pet_id : Tget_pet_by_id_pet_id, **kwargs) -> Pet:  # noqa: E501
    ...
    @validate_arguments
    async def get_pet_by_id_with_http_info(self, pet_id : Annotated[StrictInt, Field(..., description="ID of pet to return")], **kwargs) -> ApiResponse[Pet]:  # noqa: E501
        """Find pet by ID  # noqa: E501
    ...
    if typing.TYPE_CHECKING:
        Tupdate_pet_pet: typing.TypeAlias = Pet
    else:
        Tupdate_pet_pet = Annotated[Pet, Field(..., description="Pet object that needs to be added to the store")]

    @validate_arguments
    async def update_pet(self, pet : Tupdate_pet_pet, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    async def update_pet_with_http_info(self, pet : Annotated[Pet, Field(..., description="Pet object that needs to be added to the store")], **kwargs) -> ApiResponse[None]:  # noqa: E501
        """Update an existing pet  # noqa: E501
    ...
    if typing.TYPE_CHECKING:
        Tupdate_pet_with_form_pet_id: typing.TypeAlias = int
    else:
        Tupdate_pet_with_form_pet_id = Annotated[StrictInt, Field(..., description="ID of pet that needs to be updated")]
    if typing.TYPE_CHECKING:
        Tupdate_pet_with_form_name: typing.TypeAlias = Optional[str]
    else:
        Tupdate_pet_with_form_name = Annotated[Optional[StrictStr], Field(description="Updated name of the pet")]
    if typing.TYPE_CHECKING:
        Tupdate_pet_with_form_status: typing.TypeAlias = Optional[str]
    else:
        Tupdate_pet_with_form_status = Annotated[Optional[StrictStr], Field(description="Updated status of the pet")]

    @validate_arguments
    async def update_pet_with_form(self, pet_id : Tupdate_pet_with_form_pet_id, name : Tupdate_pet_with_form_name = None, status : Tupdate_pet_with_form_status = None, **kwargs) -> None:  # noqa: E501
    ...
    if typing.TYPE_CHECKING:
        Tupload_file_pet_id: typing.TypeAlias = int
    else:
        Tupload_file_pet_id = Annotated[StrictInt, Field(..., description="ID of pet to update")]
    if typing.TYPE_CHECKING:
        Tupload_file_additional_metadata: typing.TypeAlias = Optional[str]
    else:
        Tupload_file_additional_metadata = Annotated[Optional[StrictStr], Field(description="Additional data to pass to server")]
    if typing.TYPE_CHECKING:
        Tupload_file_file: typing.TypeAlias = Optional[bytearray]
    else:
        Tupload_file_file = Annotated[Optional[Union[StrictBytes, StrictStr]], Field(description="file to upload")]

    @validate_arguments
    async def upload_file(self, pet_id : Tupload_file_pet_id, additional_metadata : Tupload_file_additional_metadata = None, file : Tupload_file_file = None, **kwargs) -> ApiResponse:  # noqa: E501
    ...
    if typing.TYPE_CHECKING:
        Tupload_file_with_required_file_pet_id: typing.TypeAlias = int
    else:
        Tupload_file_with_required_file_pet_id = Annotated[StrictInt, Field(..., description="ID of pet to update")]
    if typing.TYPE_CHECKING:
        Tupload_file_with_required_file_required_file: typing.TypeAlias = bytearray
    else:
        Tupload_file_with_required_file_required_file = Annotated[Union[StrictBytes, StrictStr], Field(..., description="file to upload")]
    if typing.TYPE_CHECKING:
        Tupload_file_with_required_file_additional_metadata: typing.TypeAlias = Optional[str]
    else:
        Tupload_file_with_required_file_additional_metadata = Annotated[Optional[StrictStr], Field(description="Additional data to pass to server")]

    @validate_arguments
    async def upload_file_with_required_file(self, pet_id : Tupload_file_with_required_file_pet_id, required_file : Tupload_file_with_required_file_required_file, additional_metadata : Tupload_file_with_required_file_additional_metadata = None, **kwargs) -> ApiResponse:  # noqa: E501
