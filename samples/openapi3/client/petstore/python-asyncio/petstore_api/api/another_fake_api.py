...
class AnotherFakeApi(object):
    ...
    if typing.TYPE_CHECKING:
        Tcall_123_test_special_tags_client: typing.TypeAlias = Client
    else:
        Tcall_123_test_special_tags_client = Annotated[Client, Field(..., description="client model")]

    @validate_arguments
    async def call_123_test_special_tags(self, client : Tcall_123_test_special_tags_client, **kwargs) -> Client:  # noqa: E501
    ...
    @validate_arguments
    async def call_123_test_special_tags_with_http_info(self, client : Annotated[Client, Field(..., description="client model")], **kwargs) -> ApiResponse[Client]:  # noqa: E501
        """To test special tags  # noqa: E501
