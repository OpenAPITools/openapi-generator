...
class MapTest(BaseModel):
    ...
    if typing.TYPE_CHECKING:
        ...
        map_map_of_string: Optional[Dict[str, Dict[str, str]]]
    else:
        map_map_of_string: Optional[Dict[str, Dict[str, StrictStr]]] = None

    if typing.TYPE_CHECKING:
        # Mypy does not understand pydantic constrained types, Use the python builtin type when linting is run
        map_of_enum_string: Optional[Dict[str, str]]
    else:
        map_of_enum_string: Optional[Dict[str, StrictStr]] = None

    if typing.TYPE_CHECKING:
        # Mypy does not understand pydantic constrained types, Use the python builtin type when linting is run
        direct_map: Optional[Dict[str, bool]]
    else:
        direct_map: Optional[Dict[str, StrictBool]] = None

    if typing.TYPE_CHECKING:
        # Mypy does not understand pydantic constrained types, Use the python builtin type when linting is run
        indirect_map: Optional[Dict[str, bool]]
    else:
