...
from petstore_client.models.special_name import SpecialName  # noqa: E501
...
class TestSpecialName(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = petstore_client.models.special_name.SpecialName()  # noqa: E501
        if include_optional :
            return SpecialName(
                var_property = 56, 
                var_async = petstore_client.models.category.Category(
                    id = 56, 
                    name = 'default-name', ), 
                status = 'available'
            )
