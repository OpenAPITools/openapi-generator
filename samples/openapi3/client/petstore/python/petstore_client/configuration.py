...
class Configuration:
    ...
    :param signing_info: Configuration parameters for the HTTP signature security scheme.
        Must be an instance of petstore_client.signing.HttpSigningConfiguration
...
conf = petstore_client.Configuration(
    ...
    Note you can use the constants defined in the petstore_client.signing module, and you can
...
conf = petstore_client.Configuration(
    signing_info = petstore_client.signing.HttpSigningConfiguration(
        key_id =                 'my-key-id',
        private_key_path =       'rsa.pem',
        signing_scheme =         petstore_client.signing.SCHEME_HS2019,
        signing_algorithm =      petstore_client.signing.ALGORITHM_RSASSA_PSS,
        signed_headers =         [petstore_client.signing.HEADER_REQUEST_TARGET,
