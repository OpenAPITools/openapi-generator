...
with petstore_client.ApiClient(configuration) as api_client:
    ...
    user = petstore_client.User() # User | Created user object
...
with petstore_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = petstore_client.UserApi(api_client)
    user = [petstore_client.User()] # List[User] | List of user object
...
with petstore_client.ApiClient(configuration) as api_client:
    ...
    user = petstore_client.User() # User | Updated user object
