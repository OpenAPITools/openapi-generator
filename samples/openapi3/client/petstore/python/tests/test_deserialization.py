...
class DeserializationTests(unittest.TestCase):
    ...
    def test_enum_test(self):
       ...
       self.assertTrue(isinstance(deserialized['enum_test'], petstore_client.EnumTest))
       self.assertEqual(deserialized['enum_test'],
                        petstore_client.EnumTest(enum_string="UPPER",
                                              enum_string_required="lower",
                                              enum_integer=1,
                                              enum_number=1.1,
                                              outerEnum=petstore_client.OuterEnum.PLACED))
    ...
    def test_deserialize_dict_str_pet(self):
        ...
        self.assertTrue(isinstance(deserialized, dict))
        self.assertTrue(isinstance(deserialized['pet'], petstore_client.Pet))
    ...
    def test_deserialize_dict_str_dog(self):
        ...
        self.assertTrue(isinstance(deserialized, dict))
        self.assertTrue(isinstance(deserialized['dog'], petstore_client.Dog))
    ...
    def test_deserialize_pet(self):
        ...
        self.assertTrue(isinstance(deserialized, petstore_client.Pet))
        self.assertEqual(deserialized.id, 0)
        self.assertEqual(deserialized.name, "doggie")
        self.assertTrue(isinstance(deserialized.category, petstore_client.Category))
    ...
    def test_deserialize_list_of_pet(self):
        ...
        self.assertTrue(isinstance(deserialized[0], petstore_client.Pet))
    ...
    def test_deserialize_animal(self):
        ...
        deserialized = self.deserialize(response, "Animal")
        self.assertTrue(isinstance(deserialized, petstore_client.Cat))
        ...
        deserialized = petstore_client.Animal.from_json(json_str)
        self.assertTrue(isinstance(deserialized, petstore_client.Cat))
        self.assertEqual(deserialized.class_name, "Cat")
        self.assertEqual(deserialized.declawed, True)
        self.assertEqual(deserialized.to_json(), '{"className": "Cat", "color": "red", "declawed": true}')
