...
def lazy_import():
    from petstore_api.openapi_client.model.shape_interface import ShapeInterface
    from petstore_api.openapi_client.model.triangle_interface import TriangleInterface
    globals()['ShapeInterface'] = ShapeInterface
    globals()['TriangleInterface'] = TriangleInterface


class EquilateralTriangle(ModelComposed):
