...
class FakeApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __object_with_no_reference_schema(
            self,
            **kwargs
        ):
            """object_with_no_reference_schema  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.object_with_no_reference_schema(async_req=True)
            >>> result = thread.get()
        ...
        self.object_with_no_reference_schema = _Endpoint(
            ...
            api_client=api_client,
            callable=__object_with_no_reference_schema
        )
