...
class FakeClassnameTags123Api:
    ...
    def test_classname(
        ...
        **kwargs,
        ...
        response = self.test_classname_with_http_info.raw_function(
            client,
            **kwargs,
        )
    ...
    def test_classname_async(
        ...
        **kwargs,
        ...
        >>> thread = api.test_classname(client, )
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the test_classname_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        response = self.test_classname_with_http_info_async(
            client,
            **kwargs,
        )
    ...
    @validate_call
    def test_classname_with_http_info_async(self, client : Annotated[Client, Field(description="client model")], **kwargs) -> AsyncApiResponse:  # noqa: E501
        """To test class name in snake case  # noqa: E501

        To test class name in snake case  # noqa: E501
        This method makes a asynchronous HTTP request:

        >>> thread = api.test_classname_with_http_info_async(client, )
        >>> result = thread.get()
