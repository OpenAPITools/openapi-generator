...
class AnotherFakeApi:
    ...
    def call_123_test_special_tags(
        ...
        **kwargs,
        ...
        response = self.call_123_test_special_tags_with_http_info.raw_function(
            client,
            **kwargs,
        )
    ...
    def call_123_test_special_tags_async(
        self,
        client: Annotated[Client, Field(description="client model")],
        **kwargs,
        ...
        >>> thread = api.call_123_test_special_tags(client, )
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the call_123_test_special_tags_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        response = self.call_123_test_special_tags_with_http_info_async(
            client,
            **kwargs,
        )
    ...
    @validate_call
    def call_123_test_special_tags_with_http_info_async(self, client : Annotated[Client, Field(description="client model")], **kwargs) -> AsyncApiResponse:  # noqa: E501
        """To test special tags  # noqa: E501

        To test special tags and operation ID starting with number  # noqa: E501
        This method makes a asynchronous HTTP request:

        >>> thread = api.call_123_test_special_tags_with_http_info_async(client, )
        >>> result = thread.get()
