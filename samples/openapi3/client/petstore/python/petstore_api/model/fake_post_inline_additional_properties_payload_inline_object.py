...
class FakePostInlineAdditionalPropertiesPayloadInlineObject(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """FakePostInlineAdditionalPropertiesPayloadInlineObject - a model defined in OpenAPI
