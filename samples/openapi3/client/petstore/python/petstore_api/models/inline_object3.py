...
class InlineObject3(OpenApiModel):
    ...
    def __init__(self, number, double, pattern_without_delimiter, byte, _check_type=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
