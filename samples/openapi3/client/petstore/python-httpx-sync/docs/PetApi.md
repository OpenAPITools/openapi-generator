...
**Synchronous variant:** `add_pet_sync(...)` — same parameters and return type, but blocks until completion instead of requiring `await`.
...
**Synchronous variant:** `delete_pet_sync(...)` — same parameters and return type, but blocks until completion instead of requiring `await`.
...
**Synchronous variant:** `get_pet_by_id_sync(...)` — same parameters and return type, but blocks until completion instead of requiring `await`.
...
**Synchronous variant:** `update_pet_sync(...)` — same parameters and return type, but blocks until completion instead of requiring `await`.
...
**Synchronous variant:** `update_pet_with_form_sync(...)` — same parameters and return type, but blocks until completion instead of requiring `await`.
...
**Synchronous variant:** `upload_file_sync(...)` — same parameters and return type, but blocks until completion instead of requiring `await`.
...
**Synchronous variant:** `upload_file_with_required_file_sync(...)` — same parameters and return type, but blocks until completion instead of requiring `await`.
