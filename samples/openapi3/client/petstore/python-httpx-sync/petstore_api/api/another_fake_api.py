...
class AnotherFakeApi:
    ...
    @validate_call
    def call_123_test_special_tags_sync(
        self,
        client: Annotated[Client, Field(description="client model")],
        _request_timeout: Union[
            None,
        ...
        """To test special tags (synchronous)

        Synchronous variant of :meth:`call_123_test_special_tags`. It calls the asynchronous
        method and blocks until it completes.
        """ # noqa: E501
        return run_sync(
            self.call_123_test_special_tags(
                client=client,
                _request_timeout=_request_timeout,
                _request_auth=_request_auth,
                _content_type=_content_type,
    ...
    @validate_call
    def call_123_test_special_tags_sync_with_http_info(
        self,
        client: Annotated[Client, Field(description="client model")],
        _request_timeout: Union[
            None,
        ...
        Synchronous variant of :meth:`call_123_test_special_tags_with_http_info`. It calls the
        asynchronous method and blocks until it completes.
        """ # noqa: E501
        return run_sync(
            self.call_123_test_special_tags_with_http_info(
                client=client,
                _request_timeout=_request_timeout,
                _request_auth=_request_auth,
                _content_type=_content_type,
    ...
    @validate_call
    def call_123_test_special_tags_sync_without_preload_content(
        self,
        client: Annotated[Client, Field(description="client model")],
        _request_timeout: Union[
            None,
        ...
        Synchronous variant of :meth:`call_123_test_special_tags_without_preload_content`. It calls
        the asynchronous method and blocks until it completes.
        """ # noqa: E501
        return run_sync(
            self.call_123_test_special_tags_without_preload_content(
                client=client,
                _request_timeout=_request_timeout,
                _request_auth=_request_auth,
                _content_type=_content_type,
