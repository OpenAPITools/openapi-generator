...
class StoreApi:
    ...
    def delete_order_sync(
        ...
        Synchronous variant of :meth:`delete_order`. It calls the asynchronous
    ...
    @validate_call
    def delete_order_sync_with_http_info(
        self,
        order_id: Annotated[StrictStr, Field(description="ID of the order that needs to be deleted")],
        _request_timeout: Union[
            None,
        ...
        Synchronous variant of :meth:`delete_order_with_http_info`. It calls the
        asynchronous method and blocks until it completes.
        """ # noqa: E501
        return run_sync(
            self.delete_order_with_http_info(
                order_id=order_id,
                _request_timeout=_request_timeout,
                _request_auth=_request_auth,
                _content_type=_content_type,
    ...
    @validate_call
    def delete_order_sync_without_preload_content(
        self,
        order_id: Annotated[StrictStr, Field(description="ID of the order that needs to be deleted")],
        _request_timeout: Union[
            None,
        ...
        Synchronous variant of :meth:`delete_order_without_preload_content`. It calls
        the asynchronous method and blocks until it completes.
        """ # noqa: E501
        return run_sync(
            self.delete_order_without_preload_content(
                order_id=order_id,
                _request_timeout=_request_timeout,
                _request_auth=_request_auth,
                _content_type=_content_type,
    ...
    @validate_call
    def get_inventory_sync_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        """ # noqa: E501
        return run_sync(
            self.get_inventory_with_http_info(
                _request_timeout=_request_timeout,
                _request_auth=_request_auth,
                _content_type=_content_type,
                _headers=_headers,
    ...
    @validate_call
    def get_inventory_sync_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        Synchronous variant of :meth:`get_inventory_without_preload_content`. It calls
        the asynchronous method and blocks until it completes.
        """ # noqa: E501
        return run_sync(
            self.get_inventory_without_preload_content(
                _request_timeout=_request_timeout,
                _request_auth=_request_auth,
                _content_type=_content_type,
                _headers=_headers,
    ...
    def get_order_by_id_sync(
        ...
        Synchronous variant of :meth:`get_order_by_id`. It calls the asynchronous
        method and blocks until it completes.
        """ # noqa: E501
        return run_sync(
    ...
    @validate_call
    def get_order_by_id_sync_with_http_info(
        self,
        order_id: Annotated[int, Field(le=5, strict=True, ge=1, description="ID of pet that needs to be fetched")],
        _request_timeout: Union[
            None,
        ...
        Synchronous variant of :meth:`get_order_by_id_with_http_info`. It calls the
        asynchronous method and blocks until it completes.
        """ # noqa: E501
        return run_sync(
            self.get_order_by_id_with_http_info(
                order_id=order_id,
                _request_timeout=_request_timeout,
                _request_auth=_request_auth,
                _content_type=_content_type,
    ...
    @validate_call
    def get_order_by_id_sync_without_preload_content(
        self,
        order_id: Annotated[int, Field(le=5, strict=True, ge=1, description="ID of pet that needs to be fetched")],
        _request_timeout: Union[
            None,
        ...
        Synchronous variant of :meth:`get_order_by_id_without_preload_content`. It calls
        the asynchronous method and blocks until it completes.
        """ # noqa: E501
        return run_sync(
            self.get_order_by_id_without_preload_content(
                order_id=order_id,
                _request_timeout=_request_timeout,
                _request_auth=_request_auth,
                _content_type=_content_type,
    ...
    def place_order_sync(
        ...
        Synchronous variant of :meth:`place_order`. It calls the asynchronous
        method and blocks until it completes.
        """ # noqa: E501
        return run_sync(
            self.place_order(
    ...
    @validate_call
    def place_order_sync_with_http_info(
        self,
        order: Annotated[Order, Field(description="order placed for purchasing the pet")],
        _request_timeout: Union[
            None,
        ...
        Synchronous variant of :meth:`place_order_with_http_info`. It calls the
        asynchronous method and blocks until it completes.
        """ # noqa: E501
        return run_sync(
    ...
    @validate_call
    def place_order_sync_without_preload_content(
        self,
        order: Annotated[Order, Field(description="order placed for purchasing the pet")],
        _request_timeout: Union[
            None,
        ...
        Synchronous variant of :meth:`place_order_without_preload_content`. It calls
        the asynchronous method and blocks until it completes.
        """ # noqa: E501
        return run_sync(
            self.place_order_without_preload_content(
                order=order,
                _request_timeout=_request_timeout,
                _request_auth=_request_auth,
                _content_type=_content_type,
