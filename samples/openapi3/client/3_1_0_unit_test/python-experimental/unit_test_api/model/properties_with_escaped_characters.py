...
class PropertiesWithEscapedCharacters(
    ...
    class MetaOapg:
        ...
        class properties:
            foo_nbar = schemas.AnyTypeSchema
            foo_bar = schemas.AnyTypeSchema
            foo__bar = schemas.AnyTypeSchema
            foo_rbar = schemas.AnyTypeSchema
            foo_tbar = schemas.AnyTypeSchema
            foo_fbar = schemas.AnyTypeSchema
            __annotations__ = {
                "foo\nbar": foo_nbar,
                "foo\"bar": foo_bar,
                "foo\\bar": foo__bar,
