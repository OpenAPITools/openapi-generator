...
class BaseApi(api_client.Api):
    ...
    def _post_uuid_format_request_body_oapg(
        self: api_client.Api,
...
class PostUuidFormatRequestBody(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def post_uuid_format_request_body(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationJson, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, ],
        content_type: str = 'application/json',
        stream: bool = False,
        ...
        return self._post_uuid_format_request_body_oapg(
            body=body,
