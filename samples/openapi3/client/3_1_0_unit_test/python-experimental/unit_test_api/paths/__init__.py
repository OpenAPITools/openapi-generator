...
class PathValues(str, enum.Enum):
    REQUEST_BODY_POST_ADDITIONALPROPERTIES_WITH_SCHEMA_REQUEST_BODY = "/requestBody/postAdditionalpropertiesWithSchemaRequestBody"
    RESPONSE_BODY_POST_ADDITIONALPROPERTIES_WITH_SCHEMA_RESPONSE_BODY_FOR_CONTENT_TYPES = "/responseBody/postAdditionalpropertiesWithSchemaResponseBodyForContentTypes"
    ...
    REQUEST_BODY_POST_ADDITIONALPROPERTIES_DOES_NOT_LOOK_IN_APPLICATORS_REQUEST_BODY = "/requestBody/postAdditionalpropertiesDoesNotLookInApplicatorsRequestBody"
    RESPONSE_BODY_POST_ADDITIONALPROPERTIES_DOES_NOT_LOOK_IN_APPLICATORS_RESPONSE_BODY_FOR_CONTENT_TYPES = "/responseBody/postAdditionalpropertiesDoesNotLookInApplicatorsResponseBodyForContentTypes"
    REQUEST_BODY_POST_ADDITIONALPROPERTIES_WITH_NULL_VALUED_INSTANCE_PROPERTIES_REQUEST_BODY = "/requestBody/postAdditionalpropertiesWithNullValuedInstancePropertiesRequestBody"
    RESPONSE_BODY_POST_ADDITIONALPROPERTIES_WITH_NULL_VALUED_INSTANCE_PROPERTIES_RESPONSE_BODY_FOR_CONTENT_TYPES = "/responseBody/postAdditionalpropertiesWithNullValuedInstancePropertiesResponseBodyForContentTypes"
    ...
    REQUEST_BODY_POST_IDN_EMAIL_FORMAT_REQUEST_BODY = "/requestBody/postIdnEmailFormatRequestBody"
    RESPONSE_BODY_POST_IDN_EMAIL_FORMAT_RESPONSE_BODY_FOR_CONTENT_TYPES = "/responseBody/postIdnEmailFormatResponseBodyForContentTypes"
    REQUEST_BODY_POST_REGEX_FORMAT_REQUEST_BODY = "/requestBody/postRegexFormatRequestBody"
    RESPONSE_BODY_POST_REGEX_FORMAT_RESPONSE_BODY_FOR_CONTENT_TYPES = "/responseBody/postRegexFormatResponseBodyForContentTypes"
    ...
    REQUEST_BODY_POST_IDN_HOSTNAME_FORMAT_REQUEST_BODY = "/requestBody/postIdnHostnameFormatRequestBody"
    RESPONSE_BODY_POST_IDN_HOSTNAME_FORMAT_RESPONSE_BODY_FOR_CONTENT_TYPES = "/responseBody/postIdnHostnameFormatResponseBodyForContentTypes"
    ...
    REQUEST_BODY_POST_DATE_FORMAT_REQUEST_BODY = "/requestBody/postDateFormatRequestBody"
    RESPONSE_BODY_POST_DATE_FORMAT_RESPONSE_BODY_FOR_CONTENT_TYPES = "/responseBody/postDateFormatResponseBodyForContentTypes"
    ...
    REQUEST_BODY_POST_TIME_FORMAT_REQUEST_BODY = "/requestBody/postTimeFormatRequestBody"
    RESPONSE_BODY_POST_TIME_FORMAT_RESPONSE_BODY_FOR_CONTENT_TYPES = "/responseBody/postTimeFormatResponseBodyForContentTypes"
    ...
    REQUEST_BODY_POST_RELATIVE_JSON_POINTER_FORMAT_REQUEST_BODY = "/requestBody/postRelativeJsonPointerFormatRequestBody"
    RESPONSE_BODY_POST_RELATIVE_JSON_POINTER_FORMAT_RESPONSE_BODY_FOR_CONTENT_TYPES = "/responseBody/postRelativeJsonPointerFormatResponseBodyForContentTypes"
    REQUEST_BODY_POST_IRI_FORMAT_REQUEST_BODY = "/requestBody/postIriFormatRequestBody"
    RESPONSE_BODY_POST_IRI_FORMAT_RESPONSE_BODY_FOR_CONTENT_TYPES = "/responseBody/postIriFormatResponseBodyForContentTypes"
    REQUEST_BODY_POST_IRI_REFERENCE_FORMAT_REQUEST_BODY = "/requestBody/postIriReferenceFormatRequestBody"
    RESPONSE_BODY_POST_IRI_REFERENCE_FORMAT_RESPONSE_BODY_FOR_CONTENT_TYPES = "/responseBody/postIriReferenceFormatResponseBodyForContentTypes"
    ...
    REQUEST_BODY_POST_UUID_FORMAT_REQUEST_BODY = "/requestBody/postUuidFormatRequestBody"
    RESPONSE_BODY_POST_UUID_FORMAT_RESPONSE_BODY_FOR_CONTENT_TYPES = "/responseBody/postUuidFormatResponseBodyForContentTypes"
    REQUEST_BODY_POST_DURATION_FORMAT_REQUEST_BODY = "/requestBody/postDurationFormatRequestBody"
    RESPONSE_BODY_POST_DURATION_FORMAT_RESPONSE_BODY_FOR_CONTENT_TYPES = "/responseBody/postDurationFormatResponseBodyForContentTypes"
    ...
    REQUEST_BODY_POST_PREFIXITEMS_WITH_NO_ADDITIONAL_ITEMS_ALLOWED_REQUEST_BODY = "/requestBody/postPrefixitemsWithNoAdditionalItemsAllowedRequestBody"
    RESPONSE_BODY_POST_PREFIXITEMS_WITH_NO_ADDITIONAL_ITEMS_ALLOWED_RESPONSE_BODY_FOR_CONTENT_TYPES = "/responseBody/postPrefixitemsWithNoAdditionalItemsAllowedResponseBodyForContentTypes"
    REQUEST_BODY_POST_ITEMS_DOES_NOT_LOOK_IN_APPLICATORS_VALID_CASE_REQUEST_BODY = "/requestBody/postItemsDoesNotLookInApplicatorsValidCaseRequestBody"
    RESPONSE_BODY_POST_ITEMS_DOES_NOT_LOOK_IN_APPLICATORS_VALID_CASE_RESPONSE_BODY_FOR_CONTENT_TYPES = "/responseBody/postItemsDoesNotLookInApplicatorsValidCaseResponseBodyForContentTypes"
    REQUEST_BODY_POST_PREFIXITEMS_VALIDATION_ADJUSTS_THE_STARTING_INDEX_FOR_ITEMS_REQUEST_BODY = "/requestBody/postPrefixitemsValidationAdjustsTheStartingIndexForItemsRequestBody"
    RESPONSE_BODY_POST_PREFIXITEMS_VALIDATION_ADJUSTS_THE_STARTING_INDEX_FOR_ITEMS_RESPONSE_BODY_FOR_CONTENT_TYPES = "/responseBody/postPrefixitemsValidationAdjustsTheStartingIndexForItemsResponseBodyForContentTypes"
    REQUEST_BODY_POST_ITEMS_WITH_NULL_INSTANCE_ELEMENTS_REQUEST_BODY = "/requestBody/postItemsWithNullInstanceElementsRequestBody"
    RESPONSE_BODY_POST_ITEMS_WITH_NULL_INSTANCE_ELEMENTS_RESPONSE_BODY_FOR_CONTENT_TYPES = "/responseBody/postItemsWithNullInstanceElementsResponseBodyForContentTypes"
    ...
    REQUEST_BODY_POST_MAXITEMS_VALIDATION_WITH_ADECIMAL_REQUEST_BODY = "/requestBody/postMaxitemsValidationWithADecimalRequestBody"
    RESPONSE_BODY_POST_MAXITEMS_VALIDATION_WITH_ADECIMAL_RESPONSE_BODY_FOR_CONTENT_TYPES = "/responseBody/postMaxitemsValidationWithADecimalResponseBodyForContentTypes"
    ...
    REQUEST_BODY_POST_MAXLENGTH_VALIDATION_WITH_ADECIMAL_REQUEST_BODY = "/requestBody/postMaxlengthValidationWithADecimalRequestBody"
    RESPONSE_BODY_POST_MAXLENGTH_VALIDATION_WITH_ADECIMAL_RESPONSE_BODY_FOR_CONTENT_TYPES = "/responseBody/postMaxlengthValidationWithADecimalResponseBodyForContentTypes"
    ...
    REQUEST_BODY_POST_MAXPROPERTIES_VALIDATION_WITH_ADECIMAL_REQUEST_BODY = "/requestBody/postMaxpropertiesValidationWithADecimalRequestBody"
    RESPONSE_BODY_POST_MAXPROPERTIES_VALIDATION_WITH_ADECIMAL_RESPONSE_BODY_FOR_CONTENT_TYPES = "/responseBody/postMaxpropertiesValidationWithADecimalResponseBodyForContentTypes"
    ...
    REQUEST_BODY_POST_MINITEMS_VALIDATION_WITH_ADECIMAL_REQUEST_BODY = "/requestBody/postMinitemsValidationWithADecimalRequestBody"
    ...
    RESPONSE_BODY_POST_MINPROPERTIES_VALIDATION_WITH_ADECIMAL_RESPONSE_BODY_FOR_CONTENT_TYPES = "/responseBody/postMinpropertiesValidationWithADecimalResponseBodyForContentTypes"
    ...
    REQUEST_BODY_POST_FLOAT_DIVISION_INF_REQUEST_BODY = "/requestBody/postFloatDivisionInfRequestBody"
    RESPONSE_BODY_POST_FLOAT_DIVISION_INF_RESPONSE_BODY_FOR_CONTENT_TYPES = "/responseBody/postFloatDivisionInfResponseBodyForContentTypes"
    ...
    REQUEST_BODY_POST_PROPERTIES_WITH_NULL_VALUED_INSTANCE_PROPERTIES_REQUEST_BODY = "/requestBody/postPropertiesWithNullValuedInstancePropertiesRequestBody"
    RESPONSE_BODY_POST_PROPERTIES_WITH_NULL_VALUED_INSTANCE_PROPERTIES_RESPONSE_BODY_FOR_CONTENT_TYPES = "/responseBody/postPropertiesWithNullValuedInstancePropertiesResponseBodyForContentTypes"
    REQUEST_BODY_POST_PROPERTIES_WHOSE_NAMES_ARE_JAVASCRIPT_OBJECT_PROPERTY_NAMES_REQUEST_BODY = "/requestBody/postPropertiesWhoseNamesAreJavascriptObjectPropertyNamesRequestBody"
    RESPONSE_BODY_POST_PROPERTIES_WHOSE_NAMES_ARE_JAVASCRIPT_OBJECT_PROPERTY_NAMES_RESPONSE_BODY_FOR_CONTENT_TYPES = "/responseBody/postPropertiesWhoseNamesAreJavascriptObjectPropertyNamesResponseBodyForContentTypes"
    ...
    REQUEST_BODY_POST_ID_MUST_BE_RESOLVED_AGAINST_NEAREST_PARENT_NOT_JUST_IMMEDIATE_PARENT_REQUEST_BODY = "/requestBody/postIdMustBeResolvedAgainstNearestParentNotJustImmediateParentRequestBody"
    RESPONSE_BODY_POST_ID_MUST_BE_RESOLVED_AGAINST_NEAREST_PARENT_NOT_JUST_IMMEDIATE_PARENT_RESPONSE_BODY_FOR_CONTENT_TYPES = "/responseBody/postIdMustBeResolvedAgainstNearestParentNotJustImmediateParentResponseBodyForContentTypes"
    REQUEST_BODY_POST_URN_BASE_URI_WITH_FCOMPONENT_REQUEST_BODY = "/requestBody/postUrnBaseUriWithFComponentRequestBody"
    RESPONSE_BODY_POST_URN_BASE_URI_WITH_FCOMPONENT_RESPONSE_BODY_FOR_CONTENT_TYPES = "/responseBody/postUrnBaseUriWithFComponentResponseBodyForContentTypes"
    ...
    REQUEST_BODY_POST_REQUIRED_PROPERTIES_WHOSE_NAMES_ARE_JAVASCRIPT_OBJECT_PROPERTY_NAMES_REQUEST_BODY = "/requestBody/postRequiredPropertiesWhoseNamesAreJavascriptObjectPropertyNamesRequestBody"
    RESPONSE_BODY_POST_REQUIRED_PROPERTIES_WHOSE_NAMES_ARE_JAVASCRIPT_OBJECT_PROPERTY_NAMES_RESPONSE_BODY_FOR_CONTENT_TYPES = "/responseBody/postRequiredPropertiesWhoseNamesAreJavascriptObjectPropertyNamesResponseBodyForContentTypes"
