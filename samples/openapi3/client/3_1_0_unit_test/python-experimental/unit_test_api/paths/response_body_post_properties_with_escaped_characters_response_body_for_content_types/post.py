...
class PostPropertiesWithEscapedCharactersResponseBodyForContentTypes(BaseApi):
    ...
    def post_properties_with_escaped_characters_response_body_for_content_types(
        ...
        return self._post_properties_with_escaped_characters_response_body_for_content_types_oapg(
