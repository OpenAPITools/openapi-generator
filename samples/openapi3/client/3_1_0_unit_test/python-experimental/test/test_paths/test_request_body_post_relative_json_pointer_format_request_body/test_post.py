...
from unit_test_api.paths.request_body_post_relative_json_pointer_format_request_body import post  # noqa: E501
from unit_test_api import configuration, schemas, api_client

from .. import ApiTestMixin


class TestRequestBodyPostRelativeJsonPointerFormatRequestBody(ApiTestMixin, unittest.TestCase):
    """
    RequestBodyPostRelativeJsonPointerFormatRequestBody unit test stubs
    """
    ...
    def test_all_string_formats_ignore_objects_passes(self):
        ...
        with patch.object(urllib3.PoolManager, 'request') as mock_request:
            ...
            self.assert_pool_manager_request_called_with(
                mock_request,
                self._configuration.host + '/requestBody/postRelativeJsonPointerFormatRequestBody',
                method='post'.upper(),
