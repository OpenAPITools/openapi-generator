...
from unit_test_api.paths.response_body_post_iri_format_response_body_for_content_types import post  # noqa: E501
from unit_test_api import configuration, schemas, api_client

from .. import ApiTestMixin


class TestResponseBodyPostIriFormatResponseBodyForContentTypes(ApiTestMixin, unittest.TestCase):
    """
    ResponseBodyPostIriFormatResponseBodyForContentTypes unit test stubs
    """
    ...
    def test_all_string_formats_ignore_objects_passes(self):
        ...
        with patch.object(urllib3.PoolManager, 'request') as mock_request:
            ...
            self.assert_pool_manager_request_called_with(
                mock_request,
                self._configuration.host + '/responseBody/postIriFormatResponseBodyForContentTypes',
                method='post'.upper(),
