...
class PetApiInterfaceTest extends WebTestCase
{
    ...
    /**
     * Test case for petAge
     *
     * Get the age of the pet.
     *
     */
    public function testPetAge(): void
    {
        $client = self::$client;
        ...
        $crawler = $client->request('GET', $path);
        $this->markTestSkipped('Test for petAge not implemented');
    }

    /**
     * Test case for petAvailableForSale
     *
     * Whether the pet can currently be bought.
     *
     */
    public function testPetAvailableForSale(): void
    {
        $client = self::$client;
        ...
        $crawler = $client->request('GET', $path);
        $this->markTestSkipped('Test for petAvailableForSale not implemented');
    }
