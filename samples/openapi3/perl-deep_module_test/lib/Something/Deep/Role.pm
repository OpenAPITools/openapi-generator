...
has version_info => ( is => 'ro',
                      ...
                      default => sub { {
                          ...
                          app_version => '1.0.0',
                          generator_version => '7.24.0-SNAPSHOT',
...
Something::Deep::Role - a Moose role for the OpenAPI Petstore

=head2 OpenAPI Petstore version: 1.0.0
...
=item Generator version: 7.24.0-SNAPSHOT
