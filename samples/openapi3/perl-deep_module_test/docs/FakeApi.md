...
my $xml_item = Something::Deep::Object::XmlItem->new(); # XmlItem | XmlItem Body
...
my $body = Something::Deep::Object::boolean->new(); # boolean | Input boolean as post body
...
my $body = Something::Deep::Object::OuterComposite->new(); # OuterComposite | Input composite as post body
...
my $body = Something::Deep::Object::double->new(); # double | Input number as post body
...
my $body = Something::Deep::Object::string->new(); # string | Input string as post body
...
my $body = Something::Deep::Object::FileSchemaTestClass->new(); # FileSchemaTestClass | 
...
my $body = Something::Deep::Object::User->new(); # User | 
...
my $param = Something::Deep::Object::HASH[string,string]->new(); # HASH[string,string] | request body
