...
namespace Org.OpenAPITools.Test.Api
{
    ...
    public class QueryApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test TestQueryStyleJsonSerializationObject
        /// </summary>
        [Fact]
        public void TestQueryStyleJsonSerializationObjectTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //Pet? jsonSerializedObjectRefStringQuery = null;
            //List<Pet>? jsonSerializedObjectArrayRefStringQuery = null;
            //var response = instance.TestQueryStyleJsonSerializationObject(jsonSerializedObjectRefStringQuery, jsonSerializedObjectArrayRefStringQuery);
            //Assert.IsType<string>(response);
        }
    }
}
