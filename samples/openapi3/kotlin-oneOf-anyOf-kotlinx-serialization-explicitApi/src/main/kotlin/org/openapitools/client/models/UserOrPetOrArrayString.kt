...
public sealed interface UserOrPetOrArrayString {
    @JvmInline
    public value class UserValue(public val value: User) : UserOrPetOrArrayString

    @JvmInline
    public value class PetValue(public val value: Pet) : UserOrPetOrArrayString

    @JvmInline
    public value class ListStringValue(public val value: kotlin.collections.List<kotlin.String>) : UserOrPetOrArrayString

}

public object UserOrPetOrArrayStringSerializer : KSerializer<UserOrPetOrArrayString> {
