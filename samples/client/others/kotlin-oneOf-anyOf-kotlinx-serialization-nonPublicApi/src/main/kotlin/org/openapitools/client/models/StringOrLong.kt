...
internal sealed interface StringOrLong {
    @JvmInline
    value class StringValue(internal val value: kotlin.String) : StringOrLong

    @JvmInline
    value class LongValue(internal val value: kotlin.Long) : StringOrLong

}

internal object StringOrLongSerializer : KSerializer<StringOrLong> {
