...
internal sealed interface UserOrPetOrArrayString {
    @JvmInline
    value class UserValue(internal val value: User) : UserOrPetOrArrayString

    @JvmInline
    value class PetValue(internal val value: Pet) : UserOrPetOrArrayString

    @JvmInline
    value class ListStringValue(internal val value: kotlin.collections.List<kotlin.String>) : UserOrPetOrArrayString

}

internal object UserOrPetOrArrayStringSerializer : KSerializer<UserOrPetOrArrayString> {
