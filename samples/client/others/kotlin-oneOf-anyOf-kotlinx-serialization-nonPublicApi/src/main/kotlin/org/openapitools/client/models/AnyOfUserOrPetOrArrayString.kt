...
internal sealed interface AnyOfUserOrPetOrArrayString {
    @JvmInline
    value class UserValue(internal val value: User) : AnyOfUserOrPetOrArrayString

    @JvmInline
    value class PetValue(internal val value: Pet) : AnyOfUserOrPetOrArrayString

    @JvmInline
    value class ListStringValue(internal val value: kotlin.collections.List<kotlin.String>) : AnyOfUserOrPetOrArrayString

}

internal object AnyOfUserOrPetOrArrayStringSerializer : KSerializer<AnyOfUserOrPetOrArrayString> {
