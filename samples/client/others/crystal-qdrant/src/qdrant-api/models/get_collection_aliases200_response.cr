...
module Qdrant::Api
  class GetCollectionAliases200Response
    ...
    property result : CollectionsAliasesResponse?


    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@time : Float32? = nil, @status : String? = nil, @result : CollectionsAliasesResponse? = nil)
    end
