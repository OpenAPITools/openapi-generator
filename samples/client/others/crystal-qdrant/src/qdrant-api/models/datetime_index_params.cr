...
module Qdrant::Api
  class DatetimeIndexParams
    ...
    property _type : DatetimeIndexType
    ...
    def initialize(@_type : DatetimeIndexType, @is_principal : Bool? = nil, @on_disk : Bool? = nil)
    end
    ...
    def_equals_and_hash(_type, is_principal, on_disk)
  end
