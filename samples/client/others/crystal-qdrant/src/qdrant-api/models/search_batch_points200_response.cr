...
module Qdrant::Api
  class SearchBatchPoints200Response
    ...
    property result : Array(Array(ScoredPoint))?


    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@time : Float32? = nil, @status : String? = nil, @result : Array(Array(ScoredPoint))? = nil)
    end
