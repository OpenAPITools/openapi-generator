...
module Qdrant::Api
  class CollectionClusterInfo200Response
    ...
    property result : CollectionClusterInfo?


    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@time : Float32? = nil, @status : String? = nil, @result : CollectionClusterInfo? = nil)
    end
