...
# Unit tests for Qdrant::Api::AppFeaturesTelemetry
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe Qdrant::Api::AppFeaturesTelemetry do
  describe "required-field enforcement" do
    ...
    it "raises when required properties are missing" do
      expect { Qdrant::Api::AppFeaturesTelemetry.from_json("{}") }.to raise_error(JSON::SerializableError)
    end
  end
end
