...
# Unit tests for Qdrant::Api::ClearPayloadOperation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe Qdrant::Api::ClearPayloadOperation do
  describe "required-field enforcement" do
    ...
    it "raises when required properties are missing" do
      expect { Qdrant::Api::ClearPayloadOperation.from_json("{}") }.to raise_error(JSON::SerializableError)
    end
  end
end
