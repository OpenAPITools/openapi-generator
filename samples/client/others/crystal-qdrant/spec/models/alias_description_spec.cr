...
# Unit tests for Qdrant::Api::AliasDescription
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe Qdrant::Api::AliasDescription do
  describe "required-field enforcement" do
    ...
    it "raises when required properties are missing" do
      expect { Qdrant::Api::AliasDescription.from_json("{}") }.to raise_error(JSON::SerializableError)
    end
  end
end
