...
<dependency>
  ...
  <artifactId>okhttp-oneOf</artifactId>
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'okhttp-oneOf' jar has been published to maven central.
    mavenLocal()       // Needed if the 'okhttp-oneOf' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "org.openapitools:okhttp-oneOf:1.0.0"
  }
```
