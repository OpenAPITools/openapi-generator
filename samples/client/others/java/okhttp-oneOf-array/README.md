...
<dependency>
  ...
  <artifactId>okhttp-oneOf-array</artifactId>
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'okhttp-oneOf-array' jar has been published to maven central.
    mavenLocal()       // Needed if the 'okhttp-oneOf-array' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "org.openapitools:okhttp-oneOf-array:1.0.0"
  }
```
...
* `target/okhttp-oneOf-array-1.0.0.jar`
* `target/lib/*.jar`
