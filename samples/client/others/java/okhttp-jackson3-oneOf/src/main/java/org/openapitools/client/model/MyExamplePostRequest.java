...
public class MyExamplePostRequest extends AbstractOpenApiSchema {
    ...
    public static class MyExamplePostRequestSerializer extends StdSerializer<MyExamplePostRequest> {
        ...
        @Override
        public void serialize(MyExamplePostRequest value, JsonGenerator jgen, SerializationContext serializationContext) throws JacksonException {
    ...
    public static class MyExamplePostRequestDeserializer extends StdDeserializer<MyExamplePostRequest> {
        ...
        @Override
        public MyExamplePostRequest deserialize(JsonParser jp, DeserializationContext ctxt) throws JacksonException {
            ...
            throw DatabindException.from(jp, String.format(java.util.Locale.ROOT, "Failed deserialization for MyExamplePostRequest: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public MyExamplePostRequest getNullValue(DeserializationContext ctxt) {
            throw DatabindException.from(ctxt.getParser(), "MyExamplePostRequest cannot be null");
        }
    }
