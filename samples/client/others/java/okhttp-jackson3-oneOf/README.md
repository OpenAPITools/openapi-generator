...
<dependency>
  ...
  <artifactId>okhttp-jackson3-oneOf</artifactId>
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'okhttp-jackson3-oneOf' jar has been published to maven central.
    mavenLocal()       // Needed if the 'okhttp-jackson3-oneOf' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "org.openapitools:okhttp-jackson3-oneOf:1.0.0"
  }
```
...
* `target/okhttp-jackson3-oneOf-1.0.0.jar`
* `target/lib/*.jar`
