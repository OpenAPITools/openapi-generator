...
<dependency>
  ...
  <artifactId>okhttp-jackson-oneOf</artifactId>
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'okhttp-jackson-oneOf' jar has been published to maven central.
    mavenLocal()       // Needed if the 'okhttp-jackson-oneOf' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "org.openapitools:okhttp-jackson-oneOf:1.0.0"
  }
```
...
* `target/okhttp-jackson-oneOf-1.0.0.jar`
* `target/lib/*.jar`
