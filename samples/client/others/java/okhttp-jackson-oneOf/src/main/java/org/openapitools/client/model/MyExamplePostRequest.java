...
public class MyExamplePostRequest extends AbstractOpenApiSchema {
    ...
    public static class MyExamplePostRequestSerializer extends StdSerializer<MyExamplePostRequest> {
        public MyExamplePostRequestSerializer(Class<MyExamplePostRequest> t) {
            super(t);
        }

        public MyExamplePostRequestSerializer() {
            this(null);
        }

        @Override
        public void serialize(MyExamplePostRequest value, JsonGenerator jgen, SerializerProvider provider) throws IOException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class MyExamplePostRequestDeserializer extends StdDeserializer<MyExamplePostRequest> {
        public MyExamplePostRequestDeserializer() {
            this(MyExamplePostRequest.class);
        }

        public MyExamplePostRequestDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public MyExamplePostRequest deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException {
            ...
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for MyExamplePostRequest: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public MyExamplePostRequest getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "MyExamplePostRequest cannot be null");
        }
    }
    ...
    static {
        ...
        schemas.put("String", String.class);
        JSON.registerDescendants(MyExamplePostRequest.class, Collections.unmodifiableMap(schemas));
    }
