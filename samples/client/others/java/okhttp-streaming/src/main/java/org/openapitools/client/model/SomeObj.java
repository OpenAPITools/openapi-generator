...
public class SomeObj implements Serializable {
   ...
   * @return the SomeObj instance itself
   */
  public SomeObj putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.$type, someObj.$type) &&
        ...
        Objects.equals(this.additionalProperties, someObj.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash($type, id, name, active, type, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SomeObj.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SomeObj is not found in the empty JSON string", SomeObj.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SomeObj>() {
           ...
           public SomeObj read(JsonReader in) throws IOException {
             ...
             SomeObj instance = thisAdapter.fromJsonTree(jsonObj);
