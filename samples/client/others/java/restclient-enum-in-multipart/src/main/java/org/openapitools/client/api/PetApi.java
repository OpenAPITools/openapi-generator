...
public class PetApi {
     ...
     */
    @Deprecated
    private ResponseSpec findPetsByTagsRequestCreation(@jakarta.annotation.Nonnull List<String> tags) throws RestClientResponseException {
        Object postBody = null;
     ...
     * @throws RestClientResponseException if an error occurs while attempting to invoke the API
     */
    public List<Pet> findPetsByTags(@jakarta.annotation.Nonnull List<String> tags) throws RestClientResponseException {
        ParameterizedTypeReference<List<Pet>> localVarReturnType = new ParameterizedTypeReference<>() {};
     ...
     * @throws RestClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<List<Pet>> findPetsByTagsWithHttpInfo(@jakarta.annotation.Nonnull List<String> tags) throws RestClientResponseException {
        ParameterizedTypeReference<List<Pet>> localVarReturnType = new ParameterizedTypeReference<>() {};
     ...
     * @throws RestClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec findPetsByTagsWithResponseSpec(@jakarta.annotation.Nonnull List<String> tags) throws RestClientResponseException {
    ...
    * @see <a href="http://petstore.swagger.io/v2/doc/updatePet">Update an existing pet Documentation</a>
     */
    public Pet updatePet(@jakarta.annotation.Nonnull Pet pet) throws RestClientResponseException {
        ParameterizedTypeReference<Pet> localVarReturnType = new ParameterizedTypeReference<>() {};
        return updatePetRequestCreation(pet).body(localVarReturnType);
    }
     ...
     * @see <a href="http://petstore.swagger.io/v2/doc/updatePet">Update an existing pet Documentation</a>
     */
    public ResponseEntity<Pet> updatePetWithHttpInfo(@jakarta.annotation.Nonnull Pet pet) throws RestClientResponseException {
        ParameterizedTypeReference<Pet> localVarReturnType = new ParameterizedTypeReference<>() {};
