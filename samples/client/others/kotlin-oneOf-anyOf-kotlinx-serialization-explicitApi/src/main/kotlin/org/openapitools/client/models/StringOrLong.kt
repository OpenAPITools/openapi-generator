...
public sealed interface StringOrLong {
    @JvmInline
    public value class StringValue(public val value: kotlin.String) : StringOrLong

    @JvmInline
    public value class LongValue(public val value: kotlin.Long) : StringOrLong

}

public object StringOrLongSerializer : KSerializer<StringOrLong> {
