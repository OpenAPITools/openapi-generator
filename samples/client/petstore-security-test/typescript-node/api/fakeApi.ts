...
export class FakeApi {
     ...
     */
    public testCodeInjectEndRnNR (testCodeInjectEndRnNR?: string, options: {headerParams: {[name: string]: value}} = {headerParams: {}}) : Promise<{ response: http.ClientResponse; body?: any;  }> {
