...
export class FakeApi {
     ...
     */
    public testCodeInjectEndRnNR (testCodeInjectEndRnNR?: string, options: {headerParams: {[name: string]: string}} = {headerParams: {}}) : Promise<{ response: http.ClientResponse; body?: any;  }> {
