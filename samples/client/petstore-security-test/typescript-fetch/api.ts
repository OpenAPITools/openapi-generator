...
const BASE_PATH = "petstore.swagger.io *_/ ' \" =end -- \\r\\n \\n \\r/v2 *_/ ' \" =end -- \\r\\n \\n \\r".replace(/\/+$/, "");
...
export const FakeApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        testCodeInjectEndRnNR(UNKNOWN_BASE_TYPE?: any, options: any = {}): FetchArgs {
...
export const FakeApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        testCodeInjectEndRnNR(UNKNOWN_BASE_TYPE?: any, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
...
export const FakeApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        testCodeInjectEndRnNR(UNKNOWN_BASE_TYPE?: any, options?: any) {
...
export class FakeApi extends BaseAPI {
     ...
     * @memberof FakeApi
     */
    public testCodeInjectEndRnNR(UNKNOWN_BASE_TYPE?: any, options?: any) {
