 ...
 * 
 * @param {!API.Client.Object=} opt_UNKNOWN_BASE_TYPE 
 * @param {!angular.$http.Config=} opt_extraHttpRequestParams Extra HTTP parameters to send.
 * @return {!angular.$q.Promise}
 */
API.Client.FakeApi.prototype.testCodeInjectEndRnNR = function(opt_UNKNOWN_BASE_TYPE, opt_extraHttpRequestParams) {
  /** @const {string} */
