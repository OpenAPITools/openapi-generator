...
type TypeHolderExample struct {
	StringItem *string `json:"string_item,omitempty" xml:"string_item"`

	NumberItem *float32 `json:"number_item,omitempty" xml:"number_item"`

	IntegerItem *int32 `json:"integer_item,omitempty" xml:"integer_item"`

	BoolItem *bool `json:"bool_item,omitempty" xml:"bool_item"`

	ArrayItem *[]int32 `json:"array_item,omitempty" xml:"array_item"`
