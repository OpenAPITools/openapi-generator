...
open class PetAPI {
     ...
     */
    @discardableResult
    open class func updateImageFile(petId: Int64, imageData: URL? = nil, apiConfiguration: PetstoreClientAPIConfiguration = PetstoreClientAPIConfiguration.shared, completion: @Sendable @escaping (_ data: ApiResponse?, _ error: Error?) -> Void) -> RequestTask {
