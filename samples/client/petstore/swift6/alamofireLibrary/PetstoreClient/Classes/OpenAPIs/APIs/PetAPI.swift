...
open class PetAPI {
    ...
    @discardableResult
    open class func findPetsByTags(tags: [String], client: OpenAPIClient = OpenAPIClient.shared, completion: @Sendable @escaping (_ data: [Pet]?, _ error: Error?) -> Void) -> RequestTask {
