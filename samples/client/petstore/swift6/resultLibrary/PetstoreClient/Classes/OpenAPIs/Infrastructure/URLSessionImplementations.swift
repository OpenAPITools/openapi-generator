...
internal final class URLSessionRequestBuilderFactory: RequestBuilderFactory, Sendable {
    internal init() {}
...
internal class URLSessionDecodableRequestBuilder<T: Decodable & Sendable>: URLSessionRequestBuilder<T>, @unchecked Sendable {
...
internal protocol OpenAPIInterceptor: Sendable {
...
internal extension OpenAPIInterceptor {
    func willSendRequest<T>(urlRequest: URLRequest, urlSession: URLSessionProtocol, requestBuilder: RequestBuilder<T>) {}
...
internal final class DefaultOpenAPIInterceptor: OpenAPIInterceptor {
    public init() {}
