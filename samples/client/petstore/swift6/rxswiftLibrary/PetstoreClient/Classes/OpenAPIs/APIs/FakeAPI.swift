...
open class FakeAPI {
     ...
     */
    open class func fakeOuterBooleanSerialize(body: Bool? = nil, client: OpenAPIClient = OpenAPIClient.shared) -> Observable<Bool> {
     ...
     */
    open class func fakeOuterCompositeSerialize(body: OuterComposite? = nil, client: OpenAPIClient = OpenAPIClient.shared) -> Observable<OuterComposite> {
        return Observable.create { observer -> Disposable in
     ...
     */
    open class func fakeOuterNumberSerialize(body: Double? = nil, client: OpenAPIClient = OpenAPIClient.shared) -> Observable<Double> {
        return Observable.create { observer -> Disposable in
     ...
     */
    open class func fakeOuterStringSerialize(body: String? = nil, client: OpenAPIClient = OpenAPIClient.shared) -> Observable<String> {
        return Observable.create { observer -> Disposable in
     ...
     */
    open class func testBodyWithFileSchema(body: FileSchemaTestClass, client: OpenAPIClient = OpenAPIClient.shared) -> Observable<Void> {
        return Observable.create { observer -> Disposable in
            let requestTask = self.testBodyWithFileSchemaWithRequestBuilder(body: body, client: client).execute { result in
                switch result {
                case .success:
                    observer.onNext(())
                case let .failure(error):
    ...
    /**
     ...
     - returns: Observable<Void>
     */
    open class func testBodyWithQueryParams(query: String, body: User, client: OpenAPIClient = OpenAPIClient.shared) -> Observable<Void> {
        return Observable.create { observer -> Disposable in
            let requestTask = self.testBodyWithQueryParamsWithRequestBuilder(query: query, body: body, client: client).execute { result in
                switch result {
                case .success:
                    observer.onNext(())
                case let .failure(error):
     ...
     */
    open class func testClientModel(body: Client, client: OpenAPIClient = OpenAPIClient.shared) -> Observable<Client> {
        return Observable.create { observer -> Disposable in
            let requestTask = self.testClientModelWithRequestBuilder(body: body, client: client).execute { result in
                switch result {
                case let .success(response):
                    observer.onNext(response.body)
                case let .failure(error):
    ...
    /**
     ...
     - returns: Observable<Void>
     */
    open class func testGroupParameters(requiredStringGroup: Int, requiredBooleanGroup: Bool, requiredInt64Group: Int64, stringGroup: Int? = nil, booleanGroup: Bool? = nil, int64Group: Int64? = nil, client: OpenAPIClient = OpenAPIClient.shared) -> Observable<Void> {
        return Observable.create { observer -> Disposable in
            let requestTask = self.testGroupParametersWithRequestBuilder(requiredStringGroup: requiredStringGroup, requiredBooleanGroup: requiredBooleanGroup, requiredInt64Group: requiredInt64Group, stringGroup: stringGroup, booleanGroup: booleanGroup, int64Group: int64Group, client: client).execute { result in
                switch result {
                case .success:
                    observer.onNext(())
                case let .failure(error):
    ...
    /**
     ...
     - returns: Observable<Void>
     */
    open class func testInlineAdditionalProperties(param: [String: String], client: OpenAPIClient = OpenAPIClient.shared) -> Observable<Void> {
        return Observable.create { observer -> Disposable in
            let requestTask = self.testInlineAdditionalPropertiesWithRequestBuilder(param: param, client: client).execute { result in
                switch result {
                case .success:
                    observer.onNext(())
                case let .failure(error):
    ...
    /**
     ...
     - returns: Observable<Void>
     */
    open class func testJsonFormData(param: String, param2: String, client: OpenAPIClient = OpenAPIClient.shared) -> Observable<Void> {
        return Observable.create { observer -> Disposable in
            let requestTask = self.testJsonFormDataWithRequestBuilder(param: param, param2: param2, client: client).execute { result in
                switch result {
                case .success:
                    observer.onNext(())
                case let .failure(error):
