...
open class UserAPI {
     ...
     */
    open class func createUser(body: User, client: OpenAPIClient = OpenAPIClient.shared) -> Observable<Void> {
        return Observable.create { observer -> Disposable in
            let requestTask = self.createUserWithRequestBuilder(body: body, client: client).execute { result in
                switch result {
                case .success:
                    observer.onNext(())
    ...
    /**
     ...
     - returns: Observable<Void>
     */
    open class func createUsersWithArrayInput(body: [User], client: OpenAPIClient = OpenAPIClient.shared) -> Observable<Void> {
        return Observable.create { observer -> Disposable in
            let requestTask = self.createUsersWithArrayInputWithRequestBuilder(body: body, client: client).execute { result in
                switch result {
                case .success:
                    observer.onNext(())
                case let .failure(error):
    ...
    /**
     ...
     - returns: Observable<Void>
     */
    open class func createUsersWithListInput(body: [User], client: OpenAPIClient = OpenAPIClient.shared) -> Observable<Void> {
        return Observable.create { observer -> Disposable in
            let requestTask = self.createUsersWithListInputWithRequestBuilder(body: body, client: client).execute { result in
                switch result {
                case .success:
                    observer.onNext(())
                case let .failure(error):
    ...
    /**
     ...
     - returns: Observable<Void>
     */
    open class func deleteUser(username: String, client: OpenAPIClient = OpenAPIClient.shared) -> Observable<Void> {
        return Observable.create { observer -> Disposable in
            let requestTask = self.deleteUserWithRequestBuilder(username: username, client: client).execute { result in
                switch result {
                case .success:
                    observer.onNext(())
                case let .failure(error):
     ...
     */
    open class func getUserByName(username: String, client: OpenAPIClient = OpenAPIClient.shared) -> Observable<User> {
        return Observable.create { observer -> Disposable in
            let requestTask = self.getUserByNameWithRequestBuilder(username: username, client: client).execute { result in
                switch result {
     ...
     */
    open class func loginUser(username: String, password: String, client: OpenAPIClient = OpenAPIClient.shared) -> Observable<String> {
        return Observable.create { observer -> Disposable in
            let requestTask = self.loginUserWithRequestBuilder(username: username, password: password, client: client).execute { result in
                switch result {
                case let .success(response):
                    observer.onNext(response.body)
                case let .failure(error):
    ...
    /**
     ...
     - returns: Observable<Void>
     */
    open class func logoutUser(client: OpenAPIClient = OpenAPIClient.shared) -> Observable<Void> {
        return Observable.create { observer -> Disposable in
            let requestTask = self.logoutUserWithRequestBuilder(client: client).execute { result in
                switch result {
                case .success:
                    observer.onNext(())
                case let .failure(error):
    ...
    /**
     ...
     - returns: Observable<Void>
     */
    open class func updateUser(username: String, body: User, client: OpenAPIClient = OpenAPIClient.shared) -> Observable<Void> {
        return Observable.create { observer -> Disposable in
            let requestTask = self.updateUserWithRequestBuilder(username: username, body: body, client: client).execute { result in
                switch result {
                case .success:
                    observer.onNext(())
                case let .failure(error):
