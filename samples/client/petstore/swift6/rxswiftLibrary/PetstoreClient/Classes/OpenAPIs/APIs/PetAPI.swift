...
open class PetAPI {
     ...
     */
    open class func addPet(body: Pet, client: OpenAPIClient = OpenAPIClient.shared) -> Observable<Void> {
        return Observable.create { observer -> Disposable in
            let requestTask = self.addPetWithRequestBuilder(body: body, client: client).execute { result in
                switch result {
                case .success:
                    observer.onNext(())
    ...
    /**
     ...
     - returns: Observable<Void>
     */
    open class func deletePet(petId: Int64, apiKey: String? = nil, client: OpenAPIClient = OpenAPIClient.shared) -> Observable<Void> {
        return Observable.create { observer -> Disposable in
            let requestTask = self.deletePetWithRequestBuilder(petId: petId, apiKey: apiKey, client: client).execute { result in
                switch result {
                case .success:
                    observer.onNext(())
                case let .failure(error):
     ...
     */
    open class func findPetsByStatus(status: [Status_findPetsByStatus], client: OpenAPIClient = OpenAPIClient.shared) -> Observable<[Pet]> {
        return Observable.create { observer -> Disposable in
            let requestTask = self.findPetsByStatusWithRequestBuilder(status: status, client: client).execute { result in
                switch result {
    ...
    open class func findPetsByTags(tags: [String], client: OpenAPIClient = OpenAPIClient.shared) -> Observable<[Pet]> {
        return Observable.create { observer -> Disposable in
            let requestTask = self.findPetsByTagsWithRequestBuilder(tags: tags, client: client).execute { result in
                switch result {
                case let .success(response):
                    observer.onNext(response.body)
                case let .failure(error):
    ...
    /**
     ...
     - returns: Observable<Pet>
     */
    open class func getPetById(petId: Int64, client: OpenAPIClient = OpenAPIClient.shared) -> Observable<Pet> {
        return Observable.create { observer -> Disposable in
            let requestTask = self.getPetByIdWithRequestBuilder(petId: petId, client: client).execute { result in
                switch result {
                case let .success(response):
                    observer.onNext(response.body)
                case let .failure(error):
    ...
    /**
     ...
     - returns: Observable<Void>
     */
    open class func updatePet(body: Pet, client: OpenAPIClient = OpenAPIClient.shared) -> Observable<Void> {
        return Observable.create { observer -> Disposable in
            let requestTask = self.updatePetWithRequestBuilder(body: body, client: client).execute { result in
                switch result {
                case .success:
                    observer.onNext(())
                case let .failure(error):
    ...
    /**
     ...
     - returns: Observable<Void>
     */
    open class func updatePetWithForm(petId: Int64, name: String? = nil, status: String? = nil, client: OpenAPIClient = OpenAPIClient.shared) -> Observable<Void> {
        return Observable.create { observer -> Disposable in
            let requestTask = self.updatePetWithFormWithRequestBuilder(petId: petId, name: name, status: status, client: client).execute { result in
                switch result {
                case .success:
                    observer.onNext(())
                case let .failure(error):
     ...
     */
    open class func uploadFile(petId: Int64, additionalMetadata: String? = nil, file: URL? = nil, client: OpenAPIClient = OpenAPIClient.shared) -> Observable<ApiResponse> {
        return Observable.create { observer -> Disposable in
            let requestTask = self.uploadFileWithRequestBuilder(petId: petId, additionalMetadata: additionalMetadata, file: file, client: client).execute { result in
                switch result {
                case let .success(response):
                    observer.onNext(response.body)
                case let .failure(error):
    ...
    /**
     ...
     - returns: Observable<ApiResponse>
     */
    open class func uploadFileWithRequiredFile(petId: Int64, requiredFile: URL, additionalMetadata: String? = nil, client: OpenAPIClient = OpenAPIClient.shared) -> Observable<ApiResponse> {
        return Observable.create { observer -> Disposable in
            let requestTask = self.uploadFileWithRequiredFileWithRequestBuilder(petId: petId, requiredFile: requiredFile, additionalMetadata: additionalMetadata, client: client).execute { result in
                switch result {
                case let .success(response):
                    observer.onNext(response.body)
                case let .failure(error):
