...
open class FakeAPI {
     ...
     */
    @discardableResult
    open class func createXmlItem(xmlItem: XmlItem, client: OpenAPIClient = OpenAPIClient.shared, completion: @Sendable @escaping (_ data: Void?, _ error: Error?) -> Void) -> RequestTask {
        return createXmlItemWithRequestBuilder(xmlItem: xmlItem, client: client).execute { result in
            switch result {
            case .success:
                completion((), nil)
     ...
     */
    open class func createXmlItemWithRequestBuilder(xmlItem: XmlItem, client: OpenAPIClient = OpenAPIClient.shared) -> RequestBuilder<Void> {
     ...
     */
    @discardableResult
    open class func testQueryParameterCollectionFormat(pipe: [String], ioutil: [String], http: [String], url: [String], context: [String], client: OpenAPIClient = OpenAPIClient.shared, completion: @Sendable @escaping (_ data: Void?, _ error: Error?) -> Void) -> RequestTask {
        return testQueryParameterCollectionFormatWithRequestBuilder(pipe: pipe, ioutil: ioutil, http: http, url: url, context: context, client: client).execute { result in
            switch result {
            case .success:
                completion((), nil)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func testQueryParameterCollectionFormatWithRequestBuilder(pipe: [String], ioutil: [String], http: [String], url: [String], context: [String], client: OpenAPIClient = OpenAPIClient.shared) -> RequestBuilder<Void> {
        ...
        var localVariableUrlComponents = URLComponents(string: localVariableURLString)
        localVariableUrlComponents?.queryItems = APIHelper.mapValuesToQueryItems([
            "pipe": (wrappedValue: pipe.encodeToJSON(codableHelper: client.codableHelper), isExplode: false),
            "ioutil": (wrappedValue: ioutil.encodeToJSON(codableHelper: client.codableHelper), isExplode: false),
            "http": (wrappedValue: http.encodeToJSON(codableHelper: client.codableHelper), isExplode: false),
            "url": (wrappedValue: url.encodeToJSON(codableHelper: client.codableHelper), isExplode: false),
            "context": (wrappedValue: context.encodeToJSON(codableHelper: client.codableHelper), isExplode: true),
        ])
