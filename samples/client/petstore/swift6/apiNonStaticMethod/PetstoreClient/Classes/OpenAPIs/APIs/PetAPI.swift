...
//     */
//    open func addPet(body: Pet, client: OpenAPIClient = OpenAPIClient.shared) -> Observable<Void> {
//        return Observable.create { observer -> Disposable in
//            let requestTask = self.addPetWithRequestBuilder(body: body, client: client).execute(client) { result in
//                switch result {
//                case .success:
//                    observer.onNext(())
//                case let .failure(error):
...
//     */
//    @discardableResult
//    open func addPet(body: Pet, client: OpenAPIClient = OpenAPIClient.shared, completion: @Sendable @escaping (_ result: Swift.Result<Void, ErrorResponse>) -> Void) -> RequestTask {
//        return addPetWithRequestBuilder(body: body, client: client).execute(client) { result in
//            switch result {
//            case .success:
//                completion(.success(()))
//            case let .failure(error):
...
//     */
//    open func addPetWithRequestBuilder(body: Pet, client: OpenAPIClient = OpenAPIClient.shared) -> RequestBuilder<Void> {
...
//     - returns: Observable<Void>
//     */
//    open func deletePet(petId: Int64, apiKey: String? = nil, client: OpenAPIClient = OpenAPIClient.shared) -> Observable<Void> {
//        return Observable.create { observer -> Disposable in
//            let requestTask = self.deletePetWithRequestBuilder(petId: petId, apiKey: apiKey, client: client).execute(client) { result in
//                switch result {
//                case .success:
//                    observer.onNext(())
//                case let .failure(error):
...
//     */
//    @discardableResult
//    open func deletePet(petId: Int64, apiKey: String? = nil, client: OpenAPIClient = OpenAPIClient.shared, completion: @Sendable @escaping (_ result: Swift.Result<Void, ErrorResponse>) -> Void) -> RequestTask {
//        return deletePetWithRequestBuilder(petId: petId, apiKey: apiKey, client: client).execute(client) { result in
//            switch result {
//            case .success:
//                completion(.success(()))
//            case let .failure(error):
...
//     - returns: RequestBuilder<Void> 
//     */
//    open func deletePetWithRequestBuilder(petId: Int64, apiKey: String? = nil, client: OpenAPIClient = OpenAPIClient.shared) -> RequestBuilder<Void> {
...
//     */
//    open func findPetsByStatus(status: [Status_findPetsByStatus], client: OpenAPIClient = OpenAPIClient.shared) -> Observable<[Pet]> {
//        return Observable.create { observer -> Disposable in
//            let requestTask = self.findPetsByStatusWithRequestBuilder(status: status, client: client).execute(client) { result in
//                switch result {
//                case let .success(response):
...
//     */
//    @discardableResult
//    open func findPetsByStatus(status: [Status_findPetsByStatus], client: OpenAPIClient = OpenAPIClient.shared, completion: @Sendable @escaping (_ result: Swift.Result<[Pet], ErrorResponse>) -> Void) -> RequestTask {
//        return findPetsByStatusWithRequestBuilder(status: status, client: client).execute(client) { result in
//            switch result {
//            case let .success(response):
...
//     */
//    open func findPetsByStatusWithRequestBuilder(status: [Status_findPetsByStatus], client: OpenAPIClient = OpenAPIClient.shared) -> RequestBuilder<[Pet]> {
...
//     */
//    @available(*, deprecated, message: "This operation is deprecated.")
//    open func findPetsByTags(tags: [String], client: OpenAPIClient = OpenAPIClient.shared) -> Observable<[Pet]> {
//        return Observable.create { observer -> Disposable in
//            let requestTask = self.findPetsByTagsWithRequestBuilder(tags: tags, client: client).execute(client) { result in
//                switch result {
//                case let .success(response):
//                    observer.onNext(response.body)
//                case let .failure(error):
...
//    @available(*, deprecated, message: "This operation is deprecated.")
//    @discardableResult
//    open func findPetsByTags(tags: [String], client: OpenAPIClient = OpenAPIClient.shared, completion: @Sendable @escaping (_ result: Swift.Result<[Pet], ErrorResponse>) -> Void) -> RequestTask {
//        return findPetsByTagsWithRequestBuilder(tags: tags, client: client).execute(client) { result in
//            switch result {
//            case let .success(response):
//                completion(.success(response.body))
//            case let .failure(error):
...
//     */
//    @available(*, deprecated, message: "This operation is deprecated.")
//    open func findPetsByTagsWithRequestBuilder(tags: [String], client: OpenAPIClient = OpenAPIClient.shared) -> RequestBuilder<[Pet]> {
...
//     - returns: Observable<Pet>
//     */
//    open func getPetById(petId: Int64, client: OpenAPIClient = OpenAPIClient.shared) -> Observable<Pet> {
//        return Observable.create { observer -> Disposable in
//            let requestTask = self.getPetByIdWithRequestBuilder(petId: petId, client: client).execute(client) { result in
//                switch result {
//                case let .success(response):
//                    observer.onNext(response.body)
//                case let .failure(error):
...
//     */
//    @discardableResult
//    open func getPetById(petId: Int64, client: OpenAPIClient = OpenAPIClient.shared, completion: @Sendable @escaping (_ result: Swift.Result<Pet, ErrorResponse>) -> Void) -> RequestTask {
//        return getPetByIdWithRequestBuilder(petId: petId, client: client).execute(client) { result in
//            switch result {
//            case let .success(response):
//                completion(.success(response.body))
//            case let .failure(error):
...
//     - returns: RequestBuilder<Pet> 
//     */
//    open func getPetByIdWithRequestBuilder(petId: Int64, client: OpenAPIClient = OpenAPIClient.shared) -> RequestBuilder<Pet> {
//        var localVariablePath = "/pet/{petId}"
//        let petIdPreEscape = "\(APIHelper.mapValueToPathItem(petId))"
//        let petIdPostEscape = petIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
//        localVariablePath = localVariablePath.replacingOccurrences(of: "{petId}", with: petIdPostEscape, options: .literal, range: nil)
...
//     - returns: Observable<Void>
//     */
//    open func updatePet(body: Pet, client: OpenAPIClient = OpenAPIClient.shared) -> Observable<Void> {
//        return Observable.create { observer -> Disposable in
//            let requestTask = self.updatePetWithRequestBuilder(body: body, client: client).execute(client) { result in
//                switch result {
//                case .success:
//                    observer.onNext(())
//                case let .failure(error):
...
//     */
//    @discardableResult
//    open func updatePet(body: Pet, client: OpenAPIClient = OpenAPIClient.shared, completion: @Sendable @escaping (_ result: Swift.Result<Void, ErrorResponse>) -> Void) -> RequestTask {
//        return updatePetWithRequestBuilder(body: body, client: client).execute(client) { result in
//            switch result {
//            case .success:
//                completion(.success(()))
//            case let .failure(error):
...
//     - returns: RequestBuilder<Void> 
//     */
//    open func updatePetWithRequestBuilder(body: Pet, client: OpenAPIClient = OpenAPIClient.shared) -> RequestBuilder<Void> {
//        let localVariablePath = "/pet"
//        let localVariableURLString = client.basePath + localVariablePath
//        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: body)
//
...
//     - returns: Observable<Void>
//     */
//    open func updatePetWithForm(petId: Int64, name: String? = nil, status: String? = nil, client: OpenAPIClient = OpenAPIClient.shared) -> Observable<Void> {
//        return Observable.create { observer -> Disposable in
//            let requestTask = self.updatePetWithFormWithRequestBuilder(petId: petId, name: name, status: status, client: client).execute(client) { result in
//                switch result {
//                case .success:
//                    observer.onNext(())
//                case let .failure(error):
...
//     */
//    @discardableResult
//    open func updatePetWithForm(petId: Int64, name: String? = nil, status: String? = nil, client: OpenAPIClient = OpenAPIClient.shared, completion: @Sendable @escaping (_ result: Swift.Result<Void, ErrorResponse>) -> Void) -> RequestTask {
//        return updatePetWithFormWithRequestBuilder(petId: petId, name: name, status: status, client: client).execute(client) { result in
//            switch result {
//            case .success:
//                completion(.success(()))
//            case let .failure(error):
...
//     - returns: RequestBuilder<Void> 
//     */
//    open func updatePetWithFormWithRequestBuilder(petId: Int64, name: String? = nil, status: String? = nil, client: OpenAPIClient = OpenAPIClient.shared) -> RequestBuilder<Void> {
//        var localVariablePath = "/pet/{petId}"
//        let petIdPreEscape = "\(APIHelper.mapValueToPathItem(petId))"
//        let petIdPostEscape = petIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
//        localVariablePath = localVariablePath.replacingOccurrences(of: "{petId}", with: petIdPostEscape, options: .literal, range: nil)
...
//     */
//    open func uploadFile(petId: Int64, additionalMetadata: String? = nil, file: URL? = nil, client: OpenAPIClient = OpenAPIClient.shared) -> Observable<ApiResponse> {
//        return Observable.create { observer -> Disposable in
//            let requestTask = self.uploadFileWithRequestBuilder(petId: petId, additionalMetadata: additionalMetadata, file: file, client: client).execute(client) { result in
//                switch result {
//                case let .success(response):
//                    observer.onNext(response.body)
//                case let .failure(error):
...
//     */
//    @discardableResult
//    open func uploadFile(petId: Int64, additionalMetadata: String? = nil, file: URL? = nil, client: OpenAPIClient = OpenAPIClient.shared, completion: @Sendable @escaping (_ result: Swift.Result<ApiResponse, ErrorResponse>) -> Void) -> RequestTask {
//        return uploadFileWithRequestBuilder(petId: petId, additionalMetadata: additionalMetadata, file: file, client: client).execute(client) { result in
//            switch result {
//            case let .success(response):
//                completion(.success(response.body))
//            case let .failure(error):
...
//     */
//    open func uploadFileWithRequestBuilder(petId: Int64, additionalMetadata: String? = nil, file: URL? = nil, client: OpenAPIClient = OpenAPIClient.shared) -> RequestBuilder<ApiResponse> {
...
//     - returns: Observable<ApiResponse>
//     */
//    open func uploadFileWithRequiredFile(petId: Int64, requiredFile: URL, additionalMetadata: String? = nil, client: OpenAPIClient = OpenAPIClient.shared) -> Observable<ApiResponse> {
//        return Observable.create { observer -> Disposable in
//            let requestTask = self.uploadFileWithRequiredFileWithRequestBuilder(petId: petId, requiredFile: requiredFile, additionalMetadata: additionalMetadata, client: client).execute(client) { result in
//                switch result {
//                case let .success(response):
//                    observer.onNext(response.body)
//                case let .failure(error):
...
//     */
//    @discardableResult
//    open func uploadFileWithRequiredFile(petId: Int64, requiredFile: URL, additionalMetadata: String? = nil, client: OpenAPIClient = OpenAPIClient.shared, completion: @Sendable @escaping (_ result: Swift.Result<ApiResponse, ErrorResponse>) -> Void) -> RequestTask {
//        return uploadFileWithRequiredFileWithRequestBuilder(petId: petId, requiredFile: requiredFile, additionalMetadata: additionalMetadata, client: client).execute(client) { result in
//            switch result {
//            case let .success(response):
//                completion(.success(response.body))
//            case let .failure(error):
...
//     - returns: RequestBuilder<ApiResponse> 
//     */
//    open func uploadFileWithRequiredFileWithRequestBuilder(petId: Int64, requiredFile: URL, additionalMetadata: String? = nil, client: OpenAPIClient = OpenAPIClient.shared) -> RequestBuilder<ApiResponse> {
