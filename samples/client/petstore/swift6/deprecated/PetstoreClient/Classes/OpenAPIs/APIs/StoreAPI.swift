...
open class StoreAPI {
     ...
     */
    @discardableResult
    open class func placeOrder(order: Order, apiResponseQueue: DispatchQueue = PetstoreClientAPI.shared.apiResponseQueue, completion: @Sendable @escaping (_ data: Order?, _ error: Error?) -> Void) -> RequestTask {
