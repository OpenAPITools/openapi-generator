...
open class FakeClassnameTags123API {
     ...
     */
    open class func testClassname(body: Client, client: OpenAPIClient = OpenAPIClient.shared) -> Promise<Client> {
        let deferred = Promise<Client>.pending()
        testClassnameWithRequestBuilder(body: body, client: client).execute { result in
            switch result {
