...
open class FakeAPI {
     ...
     */
    open class func fakeOuterBooleanSerialize(body: Bool? = nil, client: OpenAPIClient = OpenAPIClient.shared) -> Promise<Bool> {
     ...
     */
    open class func fakeOuterCompositeSerialize(body: OuterComposite? = nil, client: OpenAPIClient = OpenAPIClient.shared) -> Promise<OuterComposite> {
        let deferred = Promise<OuterComposite>.pending()
        fakeOuterCompositeSerializeWithRequestBuilder(body: body, client: client).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
     ...
     */
    open class func fakeOuterNumberSerialize(body: Double? = nil, client: OpenAPIClient = OpenAPIClient.shared) -> Promise<Double> {
     ...
     */
    open class func fakeOuterStringSerialize(body: String? = nil, client: OpenAPIClient = OpenAPIClient.shared) -> Promise<String> {
     ...
     */
    open class func testBodyWithFileSchema(body: FileSchemaTestClass, client: OpenAPIClient = OpenAPIClient.shared) -> Promise<Void> {
        let deferred = Promise<Void>.pending()
        testBodyWithFileSchemaWithRequestBuilder(body: body, client: client).execute { result in
            switch result {
            case .success:
    ...
    /**
     ...
     - returns: Promise<Void>
     */
    open class func testBodyWithQueryParams(query: String, body: User, client: OpenAPIClient = OpenAPIClient.shared) -> Promise<Void> {
        let deferred = Promise<Void>.pending()
        testBodyWithQueryParamsWithRequestBuilder(query: query, body: body, client: client).execute { result in
            switch result {
            case .success:
                deferred.resolver.fulfill(())
            case let .failure(error):
     ...
     */
    open class func testClientModel(body: Client, client: OpenAPIClient = OpenAPIClient.shared) -> Promise<Client> {
        let deferred = Promise<Client>.pending()
        testClientModelWithRequestBuilder(body: body, client: client).execute { result in
            switch result {
            case let .success(response):
                deferred.resolver.fulfill(response.body)
            case let .failure(error):
    ...
    /**
     ...
     - returns: Promise<Void>
     */
    open class func testEndpointParameters(number: Double, double: Double, patternWithoutDelimiter: String, byte: Data, integer: Int? = nil, int32: Int? = nil, int64: Int64? = nil, float: Float? = nil, string: String? = nil, binary: URL? = nil, date: Date? = nil, dateTime: Date? = nil, password: String? = nil, callback: String? = nil, client: OpenAPIClient = OpenAPIClient.shared) -> Promise<Void> {
        let deferred = Promise<Void>.pending()
    ...
    /**
     ...
     - returns: Promise<Void>
     */
    open class func testEnumParameters(enumHeaderStringArray: [EnumHeaderStringArray_testEnumParameters]? = nil, enumHeaderString: EnumHeaderString_testEnumParameters? = nil, enumQueryStringArray: [EnumQueryStringArray_testEnumParameters]? = nil, enumQueryString: EnumQueryString_testEnumParameters? = nil, enumQueryInteger: EnumQueryInteger_testEnumParameters? = nil, enumQueryDouble: EnumQueryDouble_testEnumParameters? = nil, enumFormStringArray: [EnumFormStringArray_testEnumParameters]? = nil, enumFormString: EnumFormString_testEnumParameters? = nil, client: OpenAPIClient = OpenAPIClient.shared) -> Promise<Void> {
        let deferred = Promise<Void>.pending()
    ...
    /**
     ...
     - returns: Promise<Void>
     */
    open class func testGroupParameters(requiredStringGroup: Int, requiredBooleanGroup: Bool, requiredInt64Group: Int64, stringGroup: Int? = nil, booleanGroup: Bool? = nil, int64Group: Int64? = nil, client: OpenAPIClient = OpenAPIClient.shared) -> Promise<Void> {
        let deferred = Promise<Void>.pending()
        testGroupParametersWithRequestBuilder(requiredStringGroup: requiredStringGroup, requiredBooleanGroup: requiredBooleanGroup, requiredInt64Group: requiredInt64Group, stringGroup: stringGroup, booleanGroup: booleanGroup, int64Group: int64Group, client: client).execute { result in
            switch result {
            case .success:
                deferred.resolver.fulfill(())
            case let .failure(error):
    ...
    /**
     ...
     - returns: Promise<Void>
     */
    open class func testInlineAdditionalProperties(param: [String: String], client: OpenAPIClient = OpenAPIClient.shared) -> Promise<Void> {
        let deferred = Promise<Void>.pending()
        testInlineAdditionalPropertiesWithRequestBuilder(param: param, client: client).execute { result in
            switch result {
            case .success:
                deferred.resolver.fulfill(())
            case let .failure(error):
    ...
    /**
     ...
     - returns: Promise<Void>
     */
    open class func testJsonFormData(param: String, param2: String, client: OpenAPIClient = OpenAPIClient.shared) -> Promise<Void> {
        let deferred = Promise<Void>.pending()
        testJsonFormDataWithRequestBuilder(param: param, param2: param2, client: client).execute { result in
            switch result {
            case .success:
                deferred.resolver.fulfill(())
            case let .failure(error):
