...
open class PetAPI {
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func updateImageFile(petId: Int64, imageData: URL? = nil, apiConfiguration: PetstoreClientAPIConfiguration = PetstoreClientAPIConfiguration.shared) async throws(ErrorResponse) -> ApiResponse {
        return try await updateImageFileWithRequestBuilder(petId: petId, imageData: imageData, apiConfiguration: apiConfiguration).execute().body
    }
