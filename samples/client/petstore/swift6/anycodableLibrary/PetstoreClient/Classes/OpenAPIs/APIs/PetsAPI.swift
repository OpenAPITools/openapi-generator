...
open class PetsAPI {
     ...
     */
    @discardableResult
    open class func petsGet(apiResponseQueue: DispatchQueue = PetstoreClientAPI.shared.apiResponseQueue, completion: @Sendable @escaping (_ data: PrefixPetSuffix?, _ error: Error?) -> Void) -> RequestTask {
    ...
    open class func petsGetWithRequestBuilder() -> RequestBuilder<PrefixPetSuffix> {
        ...
        let localVariableRequestBuilder: RequestBuilder<PrefixPetSuffix>.Type = PetstoreClientAPI.shared.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func showPetById(petId: String, apiResponseQueue: DispatchQueue = PetstoreClientAPI.shared.apiResponseQueue, completion: @Sendable @escaping (_ data: AnyCodable?, _ error: Error?) -> Void) -> RequestTask {
    ...
    open class func showPetByIdWithRequestBuilder(petId: String) -> RequestBuilder<AnyCodable> {
        ...
        let localVariableRequestBuilder: RequestBuilder<AnyCodable>.Type = PetstoreClientAPI.shared.requestBuilderFactory.getBuilder()
