...
*OpenApiPetstore.FakeApi* | [**testMixedPropertiesAndAdditionalProperties**](docs/FakeApi.md#testMixedPropertiesAndAdditionalProperties) | **POST** /fake/body-mixedPropertiesAndAdditionalProperties | test mixed properties and additionalProperties
