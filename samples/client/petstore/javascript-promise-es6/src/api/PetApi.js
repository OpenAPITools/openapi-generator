...
export default class PetApi {
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponse} and HTTP response
     */
    uploadFileWithRequiredFileWithHttpInfo(petId, file, opts) {
      opts = opts || {};
      let postBody = null;
      ...
      if (file === undefined || file === null) {
        throw new Error("Missing the required parameter 'file' when calling uploadFileWithRequiredFile");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponse}
     */
    uploadFileWithRequiredFile(petId, file, opts) {
      return this.uploadFileWithRequiredFileWithHttpInfo(petId, file, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
