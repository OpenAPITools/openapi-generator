...
public open class ApiClient(
    ...
    public val `pet`: PetApi by lazy {
        PetApi(baseUrl, client, apiKeyAuth, basicAuth, bearerAuth, oAuth)
    }
    public val `store`: StoreApi by lazy {
        StoreApi(baseUrl, client, apiKeyAuth, basicAuth, bearerAuth, oAuth)
    }
    public val `user`: UserApi by lazy {
        UserApi(baseUrl, client, apiKeyAuth, basicAuth, bearerAuth, oAuth)
    }
