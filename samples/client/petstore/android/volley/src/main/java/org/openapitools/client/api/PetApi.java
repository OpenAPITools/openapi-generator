...
public class PetApi {
  ...
  * Multiple tags can be provided with comma separated strings. Use tag1, tag2, tag3 for testing.
   ...
   * @return List<Pet>
  */
  public List<Pet> findPetsByTags (List<String> tags, Integer maxCount) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
   ...
   * Finds Pets by tags
   * Multiple tags can be provided with comma separated strings. Use tag1, tag2, tag3 for testing.
   * @param tags Tags to filter by   * @param maxCount Maximum number of items to return
  */
  public void findPetsByTags (List<String> tags, Integer maxCount, final Response.Listener<List<Pet>> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
