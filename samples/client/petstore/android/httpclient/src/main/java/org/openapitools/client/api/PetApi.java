...
public class PetApi {
   ...
   * @return List<Pet>
   */
  public List<Pet>  findPetsByTags (List<String> tags, Integer maxCount) throws ApiException {
    Object localVarPostBody = null;
    ...
    localVarQueryParams.addAll(ApiInvoker.parameterToPairs("", "maxCount", maxCount));
