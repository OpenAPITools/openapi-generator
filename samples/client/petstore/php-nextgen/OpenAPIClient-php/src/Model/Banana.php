 ...
 */
class Banana implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'Banana';
     ...
     * @return $this
     */
    public function setLengthCm(?float $length_cm): static
    {
