 ...
 */
class Snake implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'Snake';
    ...
    {
        $this->setIfExists('venomous', $data ?? [], null);
     ...
     * @return bool|null
     */
    public function getVenomous(): ?bool
    {
        return $this->container['venomous'];
    }

    /**
     * Sets venomous
     *
     * @param bool|null $venomous venomous
     *
     * @return $this
     */
    public function setVenomous(?bool $venomous): static
    {
        if (is_null($venomous)) {
            throw new InvalidArgumentException('non-nullable venomous cannot be null');
        }
        $this->container['venomous'] = $venomous;
