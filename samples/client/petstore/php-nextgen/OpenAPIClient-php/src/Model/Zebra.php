 ...
 */
class Zebra implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'Zebra';
    ...
    public const TYPE_PLAINS = 'plains';
    public const TYPE_MOUNTAIN = 'mountain';
    public const TYPE_GREVYS = 'grevys';
