...
genTypeHolderDefault n =
  TypeHolderDefault
    <$> arbitraryReducedMaybe n -- typeHolderDefaultStringItem :: Maybe Text
    <*> arbitraryReducedMaybe n -- typeHolderDefaultNumberItem :: Maybe Float
    <*> arbitraryReducedMaybe n -- typeHolderDefaultIntegerItem :: Maybe Int
    <*> arbitraryReducedMaybe n -- typeHolderDefaultBoolItem :: Maybe Bool
    <*> arbitraryReducedMaybe n -- typeHolderDefaultDateItem :: Maybe Date
    <*> arbitraryReducedMaybe n -- typeHolderDefaultDatetimeItem :: Maybe DateTime
    <*> arbitraryReducedMaybe n -- typeHolderDefaultArrayItem :: Maybe [Int]
...
genTypeHolderExample n =
  TypeHolderExample
    <$> arbitrary -- typeHolderExampleStringItem :: E'StringItem
    <*> arbitrary -- typeHolderExampleNumberItem :: E'NumberItem
    <*> arbitrary -- typeHolderExampleIntegerItem :: E'IntegerItem
    <*> arbitrary -- typeHolderExampleBoolItem :: Bool
    <*> arbitraryReduced n -- typeHolderExampleDateItem :: E'DateItem
    <*> arbitraryReduced n -- typeHolderExampleDatetimeItem :: E'DatetimeItem
...
instance Arbitrary E'DateItem where
  arbitrary = arbitraryBoundedEnum

instance Arbitrary E'DatetimeItem where
  arbitrary = arbitraryBoundedEnum
...
instance Arbitrary E'HeaderNumber where
  arbitrary = arbitraryBoundedEnum

instance Arbitrary E'Inner where
  arbitrary = arbitraryBoundedEnum

instance Arbitrary E'IntegerItem where
  arbitrary = arbitraryBoundedEnum

instance Arbitrary E'JustSymbol where
  arbitrary = arbitraryBoundedEnum

instance Arbitrary E'NumberItem where
  arbitrary = arbitraryBoundedEnum

instance Arbitrary E'PathInteger where
  arbitrary = arbitraryBoundedEnum

instance Arbitrary E'PathString where
  arbitrary = arbitraryBoundedEnum

instance Arbitrary E'QueryInteger where
  arbitrary = arbitraryBoundedEnum

instance Arbitrary E'QueryString where
  arbitrary = arbitraryBoundedEnum
...
instance Arbitrary E'StringItem where
  arbitrary = arbitraryBoundedEnum
