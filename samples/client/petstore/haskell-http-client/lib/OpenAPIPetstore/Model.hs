...
-- ** Header1
newtype Header1 = Header1 { unHeader1 :: Text } deriving (P.Eq, P.Show)
...
-- ** Query1
newtype Query1 = Query1 { unQuery1 :: Text } deriving (P.Eq, P.Show)
...
data EnumTest = EnumTest
  ...
  , enumTestOuterEnumInteger :: !(Maybe OuterEnumInteger) -- ^ "outerEnumInteger"
  , enumTestOuterEnumDefaultValue :: !(Maybe OuterEnumDefaultValue) -- ^ "outerEnumDefaultValue"
  , enumTestOuterEnumIntegerDefaultValue :: !(Maybe OuterEnumIntegerDefaultValue) -- ^ "outerEnumIntegerDefaultValue"
  } deriving (P.Show, P.Eq, P.Typeable)
...
instance A.FromJSON EnumTest where
  parseJSON = A.withObject "EnumTest" $ \o ->
    EnumTest
      ...
      <*> (o .:? "outerEnumIntegerDefaultValue")
...
instance A.ToJSON EnumTest where
  toJSON EnumTest {..} =
   _omitNulls
      ...
      , "outerEnumInteger" .= enumTestOuterEnumInteger
      , "outerEnumDefaultValue" .= enumTestOuterEnumDefaultValue
      , "outerEnumIntegerDefaultValue" .= enumTestOuterEnumIntegerDefaultValue
      ]
...
mkEnumTest enumTestEnumStringRequired =
  ...
  , enumTestOuterEnumInteger = Nothing
  , enumTestOuterEnumDefaultValue = Nothing
  , enumTestOuterEnumIntegerDefaultValue = Nothing
  }
...
-- | Foo
data Foo = Foo
  { fooBar :: !(Maybe Text) -- ^ "bar"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON Foo
instance A.FromJSON Foo where
  parseJSON = A.withObject "Foo" $ \o ->
    Foo
      <$> (o .:? "bar")

-- | ToJSON Foo
instance A.ToJSON Foo where
  toJSON Foo {..} =
   _omitNulls
      [ "bar" .= fooBar
      ]
...
-- | Construct a value of type 'Foo' (by applying it's required fields, if any)
mkFoo
  :: Foo
mkFoo =
  Foo
...
data FormatTest = FormatTest
  ...
  , formatTestPatternWithDigits :: !(Maybe Text) -- ^ "pattern_with_digits" - A string that is a 10 digit number. Can have leading zeros.
  , formatTestPatternWithDigitsAndDelimiter :: !(Maybe Text) -- ^ "pattern_with_digits_and_delimiter" - A string starting with &#39;image_&#39; (case insensitive) and one to three digits following i.e. Image_01.
  } deriving (P.Show, P.Eq, P.Typeable)
...
instance A.FromJSON FormatTest where
  parseJSON = A.withObject "FormatTest" $ \o ->
    FormatTest
      ...
      <*> (o .:? "uuid")
      <*> (o .:  "password")
      <*> (o .:? "pattern_with_digits")
      <*> (o .:? "pattern_with_digits_and_delimiter")
...
instance A.ToJSON FormatTest where
  toJSON FormatTest {..} =
   _omitNulls
      ...
      , "pattern_with_digits" .= formatTestPatternWithDigits
      , "pattern_with_digits_and_delimiter" .= formatTestPatternWithDigitsAndDelimiter
      ]
...
mkFormatTest formatTestNumber formatTestByte formatTestDate formatTestPassword =
  ...
  , formatTestPassword
  , formatTestPatternWithDigits = Nothing
  , formatTestPatternWithDigitsAndDelimiter = Nothing
  }
...
data HealthCheckResult = HealthCheckResult
  { healthCheckResultNullableMessage :: !(Maybe Text) -- ^ "NullableMessage"
  } deriving (P.Show, P.Eq, P.Typeable)
...
instance A.ToJSON HealthCheckResult where
  toJSON HealthCheckResult {..} =
   _omitNulls
      [ "NullableMessage" .= healthCheckResultNullableMessage
      ]
...
mkHealthCheckResult =
  HealthCheckResult
  { healthCheckResultNullableMessage = Nothing
  }

-- ** InlineObject
-- | InlineObject
data InlineObject = InlineObject
  { inlineObjectName :: !(Maybe Text) -- ^ "name" - Updated name of the pet
  , inlineObjectStatus :: !(Maybe Text) -- ^ "status" - Updated status of the pet
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkInlineObject =
  ...
  , inlineObjectStatus = Nothing
  }

-- ** InlineObject1
-- | InlineObject1
data InlineObject1 = InlineObject1
  { inlineObject1AdditionalMetadata :: !(Maybe Text) -- ^ "additionalMetadata" - Additional data to pass to server
  , inlineObject1File :: !(Maybe FilePath) -- ^ "file" - file to upload
  } deriving (P.Show, P.Eq, P.Typeable)
...
instance A.ToJSON InlineObject1 where
  toJSON InlineObject1 {..} =
   _omitNulls
      [ "additionalMetadata" .= inlineObject1AdditionalMetadata
      , "file" .= inlineObject1File
      ]
...
mkInlineObject1 =
  InlineObject1
  { inlineObject1AdditionalMetadata = Nothing
  , inlineObject1File = Nothing
  }

-- ** InlineObject2
-- | InlineObject2
data InlineObject2 = InlineObject2
  { inlineObject2EnumFormStringArray :: !(Maybe [E'EnumFormStringArray]) -- ^ "enum_form_string_array" - Form parameter enum test (string array)
  , inlineObject2EnumFormString :: !(Maybe E'EnumFormString) -- ^ "enum_form_string" - Form parameter enum test (string)
  } deriving (P.Show, P.Eq, P.Typeable)
...
instance A.ToJSON InlineObject2 where
  toJSON InlineObject2 {..} =
   _omitNulls
      [ "enum_form_string_array" .= inlineObject2EnumFormStringArray
      , "enum_form_string" .= inlineObject2EnumFormString
      ]
...
mkInlineObject2 =
  InlineObject2
  { inlineObject2EnumFormStringArray = Nothing
  , inlineObject2EnumFormString = Nothing
  }

-- ** InlineObject3
-- | InlineObject3
data InlineObject3 = InlineObject3
  { inlineObject3Integer :: !(Maybe Int) -- ^ "integer" - None
  , inlineObject3Int32 :: !(Maybe Int) -- ^ "int32" - None
  , inlineObject3Int64 :: !(Maybe Integer) -- ^ "int64" - None
  , inlineObject3Number :: !(Double) -- ^ /Required/ "number" - None
  , inlineObject3Float :: !(Maybe Float) -- ^ "float" - None
  , inlineObject3Double :: !(Double) -- ^ /Required/ "double" - None
  , inlineObject3String :: !(Maybe Text) -- ^ "string" - None
  , inlineObject3PatternWithoutDelimiter :: !(Text) -- ^ /Required/ "pattern_without_delimiter" - None
  , inlineObject3Byte :: !(ByteArray) -- ^ /Required/ "byte" - None
  , inlineObject3Binary :: !(Maybe FilePath) -- ^ "binary" - None
  , inlineObject3Date :: !(Maybe Date) -- ^ "date" - None
  , inlineObject3DateTime :: !(Maybe DateTime) -- ^ "dateTime" - None
  , inlineObject3Password :: !(Maybe Text) -- ^ "password" - None
  , inlineObject3Callback :: !(Maybe Text) -- ^ "callback" - None
  } deriving (P.Show, P.Eq, P.Typeable)
...
instance A.ToJSON InlineObject3 where
  toJSON InlineObject3 {..} =
   _omitNulls
      [ "integer" .= inlineObject3Integer
      , "int32" .= inlineObject3Int32
      , "int64" .= inlineObject3Int64
      , "number" .= inlineObject3Number
      , "float" .= inlineObject3Float
      , "double" .= inlineObject3Double
      , "string" .= inlineObject3String
      , "pattern_without_delimiter" .= inlineObject3PatternWithoutDelimiter
      , "byte" .= inlineObject3Byte
      , "binary" .= inlineObject3Binary
      , "date" .= inlineObject3Date
      , "dateTime" .= inlineObject3DateTime
      , "password" .= inlineObject3Password
      , "callback" .= inlineObject3Callback
      ]


-- | Construct a value of type 'InlineObject3' (by applying it's required fields, if any)
mkInlineObject3
  :: Double -- ^ 'inlineObject3Number': None
  -> Double -- ^ 'inlineObject3Double': None
  -> Text -- ^ 'inlineObject3PatternWithoutDelimiter': None
  -> ByteArray -- ^ 'inlineObject3Byte': None
  -> InlineObject3
mkInlineObject3 inlineObject3Number inlineObject3Double inlineObject3PatternWithoutDelimiter inlineObject3Byte =
  InlineObject3
  { inlineObject3Integer = Nothing
  , inlineObject3Int32 = Nothing
  , inlineObject3Int64 = Nothing
  , inlineObject3Number
  , inlineObject3Float = Nothing
  , inlineObject3Double
  , inlineObject3String = Nothing
  , inlineObject3PatternWithoutDelimiter
  , inlineObject3Byte
  , inlineObject3Binary = Nothing
  , inlineObject3Date = Nothing
  , inlineObject3DateTime = Nothing
  , inlineObject3Password = Nothing
  , inlineObject3Callback = Nothing
  }

-- ** InlineObject4
-- | InlineObject4
data InlineObject4 = InlineObject4
  { inlineObject4Param :: !(Text) -- ^ /Required/ "param" - field1
  , inlineObject4Param2 :: !(Text) -- ^ /Required/ "param2" - field2
  } deriving (P.Show, P.Eq, P.Typeable)
...
instance A.ToJSON InlineObject4 where
  toJSON InlineObject4 {..} =
   _omitNulls
      [ "param" .= inlineObject4Param
      , "param2" .= inlineObject4Param2
      ]


-- | Construct a value of type 'InlineObject4' (by applying it's required fields, if any)
mkInlineObject4
  :: Text -- ^ 'inlineObject4Param': field1
  -> Text -- ^ 'inlineObject4Param2': field2
  -> InlineObject4
mkInlineObject4 inlineObject4Param inlineObject4Param2 =
  InlineObject4
  { inlineObject4Param
  , inlineObject4Param2
  }
...
data InlineObject5 = InlineObject5
  { inlineObject5AdditionalMetadata :: !(Maybe Text) -- ^ "additionalMetadata" - Additional data to pass to server
  , inlineObject5RequiredFile :: !(FilePath) -- ^ /Required/ "requiredFile" - file to upload
  } deriving (P.Show, P.Eq, P.Typeable)
...
instance A.ToJSON InlineObject5 where
  toJSON InlineObject5 {..} =
   _omitNulls
      [ "additionalMetadata" .= inlineObject5AdditionalMetadata
      , "requiredFile" .= inlineObject5RequiredFile
      ]


-- | Construct a value of type 'InlineObject5' (by applying it's required fields, if any)
mkInlineObject5
  :: FilePath -- ^ 'inlineObject5RequiredFile': file to upload
  -> InlineObject5
mkInlineObject5 inlineObject5RequiredFile =
  InlineObject5
  { inlineObject5AdditionalMetadata = Nothing
  , inlineObject5RequiredFile
  }

-- ** InlineResponseDefault
-- | InlineResponseDefault
data InlineResponseDefault = InlineResponseDefault
  { inlineResponseDefaultString :: !(Maybe Foo) -- ^ "string"
  } deriving (P.Show, P.Eq, P.Typeable)
...
instance A.ToJSON InlineResponseDefault where
  toJSON InlineResponseDefault {..} =
   _omitNulls
      [ "string" .= inlineResponseDefaultString
      ]
...
mkInlineResponseDefault =
  InlineResponseDefault
  { inlineResponseDefaultString = Nothing
  }
...
-- ** NullableClass
-- | NullableClass
data NullableClass = NullableClass
  { nullableClassIntegerProp :: !(Maybe Int) -- ^ "integer_prop"
  , nullableClassNumberProp :: !(Maybe Double) -- ^ "number_prop"
  , nullableClassBooleanProp :: !(Maybe Bool) -- ^ "boolean_prop"
  , nullableClassStringProp :: !(Maybe Text) -- ^ "string_prop"
  , nullableClassDateProp :: !(Maybe Date) -- ^ "date_prop"
  , nullableClassDatetimeProp :: !(Maybe DateTime) -- ^ "datetime_prop"
  , nullableClassArrayNullableProp :: !(Maybe [A.Value]) -- ^ "array_nullable_prop"
  , nullableClassArrayAndItemsNullableProp :: !(Maybe [A.Value]) -- ^ "array_and_items_nullable_prop"
  , nullableClassArrayItemsNullable :: !(Maybe [A.Value]) -- ^ "array_items_nullable"
  , nullableClassObjectNullableProp :: !(Maybe (Map.Map String A.Value)) -- ^ "object_nullable_prop"
  , nullableClassObjectAndItemsNullableProp :: !(Maybe (Map.Map String A.Value)) -- ^ "object_and_items_nullable_prop"
  , nullableClassObjectItemsNullable :: !(Maybe (Map.Map String A.Value)) -- ^ "object_items_nullable"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON NullableClass
instance A.FromJSON NullableClass where
  parseJSON = A.withObject "NullableClass" $ \o ->
    NullableClass
      <$> (o .:? "integer_prop")
      <*> (o .:? "number_prop")
      <*> (o .:? "boolean_prop")
      ...
      <*> (o .:? "date_prop")
      <*> (o .:? "datetime_prop")
      <*> (o .:? "array_nullable_prop")
      <*> (o .:? "array_and_items_nullable_prop")
      <*> (o .:? "array_items_nullable")
      <*> (o .:? "object_nullable_prop")
      <*> (o .:? "object_and_items_nullable_prop")
      <*> (o .:? "object_items_nullable")

-- | ToJSON NullableClass
instance A.ToJSON NullableClass where
  toJSON NullableClass {..} =
   _omitNulls
      [ "integer_prop" .= nullableClassIntegerProp
      , "number_prop" .= nullableClassNumberProp
      , "boolean_prop" .= nullableClassBooleanProp
      , "string_prop" .= nullableClassStringProp
      , "date_prop" .= nullableClassDateProp
      , "datetime_prop" .= nullableClassDatetimeProp
      , "array_nullable_prop" .= nullableClassArrayNullableProp
      , "array_and_items_nullable_prop" .= nullableClassArrayAndItemsNullableProp
      , "array_items_nullable" .= nullableClassArrayItemsNullable
      , "object_nullable_prop" .= nullableClassObjectNullableProp
      , "object_and_items_nullable_prop" .= nullableClassObjectAndItemsNullableProp
      , "object_items_nullable" .= nullableClassObjectItemsNullable
      ]


-- | Construct a value of type 'NullableClass' (by applying it's required fields, if any)
mkNullableClass
  :: NullableClass
mkNullableClass =
  NullableClass
  { nullableClassIntegerProp = Nothing
  , nullableClassNumberProp = Nothing
  , nullableClassBooleanProp = Nothing
  , nullableClassStringProp = Nothing
  , nullableClassDateProp = Nothing
  , nullableClassDatetimeProp = Nothing
  , nullableClassArrayNullableProp = Nothing
  , nullableClassArrayAndItemsNullableProp = Nothing
  , nullableClassArrayItemsNullable = Nothing
  , nullableClassObjectNullableProp = Nothing
  , nullableClassObjectAndItemsNullableProp = Nothing
  , nullableClassObjectItemsNullable = Nothing
  }
...
-- | Enum of 'Text'
data OuterEnumDefaultValue
  = OuterEnumDefaultValue'Placed -- ^ @"placed"@
  | OuterEnumDefaultValue'Approved -- ^ @"approved"@
  | OuterEnumDefaultValue'Delivered -- ^ @"delivered"@
  deriving (P.Show, P.Eq, P.Typeable, P.Ord, P.Bounded, P.Enum)

instance A.ToJSON OuterEnumDefaultValue where toJSON = A.toJSON . fromOuterEnumDefaultValue
instance A.FromJSON OuterEnumDefaultValue where parseJSON o = P.either P.fail (pure . P.id) . toOuterEnumDefaultValue =<< A.parseJSON o
instance WH.ToHttpApiData OuterEnumDefaultValue where toQueryParam = WH.toQueryParam . fromOuterEnumDefaultValue
instance WH.FromHttpApiData OuterEnumDefaultValue where parseQueryParam o = WH.parseQueryParam o >>= P.left T.pack . toOuterEnumDefaultValue
instance MimeRender MimeMultipartFormData OuterEnumDefaultValue where mimeRender _ = mimeRenderDefaultMultipartFormData

-- | unwrap 'OuterEnumDefaultValue' enum
fromOuterEnumDefaultValue :: OuterEnumDefaultValue -> Text
fromOuterEnumDefaultValue = \case
  OuterEnumDefaultValue'Placed -> "placed"
  OuterEnumDefaultValue'Approved -> "approved"
  OuterEnumDefaultValue'Delivered -> "delivered"

-- | parse 'OuterEnumDefaultValue' enum
toOuterEnumDefaultValue :: Text -> P.Either String OuterEnumDefaultValue
toOuterEnumDefaultValue = \case
  "placed" -> P.Right OuterEnumDefaultValue'Placed
  "approved" -> P.Right OuterEnumDefaultValue'Approved
  "delivered" -> P.Right OuterEnumDefaultValue'Delivered
  s -> P.Left $ "toOuterEnumDefaultValue: enum parse failure: " P.++ P.show s


-- ** OuterEnumInteger

-- | Enum of 'Int'
data OuterEnumInteger
  = OuterEnumInteger'Num0 -- ^ @0@
  | OuterEnumInteger'Num1 -- ^ @1@
  | OuterEnumInteger'Num2 -- ^ @2@
  deriving (P.Show, P.Eq, P.Typeable, P.Ord, P.Bounded, P.Enum)

instance A.ToJSON OuterEnumInteger where toJSON = A.toJSON . fromOuterEnumInteger
instance A.FromJSON OuterEnumInteger where parseJSON o = P.either P.fail (pure . P.id) . toOuterEnumInteger =<< A.parseJSON o
instance WH.ToHttpApiData OuterEnumInteger where toQueryParam = WH.toQueryParam . fromOuterEnumInteger
instance WH.FromHttpApiData OuterEnumInteger where parseQueryParam o = WH.parseQueryParam o >>= P.left T.pack . toOuterEnumInteger
instance MimeRender MimeMultipartFormData OuterEnumInteger where mimeRender _ = mimeRenderDefaultMultipartFormData

-- | unwrap 'OuterEnumInteger' enum
fromOuterEnumInteger :: OuterEnumInteger -> Int
fromOuterEnumInteger = \case
  OuterEnumInteger'Num0 -> 0
  OuterEnumInteger'Num1 -> 1
  OuterEnumInteger'Num2 -> 2

-- | parse 'OuterEnumInteger' enum
toOuterEnumInteger :: Int -> P.Either String OuterEnumInteger
toOuterEnumInteger = \case
  0 -> P.Right OuterEnumInteger'Num0
  1 -> P.Right OuterEnumInteger'Num1
  2 -> P.Right OuterEnumInteger'Num2
  s -> P.Left $ "toOuterEnumInteger: enum parse failure: " P.++ P.show s


-- ** OuterEnumIntegerDefaultValue

-- | Enum of 'Int'
data OuterEnumIntegerDefaultValue
  = OuterEnumIntegerDefaultValue'Num0 -- ^ @0@
  | OuterEnumIntegerDefaultValue'Num1 -- ^ @1@
  | OuterEnumIntegerDefaultValue'Num2 -- ^ @2@
  deriving (P.Show, P.Eq, P.Typeable, P.Ord, P.Bounded, P.Enum)

instance A.ToJSON OuterEnumIntegerDefaultValue where toJSON = A.toJSON . fromOuterEnumIntegerDefaultValue
instance A.FromJSON OuterEnumIntegerDefaultValue where parseJSON o = P.either P.fail (pure . P.id) . toOuterEnumIntegerDefaultValue =<< A.parseJSON o
instance WH.ToHttpApiData OuterEnumIntegerDefaultValue where toQueryParam = WH.toQueryParam . fromOuterEnumIntegerDefaultValue
instance WH.FromHttpApiData OuterEnumIntegerDefaultValue where parseQueryParam o = WH.parseQueryParam o >>= P.left T.pack . toOuterEnumIntegerDefaultValue
instance MimeRender MimeMultipartFormData OuterEnumIntegerDefaultValue where mimeRender _ = mimeRenderDefaultMultipartFormData

-- | unwrap 'OuterEnumIntegerDefaultValue' enum
fromOuterEnumIntegerDefaultValue :: OuterEnumIntegerDefaultValue -> Int
fromOuterEnumIntegerDefaultValue = \case
  OuterEnumIntegerDefaultValue'Num0 -> 0
  OuterEnumIntegerDefaultValue'Num1 -> 1
  OuterEnumIntegerDefaultValue'Num2 -> 2

-- | parse 'OuterEnumIntegerDefaultValue' enum
toOuterEnumIntegerDefaultValue :: Int -> P.Either String OuterEnumIntegerDefaultValue
toOuterEnumIntegerDefaultValue = \case
  0 -> P.Right OuterEnumIntegerDefaultValue'Num0
  1 -> P.Right OuterEnumIntegerDefaultValue'Num1
  2 -> P.Right OuterEnumIntegerDefaultValue'Num2
  s -> P.Left $ "toOuterEnumIntegerDefaultValue: enum parse failure: " P.++ P.show s
...
-- ** AuthBasicBearerTest
data AuthBasicBearerTest =
  AuthBasicBearerTest B.ByteString B.ByteString -- ^ username password
  deriving (P.Eq, P.Show, P.Typeable)

instance AuthMethod AuthBasicBearerTest where
  applyAuthMethod _ a@(AuthBasicBearerTest user pw) req =
    P.pure $
    if (P.typeOf a `P.elem` rAuthTypes req)
...
-- ** AuthBasicHttpSignatureTest
data AuthBasicHttpSignatureTest =
  AuthBasicHttpSignatureTest B.ByteString B.ByteString -- ^ username password
  deriving (P.Eq, P.Show, P.Typeable)

instance AuthMethod AuthBasicHttpSignatureTest where
  applyAuthMethod _ a@(AuthBasicHttpSignatureTest user pw) req =
    P.pure $
    if (P.typeOf a `P.elem` rAuthTypes req)
      then req `setHeader` toHeader ("Authorization", T.decodeUtf8 cred)
           & L.over rAuthTypesL (P.filter (/= P.typeOf a))
