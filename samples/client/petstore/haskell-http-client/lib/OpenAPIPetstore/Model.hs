...
-- ** EnumQueryInteger
newtype EnumQueryInteger = EnumQueryInteger { unEnumQueryInteger :: E'EnumInteger } deriving (P.Eq, P.Show)
...
toE'EnumInteger = \case
  ...
  null -> P.Right E'EnumInteger'Numnull
