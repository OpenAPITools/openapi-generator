#tag Module
Protected Module XojoOpenAPIClientSynchronous
		...
		Private Function LocalFuncSerializeFile(Extends file As FolderItem) As String
		  If file <> Nil Then
		    ...
		    Catch e As IOException
		      Dim error As New XojoOpenAPIClientSynchronous.XojoOpenAPIClientSynchronousException(kErrorFileWrite, e.Message)
