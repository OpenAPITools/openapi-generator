...
open class FakeAPI {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func testMixedPropertiesAndAdditionalProperties(param: MixedPropertiesAndAdditionalPropertiesClass, completion: @escaping ((_ data: MixedPropertiesAndAdditionalPropertiesClass?,_ error: Error?) -> Void)) {
    ...
    open class func testMixedPropertiesAndAdditionalPropertiesWithRequestBuilder(param: MixedPropertiesAndAdditionalPropertiesClass) -> RequestBuilder<MixedPropertiesAndAdditionalPropertiesClass> {
        ...
        let requestBuilder: RequestBuilder<MixedPropertiesAndAdditionalPropertiesClass>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
