...
open class StoreAPI {
     ...
     */
    open class func deleteOrder( orderId: String, queue: DispatchQueue? = nil) -> Promise<Void> {
     ...
     */
    open class func getInventory(queue: DispatchQueue? = nil) -> Promise<[String:Int]> {
     ...
     */
    open class func getOrderById( orderId: Int64, queue: DispatchQueue? = nil) -> Promise<Order> {
    ...
    /**
     ...
     - returns: Promise<Order>
     */
    open class func placeOrder( order: Order, queue: DispatchQueue? = nil) -> Promise<Order> {
        let deferred = Promise<Order>.pending()
