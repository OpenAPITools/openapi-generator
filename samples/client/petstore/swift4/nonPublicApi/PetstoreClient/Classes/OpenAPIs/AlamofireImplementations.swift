...
internal class AlamofireRequestBuilder<T>: RequestBuilder<T> {
    ...
    /**
     ...
     configuration.
     */
    internal func createSessionManager() -> Alamofire.SessionManager {
     ...
     */
    internal func makeRequest(manager: SessionManager, method: HTTPMethod, encoding: ParameterEncoding, headers: [String: String]) -> DataRequest {
        return manager.request(URLString, method: method, parameters: parameters, encoding: encoding, headers: headers)
    }

    override internal func execute(_ completion: @escaping (_ response: Response<T>?, _ error: Error?) -> Void) {
