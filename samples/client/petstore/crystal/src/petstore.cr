...
require "./petstore/connection"
require "./petstore/response"
require "./petstore/api_error"
require "./petstore/client"
require "./petstore/serializable"
require "./petstore/validation"
...
require "./petstore/models/model_client"
...
# APIs
require "./petstore/api/another_fake"
require "./petstore/api/fake"
require "./petstore/api/fake_classname_test"
require "./petstore/api/foo"
require "./petstore/api/pet"
require "./petstore/api/store"
require "./petstore/api/store/order"
require "./petstore/api/user"
