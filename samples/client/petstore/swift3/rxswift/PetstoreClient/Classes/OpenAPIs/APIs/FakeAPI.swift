...
open class FakeAPI: APIBase {
     ...
     */
    open class func createXmlItem(xmlItem: XmlItem, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
    ...
    open class func createXmlItem(xmlItem: XmlItem) -> Observable<Void> {
        return Observable.create { observer -> Disposable in
            createXmlItem(xmlItem: xmlItem) { error in
                if let error = error {
    ...
    open class func createXmlItemWithRequestBuilder(xmlItem: XmlItem) -> RequestBuilder<Void> {
        ...
        let parameters = xmlItem.encodeToJSON()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func testBodyWithFileSchema(body: FileSchemaTestClass, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
    ...
    open class func testBodyWithFileSchema(body: FileSchemaTestClass) -> Observable<Void> {
        return Observable.create { observer -> Disposable in
            testBodyWithFileSchema(body: body) { error in
                if let error = error {
                    observer.on(.error(error as Error))
                } else {
                    observer.on(.next())
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func testBodyWithQueryParams(query: String, body: User, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
    ...
    open class func testBodyWithQueryParams(query: String, body: User) -> Observable<Void> {
        return Observable.create { observer -> Disposable in
            testBodyWithQueryParams(query: query, body: body) { error in
                if let error = error {
                    observer.on(.error(error as Error))
                } else {
                    observer.on(.next())
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func testEnumParameters(enumHeaderStringArray: [String]? = nil, enumHeaderString: EnumHeaderString_testEnumParameters? = nil, enumQueryStringArray: [String]? = nil, enumQueryString: EnumQueryString_testEnumParameters? = nil, enumQueryInteger: EnumQueryInteger_testEnumParameters? = nil, enumQueryDouble: EnumQueryDouble_testEnumParameters? = nil, enumFormStringArray: [String]? = nil, enumFormString: EnumFormString_testEnumParameters? = nil, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func testGroupParameters(requiredStringGroup: Int32, requiredBooleanGroup: Bool, requiredInt64Group: Int64, stringGroup: Int32? = nil, booleanGroup: Bool? = nil, int64Group: Int64? = nil, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - returns: Observable<Void>
     */
    open class func testGroupParameters(requiredStringGroup: Int32, requiredBooleanGroup: Bool, requiredInt64Group: Int64, stringGroup: Int32? = nil, booleanGroup: Bool? = nil, int64Group: Int64? = nil) -> Observable<Void> {
        return Observable.create { observer -> Disposable in
            testGroupParameters(requiredStringGroup: requiredStringGroup, requiredBooleanGroup: requiredBooleanGroup, requiredInt64Group: requiredInt64Group, stringGroup: stringGroup, booleanGroup: booleanGroup, int64Group: int64Group) { error in
                if let error = error {
                    observer.on(.error(error as Error))
                } else {
                    observer.on(.next())
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func testGroupParametersWithRequestBuilder(requiredStringGroup: Int32, requiredBooleanGroup: Bool, requiredInt64Group: Int64, stringGroup: Int32? = nil, booleanGroup: Bool? = nil, int64Group: Int64? = nil) -> RequestBuilder<Void> {
        let path = "/fake"
        let URLString = PetstoreClientAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func testInlineAdditionalProperties(param: [String:String], completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func testMixedPropertiesAndAdditionalProperties(param: MixedPropertiesAndAdditionalPropertiesClass, completion: @escaping ((_ data: MixedPropertiesAndAdditionalPropertiesClass?, _ error: ErrorResponse?) -> Void)) {
    ...
    open class func testMixedPropertiesAndAdditionalProperties(param: MixedPropertiesAndAdditionalPropertiesClass) -> Observable<MixedPropertiesAndAdditionalPropertiesClass> {
        return Observable.create { observer -> Disposable in
            testMixedPropertiesAndAdditionalProperties(param: param) { data, error in
                if let error = error {
                    observer.on(.error(error as Error))
                } else {
                    observer.on(.next(data!))
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func testQueryParameterCollectionFormat(pipe: [String], ioutil: [String], http: [String], url: [String], context: [String], completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
    ...
    open class func testQueryParameterCollectionFormat(pipe: [String], ioutil: [String], http: [String], url: [String], context: [String]) -> Observable<Void> {
        return Observable.create { observer -> Disposable in
            testQueryParameterCollectionFormat(pipe: pipe, ioutil: ioutil, http: http, url: url, context: context) { error in
                if let error = error {
                    observer.on(.error(error as Error))
                } else {
                    observer.on(.next())
