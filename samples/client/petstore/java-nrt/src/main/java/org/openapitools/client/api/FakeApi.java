...
public class FakeApi {
     ...
     * @param requiredStringUuid Required UUID String (required)
     ...
     */
    public okhttp3.Call fakeOuterStringSerializeCall(UUID requiredStringUuid, String body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        if (requiredStringUuid != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("required_string_uuid", requiredStringUuid));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call fakeOuterStringSerializeValidateBeforeCall(UUID requiredStringUuid, String body, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'requiredStringUuid' is set
        if (requiredStringUuid == null) {
            throw new ApiException("Missing the required parameter 'requiredStringUuid' when calling fakeOuterStringSerialize(Async)");
        }

        return fakeOuterStringSerializeCall(requiredStringUuid, body, _callback);
     ...
     */
    public String fakeOuterStringSerialize(UUID requiredStringUuid, String body) throws ApiException {
        ApiResponse<String> localVarResp = fakeOuterStringSerializeWithHttpInfo(requiredStringUuid, body);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<String> fakeOuterStringSerializeWithHttpInfo(UUID requiredStringUuid, String body) throws ApiException {
        okhttp3.Call localVarCall = fakeOuterStringSerializeValidateBeforeCall(requiredStringUuid, body, null);
     ...
     */
    public okhttp3.Call fakeOuterStringSerializeAsync(UUID requiredStringUuid, String body, final ApiCallback<String> _callback) throws ApiException {

        okhttp3.Call localVarCall = fakeOuterStringSerializeValidateBeforeCall(requiredStringUuid, body, _callback);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param requiredNotNullable  (required)
     * @param requiredNullable  (required)
     * @param notRequiredNotNullable  (optional)
     * @param notRequiredNullable  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    public okhttp3.Call testQueryParameterCollectionFormatCall(List<String> pipe, List<String> ioutil, List<String> http, List<String> url, List<String> context, String requiredNotNullable, String requiredNullable, String notRequiredNotNullable, String notRequiredNullable, final ApiCallback _callback) throws ApiException {
        ...
        if (requiredNotNullable != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("requiredNotNullable", requiredNotNullable));
        }

        if (requiredNullable != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("requiredNullable", requiredNullable));
        }

        if (notRequiredNotNullable != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("notRequiredNotNullable", notRequiredNotNullable));
        }

        if (notRequiredNullable != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("notRequiredNullable", notRequiredNullable));
        }
    ...
    private okhttp3.Call testQueryParameterCollectionFormatValidateBeforeCall(List<String> pipe, List<String> ioutil, List<String> http, List<String> url, List<String> context, String requiredNotNullable, String requiredNullable, String notRequiredNotNullable, String notRequiredNullable, final ApiCallback _callback) throws ApiException {
        ...
        if (requiredNotNullable == null) {
            throw new ApiException("Missing the required parameter 'requiredNotNullable' when calling testQueryParameterCollectionFormat(Async)");
        }

        // verify the required parameter 'requiredNullable' is set
        if (requiredNullable == null) {
            throw new ApiException("Missing the required parameter 'requiredNullable' when calling testQueryParameterCollectionFormat(Async)");
        }

        return testQueryParameterCollectionFormatCall(pipe, ioutil, http, url, context, requiredNotNullable, requiredNullable, notRequiredNotNullable, notRequiredNullable, _callback);
     ...
     */
    public void testQueryParameterCollectionFormat(List<String> pipe, List<String> ioutil, List<String> http, List<String> url, List<String> context, String requiredNotNullable, String requiredNullable, String notRequiredNotNullable, String notRequiredNullable) throws ApiException {
     ...
     */
    public ApiResponse<Void> testQueryParameterCollectionFormatWithHttpInfo(List<String> pipe, List<String> ioutil, List<String> http, List<String> url, List<String> context, String requiredNotNullable, String requiredNullable, String notRequiredNotNullable, String notRequiredNullable) throws ApiException {
        okhttp3.Call localVarCall = testQueryParameterCollectionFormatValidateBeforeCall(pipe, ioutil, http, url, context, requiredNotNullable, requiredNullable, notRequiredNotNullable, notRequiredNullable, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call testQueryParameterCollectionFormatAsync(List<String> pipe, List<String> ioutil, List<String> http, List<String> url, List<String> context, String requiredNotNullable, String requiredNullable, String notRequiredNotNullable, String notRequiredNullable, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = testQueryParameterCollectionFormatValidateBeforeCall(pipe, ioutil, http, url, context, requiredNotNullable, requiredNullable, notRequiredNotNullable, notRequiredNullable, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
