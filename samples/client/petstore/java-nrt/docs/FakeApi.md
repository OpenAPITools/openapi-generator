...
> String fakeOuterStringSerialize(requiredStringUuid, body)
...
public class Example {
  public static void main(String[] args) {
    ...
    FakeApi apiInstance = new FakeApi(defaultClient);
    UUID requiredStringUuid = UUID.randomUUID(); // UUID | Required UUID String
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **requiredStringUuid** | **UUID**| Required UUID String | |
...
> testQueryParameterCollectionFormat(pipe, ioutil, http, url, context, requiredNotNullable, requiredNullable, notRequiredNotNullable, notRequiredNullable)
...
public class Example {
  public static void main(String[] args) {
    ...
    String requiredNotNullable = "requiredNotNullable_example"; // String | 
    String requiredNullable = "requiredNullable_example"; // String | 
    String notRequiredNotNullable = "notRequiredNotNullable_example"; // String | 
    String notRequiredNullable = "notRequiredNullable_example"; // String | 
    try {
