...
module Petstore
  class FakeApi
    ...
    # @return [nil]
    def fake_unsupported_scheme_test(pet, opts = {})
      fake_unsupported_scheme_test_with_http_info(pet, opts)
      nil
    end
    ...
    def fake_unsupported_scheme_test_with_http_info(pet, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FakeApi.fake_unsupported_scheme_test ...'
      end
      # verify the required parameter 'pet' is set
      if @api_client.config.client_side_validation && pet.nil?
        fail ArgumentError, "Missing the required parameter 'pet' when calling FakeApi.fake_unsupported_scheme_test"
      end
      # resource path
      local_var_path = '/fake/unsupported-scheme-test'
      ...
      # auth_names
      auth_names = opts[:debug_auth_names] || ['unsupported_test']

      new_options = opts.merge(
        :operation => :"FakeApi.fake_unsupported_scheme_test",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FakeApi#fake_unsupported_scheme_test\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
