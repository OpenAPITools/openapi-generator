...
module Petstore
  class FakeApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [File]
    def file_response_test(opts = {})
      data, _status_code, _headers = file_response_test_with_http_info(opts)
      data
    end

    # @param [Hash] opts the optional parameters
    # @return [Array<(File, Integer, Hash)>] File data, response status code and response headers
    def file_response_test_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FakeApi.file_response_test ...'
      end
      # resource path
      local_var_path = '/fake/fileResponseTest'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FakeApi#file_response_test\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
