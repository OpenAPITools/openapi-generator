...
# Unit tests for Petstore::TestEndpointParametersBody
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Petstore::TestEndpointParametersBody do
  let(:instance) { Petstore::TestEndpointParametersBody.new }

  describe 'test an instance of TestEndpointParametersBody' do
    it 'should create an instance of TestEndpointParametersBody' do
      expect(instance).to be_instance_of(Petstore::TestEndpointParametersBody)
    end
  end
