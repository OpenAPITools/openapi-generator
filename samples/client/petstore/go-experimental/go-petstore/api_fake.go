...
/*
TestMixedPropertiesAndAdditionalProperties test mixed properties and additionalProperties
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param param request body
@return MixedPropertiesAndAdditionalPropertiesClass
*/
func (a *FakeApiService) TestMixedPropertiesAndAdditionalProperties(ctx _context.Context, param MixedPropertiesAndAdditionalPropertiesClass) (MixedPropertiesAndAdditionalPropertiesClass, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  MixedPropertiesAndAdditionalPropertiesClass
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/fake/body-mixedPropertiesAndAdditionalProperties"
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v MixedPropertiesAndAdditionalPropertiesClass
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
