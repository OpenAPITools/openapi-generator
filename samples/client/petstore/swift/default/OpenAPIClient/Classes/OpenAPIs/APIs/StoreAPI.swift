...
public class StoreAPI: APIBase {
    ...
    public class func getInventoryWithRequestBuilder() -> RequestBuilder<[String:Int32]> {
        ...
        let requestBuilder: RequestBuilder<[String:Int32]>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
  ...
  <complete>true</complete>
    ...
    public class func getOrderByIdWithRequestBuilder(orderId orderId: Int64) -> RequestBuilder<Order> {
        ...
        let requestBuilder: RequestBuilder<Order>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
