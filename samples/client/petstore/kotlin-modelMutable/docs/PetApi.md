...
# **findPetsByStatus**
> MutableList&lt;Pet&gt; findPetsByStatus(status)
...
val apiInstance = PetApi()
val status : MutableList<String> =  // MutableList<String> | Status values that need to be considered for filter
try {
    val result : MutableList<Pet> = apiInstance.findPetsByStatus(status)
    println(result)
} catch (e: ClientException) {
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **status** | [**MutableList&lt;String&gt;**](String.md)| Status values that need to be considered for filter | [enum: available, pending, sold] |

### Return type

[**MutableList&lt;Pet&gt;**](Pet.md)
...
# **findPetsByTags**
> MutableList&lt;Pet&gt; findPetsByTags(tags)
...
val apiInstance = PetApi()
val tags : MutableList<String> =  // MutableList<String> | Tags to filter by
try {
    val result : MutableList<Pet> = apiInstance.findPetsByTags(tags)
    println(result)
} catch (e: ClientException) {
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **tags** | [**MutableList&lt;String&gt;**](String.md)| Tags to filter by | |
