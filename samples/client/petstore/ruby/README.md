...
*Petstore::PetApi* | [**replace_file_with_required_file**](docs/PetApi.md#replace_file_with_required_file) | **PUT** /fake/{petId}/uploadImageWithRequiredFile | replaces an image (required)
