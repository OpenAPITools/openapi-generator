...
module Petstore
  class PetApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [File]
    def get_pet_by_id_download(pet_id, opts = {})
      data, _status_code, _headers = get_pet_by_id_download_with_http_info(pet_id, opts)
      data
    end
    ...
    def get_pet_by_id_download_with_http_info(pet_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PetApi.get_pet_by_id_download ...'
      end
      # verify the required parameter 'pet_id' is set
      if @api_client.config.client_side_validation && pet_id.nil?
        fail ArgumentError, "Missing the required parameter 'pet_id' when calling PetApi.get_pet_by_id_download"
      end
      # resource path
      local_var_path = '/pet/{petId}?download'.sub('{' + 'petId' + '}', CGI.escape(pet_id.to_s).gsub('%2F', '/'))
      ...
      new_options = opts.merge(
        :operation => :"PetApi.get_pet_by_id_download",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PetApi#get_pet_by_id_download\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
