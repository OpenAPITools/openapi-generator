...
module Petstore
  class DefaultApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(FooInlineResponseDefault, Integer, Hash)>] FooInlineResponseDefault data, response status code and response headers
    def foo_get_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'FooInlineResponseDefault'
