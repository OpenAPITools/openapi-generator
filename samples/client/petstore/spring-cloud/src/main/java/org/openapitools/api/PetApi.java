...
public interface PetApi {
    ...
    com.netflix.hystrix.HystrixCommand<ResponseEntity<Void>> deletePet( @ApiParam(value = "Pet id to delete", required=true, example="56") @PathVariable("petId") Long petId, @ApiParam(value = "", example="apiKey_example") @RequestHeader(value="api_key", required=false) String apiKey);
    ...
    com.netflix.hystrix.HystrixCommand<ResponseEntity<List<Pet>>> findPetsByStatus(@NotNull  @ApiParam(value = "Status values that need to be considered for filter", required=true, allowableValues = "\"available\", \"pending\", \"sold\"", example="[\"available\"]") @Valid @RequestParam(value = "status", required = true) List<String> status);
    ...
    com.netflix.hystrix.HystrixCommand<ResponseEntity<List<Pet>>> findPetsByTags(@NotNull  @ApiParam(value = "Tags to filter by", required=true, example="[]") @Valid @RequestParam(value = "tags", required = true) List<String> tags);
    ...
    com.netflix.hystrix.HystrixCommand<ResponseEntity<Pet>> getPetById( @ApiParam(value = "ID of pet to return", required=true, example="56") @PathVariable("petId") Long petId);
    ...
    com.netflix.hystrix.HystrixCommand<ResponseEntity<Void>> updatePetWithForm( @ApiParam(value = "ID of pet that needs to be updated", required=true, example="56") @PathVariable("petId") Long petId,@ApiParam(value = "Updated name of the pet" ) @RequestParam(value="name", required=false)  String name,@ApiParam(value = "Updated status of the pet" ) @RequestParam(value="status", required=false)  String status);
    ...
    com.netflix.hystrix.HystrixCommand<ResponseEntity<ModelApiResponse>> uploadFile( @ApiParam(value = "ID of pet to update", required=true, example="56") @PathVariable("petId") Long petId,@ApiParam(value = "Additional data to pass to server" ) @RequestParam(value="additionalMetadata", required=false)  String additionalMetadata,@ApiParam(value = "file to upload") @RequestParam("file") MultipartFile file);
