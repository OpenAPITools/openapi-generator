...
public interface PetApi {
    ...
    com.netflix.hystrix.HystrixCommand<ResponseEntity<Void>> addPet(@Parameter(description = "Pet object that needs to be added to the store" ,required=true )  @Valid @RequestBody Pet body);
    ...
    com.netflix.hystrix.HystrixCommand<ResponseEntity<Void>> updatePet(@Parameter(description = "Pet object that needs to be added to the store" ,required=true )  @Valid @RequestBody Pet body);
