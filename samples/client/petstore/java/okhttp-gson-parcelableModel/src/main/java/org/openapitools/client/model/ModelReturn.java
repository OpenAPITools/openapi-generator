...
public class ModelReturn implements Parcelable {
  ...
  @SerializedName(SERIALIZED_NAME_RETURN) private Integer _return;
  ...
  public void writeToParcel(Parcel out, int flags) { out.writeValue(_return); }

  ModelReturn(Parcel in) { _return = (Integer)in.readValue(null); }

  public int describeContents() { return 0; }

  public static final Parcelable.Creator<ModelReturn> CREATOR =
      new Parcelable.Creator<ModelReturn>() {
