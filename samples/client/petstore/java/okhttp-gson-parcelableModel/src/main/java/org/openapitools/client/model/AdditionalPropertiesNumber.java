...
public class AdditionalPropertiesNumber
    extends HashMap<String, BigDecimal> implements Parcelable {
  public static final String SERIALIZED_NAME_NAME = "name";
  @SerializedName(SERIALIZED_NAME_NAME) private String name;

  public AdditionalPropertiesNumber() { super(); }
  ...
  public static final Parcelable.Creator<AdditionalPropertiesNumber> CREATOR =
      new Parcelable.Creator<AdditionalPropertiesNumber>() {
