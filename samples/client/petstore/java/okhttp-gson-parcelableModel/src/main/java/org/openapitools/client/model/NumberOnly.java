...
public class NumberOnly implements Parcelable {
  ...
  @SerializedName(SERIALIZED_NAME_JUST_NUMBER) private BigDecimal justNumber;
  ...
  public static final Parcelable.Creator<NumberOnly> CREATOR =
      new Parcelable.Creator<NumberOnly>() {
        public NumberOnly createFromParcel(Parcel in) {
          return new NumberOnly(in);
        }
        public NumberOnly[] newArray(int size) { return new NumberOnly[size]; }
      };
}
