...
public class ArrayTest implements Parcelable {
  ...
  ArrayTest(Parcel in) {
    ...
    arrayArrayOfInteger =
        (List<List<Long>>)in.readValue(List.class.getClassLoader());
    arrayArrayOfModel =
        (List<List<ReadOnlyFirst>>)in.readValue(List.class.getClassLoader());
  }

  public int describeContents() { return 0; }

  public static final Parcelable.Creator<ArrayTest> CREATOR =
      new Parcelable.Creator<ArrayTest>() {
        public ArrayTest createFromParcel(Parcel in) {
          return new ArrayTest(in);
        }
        public ArrayTest[] newArray(int size) { return new ArrayTest[size]; }
      };
}
