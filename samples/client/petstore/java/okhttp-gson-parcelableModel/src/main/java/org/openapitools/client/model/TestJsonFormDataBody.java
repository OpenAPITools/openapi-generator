...
public class TestJsonFormDataBody implements Parcelable {
  ...
  **/
  ...
  TestJsonFormDataBody(Parcel in) {
  ...
  public static final Parcelable.Creator<TestJsonFormDataBody> CREATOR = new Parcelable.Creator<TestJsonFormDataBody>() {
    public TestJsonFormDataBody createFromParcel(Parcel in) {
      return new TestJsonFormDataBody(in);
    }
    public TestJsonFormDataBody[] newArray(int size) {
      return new TestJsonFormDataBody[size];
    }
  };
}
