...
public class BigCatAllOf implements Parcelable {
  ...
  public void writeToParcel(Parcel out, int flags) { out.writeValue(kind); }

  BigCatAllOf(Parcel in) { kind = (KindEnum)in.readValue(null); }

  public int describeContents() { return 0; }

  public static final Parcelable.Creator<BigCatAllOf> CREATOR =
      new Parcelable.Creator<BigCatAllOf>() {
