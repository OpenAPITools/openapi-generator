           ...
           public BigCatAllOf read(JsonReader in) throws IOException {
             ...
             for (Entry<String, JsonElement> entry: entries) {
               if (!BigCatAllOf.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException("The field `" + entry.getKey() + "` in the JSON string is not defined in the `BigCatAllOf` properties");
               }
             }
...
/*
  public static class CustomDeserializer implements JsonDeserializer<BigCatAllOf> {
    @Override
    public BigCatAllOf deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
      ...
      return new Gson().fromJson(json, BigCatAllOf.class);
    }
  }*/
}
