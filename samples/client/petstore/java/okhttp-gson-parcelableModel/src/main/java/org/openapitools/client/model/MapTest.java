...
public class MapTest implements Parcelable {
  ...
  MapTest(Parcel in) {
    mapMapOfString = (Map<String, Map<String, String>>)in.readValue(
  ...
  public static final Parcelable.Creator<MapTest> CREATOR =
      new Parcelable.Creator<MapTest>() {
        public MapTest createFromParcel(Parcel in) { return new MapTest(in); }
        public MapTest[] newArray(int size) { return new MapTest[size]; }
      };
}
