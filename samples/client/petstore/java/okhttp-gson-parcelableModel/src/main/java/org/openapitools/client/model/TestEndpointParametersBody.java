...
public class TestEndpointParametersBody implements Parcelable {
  ...
  public TestEndpointParametersBody() {
  }
  ...
  **/
  ...
  TestEndpointParametersBody(Parcel in) {
  ...
  public static final Parcelable.Creator<TestEndpointParametersBody> CREATOR = new Parcelable.Creator<TestEndpointParametersBody>() {
    public TestEndpointParametersBody createFromParcel(Parcel in) {
      return new TestEndpointParametersBody(in);
    }
    public TestEndpointParametersBody[] newArray(int size) {
      return new TestEndpointParametersBody[size];
    }
  };
}
