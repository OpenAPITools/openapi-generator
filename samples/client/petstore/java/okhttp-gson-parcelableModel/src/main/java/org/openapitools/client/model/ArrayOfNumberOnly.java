...
public class ArrayOfNumberOnly implements Parcelable {
  ...
  ArrayOfNumberOnly(Parcel in) {
    arrayNumber =
        (List<BigDecimal>)in.readValue(BigDecimal.class.getClassLoader());
  }

  public int describeContents() { return 0; }

  public static final Parcelable.Creator<ArrayOfNumberOnly> CREATOR =
      new Parcelable.Creator<ArrayOfNumberOnly>() {
