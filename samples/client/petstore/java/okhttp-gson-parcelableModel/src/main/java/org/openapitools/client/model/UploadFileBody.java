...
public class UploadFileBody implements Parcelable {
  ...
  **/
  ...
  public static final Parcelable.Creator<UploadFileBody> CREATOR = new Parcelable.Creator<UploadFileBody>() {
    public UploadFileBody createFromParcel(Parcel in) {
      return new UploadFileBody(in);
    }
    public UploadFileBody[] newArray(int size) {
      return new UploadFileBody[size];
    }
  };
}
