...
public class UploadFileWithRequiredFileBody implements Parcelable {
  ...
  public UploadFileWithRequiredFileBody() {
  }
  ...
  **/
  ...
  UploadFileWithRequiredFileBody(Parcel in) {
  ...
  public static final Parcelable.Creator<UploadFileWithRequiredFileBody> CREATOR = new Parcelable.Creator<UploadFileWithRequiredFileBody>() {
    public UploadFileWithRequiredFileBody createFromParcel(Parcel in) {
      return new UploadFileWithRequiredFileBody(in);
    }
    public UploadFileWithRequiredFileBody[] newArray(int size) {
      return new UploadFileWithRequiredFileBody[size];
    }
  };
}
