...
public class HasOnlyReadOnly implements Parcelable {
  ...
  @SerializedName(SERIALIZED_NAME_FOO) private String foo;
  ...
  public static final Parcelable.Creator<HasOnlyReadOnly> CREATOR =
      new Parcelable.Creator<HasOnlyReadOnly>() {
