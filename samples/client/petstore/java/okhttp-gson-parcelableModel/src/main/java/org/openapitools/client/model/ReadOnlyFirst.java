...
public class ReadOnlyFirst implements Parcelable {
  ...
  @SerializedName(SERIALIZED_NAME_BAR) private String bar;

  public static final String SERIALIZED_NAME_BAZ = "baz";
  @SerializedName(SERIALIZED_NAME_BAZ) private String baz;
  ...
  public static final Parcelable.Creator<ReadOnlyFirst> CREATOR =
      new Parcelable.Creator<ReadOnlyFirst>() {
