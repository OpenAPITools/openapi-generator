...
public class EnumArrays implements Parcelable {
  ...
  public static final Parcelable.Creator<EnumArrays> CREATOR =
      new Parcelable.Creator<EnumArrays>() {
        public EnumArrays createFromParcel(Parcel in) {
          return new EnumArrays(in);
        }
        public EnumArrays[] newArray(int size) { return new EnumArrays[size]; }
      };
}
