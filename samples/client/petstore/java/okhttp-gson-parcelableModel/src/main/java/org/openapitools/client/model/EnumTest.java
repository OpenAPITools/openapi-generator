...
public class EnumTest implements Parcelable {
  ...
  public static final String SERIALIZED_NAME_ENUM_STRING_REQUIRED =
  ...
  @SerializedName(SERIALIZED_NAME_OUTER_ENUM) private OuterEnum outerEnum;
  ...
  public static final Parcelable.Creator<EnumTest> CREATOR =
      new Parcelable.Creator<EnumTest>() {
        public EnumTest createFromParcel(Parcel in) { return new EnumTest(in); }
        public EnumTest[] newArray(int size) { return new EnumTest[size]; }
      };
}
