...
public class BigCat extends Cat implements Parcelable {
  ...
  public static final Parcelable.Creator<BigCat> CREATOR =
      new Parcelable.Creator<BigCat>() {
        public BigCat createFromParcel(Parcel in) { return new BigCat(in); }
        public BigCat[] newArray(int size) { return new BigCat[size]; }
      };
}
