...
public class FakeClassnameTags123Api {
   ...
   */
  public okhttp3.Call testClassnameCall(Client body,
  ...
  testClassnameValidateBeforeCall(Client body, final ApiCallback _callback)
      throws ApiException {

    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling testClassname(Async)");
    }
   ...
   */
  public okhttp3.Call testClassnameAsync(Client body,
                                         final ApiCallback<Client> _callback)
      throws ApiException {

    okhttp3.Call localVarCall =
        testClassnameValidateBeforeCall(body, _callback);
    Type localVarReturnType = new TypeToken<Client>() {}.getType();
