...
public class FileSchemaTestClass implements Parcelable {
  ...
  FileSchemaTestClass(Parcel in) {
    ...
    files =
        (List<java.io.File>)in.readValue(java.io.File.class.getClassLoader());
  }

  public int describeContents() { return 0; }

  public static final Parcelable.Creator<FileSchemaTestClass> CREATOR =
      new Parcelable.Creator<FileSchemaTestClass>() {
