...
public class FormatTest implements Parcelable {
  ...
  public static final Parcelable.Creator<FormatTest> CREATOR =
      new Parcelable.Creator<FormatTest>() {
        public FormatTest createFromParcel(Parcel in) {
          return new FormatTest(in);
        }
        public FormatTest[] newArray(int size) { return new FormatTest[size]; }
      };
}
