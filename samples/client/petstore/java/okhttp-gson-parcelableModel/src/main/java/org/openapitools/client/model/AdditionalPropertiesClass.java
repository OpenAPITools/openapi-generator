...
public class AdditionalPropertiesClass implements Parcelable {
  ...
  AdditionalPropertiesClass(Parcel in) {
    ...
    mapNumber = (Map<String, BigDecimal>)in.readValue(
    ...
    mapArrayInteger =
        (Map<String, List<Integer>>)in.readValue(List.class.getClassLoader());
    mapArrayAnytype =
        (Map<String, List<Object>>)in.readValue(List.class.getClassLoader());
    mapMapString = (Map<String, Map<String, String>>)in.readValue(
        Map.class.getClassLoader());
    mapMapAnytype = (Map<String, Map<String, Object>>)in.readValue(
        Map.class.getClassLoader());
  ...
  public static final Parcelable.Creator<AdditionalPropertiesClass> CREATOR =
      new Parcelable.Creator<AdditionalPropertiesClass>() {
