...
public class AdditionalPropertiesArray
    extends HashMap<String, List> implements Parcelable {
  public static final String SERIALIZED_NAME_NAME = "name";
  @SerializedName(SERIALIZED_NAME_NAME) private String name;

  public AdditionalPropertiesArray() { super(); }
  ...
  public static final Parcelable.Creator<AdditionalPropertiesArray> CREATOR =
      new Parcelable.Creator<AdditionalPropertiesArray>() {
