...
public class ArrayOfArrayOfNumberOnly implements Parcelable {
  ...
  ArrayOfArrayOfNumberOnly(Parcel in) {
    arrayArrayNumber =
        (List<List<BigDecimal>>)in.readValue(List.class.getClassLoader());
  }

  public int describeContents() { return 0; }

  public static final Parcelable.Creator<ArrayOfArrayOfNumberOnly> CREATOR =
      new Parcelable.Creator<ArrayOfArrayOfNumberOnly>() {
