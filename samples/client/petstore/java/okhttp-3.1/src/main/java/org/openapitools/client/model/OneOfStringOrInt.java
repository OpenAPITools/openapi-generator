...
public class OneOfStringOrInt extends AbstractOpenApiSchema {
   ...
   * @return the OneOfStringOrInt instance itself
   */
  public OneOfStringOrInt putAdditionalProperty(String key, Object value) {
  ...
  public Object getAdditionalProperty(String key) {
     ...
     */
    private static void collectUnconsumedProperties(OneOfStringOrInt instance, JsonElement jsonElement, Gson gson) {
     ...
     */
    private static void writeUnconsumedProperties(OneOfStringOrInt value, JsonObject obj, Gson gson) {
