...
<dependency>
  ...
  <artifactId>petstore-okhttp-31</artifactId>
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'petstore-okhttp-31' jar has been published to maven central.
    mavenLocal()       // Needed if the 'petstore-okhttp-31' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "org.openapitools:petstore-okhttp-31:1.0.0"
  }
```
...
* `target/petstore-okhttp-31-1.0.0.jar`
* `target/lib/*.jar`
