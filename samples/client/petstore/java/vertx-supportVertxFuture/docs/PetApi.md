...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            AsyncFile result = apiInstance.downloadFile(petId);
...
public class Example {
    public static void main(String[] args) {
        ...
        AsyncFile _file = new AsyncFile(); // AsyncFile | file to upload
        try {
...
| **_file** | **AsyncFile**| file to upload | [optional] |
