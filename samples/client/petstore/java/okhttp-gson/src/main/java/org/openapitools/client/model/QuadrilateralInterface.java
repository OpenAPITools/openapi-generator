...
/*
  public static class CustomDeserializer implements JsonDeserializer<QuadrilateralInterface> {
    @Override
    public QuadrilateralInterface deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
      ...
      return new Gson().fromJson(json, QuadrilateralInterface.class);
    }
  }*/
}
