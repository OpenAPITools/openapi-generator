...
public class ArrayTest {
  ...
  **/
  ...
  public static class ArrayTestDeserializer implements JsonDeserializer<ArrayTest> {
    @Override
    public ArrayTest deserialize(JsonElement json, Type typeOf, JsonDeserializationContext context) throws JsonParseException {
      HashSet<String> test = ArrayTest.openapiFields;
