...
public class ApiClient {
   ...
   */
  public ApiClient(String clientId) { this(clientId, null, null); }
   ...
   */
  public ApiClient(String basePath, String clientId, String clientSecret,
                   Map<String, String> parameters) {
    init();
    if (basePath != null) {
    ...
    if (!"".equals(tokenUrl) && !URI.create(tokenUrl).isAbsolute()) {
      ...
      if (!URI.create(tokenUrl).isAbsolute()) {
        throw new IllegalArgumentException(
            "OAuth2 token URL must be an absolute URL");
      }
    }
    RetryingOAuth retryingOAuth = new RetryingOAuth(
        tokenUrl, clientId, OAuthFlow.implicit, clientSecret, parameters);
