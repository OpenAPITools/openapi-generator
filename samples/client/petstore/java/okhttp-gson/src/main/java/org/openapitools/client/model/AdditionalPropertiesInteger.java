...
public class AdditionalPropertiesInteger extends HashMap<String, Integer> {
  ...
  **/
  ...
  public static class AdditionalPropertiesIntegerDeserializer implements JsonDeserializer<AdditionalPropertiesInteger> {
    @Override
    public AdditionalPropertiesInteger deserialize(JsonElement json, Type typeOf, JsonDeserializationContext context) throws JsonParseException {
      HashSet<String> test = AdditionalPropertiesInteger.openapiFields;
