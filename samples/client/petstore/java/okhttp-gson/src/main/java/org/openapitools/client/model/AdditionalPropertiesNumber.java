...
public class AdditionalPropertiesNumber extends HashMap<String, BigDecimal> {
  ...
  **/
  ...
  public static class AdditionalPropertiesNumberDeserializer implements JsonDeserializer<AdditionalPropertiesNumber> {
    @Override
    public AdditionalPropertiesNumber deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
      ...
      for (Entry<String, JsonElement> entry: entries) {
        if (!AdditionalPropertiesNumber.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException("The field `" + entry.getKey() + "` in the JSON payload is not defined in the `AdditionalPropertiesNumber` properties");
        }
      }
