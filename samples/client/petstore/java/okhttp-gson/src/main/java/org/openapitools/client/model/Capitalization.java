...
public class Capitalization {
  ...
  **/
  ...
  public static class CapitalizationDeserializer implements JsonDeserializer<Capitalization> {
    @Override
    public Capitalization deserialize(JsonElement json, Type typeOf, JsonDeserializationContext context) throws JsonParseException {
      HashSet<String> test = Capitalization.openapiFields;
