...
/*
  public static class CustomDeserializer implements JsonDeserializer<InlineResponseDefault> {
    @Override
    public InlineResponseDefault deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
      ...
      return new Gson().fromJson(json, InlineResponseDefault.class);
    }
  }*/
}
