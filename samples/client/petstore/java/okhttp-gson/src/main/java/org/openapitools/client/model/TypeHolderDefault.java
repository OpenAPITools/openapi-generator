...
public class TypeHolderDefault {
  ...
  **/
  ...
  public static class TypeHolderDefaultDeserializer implements JsonDeserializer<TypeHolderDefault> {
    @Override
    public TypeHolderDefault deserialize(JsonElement json, Type typeOf, JsonDeserializationContext context) throws JsonParseException {
      HashSet<String> test = TypeHolderDefault.openapiFields;
