...
public class AnotherFakeApi {
   ...
   */
  public okhttp3.Call call123testSpecialTagsCall(Client body,
    ...
    return localVarApiClient.buildCall(
        localVarPath, "PATCH", localVarQueryParams,
  ...
  private okhttp3.Call call123testSpecialTagsValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling call123testSpecialTags(Async)");
    }
  ...
  public ApiResponse<Client> call123testSpecialTagsWithHttpInfo(Client body)
    ...
    okhttp3.Call localVarCall =
        call123testSpecialTagsValidateBeforeCall(body, null);
   ...
   */
  public okhttp3.Call
  call123testSpecialTagsAsync(Client body, final ApiCallback<Client> _callback)
      throws ApiException {

    okhttp3.Call localVarCall =
        call123testSpecialTagsValidateBeforeCall(body, _callback);
    Type localVarReturnType = new TypeToken<Client>() {}.getType();
