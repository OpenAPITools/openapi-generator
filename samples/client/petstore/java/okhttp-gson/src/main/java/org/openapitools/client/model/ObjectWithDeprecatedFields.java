...
/*
  public static class CustomDeserializer implements JsonDeserializer<ObjectWithDeprecatedFields> {
    @Override
    public ObjectWithDeprecatedFields deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
      ...
      return new Gson().fromJson(json, ObjectWithDeprecatedFields.class);
    }
  }*/
}
