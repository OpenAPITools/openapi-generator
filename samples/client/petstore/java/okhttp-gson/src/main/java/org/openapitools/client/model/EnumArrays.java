...
public class EnumArrays {
  ...
  **/
  ...
  public static class EnumArraysDeserializer implements JsonDeserializer<EnumArrays> {
    @Override
    public EnumArrays deserialize(JsonElement json, Type typeOf, JsonDeserializationContext context) throws JsonParseException {
      HashSet<String> test = EnumArrays.openapiFields;
