           ...
           public Zebra read(JsonReader in) throws IOException {
             ...
             for (Entry<String, JsonElement> entry: entries) {
               if (!Zebra.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException("The field `" + entry.getKey() + "` in the JSON string is not defined in the `Zebra` properties");
               }
             }
...
/*
  public static class CustomDeserializer implements JsonDeserializer<Zebra> {
    @Override
    public Zebra deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
      ...
      return new Gson().fromJson(json, Zebra.class);
    }
  }*/
}
