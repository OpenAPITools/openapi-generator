...
public class NumberOnly {
  ...
  **/
  ...
  public static class NumberOnlyDeserializer implements JsonDeserializer<NumberOnly> {
    @Override
    public NumberOnly deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
      ...
      for (Entry<String, JsonElement> entry: entries) {
        if (!NumberOnly.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException("The field `" + entry.getKey() + "` in the JSON payload is not defined in the `NumberOnly` properties");
        }
      }
