...
public class NestedArrayWithDefaultValues {
  ...
  private List<List<String>> nestedArray = new ArrayList<>(Arrays.asList(new ArrayList<>(Arrays.asList("h1", "Header 1")), new ArrayList<>(Arrays.asList("h2", "Header 2")), new ArrayList<>(Arrays.asList("h3", "Header 3")), new ArrayList<>(Arrays.asList("h4", "Header 4"))));
  ...
  public NestedArrayWithDefaultValues addNestedArrayItem(List<String> nestedArrayItem) {
    if (this.nestedArray == null) {
      this.nestedArray = new ArrayList<>(Arrays.asList(new ArrayList<>(Arrays.asList("h1", "Header 1")), new ArrayList<>(Arrays.asList("h2", "Header 2")), new ArrayList<>(Arrays.asList("h3", "Header 3")), new ArrayList<>(Arrays.asList("h4", "Header 4"))));
    }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("nestedArray") != null && !jsonObj.get("nestedArray").isJsonNull() && !jsonObj.get("nestedArray").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `nestedArray` to be an array in the JSON string but got `%s`", jsonObj.get("nestedArray").toString()));
      }
  }
