    ...
    public static class CustomDeserializer implements JsonDeserializer<Triangle> {
        ...
        /*    JsonNode tree = jp.readValueAsTree();
            ...
            try {
                ...
                deserialized = gson.fromJson(json.toString(), EquilateralTriangle.class);
            ...
            try {
                ...
                //        .create();
                Gson gson = new JSON().getGson();
                deserialized = gson.fromJson(json.toString(), IsoscelesTriangle.class);
            ...
            try {
                ...
                //        .create();
                Gson gson = new JSON().getGson();
                deserialized = gson.fromJson(json.toString(), ScaleneTriangle.class);
