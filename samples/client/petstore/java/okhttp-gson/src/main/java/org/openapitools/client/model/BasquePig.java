...
/*
  public static class CustomDeserializer implements JsonDeserializer<BasquePig> {
    @Override
    public BasquePig deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
      ...
      return new Gson().fromJson(json, BasquePig.class);
    }
  }*/
}
