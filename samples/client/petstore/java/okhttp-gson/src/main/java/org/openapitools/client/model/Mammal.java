    ...
    public static class CustomDeserializer implements JsonDeserializer<Mammal> {
        ...
        /*    JsonNode tree = jp.readValueAsTree();
            ...
            try {
                ...
                deserialized = gson.fromJson(json.toString(), Pig.class);
            ...
            try {
                ...
                //        .create();
                Gson gson = new JSON().getGson();
                deserialized = gson.fromJson(json.toString(), Whale.class);
            ...
            try {
                ...
                //        .create();
                Gson gson = new JSON().getGson();
                deserialized = gson.fromJson(json.toString(), Zebra.class);
