...
public class AppleReq {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cultivar, appleReq.cultivar) &&
        ...
        Objects.equals(this.additionalProperties, appleReq.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cultivar, mealy, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AppleReq>() {
           ...
           public AppleReq read(JsonReader in) throws IOException {
             ...
             AppleReq instance = thisAdapter.fromJsonTree(jsonObj);
