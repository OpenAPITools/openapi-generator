...
public class PetApiTest {
  ...
  // In the circle.yml file, /etc/host is configured with an entry to resolve
  // petstore.swagger.io to 127.0.0.1
  ...
  public void setup() {
    ...
    ApiKeyAuth apiKeyAuth =
        (ApiKeyAuth)api.getApiClient().getAuthentication("api_key");
  ...
  public void testCreateAndGetPetWithHttpInfo() throws Exception {
    ...
    assertEquals("application/json",
                 resp.getHeaders().get("Content-Type").get(0));
  ...
  public void testCreateAndGetPetAsync() throws Exception {
    ...
    api.getPetByIdAsync(pet.getId(), new ApiCallback<Pet>() {
      ...
      @Override
      public void onSuccess(Pet pet, int statusCode,
                            Map<String, List<String>> responseHeaders) {
        result.put("pet", pet);
      }
  ...
  public void testCreateAndGetPetAsyncInvalidID() throws Exception {
    ...
    assertEquals("application/json",
                 exception.getResponseHeaders().get("Content-Type").get(0));
    api.deletePet(pet.getId(), null);
  }
  ...
  public void testCreateAndGetMultiplePetsAsync() throws Exception {
    ...
    final TestApiCallback<Void> addCallback1 =
        new TestApiCallback<Void>(addLatch);
    final TestApiCallback<Void> addCallback2 =
        new TestApiCallback<Void>(addLatch);
    ...
    if (!addCallback1.isSuccess())
      throw addCallback1.getException();
    if (!addCallback2.isSuccess())
      throw addCallback2.getException();
    ...
    final TestApiCallback<Pet> getCallback1 =
        new TestApiCallback<Pet>(getLatch);
    final TestApiCallback<Pet> getCallback2 =
        new TestApiCallback<Pet>(getLatch);
    final TestApiCallback<Pet> getCallback3 =
        new TestApiCallback<Pet>(getLatch);
    ...
    if (!getCallback1.isSuccess())
      throw getCallback1.getException();
    if (!getCallback2.isSuccess())
      throw getCallback2.getException();
  ...
  public void testUploadFile() throws Exception {
    ...
    api.uploadFile(pet.getId(), "a test file",
  ...
  private static class TestApiCallback<T> implements ApiCallback<T> {
    ...
    public ApiException getException() { return exception; }
