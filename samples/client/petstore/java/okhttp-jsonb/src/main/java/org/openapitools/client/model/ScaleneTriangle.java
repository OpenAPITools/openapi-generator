...
public class ScaleneTriangle {
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<ScaleneTriangle> {
    @Override
    public void serialize(ScaleneTriangle value, JsonGenerator generator, SerializationContext context) {
   ...
   */
  public static class CustomJsonbDeserializer implements JsonbDeserializer<ScaleneTriangle> {
    @Override
    public ScaleneTriangle deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
      ...
      ScaleneTriangle instance = new ScaleneTriangle();
    ...
    private static java.lang.reflect.Field declaredField(String fieldName) {
      ...
      for (Class<?> clazz = ScaleneTriangle.class; clazz != null; clazz = clazz.getSuperclass()) {
        try {
      ...
      throw new IllegalArgumentException("Field " + fieldName + " not found on ScaleneTriangle");
    }
    ...
    private static void setField(ScaleneTriangle instance, String fieldName, Object value) {
      try {
        java.lang.reflect.Field field = declaredField(fieldName);
        field.setAccessible(true);
        field.set(instance, value);
      } catch (IllegalAccessException e) {
        throw new JsonbException("Unable to bind the field " + fieldName + " on ScaleneTriangle", e);
      }
    }
  }
}
