...
public class ComplexQuadrilateral {
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<ComplexQuadrilateral> {
    @Override
    public void serialize(ComplexQuadrilateral value, JsonGenerator generator, SerializationContext context) {
      generator.writeStartObject();
      if (value.getShapeType() != null) {
        context.serialize("shapeType", value.getShapeType(), generator);
      }
      if (value.getQuadrilateralType() != null) {
        context.serialize("quadrilateralType", value.getQuadrilateralType(), generator);
      }
   ...
   */
  public static class CustomJsonbDeserializer implements JsonbDeserializer<ComplexQuadrilateral> {
    @Override
    public ComplexQuadrilateral deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
      ...
      ComplexQuadrilateral instance = new ComplexQuadrilateral();
      ...
      if (jsonObj.containsKey("quadrilateralType")) {
        instance.setQuadrilateralType(jsonObj.get("quadrilateralType").getValueType() == JsonValue.ValueType.NULL
            ? null
            : jsonb.fromJson(jsonObj.get("quadrilateralType").toString(), fieldType("quadrilateralType")));
      }
    ...
    private static java.lang.reflect.Field declaredField(String fieldName) {
      ...
      for (Class<?> clazz = ComplexQuadrilateral.class; clazz != null; clazz = clazz.getSuperclass()) {
        try {
      ...
      throw new IllegalArgumentException("Field " + fieldName + " not found on ComplexQuadrilateral");
    }
    ...
    private static void setField(ComplexQuadrilateral instance, String fieldName, Object value) {
      try {
        java.lang.reflect.Field field = declaredField(fieldName);
        field.setAccessible(true);
        field.set(instance, value);
      } catch (IllegalAccessException e) {
        throw new JsonbException("Unable to bind the field " + fieldName + " on ComplexQuadrilateral", e);
      }
    }
  }
