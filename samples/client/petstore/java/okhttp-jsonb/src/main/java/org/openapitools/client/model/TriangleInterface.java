...
public class TriangleInterface {
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<TriangleInterface> {
    @Override
    public void serialize(TriangleInterface value, JsonGenerator generator, SerializationContext context) {
      generator.writeStartObject();
      if (value.getTriangleType() != null) {
        context.serialize("triangleType", value.getTriangleType(), generator);
      }
   ...
   */
  public static class CustomJsonbDeserializer implements JsonbDeserializer<TriangleInterface> {
    @Override
    public TriangleInterface deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
      ...
      TriangleInterface instance = new TriangleInterface();
    ...
    private static java.lang.reflect.Field declaredField(String fieldName) {
      ...
      for (Class<?> clazz = TriangleInterface.class; clazz != null; clazz = clazz.getSuperclass()) {
        try {
      ...
      throw new IllegalArgumentException("Field " + fieldName + " not found on TriangleInterface");
    }
    ...
    private static void setField(TriangleInterface instance, String fieldName, Object value) {
      try {
        java.lang.reflect.Field field = declaredField(fieldName);
        field.setAccessible(true);
        field.set(instance, value);
      } catch (IllegalAccessException e) {
        throw new JsonbException("Unable to bind the field " + fieldName + " on TriangleInterface", e);
      }
    }
  }
}
