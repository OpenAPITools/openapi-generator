...
public class Variable {
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<Variable> {
    @Override
    public void serialize(Variable value, JsonGenerator generator, SerializationContext context) {
   ...
   */
  public static class CustomJsonbDeserializer implements JsonbDeserializer<Variable> {
    @Override
    public Variable deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
    ...
    private static java.lang.reflect.Field declaredField(String fieldName) {
      ...
      for (Class<?> clazz = Variable.class; clazz != null; clazz = clazz.getSuperclass()) {
        try {
      ...
      throw new IllegalArgumentException("Field " + fieldName + " not found on Variable");
    }
    ...
    private static void setField(Variable instance, String fieldName, Object value) {
      try {
        java.lang.reflect.Field field = declaredField(fieldName);
        field.setAccessible(true);
        field.set(instance, value);
      } catch (IllegalAccessException e) {
        throw new JsonbException("Unable to bind the field " + fieldName + " on Variable", e);
      }
    }
  }
