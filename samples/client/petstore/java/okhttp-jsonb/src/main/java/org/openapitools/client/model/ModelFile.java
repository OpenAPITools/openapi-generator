...
public class ModelFile {
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<ModelFile> {
    @Override
    public void serialize(ModelFile value, JsonGenerator generator, SerializationContext context) {
      generator.writeStartObject();
      if (value.getSourceURI() != null) {
        context.serialize("sourceURI", value.getSourceURI(), generator);
      }
   ...
   */
  public static class CustomJsonbDeserializer implements JsonbDeserializer<ModelFile> {
    @Override
    public ModelFile deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
      ...
      ModelFile instance = new ModelFile();
      if (jsonObj.containsKey("sourceURI")) {
        instance.setSourceURI(jsonObj.get("sourceURI").getValueType() == JsonValue.ValueType.NULL
            ? null
            : jsonb.fromJson(jsonObj.get("sourceURI").toString(), fieldType("sourceURI")));
      }
    ...
    private static java.lang.reflect.Field declaredField(String fieldName) {
      ...
      for (Class<?> clazz = ModelFile.class; clazz != null; clazz = clazz.getSuperclass()) {
        try {
      ...
      throw new IllegalArgumentException("Field " + fieldName + " not found on ModelFile");
    }
    ...
    private static void setField(ModelFile instance, String fieldName, Object value) {
      try {
        java.lang.reflect.Field field = declaredField(fieldName);
        field.setAccessible(true);
        field.set(instance, value);
      } catch (IllegalAccessException e) {
        throw new JsonbException("Unable to bind the field " + fieldName + " on ModelFile", e);
      }
    }
  }
