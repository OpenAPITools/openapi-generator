...
public class AllOfModelArrayAnyOf {
  ...
  public AllOfModelArrayAnyOf id(@jakarta.annotation.Nullable Long id) {
    this.id = id;
    return this;
  }
  ...
  public AllOfModelArrayAnyOf name(@jakarta.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public AllOfModelArrayAnyOf linkListColumn1(@jakarta.annotation.Nullable AllOfModelArrayAnyOfAllOfLinkListColumn1 linkListColumn1) {
  ...
  public void setLinkListColumn1(@jakarta.annotation.Nullable AllOfModelArrayAnyOfAllOfLinkListColumn1 linkListColumn1) {
    this.linkListColumn1 = linkListColumn1;
  }


  public AllOfModelArrayAnyOf attributes(@jakarta.annotation.Nullable AllOfModelArrayAnyOfAllOfAttributes attributes) {
  ...
  public void setAttributes(@jakarta.annotation.Nullable AllOfModelArrayAnyOfAllOfAttributes attributes) {
    this.attributes = attributes;
  }
