...
@JsonbTypeDeserializer(FakeRefParameterPetIdParameter.FakeRefParameterPetIdParameterDeserializer.class)
@JsonbTypeSerializer(FakeRefParameterPetIdParameter.FakeRefParameterPetIdParameterSerializer.class)
public class FakeRefParameterPetIdParameter extends AbstractOpenApiSchema {
  ...
  public Object getAdditionalProperty(String key) {
    ...
    public static class FakeRefParameterPetIdParameterSerializer implements JsonbSerializer<FakeRefParameterPetIdParameter> {
        @Override
        public void serialize(FakeRefParameterPetIdParameter obj, JsonGenerator generator, SerializationContext ctx) {
     ...
     */
    private static void collectUnconsumedProperties(FakeRefParameterPetIdParameter instance, JsonObject jsonObject) {
    ...
    public static class FakeRefParameterPetIdParameterDeserializer implements JsonbDeserializer<FakeRefParameterPetIdParameter> {
        @Override
        public FakeRefParameterPetIdParameter deserialize(JsonParser parser, DeserializationContext ctx, Type rt) {
            JsonValue jsonValue = parser.getValue();
            if (jsonValue == null || jsonValue.getValueType() == JsonValue.ValueType.NULL) {
                throw new RuntimeException("FakeRefParameterPetIdParameter cannot be null");
            }
            ...
            throw new RuntimeException(String.format(java.util.Locale.ROOT, "Failed deserialization for FakeRefParameterPetIdParameter: %d classes match result, expected 1", match));
        }
    }
