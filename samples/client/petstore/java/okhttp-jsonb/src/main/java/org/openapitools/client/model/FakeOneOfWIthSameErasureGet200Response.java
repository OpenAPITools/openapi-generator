...
@JsonbTypeDeserializer(FakeOneOfWIthSameErasureGet200Response.FakeOneOfWIthSameErasureGet200ResponseDeserializer.class)
@JsonbTypeSerializer(FakeOneOfWIthSameErasureGet200Response.FakeOneOfWIthSameErasureGet200ResponseSerializer.class)
public class FakeOneOfWIthSameErasureGet200Response extends AbstractOpenApiSchema {
  ...
  public Object getAdditionalProperty(String key) {
    ...
    public static class FakeOneOfWIthSameErasureGet200ResponseSerializer implements JsonbSerializer<FakeOneOfWIthSameErasureGet200Response> {
        @Override
        public void serialize(FakeOneOfWIthSameErasureGet200Response obj, JsonGenerator generator, SerializationContext ctx) {
     ...
     */
    private static void collectUnconsumedProperties(FakeOneOfWIthSameErasureGet200Response instance, JsonObject jsonObject) {
    ...
    public static class FakeOneOfWIthSameErasureGet200ResponseDeserializer implements JsonbDeserializer<FakeOneOfWIthSameErasureGet200Response> {
        @Override
        public FakeOneOfWIthSameErasureGet200Response deserialize(JsonParser parser, DeserializationContext ctx, Type rt) {
            JsonValue jsonValue = parser.getValue();
            if (jsonValue == null || jsonValue.getValueType() == JsonValue.ValueType.NULL) {
                throw new RuntimeException("FakeOneOfWIthSameErasureGet200Response cannot be null");
            }
            ...
            throw new RuntimeException(String.format(java.util.Locale.ROOT, "Failed deserialization for FakeOneOfWIthSameErasureGet200Response: %d classes match result, expected 1", match));
        }
    }
