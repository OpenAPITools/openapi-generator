...
public class AllOfRefToDouble {
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<AllOfRefToDouble> {
    @Override
    public void serialize(AllOfRefToDouble value, JsonGenerator generator, SerializationContext context) {
      generator.writeStartObject();
      if (value.getHeight() != null) {
        context.serialize("height", value.getHeight(), generator);
      }
   ...
   */
  public static class CustomJsonbDeserializer implements JsonbDeserializer<AllOfRefToDouble> {
    @Override
    public AllOfRefToDouble deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
      ...
      AllOfRefToDouble instance = new AllOfRefToDouble();
      if (jsonObj.containsKey("height")) {
        instance.setHeight(jsonObj.get("height").getValueType() == JsonValue.ValueType.NULL
            ? null
            : jsonb.fromJson(jsonObj.get("height").toString(), fieldType("height")));
      }
    ...
    private static java.lang.reflect.Field declaredField(String fieldName) {
      ...
      for (Class<?> clazz = AllOfRefToDouble.class; clazz != null; clazz = clazz.getSuperclass()) {
        try {
      ...
      throw new IllegalArgumentException("Field " + fieldName + " not found on AllOfRefToDouble");
    }
    ...
    private static void setField(AllOfRefToDouble instance, String fieldName, Object value) {
      try {
        java.lang.reflect.Field field = declaredField(fieldName);
        field.setAccessible(true);
        field.set(instance, value);
      } catch (IllegalAccessException e) {
        throw new JsonbException("Unable to bind the field " + fieldName + " on AllOfRefToDouble", e);
      }
    }
  }
  ...
  public static class Builder {
    ...
    *
    * The values are put through {@link AllOfRefToDouble#putAdditionalProperty}, so the map is
    * rebuilt on the instance that actually owns it: a subclass declares its own holder that
    * shadows the parent one, and the virtual call always reaches the subclass field.
    */
    public AllOfRefToDouble.Builder additionalProperties(Map<String, Object> additionalProperties) {
