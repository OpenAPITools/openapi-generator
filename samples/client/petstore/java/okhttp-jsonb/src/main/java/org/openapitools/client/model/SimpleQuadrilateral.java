...
public class SimpleQuadrilateral {
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<SimpleQuadrilateral> {
    @Override
    public void serialize(SimpleQuadrilateral value, JsonGenerator generator, SerializationContext context) {
   ...
   */
  public static class CustomJsonbDeserializer implements JsonbDeserializer<SimpleQuadrilateral> {
    @Override
    public SimpleQuadrilateral deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
      ...
      SimpleQuadrilateral instance = new SimpleQuadrilateral();
    ...
    private static java.lang.reflect.Field declaredField(String fieldName) {
      ...
      for (Class<?> clazz = SimpleQuadrilateral.class; clazz != null; clazz = clazz.getSuperclass()) {
        try {
      ...
      throw new IllegalArgumentException("Field " + fieldName + " not found on SimpleQuadrilateral");
    }
    ...
    private static void setField(SimpleQuadrilateral instance, String fieldName, Object value) {
      try {
        java.lang.reflect.Field field = declaredField(fieldName);
        field.setAccessible(true);
        field.set(instance, value);
      } catch (IllegalAccessException e) {
        throw new JsonbException("Unable to bind the field " + fieldName + " on SimpleQuadrilateral", e);
      }
    }
  }
}
