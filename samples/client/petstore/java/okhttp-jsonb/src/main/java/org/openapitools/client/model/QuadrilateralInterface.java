...
public class QuadrilateralInterface {
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<QuadrilateralInterface> {
    @Override
    public void serialize(QuadrilateralInterface value, JsonGenerator generator, SerializationContext context) {
   ...
   */
  public static class CustomJsonbDeserializer implements JsonbDeserializer<QuadrilateralInterface> {
    @Override
    public QuadrilateralInterface deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
      ...
      QuadrilateralInterface instance = new QuadrilateralInterface();
    ...
    private static java.lang.reflect.Field declaredField(String fieldName) {
      ...
      for (Class<?> clazz = QuadrilateralInterface.class; clazz != null; clazz = clazz.getSuperclass()) {
        try {
      ...
      throw new IllegalArgumentException("Field " + fieldName + " not found on QuadrilateralInterface");
    }
    ...
    private static void setField(QuadrilateralInterface instance, String fieldName, Object value) {
      try {
        java.lang.reflect.Field field = declaredField(fieldName);
        field.setAccessible(true);
        field.set(instance, value);
      } catch (IllegalAccessException e) {
        throw new JsonbException("Unable to bind the field " + fieldName + " on QuadrilateralInterface", e);
      }
    }
  }
  ...
  public static class Builder {
    ...
    *
    * The values are put through {@link QuadrilateralInterface#putAdditionalProperty}, so the map is
    * rebuilt on the instance that actually owns it: a subclass declares its own holder that
    * shadows the parent one, and the virtual call always reaches the subclass field.
    */
    public QuadrilateralInterface.Builder additionalProperties(Map<String, Object> additionalProperties) {
