...
public class PetComposition {
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<PetComposition> {
    @Override
    public void serialize(PetComposition value, JsonGenerator generator, SerializationContext context) {
   ...
   */
  public static class CustomJsonbDeserializer implements JsonbDeserializer<PetComposition> {
    @Override
    public PetComposition deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
      ...
      PetComposition instance = new PetComposition();
    ...
    private static java.lang.reflect.Field declaredField(String fieldName) {
      ...
      for (Class<?> clazz = PetComposition.class; clazz != null; clazz = clazz.getSuperclass()) {
        try {
      ...
      throw new IllegalArgumentException("Field " + fieldName + " not found on PetComposition");
    }
    ...
    private static void setField(PetComposition instance, String fieldName, Object value) {
      try {
        java.lang.reflect.Field field = declaredField(fieldName);
        field.setAccessible(true);
        field.set(instance, value);
      } catch (IllegalAccessException e) {
        throw new JsonbException("Unable to bind the field " + fieldName + " on PetComposition", e);
      }
    }
  }
}
