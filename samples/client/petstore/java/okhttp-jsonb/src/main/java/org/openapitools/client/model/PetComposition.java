...
public class PetComposition {
  ...
  public PetComposition id(@jakarta.annotation.Nullable Long id) {
    this.id = id;
    return this;
  }
  ...
  public PetComposition category(@jakarta.annotation.Nullable Category category) {
  ...
  public PetComposition name(@jakarta.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public PetComposition photoUrls(@jakarta.annotation.Nonnull List<String> photoUrls) {
  ...
  public PetComposition tags(@jakarta.annotation.Nullable List<Tag> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public PetComposition status(@jakarta.annotation.Nullable StatusEnum status) {
    this.status = status;
    return this;
  }
