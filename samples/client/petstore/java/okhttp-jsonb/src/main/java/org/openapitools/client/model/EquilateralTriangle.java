...
public class EquilateralTriangle {
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<EquilateralTriangle> {
    @Override
    public void serialize(EquilateralTriangle value, JsonGenerator generator, SerializationContext context) {
   ...
   */
  public static class CustomJsonbDeserializer implements JsonbDeserializer<EquilateralTriangle> {
    @Override
    public EquilateralTriangle deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
      ...
      EquilateralTriangle instance = new EquilateralTriangle();
    ...
    private static java.lang.reflect.Field declaredField(String fieldName) {
      ...
      for (Class<?> clazz = EquilateralTriangle.class; clazz != null; clazz = clazz.getSuperclass()) {
        try {
      ...
      throw new IllegalArgumentException("Field " + fieldName + " not found on EquilateralTriangle");
    }
    ...
    private static void setField(EquilateralTriangle instance, String fieldName, Object value) {
      try {
        java.lang.reflect.Field field = declaredField(fieldName);
        field.setAccessible(true);
        field.set(instance, value);
      } catch (IllegalAccessException e) {
        throw new JsonbException("Unable to bind the field " + fieldName + " on EquilateralTriangle", e);
      }
    }
  }
}
