...
@JsonbTypeDeserializer(AllOfModelArrayAnyOfAllOfAttributesC.AllOfModelArrayAnyOfAllOfAttributesCDeserializer.class)
@JsonbTypeSerializer(AllOfModelArrayAnyOfAllOfAttributesC.AllOfModelArrayAnyOfAllOfAttributesCSerializer.class)
public class AllOfModelArrayAnyOfAllOfAttributesC extends AbstractOpenApiSchema {
  ...
  public Object getAdditionalProperty(String key) {
    ...
    public static class AllOfModelArrayAnyOfAllOfAttributesCSerializer implements JsonbSerializer<AllOfModelArrayAnyOfAllOfAttributesC> {
        @Override
        public void serialize(AllOfModelArrayAnyOfAllOfAttributesC obj, JsonGenerator generator, SerializationContext ctx) {
     ...
     */
    private static void collectUnconsumedProperties(AllOfModelArrayAnyOfAllOfAttributesC instance, JsonObject jsonObject) {
    ...
    public static class AllOfModelArrayAnyOfAllOfAttributesCDeserializer implements JsonbDeserializer<AllOfModelArrayAnyOfAllOfAttributesC> {
        @Override
        public AllOfModelArrayAnyOfAllOfAttributesC deserialize(JsonParser parser, DeserializationContext ctx, Type rt) {
            JsonValue jsonValue = parser.getValue();
            if (jsonValue == null || jsonValue.getValueType() == JsonValue.ValueType.NULL) {
                throw new RuntimeException("AllOfModelArrayAnyOfAllOfAttributesC cannot be null");
            }
            ...
            // deserialize Pet
            try {
                deserialized = deserializeBranch(Pet.class, jsonValue);
                match++;
            } catch (Exception e) {
            ...
            // deserialize Order
            try {
                deserialized = deserializeBranch(Order.class, jsonValue);
                match++;
            } catch (Exception e) {
                // deserialization failed, continue
            }
            ...
            throw new RuntimeException(String.format(java.util.Locale.ROOT, "Failed deserialization for AllOfModelArrayAnyOfAllOfAttributesC: %d classes match result, expected 1", match));
        }
    }
