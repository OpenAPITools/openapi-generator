...
public class NumberOnly {
   ...
   */
  public NumberOnly putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.justNumber, numberOnly.justNumber)&&
        Objects.equals(this.additionalProperties, numberOnly.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(justNumber, additionalProperties);
  }
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<NumberOnly> {
    @Override
    public void serialize(NumberOnly value, JsonGenerator generator, SerializationContext context) {
      generator.writeStartObject();
      if (value.getJustNumber() != null) {
        context.serialize("JustNumber", value.getJustNumber(), generator);
      }
   ...
   */
  public static class CustomJsonbDeserializer implements JsonbDeserializer<NumberOnly> {
    @Override
    public NumberOnly deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
      ...
      NumberOnly instance = new NumberOnly();
      if (jsonObj.containsKey("JustNumber")) {
        instance.setJustNumber(jsonObj.get("JustNumber").getValueType() == JsonValue.ValueType.NULL
            ? null
            : jsonb.fromJson(jsonObj.get("JustNumber").toString(), fieldType("justNumber")));
      }
    ...
    private static java.lang.reflect.Field declaredField(String fieldName) {
      ...
      for (Class<?> clazz = NumberOnly.class; clazz != null; clazz = clazz.getSuperclass()) {
        try {
      ...
      throw new IllegalArgumentException("Field " + fieldName + " not found on NumberOnly");
    }
    ...
    private static void setField(NumberOnly instance, String fieldName, Object value) {
      try {
        java.lang.reflect.Field field = declaredField(fieldName);
        field.setAccessible(true);
        field.set(instance, value);
      } catch (IllegalAccessException e) {
        throw new JsonbException("Unable to bind the field " + fieldName + " on NumberOnly", e);
      }
    }
  }
  ...
  public static class Builder {
    ...
    *
    * The values are put through {@link NumberOnly#putAdditionalProperty}, so the map is
    * rebuilt on the instance that actually owns it: a subclass declares its own holder that
    * shadows the parent one, and the virtual call always reaches the subclass field.
    */
    public NumberOnly.Builder additionalProperties(Map<String, Object> additionalProperties) {
