...
@JsonbTypeDeserializer(FruitReq.FruitReqDeserializer.class)
@JsonbTypeSerializer(FruitReq.FruitReqSerializer.class)
public class FruitReq extends AbstractOpenApiSchema {
    ...
    public static class FruitReqSerializer implements JsonbSerializer<FruitReq> {
        @Override
        public void serialize(FruitReq obj, JsonGenerator generator, SerializationContext ctx) {
    ...
    public static class FruitReqDeserializer implements JsonbDeserializer<FruitReq> {
        ...
        public FruitReq deserialize(JsonParser parser, DeserializationContext ctx, Type rt) {
            ...
            try {
                deserialized = deserializeBranch(AppleReq.class, jsonValue);
                match++;
            } catch (Exception e) {
            ...
            try {
                deserialized = deserializeBranch(BananaReq.class, jsonValue);
                match++;
            } catch (Exception e) {
                // deserialization failed, continue
            }
            ...
            throw new RuntimeException(String.format(java.util.Locale.ROOT, "Failed deserialization for FruitReq: %d classes match result, expected 1", match));
        }
    }
