...
public enum OuterEnumInteger {
  ...
  public static class Adapter implements JsonbAdapter<OuterEnumInteger, Integer> {
    @Override
    public Integer adaptToJson(OuterEnumInteger enumeration) {
      return enumeration == null ? null : enumeration.getValue();
    }

    @Override
    public OuterEnumInteger adaptFromJson(Integer value) {
      return value == null ? null : OuterEnumInteger.fromValue(value);
    }
  }
}
