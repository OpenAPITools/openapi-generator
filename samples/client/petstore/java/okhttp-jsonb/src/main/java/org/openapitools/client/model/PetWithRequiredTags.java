...
public class PetWithRequiredTags {
  ...
  public PetWithRequiredTags id(@jakarta.annotation.Nullable Long id) {
    this.id = id;
    return this;
  }
  ...
  public PetWithRequiredTags category(@jakarta.annotation.Nullable Category category) {
  ...
  public PetWithRequiredTags name(@jakarta.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public PetWithRequiredTags photoUrls(@jakarta.annotation.Nonnull List<String> photoUrls) {
  ...
  public PetWithRequiredTags tags(@jakarta.annotation.Nonnull List<Tag> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public PetWithRequiredTags status(@jakarta.annotation.Nullable StatusEnum status) {
    this.status = status;
    return this;
  }
