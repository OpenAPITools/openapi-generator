...
public class PetWithRequiredTags {
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("name", "photoUrls", "tags"));
  }
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<PetWithRequiredTags> {
    @Override
    public void serialize(PetWithRequiredTags value, JsonGenerator generator, SerializationContext context) {
   ...
   */
  public static class CustomJsonbDeserializer implements JsonbDeserializer<PetWithRequiredTags> {
    @Override
    public PetWithRequiredTags deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
      ...
      PetWithRequiredTags instance = new PetWithRequiredTags();
    ...
    private static java.lang.reflect.Field declaredField(String fieldName) {
      ...
      for (Class<?> clazz = PetWithRequiredTags.class; clazz != null; clazz = clazz.getSuperclass()) {
        try {
      ...
      throw new IllegalArgumentException("Field " + fieldName + " not found on PetWithRequiredTags");
    }
    ...
    private static void setField(PetWithRequiredTags instance, String fieldName, Object value) {
      try {
        java.lang.reflect.Field field = declaredField(fieldName);
        field.setAccessible(true);
        field.set(instance, value);
      } catch (IllegalAccessException e) {
        throw new JsonbException("Unable to bind the field " + fieldName + " on PetWithRequiredTags", e);
      }
    }
  }
  ...
  public static class Builder {
    ...
    *
    * The values are put through {@link PetWithRequiredTags#putAdditionalProperty}, so the map is
    * rebuilt on the instance that actually owns it: a subclass declares its own holder that
    * shadows the parent one, and the virtual call always reaches the subclass field.
    */
    public PetWithRequiredTags.Builder additionalProperties(Map<String, Object> additionalProperties) {
