...
public class BasquePig {
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<BasquePig> {
    @Override
    public void serialize(BasquePig value, JsonGenerator generator, SerializationContext context) {
   ...
   */
  public static class CustomJsonbDeserializer implements JsonbDeserializer<BasquePig> {
    @Override
    public BasquePig deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
      ...
      BasquePig instance = new BasquePig();
    ...
    private static java.lang.reflect.Field declaredField(String fieldName) {
      ...
      for (Class<?> clazz = BasquePig.class; clazz != null; clazz = clazz.getSuperclass()) {
        try {
      ...
      throw new IllegalArgumentException("Field " + fieldName + " not found on BasquePig");
    }
    ...
    private static void setField(BasquePig instance, String fieldName, Object value) {
      try {
        java.lang.reflect.Field field = declaredField(fieldName);
        field.setAccessible(true);
        field.set(instance, value);
      } catch (IllegalAccessException e) {
        throw new JsonbException("Unable to bind the field " + fieldName + " on BasquePig", e);
      }
    }
  }
