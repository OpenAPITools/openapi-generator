...
public class EnumStringDiscriminator {
  ...
  @JsonbTypeAdapter(EnumStrTypeEnum.Adapter.class)
  public enum EnumStrTypeEnum {
    ...
    public static class Adapter implements JsonbAdapter<EnumStrTypeEnum, String> {
      @Override
      public String adaptToJson(EnumStrTypeEnum enumeration) {
        return enumeration == null ? null : enumeration.getValue();
      }

      @Override
      public EnumStrTypeEnum adaptFromJson(String value) {
        return value == null ? null : EnumStrTypeEnum.fromValue(value);
      }
    }
  }
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<EnumStringDiscriminator> {
    @Override
    public void serialize(EnumStringDiscriminator value, JsonGenerator generator, SerializationContext context) {
      generator.writeStartObject();
      if (value.getEnumStrType() != null) {
        context.serialize("enum_str_type", value.getEnumStrType(), generator);
      }
   ...
   */
  public static class CustomJsonbDeserializer implements JsonbDeserializer<EnumStringDiscriminator> {
    @Override
    public EnumStringDiscriminator deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
      ...
      EnumStringDiscriminator instance = new EnumStringDiscriminator();
      if (jsonObj.containsKey("enum_str_type")) {
        instance.setEnumStrType(jsonObj.get("enum_str_type").getValueType() == JsonValue.ValueType.NULL
            ? null
            : jsonb.fromJson(jsonObj.get("enum_str_type").toString(), fieldType("enumStrType")));
      }
    ...
    private static java.lang.reflect.Field declaredField(String fieldName) {
      ...
      for (Class<?> clazz = EnumStringDiscriminator.class; clazz != null; clazz = clazz.getSuperclass()) {
        try {
      ...
      throw new IllegalArgumentException("Field " + fieldName + " not found on EnumStringDiscriminator");
    }
    ...
    private static void setField(EnumStringDiscriminator instance, String fieldName, Object value) {
      try {
        java.lang.reflect.Field field = declaredField(fieldName);
        field.setAccessible(true);
        field.set(instance, value);
      } catch (IllegalAccessException e) {
        throw new JsonbException("Unable to bind the field " + fieldName + " on EnumStringDiscriminator", e);
      }
    }
  }
}
