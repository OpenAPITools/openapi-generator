...
public class Name {
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<Name> {
    @Override
    public void serialize(Name value, JsonGenerator generator, SerializationContext context) {
      generator.writeStartObject();
      if (value.getName() != null) {
        context.serialize("name", value.getName(), generator);
      }
      if (value.getSnakeCase() != null) {
        context.serialize("snake_case", value.getSnakeCase(), generator);
      }
      if (value.getProperty() != null) {
        context.serialize("property", value.getProperty(), generator);
      }
      if (value.get123number() != null) {
        context.serialize("123Number", value.get123number(), generator);
      }
   ...
   */
  public static class CustomJsonbDeserializer implements JsonbDeserializer<Name> {
    @Override
    public Name deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
      ...
      if (jsonObj.containsKey("snake_case")) {
        // readOnly properties have no setter; bind the declared field directly
        setField(instance, "snakeCase", jsonObj.get("snake_case").getValueType() == JsonValue.ValueType.NULL
            ? null
            : jsonb.fromJson(jsonObj.get("snake_case").toString(), fieldType("snakeCase")));
      }
      if (jsonObj.containsKey("property")) {
        instance.setProperty(jsonObj.get("property").getValueType() == JsonValue.ValueType.NULL
            ? null
            : jsonb.fromJson(jsonObj.get("property").toString(), fieldType("property")));
      }
      if (jsonObj.containsKey("123Number")) {
        // readOnly properties have no setter; bind the declared field directly
        setField(instance, "_123number", jsonObj.get("123Number").getValueType() == JsonValue.ValueType.NULL
            ? null
            : jsonb.fromJson(jsonObj.get("123Number").toString(), fieldType("_123number")));
      }
    ...
    private static java.lang.reflect.Field declaredField(String fieldName) {
      ...
      for (Class<?> clazz = Name.class; clazz != null; clazz = clazz.getSuperclass()) {
        try {
      ...
      throw new IllegalArgumentException("Field " + fieldName + " not found on Name");
    }
    ...
    private static void setField(Name instance, String fieldName, Object value) {
      try {
        java.lang.reflect.Field field = declaredField(fieldName);
        field.setAccessible(true);
        field.set(instance, value);
      } catch (IllegalAccessException e) {
        throw new JsonbException("Unable to bind the field " + fieldName + " on Name", e);
      }
    }
  }
}
