...
@JsonbTypeDeserializer(ScalarAnyOf.ScalarAnyOfDeserializer.class)
@JsonbTypeSerializer(ScalarAnyOf.ScalarAnyOfSerializer.class)
public class ScalarAnyOf extends AbstractOpenApiSchema {
  ...
  public Object getAdditionalProperty(String key) {
    ...
    public static class ScalarAnyOfSerializer implements JsonbSerializer<ScalarAnyOf> {
        @Override
        public void serialize(ScalarAnyOf obj, JsonGenerator generator, SerializationContext ctx) {
     ...
     */
    private static void collectUnconsumedProperties(ScalarAnyOf instance, JsonObject jsonObject) {
    ...
    public static class ScalarAnyOfDeserializer implements JsonbDeserializer<ScalarAnyOf> {
        ...
        public ScalarAnyOf deserialize(JsonParser parser, DeserializationContext ctx, Type rt) {
            ...
            throw new RuntimeException(String.format(java.util.Locale.ROOT, "Failed deserialization for ScalarAnyOf: no match found"));
        }
    }
