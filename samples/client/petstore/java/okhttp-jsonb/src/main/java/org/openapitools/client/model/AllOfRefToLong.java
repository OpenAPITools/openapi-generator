...
public class AllOfRefToLong {
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<AllOfRefToLong> {
    @Override
    public void serialize(AllOfRefToLong value, JsonGenerator generator, SerializationContext context) {
   ...
   */
  public static class CustomJsonbDeserializer implements JsonbDeserializer<AllOfRefToLong> {
    @Override
    public AllOfRefToLong deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
      ...
      AllOfRefToLong instance = new AllOfRefToLong();
    ...
    private static java.lang.reflect.Field declaredField(String fieldName) {
      ...
      for (Class<?> clazz = AllOfRefToLong.class; clazz != null; clazz = clazz.getSuperclass()) {
        try {
      ...
      throw new IllegalArgumentException("Field " + fieldName + " not found on AllOfRefToLong");
    }
    ...
    private static void setField(AllOfRefToLong instance, String fieldName, Object value) {
      try {
        java.lang.reflect.Field field = declaredField(fieldName);
        field.setAccessible(true);
        field.set(instance, value);
      } catch (IllegalAccessException e) {
        throw new JsonbException("Unable to bind the field " + fieldName + " on AllOfRefToLong", e);
      }
    }
  }
}
