...
public class Foo {
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<Foo> {
    @Override
    public void serialize(Foo value, JsonGenerator generator, SerializationContext context) {
  ...
  public static class CustomJsonbDeserializer implements JsonbDeserializer<Foo> {
    ...
    public Foo deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
      ...
      if (jsonObj.containsKey("bar")) {
        instance.setBar(jsonObj.get("bar").getValueType() == JsonValue.ValueType.NULL
            ? null
  ...
  public static class Builder {
    ...
    *
    * The values are put through {@link Foo#putAdditionalProperty}, so the map is
    * rebuilt on the instance that actually owns it: a subclass declares its own holder that
    * shadows the parent one, and the virtual call always reaches the subclass field.
    */
    public Foo.Builder additionalProperties(Map<String, Object> additionalProperties) {
