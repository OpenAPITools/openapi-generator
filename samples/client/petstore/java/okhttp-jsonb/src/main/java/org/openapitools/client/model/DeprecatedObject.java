...
public class DeprecatedObject {
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<DeprecatedObject> {
    @Override
    public void serialize(DeprecatedObject value, JsonGenerator generator, SerializationContext context) {
   ...
   */
  public static class CustomJsonbDeserializer implements JsonbDeserializer<DeprecatedObject> {
    @Override
    public DeprecatedObject deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
      ...
      DeprecatedObject instance = new DeprecatedObject();
    ...
    private static java.lang.reflect.Field declaredField(String fieldName) {
      ...
      for (Class<?> clazz = DeprecatedObject.class; clazz != null; clazz = clazz.getSuperclass()) {
        try {
      ...
      throw new IllegalArgumentException("Field " + fieldName + " not found on DeprecatedObject");
    }
    ...
    private static void setField(DeprecatedObject instance, String fieldName, Object value) {
      try {
        java.lang.reflect.Field field = declaredField(fieldName);
        field.setAccessible(true);
        field.set(instance, value);
      } catch (IllegalAccessException e) {
        throw new JsonbException("Unable to bind the field " + fieldName + " on DeprecatedObject", e);
      }
    }
  }
