...
public class Mammal extends AbstractOpenApiSchema {
  ...
  public Object getAdditionalProperty(String key) {
     ...
     */
    private static void collectUnconsumedProperties(Mammal instance, JsonObject jsonObject) {
    ...
    public static class MammalDeserializer implements JsonbDeserializer<Mammal> {
        ...
        public Mammal deserialize(JsonParser parser, DeserializationContext ctx, Type rt) {
            ...
            if (jsonValue == null || jsonValue.getValueType() == JsonValue.ValueType.NULL) {
                throw new RuntimeException("Mammal cannot be null");
            }
            ...
            if (jsonObject != null && jsonObject.containsKey("className")) {
                ...
                if ("Pig".equals(discriminatorValue)) {
                    ...
                    if (jsonObject != null) {
                        collectUnconsumedProperties(newMammal, jsonObject);
                    }
                    return newMammal;
                }
