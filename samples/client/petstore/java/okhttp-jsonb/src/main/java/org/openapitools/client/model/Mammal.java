...
@JsonbTypeDeserializer(Mammal.MammalDeserializer.class)
@JsonbTypeSerializer(Mammal.MammalSerializer.class)
public class Mammal extends AbstractOpenApiSchema {
    ...
    public static class MammalSerializer implements JsonbSerializer<Mammal> {
        @Override
        public void serialize(Mammal obj, JsonGenerator generator, SerializationContext ctx) {
    ...
    public static class MammalDeserializer implements JsonbDeserializer<Mammal> {
        @Override
        public Mammal deserialize(JsonParser parser, DeserializationContext ctx, Type rt) {
            JsonObject jsonObject = parser.getObject();
            Object deserialized = null;
            int match = 0;
            // deserialize Whale
            try {
                deserialized = ctx.deserialize(Whale.class, jakarta.json.Json.createParser(new java.io.StringReader(jsonObject.toString())));
                match++;
            } catch (Exception e) {
            ...
            // deserialize Zebra
            try {
                deserialized = ctx.deserialize(Zebra.class, jakarta.json.Json.createParser(new java.io.StringReader(jsonObject.toString())));
                match++;
            } catch (Exception e) {
                // deserialization failed, continue
            }
            // deserialize Pig
            try {
                deserialized = ctx.deserialize(Pig.class, jakarta.json.Json.createParser(new java.io.StringReader(jsonObject.toString())));
                match++;
            } catch (Exception e) {
                // deserialization failed, continue
            }
            ...
            throw new RuntimeException(String.format(java.util.Locale.ROOT, "Failed deserialization for Mammal: %d classes match result, expected 1", match));
        }
    }
