...
public class NewPetCategoryInlineAllof {
  ...
  public NewPetCategoryInlineAllof id(@jakarta.annotation.Nullable Long id) {
    this.id = id;
    return this;
  }
  ...
  public NewPetCategoryInlineAllof name(@jakarta.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public NewPetCategoryInlineAllof categoryTag(@jakarta.annotation.Nullable NewPetCategoryInlineAllofAllOfCategoryTag categoryTag) {
  ...
  public void setCategoryTag(@jakarta.annotation.Nullable NewPetCategoryInlineAllofAllOfCategoryTag categoryTag) {
    this.categoryTag = categoryTag;
  }
