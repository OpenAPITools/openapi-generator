...
public class NewPetCategoryInlineAllof {
  ...
  @JsonbProperty(SERIALIZED_NAME_CATEGORY_TAG)
  @javax.annotation.Nullable
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<NewPetCategoryInlineAllof> {
    @Override
    public void serialize(NewPetCategoryInlineAllof value, JsonGenerator generator, SerializationContext context) {
      ...
      if (value.getCategoryTag() != null) {
        context.serialize("category_tag", value.getCategoryTag(), generator);
      }
   ...
   */
  public static class CustomJsonbDeserializer implements JsonbDeserializer<NewPetCategoryInlineAllof> {
    @Override
    public NewPetCategoryInlineAllof deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
      ...
      NewPetCategoryInlineAllof instance = new NewPetCategoryInlineAllof();
      ...
      if (jsonObj.containsKey("category_tag")) {
        instance.setCategoryTag(jsonObj.get("category_tag").getValueType() == JsonValue.ValueType.NULL
            ? null
            : jsonb.fromJson(jsonObj.get("category_tag").toString(), fieldType("categoryTag")));
      }
    ...
    private static java.lang.reflect.Field declaredField(String fieldName) {
      ...
      for (Class<?> clazz = NewPetCategoryInlineAllof.class; clazz != null; clazz = clazz.getSuperclass()) {
        try {
      ...
      throw new IllegalArgumentException("Field " + fieldName + " not found on NewPetCategoryInlineAllof");
    }
    ...
    private static void setField(NewPetCategoryInlineAllof instance, String fieldName, Object value) {
      try {
        java.lang.reflect.Field field = declaredField(fieldName);
        field.setAccessible(true);
        field.set(instance, value);
      } catch (IllegalAccessException e) {
        throw new JsonbException("Unable to bind the field " + fieldName + " on NewPetCategoryInlineAllof", e);
      }
    }
  }
}
