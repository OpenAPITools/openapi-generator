...
public class ArrayOfInlineAllOf {
  ...
  public ArrayOfInlineAllOf id(@jakarta.annotation.Nullable Long id) {
    this.id = id;
    return this;
  }
  ...
  public ArrayOfInlineAllOf name(@jakarta.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public ArrayOfInlineAllOf arrayAllofDogProperty(@jakarta.annotation.Nullable List<ArrayOfInlineAllOfArrayAllofDogPropertyInner> arrayAllofDogProperty) {
  ...
  public void setArrayAllofDogProperty(@jakarta.annotation.Nullable List<ArrayOfInlineAllOfArrayAllofDogPropertyInner> arrayAllofDogProperty) {
    this.arrayAllofDogProperty = arrayAllofDogProperty;
  }
