...
public class ArrayDefault {
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<ArrayDefault> {
    @Override
    public void serialize(ArrayDefault value, JsonGenerator generator, SerializationContext context) {
      generator.writeStartObject();
      if (value.getWithDefaultEmptyBracket() != null) {
        context.serialize("WithDefaultEmptyBracket", value.getWithDefaultEmptyBracket(), generator);
      }
      if (value.getWithoutDefault() != null) {
        context.serialize("WithoutDefault", value.getWithoutDefault(), generator);
      }
   ...
   */
  public static class CustomJsonbDeserializer implements JsonbDeserializer<ArrayDefault> {
    @Override
    public ArrayDefault deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
      ...
      ArrayDefault instance = new ArrayDefault();
      if (jsonObj.containsKey("WithDefaultEmptyBracket")) {
        instance.setWithDefaultEmptyBracket(jsonObj.get("WithDefaultEmptyBracket").getValueType() == JsonValue.ValueType.NULL
            ? null
            : jsonb.fromJson(jsonObj.get("WithDefaultEmptyBracket").toString(), fieldType("withDefaultEmptyBracket")));
      }
      if (jsonObj.containsKey("WithoutDefault")) {
        instance.setWithoutDefault(jsonObj.get("WithoutDefault").getValueType() == JsonValue.ValueType.NULL
            ? null
            : jsonb.fromJson(jsonObj.get("WithoutDefault").toString(), fieldType("withoutDefault")));
      }
    ...
    private static java.lang.reflect.Field declaredField(String fieldName) {
      ...
      for (Class<?> clazz = ArrayDefault.class; clazz != null; clazz = clazz.getSuperclass()) {
        try {
      ...
      throw new IllegalArgumentException("Field " + fieldName + " not found on ArrayDefault");
    }
    ...
    private static void setField(ArrayDefault instance, String fieldName, Object value) {
      try {
        java.lang.reflect.Field field = declaredField(fieldName);
        field.setAccessible(true);
        field.set(instance, value);
      } catch (IllegalAccessException e) {
        throw new JsonbException("Unable to bind the field " + fieldName + " on ArrayDefault", e);
      }
    }
  }
}
