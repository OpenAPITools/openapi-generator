...
public class Dog extends Animal {
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<Dog> {
    @Override
    public void serialize(Dog value, JsonGenerator generator, SerializationContext context) {
      ...
      if (value.getBreed() != null) {
        context.serialize("breed", value.getBreed(), generator);
      }
   ...
   */
  public static class CustomJsonbDeserializer implements JsonbDeserializer<Dog> {
    @Override
    public Dog deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
      ...
      if (jsonObj.containsKey("breed")) {
        instance.setBreed(jsonObj.get("breed").getValueType() == JsonValue.ValueType.NULL
            ? null
            : jsonb.fromJson(jsonObj.get("breed").toString(), fieldType("breed")));
      }
    ...
    private static java.lang.reflect.Field declaredField(String fieldName) {
      ...
      for (Class<?> clazz = Dog.class; clazz != null; clazz = clazz.getSuperclass()) {
        try {
      ...
      throw new IllegalArgumentException("Field " + fieldName + " not found on Dog");
    }
    ...
    private static void setField(Dog instance, String fieldName, Object value) {
      try {
        java.lang.reflect.Field field = declaredField(fieldName);
        field.setAccessible(true);
        field.set(instance, value);
      } catch (IllegalAccessException e) {
        throw new JsonbException("Unable to bind the field " + fieldName + " on Dog", e);
      }
    }
  }
}
