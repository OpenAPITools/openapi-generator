...
public class DanishPig {
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<DanishPig> {
    @Override
    public void serialize(DanishPig value, JsonGenerator generator, SerializationContext context) {
   ...
   */
  public static class CustomJsonbDeserializer implements JsonbDeserializer<DanishPig> {
    @Override
    public DanishPig deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
      ...
      DanishPig instance = new DanishPig();
    ...
    private static java.lang.reflect.Field declaredField(String fieldName) {
      ...
      for (Class<?> clazz = DanishPig.class; clazz != null; clazz = clazz.getSuperclass()) {
        try {
      ...
      throw new IllegalArgumentException("Field " + fieldName + " not found on DanishPig");
    }
    ...
    private static void setField(DanishPig instance, String fieldName, Object value) {
      try {
        java.lang.reflect.Field field = declaredField(fieldName);
        field.setAccessible(true);
        field.set(instance, value);
      } catch (IllegalAccessException e) {
        throw new JsonbException("Unable to bind the field " + fieldName + " on DanishPig", e);
      }
    }
  }
