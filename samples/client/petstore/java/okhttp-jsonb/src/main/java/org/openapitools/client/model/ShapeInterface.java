...
public class ShapeInterface {
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<ShapeInterface> {
    @Override
    public void serialize(ShapeInterface value, JsonGenerator generator, SerializationContext context) {
   ...
   */
  public static class CustomJsonbDeserializer implements JsonbDeserializer<ShapeInterface> {
    @Override
    public ShapeInterface deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
      ...
      ShapeInterface instance = new ShapeInterface();
    ...
    private static java.lang.reflect.Field declaredField(String fieldName) {
      ...
      for (Class<?> clazz = ShapeInterface.class; clazz != null; clazz = clazz.getSuperclass()) {
        try {
      ...
      throw new IllegalArgumentException("Field " + fieldName + " not found on ShapeInterface");
    }
    ...
    private static void setField(ShapeInterface instance, String fieldName, Object value) {
      try {
        java.lang.reflect.Field field = declaredField(fieldName);
        field.setAccessible(true);
        field.set(instance, value);
      } catch (IllegalAccessException e) {
        throw new JsonbException("Unable to bind the field " + fieldName + " on ShapeInterface", e);
      }
    }
  }
