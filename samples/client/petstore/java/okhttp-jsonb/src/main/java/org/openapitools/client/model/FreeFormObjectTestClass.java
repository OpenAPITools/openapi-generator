...
public class FreeFormObjectTestClass {
  ...
  public FreeFormObjectTestClass name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public FreeFormObjectTestClass properties(@jakarta.annotation.Nullable FreeFormObjectTestClassProperties properties) {
  ...
  public void setProperties(@jakarta.annotation.Nullable FreeFormObjectTestClassProperties properties) {
    this.properties = properties;
  }
