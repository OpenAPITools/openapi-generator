...
public class FreeFormObjectTestClass {
  ...
  @JsonbProperty(SERIALIZED_NAME_PROPERTIES)
  @javax.annotation.Nullable
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<FreeFormObjectTestClass> {
    @Override
    public void serialize(FreeFormObjectTestClass value, JsonGenerator generator, SerializationContext context) {
      generator.writeStartObject();
      if (value.getName() != null) {
        context.serialize("name", value.getName(), generator);
      }
      if (value.getProperties() != null) {
        context.serialize("properties", value.getProperties(), generator);
      }
   ...
   */
  public static class CustomJsonbDeserializer implements JsonbDeserializer<FreeFormObjectTestClass> {
    @Override
    public FreeFormObjectTestClass deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
      ...
      FreeFormObjectTestClass instance = new FreeFormObjectTestClass();
      ...
      if (jsonObj.containsKey("properties")) {
        instance.setProperties(jsonObj.get("properties").getValueType() == JsonValue.ValueType.NULL
            ? null
            : jsonb.fromJson(jsonObj.get("properties").toString(), fieldType("properties")));
      }
    ...
    private static java.lang.reflect.Field declaredField(String fieldName) {
      ...
      for (Class<?> clazz = FreeFormObjectTestClass.class; clazz != null; clazz = clazz.getSuperclass()) {
        try {
      ...
      throw new IllegalArgumentException("Field " + fieldName + " not found on FreeFormObjectTestClass");
    }
    ...
    private static void setField(FreeFormObjectTestClass instance, String fieldName, Object value) {
      try {
        java.lang.reflect.Field field = declaredField(fieldName);
        field.setAccessible(true);
        field.set(instance, value);
      } catch (IllegalAccessException e) {
        throw new JsonbException("Unable to bind the field " + fieldName + " on FreeFormObjectTestClass", e);
      }
    }
  }
}
