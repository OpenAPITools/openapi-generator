...
public class PetUsingAllOf {
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<PetUsingAllOf> {
    @Override
    public void serialize(PetUsingAllOf value, JsonGenerator generator, SerializationContext context) {
   ...
   */
  public static class CustomJsonbDeserializer implements JsonbDeserializer<PetUsingAllOf> {
    @Override
    public PetUsingAllOf deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
      ...
      PetUsingAllOf instance = new PetUsingAllOf();
    ...
    private static java.lang.reflect.Field declaredField(String fieldName) {
      ...
      for (Class<?> clazz = PetUsingAllOf.class; clazz != null; clazz = clazz.getSuperclass()) {
        try {
      ...
      throw new IllegalArgumentException("Field " + fieldName + " not found on PetUsingAllOf");
    }
    ...
    private static void setField(PetUsingAllOf instance, String fieldName, Object value) {
      try {
        java.lang.reflect.Field field = declaredField(fieldName);
        field.setAccessible(true);
        field.set(instance, value);
      } catch (IllegalAccessException e) {
        throw new JsonbException("Unable to bind the field " + fieldName + " on PetUsingAllOf", e);
      }
    }
  }
}
