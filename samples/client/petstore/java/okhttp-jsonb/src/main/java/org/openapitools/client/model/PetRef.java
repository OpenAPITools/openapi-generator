...
public class PetRef {
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<PetRef> {
    @Override
    public void serialize(PetRef value, JsonGenerator generator, SerializationContext context) {
   ...
   */
  public static class CustomJsonbDeserializer implements JsonbDeserializer<PetRef> {
    @Override
    public PetRef deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
    ...
    private static java.lang.reflect.Field declaredField(String fieldName) {
      ...
      for (Class<?> clazz = PetRef.class; clazz != null; clazz = clazz.getSuperclass()) {
        try {
      ...
      throw new IllegalArgumentException("Field " + fieldName + " not found on PetRef");
    }
    ...
    private static void setField(PetRef instance, String fieldName, Object value) {
      try {
        java.lang.reflect.Field field = declaredField(fieldName);
        field.setAccessible(true);
        field.set(instance, value);
      } catch (IllegalAccessException e) {
        throw new JsonbException("Unable to bind the field " + fieldName + " on PetRef", e);
      }
    }
  }
}
