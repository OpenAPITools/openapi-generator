...
public class AllOfModelArrayAnyOfAllOfAttributes {
  ...
  @JsonbProperty(SERIALIZED_NAME_C)
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<AllOfModelArrayAnyOfAllOfAttributes> {
    @Override
    public void serialize(AllOfModelArrayAnyOfAllOfAttributes value, JsonGenerator generator, SerializationContext context) {
      generator.writeStartObject();
      if (value.getC() != null) {
        context.serialize("C", value.getC(), generator);
      }
   ...
   */
  public static class CustomJsonbDeserializer implements JsonbDeserializer<AllOfModelArrayAnyOfAllOfAttributes> {
    @Override
    public AllOfModelArrayAnyOfAllOfAttributes deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
      ...
      AllOfModelArrayAnyOfAllOfAttributes instance = new AllOfModelArrayAnyOfAllOfAttributes();
      if (jsonObj.containsKey("C")) {
        instance.setC(jsonObj.get("C").getValueType() == JsonValue.ValueType.NULL
            ? null
            : jsonb.fromJson(jsonObj.get("C").toString(), fieldType("C")));
      }
    ...
    private static java.lang.reflect.Field declaredField(String fieldName) {
      ...
      for (Class<?> clazz = AllOfModelArrayAnyOfAllOfAttributes.class; clazz != null; clazz = clazz.getSuperclass()) {
        try {
      ...
      throw new IllegalArgumentException("Field " + fieldName + " not found on AllOfModelArrayAnyOfAllOfAttributes");
    }
    ...
    private static void setField(AllOfModelArrayAnyOfAllOfAttributes instance, String fieldName, Object value) {
      try {
        java.lang.reflect.Field field = declaredField(fieldName);
        field.setAccessible(true);
        field.set(instance, value);
      } catch (IllegalAccessException e) {
        throw new JsonbException("Unable to bind the field " + fieldName + " on AllOfModelArrayAnyOfAllOfAttributes", e);
      }
    }
  }
}
