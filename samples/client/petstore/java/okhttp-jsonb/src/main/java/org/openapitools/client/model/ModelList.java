...
public class ModelList {
  ...
  @JsonbProperty(SERIALIZED_NAME_123LIST)
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<ModelList> {
    @Override
    public void serialize(ModelList value, JsonGenerator generator, SerializationContext context) {
      generator.writeStartObject();
      if (value.get123list() != null) {
        context.serialize("123-list", value.get123list(), generator);
      }
   ...
   */
  public static class CustomJsonbDeserializer implements JsonbDeserializer<ModelList> {
    @Override
    public ModelList deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
      ...
      if (jsonObj.containsKey("123-list")) {
        instance.set123list(jsonObj.get("123-list").getValueType() == JsonValue.ValueType.NULL
            ? null
            : jsonb.fromJson(jsonObj.get("123-list").toString(), fieldType("_123list")));
      }
    ...
    private static java.lang.reflect.Field declaredField(String fieldName) {
      ...
      for (Class<?> clazz = ModelList.class; clazz != null; clazz = clazz.getSuperclass()) {
        try {
      ...
      throw new IllegalArgumentException("Field " + fieldName + " not found on ModelList");
    }
    ...
    private static void setField(ModelList instance, String fieldName, Object value) {
      try {
        java.lang.reflect.Field field = declaredField(fieldName);
        field.setAccessible(true);
        field.set(instance, value);
      } catch (IllegalAccessException e) {
        throw new JsonbException("Unable to bind the field " + fieldName + " on ModelList", e);
      }
    }
  }
}
