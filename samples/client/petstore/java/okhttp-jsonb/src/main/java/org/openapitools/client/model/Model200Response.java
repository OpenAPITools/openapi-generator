...
public class Model200Response {
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<Model200Response> {
    @Override
    public void serialize(Model200Response value, JsonGenerator generator, SerializationContext context) {
      generator.writeStartObject();
      if (value.getName() != null) {
        context.serialize("name", value.getName(), generator);
      }
      if (value.getPropertyClass() != null) {
        context.serialize("class", value.getPropertyClass(), generator);
      }
   ...
   */
  public static class CustomJsonbDeserializer implements JsonbDeserializer<Model200Response> {
    @Override
    public Model200Response deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
      ...
      Model200Response instance = new Model200Response();
      ...
      if (jsonObj.containsKey("class")) {
        instance.setPropertyClass(jsonObj.get("class").getValueType() == JsonValue.ValueType.NULL
            ? null
            : jsonb.fromJson(jsonObj.get("class").toString(), fieldType("propertyClass")));
      }
    ...
    private static java.lang.reflect.Field declaredField(String fieldName) {
      ...
      for (Class<?> clazz = Model200Response.class; clazz != null; clazz = clazz.getSuperclass()) {
        try {
      ...
      throw new IllegalArgumentException("Field " + fieldName + " not found on Model200Response");
    }
    ...
    private static void setField(Model200Response instance, String fieldName, Object value) {
      try {
        java.lang.reflect.Field field = declaredField(fieldName);
        field.setAccessible(true);
        field.set(instance, value);
      } catch (IllegalAccessException e) {
        throw new JsonbException("Unable to bind the field " + fieldName + " on Model200Response", e);
      }
    }
  }
}
