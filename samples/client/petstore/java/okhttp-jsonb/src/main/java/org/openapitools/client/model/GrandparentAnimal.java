...
public class GrandparentAnimal {
  ...
  public static class CustomJsonbDeserializer implements JsonbDeserializer<GrandparentAnimal> {
    ...
    public GrandparentAnimal deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
      ...
      validateRequiredFields(jsonObj, openapiRequiredFields, "GrandparentAnimal");
  ...
  public static class Builder {
    ...
    *
    * The values are put through {@link GrandparentAnimal#putAdditionalProperty}, so the map is
    * rebuilt on the instance that actually owns it: a subclass declares its own holder that
    * shadows the parent one, and the virtual call always reaches the subclass field.
    */
    public GrandparentAnimal.Builder additionalProperties(Map<String, Object> additionalProperties) {
