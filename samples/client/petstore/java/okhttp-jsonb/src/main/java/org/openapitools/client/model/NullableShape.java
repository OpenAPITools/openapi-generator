...
public class NullableShape extends AbstractOpenApiSchema {
    ...
    public static class NullableShapeDeserializer implements JsonbDeserializer<NullableShape> {
        ...
        public NullableShape deserialize(JsonParser parser, DeserializationContext ctx, Type rt) {
            ...
            try {
                deserialized = ctx.deserialize(Triangle.class, jakarta.json.Json.createParser(new java.io.StringReader(jsonObject.toString())));
                match++;
            } catch (Exception e) {
            ...
            try {
                deserialized = ctx.deserialize(Quadrilateral.class, jakarta.json.Json.createParser(new java.io.StringReader(jsonObject.toString())));
                match++;
            } catch (Exception e) {
                // deserialization failed, continue
            }
