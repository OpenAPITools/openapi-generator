...
@JsonbTypeDeserializer(NullableShape.NullableShapeDeserializer.class)
@JsonbTypeSerializer(NullableShape.NullableShapeSerializer.class)
public class NullableShape extends AbstractOpenApiSchema {
  ...
  public Object getAdditionalProperty(String key) {
    ...
    public static class NullableShapeSerializer implements JsonbSerializer<NullableShape> {
        @Override
        public void serialize(NullableShape obj, JsonGenerator generator, SerializationContext ctx) {
     ...
     */
    private static void collectUnconsumedProperties(NullableShape instance, JsonObject jsonObject) {
    ...
    public static class NullableShapeDeserializer implements JsonbDeserializer<NullableShape> {
        @Override
        public NullableShape deserialize(JsonParser parser, DeserializationContext ctx, Type rt) {
            JsonValue jsonValue = parser.getValue();
            JsonObject jsonObject = jsonValue instanceof JsonObject ? (JsonObject) jsonValue : null;
            Object deserialized = null;
            if (jsonObject != null && jsonObject.containsKey("shapeType")) {
                String discriminatorValue = jsonObject.getString("shapeType");
                if ("Quadrilateral".equals(discriminatorValue)) {
                    deserialized = deserializeBranch(ctx, Quadrilateral.class, jsonValue);
                    NullableShape newNullableShape = new NullableShape();
                    newNullableShape.setActualInstance(deserialized);
                    if (jsonObject != null) {
                        collectUnconsumedProperties(newNullableShape, jsonObject);
                    }
                    return newNullableShape;
                }
                if ("Triangle".equals(discriminatorValue)) {
                    deserialized = deserializeBranch(ctx, Triangle.class, jsonValue);
                    NullableShape newNullableShape = new NullableShape();
                    newNullableShape.setActualInstance(deserialized);
                    if (jsonObject != null) {
                        collectUnconsumedProperties(newNullableShape, jsonObject);
            ...
            throw new RuntimeException(String.format(java.util.Locale.ROOT, "Failed deserialization for NullableShape: %d classes match result, expected 1", match));
        }
    }
