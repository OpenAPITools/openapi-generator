...
public class Banana {
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<Banana> {
    @Override
    public void serialize(Banana value, JsonGenerator generator, SerializationContext context) {
      generator.writeStartObject();
      if (value.getLengthCm() != null) {
        context.serialize("lengthCm", value.getLengthCm(), generator);
      }
   ...
   */
  public static class CustomJsonbDeserializer implements JsonbDeserializer<Banana> {
    @Override
    public Banana deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
    ...
    private static java.lang.reflect.Field declaredField(String fieldName) {
      ...
      for (Class<?> clazz = Banana.class; clazz != null; clazz = clazz.getSuperclass()) {
        try {
      ...
      throw new IllegalArgumentException("Field " + fieldName + " not found on Banana");
    }
    ...
    private static void setField(Banana instance, String fieldName, Object value) {
      try {
        java.lang.reflect.Field field = declaredField(fieldName);
        field.setAccessible(true);
        field.set(instance, value);
      } catch (IllegalAccessException e) {
        throw new JsonbException("Unable to bind the field " + fieldName + " on Banana", e);
      }
    }
  }
  ...
  public static class Builder {
    ...
    *
    * The values are put through {@link Banana#putAdditionalProperty}, so the map is
    * rebuilt on the instance that actually owns it: a subclass declares its own holder that
    * shadows the parent one, and the virtual call always reaches the subclass field.
    */
    public Banana.Builder additionalProperties(Map<String, Object> additionalProperties) {
