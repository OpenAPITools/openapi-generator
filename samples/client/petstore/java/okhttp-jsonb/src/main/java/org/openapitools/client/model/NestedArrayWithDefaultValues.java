...
public class NestedArrayWithDefaultValues {
  ...
  public NestedArrayWithDefaultValues nestedArray(@jakarta.annotation.Nullable List<List<String>> nestedArray) {
  ...
  public void setNestedArray(@jakarta.annotation.Nullable List<List<String>> nestedArray) {
    this.nestedArray = nestedArray;
  }
