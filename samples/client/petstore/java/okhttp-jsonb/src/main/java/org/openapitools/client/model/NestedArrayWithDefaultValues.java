...
public class NestedArrayWithDefaultValues {
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<NestedArrayWithDefaultValues> {
    @Override
    public void serialize(NestedArrayWithDefaultValues value, JsonGenerator generator, SerializationContext context) {
      generator.writeStartObject();
      if (value.getNestedArray() != null) {
        context.serialize("nestedArray", value.getNestedArray(), generator);
      }
   ...
   */
  public static class CustomJsonbDeserializer implements JsonbDeserializer<NestedArrayWithDefaultValues> {
    @Override
    public NestedArrayWithDefaultValues deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
      ...
      NestedArrayWithDefaultValues instance = new NestedArrayWithDefaultValues();
      if (jsonObj.containsKey("nestedArray")) {
        instance.setNestedArray(jsonObj.get("nestedArray").getValueType() == JsonValue.ValueType.NULL
            ? null
            : jsonb.fromJson(jsonObj.get("nestedArray").toString(), fieldType("nestedArray")));
      }
    ...
    private static java.lang.reflect.Field declaredField(String fieldName) {
      ...
      for (Class<?> clazz = NestedArrayWithDefaultValues.class; clazz != null; clazz = clazz.getSuperclass()) {
        try {
      ...
      throw new IllegalArgumentException("Field " + fieldName + " not found on NestedArrayWithDefaultValues");
    }
    ...
    private static void setField(NestedArrayWithDefaultValues instance, String fieldName, Object value) {
      try {
        java.lang.reflect.Field field = declaredField(fieldName);
        field.setAccessible(true);
        field.set(instance, value);
      } catch (IllegalAccessException e) {
        throw new JsonbException("Unable to bind the field " + fieldName + " on NestedArrayWithDefaultValues", e);
      }
    }
  }
}
