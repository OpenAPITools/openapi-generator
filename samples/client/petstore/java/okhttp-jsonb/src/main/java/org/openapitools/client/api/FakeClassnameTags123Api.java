...
public class FakeClassnameTags123Api {
     ...
     */
    public okhttp3.Call testClassnameCall(@jakarta.annotation.Nonnull Client client, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call testClassnameValidateBeforeCall(@jakarta.annotation.Nonnull Client client, final ApiCallback _callback) throws ApiException {
    ...
    public ApiResponse<Client> testClassnameWithHttpInfo(@jakarta.annotation.Nonnull Client client) throws ApiException {
        ...
        Type localVarReturnType = new JSON.GenericType<Client>(){}.getType();
     ...
     */
    public okhttp3.Call testClassnameAsync(@jakarta.annotation.Nonnull Client client, final ApiCallback<Client> _callback) throws ApiException {
