...
public class FileSchemaTestClass {
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<FileSchemaTestClass> {
    @Override
    public void serialize(FileSchemaTestClass value, JsonGenerator generator, SerializationContext context) {
      generator.writeStartObject();
      if (value.getFile() != null) {
        context.serialize("file", value.getFile(), generator);
      }
      if (value.getFiles() != null) {
        context.serialize("files", value.getFiles(), generator);
      }
   ...
   */
  public static class CustomJsonbDeserializer implements JsonbDeserializer<FileSchemaTestClass> {
    @Override
    public FileSchemaTestClass deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
      ...
      FileSchemaTestClass instance = new FileSchemaTestClass();
      ...
      if (jsonObj.containsKey("files")) {
        instance.setFiles(jsonObj.get("files").getValueType() == JsonValue.ValueType.NULL
            ? null
            : jsonb.fromJson(jsonObj.get("files").toString(), fieldType("files")));
      }
    ...
    private static java.lang.reflect.Field declaredField(String fieldName) {
      ...
      for (Class<?> clazz = FileSchemaTestClass.class; clazz != null; clazz = clazz.getSuperclass()) {
        try {
      ...
      throw new IllegalArgumentException("Field " + fieldName + " not found on FileSchemaTestClass");
    }
    ...
    private static void setField(FileSchemaTestClass instance, String fieldName, Object value) {
      try {
        java.lang.reflect.Field field = declaredField(fieldName);
        field.setAccessible(true);
        field.set(instance, value);
      } catch (IllegalAccessException e) {
        throw new JsonbException("Unable to bind the field " + fieldName + " on FileSchemaTestClass", e);
      }
    }
  }
}
