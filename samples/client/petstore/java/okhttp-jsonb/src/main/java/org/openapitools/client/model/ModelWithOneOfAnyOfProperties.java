...
public class ModelWithOneOfAnyOfProperties {
  ...
  public ModelWithOneOfAnyOfProperties oneofProp(@jakarta.annotation.Nullable ArrayOneOf oneofProp) {
  ...
  public void setOneofProp(@jakarta.annotation.Nullable ArrayOneOf oneofProp) {
    this.oneofProp = oneofProp;
  }


  public ModelWithOneOfAnyOfProperties anyofProp(@jakarta.annotation.Nullable ArrayAnyOf anyofProp) {
  ...
  public void setAnyofProp(@jakarta.annotation.Nullable ArrayAnyOf anyofProp) {
    this.anyofProp = anyofProp;
  }
