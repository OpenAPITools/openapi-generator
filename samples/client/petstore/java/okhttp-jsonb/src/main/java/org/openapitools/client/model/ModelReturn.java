...
public class ModelReturn {
   ...
   */
  public ModelReturn putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this._return, _return._return)&&
        Objects.equals(this.additionalProperties, _return.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_return, additionalProperties);
  }
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<ModelReturn> {
    @Override
    public void serialize(ModelReturn value, JsonGenerator generator, SerializationContext context) {
      generator.writeStartObject();
      if (value.getReturn() != null) {
        context.serialize("return", value.getReturn(), generator);
      }
   ...
   */
  public static class CustomJsonbDeserializer implements JsonbDeserializer<ModelReturn> {
    @Override
    public ModelReturn deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
      ...
      ModelReturn instance = new ModelReturn();
      if (jsonObj.containsKey("return")) {
        instance.setReturn(jsonObj.get("return").getValueType() == JsonValue.ValueType.NULL
            ? null
            : jsonb.fromJson(jsonObj.get("return").toString(), fieldType("_return")));
      }
    ...
    private static java.lang.reflect.Field declaredField(String fieldName) {
      ...
      for (Class<?> clazz = ModelReturn.class; clazz != null; clazz = clazz.getSuperclass()) {
        try {
      ...
      throw new IllegalArgumentException("Field " + fieldName + " not found on ModelReturn");
    }
    ...
    private static void setField(ModelReturn instance, String fieldName, Object value) {
      try {
        java.lang.reflect.Field field = declaredField(fieldName);
        field.setAccessible(true);
        field.set(instance, value);
      } catch (IllegalAccessException e) {
        throw new JsonbException("Unable to bind the field " + fieldName + " on ModelReturn", e);
      }
    }
  }
