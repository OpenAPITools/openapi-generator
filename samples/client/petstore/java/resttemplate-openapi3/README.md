# petstore-resttemplate-openapi3
...
<dependency>
  ...
  <artifactId>petstore-resttemplate-openapi3</artifactId>
...
```groovy
compile "org.openapitools:petstore-resttemplate-openapi3:1.0.0"
```
...
- `target/petstore-resttemplate-openapi3-1.0.0.jar`
- `target/lib/*.jar`
