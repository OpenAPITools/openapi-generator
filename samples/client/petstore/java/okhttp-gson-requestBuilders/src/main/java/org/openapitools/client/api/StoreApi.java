...
public class StoreApi {
    ...
    private com.squareup.okhttp.Call deleteOrderAsync(String orderId, final ApiCallback<Void> callback) throws ApiException {
    ...
    public class APIdeleteOrderRequest {
        ...
        private APIdeleteOrderRequest(String orderId) {
        ...
        public com.squareup.okhttp.Call executeAsync(final ApiCallback<Void> callback) throws ApiException {
            return deleteOrderAsync(orderId, callback);
        }
    }
     ...
     */
    public APIdeleteOrderRequest deleteOrder(String orderId) {
    ...
    private com.squareup.okhttp.Call getInventoryAsync(final ApiCallback<Map<String, Integer>> callback) throws ApiException {
    ...
    public class APIgetInventoryRequest {
         ...
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         */
        public com.squareup.okhttp.Call executeAsync(final ApiCallback<Map<String, Integer>> callback) throws ApiException {
            return getInventoryAsync(callback);
        }
    }
    ...
    private com.squareup.okhttp.Call getOrderByIdAsync(Long orderId, final ApiCallback<Order> callback) throws ApiException {
    ...
    public class APIgetOrderByIdRequest {
         ...
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         */
        public com.squareup.okhttp.Call executeAsync(final ApiCallback<Order> callback) throws ApiException {
            return getOrderByIdAsync(orderId, callback);
        }
    }
    ...
    private com.squareup.okhttp.Call placeOrderCall(Order order, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call placeOrderAsync(Order order, final ApiCallback<Order> callback) throws ApiException {
    ...
    public class APIplaceOrderRequest {
         ...
         */
        public com.squareup.okhttp.Call buildCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
            return placeOrderCall(order, progressListener, progressRequestListener);
        }
         ...
         */
        public com.squareup.okhttp.Call executeAsync(final ApiCallback<Order> callback) throws ApiException {
            return placeOrderAsync(order, callback);
        }
    }
