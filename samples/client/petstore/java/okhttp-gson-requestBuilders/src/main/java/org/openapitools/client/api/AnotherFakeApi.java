...
public class AnotherFakeApi {
    ...
    private com.squareup.okhttp.Call call123testSpecialTagsCall(Client client, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private ApiResponse<Client> call123testSpecialTagsWithHttpInfo(Client client) throws ApiException {
        com.squareup.okhttp.Call call = call123testSpecialTagsValidateBeforeCall(client, null, null);
        Type localVarReturnType = new TypeToken<Client>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    private com.squareup.okhttp.Call call123testSpecialTagsAsync(Client client, final ApiCallback<Client> callback) throws ApiException {
    ...
    public class APIcall123testSpecialTagsRequest {
        private final Client client;

        private APIcall123testSpecialTagsRequest(Client client) {
            this.client = client;
        }
        ...
        public com.squareup.okhttp.Call buildCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
            return call123testSpecialTagsCall(client, progressListener, progressRequestListener);
        }

        /**
         * Execute call123testSpecialTags request
         * @return Client
        ...
        /**
         * Execute call123testSpecialTags request with HTTP info returned
         * @return ApiResponse&lt;Client&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         */
        public ApiResponse<Client> executeWithHttpInfo() throws ApiException {
            return call123testSpecialTagsWithHttpInfo(client);
        }

        /**
         * Execute call123testSpecialTags request (asynchronously)
        ...
        public com.squareup.okhttp.Call executeAsync(final ApiCallback<Client> callback) throws ApiException {
            return call123testSpecialTagsAsync(client, callback);
        }
    }
     ...
     */
    public APIcall123testSpecialTagsRequest call123testSpecialTags(Client client) {
        return new APIcall123testSpecialTagsRequest(client);
    }
}
