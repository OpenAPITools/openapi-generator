...
public class FakeClassnameTags123Api {
    ...
    private com.squareup.okhttp.Call testClassnameCall(Client client, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private ApiResponse<Client> testClassnameWithHttpInfo(Client client) throws ApiException {
        com.squareup.okhttp.Call call = testClassnameValidateBeforeCall(client, null, null);
        Type localVarReturnType = new TypeToken<Client>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    private com.squareup.okhttp.Call testClassnameAsync(Client client, final ApiCallback<Client> callback) throws ApiException {
    ...
    public class APItestClassnameRequest {
        private final Client client;

        private APItestClassnameRequest(Client client) {
            this.client = client;
        }
        ...
        public com.squareup.okhttp.Call buildCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
            return testClassnameCall(client, progressListener, progressRequestListener);
        }

        /**
         * Execute testClassname request
         * @return Client
        ...
        /**
         * Execute testClassname request with HTTP info returned
         * @return ApiResponse&lt;Client&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         */
        public ApiResponse<Client> executeWithHttpInfo() throws ApiException {
            return testClassnameWithHttpInfo(client);
        }

        /**
         * Execute testClassname request (asynchronously)
        ...
        public com.squareup.okhttp.Call executeAsync(final ApiCallback<Client> callback) throws ApiException {
            return testClassnameAsync(client, callback);
        }
    }
     ...
     */
    public APItestClassnameRequest testClassname(Client client) {
        return new APItestClassnameRequest(client);
    }
}
