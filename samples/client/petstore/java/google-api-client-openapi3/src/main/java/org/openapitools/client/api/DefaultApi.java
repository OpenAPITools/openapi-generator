...
public class DefaultApi {
  ...
  /**
    ...
    **/
    public InlineResponseDefault fooGet() throws IOException {
        HttpResponse response = fooGetForHttpResponse();
        TypeReference<InlineResponseDefault> typeRef = new TypeReference<InlineResponseDefault>() {};
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public InlineResponseDefault fooGet(Map<String, Object> params) throws IOException {
