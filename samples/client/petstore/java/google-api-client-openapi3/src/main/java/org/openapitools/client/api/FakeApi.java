...
public class FakeApi {
  ...
  /**
    ...
    **/
    public HealthCheckResult fakeHealthGet() throws IOException {
        HttpResponse response = fakeHealthGetForHttpResponse();
        TypeReference<HealthCheckResult> typeRef = new TypeReference<HealthCheckResult>() {};
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public HealthCheckResult fakeHealthGet(Map<String, Object> params) throws IOException {
        HttpResponse response = fakeHealthGetForHttpResponse(params);
        TypeReference<HealthCheckResult> typeRef = new TypeReference<HealthCheckResult>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse fakeHealthGetForHttpResponse() throws IOException {
        
        UriBuilder uriBuilder = UriBuilder.fromUri(apiClient.getBasePath() + "/fake/health");
    ...
    public HttpResponse fakeHealthGetForHttpResponse(Map<String, Object> params) throws IOException {
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public void fakeHttpSignatureTest(Pet pet, String query1, String header1) throws IOException {
        fakeHttpSignatureTestForHttpResponse(pet, query1, header1);
    }
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public void fakeHttpSignatureTest(Pet pet, Map<String, Object> params) throws IOException {
        fakeHttpSignatureTestForHttpResponse(pet, params);
    }

    public HttpResponse fakeHttpSignatureTestForHttpResponse(Pet pet, String query1, String header1) throws IOException {
        // verify the required parameter 'pet' is set
        if (pet == null) {
            throw new IllegalArgumentException("Missing the required parameter 'pet' when calling fakeHttpSignatureTest");
        }
        UriBuilder uriBuilder = UriBuilder.fromUri(apiClient.getBasePath() + "/fake/http-signature-test");
        if (query1 != null) {
            String key = "query_1";
            Object value = query1;
            if (value instanceof Collection) {
      ...
      public HttpResponse fakeHttpSignatureTestForHttpResponse(java.io.InputStream pet, String query1, String header1, String mediaType) throws IOException {
          // verify the required parameter 'pet' is set
              if (pet == null) {
              throw new IllegalArgumentException("Missing the required parameter 'pet' when calling fakeHttpSignatureTest");
              }
    ...
    public HttpResponse fakeHttpSignatureTestForHttpResponse(Pet pet, Map<String, Object> params) throws IOException {
        // verify the required parameter 'pet' is set
        if (pet == null) {
            throw new IllegalArgumentException("Missing the required parameter 'pet' when calling fakeHttpSignatureTest");
        }
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public OuterObjectWithEnumProperty fakePropertyEnumIntegerSerialize(OuterObjectWithEnumProperty outerObjectWithEnumProperty) throws IOException {
        HttpResponse response = fakePropertyEnumIntegerSerializeForHttpResponse(outerObjectWithEnumProperty);
        TypeReference<OuterObjectWithEnumProperty> typeRef = new TypeReference<OuterObjectWithEnumProperty>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public OuterObjectWithEnumProperty fakePropertyEnumIntegerSerialize(OuterObjectWithEnumProperty outerObjectWithEnumProperty, Map<String, Object> params) throws IOException {
        HttpResponse response = fakePropertyEnumIntegerSerializeForHttpResponse(outerObjectWithEnumProperty, params);
        TypeReference<OuterObjectWithEnumProperty> typeRef = new TypeReference<OuterObjectWithEnumProperty>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse fakePropertyEnumIntegerSerializeForHttpResponse(OuterObjectWithEnumProperty outerObjectWithEnumProperty) throws IOException {
        // verify the required parameter 'outerObjectWithEnumProperty' is set
        if (outerObjectWithEnumProperty == null) {
            throw new IllegalArgumentException("Missing the required parameter 'outerObjectWithEnumProperty' when calling fakePropertyEnumIntegerSerialize");
        }
        UriBuilder uriBuilder = UriBuilder.fromUri(apiClient.getBasePath() + "/fake/property/enum-int");

        String localVarUrl = uriBuilder.build().toString();
        GenericUrl genericUrl = new GenericUrl(localVarUrl);

        HttpContent content = apiClient.new JacksonJsonHttpContent(outerObjectWithEnumProperty);
        return apiClient.getHttpRequestFactory().buildRequest(HttpMethods.POST, genericUrl, content).execute();
    }

      public HttpResponse fakePropertyEnumIntegerSerializeForHttpResponse(java.io.InputStream outerObjectWithEnumProperty, String mediaType) throws IOException {
          // verify the required parameter 'outerObjectWithEnumProperty' is set
              if (outerObjectWithEnumProperty == null) {
              throw new IllegalArgumentException("Missing the required parameter 'outerObjectWithEnumProperty' when calling fakePropertyEnumIntegerSerialize");
              }
              ...
              HttpContent content = outerObjectWithEnumProperty == null ?
                apiClient.new JacksonJsonHttpContent(null) :
                new InputStreamContent(mediaType == null ? Json.MEDIA_TYPE : mediaType, outerObjectWithEnumProperty);
              return apiClient.getHttpRequestFactory().buildRequest(HttpMethods.POST, genericUrl, content).execute();
      }

    public HttpResponse fakePropertyEnumIntegerSerializeForHttpResponse(OuterObjectWithEnumProperty outerObjectWithEnumProperty, Map<String, Object> params) throws IOException {
        // verify the required parameter 'outerObjectWithEnumProperty' is set
        if (outerObjectWithEnumProperty == null) {
            throw new IllegalArgumentException("Missing the required parameter 'outerObjectWithEnumProperty' when calling fakePropertyEnumIntegerSerialize");
        }
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public void testBodyWithBinary(File body) throws IOException {
        testBodyWithBinaryForHttpResponse(body);
    }
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public void testBodyWithBinary(File body, Map<String, Object> params) throws IOException {
        testBodyWithBinaryForHttpResponse(body, params);
    }

    public HttpResponse testBodyWithBinaryForHttpResponse(File body) throws IOException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new IllegalArgumentException("Missing the required parameter 'body' when calling testBodyWithBinary");
        }
        UriBuilder uriBuilder = UriBuilder.fromUri(apiClient.getBasePath() + "/fake/body-with-binary");
      ...
      public HttpResponse testBodyWithBinaryForHttpResponse(java.io.InputStream body, String mediaType) throws IOException {
          // verify the required parameter 'body' is set
              if (body == null) {
              throw new IllegalArgumentException("Missing the required parameter 'body' when calling testBodyWithBinary");
              }
    ...
    public HttpResponse testBodyWithBinaryForHttpResponse(File body, Map<String, Object> params) throws IOException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new IllegalArgumentException("Missing the required parameter 'body' when calling testBodyWithBinary");
        }
