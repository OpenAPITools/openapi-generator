...
public class FileApi extends BaseApi {
     ...
     */
    public FileContent fileIdGet(String id) throws RestClientException {
        return fileIdGetWithHttpInfo(id).getBody();
    }
    ...
    public ResponseEntity<FileContent> fileIdGetWithHttpInfo(String id) throws RestClientException {
        ...
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling fileIdGet");
        }
