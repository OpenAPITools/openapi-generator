...
public class UserApi {
   ...
   */
  public ApiResponse<Void> createUserWithHttpInfo(User user)
      throws ApiException {
    ...
    if (user == null) {
      throw new ApiException(
          400, "Missing the required parameter 'user' when calling createUser");
    }
    ...
    return apiClient.invokeAPI(
        "UserApi.createUser", localVarPath, "POST", localVarQueryParams,
  ...
  createUsersWithArrayInputWithHttpInfo(List<User> user) throws ApiException {
    Object localVarPostBody = user;
    ...
    return apiClient.invokeAPI(
        ...
        localVarContentType, localVarAuthNames, null, null);
  }
  /**
   * Creates list of users with given input array
   *
  ...
  public ApiResponse<Void> createUsersWithListInputWithHttpInfo(List<User> user)
    ...
    return apiClient.invokeAPI(
        "UserApi.createUsersWithListInput", localVarPath, "POST",
        localVarQueryParams, localVarPostBody, localVarHeaderParams,
        localVarCookieParams, localVarFormParams, localVarAccept,
        localVarContentType, localVarAuthNames, null, null);
  }
  ...
  public ApiResponse<Void> deleteUserWithHttpInfo(String username)
    ...
    return apiClient.invokeAPI(
        "UserApi.deleteUser", localVarPath, "DELETE", localVarQueryParams,
        localVarPostBody, localVarHeaderParams, localVarCookieParams,
        localVarFormParams, localVarAccept, localVarContentType,
        localVarAuthNames, null, null);
  }
  ...
  public ApiResponse<Void> logoutUserWithHttpInfo() throws ApiException {
    ...
    return apiClient.invokeAPI(
        "UserApi.logoutUser", localVarPath, "GET", localVarQueryParams,
        localVarPostBody, localVarHeaderParams, localVarCookieParams,
        localVarFormParams, localVarAccept, localVarContentType,
        localVarAuthNames, null, null);
  }
   ...
   */
  public ApiResponse<Void> updateUserWithHttpInfo(String username, User user)
      throws ApiException {
    Object localVarPostBody = user;
    ...
    if (user == null) {
      throw new ApiException(
          400, "Missing the required parameter 'user' when calling updateUser");
    }
    ...
    return apiClient.invokeAPI(
        "UserApi.updateUser", localVarPath, "PUT", localVarQueryParams,
        localVarPostBody, localVarHeaderParams, localVarCookieParams,
        localVarFormParams, localVarAccept, localVarContentType,
        localVarAuthNames, null, null);
  }
