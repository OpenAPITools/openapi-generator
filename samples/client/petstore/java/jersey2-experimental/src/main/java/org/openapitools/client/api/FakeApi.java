...
public class FakeApi {
   ...
   * </table>
   */
  public ApiResponse<Void> fakeHttpSignatureTestWithHttpInfo(Pet pet, String query1, String header1)
      throws ApiException {
    ...
    if (pet == null) {
      throw new ApiException(
          400, "Missing the required parameter 'pet' when calling fakeHttpSignatureTest");
    }
    ...
    if (header1 != null) localVarHeaderParams.put("header_1", apiClient.parameterToString(header1));
  ...
  public ApiResponse<Void> testBodyWithQueryParamsWithHttpInfo(String query, User user)
    ...
    if (query == null) {
      throw new ApiException(
          400, "Missing the required parameter 'query' when calling testBodyWithQueryParams");
    }

    // verify the required parameter 'user' is set
    if (user == null) {
      throw new ApiException(
          400, "Missing the required parameter 'user' when calling testBodyWithQueryParams");
    }
  ...
  public ApiResponse<Void> testEndpointParametersWithHttpInfo(
    ...
    if (number == null) {
      throw new ApiException(
          400, "Missing the required parameter 'number' when calling testEndpointParameters");
    }

    // verify the required parameter '_double' is set
    if (_double == null) {
      throw new ApiException(
          400, "Missing the required parameter '_double' when calling testEndpointParameters");
    }
    ...
    if (_byte == null) {
      throw new ApiException(
          400, "Missing the required parameter '_byte' when calling testEndpointParameters");
    }
  ...
  private ApiResponse<Void> testGroupParametersWithHttpInfo(
    ...
    if (requiredBooleanGroup != null)
      localVarHeaderParams.put(
          "required_boolean_group", apiClient.parameterToString(requiredBooleanGroup));
