...
public class StoreApi {
  ...
  public StoreApi(ApiClient apiClient) { this.apiClient = apiClient; }
   ...
   */
  public ApiResponse<Void> deleteOrderWithHttpInfo(String orderId)
      throws ApiException {
    ...
    String localVarPath = "/store/order/{order_id}".replaceAll(
        "\\{"
            + "order_id"
            + "\\}",
    ...
    return apiClient.invokeAPI(
        "StoreApi.deleteOrder", localVarPath, "DELETE", localVarQueryParams,
   ...
   */
  public ApiResponse<Map<String, Integer>> getInventoryWithHttpInfo()
      throws ApiException {
    Object localVarPostBody = null;
    ...
    return apiClient.invokeAPI(
        "StoreApi.getInventory", localVarPath, "GET", localVarQueryParams,
        localVarPostBody, localVarHeaderParams, localVarCookieParams,
        localVarFormParams, localVarAccept, localVarContentType,
  ...
  public ApiResponse<Order> getOrderByIdWithHttpInfo(Long orderId)
    ...
    return apiClient.invokeAPI(
        "StoreApi.getOrderById", localVarPath, "GET", localVarQueryParams,
        localVarPostBody, localVarHeaderParams, localVarCookieParams,
        localVarFormParams, localVarAccept, localVarContentType,
        localVarAuthNames, localVarReturnType, null);
  }
   ...
   * @http.response.details
   ...
   </td></tr> <tr><td> 400 </td><td> Invalid Order </td><td>  -  </td></tr>
     </table>
   */
  ...
  public ApiResponse<Order> placeOrderWithHttpInfo(Order order)
    ...
    return apiClient.invokeAPI(
        "StoreApi.placeOrder", localVarPath, "POST", localVarQueryParams,
        localVarPostBody, localVarHeaderParams, localVarCookieParams,
        localVarFormParams, localVarAccept, localVarContentType,
        localVarAuthNames, localVarReturnType, null);
  }
