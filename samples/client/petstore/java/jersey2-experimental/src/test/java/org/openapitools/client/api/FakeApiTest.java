...
public class FakeApiTest {
  ...
  public void fakeHttpSignatureTestTest() throws Exception {
    ...
    PrivateKey privateKey =
        PEM.readPrivateKey(new ByteArrayInputStream(privateKeyPem.getBytes()));
    ApiClient client = api.getApiClient();
    HttpSignatureAuth auth =
        (HttpSignatureAuth)client.getAuthentication("http_signature_test");
   ...
   * 엔드 포인트
   *
   * <p>Fake endpoint for testing various parameters 假端點 偽のエンドポイント
   * 가짜 엔드 포인트
   *
   * @throws ApiException if the Api call fails
   */
