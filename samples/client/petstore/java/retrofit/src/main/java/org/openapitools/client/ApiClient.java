...
public class ApiClient {
  ...
  public void createDefaultAdapter() {
    ...
    adapterBuilder = new RestAdapter.Builder()
  ...
  public RestAdapter.Builder getAdapterBuilder() { return adapterBuilder; }
  ...
  /**
   * Clones the okClient given in parameter, adds the auth interceptors and uses
   * it to configure the RestAdapter
