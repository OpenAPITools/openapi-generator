...
public class OAuthOkHttpClient implements HttpClient {
  ...
  public OAuthOkHttpClient(OkHttpClient client) { this.client = client; }
  ...
  public <T extends OAuthClientResponse>
    ...
    Request.Builder requestBuilder =
        new Request.Builder().url(request.getLocationUri());
    ...
    RequestBody body = request.getBody() != null
                           ? RequestBody.create(mediaType, request.getBody())
                           : null;
    ...
    try {
      ...
      return OAuthClientResponseFactory.createCustomResponse(
          response.body().string(), response.body().contentType().toString(),
