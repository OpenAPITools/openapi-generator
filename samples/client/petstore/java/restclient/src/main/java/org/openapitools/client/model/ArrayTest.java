...
public class ArrayTest {
  ...
  @jakarta.annotation.Nullable  private List<String> arrayOfString;

  public static final String JSON_PROPERTY_ARRAY_ARRAY_OF_INTEGER = "array_array_of_integer";
  @jakarta.annotation.Nullable  private List<List<Long>> arrayArrayOfInteger;

  public static final String JSON_PROPERTY_ARRAY_ARRAY_OF_MODEL = "array_array_of_model";
  @jakarta.annotation.Nullable  private List<List<ReadOnlyFirst>> arrayArrayOfModel;
