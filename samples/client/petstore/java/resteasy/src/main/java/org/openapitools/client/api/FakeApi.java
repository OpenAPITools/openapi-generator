...
public class FakeApi {
  ...
  public void createXmlItem(XmlItem xmlItem) throws ApiException {
    ...
    String localVarPath =
        "/fake/create_xml_item".replaceAll("\\{format\\}", "json");
  ...
  public Boolean fakeOuterBooleanSerialize(Boolean body) throws ApiException {
    ...
    // create path and map variables
    String localVarPath =
        "/fake/outer/boolean".replaceAll("\\{format\\}", "json");
  ...
  public OuterComposite fakeOuterCompositeSerialize(OuterComposite body)
    ...
    // create path and map variables
    String localVarPath =
        "/fake/outer/composite".replaceAll("\\{format\\}", "json");
  ...
  public BigDecimal fakeOuterNumberSerialize(BigDecimal body)
    ...
    // create path and map variables
    String localVarPath =
        "/fake/outer/number".replaceAll("\\{format\\}", "json");
  ...
  public String fakeOuterStringSerialize(String body) throws ApiException {
    ...
    // create path and map variables
    String localVarPath =
        "/fake/outer/string".replaceAll("\\{format\\}", "json");
  ...
  public void testBodyWithFileSchema(FileSchemaTestClass body)
    ...
    // create path and map variables
    String localVarPath =
        "/fake/body-with-file-schema".replaceAll("\\{format\\}", "json");
  ...
  public void testBodyWithQueryParams(String query, User body)
    ...
    // create path and map variables
    String localVarPath =
        "/fake/body-with-query-params".replaceAll("\\{format\\}", "json");
  ...
  public void testInlineAdditionalProperties(Map<String, String> param)
    ...
    // create path and map variables
    String localVarPath =
        "/fake/inline-additionalProperties".replaceAll("\\{format\\}", "json");
  ...
  public void testJsonFormData(String param, String param2)
    ...
    // create path and map variables
    String localVarPath =
        "/fake/jsonFormData".replaceAll("\\{format\\}", "json");
  ...
  testQueryParameterCollectionFormat(List<String> pipe, List<String> ioutil,
    ...
    // create path and map variables
    String localVarPath =
        "/fake/test-query-paramters".replaceAll("\\{format\\}", "json");
