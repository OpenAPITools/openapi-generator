...
public class RequiredAndNullableApi implements AutoCloseable {
  /**
    ...
    try {
      ...
      try {
        ...
        if (localVarResponseBody == null) {
          return new ApiResponse<RequiredAndNullable>(
  ...
  private HttpRequest.Builder requiredAndNullablePostRequestBuilder(RequiredAndNullable requiredAndNullable, Map<String, String> headers) throws ApiException {
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(requiredAndNullable);
