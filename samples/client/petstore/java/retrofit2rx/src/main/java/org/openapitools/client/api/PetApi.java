...
public interface PetApi {
  ...
  @POST("pet")
  Observable<Void> addPet(@retrofit2.http.Body Pet body);
   ...
   */
  @DELETE("pet/{petId}")
  Observable<Void> deletePet(@retrofit2.http.Path("petId") Long petId,
  ...
  @Headers({"Content-Type:application/json"})
  @PUT("pet")
  Observable<Void> updatePet(@retrofit2.http.Body Pet body);
