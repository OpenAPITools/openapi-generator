...
public class UploadApi {
     ...
     */
    private ResponseSpec uploadFilesPostRequestCreation(@Nullable List<File> _file) throws WebClientResponseException {
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<Void> uploadFilesPost(@Nullable List<File> _file) throws WebClientResponseException {
        ParameterizedTypeReference<Void> localVarReturnType = new ParameterizedTypeReference<Void>() {};
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<Void>> uploadFilesPostWithHttpInfo(@Nullable List<File> _file) throws WebClientResponseException {
        ParameterizedTypeReference<Void> localVarReturnType = new ParameterizedTypeReference<Void>() {};
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec uploadFilesPostWithResponseSpec(@Nullable List<File> _file) throws WebClientResponseException {
