...
public class Foo {
  ...
  public java.util.Optional<java.time.Instant> getNullableDt() {
  ...
  public java.util.Optional<File> getNullableBinary() {
  ...
  public java.util.Optional<List<java.time.Instant>> getNullableListMinIntems() {
  ...
  public java.util.Optional<java.math.BigDecimal> getNullableNumber() {
  ...
  public java.util.Optional<String> getNullableColor() {
