...
public class FakeClassnameTags123Api {
  ...
  public FakeClassnameTags123Api(
      org.openapitools.client.api.FakeClassnameTags123Api delegate) {
  ...
  public Single<Client> rxTestClassname(Client body) {
    return Single.create(new io.vertx.rx.java.SingleOnSubscribeAdapter<>(
        fut -> { delegate.testClassname(body, fut); }));
  }

  public static FakeClassnameTags123Api
  newInstance(org.openapitools.client.api.FakeClassnameTags123Api arg) {
