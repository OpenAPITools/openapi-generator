...
public class StoreApiImpl implements StoreApi {
  ...
  public void deleteOrder(String orderId,
    ...
    String localVarPath =
        "/store/order/{order_id}".replaceAll("\\{"
                                                 + "order_id"
                                                 + "\\}",
                                             orderId.toString());
   ...
   */
  public void
  getInventory(Handler<AsyncResult<Map<String, Integer>>> resultHandler) {
    Object localVarBody = null;
    ...
    TypeReference<Map<String, Integer>> localVarReturnType =
  ...
  public void getOrderById(Long orderId,
                           Handler<AsyncResult<Order>> resultHandler) {
    Object localVarBody = null;
