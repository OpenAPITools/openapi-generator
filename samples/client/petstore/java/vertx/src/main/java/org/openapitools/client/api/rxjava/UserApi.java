...
public class UserApi {
  ...
  public org.openapitools.client.api.UserApi getDelegate() { return delegate; }
  ...
  public Single<Void> rxCreateUser(User body) {
    return Single.create(new io.vertx.rx.java.SingleOnSubscribeAdapter<>(
        fut -> { delegate.createUser(body, fut); }));
  }
  /**
  ...
  public Single<Void> rxCreateUsersWithArrayInput(List<User> body) {
    return Single.create(new io.vertx.rx.java.SingleOnSubscribeAdapter<>(
        fut -> { delegate.createUsersWithArrayInput(body, fut); }));
  }
  /**
   * Creates list of users with given input array
   *
  ...
  public Single<Void> rxCreateUsersWithListInput(List<User> body) {
    return Single.create(new io.vertx.rx.java.SingleOnSubscribeAdapter<>(
        fut -> { delegate.createUsersWithListInput(body, fut); }));
  }
  /**
   * Delete user
   * This can only be done by the logged in user.
  ...
  public Single<Void> rxDeleteUser(String username) {
    return Single.create(new io.vertx.rx.java.SingleOnSubscribeAdapter<>(
        fut -> { delegate.deleteUser(username, fut); }));
  }
  /**
  ...
  public Single<User> rxGetUserByName(String username) {
    return Single.create(new io.vertx.rx.java.SingleOnSubscribeAdapter<>(
        fut -> { delegate.getUserByName(username, fut); }));
  }
  /**
  ...
  public Single<String> rxLoginUser(String username, String password) {
    return Single.create(new io.vertx.rx.java.SingleOnSubscribeAdapter<>(
        fut -> { delegate.loginUser(username, password, fut); }));
  }
  /**
  ...
  public Single<Void> rxUpdateUser(String username, User body) {
    return Single.create(new io.vertx.rx.java.SingleOnSubscribeAdapter<>(
        fut -> { delegate.updateUser(username, body, fut); }));
  }
