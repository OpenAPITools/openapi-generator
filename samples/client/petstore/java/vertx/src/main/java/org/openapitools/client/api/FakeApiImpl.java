...
public class FakeApiImpl implements FakeApi {
  ...
  public void createXmlItem(XmlItem xmlItem,
    ...
    String[] localVarContentTypes = {"application/xml",
  ...
  public void fakeOuterCompositeSerialize(
    ...
    String[] localVarContentTypes = {};
    String[] localVarAuthNames = new String[] {};
    TypeReference<OuterComposite> localVarReturnType =
  ...
  fakeOuterNumberSerialize(BigDecimal body,
    ...
    String[] localVarContentTypes = {};
    String[] localVarAuthNames = new String[] {};
    TypeReference<BigDecimal> localVarReturnType =
  ...
  public void testGroupParameters(Integer requiredStringGroup,
    ...
    if (booleanGroup != null)
      localVarHeaderParams.add("boolean_group",
