...
public class PetApi {
  ...
  public org.openapitools.client.api.PetApi getDelegate() { return delegate; }
  ...
  public Single<Void> rxDeletePet(Long petId, String apiKey) {
    return Single.create(new io.vertx.rx.java.SingleOnSubscribeAdapter<>(
        fut -> { delegate.deletePet(petId, apiKey, fut); }));
  }
  /**
   ...
   * @param resultHandler Asynchronous result handler
   */
  public void findPetsByStatus(List<String> status,
                               Handler<AsyncResult<List<Pet>>> resultHandler) {
  ...
  public Single<List<Pet>> rxFindPetsByStatus(List<String> status) {
    return Single.create(new io.vertx.rx.java.SingleOnSubscribeAdapter<>(
        fut -> { delegate.findPetsByStatus(status, fut); }));
  }
  /**
   * Finds Pets by tags
   ...
   * @param resultHandler Asynchronous result handler
   */
  public void findPetsByTags(List<String> tags,
                             Handler<AsyncResult<List<Pet>>> resultHandler) {
  ...
  public Single<List<Pet>> rxFindPetsByTags(List<String> tags) {
    return Single.create(new io.vertx.rx.java.SingleOnSubscribeAdapter<>(
        fut -> { delegate.findPetsByTags(tags, fut); }));
  }
  /**
   * Find pet by ID
  ...
  public Single<Pet> rxGetPetById(Long petId) {
    return Single.create(new io.vertx.rx.java.SingleOnSubscribeAdapter<>(
        fut -> { delegate.getPetById(petId, fut); }));
  }
  /**
  ...
  public Single<Void> rxUpdatePet(Pet body) {
    return Single.create(new io.vertx.rx.java.SingleOnSubscribeAdapter<>(
        fut -> { delegate.updatePet(body, fut); }));
  }
  /**
   ...
   * @return Asynchronous result handler (RxJava Single)
   */
  public Single<Void> rxUpdatePetWithForm(Long petId, String name,
                                          String status) {
    return Single.create(new io.vertx.rx.java.SingleOnSubscribeAdapter<>(
        fut -> { delegate.updatePetWithForm(petId, name, status, fut); }));
  }
  /**
   * uploads an image
   *
   ...
   * @param resultHandler Asynchronous result handler
   */
  public void uploadFile(Long petId, String additionalMetadata, AsyncFile file,
                         Handler<AsyncResult<ModelApiResponse>> resultHandler) {
   ...
   * @return Asynchronous result handler (RxJava Single)
   */
  public Single<ModelApiResponse>
  rxUploadFile(Long petId, String additionalMetadata, AsyncFile file) {
    return Single.create(new io.vertx.rx.java.SingleOnSubscribeAdapter<>(
        fut -> { delegate.uploadFile(petId, additionalMetadata, file, fut); }));
  }
  /**
   ...
   * @param resultHandler Asynchronous result handler
   */
  public void uploadFileWithRequiredFile(
      Long petId, AsyncFile requiredFile, String additionalMetadata,
      Handler<AsyncResult<ModelApiResponse>> resultHandler) {
    delegate.uploadFileWithRequiredFile(petId, requiredFile, additionalMetadata,
                                        resultHandler);
  }
