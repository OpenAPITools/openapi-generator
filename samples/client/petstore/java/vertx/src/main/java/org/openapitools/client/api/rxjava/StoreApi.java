...
public class StoreApi {
  ...
  public org.openapitools.client.api.StoreApi getDelegate() { return delegate; }
  ...
  public Single<Void> rxDeleteOrder(String orderId) {
    return Single.create(new io.vertx.rx.java.SingleOnSubscribeAdapter<>(
        fut -> { delegate.deleteOrder(orderId, fut); }));
  }
  /**
  ...
  public Single<Order> rxGetOrderById(Long orderId) {
    return Single.create(new io.vertx.rx.java.SingleOnSubscribeAdapter<>(
        fut -> { delegate.getOrderById(orderId, fut); }));
  }
  /**
  ...
  public Single<Order> rxPlaceOrder(Order body) {
    return Single.create(new io.vertx.rx.java.SingleOnSubscribeAdapter<>(
        fut -> { delegate.placeOrder(body, fut); }));
  }
