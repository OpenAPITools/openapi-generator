...
public class FakeApi {
    ...
    public class TestEnumParametersRequest {
        ...
        public Integer enumFormInteger() {
            return this.enumFormInteger;
        }
        public BigDecimal enumFormDouble() {
