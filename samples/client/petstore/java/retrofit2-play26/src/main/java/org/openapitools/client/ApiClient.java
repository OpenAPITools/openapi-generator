...
public class ApiClient {
  ...
  /**
   * Create {@link java.util.concurrent.CompletionStage} instances from HTTP
   * calls
   */
  ...
  public <S> S createService(Class<S> serviceClass) {
    ...
    if (callFactory == null) {
      callFactory = new Play26CallFactory(wsClient, extraHeaders, extraCookies,
                                          extraQueryParams);
    }
  ...
  /**
   * Helper method to set {@link java.util.concurrent.CompletionStage} instances
   * factory
   */
  public ApiClient
  setCallAdapterFactory(Play26CallAdapterFactory callAdapterFactory) {
  ...
  static class FileConverter extends Converter.Factory {
    ...
    @Override
    public Converter<ResponseBody, File>
