...
public interface PetApi {
  ...
  @POST("pet")
  CompletionStage<Response<Void>> addPet(@retrofit2.http.Body Pet body);
  ...
  CompletionStage<Response<List<Pet>>>
   ...
   */
  @GET("pet/{petId}")
  CompletionStage<Response<Pet>>
  getPetById(@retrofit2.http.Path("petId") Long petId);
  ...
  @Headers({"Content-Type:application/json"})
  @PUT("pet")
  CompletionStage<Response<Void>> updatePet(@retrofit2.http.Body Pet body);
