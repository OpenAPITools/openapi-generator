...
public interface FakeApi {
  ...
  createXmlItem(@retrofit2.http.Body XmlItem xmlItem);
  ...
  CompletionStage<Response<Boolean>>
  ...
  CompletionStage<Response<OuterComposite>>
  ...
  CompletionStage<Response<BigDecimal>>
  ...
  testClientModel(@retrofit2.http.Body Client body);
