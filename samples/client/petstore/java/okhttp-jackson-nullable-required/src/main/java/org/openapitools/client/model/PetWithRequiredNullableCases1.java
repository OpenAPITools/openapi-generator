...
@JsonPropertyOrder({
  PetWithRequiredNullableCases1.JSON_PROPERTY_ID,
  PetWithRequiredNullableCases1.JSON_PROPERTY_CATEGORY,
  PetWithRequiredNullableCases1.JSON_PROPERTY_NAME,
  PetWithRequiredNullableCases1.JSON_PROPERTY_PHOTO_URLS,
  PetWithRequiredNullableCases1.JSON_PROPERTY_TAGS,
  PetWithRequiredNullableCases1.JSON_PROPERTY_STATUS
})
@JsonTypeName("PetWithRequiredNullableCases1")
public class PetWithRequiredNullableCases1 {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_PHOTO_URLS, required = false)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
