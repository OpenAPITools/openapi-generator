...
@JsonPropertyOrder({
  PetWithRequiredNullableCases2.JSON_PROPERTY_ID,
  PetWithRequiredNullableCases2.JSON_PROPERTY_CATEGORY,
  PetWithRequiredNullableCases2.JSON_PROPERTY_NAME,
  PetWithRequiredNullableCases2.JSON_PROPERTY_PHOTO_URLS,
  PetWithRequiredNullableCases2.JSON_PROPERTY_TAGS,
  PetWithRequiredNullableCases2.JSON_PROPERTY_STATUS
})
@JsonTypeName("PetWithRequiredNullableCases2")
