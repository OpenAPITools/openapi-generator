...
public class ByteArrayObject {
  ...
  **/
  ...
  public static class Builder {
    ...
    private ByteArrayObject instance;

    public Builder() {
      this(new ByteArrayObject());
    }

    protected Builder(ByteArrayObject instance) {
      this.instance = instance;
    }

    public ByteArrayObject.Builder nullableArray(byte[] nullableArray) {
      this.instance.nullableArray = JsonNullable.<byte[]>of(nullableArray);
      return this;
    }

    public ByteArrayObject.Builder normalArray(byte[] normalArray) {
      this.instance.normalArray = normalArray;
      return this;
    }

    public ByteArrayObject.Builder nullableString(String nullableString) {
      this.instance.nullableString = JsonNullable.<String>of(nullableString);
      return this;
    }

    public ByteArrayObject.Builder stringField(String stringField) {
      this.instance.stringField = stringField;
      return this;
    }

    public ByteArrayObject.Builder intField(BigDecimal intField) {
      this.instance.intField = intField;
      return this;
    }


    /**
    * returns a built ByteArrayObject instance.
    *
    * The builder is not reusable.
    */
    public ByteArrayObject build() {
      try {
  ...
  */
  public static ByteArrayObject.Builder builder() {
    return new ByteArrayObject.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public ByteArrayObject.Builder toBuilder() {
    return new ByteArrayObject.Builder()
      .nullableArray(getNullableArray())
      .normalArray(getNormalArray())
      .nullableString(getNullableString())
