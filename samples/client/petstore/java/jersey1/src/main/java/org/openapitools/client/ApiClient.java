...
public class ApiClient {
   ...
   * serialization/deserialization. <p> Note: If you make changes to the object
   * mapper, remember to set it back via <code>setObjectMapper</code> in order
   ...
   */
  public Object serialize(Object obj, String contentType,
    ...
    if (contentType.startsWith("multipart/form-data")) {
      ...
      for (Entry<String, Object> param : formParams.entrySet()) {
        if (param.getValue() instanceof List &&
          ...
          for (File file : files) {
            mp.bodyPart(new FileDataBodyPart(
                param.getKey(), file, MediaType.APPLICATION_OCTET_STREAM_TYPE));
          }
  ...
  getAPIResponse(String path, String method, List<Pair> queryParams,
    ...
    if ("GET".equals(method)) {
      ...
      response = builder.type(contentType)
  ...
  public <T> T invokeAPI(String path, String method, List<Pair> queryParams,
    ...
    ClientResponse response = getAPIResponse(
  ...
  private String getXWWWFormUrlencodedParams(Map<String, Object> formParams) {
    ...
    if (encodedFormParams.endsWith("&")) {
      encodedFormParams =
          encodedFormParams.substring(0, encodedFormParams.length() - 1);
    }
