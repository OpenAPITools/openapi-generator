...
public class FakeApi {
  ...
  testEnumParameters(List<String> enumHeaderStringArray,
    ...
    localVarCollectionQueryParams.addAll(apiClient.parameterToPairs(
        "csv", "enum_query_string_array", enumQueryStringArray));
    localVarQueryParams.addAll(
        apiClient.parameterToPair("enum_query_string", enumQueryString));
    localVarQueryParams.addAll(
        apiClient.parameterToPair("enum_query_integer", enumQueryInteger));
    localVarQueryParams.addAll(
        apiClient.parameterToPair("enum_query_double", enumQueryDouble));
    ...
    apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams,
                        localVarCollectionQueryParams, localVarPostBody,
                        localVarHeaderParams, localVarCookieParams,
                        localVarFormParams, localVarAccept, localVarContentType,
                        localVarAuthNames, null);
  ...
  public void testGroupParameters(Integer requiredStringGroup,
    ...
    localVarQueryParams.addAll(
        apiClient.parameterToPair("required_int64_group", requiredInt64Group));
    localVarQueryParams.addAll(
        apiClient.parameterToPair("string_group", stringGroup));
    localVarQueryParams.addAll(
        apiClient.parameterToPair("int64_group", int64Group));
  ...
  testQueryParameterCollectionFormat(List<String> pipe, List<String> ioutil,
    ...
    localVarCollectionQueryParams.addAll(
        apiClient.parameterToPairs("csv", "url", url));
    localVarCollectionQueryParams.addAll(
