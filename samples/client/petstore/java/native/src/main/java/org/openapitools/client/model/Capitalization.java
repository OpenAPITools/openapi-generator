...
public class Capitalization {
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getSmallCamel() != null) {
            joiner.add(
                    String.format(
                            ...
                            suffix,
                            URLEncoder.encode(
                                            String.valueOf(getSmallCamel()), StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
        ...
        if (getCapitalCamel() != null) {
            joiner.add(
                    String.format(
                            ...
                            suffix,
                            URLEncoder.encode(
                                            String.valueOf(getCapitalCamel()),
        ...
        if (getSmallSnake() != null) {
            joiner.add(
                    String.format(
                            ...
                            suffix,
                            URLEncoder.encode(
                                            String.valueOf(getSmallSnake()), StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
        ...
        if (getCapitalSnake() != null) {
            joiner.add(
                    String.format(
                            ...
                            suffix,
                            URLEncoder.encode(
                                            String.valueOf(getCapitalSnake()),
                                            StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
        ...
        if (getScAETHFlowPoints() != null) {
            joiner.add(
                    String.format(
                            "%sSCA_ETH_Flow_Points%s=%s",
                            prefix,
                            suffix,
                            URLEncoder.encode(
                                            String.valueOf(getScAETHFlowPoints()),
                                            StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
        ...
        if (getATTNAME() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            URLEncoder.encode(String.valueOf(getATTNAME()), StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
