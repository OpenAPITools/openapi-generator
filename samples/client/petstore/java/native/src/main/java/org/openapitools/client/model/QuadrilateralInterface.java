...
@JsonPropertyOrder({QuadrilateralInterface.JSON_PROPERTY_QUADRILATERAL_TYPE})
...
public class QuadrilateralInterface {
    ...
    public String toString() {
        ...
        sb.append("    quadrilateralType: ")
                .append(toIndentedString(quadrilateralType))
                .append("\n");
        sb.append("}");
        return sb.toString();
    }
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getQuadrilateralType() != null) {
            joiner.add(
                    String.format(
                            "%squadrilateralType%s=%s",
                            prefix,
                            suffix,
                            URLEncoder.encode(
                                            String.valueOf(getQuadrilateralType()),
