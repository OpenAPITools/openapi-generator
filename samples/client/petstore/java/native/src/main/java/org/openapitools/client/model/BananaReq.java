...
/** BananaReq */
@JsonPropertyOrder({BananaReq.JSON_PROPERTY_LENGTH_CM, BananaReq.JSON_PROPERTY_SWEET})
        ...
        if (getLengthCm() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            URLEncoder.encode(String.valueOf(getLengthCm()), StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
        ...
        if (getSweet() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            URLEncoder.encode(String.valueOf(getSweet()), StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
