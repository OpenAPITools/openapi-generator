...
public class User {
    ...
    public static final String JSON_PROPERTY_OBJECT_WITH_NO_DECLARED_PROPS =
            "objectWithNoDeclaredProps";
    private Object objectWithNoDeclaredProps;

    public static final String JSON_PROPERTY_OBJECT_WITH_NO_DECLARED_PROPS_NULLABLE =
            "objectWithNoDeclaredPropsNullable";
    private JsonNullable<Object> objectWithNoDeclaredPropsNullable =
            JsonNullable.<Object>undefined();
    ...
    /**
     * test code generation for objects Value must be a map of strings to values. It cannot be the
     * &#39;null&#39; value.
     *
    ...
    public User objectWithNoDeclaredPropsNullable(Object objectWithNoDeclaredPropsNullable) {
        this.objectWithNoDeclaredPropsNullable =
                JsonNullable.<Object>of(objectWithNoDeclaredPropsNullable);
        return this;
    }

    /**
     * test code generation for nullable objects. Value must be a map of strings to values or the
     * &#39;null&#39; value.
     *
    ...
    @JsonProperty(JSON_PROPERTY_OBJECT_WITH_NO_DECLARED_PROPS_NULLABLE)
    public void setObjectWithNoDeclaredPropsNullable_JsonNullable(
            JsonNullable<Object> objectWithNoDeclaredPropsNullable) {
    ...
    /**
     * test code generation for any type Here the &#39;type&#39; attribute is not specified, which
     * means the value can be anything, including the null value, string, number, boolean, array or
     * object. See https://github.com/OAI/OpenAPI-Specification/issues/1389
     *
     * @return anyTypeProp
     */
    @javax.annotation.Nullable
     ...
     * test code generation for any type Here the &#39;type&#39; attribute is not specified, which
     * means the value can be anything, including the null value, string, number, boolean, array or
     * object. The &#39;nullable&#39; attribute does not change the allowed values.
     *
    ...
    public int hashCode() {
        return Objects.hash(
                ...
                userStatus,
                objectWithNoDeclaredProps,
                hashCodeNullable(objectWithNoDeclaredPropsNullable),
                hashCodeNullable(anyTypeProp),
                hashCodeNullable(anyTypePropNullable));
    }
    ...
    public String toString() {
        ...
        sb.append("    objectWithNoDeclaredProps: ")
                .append(toIndentedString(objectWithNoDeclaredProps))
                .append("\n");
        sb.append("    objectWithNoDeclaredPropsNullable: ")
                .append(toIndentedString(objectWithNoDeclaredPropsNullable))
                .append("\n");
        sb.append("    anyTypeProp: ").append(toIndentedString(anyTypeProp)).append("\n");
        sb.append("    anyTypePropNullable: ")
                .append(toIndentedString(anyTypePropNullable))
                .append("\n");
        sb.append("}");
        return sb.toString();
    }
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getUserStatus() != null) {
            joiner.add(
                    String.format(
                            ...
                            suffix,
                            URLEncoder.encode(
                                            String.valueOf(getUserStatus()), StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
        ...
        if (getObjectWithNoDeclaredProps() != null) {
            joiner.add(
                    String.format(
                            "%sobjectWithNoDeclaredProps%s=%s",
                            prefix,
                            suffix,
                            URLEncoder.encode(
                                            String.valueOf(getObjectWithNoDeclaredProps()),
        ...
        if (getObjectWithNoDeclaredPropsNullable() != null) {
            joiner.add(
                    String.format(
                            "%sobjectWithNoDeclaredPropsNullable%s=%s",
                            prefix,
                            suffix,
                            URLEncoder.encode(
                                            String.valueOf(getObjectWithNoDeclaredPropsNullable()),
                                            StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
        ...
        if (getAnyTypePropNullable() != null) {
            joiner.add(
                    String.format(
                            "%sanyTypePropNullable%s=%s",
                            prefix,
                            suffix,
                            URLEncoder.encode(
                                            String.valueOf(getAnyTypePropNullable()),
                                            StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
