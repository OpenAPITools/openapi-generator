        ...
        if (getMyNumber() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            URLEncoder.encode(String.valueOf(getMyNumber()), StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
        ...
        if (getMyString() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            URLEncoder.encode(String.valueOf(getMyString()), StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
        ...
        if (getMyBoolean() != null) {
            joiner.add(
                    String.format(
                            ...
                            suffix,
                            URLEncoder.encode(
                                            String.valueOf(getMyBoolean()), StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
