...
public class FakeClassnameTags123Api {
  ...
  private final Consumer<HttpResponse<InputStream>>
  ...
  public Client testClassname(Client body) throws ApiException {
    ...
    try {
      ...
      HttpResponse<InputStream> localVarResponse =
          memberVarHttpClient.send(localVarRequestBuilder.build(),
      ...
      return memberVarObjectMapper.readValue(localVarResponse.body(),
