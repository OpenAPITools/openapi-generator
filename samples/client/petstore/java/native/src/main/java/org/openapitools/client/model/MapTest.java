            ...
            for (String _key : getMapMapOfString().keySet()) {
                joiner.add(
                        String.format(
                                ...
                                getMapMapOfString().get(_key),
                                URLEncoder.encode(
                                                String.valueOf(getMapMapOfString().get(_key)),
                ...
                joiner.add(
                        String.format(
                                ...
                                "".equals(suffix)
                                        ...
                                        : String.format(
                                                "%s%d%s", containerPrefix, _key, containerSuffix),
                                getMapOfEnumString().get(_key),
                                URLEncoder.encode(
                                                String.valueOf(getMapOfEnumString().get(_key)),
                                                StandardCharsets.UTF_8)
                                        .replaceAll("\\+", "%20")));
            }
        }
                ...
                joiner.add(
                        String.format(
                                ...
                                "".equals(suffix)
                                        ...
                                        : String.format(
                                                "%s%d%s", containerPrefix, _key, containerSuffix),
                                getDirectMap().get(_key),
                                URLEncoder.encode(
                                                String.valueOf(getDirectMap().get(_key)),
                                                StandardCharsets.UTF_8)
                                        .replaceAll("\\+", "%20")));
            }
        }
                ...
                joiner.add(
                        String.format(
                                ...
                                "".equals(suffix)
                                        ...
                                        : String.format(
                                                "%s%d%s", containerPrefix, _key, containerSuffix),
                                getIndirectMap().get(_key),
                                URLEncoder.encode(
                                                String.valueOf(getIndirectMap().get(_key)),
                                                StandardCharsets.UTF_8)
                                        .replaceAll("\\+", "%20")));
            }
        }
