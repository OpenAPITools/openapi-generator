...
public class NullableClass extends HashMap<String, Object> {
    ...
    public NullableClass objectAndItemsNullableProp(
    ...
    public boolean equals(Object o) {
        ...
        return equalsNullable(this.integerProp, nullableClass.integerProp)
                ...
                && equalsNullable(
                        this.arrayAndItemsNullableProp, nullableClass.arrayAndItemsNullableProp)
                ...
                && equalsNullable(
                        this.objectAndItemsNullableProp, nullableClass.objectAndItemsNullableProp)
    ...
    public int hashCode() {
        return Objects.hash(
                hashCodeNullable(integerProp),
                hashCodeNullable(numberProp),
                hashCodeNullable(booleanProp),
                hashCodeNullable(stringProp),
                hashCodeNullable(dateProp),
                hashCodeNullable(datetimeProp),
                hashCodeNullable(arrayNullableProp),
                hashCodeNullable(arrayAndItemsNullableProp),
                arrayItemsNullable,
                hashCodeNullable(objectNullableProp),
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getNumberProp() != null) {
            joiner.add(
                    String.format(
                            ...
                            suffix,
                            URLEncoder.encode(
                                            String.valueOf(getNumberProp()), StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
        ...
        if (getStringProp() != null) {
            joiner.add(
                    String.format(
                            ...
                            suffix,
                            URLEncoder.encode(
                                            String.valueOf(getStringProp()), StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
        ...
        if (getDateProp() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            URLEncoder.encode(String.valueOf(getDateProp()), StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
        ...
        if (getDatetimeProp() != null) {
            joiner.add(
                    String.format(
                            ...
                            suffix,
                            URLEncoder.encode(
                                            String.valueOf(getDatetimeProp()),
                                            StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
            ...
            for (int i = 0; i < getArrayNullableProp().size(); i++) {
                joiner.add(
                        String.format(
                                ...
                                URLEncoder.encode(
                                                String.valueOf(getArrayNullableProp().get(i)),
                                                StandardCharsets.UTF_8)
                                        .replaceAll("\\+", "%20")));
            }
        }
        ...
        if (getArrayAndItemsNullableProp() != null) {
            for (int i = 0; i < getArrayAndItemsNullableProp().size(); i++) {
                joiner.add(
                        String.format(
                                "%sarray_and_items_nullable_prop%s%s=%s",
                                prefix,
                                suffix,
                                "".equals(suffix)
                                        ? ""
                                ...
                                URLEncoder.encode(
                                                String.valueOf(
                                                        getArrayAndItemsNullableProp().get(i)),
                                                StandardCharsets.UTF_8)
                                        .replaceAll("\\+", "%20")));
            }
        }
                        ...
                        String.format(
                                ...
                                "".equals(suffix)
                                        ...
                                        : String.format(
                                                "%s%d%s", containerPrefix, i, containerSuffix),
                                URLEncoder.encode(
                                                String.valueOf(getArrayItemsNullable().get(i)),
                                                StandardCharsets.UTF_8)
                                        .replaceAll("\\+", "%20")));
            }
        }
            ...
            for (String _key : getObjectNullableProp().keySet()) {
                joiner.add(
                        String.format(
                                ...
                                getObjectNullableProp().get(_key),
                                URLEncoder.encode(
                                                String.valueOf(getObjectNullableProp().get(_key)),
                                                StandardCharsets.UTF_8)
                                        .replaceAll("\\+", "%20")));
            }
        }
        ...
        if (getObjectAndItemsNullableProp() != null) {
            for (String _key : getObjectAndItemsNullableProp().keySet()) {
                joiner.add(
                        String.format(
                                "%sobject_and_items_nullable_prop%s%s=%s",
                                prefix,
                                suffix,
                                "".equals(suffix)
                                        ? ""
                                        : String.format(
                                                "%s%d%s", containerPrefix, _key, containerSuffix),
                                getObjectAndItemsNullableProp().get(_key),
                                URLEncoder.encode(
                                                String.valueOf(
                                                        getObjectAndItemsNullableProp().get(_key)),
                                                StandardCharsets.UTF_8)
                ...
                joiner.add(
                        String.format(
                                ...
                                "".equals(suffix)
                                        ...
                                        : String.format(
                                                "%s%d%s", containerPrefix, _key, containerSuffix),
                                getObjectItemsNullable().get(_key),
                                URLEncoder.encode(
                                                String.valueOf(getObjectItemsNullable().get(_key)),
                                                StandardCharsets.UTF_8)
                                        .replaceAll("\\+", "%20")));
            }
        }
