...
public class PetApi {
  ...
  public void deletePet(Long petId, String apiKey) throws ApiException {
    ...
    String localVarPath = "/pet/{petId}".replace(
        "{petId}", ApiClient.urlEncode(petId.toString()));
  ...
  public ModelApiResponse uploadFile(Long petId, String additionalMetadata,
    ...
    String localVarPath = "/pet/{petId}/uploadImage".replace(
        "{petId}", ApiClient.urlEncode(petId.toString()));
    ...
    try {
      ...
      return memberVarObjectMapper.readValue(
          localVarResponse.body(), new TypeReference<ModelApiResponse>() {});
    } catch (IOException e) {
      throw new ApiException(e);
    } catch (InterruptedException e) {
      Thread.currentThread().interrupt();
  ...
  public ModelApiResponse uploadFileWithRequiredFile(Long petId,
    ...
    String localVarPath = "/fake/{petId}/uploadImageWithRequiredFile".replace(
        "{petId}", ApiClient.urlEncode(petId.toString()));
