...
public class FormatTest {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.integer, formatTest.integer)
                ...
                && Objects.equals(
                        ...
                        formatTest.patternWithDigitsAndDelimiter);
    }
    ...
    public String toString() {
        ...
        sb.append("    patternWithDigits: ")
                .append(toIndentedString(patternWithDigits))
                .append("\n");
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getInteger() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            URLEncoder.encode(String.valueOf(getInteger()), StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
        ...
        if (getInt32() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            URLEncoder.encode(String.valueOf(getInt32()), StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
        ...
        if (getInt64() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            URLEncoder.encode(String.valueOf(getInt64()), StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
        ...
        if (getFloat() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            URLEncoder.encode(String.valueOf(getFloat()), StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
        ...
        if (getDouble() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            URLEncoder.encode(String.valueOf(getDouble()), StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
        ...
        if (getDecimal() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            URLEncoder.encode(String.valueOf(getDecimal()), StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
        ...
        if (getString() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            URLEncoder.encode(String.valueOf(getString()), StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
        ...
        if (getByte() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            URLEncoder.encode(String.valueOf(getByte()), StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
        ...
        if (getDate() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            URLEncoder.encode(String.valueOf(getDate()), StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
        ...
        if (getDateTime() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            URLEncoder.encode(String.valueOf(getDateTime()), StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
        ...
        if (getUuid() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            URLEncoder.encode(String.valueOf(getUuid()), StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
        ...
        if (getPatternWithDigits() != null) {
            joiner.add(
                    String.format(
                            "%spattern_with_digits%s=%s",
                            prefix,
                            suffix,
                            URLEncoder.encode(
                                            String.valueOf(getPatternWithDigits()),
        ...
        if (getPatternWithDigitsAndDelimiter() != null) {
            joiner.add(
                    String.format(
                            "%spattern_with_digits_and_delimiter%s=%s",
                            prefix,
                            suffix,
                            URLEncoder.encode(
                                            String.valueOf(getPatternWithDigitsAndDelimiter()),
                                            StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
