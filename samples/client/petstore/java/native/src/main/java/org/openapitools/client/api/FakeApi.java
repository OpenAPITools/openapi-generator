...
public class FakeApi {
  ...
  public void createXmlItem(XmlItem xmlItem) throws ApiException {
    ...
    try {
      byte[] localVarPostBody =
          memberVarObjectMapper.writeValueAsBytes(xmlItem);
  ...
  public OuterComposite fakeOuterCompositeSerialize(OuterComposite body)
    ...
    try {
      ...
      return memberVarObjectMapper.readValue(
          localVarResponse.body(), new TypeReference<OuterComposite>() {});
    } catch (IOException e) {
      throw new ApiException(e);
    } catch (InterruptedException e) {
      Thread.currentThread().interrupt();
  ...
  public BigDecimal fakeOuterNumberSerialize(BigDecimal body)
    ...
    try {
      ...
      return memberVarObjectMapper.readValue(
          localVarResponse.body(), new TypeReference<BigDecimal>() {});
    } catch (IOException e) {
      throw new ApiException(e);
    } catch (InterruptedException e) {
      Thread.currentThread().interrupt();
  ...
  public void testBodyWithQueryParams(String query, User body)
    ...
    if (!localVarQueryParams.isEmpty()) {
      ...
      localVarQueryParams.forEach(
          p -> queryJoiner.add(p.getName() + '=' + p.getValue()));
      localVarRequestBuilder.uri(URI.create(memberVarBaseUri + localVarPath +
  ...
  testEnumParameters(List<String> enumHeaderStringArray,
    ...
    if (enumHeaderStringArray != null) {
      localVarRequestBuilder.header("enum_header_string_array",
                                    enumHeaderStringArray.toString());
    }
    if (enumHeaderString != null) {
      localVarRequestBuilder.header("enum_header_string",
                                    enumHeaderString.toString());
    }
    localVarRequestBuilder.header("Accept", "application/json");
  ...
  public void testGroupParameters(Integer requiredStringGroup,
    ...
    if (requiredBooleanGroup != null) {
      localVarRequestBuilder.header("required_boolean_group",
                                    requiredBooleanGroup.toString());
    }
    ...
    try {
      localVarRequestBuilder.method("DELETE",
                                    HttpRequest.BodyPublishers.noBody());
      if (memberVarReadTimeout != null) {
        localVarRequestBuilder.timeout(memberVarReadTimeout);
      }
