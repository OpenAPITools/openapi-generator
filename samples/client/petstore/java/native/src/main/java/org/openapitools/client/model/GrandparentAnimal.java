...
/** GrandparentAnimal */
@JsonPropertyOrder({GrandparentAnimal.JSON_PROPERTY_PET_TYPE})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
@JsonIgnoreProperties(
        value = "pet_type", // ignore manually set pet_type, it will be automatically generated by
        ...
        if (getPetType() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            URLEncoder.encode(String.valueOf(getPetType()), StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
