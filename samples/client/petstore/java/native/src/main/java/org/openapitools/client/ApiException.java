...
public class ApiException extends Exception {
  ...
  public ApiException(String message, int code, HttpHeaders responseHeaders,
                      String responseBody) {
  ...
  public ApiException(int code, HttpHeaders responseHeaders,
                      String responseBody) {
  ...
  public ApiException(int code, String message, HttpHeaders responseHeaders,
                      String responseBody) {
    this(code, message);
    this.responseHeaders = responseHeaders;
    this.responseBody = responseBody;
