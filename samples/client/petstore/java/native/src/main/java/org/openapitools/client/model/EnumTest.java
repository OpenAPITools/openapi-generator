...
public class EnumTest {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.enumString, enumTest.enumString)
                ...
                && Objects.equals(
                        this.outerEnumIntegerDefaultValue, enumTest.outerEnumIntegerDefaultValue);
    }
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getEnumString() != null) {
            joiner.add(
                    String.format(
                            ...
                            suffix,
                            URLEncoder.encode(
                                            String.valueOf(getEnumString()), StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
        ...
        if (getEnumStringRequired() != null) {
            joiner.add(
                    String.format(
                            "%senum_string_required%s=%s",
                            prefix,
                            suffix,
                            URLEncoder.encode(
                                            String.valueOf(getEnumStringRequired()),
        ...
        if (getEnumIntegerOnly() != null) {
            joiner.add(
                    String.format(
                            "%senum_integer_only%s=%s",
                            prefix,
                            suffix,
                            URLEncoder.encode(
                                            String.valueOf(getEnumIntegerOnly()),
                                            StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
        ...
        if (getEnumNumber() != null) {
            joiner.add(
                    String.format(
                            ...
                            suffix,
                            URLEncoder.encode(
                                            String.valueOf(getEnumNumber()), StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
        ...
        if (getOuterEnum() != null) {
            joiner.add(
                    String.format(
                            ...
                            suffix,
                            URLEncoder.encode(
                                            String.valueOf(getOuterEnum()), StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
        ...
        if (getOuterEnumInteger() != null) {
            joiner.add(
                    String.format(
                            "%souterEnumInteger%s=%s",
                            prefix,
                            suffix,
                            URLEncoder.encode(
                                            String.valueOf(getOuterEnumInteger()),
                                            StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
        ...
        if (getOuterEnumDefaultValue() != null) {
            joiner.add(
                    String.format(
                            "%souterEnumDefaultValue%s=%s",
                            prefix,
                            suffix,
                            URLEncoder.encode(
                                            String.valueOf(getOuterEnumDefaultValue()),
                                            StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
        ...
        if (getOuterEnumIntegerDefaultValue() != null) {
            joiner.add(
                    String.format(
                            "%souterEnumIntegerDefaultValue%s=%s",
                            prefix,
                            suffix,
                            URLEncoder.encode(
                                            String.valueOf(getOuterEnumIntegerDefaultValue()),
                                            StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
