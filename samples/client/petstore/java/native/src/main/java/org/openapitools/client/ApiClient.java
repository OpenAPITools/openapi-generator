...
public class ApiClient {
  ...
  public static List<Pair> parameterToPairs(String name, Object value) {
    ...
    return Collections.singletonList(
        new Pair(urlEncode(name), urlEncode(value.toString())));
  }
   ...
   * empty list is returned.
   */
  public static List<Pair> parameterToPairs(String collectionFormat,
    ...
    case "pipes":
      ...
      break;
    default:
      throw new IllegalArgumentException("Illegal collection format: " +
                                         collectionFormat);
    }
    ...
    return Collections.singletonList(
        new Pair(urlEncode(name), joiner.toString()));
  }
   ...
   */
  public HttpClient getHttpClient() { return builder.build(); }
   ...
   */
  public ObjectMapper getObjectMapper() { return mapper.copy(); }
   ...
   *
   * <p>This is useful for logging, monitoring or extraction of header
   * variables</p>
   *
   * @param interceptor A function invoked before creating each request. A value
   *                    of null resets the interceptor to a no-op.
