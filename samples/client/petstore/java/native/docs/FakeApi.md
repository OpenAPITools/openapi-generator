...
> ApiResponse<Void> testBodyWithFileSchema testBodyWithFileSchemaWithHttpInfo(body)
...
> ApiResponse<Void> testBodyWithQueryParams testBodyWithQueryParamsWithHttpInfo(query, body)
