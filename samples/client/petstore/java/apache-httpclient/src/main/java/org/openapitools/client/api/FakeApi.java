...
public class FakeApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public void fakeUnsupportedSchemeTest(Pet pet, String query1, String header1) throws ApiException {
    this.fakeUnsupportedSchemeTest(pet, query1, header1, Collections.emptyMap());
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public void fakeUnsupportedSchemeTest(Pet pet, String query1, String header1, Map<String, String> additionalHeaders) throws ApiException {
    Object localVarPostBody = pet;
    
    // verify the required parameter 'pet' is set
    if (pet == null) {
      throw new ApiException(400, "Missing the required parameter 'pet' when calling fakeUnsupportedSchemeTest");
    }
    
    // create path and map variables
    String localVarPath = "/fake/unsupported-scheme-test";
