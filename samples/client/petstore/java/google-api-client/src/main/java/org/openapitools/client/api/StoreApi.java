...
public class StoreApi {
   ...
   * @throws IOException if an error occurs while attempting to invoke the API
   **/
  public void deleteOrder(String orderId, Map<String, Object> params)
      throws IOException {
    deleteOrderForHttpResponse(orderId, params);
  }

  public HttpResponse deleteOrderForHttpResponse(String orderId)
      throws IOException {
    ...
    UriBuilder uriBuilder =
        UriBuilder.fromUri(apiClient.getBasePath() + "/store/order/{order_id}");
   ...
   * @throws IOException if an error occurs while attempting to invoke the API
   **/
  public Map<String, Integer> getInventory(Map<String, Object> params)
      throws IOException {
  ...
  public HttpResponse getInventoryForHttpResponse() throws IOException {
    ...
    UriBuilder uriBuilder =
        UriBuilder.fromUri(apiClient.getBasePath() + "/store/inventory");
  ...
  public HttpResponse getInventoryForHttpResponse(Map<String, Object> params)
      throws IOException {
   ...
   * @throws IOException if an error occurs while attempting to invoke the API
   **/
  public Order getOrderById(Long orderId, Map<String, Object> params)
      throws IOException {
  ...
  public HttpResponse getOrderByIdForHttpResponse(Long orderId)
      throws IOException {
    // verify the required parameter 'orderId' is set
    if (orderId == null) {
      throw new IllegalArgumentException(
   ...
   * @throws IOException if an error occurs while attempting to invoke the API
   **/
  public Order placeOrder(Order body, Map<String, Object> params)
      throws IOException {
  ...
  public HttpResponse placeOrderForHttpResponse(Order body) throws IOException {
    ...
    UriBuilder uriBuilder =
        UriBuilder.fromUri(apiClient.getBasePath() + "/store/order");
  ...
  public HttpResponse placeOrderForHttpResponse(java.io.InputStream body,
                                                String mediaType)
      throws IOException {
    // verify the required parameter 'body' is set
    if (body == null) {
  ...
  public HttpResponse placeOrderForHttpResponse(Order body,
                                                Map<String, Object> params)
      throws IOException {
    // verify the required parameter 'body' is set
    if (body == null) {
