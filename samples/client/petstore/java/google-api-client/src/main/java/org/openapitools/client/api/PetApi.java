...
public class PetApi {
  ...
  public PetApi() { this(new ApiClient()); }

  public PetApi(ApiClient apiClient) { this.apiClient = apiClient; }
   ...
   * <p><b>405</b> - Invalid input
   * @param body Pet object that needs to be added to the store
   * @param params Map of query params. A collection will be interpreted as
   *passing in multiple instances of the same query param.
   * @throws IOException if an error occurs while attempting to invoke the API
   **/
  ...
  public HttpResponse addPetForHttpResponse(Pet body) throws IOException {
    ...
    UriBuilder uriBuilder =
        UriBuilder.fromUri(apiClient.getBasePath() + "/pet");
  ...
  public HttpResponse addPetForHttpResponse(java.io.InputStream body,
                                            String mediaType)
      throws IOException {
    // verify the required parameter 'body' is set
    if (body == null) {
    ...
    HttpContent content =
        body == null
            ...
            : new InputStreamContent(
                  mediaType == null ? Json.MEDIA_TYPE : mediaType, body);
    return apiClient.getHttpRequestFactory()
        .buildRequest(HttpMethods.POST, genericUrl, content)
        .execute();
  }

  public HttpResponse addPetForHttpResponse(Pet body,
    ...
    Map<String, Object> allParams = params == null
    ...
    for (Map.Entry<String, Object> entry : allParams.entrySet()) {
      ...
      if (key != null && value != null) {
        if (value instanceof Collection) {
          uriBuilder =
              uriBuilder.queryParam(key, ((Collection)value).toArray());
   ...
   * @throws IOException if an error occurs while attempting to invoke the API
   **/
  public void deletePet(Long petId, Map<String, Object> params)
      throws IOException {
    deletePetForHttpResponse(petId, params);
  }

  public HttpResponse deletePetForHttpResponse(Long petId, String apiKey)
      throws IOException {
    ...
    UriBuilder uriBuilder =
        UriBuilder.fromUri(apiClient.getBasePath() + "/pet/{petId}");
  ...
  public HttpResponse deletePetForHttpResponse(Long petId,
                                               Map<String, Object> params)
      throws IOException {
    // verify the required parameter 'petId' is set
    if (petId == null) {
  ...
  public List<Pet> findPetsByStatus(List<String> status) throws IOException {
    ...
    return apiClient.getObjectMapper().readValue(response.getContent(),
                                                 typeRef);
  }
  ...
  public HttpResponse findPetsByStatusForHttpResponse(List<String> status)
      throws IOException {
    ...
    UriBuilder uriBuilder =
        UriBuilder.fromUri(apiClient.getBasePath() + "/pet/findByStatus");
    if (status != null) {
      String key = "status";
      Object value = status;
      if (value instanceof Collection) {
  ...
  public HttpResponse findPetsByStatusForHttpResponse(
      List<String> status, Map<String, Object> params) throws IOException {
    // verify the required parameter 'status' is set
    if (status == null) {
      throw new IllegalArgumentException(
          "Missing the required parameter 'status' when calling findPetsByStatus");
   ...
   *tag3 for testing. <p><b>200</b> - successful operation <p><b>400</b> -
   *Invalid tag value
   ...
   * @throws IOException if an error occurs while attempting to invoke the API
   **/
  public List<Pet> findPetsByTags(List<String> tags, Map<String, Object> params)
      throws IOException {
  ...
  public HttpResponse findPetsByTagsForHttpResponse(List<String> tags)
      throws IOException {
    ...
    UriBuilder uriBuilder =
        UriBuilder.fromUri(apiClient.getBasePath() + "/pet/findByTags");
    if (tags != null) {
      String key = "tags";
      Object value = tags;
      if (value instanceof Collection) {
   ...
   * @throws IOException if an error occurs while attempting to invoke the API
   **/
  public Pet getPetById(Long petId, Map<String, Object> params)
      throws IOException {
  ...
  public HttpResponse getPetByIdForHttpResponse(Long petId,
                                                Map<String, Object> params)
      throws IOException {
    // verify the required parameter 'petId' is set
    if (petId == null) {
   ...
   * @throws IOException if an error occurs while attempting to invoke the API
   **/
  public void updatePet(Pet body, Map<String, Object> params)
      throws IOException {
  ...
  public HttpResponse updatePetForHttpResponse(java.io.InputStream body,
                                               String mediaType)
      throws IOException {
    // verify the required parameter 'body' is set
    if (body == null) {
  ...
  public HttpResponse updatePetForHttpResponse(Pet body,
                                               Map<String, Object> params)
      throws IOException {
    // verify the required parameter 'body' is set
    if (body == null) {
   ...
   * @throws IOException if an error occurs while attempting to invoke the API
   **/
  public void updatePetWithForm(Long petId, Map<String, Object> params)
      throws IOException {
    updatePetWithFormForHttpResponse(petId, params);
  }

  public HttpResponse updatePetWithFormForHttpResponse(Long petId, String name,
                                                       String status)
      throws IOException {
    // verify the required parameter 'petId' is set
    if (petId == null) {
  ...
  public HttpResponse
  updatePetWithFormForHttpResponse(Long petId, Map<String, Object> params)
      throws IOException {
    // verify the required parameter 'petId' is set
    if (petId == null) {
      throw new IllegalArgumentException(
  ...
  public ModelApiResponse uploadFile(Long petId, String additionalMetadata,
    ...
    HttpResponse response =
        uploadFileForHttpResponse(petId, additionalMetadata, file);
    TypeReference<ModelApiResponse> typeRef =
        new TypeReference<ModelApiResponse>() {};
    return apiClient.getObjectMapper().readValue(response.getContent(),
                                                 typeRef);
  }
   ...
   * @throws IOException if an error occurs while attempting to invoke the API
   **/
  public ModelApiResponse uploadFile(Long petId, Map<String, Object> params)
      throws IOException {
  ...
  public HttpResponse uploadFileForHttpResponse(Long petId,
    ...
    final Map<String, Object> uriVariables = new HashMap<String, Object>();
    uriVariables.put("petId", petId);
    UriBuilder uriBuilder = UriBuilder.fromUri(apiClient.getBasePath() +
   ...
   * @throws IOException if an error occurs while attempting to invoke the API
   **/
  public ModelApiResponse uploadFileWithRequiredFile(Long petId,
                                                     File requiredFile,
                                                     String additionalMetadata)
      throws IOException {
    HttpResponse response = uploadFileWithRequiredFileForHttpResponse(
        petId, requiredFile, additionalMetadata);
    TypeReference<ModelApiResponse> typeRef =
        new TypeReference<ModelApiResponse>() {};
    return apiClient.getObjectMapper().readValue(response.getContent(),
                                                 typeRef);
  ...
  public ModelApiResponse uploadFileWithRequiredFile(Long petId,
      ...
      throws IOException {
    HttpResponse response =
        uploadFileWithRequiredFileForHttpResponse(petId, requiredFile, params);
    TypeReference<ModelApiResponse> typeRef =
        new TypeReference<ModelApiResponse>() {};
    return apiClient.getObjectMapper().readValue(response.getContent(),
                                                 typeRef);
  ...
  public HttpResponse
  uploadFileWithRequiredFileForHttpResponse(Long petId, File requiredFile,
                                            String additionalMetadata)
      throws IOException {
    // verify the required parameter 'petId' is set
    if (petId == null) {
      throw new IllegalArgumentException(
          "Missing the required parameter 'petId' when calling uploadFileWithRequiredFile");
    ...
    UriBuilder uriBuilder = UriBuilder.fromUri(
        apiClient.getBasePath() + "/fake/{petId}/uploadImageWithRequiredFile");
