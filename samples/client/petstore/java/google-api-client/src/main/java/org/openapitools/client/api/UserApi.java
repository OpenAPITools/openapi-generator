...
public class UserApi {
  ...
  public UserApi() { this(new ApiClient()); }
   ...
   * @throws IOException if an error occurs while attempting to invoke the API
   **/
  public void createUser(User body, Map<String, Object> params)
      throws IOException {
  ...
  public HttpResponse createUserForHttpResponse(User body) throws IOException {
    ...
    UriBuilder uriBuilder =
        UriBuilder.fromUri(apiClient.getBasePath() + "/user");
  ...
  public HttpResponse createUserForHttpResponse(java.io.InputStream body,
                                                String mediaType)
      throws IOException {
    // verify the required parameter 'body' is set
    if (body == null) {
  ...
  public HttpResponse createUserForHttpResponse(User body,
  ...
  public HttpResponse createUsersWithArrayInputForHttpResponse(List<User> body)
      throws IOException {
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new IllegalArgumentException(
    ...
    UriBuilder uriBuilder =
        UriBuilder.fromUri(apiClient.getBasePath() + "/user/createWithArray");
  ...
  public HttpResponse createUsersWithArrayInputForHttpResponse(
      java.io.InputStream body, String mediaType) throws IOException {
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new IllegalArgumentException(
          "Missing the required parameter 'body' when calling createUsersWithArrayInput");
  ...
  public HttpResponse createUsersWithArrayInputForHttpResponse(
      List<User> body, Map<String, Object> params) throws IOException {
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new IllegalArgumentException(
          "Missing the required parameter 'body' when calling createUsersWithArrayInput");
  ...
  public HttpResponse createUsersWithListInputForHttpResponse(List<User> body)
      throws IOException {
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new IllegalArgumentException(
    ...
    UriBuilder uriBuilder =
        UriBuilder.fromUri(apiClient.getBasePath() + "/user/createWithList");
  ...
  public HttpResponse
  createUsersWithListInputForHttpResponse(java.io.InputStream body,
  ...
  public HttpResponse createUsersWithListInputForHttpResponse(
      List<User> body, Map<String, Object> params) throws IOException {
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new IllegalArgumentException(
   ...
   * @throws IOException if an error occurs while attempting to invoke the API
   **/
  public void deleteUser(String username, Map<String, Object> params)
      throws IOException {
    deleteUserForHttpResponse(username, params);
  }

  public HttpResponse deleteUserForHttpResponse(String username)
      throws IOException {
    ...
    UriBuilder uriBuilder =
        UriBuilder.fromUri(apiClient.getBasePath() + "/user/{username}");
   ...
   * @throws IOException if an error occurs while attempting to invoke the API
   **/
  public User getUserByName(String username, Map<String, Object> params)
      throws IOException {
  ...
  public HttpResponse getUserByNameForHttpResponse(String username)
      throws IOException {
    // verify the required parameter 'username' is set
    if (username == null) {
      throw new IllegalArgumentException(
  ...
  public String loginUser(String username, String password,
    ...
    HttpResponse response =
        loginUserForHttpResponse(username, password, params);
    TypeReference<String> typeRef = new TypeReference<String>() {};
    return apiClient.getObjectMapper().readValue(response.getContent(),
                                                 typeRef);
  }

  public HttpResponse loginUserForHttpResponse(String username, String password)
      throws IOException {
    // verify the required parameter 'username' is set
    if (username == null) {
      throw new IllegalArgumentException(
    ...
    UriBuilder uriBuilder =
        UriBuilder.fromUri(apiClient.getBasePath() + "/user/login");
    if (username != null) {
      String key = "username";
   ...
   * @throws IOException if an error occurs while attempting to invoke the API
   **/
  public void logoutUser() throws IOException { logoutUserForHttpResponse(); }
  ...
  public HttpResponse logoutUserForHttpResponse() throws IOException {
    ...
    UriBuilder uriBuilder =
        UriBuilder.fromUri(apiClient.getBasePath() + "/user/logout");
  ...
  public HttpResponse logoutUserForHttpResponse(Map<String, Object> params)
      throws IOException {
   ...
   * @throws IOException if an error occurs while attempting to invoke the API
   **/
  public void updateUser(String username, User body, Map<String, Object> params)
      throws IOException {
    updateUserForHttpResponse(username, body, params);
  }

  public HttpResponse updateUserForHttpResponse(String username, User body)
      throws IOException {
    // verify the required parameter 'username' is set
    if (username == null) {
      throw new IllegalArgumentException(
  ...
  public HttpResponse updateUserForHttpResponse(String username,
