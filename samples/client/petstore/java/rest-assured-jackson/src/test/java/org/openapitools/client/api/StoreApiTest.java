...
public class StoreApiTest {
  ...
  public void shouldSee400AfterDeleteOrder() {
    String orderId = null;
    api.deleteOrder().orderIdPath(orderId).execute(r -> r.prettyPeek());
  ...
  public void shouldSee200AfterGetOrderById() {
    Long orderId = null;
    api.getOrderById().orderIdPath(orderId).execute(r -> r.prettyPeek());
    // TODO: test validations
  }
  ...
  public void shouldSee200AfterPlaceOrder() {
    Order body = null;
    api.placeOrder().body(body).execute(r -> r.prettyPeek());
    // TODO: test validations
  }
