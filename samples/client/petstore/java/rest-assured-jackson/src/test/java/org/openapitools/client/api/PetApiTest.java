...
public class PetApiTest {
  ...
  public void shouldSee200AfterAddPet() {
    Pet body = null;
    api.addPet().body(body).execute(r -> r.prettyPeek());
  ...
  public void shouldSee200AfterDeletePet() {
    Long petId = null;
    String apiKey = null;
    api.deletePet().petIdPath(petId).execute(r -> r.prettyPeek());
    // TODO: test validations
  }
  ...
  public void shouldSee200AfterFindPetsByStatus() {
    ...
    api.findPetsByStatus().statusQuery(status).execute(r -> r.prettyPeek());
    // TODO: test validations
  }
  ...
  public void shouldSee200AfterFindPetsByTags() {
    ...
    api.findPetsByTags().tagsQuery(tags).execute(r -> r.prettyPeek());
    // TODO: test validations
  }
  ...
  public void shouldSee200AfterGetPetById() {
    Long petId = null;
    api.getPetById().petIdPath(petId).execute(r -> r.prettyPeek());
    // TODO: test validations
  }
  ...
  public void shouldSee405AfterUpdatePetWithForm() {
    ...
    String name = null;
    String status = null;
    api.updatePetWithForm().petIdPath(petId).execute(r -> r.prettyPeek());
    // TODO: test validations
  }
  ...
  public void shouldSee200AfterUploadFile() {
    ...
    File file = null;
    api.uploadFile().petIdPath(petId).execute(r -> r.prettyPeek());
    // TODO: test validations
  }
  ...
  public void shouldSee200AfterUploadFileWithRequiredFile() {
    ...
    api.uploadFileWithRequiredFile()
        .petIdPath(petId)
        .requiredFileMultiPart(requiredFile)
