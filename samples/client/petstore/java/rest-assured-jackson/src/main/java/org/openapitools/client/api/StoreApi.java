...
public class StoreApi {
  ...
  public List<Oper> getAllOperations() {
    return Arrays.asList(deleteOrder(), getInventory(), getOrderById(),
                         placeOrder());
  }
  ...
  @ApiOperation(
      ...
      nickname = "deleteOrder", tags = {"store"})
  @ApiResponses(value =
                {
  ...
  @ApiOperation(value = "Returns pet inventories by status",
                ...
                nickname = "getInventory", tags = {"store"})
  @ApiResponses(
  ...
  @ApiOperation(
      ...
      nickname = "getOrderById", tags = {"store"})
  @ApiResponses(value =
                {
  ...
  @ApiOperation(value = "Place an order for a pet", notes = "",
                nickname = "placeOrder", tags = {"store"})
  @ApiResponses(value =
                {
                  @ApiResponse(code = 200, message = "successful operation")
  ...
  public static class GetInventoryOper implements Oper {
    ...
    executeAs(Function<Response, Response> handler) {
      TypeRef<Map<String, Integer>> type =
