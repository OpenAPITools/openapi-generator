...
public class FakeApi {
  ...
  public List<Oper> getAllOperations() {
    return Arrays.asList(createXmlItem(), fakeOuterBooleanSerialize(),
                         fakeOuterCompositeSerialize(),
                         fakeOuterNumberSerialize(), fakeOuterStringSerialize(),
                         testBodyWithFileSchema(), testBodyWithQueryParams(),
                         testClientModel(), testEndpointParameters(),
                         testEnumParameters(), testGroupParameters(),
                         testInlineAdditionalProperties(), testJsonFormData(),
                         testQueryParameterCollectionFormat());
  }

  @ApiOperation(value = "creates an XmlItem",
                notes = "this route creates an XmlItem",
                nickname = "createXmlItem", tags = {"fake"})
  @ApiResponses(
      value = { @ApiResponse(code = 200, message = "successful operation") })
  public CreateXmlItemOper
  createXmlItem() {
    return new CreateXmlItemOper(createReqSpec());
  }

  @ApiOperation(value = "", notes = "Test serialization of outer boolean types",
                nickname = "fakeOuterBooleanSerialize", tags = {"fake"})
  @ApiResponses(
      value = { @ApiResponse(code = 200, message = "Output boolean") })
  ...
  @ApiOperation(value = "",
                ...
                nickname = "fakeOuterCompositeSerialize", tags = {"fake"})
  @ApiResponses(
      value = { @ApiResponse(code = 200, message = "Output composite") })
  public FakeOuterCompositeSerializeOper
  fakeOuterCompositeSerialize() {
    return new FakeOuterCompositeSerializeOper(createReqSpec());
  }

  @ApiOperation(value = "", notes = "Test serialization of outer number types",
                nickname = "fakeOuterNumberSerialize", tags = {"fake"})
  @ApiResponses(value = { @ApiResponse(code = 200, message = "Output number") })
  public FakeOuterNumberSerializeOper
  fakeOuterNumberSerialize() {
    return new FakeOuterNumberSerializeOper(createReqSpec());
  }

  @ApiOperation(value = "", notes = "Test serialization of outer string types",
                nickname = "fakeOuterStringSerialize", tags = {"fake"})
  @ApiResponses(value = { @ApiResponse(code = 200, message = "Output string") })
  ...
  @ApiOperation(
      ...
      nickname = "testBodyWithFileSchema", tags = {"fake"})
  ...
  @ApiOperation(value = "", notes = "", nickname = "testBodyWithQueryParams",
                tags = {"fake"})
  @ApiResponses(value = { @ApiResponse(code = 200, message = "Success") })
  ...
  @ApiOperation(value = "To test \"client\" model",
                ...
                nickname = "testClientModel", tags = {"fake"})
  @ApiResponses(
      value = { @ApiResponse(code = 200, message = "successful operation") })
  ...
  @ApiOperation(
      ...
      notes =
          "Fake endpoint for testing various parameters  假端點  偽のエンドポイント  가짜 엔드 포인트",
      nickname = "testEndpointParameters", tags = {"fake"})
  @ApiResponses(value =
                {
  ...
  @ApiOperation(value = "To test enum parameters",
                ...
                nickname = "testEnumParameters", tags = {"fake"})
  @ApiResponses(value =
                {
  ...
  @ApiOperation(value = "Fake endpoint to test group parameters (optional)",
                ...
                nickname = "testGroupParameters", tags = {"fake"})
  @ApiResponses(
      value = { @ApiResponse(code = 400, message = "Someting wrong") })
  public TestGroupParametersOper
  testGroupParameters() {
    return new TestGroupParametersOper(createReqSpec());
  }

  @ApiOperation(value = "test inline additionalProperties", notes = "",
                nickname = "testInlineAdditionalProperties", tags = {"fake"})
  @ApiResponses(
      value = { @ApiResponse(code = 200, message = "successful operation") })
  ...
  @ApiOperation(value = "test json serialization of form data", notes = "",
                nickname = "testJsonFormData", tags = {"fake"})
  @ApiResponses(
      value = { @ApiResponse(code = 200, message = "successful operation") })
  ...
  @ApiOperation(value = "",
                ...
                tags = {"fake"})
  @ApiResponses(value = { @ApiResponse(code = 200, message = "Success") })
  public TestQueryParameterCollectionFormatOper
  testQueryParameterCollectionFormat() {
  ...
  public static class TestEndpointParametersOper implements Oper {
    ...
    public static final String PATTERN_WITHOUT_DELIMITER_FORM =
     ...
     */
    public TestEndpointParametersOper
    patternWithoutDelimiterForm(Object... patternWithoutDelimiter) {
      reqSpec.addFormParam(PATTERN_WITHOUT_DELIMITER_FORM,
     ...
     */
    public TestEndpointParametersOper
    paramCallbackForm(Object... paramCallback) {
      reqSpec.addFormParam(PARAM_CALLBACK_FORM, paramCallback);
      return this;
    }

    /**
     * It will assume that the control name is file and the &lt;content-type&gt;
   ...
   * To test enum parameters
   *
   * @see #enumHeaderStringArrayHeader Header parameter enum test (string array)
   *     (optional, default to new ArrayList&lt;&gt;())
   * @see #enumHeaderStringHeader Header parameter enum test (string) (optional,
   *     default to -efg)
   * @see #enumQueryStringArrayQuery Query parameter enum test (string array)
   *     (optional, default to new ArrayList&lt;&gt;())
   * @see #enumQueryStringQuery Query parameter enum test (string) (optional,
   *     default to -efg)
   ...
   * @see #enumFormStringArrayForm Form parameter enum test (string array)
   *     (optional, default to $)
  ...
  public static class TestEnumParametersOper implements Oper {
    ...
    public static final String ENUM_HEADER_STRING_ARRAY_HEADER =
        "enum_header_string_array";

    /**
     * @param enumHeaderStringArray (List&lt;String&gt;) Header parameter enum
     *     test (string array) (optional, default to new ArrayList&lt;&gt;())
     * @return operation
     */
    public TestEnumParametersOper
    enumHeaderStringArrayHeader(String enumHeaderStringArray) {
     ...
     *     (optional, default to -efg)
     * @return operation
     */
    public TestEnumParametersOper
    enumHeaderStringHeader(String enumHeaderString) {
      reqSpec.addHeader(ENUM_HEADER_STRING_HEADER, enumHeaderString);
      return this;
    }

    public static final String ENUM_QUERY_STRING_ARRAY_QUERY =
        "enum_query_string_array";

    /**
     * @param enumQueryStringArray (List&lt;String&gt;) Query parameter enum
     *     test (string array) (optional, default to new ArrayList&lt;&gt;())
     * @return operation
     */
    public TestEnumParametersOper
    enumQueryStringArrayQuery(Object... enumQueryStringArray) {
      reqSpec.addQueryParam(ENUM_QUERY_STRING_ARRAY_QUERY,
     ...
     */
    public TestEnumParametersOper
    enumQueryStringQuery(Object... enumQueryString) {
    ...
    /**
     * @param enumQueryInteger (Integer) Query parameter enum test (double)
     *     (optional)
     * @return operation
     */
    public TestEnumParametersOper
    enumQueryIntegerQuery(Object... enumQueryInteger) {
    ...
    /**
     * @param enumQueryDouble (Double) Query parameter enum test (double)
     *     (optional)
     * @return operation
     */
    public TestEnumParametersOper
    enumQueryDoubleQuery(Object... enumQueryDouble) {
      reqSpec.addQueryParam(ENUM_QUERY_DOUBLE_QUERY, enumQueryDouble);
      return this;
    }

    public static final String ENUM_FORM_STRING_ARRAY_FORM =
        "enum_form_string_array";

    /**
     * @param enumFormStringArray (List&lt;String&gt;) Form parameter enum test
     *     (string array) (optional, default to $)
     * @return operation
     */
    public TestEnumParametersOper
    enumFormStringArrayForm(Object... enumFormStringArray) {
   ...
   * Fake endpoint to test group parameters (optional)
   *
   * @see #requiredStringGroupQuery Required String in group parameters
   *     (required)
   * @see #requiredBooleanGroupHeader Required Boolean in group parameters
   *     (required)
   * @see #requiredInt64GroupQuery Required Integer in group parameters
   *     (required)
  ...
  public static class TestGroupParametersOper implements Oper {
    ...
    public static final String REQUIRED_BOOLEAN_GROUP_HEADER =
        "required_boolean_group";

    /**
     * @param requiredBooleanGroup (Boolean) Required Boolean in group
     *     parameters (required)
     * @return operation
     */
    public TestGroupParametersOper
    requiredBooleanGroupHeader(String requiredBooleanGroup) {
    ...
    public static final String REQUIRED_STRING_GROUP_QUERY =
        "required_string_group";

    /**
     * @param requiredStringGroup (Integer) Required String in group parameters
     *     (required)
     * @return operation
     */
    public TestGroupParametersOper
    requiredStringGroupQuery(Object... requiredStringGroup) {
      reqSpec.addQueryParam(REQUIRED_STRING_GROUP_QUERY, requiredStringGroup);
      return this;
    }

    public static final String REQUIRED_INT64_GROUP_QUERY =
        "required_int64_group";

    /**
     * @param requiredInt64Group (Long) Required Integer in group parameters
     *     (required)
     * @return operation
     */
    public TestGroupParametersOper
    requiredInt64GroupQuery(Object... requiredInt64Group) {
