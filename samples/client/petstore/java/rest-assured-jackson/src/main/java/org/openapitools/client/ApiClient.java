...
public class ApiClient {
  ...
  private ApiClient(Config config) { this.config = config; }

  public static ApiClient api(Config config) { return new ApiClient(config); }

  public AnotherFakeApi anotherFake() {
    return AnotherFakeApi.anotherFake(config.reqSpecSupplier);
  }
  public FakeApi fake() { return FakeApi.fake(config.reqSpecSupplier); }
  ...
  public PetApi pet() { return PetApi.pet(config.reqSpecSupplier); }
  public StoreApi store() { return StoreApi.store(config.reqSpecSupplier); }
  public UserApi user() { return UserApi.user(config.reqSpecSupplier); }

  public static class Config {
    private Supplier<RequestSpecBuilder> reqSpecSupplier = ()
        -> new RequestSpecBuilder().setBaseUri(BASE_URI).setConfig(
    ...
    public static Config apiConfig() { return new Config(); }
  }
}