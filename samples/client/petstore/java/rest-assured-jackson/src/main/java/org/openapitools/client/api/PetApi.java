...
public class PetApi {
  ...
  public List<Oper> getAllOperations() {
    return Arrays.asList(addPet(), deletePet(), findPetsByStatus(),
                         findPetsByTags(), getPetById(), updatePet(),
                         updatePetWithForm(), uploadFile(),
                         uploadFileWithRequiredFile());
  }

  @ApiOperation(value = "Add a new pet to the store", notes = "",
                nickname = "addPet", tags = {"pet"})
  @ApiResponses(value =
                {
  ...
  @ApiOperation(value = "Deletes a pet", notes = "", nickname = "deletePet",
                tags = {"pet"})
  @ApiResponses(value =
                {
                  @ApiResponse(code = 200, message = "successful operation")
  ...
  @ApiOperation(
      ...
      nickname = "findPetsByStatus", tags = {"pet"})
  @ApiResponses(value =
                {
                  @ApiResponse(code = 200, message = "successful operation")
  ...
  @ApiOperation(
      ...
      nickname = "findPetsByTags", tags = {"pet"})
  @ApiResponses(value =
                {
                  @ApiResponse(code = 200, message = "successful operation")
  ...
  @ApiOperation(value = "Updates a pet in the store with form data", notes = "",
                nickname = "updatePetWithForm", tags = {"pet"})
  ...
  @ApiOperation(value = "uploads an image", notes = "", nickname = "uploadFile",
                tags = {"pet"})
  @ApiResponses(
  ...
  @ApiOperation(value = "uploads an image (required)", notes = "",
                nickname = "uploadFileWithRequiredFile", tags = {"pet"})
  @ApiResponses(
      value = { @ApiResponse(code = 200, message = "successful operation") })
   ...
   * Multiple status values can be provided with comma separated strings
   *
   * @see #statusQuery Status values that need to be considered for filter
   *     (required)
   * return List&lt;Pet&gt;
   */
  public static class FindPetsByStatusOper implements Oper {
    ...
    /**
     * @param status (List&lt;String&gt;) Status values that need to be
     *     considered for filter (required)
     * @return operation
     */
  ...
  public static class UploadFileWithRequiredFileOper implements Oper {
    ...
    public static final Method REQ_METHOD = POST;
    public static final String REQ_URI =
     ...
     */
    public UploadFileWithRequiredFileOper
    additionalMetadataForm(Object... additionalMetadata) {
      reqSpec.addFormParam(ADDITIONAL_METADATA_FORM, additionalMetadata);
      return this;
    }
     ...
     */
    public UploadFileWithRequiredFileOper
    requiredFileMultiPart(File requiredFile) {
