...
public class AnotherFakeApi {
  ...
  anotherFake(Supplier<RequestSpecBuilder> reqSpecSupplier) {
  ...
  public List<Oper> getAllOperations() {
    return Arrays.asList(call123testSpecialTags());
  }

  @ApiOperation(
      value = "To test special tags",
      notes = "To test special tags and operation ID starting with number",
      nickname = "call123testSpecialTags", tags = {"$another-fake?"})
  @ApiResponses(
  ...
  reqSpec(Consumer<RequestSpecBuilder> reqSpecCustomizer) {
  ...
  public static class Call123testSpecialTagsOper implements Oper {
     ...
     */
    public Call123testSpecialTagsOper
    respSpec(Consumer<ResponseSpecBuilder> respSpecCustomizer) {
