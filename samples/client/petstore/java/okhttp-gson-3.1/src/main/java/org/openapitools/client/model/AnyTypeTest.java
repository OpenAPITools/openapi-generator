...
public class AnyTypeTest {
  ...
  public AnyTypeTest refArrayPrefixItems(@javax.annotation.Nullable List<String> refArrayPrefixItems) {
  ...
  public void setRefArrayPrefixItems(@javax.annotation.Nullable List<String> refArrayPrefixItems) {
    this.refArrayPrefixItems = refArrayPrefixItems;
  }
