...
public class FakeRefParameterPetIdParameter extends AbstractOpenApiSchema {
    ...
    public static class FakeRefParameterPetIdParameterSerializer extends StdSerializer<FakeRefParameterPetIdParameter> {
        ...
        @Override
        public void serialize(FakeRefParameterPetIdParameter value, JsonGenerator jgen, SerializationContext serializationContext) throws JacksonException {
    ...
    public static class FakeRefParameterPetIdParameterDeserializer extends StdDeserializer<FakeRefParameterPetIdParameter> {
        ...
        @Override
        public FakeRefParameterPetIdParameter deserialize(JsonParser jp, DeserializationContext ctxt) throws JacksonException {
            ...
            throw DatabindException.from(jp, String.format(java.util.Locale.ROOT, "Failed deserialization for FakeRefParameterPetIdParameter: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public FakeRefParameterPetIdParameter getNullValue(DeserializationContext ctxt) {
            throw DatabindException.from(ctxt.getParser(), "FakeRefParameterPetIdParameter cannot be null");
        }
    }
