...
@JsonPropertyOrder({
  ...
  PetUsingAllOf.JSON_PROPERTY_NAME,
  PetUsingAllOf.JSON_PROPERTY_PHOTO_URLS,
  PetUsingAllOf.JSON_PROPERTY_TAGS,
  PetUsingAllOf.JSON_PROPERTY_STATUS
})
@JsonTypeName("PetUsingAllOf")
