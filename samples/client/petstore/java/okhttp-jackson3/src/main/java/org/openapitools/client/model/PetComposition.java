...
@JsonPropertyOrder({
  PetComposition.JSON_PROPERTY_ID,
  PetComposition.JSON_PROPERTY_CATEGORY,
  PetComposition.JSON_PROPERTY_NAME,
  PetComposition.JSON_PROPERTY_PHOTO_URLS,
  PetComposition.JSON_PROPERTY_TAGS,
  PetComposition.JSON_PROPERTY_STATUS
})
@JsonTypeName("PetComposition")
