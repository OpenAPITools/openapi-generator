...
@JsonIgnoreProperties(
  value = "enum_str_type", // ignore manually set enum_str_type, it will be automatically generated by Jackson during serialization
  allowSetters = true // allows the enum_str_type to be set during deserialization
)
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "enum_str_type", visible = true)

@JsonPropertyOrder({
  EnumStringDiscriminator.JSON_PROPERTY_ENUM_STR_TYPE
})
@JsonTypeName("EnumStringDiscriminator")
public class EnumStringDiscriminator {
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_ENUM_STR_TYPE, required = true)
