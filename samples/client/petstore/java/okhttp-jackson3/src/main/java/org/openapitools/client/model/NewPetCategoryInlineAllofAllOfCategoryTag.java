...
@JsonPropertyOrder({
  NewPetCategoryInlineAllofAllOfCategoryTag.JSON_PROPERTY_ID,
  NewPetCategoryInlineAllofAllOfCategoryTag.JSON_PROPERTY_NAME
})
@JsonTypeName("NewPet_category_inline_allof_allOf_category_tag")
