    ...
    public static class QuadrilateralDeserializer extends StdDeserializer<Quadrilateral> {
        ...
        public Quadrilateral deserialize(JsonParser jp, DeserializationContext ctxt) throws JacksonException {
            ...
            try {
                ...
                if (attemptParsing) {
                    deserialized = ctxt.readTreeAsValue(tree, ctxt.getTypeFactory().constructType(new TypeReference<SimpleQuadrilateral>() {}));
            ...
            try {
                ...
                if (attemptParsing) {
                    deserialized = ctxt.readTreeAsValue(tree, ctxt.getTypeFactory().constructType(new TypeReference<ComplexQuadrilateral>() {}));
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
