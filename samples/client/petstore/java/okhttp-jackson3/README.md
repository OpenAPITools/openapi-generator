...
<dependency>
  ...
  <artifactId>petstore-okhttp-jackson3</artifactId>
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'petstore-okhttp-jackson3' jar has been published to maven central.
    mavenLocal()       // Needed if the 'petstore-okhttp-jackson3' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "org.openapitools:petstore-okhttp-jackson3:1.0.0"
  }
```
...
* `target/petstore-okhttp-jackson3-1.0.0.jar`
* `target/lib/*.jar`
