...
public class PetApi {
  ...
  public ApiResponse<Void> addPetWithHttpInfo(Pet body) throws ApiException {
    ...
    if (body == null) {
      throw new ApiException(
          400, "Missing the required parameter 'body' when calling addPet");
    }
    ...
    return apiClient.invokeAPI("PetApi.addPet", localVarPath, "POST",
  ...
  public ApiResponse<Void> deletePetWithHttpInfo(Long petId, String apiKey)
    ...
    if (petId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'petId' when calling deletePet");
    }

    // create path and map variables
    String localVarPath =
        "/pet/{petId}".replaceAll("\\{"
                                      + "petId"
                                      + "\\}",
                                  apiClient.escapeString(petId.toString()));
    ...
    return apiClient.invokeAPI("PetApi.deletePet", localVarPath, "DELETE",
                               localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams,
                               localVarFormParams, localVarAccept,
                               localVarContentType, localVarAuthNames, null);
  ...
  findPetsByStatusWithHttpInfo(List<String> status) throws ApiException {
    ...
    return apiClient.invokeAPI(
        "PetApi.findPetsByStatus", localVarPath, "GET", localVarQueryParams,
  ...
  public ApiResponse<List<Pet>> findPetsByTagsWithHttpInfo(List<String> tags)
    ...
    GenericType<List<Pet>> localVarReturnType = new GenericType<List<Pet>>() {};
    return apiClient.invokeAPI(
        "PetApi.findPetsByTags", localVarPath, "GET", localVarQueryParams,
        localVarPostBody, localVarHeaderParams, localVarCookieParams,
        localVarFormParams, localVarAccept, localVarContentType,
        localVarAuthNames, localVarReturnType);
  }
  ...
  public ApiResponse<Pet> getPetByIdWithHttpInfo(Long petId)
    ...
    return apiClient.invokeAPI(
        "PetApi.getPetById", localVarPath, "GET", localVarQueryParams,
        localVarPostBody, localVarHeaderParams, localVarCookieParams,
        localVarFormParams, localVarAccept, localVarContentType,
        localVarAuthNames, localVarReturnType);
  }
  ...
  public ApiResponse<Void> updatePetWithHttpInfo(Pet body) throws ApiException {
    ...
    if (body == null) {
      throw new ApiException(
          400, "Missing the required parameter 'body' when calling updatePet");
    }
    ...
    return apiClient.invokeAPI("PetApi.updatePet", localVarPath, "PUT",
                               localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams,
                               localVarFormParams, localVarAccept,
                               localVarContentType, localVarAuthNames, null);
  ...
  updatePetWithFormWithHttpInfo(Long petId, String name, String status)
    ...
    return apiClient.invokeAPI("PetApi.updatePetWithForm", localVarPath, "POST",
                               localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams,
                               localVarFormParams, localVarAccept,
                               localVarContentType, localVarAuthNames, null);
  ...
  uploadFileWithHttpInfo(Long petId, String additionalMetadata, File file)
    ...
    GenericType<ModelApiResponse> localVarReturnType =
        new GenericType<ModelApiResponse>() {};
    return apiClient.invokeAPI(
        "PetApi.uploadFile", localVarPath, "POST", localVarQueryParams,
        localVarPostBody, localVarHeaderParams, localVarCookieParams,
        localVarFormParams, localVarAccept, localVarContentType,
        localVarAuthNames, localVarReturnType);
  }
  ...
  uploadFileWithRequiredFileWithHttpInfo(Long petId, File requiredFile,
    ...
    GenericType<ModelApiResponse> localVarReturnType =
        new GenericType<ModelApiResponse>() {};
    return apiClient.invokeAPI(
        "PetApi.uploadFileWithRequiredFile", localVarPath, "POST",
