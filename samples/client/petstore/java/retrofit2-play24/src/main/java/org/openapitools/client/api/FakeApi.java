...
public interface FakeApi {
   ...
   * 
   * @param param request body (required)
   * @return Call&lt;MixedPropertiesAndAdditionalPropertiesClass&gt;
   */
  @Headers({
    "Content-Type:application/json"
  })
  @POST("fake/body-mixedPropertiesAndAdditionalProperties")
  F.Promise<Response<MixedPropertiesAndAdditionalPropertiesClass>> testMixedPropertiesAndAdditionalProperties(
