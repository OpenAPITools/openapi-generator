...
public interface PetApi {
  ...
  @POST("pet")
  Completable addPet(@retrofit2.http.Body Pet body);
   ...
   */
  @DELETE("pet/{petId}")
  Completable deletePet(@retrofit2.http.Path("petId") Long petId,
   ...
   */
  @GET("pet/{petId}")
  Observable<Pet> getPetById(@retrofit2.http.Path("petId") Long petId);
  ...
  @Headers({"Content-Type:application/json"})
  @PUT("pet")
  Completable updatePet(@retrofit2.http.Body Pet body);
  ...
  @POST("pet/{petId}")
  Completable updatePetWithForm(@retrofit2.http.Path("petId") Long petId,
