  ...
  */
  public AdditionalPropertiesClass.Builder toBuilder() {
    return new AdditionalPropertiesClass.Builder()
      ...
      .mapInteger(getMapInteger())
      .mapBoolean(getMapBoolean())
      .mapArrayInteger(getMapArrayInteger())
      .mapArrayAnytype(getMapArrayAnytype())
      .mapMapString(getMapMapString())
      .mapMapAnytype(getMapMapAnytype())
      .anytype1(getAnytype1())
      .anytype2(getAnytype2())
      .anytype3(getAnytype3());
  }
