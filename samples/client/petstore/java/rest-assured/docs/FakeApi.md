...
api.testEndpointEnumsLengthOne()
    .queryIntegerQuery(queryInteger)
    .queryStringQuery(queryString)
    .pathStringPath(pathString)
    .pathIntegerPath(pathInteger)
    .headerNumberHeader(headerNumber).execute(r -> r.prettyPeek());
```
