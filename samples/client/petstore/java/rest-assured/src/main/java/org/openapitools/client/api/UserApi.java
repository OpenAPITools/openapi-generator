...
public class UserApi {
  ...
  public List<Oper> getAllOperations() {
    return Arrays.asList(
        createUser(), createUsersWithArrayInput(), createUsersWithListInput(),
        deleteUser(), getUserByName(), loginUser(), logoutUser(), updateUser());
  }

  @ApiOperation(value = "Create user",
                notes = "This can only be done by the logged in user.",
                nickname = "createUser", tags = {"user"})
  @ApiResponses(
      value = { @ApiResponse(code = 0, message = "successful operation") })
  ...
  @ApiOperation(value = "Creates list of users with given input array",
                notes = "", nickname = "createUsersWithArrayInput",
                tags = {"user"})
  @ApiResponses(
      value = { @ApiResponse(code = 0, message = "successful operation") })
  ...
  @ApiOperation(value = "Creates list of users with given input array",
                notes = "", nickname = "createUsersWithListInput",
                tags = {"user"})
  @ApiResponses(
      value = { @ApiResponse(code = 0, message = "successful operation") })
  ...
  @ApiOperation(value = "Get user by user name", notes = "",
                nickname = "getUserByName", tags = {"user"})
  @ApiResponses(value =
                {
  ...
  @ApiOperation(value = "Logs user into the system", notes = "",
                nickname = "loginUser", tags = {"user"})
  @ApiResponses(value =
                {
                  @ApiResponse(code = 200, message = "successful operation")
                  , @ApiResponse(code = 400,
   ...
   *
   *
   * @see #usernamePath The name that needs to be fetched. Use user1 for
   *     testing. (required)
   * return User
   */
