...
public class FakeApiTest {
  ...
  public void shouldSee200AfterCreateXmlItem() {
    ...
    api.createXmlItem().body(xmlItem).execute(r -> r.prettyPeek());
  ...
  public void shouldSee200AfterTestBodyWithFileSchema() {
    ...
    api.testBodyWithFileSchema().body(body).execute(r -> r.prettyPeek());
    // TODO: test validations
  }
  ...
  public void shouldSee200AfterTestBodyWithQueryParams() {
    String query = null;
    User body = null;
    api.testBodyWithQueryParams().queryQuery(query).body(body).execute(
        r -> r.prettyPeek());
    // TODO: test validations
  }
  ...
  public void shouldSee200AfterTestClientModel() {
    Client body = null;
    api.testClientModel().body(body).execute(r -> r.prettyPeek());
    // TODO: test validations
  }
  ...
  public void shouldSee400AfterTestGroupParameters() {
    ...
    api.testGroupParameters()
        ...
        .requiredInt64GroupQuery(requiredInt64Group)
        .execute(r -> r.prettyPeek());
    // TODO: test validations
  }
  ...
  public void shouldSee200AfterTestInlineAdditionalProperties() {
    ...
    api.testInlineAdditionalProperties().body(param).execute(
        r -> r.prettyPeek());
    // TODO: test validations
  }
  ...
  public void shouldSee200AfterTestJsonFormData() {
    String param = null;
    String param2 = null;
    api.testJsonFormData().paramForm(param).param2Form(param2).execute(
        r -> r.prettyPeek());
    // TODO: test validations
  }
