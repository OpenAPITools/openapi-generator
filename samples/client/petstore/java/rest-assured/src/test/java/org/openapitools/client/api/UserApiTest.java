...
public class UserApiTest {
  ...
  public void createApi() {
    api = ApiClient
              .api(ApiClient.Config.apiConfig().reqSpecSupplier(
                  ()
  ...
  public void shouldSee0AfterCreateUser() {
    User body = null;
    api.createUser().body(body).execute(r -> r.prettyPeek());
  ...
  public void shouldSee0AfterCreateUsersWithArrayInput() {
    List<User> body = null;
    api.createUsersWithArrayInput().body(body).execute(r -> r.prettyPeek());
    // TODO: test validations
  }
  ...
  public void shouldSee0AfterCreateUsersWithListInput() {
    List<User> body = null;
    api.createUsersWithListInput().body(body).execute(r -> r.prettyPeek());
    // TODO: test validations
  }
  ...
  public void shouldSee400AfterDeleteUser() {
    ...
    api.deleteUser().usernamePath(username).execute(r -> r.prettyPeek());
    // TODO: test validations
  }
  ...
  public void shouldSee200AfterGetUserByName() {
    String username = null;
    api.getUserByName().usernamePath(username).execute(r -> r.prettyPeek());
    // TODO: test validations
  }
  ...
  public void shouldSee200AfterLoginUser() {
    ...
    api.loginUser().usernameQuery(username).passwordQuery(password).execute(
        r -> r.prettyPeek());
    // TODO: test validations
  }
  ...
  public void shouldSee400AfterUpdateUser() {
    String username = null;
    User body = null;
    api.updateUser().usernamePath(username).body(body).execute(
        r -> r.prettyPeek());
    // TODO: test validations
  }
