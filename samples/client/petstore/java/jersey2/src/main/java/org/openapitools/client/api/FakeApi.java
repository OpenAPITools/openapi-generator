...
public class FakeApi {
  ...
  public FakeApi(ApiClient apiClient) { this.apiClient = apiClient; }
  ...
  public ApiResponse<Void> createXmlItemWithHttpInfo(XmlItem xmlItem)
    ...
    return apiClient.invokeAPI("FakeApi.createXmlItem", localVarPath, "POST",
  ...
  fakeOuterBooleanSerializeWithHttpInfo(Boolean body) throws ApiException {
    ...
    return apiClient.invokeAPI(
        "FakeApi.fakeOuterBooleanSerialize", localVarPath, "POST",
  ...
  fakeOuterCompositeSerializeWithHttpInfo(OuterComposite body)
    ...
    GenericType<OuterComposite> localVarReturnType =
        new GenericType<OuterComposite>() {};
    return apiClient.invokeAPI(
        "FakeApi.fakeOuterCompositeSerialize", localVarPath, "POST",
        localVarQueryParams, localVarPostBody, localVarHeaderParams,
        localVarCookieParams, localVarFormParams, localVarAccept,
        localVarContentType, localVarAuthNames, localVarReturnType);
  }
  ...
  fakeOuterNumberSerializeWithHttpInfo(BigDecimal body) throws ApiException {
    ...
    GenericType<BigDecimal> localVarReturnType =
        new GenericType<BigDecimal>() {};
    return apiClient.invokeAPI(
        "FakeApi.fakeOuterNumberSerialize", localVarPath, "POST",
        localVarQueryParams, localVarPostBody, localVarHeaderParams,
        localVarCookieParams, localVarFormParams, localVarAccept,
        localVarContentType, localVarAuthNames, localVarReturnType);
  }
  ...
  public ApiResponse<String> fakeOuterStringSerializeWithHttpInfo(String body)
    ...
    return apiClient.invokeAPI(
        "FakeApi.fakeOuterStringSerialize", localVarPath, "POST",
        localVarQueryParams, localVarPostBody, localVarHeaderParams,
        localVarCookieParams, localVarFormParams, localVarAccept,
        localVarContentType, localVarAuthNames, localVarReturnType);
  }
  ...
  testBodyWithFileSchemaWithHttpInfo(FileSchemaTestClass body)
    ...
    return apiClient.invokeAPI("FakeApi.testBodyWithFileSchema", localVarPath,
                               "PUT", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams,
                               localVarFormParams, localVarAccept,
                               localVarContentType, localVarAuthNames, null);
  }
  ...
  public ApiResponse<Void> testBodyWithQueryParamsWithHttpInfo(String query,
    ...
    return apiClient.invokeAPI("FakeApi.testBodyWithQueryParams", localVarPath,
                               "PUT", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams,
                               localVarFormParams, localVarAccept,
                               localVarContentType, localVarAuthNames, null);
  ...
  public ApiResponse<Client> testClientModelWithHttpInfo(Client body)
    ...
    return apiClient.invokeAPI(
        "FakeApi.testClientModel", localVarPath, "PATCH", localVarQueryParams,
  ...
  public ApiResponse<Void> testEndpointParametersWithHttpInfo(
    ...
    return apiClient.invokeAPI("FakeApi.testEndpointParameters", localVarPath,
  ...
  public ApiResponse<Void> testEnumParametersWithHttpInfo(
    ...
    localVarQueryParams.addAll(apiClient.parameterToPairs(
    ...
    return apiClient.invokeAPI("FakeApi.testEnumParameters", localVarPath,
                               "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams,
                               localVarFormParams, localVarAccept,
                               localVarContentType, localVarAuthNames, null);
  }
  ...
  private ApiResponse<Void> testGroupParametersWithHttpInfo(
    ...
    localVarQueryParams.addAll(
        apiClient.parameterToPairs("", "string_group", stringGroup));
    localVarQueryParams.addAll(
        apiClient.parameterToPairs("", "int64_group", int64Group));
    ...
    if (booleanGroup != null)
      localVarHeaderParams.put("boolean_group",
    ...
    return apiClient.invokeAPI("FakeApi.testGroupParameters", localVarPath,
                               "DELETE", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams,
                               localVarFormParams, localVarAccept,
                               localVarContentType, localVarAuthNames, null);
  }
  ...
  public class APItestGroupParametersRequest {
    ...
    requiredStringGroup(Integer requiredStringGroup) {
     ...
     */
    public APItestGroupParametersRequest
    requiredBooleanGroup(Boolean requiredBooleanGroup) {
     ...
     */
    public APItestGroupParametersRequest
    requiredInt64Group(Long requiredInt64Group) {
  ...
  public APItestGroupParametersRequest testGroupParameters()
      throws ApiException {
  ...
  testInlineAdditionalPropertiesWithHttpInfo(Map<String, String> param)
    ...
    return apiClient.invokeAPI(
        "FakeApi.testInlineAdditionalProperties", localVarPath, "POST",
        localVarQueryParams, localVarPostBody, localVarHeaderParams,
        localVarCookieParams, localVarFormParams, localVarAccept,
        localVarContentType, localVarAuthNames, null);
  }
  ...
  public ApiResponse<Void> testJsonFormDataWithHttpInfo(String param,
    ...
    return apiClient.invokeAPI("FakeApi.testJsonFormData", localVarPath, "GET",
                               localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams,
                               localVarFormParams, localVarAccept,
                               localVarContentType, localVarAuthNames, null);
  ...
  public ApiResponse<Void> testQueryParameterCollectionFormatWithHttpInfo(
    ...
    localVarQueryParams.addAll(
        apiClient.parameterToPairs("csv", "ioutil", ioutil));
    localVarQueryParams.addAll(
        apiClient.parameterToPairs("space", "http", http));
    localVarQueryParams.addAll(apiClient.parameterToPairs("csv", "url", url));
    localVarQueryParams.addAll(
        apiClient.parameterToPairs("multi", "context", context));
    ...
    return apiClient.invokeAPI(
        "FakeApi.testQueryParameterCollectionFormat", localVarPath, "PUT",
        localVarQueryParams, localVarPostBody, localVarHeaderParams,
        localVarCookieParams, localVarFormParams, localVarAccept,
        localVarContentType, localVarAuthNames, null);
  }
