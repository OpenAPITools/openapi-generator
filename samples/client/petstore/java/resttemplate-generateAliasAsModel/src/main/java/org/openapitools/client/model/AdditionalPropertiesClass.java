...
public class AdditionalPropertiesClass {
  ...
  @jakarta.annotation.Nullable
  private JsonNullable<Object> anytype2 = JsonNullable.<Object>of(null);
   ...
   */
  public AdditionalPropertiesClass(@JsonProperty(JSON_PROPERTY_MAP_STRING) Map<String, String> mapString, @JsonProperty(JSON_PROPERTY_MAP_NUMBER) Map<String, BigDecimal> mapNumber, @JsonProperty(JSON_PROPERTY_MAP_INTEGER) Map<String, Integer> mapInteger, @JsonProperty(JSON_PROPERTY_MAP_BOOLEAN) Map<String, Boolean> mapBoolean, @JsonProperty(JSON_PROPERTY_MAP_ARRAY_INTEGER) Map<String, List<Integer>> mapArrayInteger, @JsonProperty(JSON_PROPERTY_MAP_ARRAY_ANYTYPE) Map<String, List<Object>> mapArrayAnytype, @JsonProperty(JSON_PROPERTY_MAP_MAP_STRING) Map<String, Map<String, String>> mapMapString, @JsonProperty(JSON_PROPERTY_MAP_MAP_ANYTYPE) Map<String, Map<String, Object>> mapMapAnytype, @JsonProperty(JSON_PROPERTY_ANYTYPE1) Object anytype1, @JsonProperty(JSON_PROPERTY_ANYTYPE2) Object anytype2, @JsonProperty(JSON_PROPERTY_ANYTYPE3) Object anytype3) {
    ...
    this.anytype2 = anytype2 == null ? JsonNullable.<Object>undefined() : JsonNullable.of(anytype2);
  ...
  public AdditionalPropertiesClass anytype2(@jakarta.annotation.Nullable Object anytype2) {
    this.anytype2 = JsonNullable.<Object>of(anytype2);
  ...
  public Object getAnytype2() {
        return anytype2.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_ANYTYPE2)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<Object> getAnytype2_JsonNullable() {
    return anytype2;
  }
  
  @JsonProperty(JSON_PROPERTY_ANYTYPE2)
  public void setAnytype2_JsonNullable(JsonNullable<Object> anytype2) {
