...
public class AdditionalPropertiesAnyType {
   ...
   */
  public AdditionalPropertiesAnyType(@JsonProperty(JSON_PROPERTY_NAME) String name) {
    this.name = name;
  }

  public AdditionalPropertiesAnyType name(@jakarta.annotation.Nullable String name) {
