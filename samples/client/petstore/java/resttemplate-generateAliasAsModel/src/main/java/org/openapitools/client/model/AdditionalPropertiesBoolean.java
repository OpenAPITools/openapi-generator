...
public class AdditionalPropertiesBoolean {
   ...
   */
  public AdditionalPropertiesBoolean(@JsonProperty(JSON_PROPERTY_NAME) String name) {
    this.name = name;
  }

  public AdditionalPropertiesBoolean name(@jakarta.annotation.Nullable String name) {
