...
public class AdditionalPropertiesArray {
   ...
   */
  public AdditionalPropertiesArray(@JsonProperty(JSON_PROPERTY_NAME) String name) {
    this.name = name;
  }

  public AdditionalPropertiesArray name(@jakarta.annotation.Nullable String name) {
