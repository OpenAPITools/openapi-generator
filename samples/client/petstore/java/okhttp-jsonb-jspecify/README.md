# petstore-okhttp-jsonb-jspecify
...
<dependency>
  ...
  <artifactId>petstore-okhttp-jsonb-jspecify</artifactId>
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'petstore-okhttp-jsonb-jspecify' jar has been published to maven central.
    mavenLocal()       // Needed if the 'petstore-okhttp-jsonb-jspecify' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "org.openapitools:petstore-okhttp-jsonb-jspecify:1.0.0"
  }
```
...
* `target/petstore-okhttp-jsonb-jspecify-1.0.0.jar`
* `target/lib/*.jar`
