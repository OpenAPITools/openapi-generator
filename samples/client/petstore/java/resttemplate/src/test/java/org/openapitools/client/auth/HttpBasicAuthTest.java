...
public class HttpBasicAuthTest {
  ...
  public void testApplyToParams() {
    ...
    // the string below is base64-encoded result of "my-username:my-password"
    // with the "Basic " prefix
    ...
    auth.applyToParams(queryParams, headerParams, cookieParams);
    // the string below is base64-encoded result of ":my-password" with the
    // "Basic " prefix
    ...
    auth.applyToParams(queryParams, headerParams, cookieParams);
    // the string below is base64-encoded result of "my-username:" with the
    // "Basic " prefix
