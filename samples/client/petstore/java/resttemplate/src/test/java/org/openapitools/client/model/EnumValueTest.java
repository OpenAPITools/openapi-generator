...
public class EnumValueTest {
  ...
  public void testEnumTest() {
    ...
    try {
      ...
      assertEquals(
          json,
          "{\"enum_string\":\"lower\",\"enum_string_required\":null,\"enum_integer\":1,\"enum_number\":1.1,\"outerEnum\":null}");
      ...
      fail("Exception thrown during serialization/deserialzation of JSON: " +
           e.getMessage());
    }
  }
}
