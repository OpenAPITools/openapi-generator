...
public class FakeApi {
   ...
   *     the API
   */
  public ResponseEntity<Void> createXmlItemWithHttpInfo(XmlItem xmlItem)
    ...
    String path = apiClient.expandPath("/fake/create_xml_item",
    ...
    final String[] contentTypes = {"application/xml",
  ...
  fakeOuterBooleanSerializeWithHttpInfo(Boolean body)
      throws RestClientException {
    Object postBody = body;

    String path = apiClient.expandPath("/fake/outer/boolean",
                                       Collections.<String, Object>emptyMap());
   ...
   *     the API
   */
  public ResponseEntity<OuterComposite>
  fakeOuterCompositeSerializeWithHttpInfo(OuterComposite body)
      throws RestClientException {
    Object postBody = body;

    String path = apiClient.expandPath("/fake/outer/composite",
                                       Collections.<String, Object>emptyMap());
    ...
    ParameterizedTypeReference<OuterComposite> returnType =
  ...
  fakeOuterNumberSerializeWithHttpInfo(BigDecimal body)
      throws RestClientException {
    Object postBody = body;

    String path = apiClient.expandPath("/fake/outer/number",
                                       Collections.<String, Object>emptyMap());
    ...
    ParameterizedTypeReference<BigDecimal> returnType =
  ...
  fakeOuterStringSerializeWithHttpInfo(String body) throws RestClientException {
    Object postBody = body;

    String path = apiClient.expandPath("/fake/outer/string",
                                       Collections.<String, Object>emptyMap());
  ...
  testBodyWithFileSchemaWithHttpInfo(FileSchemaTestClass body)
    ...
    String path = apiClient.expandPath("/fake/body-with-file-schema",
                                       Collections.<String, Object>emptyMap());
   ...
   *     the API
   */
  public ResponseEntity<Void> testBodyWithQueryParamsWithHttpInfo(String query,
                                                                  User body)
      throws RestClientException {
    Object postBody = body;
    ...
    String path = apiClient.expandPath("/fake/body-with-query-params",
                                       Collections.<String, Object>emptyMap());
   ...
   *     the API
   */
  public ResponseEntity<Client> testClientModelWithHttpInfo(Client body)
      throws RestClientException {
    Object postBody = body;
    ...
    String path =
        apiClient.expandPath("/fake", Collections.<String, Object>emptyMap());
   ...
   *     the API
   */
  public ResponseEntity<Void> testEndpointParametersWithHttpInfo(
      BigDecimal number, Double _double, String patternWithoutDelimiter,
      byte[] _byte, Integer integer, Integer int32, Long int64, Float _float,
      String string, File binary, LocalDate date, OffsetDateTime dateTime,
      String password, String paramCallback) throws RestClientException {
   ...
   *     the API
   */
  public ResponseEntity<Void> testEnumParametersWithHttpInfo(
  ...
  testInlineAdditionalPropertiesWithHttpInfo(Map<String, String> param)
    ...
    String path = apiClient.expandPath("/fake/inline-additionalProperties",
                                       Collections.<String, Object>emptyMap());
   ...
   *     the API
   */
  public ResponseEntity<Void> testJsonFormDataWithHttpInfo(String param,
                                                           String param2)
      throws RestClientException {
    Object postBody = null;
    ...
    String path = apiClient.expandPath("/fake/jsonFormData",
                                       Collections.<String, Object>emptyMap());
   ...
   *     the API
   */
  public ResponseEntity<Void> testQueryParameterCollectionFormatWithHttpInfo(
      List<String> pipe, List<String> ioutil, List<String> http,
      List<String> url, List<String> context) throws RestClientException {
    Object postBody = null;
    ...
    String path = apiClient.expandPath("/fake/test-query-paramters",
                                       Collections.<String, Object>emptyMap());
