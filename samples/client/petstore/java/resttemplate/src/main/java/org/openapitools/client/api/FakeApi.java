...
public class FakeApi {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public MixedPropertiesAndAdditionalPropertiesClass testMixedPropertiesAndAdditionalProperties(MixedPropertiesAndAdditionalPropertiesClass param) throws RestClientException {
        Object postBody = param;
        ...
        String path = apiClient.expandPath("/fake/body-mixedPropertiesAndAdditionalProperties", Collections.<String, Object>emptyMap());
