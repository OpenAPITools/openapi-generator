...
public class MixedPropertiesAndAdditionalPropertiesClass {
   ...
   */
  public MixedPropertiesAndAdditionalPropertiesClass(@JsonProperty(JSON_PROPERTY_UUID) UUID _uuid, @JsonProperty(JSON_PROPERTY_DATE_TIME) OffsetDateTime _dateTime, @JsonProperty(JSON_PROPERTY_MAP) Map<String, Animal> _map) {
    this._uuid = _uuid;
