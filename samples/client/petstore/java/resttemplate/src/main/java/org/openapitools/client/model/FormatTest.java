...
public class FormatTest {
  ...
  public static class Builder {
    ...
    public FormatTest.Builder integer(.annotation.Nullable Integer integer) {
    ...
    public FormatTest.Builder int64(.annotation.Nullable Long int64) {
      this.instance.int64 = int64;
      return this;
    }
    public FormatTest.Builder number(.annotation.Nonnull BigDecimal number) {
      this.instance.number = number;
      return this;
    }
    public FormatTest.Builder _float(.annotation.Nullable Float _float) {
    ...
    public FormatTest.Builder decimal(.annotation.Nullable BigDecimal decimal) {
      this.instance.decimal = decimal;
      return this;
    }
    public FormatTest.Builder string(.annotation.Nullable String string) {
      this.instance.string = string;
      return this;
    }
    public FormatTest.Builder _byte(.annotation.Nonnull byte[] _byte) {
      this.instance._byte = _byte;
      return this;
    }
    public FormatTest.Builder binary(.annotation.Nullable File binary) {
    ...
    public FormatTest.Builder dateTime(.annotation.Nullable OffsetDateTime dateTime) {
      this.instance.dateTime = dateTime;
      return this;
    }
    public FormatTest.Builder uuid(.annotation.Nullable UUID uuid) {
      this.instance.uuid = uuid;
      return this;
    }
    public FormatTest.Builder password(.annotation.Nonnull String password) {
      this.instance.password = password;
      return this;
    }
    public FormatTest.Builder patternWithDigits(.annotation.Nullable String patternWithDigits) {
      this.instance.patternWithDigits = patternWithDigits;
      return this;
    }
    public FormatTest.Builder patternWithDigitsAndDelimiter(.annotation.Nullable String patternWithDigitsAndDelimiter) {
