...
public class StoreApi {
  ...
  public StoreApi() { this(new ApiClient()); }
   ...
   * 1000 or nonintegers will generate API errors <p><b>400</b> - Invalid ID
   * supplied <p><b>404</b> - Order not found
   ...
   *     the API
   */
  public ResponseEntity<Void> deleteOrderWithHttpInfo(String orderId)
    ...
    ParameterizedTypeReference<Void> returnType =
        new ParameterizedTypeReference<Void>() {};
    return apiClient.invokeAPI(path, HttpMethod.DELETE, queryParams, postBody,
   ...
   *     the API
   */
  public ResponseEntity<Map<String, Integer>> getInventoryWithHttpInfo()
      throws RestClientException {
    Object postBody = null;

    String path = apiClient.expandPath("/store/inventory",
    ...
    ParameterizedTypeReference<Map<String, Integer>> returnType =
        new ParameterizedTypeReference<Map<String, Integer>>() {};
    return apiClient.invokeAPI(path, HttpMethod.GET, queryParams, postBody,
                               headerParams, cookieParams, formParams, accept,
                               contentType, authNames, returnType);
  }
  /**
   ...
   * Other values will generated exceptions <p><b>200</b> - successful operation
   ...
   *     the API
   */
  public ResponseEntity<Order> getOrderByIdWithHttpInfo(Long orderId)
      throws RestClientException {
    Object postBody = null;
    ...
    ParameterizedTypeReference<Order> returnType =
   ...
   *     the API
   */
  public ResponseEntity<Order> placeOrderWithHttpInfo(Order body)
      throws RestClientException {
    ...
    String path = apiClient.expandPath("/store/order",
                                       Collections.<String, Object>emptyMap());
    ...
    ParameterizedTypeReference<Order> returnType =
        new ParameterizedTypeReference<Order>() {};
    return apiClient.invokeAPI(path, HttpMethod.POST, queryParams, postBody,
                               headerParams, cookieParams, formParams, accept,
                               contentType, authNames, returnType);
  }
}
