...
public class Order {
   ...
   */
  public Order(@JsonProperty(JSON_PROPERTY_ID) @javax.annotation.Nullable Long id, @JsonProperty(JSON_PROPERTY_PET_ID) @javax.annotation.Nullable Long petId, @JsonProperty(JSON_PROPERTY_QUANTITY) @javax.annotation.Nullable Integer quantity, @JsonProperty(JSON_PROPERTY_SHIP_DATE) @javax.annotation.Nullable OffsetDateTime shipDate, @JsonProperty(JSON_PROPERTY_STATUS) @javax.annotation.Nullable StatusEnum status, @JsonProperty(JSON_PROPERTY_COMPLETE) @javax.annotation.Nullable Boolean complete, @JsonProperty(JSON_PROPERTY_PAYMENT_METHOD) @javax.annotation.Nullable PaymentMethodEnum paymentMethod, @JsonProperty(JSON_PROPERTY_ORDER_STATUS) @javax.annotation.Nullable OrderStatusEnum orderStatus) {
    this.id = id;
    this.petId = petId;
  ...
  public static class Builder {
    ...
    public Order.Builder paymentMethod(PaymentMethodEnum paymentMethod) {
      this.instance.paymentMethod = paymentMethod;
      return this;
    }
    public Order.Builder orderStatus(OrderStatusEnum orderStatus) {
      this.instance.orderStatus = orderStatus;
      return this;
    }
