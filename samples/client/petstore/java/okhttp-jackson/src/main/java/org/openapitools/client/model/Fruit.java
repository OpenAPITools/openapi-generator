...
public class Fruit extends AbstractOpenApiSchema {
    ...
    public static class FruitSerializer extends StdSerializer<Fruit> {
        ...
        @Override
        public void serialize(Fruit value, JsonGenerator jgen, SerializerProvider provider) throws IOException {
    ...
    public static class FruitDeserializer extends StdDeserializer<Fruit> {
        ...
        @Override
        public Fruit deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException {
            ...
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for Fruit: %d classes match result, expected 1", match));
        }
