...
public class GmFruit extends AbstractOpenApiSchema {
    ...
    public static class GmFruitSerializer extends StdSerializer<GmFruit> {
        ...
        @Override
        public void serialize(GmFruit value, JsonGenerator jgen, SerializerProvider provider) throws IOException {
    ...
    public static class GmFruitDeserializer extends StdDeserializer<GmFruit> {
        ...
        @Override
        public GmFruit deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException {
            ...
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for GmFruit: no match found"));
        }
