...
public class AllOfModelArrayAnyOfAllOfAttributesC extends AbstractOpenApiSchema {
  ...
  public Object getAdditionalProperty(String key) {
     ...
     */
    private static void collectUnconsumedProperties(AllOfModelArrayAnyOfAllOfAttributesC instance, JsonNode tree) {
    ...
    public static class AllOfModelArrayAnyOfAllOfAttributesCSerializer extends StdSerializer<AllOfModelArrayAnyOfAllOfAttributesC> {
        ...
        @Override
        public void serialize(AllOfModelArrayAnyOfAllOfAttributesC value, JsonGenerator jgen, SerializerProvider provider) throws IOException {
    ...
    public static class AllOfModelArrayAnyOfAllOfAttributesCDeserializer extends StdDeserializer<AllOfModelArrayAnyOfAllOfAttributesC> {
        ...
        @Override
        public AllOfModelArrayAnyOfAllOfAttributesC deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException {
            ...
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for AllOfModelArrayAnyOfAllOfAttributesC: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public AllOfModelArrayAnyOfAllOfAttributesC getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "AllOfModelArrayAnyOfAllOfAttributesC cannot be null");
        }
    }
