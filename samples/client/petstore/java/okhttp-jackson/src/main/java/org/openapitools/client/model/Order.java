...
public class Order {
  ...
  @JsonProperty(value = JSON_PROPERTY_PET_ID)
  @javax.annotation.Nullable
  private Long petId;

  public static final String JSON_PROPERTY_QUANTITY = "quantity";
  @JsonProperty(value = JSON_PROPERTY_QUANTITY)
  @javax.annotation.Nullable
  private Integer quantity;

  public static final String JSON_PROPERTY_SHIP_DATE = "shipDate";
  @JsonProperty(value = JSON_PROPERTY_SHIP_DATE)
  @javax.annotation.Nullable
  ...
  @JsonProperty(value = JSON_PROPERTY_COMPLETE)
  @javax.annotation.Nullable
  ...
  public static class Builder {
    ...
    *
    * The values are put through {@link Order#putAdditionalProperty}, so the map is
    * rebuilt on the instance that actually owns it: a subclass declares its own holder that
    * shadows the parent one, and the virtual call always reaches the subclass field.
    */
    public Order.Builder additionalProperties(Map<String, Object> additionalProperties) {
