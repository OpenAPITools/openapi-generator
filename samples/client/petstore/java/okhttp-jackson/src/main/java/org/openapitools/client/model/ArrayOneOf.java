...
public class ArrayOneOf extends AbstractOpenApiSchema {
    ...
    public static class ArrayOneOfSerializer extends StdSerializer<ArrayOneOf> {
        ...
        @Override
        public void serialize(ArrayOneOf value, JsonGenerator jgen, SerializerProvider provider) throws IOException {
    ...
    public static class ArrayOneOfDeserializer extends StdDeserializer<ArrayOneOf> {
        ...
        @Override
        public ArrayOneOf deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException {
            ...
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for ArrayOneOf: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public ArrayOneOf getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "ArrayOneOf cannot be null");
        }
    }
