...
<dependency>
  ...
  <artifactId>petstore-okhttp-jackson2</artifactId>
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'petstore-okhttp-jackson2' jar has been published to maven central.
    mavenLocal()       // Needed if the 'petstore-okhttp-jackson2' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "org.openapitools:petstore-okhttp-jackson2:1.0.0"
  }
```
...
* `target/petstore-okhttp-jackson2-1.0.0.jar`
* `target/lib/*.jar`
