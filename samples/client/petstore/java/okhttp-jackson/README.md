...
<dependency>
  ...
  <artifactId>petstore-okhttp-jackson</artifactId>
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'petstore-okhttp-jackson' jar has been published to maven central.
    mavenLocal()       // Needed if the 'petstore-okhttp-jackson' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "org.openapitools:petstore-okhttp-jackson:1.0.0"
  }
```
...
* `target/petstore-okhttp-jackson-1.0.0.jar`
* `target/lib/*.jar`
