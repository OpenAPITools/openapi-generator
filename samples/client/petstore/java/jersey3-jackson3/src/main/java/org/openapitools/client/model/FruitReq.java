...
public class FruitReq extends AbstractOpenApiSchema {
    ...
    public static class FruitReqSerializer extends StdSerializer<FruitReq> {
        ...
        @Override
        public void serialize(FruitReq value, JsonGenerator jgen, SerializationContext serializationContext) throws JacksonException {
    ...
    public static class FruitReqDeserializer extends StdDeserializer<FruitReq> {
        ...
        public FruitReq deserialize(JsonParser jp, DeserializationContext ctxt) throws JacksonException {
            ...
            try {
                ...
                if (attemptParsing) {
                    deserialized = ctxt.readTreeAsValue(tree, AppleReq.class);
            ...
            try {
                boolean attemptParsing = true;
                if (attemptParsing) {
                    deserialized = ctxt.readTreeAsValue(tree, BananaReq.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
            ...
            throw DatabindException.from(jp, String.format(java.util.Locale.ROOT, "Failed deserialization for FruitReq: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public FruitReq getNullValue(DeserializationContext ctxt) {
            return null;
        }
    }
