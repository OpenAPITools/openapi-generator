...
public class ShapeOrNull extends AbstractOpenApiSchema {
    ...
    public static class ShapeOrNullDeserializer extends StdDeserializer<ShapeOrNull> {
        ...
        public ShapeOrNull deserialize(JsonParser jp, DeserializationContext ctxt) throws JacksonException {
            ...
            throw DatabindException.from(jp, String.format(java.util.Locale.ROOT, "Failed deserialization for ShapeOrNull: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public ShapeOrNull getNullValue(DeserializationContext ctxt) {
            return null;
        }
    }
