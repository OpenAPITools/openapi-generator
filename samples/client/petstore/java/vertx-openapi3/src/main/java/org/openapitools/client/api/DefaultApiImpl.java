...
public class DefaultApiImpl implements DefaultApi {
    ...
    */
    public void fooGet(Handler<AsyncResult<InlineResponseDefault>> resultHandler) {
    ...
    * @param resultHandler Asynchronous result handler
    */
    public void fooGet(ApiClient.AuthInfo authInfo, Handler<AsyncResult<InlineResponseDefault>> resultHandler) {
        ...
        TypeReference<InlineResponseDefault> localVarReturnType = new TypeReference<InlineResponseDefault>() {};
