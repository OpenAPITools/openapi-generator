...
public class ApiClient extends JavaTimeFormatter {
    ...
    public static class AuthInfo {
        ...
        public void addHttp_signature_testAuthentication(String bearerToken) {
           HttpBearerAuth auth = new
           HttpBearerAuth("signature");
           auth.setBearerToken(bearerToken);
        ...
        public static AuthInfo forHttp_signature_testAuthentication(String bearerToken) {
            AuthInfo authInfo = new AuthInfo();
            authInfo.addHttp_signature_testAuthentication(bearerToken);
            return authInfo;
        }
