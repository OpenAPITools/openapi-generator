...
<dependency>
  ...
  <artifactId>petstore-vertx-openapi3</artifactId>
...
```groovy
compile "org.openapitools:petstore-vertx-openapi3:1.0.0"
```
...
- `target/petstore-vertx-openapi3-1.0.0.jar`
- `target/lib/*.jar`
