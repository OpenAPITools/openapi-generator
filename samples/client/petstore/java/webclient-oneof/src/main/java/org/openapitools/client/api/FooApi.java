...
public class FooApi {
     ...
     */
    private ResponseSpec createFooRequestCreation(Foo foo) throws WebClientResponseException {
        Object postBody = foo;
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<FooRefOrValue> createFoo(Foo foo) throws WebClientResponseException {
        ParameterizedTypeReference<FooRefOrValue> localVarReturnType = new ParameterizedTypeReference<FooRefOrValue>() {};
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<FooRefOrValue>> createFooWithHttpInfo(Foo foo) throws WebClientResponseException {
        ParameterizedTypeReference<FooRefOrValue> localVarReturnType = new ParameterizedTypeReference<FooRefOrValue>() {};
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec createFooWithResponseSpec(Foo foo) throws WebClientResponseException {
