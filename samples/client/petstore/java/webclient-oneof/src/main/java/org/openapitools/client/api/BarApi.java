...
public class BarApi {
     ...
     */
    private ResponseSpec createBarRequestCreation(BarCreate barCreate) throws WebClientResponseException {
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<Bar> createBar(BarCreate barCreate) throws WebClientResponseException {
        ParameterizedTypeReference<Bar> localVarReturnType = new ParameterizedTypeReference<Bar>() {};
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<Bar>> createBarWithHttpInfo(BarCreate barCreate) throws WebClientResponseException {
        ParameterizedTypeReference<Bar> localVarReturnType = new ParameterizedTypeReference<Bar>() {};
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec createBarWithResponseSpec(BarCreate barCreate) throws WebClientResponseException {
