...
<dependency>
  ...
  <artifactId>petstore-webclient-oneof</artifactId>
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'petstore-webclient-oneof' jar has been published to maven central.
    mavenLocal()       // Needed if the 'petstore-webclient-oneof' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "org.openapitools:petstore-webclient-oneof:0.0.1"
  }
```
...
- `target/petstore-webclient-oneof-0.0.1.jar`
- `target/lib/*.jar`
