...
public interface PetApi  {
    ...
    @Path("/pet/findByTags")
    @Produces({ "application/xml", "application/json" })
    public Set<Pet> findPetsByTags(@QueryParam("tags") Set<String> tags) throws ApiException, ProcessingException;
    ...
    @Path("/pet")
    @Consumes({ "application/json", "application/xml" })
    public void updatePet(Pet pet) throws ApiException, ProcessingException;
    ...
    @Consumes({ "multipart/form-data" })
    @Produces({ "application/json" })
    public ModelApiResponse uploadFileWithRequiredFile(@PathParam("petId") Long petId,  @Multipart(value = "requiredFile" ) Attachment requiredFileDetail, @Multipart(value = "additionalMetadata", required = false)  String additionalMetadata) throws ApiException, ProcessingException;
}
