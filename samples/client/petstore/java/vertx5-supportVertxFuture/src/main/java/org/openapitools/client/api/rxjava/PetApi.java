...
public class PetApi {
    ...
    */
    public Single<Void> rxAddPet(Pet pet) {
        return SingleHelper.toSingle(fut -> delegate.addPet(pet, fut));
    ...
    */
    public Single<Void> rxDeletePet(Long petId, String apiKey) {
        return SingleHelper.toSingle(fut -> delegate.deletePet(petId, apiKey, fut));
    ...
    */
    public Single<List<Pet>> rxFindPetsByStatus(List<String> status) {
        return SingleHelper.toSingle(fut -> delegate.findPetsByStatus(status, fut));
    ...
    */
    public Single<Set<Pet>> rxFindPetsByTags(Set<String> tags) {
        return SingleHelper.toSingle(fut -> delegate.findPetsByTags(tags, fut));
    ...
    */
    public Single<Pet> rxGetPetById(Long petId) {
        return SingleHelper.toSingle(fut -> delegate.getPetById(petId, fut));
    ...
    */
    public Single<Void> rxUpdatePet(Pet pet) {
        return SingleHelper.toSingle(fut -> delegate.updatePet(pet, fut));
    ...
    */
    public Single<Void> rxUpdatePetWithForm(Long petId, String name, String status) {
        return SingleHelper.toSingle(fut -> delegate.updatePetWithForm(petId, name, status, fut));
    ...
    */
    public Single<ModelApiResponse> rxUploadFile(Long petId, String additionalMetadata, AsyncFile _file) {
        return SingleHelper.toSingle(fut -> delegate.uploadFile(petId, additionalMetadata, _file, fut));
    ...
    */
    public Single<ModelApiResponse> rxUploadFileWithRequiredFile(Long petId, AsyncFile requiredFile, String additionalMetadata) {
        return SingleHelper.toSingle(fut -> delegate.uploadFileWithRequiredFile(petId, requiredFile, additionalMetadata, fut));
