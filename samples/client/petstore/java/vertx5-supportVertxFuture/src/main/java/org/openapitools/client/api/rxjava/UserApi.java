...
public class UserApi {
    ...
    */
    public Single<Void> rxCreateUser(User user) {
        return SingleHelper.toSingle(fut -> delegate.createUser(user, fut));
    ...
    */
    public Single<Void> rxCreateUsersWithArrayInput(List<User> user) {
        return SingleHelper.toSingle(fut -> delegate.createUsersWithArrayInput(user, fut));
    ...
    */
    public Single<Void> rxCreateUsersWithListInput(List<User> user) {
        return SingleHelper.toSingle(fut -> delegate.createUsersWithListInput(user, fut));
    ...
    */
    public Single<Void> rxDeleteUser(String username) {
        return SingleHelper.toSingle(fut -> delegate.deleteUser(username, fut));
    ...
    */
    public Single<User> rxGetUserByName(String username) {
        return SingleHelper.toSingle(fut -> delegate.getUserByName(username, fut));
    ...
    */
    public Single<String> rxLoginUser(String username, String password) {
        return SingleHelper.toSingle(fut -> delegate.loginUser(username, password, fut));
    ...
    */
    public Single<Void> rxLogoutUser() {
        return SingleHelper.toSingle(fut -> delegate.logoutUser(fut));
    ...
    */
    public Single<Void> rxUpdateUser(String username, User user) {
        return SingleHelper.toSingle(fut -> delegate.updateUser(username, user, fut));
