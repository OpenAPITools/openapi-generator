# petstore-okhttp-parcelableModel
...
<dependency>
  ...
  <artifactId>petstore-okhttp-parcelableModel</artifactId>
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'petstore-okhttp-parcelableModel' jar has been published to maven central.
    mavenLocal()       // Needed if the 'petstore-okhttp-parcelableModel' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "org.openapitools:petstore-okhttp-parcelableModel:1.0.0"
  }
```
...
* `target/petstore-okhttp-parcelableModel-1.0.0.jar`
* `target/lib/*.jar`
