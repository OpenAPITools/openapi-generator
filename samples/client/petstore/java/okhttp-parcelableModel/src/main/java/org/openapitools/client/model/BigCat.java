...
public class BigCat extends Cat implements Parcelable {
   ...
   * @return the BigCat instance itself
   */
  public BigCat putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.kind, bigCat.kind)&&
        Objects.equals(this.additionalProperties, bigCat.additionalProperties) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(kind, super.hashCode(), additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BigCat>() {
           ...
           public BigCat read(JsonReader in) throws IOException {
             ...
             BigCat instance = thisAdapter.fromJsonTree(jsonObj);
