           ...
           public SimpleQuadrilateral read(JsonReader in) throws IOException {
             ...
             for (Entry<String, JsonElement> entry: entries) {
               if (!SimpleQuadrilateral.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException("The field `" + entry.getKey() + "` in the JSON string is not defined in the `SimpleQuadrilateral` properties");
               }
             }
...
/*
  public static class CustomDeserializer implements JsonDeserializer<SimpleQuadrilateral> {
    @Override
    public SimpleQuadrilateral deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
      ...
      return new Gson().fromJson(json, SimpleQuadrilateral.class);
    }
  }*/
}
