           ...
           public IsoscelesTriangle read(JsonReader in) throws IOException {
             ...
             for (Entry<String, JsonElement> entry: entries) {
               if (!IsoscelesTriangle.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException("The field `" + entry.getKey() + "` in the JSON string is not defined in the `IsoscelesTriangle` properties");
               }
             }
...
/*
  public static class CustomDeserializer implements JsonDeserializer<IsoscelesTriangle> {
    @Override
    public IsoscelesTriangle deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
      ...
      return new Gson().fromJson(json, IsoscelesTriangle.class);
    }
  }*/
}
