...
/*
  public static class CustomDeserializer implements JsonDeserializer<Banana> {
    @Override
    public Banana deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
      ...
      return new Gson().fromJson(json, Banana.class);
    }
  }*/
}
