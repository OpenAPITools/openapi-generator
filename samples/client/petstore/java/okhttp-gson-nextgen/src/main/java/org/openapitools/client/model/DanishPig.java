...
/*
  public static class CustomDeserializer implements JsonDeserializer<DanishPig> {
    @Override
    public DanishPig deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
      ...
      return new Gson().fromJson(json, DanishPig.class);
    }
  }*/
}
