           ...
           public EquilateralTriangle read(JsonReader in) throws IOException {
             ...
             for (Entry<String, JsonElement> entry: entries) {
               if (!EquilateralTriangle.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException("The field `" + entry.getKey() + "` in the JSON string is not defined in the `EquilateralTriangle` properties");
               }
             }
...
/*
  public static class CustomDeserializer implements JsonDeserializer<EquilateralTriangle> {
    @Override
    public EquilateralTriangle deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
      ...
      return new Gson().fromJson(json, EquilateralTriangle.class);
    }
  }*/
}
