           ...
           public HealthCheckResult read(JsonReader in) throws IOException {
             ...
             for (Entry<String, JsonElement> entry: entries) {
               if (!HealthCheckResult.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException("The field `" + entry.getKey() + "` in the JSON string is not defined in the `HealthCheckResult` properties");
               }
             }
...
/*
  public static class CustomDeserializer implements JsonDeserializer<HealthCheckResult> {
    @Override
    public HealthCheckResult deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
      ...
      return new Gson().fromJson(json, HealthCheckResult.class);
    }
  }*/
}
