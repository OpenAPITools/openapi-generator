       ...
       return (TypeAdapter<T>) new TypeAdapter<ScaleneTriangle>() {
           ...
           public ScaleneTriangle read(JsonReader in) throws IOException {
             ...
             for (Entry<String, JsonElement> entry: entries) {
               if (!ScaleneTriangle.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException("The field `" + entry.getKey() + "` in the JSON string is not defined in the `ScaleneTriangle` properties");
               }
             }
...
/*
  public static class CustomDeserializer implements JsonDeserializer<ScaleneTriangle> {
    @Override
    public ScaleneTriangle deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
      ...
      return new Gson().fromJson(json, ScaleneTriangle.class);
    }
  }*/
}
