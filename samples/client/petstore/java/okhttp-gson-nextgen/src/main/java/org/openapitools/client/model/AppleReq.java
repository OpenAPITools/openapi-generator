...
/*
  public static class CustomDeserializer implements JsonDeserializer<AppleReq> {
    @Override
    public AppleReq deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
      ...
      return new Gson().fromJson(json, AppleReq.class);
    }
  }*/
}
