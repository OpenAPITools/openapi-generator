...
public class StoreApi {
    ...
    */
    public Single<Void> rxDeleteOrder(String orderId) {
        return SingleHelper.toSingle(fut -> delegate.deleteOrder(orderId, fut));
    ...
    */
    public Single<Map<String, Integer>> rxGetInventory() {
        return SingleHelper.toSingle(fut -> delegate.getInventory(fut));
    ...
    */
    public Single<Order> rxGetOrderById(Long orderId) {
        return SingleHelper.toSingle(fut -> delegate.getOrderById(orderId, fut));
    ...
    */
    public Single<Order> rxPlaceOrder(Order order) {
        return SingleHelper.toSingle(fut -> delegate.placeOrder(order, fut));
