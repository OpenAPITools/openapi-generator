...
<dependency>
  ...
  <artifactId>petstore-vertx5</artifactId>
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'petstore-vertx5' jar has been published to maven central.
    mavenLocal()       // Needed if the 'petstore-vertx5' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "org.openapitools:petstore-vertx5:1.0.0"
  }
```
...
- `target/petstore-vertx5-1.0.0.jar`
- `target/lib/*.jar`
