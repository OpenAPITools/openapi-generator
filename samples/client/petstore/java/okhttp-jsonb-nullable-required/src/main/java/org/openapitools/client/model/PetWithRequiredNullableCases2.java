...
public class PetWithRequiredNullableCases2 {
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<PetWithRequiredNullableCases2> {
    @Override
    public void serialize(PetWithRequiredNullableCases2 value, JsonGenerator generator, SerializationContext context) {
   ...
   */
  public static class CustomJsonbDeserializer implements JsonbDeserializer<PetWithRequiredNullableCases2> {
    @Override
    public PetWithRequiredNullableCases2 deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
      ...
      PetWithRequiredNullableCases2 instance = new PetWithRequiredNullableCases2();
    ...
    private static java.lang.reflect.Field declaredField(String fieldName) {
      ...
      for (Class<?> clazz = PetWithRequiredNullableCases2.class; clazz != null; clazz = clazz.getSuperclass()) {
        try {
      ...
      throw new IllegalArgumentException("Field " + fieldName + " not found on PetWithRequiredNullableCases2");
    }
    ...
    private static void setField(PetWithRequiredNullableCases2 instance, String fieldName, Object value) {
      try {
        java.lang.reflect.Field field = declaredField(fieldName);
        field.setAccessible(true);
        field.set(instance, value);
      } catch (IllegalAccessException e) {
        throw new JsonbException("Unable to bind the field " + fieldName + " on PetWithRequiredNullableCases2", e);
      }
    }
  }
}
