...
public class PetWithRequiredNullableCases1 {
  ...
  public PetWithRequiredNullableCases1 id(@javax.annotation.Nullable Long id) {
    this.id = id;
    return this;
  }
  ...
  public PetWithRequiredNullableCases1 category(@javax.annotation.Nullable Category category) {
  ...
  public PetWithRequiredNullableCases1 name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public PetWithRequiredNullableCases1 photoUrls(@javax.annotation.Nullable List<String> photoUrls) {
  ...
  public void setPhotoUrls(@javax.annotation.Nullable List<String> photoUrls) {
    this.photoUrls = photoUrls;
  }


  public PetWithRequiredNullableCases1 tags(@javax.annotation.Nullable List<Tag> tags) {
    this.tags = tags;
    return this;
  }
  ...
  @Deprecated
  public PetWithRequiredNullableCases1 status(@javax.annotation.Nullable StatusEnum status) {
    this.status = status;
    return this;
  }
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<PetWithRequiredNullableCases1> {
    @Override
    public void serialize(PetWithRequiredNullableCases1 value, JsonGenerator generator, SerializationContext context) {
      generator.writeStartObject();
      if (value.getId() != null) {
        context.serialize("id", value.getId(), generator);
      }
      if (value.getCategory() != null) {
        context.serialize("category", value.getCategory(), generator);
      }
   ...
   */
  public static class CustomJsonbDeserializer implements JsonbDeserializer<PetWithRequiredNullableCases1> {
    @Override
    public PetWithRequiredNullableCases1 deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
      ...
      PetWithRequiredNullableCases1 instance = new PetWithRequiredNullableCases1();
    ...
    private static java.lang.reflect.Field declaredField(String fieldName) {
      ...
      for (Class<?> clazz = PetWithRequiredNullableCases1.class; clazz != null; clazz = clazz.getSuperclass()) {
        try {
      ...
      throw new IllegalArgumentException("Field " + fieldName + " not found on PetWithRequiredNullableCases1");
    }
    ...
    private static void setField(PetWithRequiredNullableCases1 instance, String fieldName, Object value) {
      try {
        java.lang.reflect.Field field = declaredField(fieldName);
        field.setAccessible(true);
        field.set(instance, value);
      } catch (IllegalAccessException e) {
        throw new JsonbException("Unable to bind the field " + fieldName + " on PetWithRequiredNullableCases1", e);
      }
    }
  }
}
