...
public class Tag {
   ...
   */
  public static class CustomJsonbSerializer implements JsonbSerializer<Tag> {
    @Override
    public void serialize(Tag value, JsonGenerator generator, SerializationContext context) {
   ...
   */
  public static class CustomJsonbDeserializer implements JsonbDeserializer<Tag> {
    @Override
    public Tag deserialize(JsonParser parser, DeserializationContext context, Type rtType) {
    ...
    private static java.lang.reflect.Field declaredField(String fieldName) {
      ...
      for (Class<?> clazz = Tag.class; clazz != null; clazz = clazz.getSuperclass()) {
        try {
      ...
      throw new IllegalArgumentException("Field " + fieldName + " not found on Tag");
    }
    ...
    private static void setField(Tag instance, String fieldName, Object value) {
      try {
        java.lang.reflect.Field field = declaredField(fieldName);
        field.setAccessible(true);
        field.set(instance, value);
      } catch (IllegalAccessException e) {
        throw new JsonbException("Unable to bind the field " + fieldName + " on Tag", e);
      }
    }
  }
}
