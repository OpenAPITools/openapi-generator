...
public class FormatTest {
  ...
  **/
  @javax.annotation.Nullable
 @Pattern(regexp="^\\d{10}$")  @ApiModelProperty(value = "A string that is a 10 digit number. Can have leading zeros.")
  ...
  **/
  @javax.annotation.Nullable
 @Pattern(regexp="/^image_\\d{1,3}$/i")  @ApiModelProperty(value = "A string starting with 'image_' (case insensitive) and one to three digits following i.e. Image_01.")
