# petstore-okhttp-jackson-jspecify
...
<dependency>
  ...
  <artifactId>petstore-okhttp-jackson-jspecify</artifactId>
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'petstore-okhttp-jackson-jspecify' jar has been published to maven central.
    mavenLocal()       // Needed if the 'petstore-okhttp-jackson-jspecify' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "org.openapitools:petstore-okhttp-jackson-jspecify:1.0.0"
  }
```
...
* `target/petstore-okhttp-jackson-jspecify-1.0.0.jar`
* `target/lib/*.jar`
