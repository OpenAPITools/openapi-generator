...
public class PetApi {
  ...
  * @throws RestClientResponseException if an error occurs while attempting to invoke the API
    */
     ...
     * @throws RestClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec downloadFileRequestCreation(@jakarta.annotation.Nonnull Long petId) throws RestClientResponseException {
        Object postBody = null;
        // verify the required parameter 'petId' is set
        if (petId == null) {
            throw new RestClientResponseException("Missing the required parameter 'petId' when calling downloadFile", HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<>();
     ...
     * @throws RestClientResponseException if an error occurs while attempting to invoke the API
     */
    public File downloadFile(@jakarta.annotation.Nonnull Long petId) throws RestClientResponseException {
        ParameterizedTypeReference<File> localVarReturnType = new ParameterizedTypeReference<>() {};
        return downloadFileRequestCreation(petId).body(localVarReturnType);
    }
     ...
     * @throws RestClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<File> downloadFileWithHttpInfo(@jakarta.annotation.Nonnull Long petId) throws RestClientResponseException {
        ParameterizedTypeReference<File> localVarReturnType = new ParameterizedTypeReference<>() {};
     ...
     * @throws RestClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec downloadFileWithResponseSpec(@jakarta.annotation.Nonnull Long petId) throws RestClientResponseException {
