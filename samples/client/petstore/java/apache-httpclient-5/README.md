...
<dependency>
  ...
  <artifactId>petstore-apache-httpclient-5</artifactId>
...
```groovy
compile "org.openapitools:petstore-apache-httpclient-5:1.0.0"
```
...
- `target/petstore-apache-httpclient-5-1.0.0.jar`
- `target/lib/*.jar`
