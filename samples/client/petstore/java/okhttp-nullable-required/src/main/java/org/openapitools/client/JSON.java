...
public class JSON {
    ...
    public JSON() {
        ...
        builder.registerTypeAdapterFactory(new org.openapitools.client.model.PetWithRequiredNullableCases1.CustomTypeAdapterFactory());
        builder.registerTypeAdapterFactory(new org.openapitools.client.model.PetWithRequiredNullableCases2.CustomTypeAdapterFactory());
