...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'nullable-required-okhttp-gson' jar has been published to maven central.
    mavenLocal()       // Needed if the 'nullable-required-okhttp-gson' jar has been published to the local maven repo.
  }
