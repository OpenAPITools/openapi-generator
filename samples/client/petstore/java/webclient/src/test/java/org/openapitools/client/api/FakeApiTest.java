...
public class FakeApiTest {
    ...
    public void fakeOuterCompositeSerializeTest()  {
        ...
        OuterComposite response = api.fakeOuterCompositeSerialize(body).block();
    ...
    public void testBodyWithFileSchemaTest()  {
        ...
        api.testBodyWithFileSchema(body).block();
    ...
    public void testBodyWithQueryParamsTest()  {
        String query = null;
        User body = null;
        api.testBodyWithQueryParams(query, body).block();
    ...
    public void testClientModelTest()  {
        Client body = null;
        Client response = api.testClientModel(body).block();
