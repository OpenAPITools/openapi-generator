...
public interface PetApi {
  ...
  @POST("pet")
  Call<Void> addPet(@retrofit2.http.Body Pet body);
   ...
   */
  @DELETE("pet/{petId}")
  Call<Void> deletePet(@retrofit2.http.Path("petId") Long petId,
  ...
  @Deprecated
  @GET("pet/findByTags")
  Call<List<Pet>> findPetsByTags(@retrofit2.http.Query("tags") CSVParams tags);
   ...
   */
  @GET("pet/{petId}")
  Call<Pet> getPetById(@retrofit2.http.Path("petId") Long petId);
  ...
  @Headers({"Content-Type:application/json"})
  @PUT("pet")
  Call<Void> updatePet(@retrofit2.http.Body Pet body);
  ...
  @POST("pet/{petId}")
  Call<Void> updatePetWithForm(@retrofit2.http.Path("petId") Long petId,
