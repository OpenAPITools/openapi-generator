...
public interface PetApi {
  ...
  public void
  updatePetWithForm(@PathParam("petId") Long petId,
                    @Multipart(value = "name", required = false) String name,
                    @Multipart(value = "status", required = false)
                    String status) throws ApiException, ProcessingException;
  ...
  uploadFile(@PathParam("petId") Long petId,
             @Multipart(value = "additionalMetadata",
