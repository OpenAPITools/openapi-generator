...
<dependency>
  ...
  <artifactId>petstore-vertx-legacy-date</artifactId>
...
```groovy
compile "org.openapitools:petstore-vertx-legacy-date:1.0.0"
```
...
- `target/petstore-vertx-legacy-date-1.0.0.jar`
- `target/lib/*.jar`
