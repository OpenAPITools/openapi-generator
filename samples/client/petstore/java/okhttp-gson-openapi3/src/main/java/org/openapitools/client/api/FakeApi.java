...
public class FakeApi {
    ...
    /**
     * Build call for fakeHttpSignatureTest
     ...
     */
    public okhttp3.Call fakeHttpSignatureTestCall(Pet pet, String query1, String header1, final ApiCallback _callback) throws ApiException {
        ...
        if (query1 != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("query_1", query1));
        }

        if (header1 != null) {
            localVarHeaderParams.put("header_1", localVarApiClient.parameterToString(header1));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call fakeHttpSignatureTestValidateBeforeCall(Pet pet, String query1, String header1, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'pet' is set
        if (pet == null) {
            throw new ApiException("Missing the required parameter 'pet' when calling fakeHttpSignatureTest(Async)");
        }
        

        okhttp3.Call localVarCall = fakeHttpSignatureTestCall(pet, query1, header1, _callback);
        return localVarCall;
    ...
    public ApiResponse<Void> fakeHttpSignatureTestWithHttpInfo(Pet pet, String query1, String header1) throws ApiException {
        okhttp3.Call localVarCall = fakeHttpSignatureTestValidateBeforeCall(pet, query1, header1, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * test http signature authentication (asynchronously)
     * 
     * @param pet Pet object that needs to be added to the store (required)
     * @param query1 query parameter (optional)
     * @param header1 header parameter (optional)
     ...
     */
    public okhttp3.Call fakeHttpSignatureTestAsync(Pet pet, String query1, String header1, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = fakeHttpSignatureTestValidateBeforeCall(pet, query1, header1, _callback);
    ...
    /**
     * Build call for fakePropertyEnumIntegerSerialize
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Output enum (int) </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call fakePropertyEnumIntegerSerializeCall(OuterObjectWithEnumProperty outerObjectWithEnumProperty, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call fakePropertyEnumIntegerSerializeValidateBeforeCall(OuterObjectWithEnumProperty outerObjectWithEnumProperty, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'outerObjectWithEnumProperty' is set
        if (outerObjectWithEnumProperty == null) {
            throw new ApiException("Missing the required parameter 'outerObjectWithEnumProperty' when calling fakePropertyEnumIntegerSerialize(Async)");
        }
        

        okhttp3.Call localVarCall = fakePropertyEnumIntegerSerializeCall(outerObjectWithEnumProperty, _callback);
        return localVarCall;
    ...
    public OuterObjectWithEnumProperty fakePropertyEnumIntegerSerialize(OuterObjectWithEnumProperty outerObjectWithEnumProperty) throws ApiException {
        ApiResponse<OuterObjectWithEnumProperty> localVarResp = fakePropertyEnumIntegerSerializeWithHttpInfo(outerObjectWithEnumProperty);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<OuterObjectWithEnumProperty> fakePropertyEnumIntegerSerializeWithHttpInfo(OuterObjectWithEnumProperty outerObjectWithEnumProperty) throws ApiException {
        okhttp3.Call localVarCall = fakePropertyEnumIntegerSerializeValidateBeforeCall(outerObjectWithEnumProperty, null);
        Type localVarReturnType = new TypeToken<OuterObjectWithEnumProperty>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call fakePropertyEnumIntegerSerializeAsync(OuterObjectWithEnumProperty outerObjectWithEnumProperty, final ApiCallback<OuterObjectWithEnumProperty> _callback) throws ApiException {

        okhttp3.Call localVarCall = fakePropertyEnumIntegerSerializeValidateBeforeCall(outerObjectWithEnumProperty, _callback);
        Type localVarReturnType = new TypeToken<OuterObjectWithEnumProperty>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
