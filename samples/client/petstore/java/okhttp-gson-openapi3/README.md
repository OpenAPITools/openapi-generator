...
<dependency>
  ...
  <artifactId>petstore-okhttp-gson-openapi3</artifactId>
...
```groovy
compile "org.openapitools:petstore-okhttp-gson-openapi3:1.0.0"
```
...
* `target/petstore-okhttp-gson-openapi3-1.0.0.jar`
* `target/lib/*.jar`
