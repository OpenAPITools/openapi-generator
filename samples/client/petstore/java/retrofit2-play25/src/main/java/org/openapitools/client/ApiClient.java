...
import org.openapitools.client.Play25CallAdapterFactory;
import org.openapitools.client.Play25CallFactory;
...
public class ApiClient {
  ...
  public <S> S createService(Class<S> serviceClass) {
    ...
    return new Retrofit.Builder()
        ...
        .callFactory(new Play25CallFactory(wsClient, extraHeaders, extraCookies,
                                           extraQueryParams))
