...
public class ArrayOfNumberOnly {
  ...
  // items.name=arrayNumber items.baseName=arrayNumber items.xmlName=
  // items.xmlNamespace= items.example= items.type=BigDecimal
  @XmlElement(name = "arrayNumber") private List<BigDecimal> arrayNumber = null;
