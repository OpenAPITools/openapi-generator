...
public class Capitalization {
  ...
  @XmlElement(name = "smallCamel") private String smallCamel;

  public static final String JSON_PROPERTY_CAPITAL_CAMEL = "CapitalCamel";
  @XmlElement(name = "CapitalCamel") private String capitalCamel;

  public static final String JSON_PROPERTY_SMALL_SNAKE = "small_Snake";
  @XmlElement(name = "small_Snake") private String smallSnake;

  public static final String JSON_PROPERTY_CAPITAL_SNAKE = "Capital_Snake";
  @XmlElement(name = "Capital_Snake") private String capitalSnake;

  public static final String JSON_PROPERTY_SC_A_E_T_H_FLOW_POINTS =
      "SCA_ETH_Flow_Points";
  @XmlElement(name = "SCA_ETH_Flow_Points") private String scAETHFlowPoints;

  public static final String JSON_PROPERTY_A_T_T_N_A_M_E = "ATT_NAME";
  @XmlElement(name = "ATT_NAME") private String ATT_NAME;
