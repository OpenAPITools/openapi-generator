...
public class PetApi {
   ...
   *     the API
   */
  public ResponseEntity<Void> addPetWithHttpInfo(Pet body)
    ...
    String path =
        apiClient.expandPath("/pet", Collections.<String, Object>emptyMap());
   ...
   *     the API
   */
  public ResponseEntity<Void> deletePetWithHttpInfo(Long petId, String apiKey)
      throws RestClientException {
   ...
   *     the API
   */
  public ResponseEntity<List<Pet>>
  findPetsByStatusWithHttpInfo(List<String> status) throws RestClientException {
    Object postBody = null;
    ...
    String path = apiClient.expandPath("/pet/findByStatus",
    ...
    ParameterizedTypeReference<List<Pet>> returnType =
   ...
   */
  @Deprecated
  public ResponseEntity<List<Pet>> findPetsByTagsWithHttpInfo(List<String> tags)
      throws RestClientException {
    Object postBody = null;
    ...
    String path = apiClient.expandPath("/pet/findByTags",
                                       Collections.<String, Object>emptyMap());
   ...
   *     the API
   */
  public ResponseEntity<Pet> getPetByIdWithHttpInfo(Long petId)
      throws RestClientException {
    Object postBody = null;
    ...
    ParameterizedTypeReference<Pet> returnType =
   ...
   *     the API
   */
  public ResponseEntity<Void> updatePetWithHttpInfo(Pet body)
      throws RestClientException {
    Object postBody = body;
    ...
    ParameterizedTypeReference<Void> returnType =
        new ParameterizedTypeReference<Void>() {};
    return apiClient.invokeAPI(path, HttpMethod.PUT, queryParams, postBody,
                               headerParams, cookieParams, formParams, accept,
                               contentType, authNames, returnType);
  }
  /**
  ...
  public ModelApiResponse uploadFile(Long petId, String additionalMetadata,
                                     File file) throws RestClientException {
   ...
   *     the API
   */
  public ResponseEntity<ModelApiResponse>
  uploadFileWithHttpInfo(Long petId, String additionalMetadata, File file)
    ...
    uriVariables.put("petId", petId);
    String path =
        apiClient.expandPath("/pet/{petId}/uploadImage", uriVariables);
    ...
    ParameterizedTypeReference<ModelApiResponse> returnType =
  ...
  public ModelApiResponse uploadFileWithRequiredFile(Long petId,
      ...
      throws RestClientException {
    return uploadFileWithRequiredFileWithHttpInfo(petId, requiredFile,
                                                  additionalMetadata)
        .getBody();
  }
  ...
  uploadFileWithRequiredFileWithHttpInfo(Long petId, File requiredFile,
    ...
    String path = apiClient.expandPath(
        "/fake/{petId}/uploadImageWithRequiredFile", uriVariables);
