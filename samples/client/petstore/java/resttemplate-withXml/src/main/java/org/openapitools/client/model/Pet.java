...
public class Pet {
  ...
  @XmlElement(name = "category") private Category category;
  ...
  // items.name=photoUrls items.baseName=photoUrls items.xmlName=
  // items.xmlNamespace= items.example= items.type=String
  ...
  @XmlElement(name = "status") private StatusEnum status;
