...
public class ApiClient {
  ...
  public <T> ResponseEntity<T> invokeAPI(
      String path, HttpMethod method, MultiValueMap<String, String> queryParams,
      Object body, HttpHeaders headerParams,
    ...
    try {
      ...
      throw new RestClientException(
          "Could not build URL: " + builder.toUriString(), ex);
    }
   ...
   * href="https://tools.ietf.org/html/rfc6265#section-5.3"> RFC6265
   * section 5.3</a>).
   *
  ...
  private String buildCookieHeader(MultiValueMap<String, String> cookies) {
    ...
    for (final Map.Entry<String, List<String>> entry : cookies.entrySet()) {
      ...
      cookieValue.append(
          String.format("%s%s=%s", delimiter, entry.getKey(), value));
      delimiter = "; ";
    }
  ...
  protected void updateParamsForAuth(
      String[] authNames, MultiValueMap<String, String> queryParams,
