...
public class FormatTest {
  ...
  @XmlElement(name = "integer") private Integer integer;

  public static final String JSON_PROPERTY_INT32 = "int32";
  @XmlElement(name = "int32") private Integer int32;

  public static final String JSON_PROPERTY_INT64 = "int64";
  @XmlElement(name = "int64") private Long int64;

  public static final String JSON_PROPERTY_NUMBER = "number";
  @XmlElement(name = "number") private BigDecimal number;

  public static final String JSON_PROPERTY_FLOAT = "float";
  @XmlElement(name = "float") private Float _float;

  public static final String JSON_PROPERTY_DOUBLE = "double";
  @XmlElement(name = "double") private Double _double;

  public static final String JSON_PROPERTY_STRING = "string";
  @XmlElement(name = "string") private String string;

  public static final String JSON_PROPERTY_BYTE = "byte";
  @XmlElement(name = "byte") private byte[] _byte;

  public static final String JSON_PROPERTY_BINARY = "binary";
  @XmlElement(name = "binary") private File binary;

  public static final String JSON_PROPERTY_DATE = "date";
  @XmlElement(name = "date") private LocalDate date;
  ...
  @XmlElement(name = "BigDecimal") private BigDecimal bigDecimal;
