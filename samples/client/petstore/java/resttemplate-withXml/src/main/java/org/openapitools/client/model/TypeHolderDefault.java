...
public class TypeHolderDefault {
  ...
  @XmlElement(name = "string_item") private String stringItem = "what";

  public static final String JSON_PROPERTY_NUMBER_ITEM = "number_item";
  @XmlElement(name = "number_item") private BigDecimal numberItem;

  public static final String JSON_PROPERTY_INTEGER_ITEM = "integer_item";
  @XmlElement(name = "integer_item") private Integer integerItem;

  public static final String JSON_PROPERTY_BOOL_ITEM = "bool_item";
  @XmlElement(name = "bool_item") private Boolean boolItem = true;

  public static final String JSON_PROPERTY_ARRAY_ITEM = "array_item";
  // Is a container wrapped=false
  // items.name=arrayItem items.baseName=arrayItem items.xmlName=
