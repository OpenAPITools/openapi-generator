...
public class UserApi {
   ...
   *     the API
   */
  public ResponseEntity<Void> createUserWithHttpInfo(User body)
    ...
    String path =
        apiClient.expandPath("/user", Collections.<String, Object>emptyMap());
  ...
  createUsersWithArrayInputWithHttpInfo(List<User> body)
      throws RestClientException {
    Object postBody = body;
    ...
    String path = apiClient.expandPath("/user/createWithArray",
   ...
   */
  public ResponseEntity<Void>
  createUsersWithListInputWithHttpInfo(List<User> body)
      throws RestClientException {
    Object postBody = body;
    ...
    String path = apiClient.expandPath("/user/createWithList",
                                       Collections.<String, Object>emptyMap());
   ...
   *     the API
   */
  public ResponseEntity<Void> deleteUserWithHttpInfo(String username)
      throws RestClientException {
   ...
   *     the API
   */
  public ResponseEntity<User> getUserByNameWithHttpInfo(String username)
      throws RestClientException {
    Object postBody = null;
    ...
    ParameterizedTypeReference<User> returnType =
   ...
   *     the API
   */
  public ResponseEntity<String> loginUserWithHttpInfo(String username,
                                                      String password)
      throws RestClientException {
    Object postBody = null;
    ...
    String path = apiClient.expandPath("/user/login",
                                       Collections.<String, Object>emptyMap());
   ...
   *     the API
   */
  public ResponseEntity<Void> logoutUserWithHttpInfo()
      throws RestClientException {
    Object postBody = null;

    String path = apiClient.expandPath("/user/logout",
                                       Collections.<String, Object>emptyMap());
   ...
   *     the API
   */
  public ResponseEntity<Void> updateUserWithHttpInfo(String username, User body)
      throws RestClientException {
    Object postBody = body;
