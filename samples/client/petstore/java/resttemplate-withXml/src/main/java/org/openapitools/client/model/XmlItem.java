 ...
 * XmlItem
 */
@JsonPropertyOrder({XmlItem.JSON_PROPERTY_ATTRIBUTE_STRING,
...
public class XmlItem {
  public static final String JSON_PROPERTY_ATTRIBUTE_STRING =
      "attribute_string";
  @XmlAttribute(name = "attribute_string") private String attributeString;

  public static final String JSON_PROPERTY_ATTRIBUTE_NUMBER =
      "attribute_number";
  @XmlAttribute(name = "attribute_number") private BigDecimal attributeNumber;

  public static final String JSON_PROPERTY_ATTRIBUTE_INTEGER =
      "attribute_integer";
  @XmlAttribute(name = "attribute_integer") private Integer attributeInteger;

  public static final String JSON_PROPERTY_ATTRIBUTE_BOOLEAN =
      "attribute_boolean";
  @XmlAttribute(name = "attribute_boolean") private Boolean attributeBoolean;

  public static final String JSON_PROPERTY_WRAPPED_ARRAY = "wrapped_array";
  // Is a container wrapped=true
  // items.name=wrappedArray items.baseName=wrappedArray items.xmlName=
  // items.xmlNamespace= items.example= items.type=Integer
  ...
  @XmlElement(name = "xml_name_string") private String nameString;

  public static final String JSON_PROPERTY_NAME_NUMBER = "name_number";
  @XmlElement(name = "xml_name_number") private BigDecimal nameNumber;

  public static final String JSON_PROPERTY_NAME_INTEGER = "name_integer";
  @XmlElement(name = "xml_name_integer") private Integer nameInteger;

  public static final String JSON_PROPERTY_NAME_BOOLEAN = "name_boolean";
  @XmlElement(name = "xml_name_boolean") private Boolean nameBoolean;

  public static final String JSON_PROPERTY_NAME_ARRAY = "name_array";
  // Is a container wrapped=false
  // items.name=nameArray items.baseName=nameArray
  // items.xmlName=xml_name_array_item items.xmlNamespace= items.example=
  // items.type=Integer
  @XmlElement(name = "xml_name_array_item")
  private List<Integer> nameArray = null;

  public static final String JSON_PROPERTY_NAME_WRAPPED_ARRAY =
      "name_wrapped_array";
  // Is a container wrapped=true
  // items.name=nameWrappedArray items.baseName=nameWrappedArray
  // items.xmlName=xml_name_wrapped_array_item items.xmlNamespace=
  ...
  @XmlElement(name = "prefix_string") private String prefixString;

  public static final String JSON_PROPERTY_PREFIX_NUMBER = "prefix_number";
  @XmlElement(name = "prefix_number") private BigDecimal prefixNumber;

  public static final String JSON_PROPERTY_PREFIX_INTEGER = "prefix_integer";
  @XmlElement(name = "prefix_integer") private Integer prefixInteger;
  ...
  // Is a container wrapped=false
  // items.name=prefixArray items.baseName=prefixArray items.xmlName=
  // items.xmlNamespace= items.example= items.type=Integer
  @XmlElement(name = "prefixArray") private List<Integer> prefixArray = null;

  public static final String JSON_PROPERTY_PREFIX_WRAPPED_ARRAY =
      "prefix_wrapped_array";
  // Is a container wrapped=true
  // items.name=prefixWrappedArray items.baseName=prefixWrappedArray
  // items.xmlName= items.xmlNamespace= items.example= items.type=Integer
  ...
  public static final String JSON_PROPERTY_NAMESPACE_STRING =
      "namespace_string";
  @XmlElement(namespace = "http://a.com/schema", name = "namespace_string")
  private String namespaceString;

  public static final String JSON_PROPERTY_NAMESPACE_NUMBER =
      "namespace_number";
  @XmlElement(namespace = "http://b.com/schema", name = "namespace_number")
  private BigDecimal namespaceNumber;

  public static final String JSON_PROPERTY_NAMESPACE_INTEGER =
      "namespace_integer";
  @XmlElement(namespace = "http://c.com/schema", name = "namespace_integer")
  private Integer namespaceInteger;

  public static final String JSON_PROPERTY_NAMESPACE_BOOLEAN =
      "namespace_boolean";
  ...
  // Is a container wrapped=false
  // items.name=namespaceArray items.baseName=namespaceArray items.xmlName=
  // items.xmlNamespace=http://e.com/schema items.example= items.type=Integer
  @XmlElement(namespace = "http://e.com/schema", name = "namespaceArray")
  private List<Integer> namespaceArray = null;

  public static final String JSON_PROPERTY_NAMESPACE_WRAPPED_ARRAY =
      "namespace_wrapped_array";
  // Is a container wrapped=true
  // items.name=namespaceWrappedArray items.baseName=namespaceWrappedArray
  // items.xmlName= items.xmlNamespace=http://g.com/schema items.example=
  // items.type=Integer
  @XmlElement(namespace = "http://g.com/schema", name = "namespaceWrappedArray")
  @XmlElementWrapper(namespace = "http://f.com/schema",
                     name = "namespace_wrapped_array")
  private List<Integer> namespaceWrappedArray = null;

  public static final String JSON_PROPERTY_PREFIX_NS_STRING =
      "prefix_ns_string";
  @XmlElement(namespace = "http://a.com/schema", name = "prefix_ns_string")
  private String prefixNsString;

  public static final String JSON_PROPERTY_PREFIX_NS_NUMBER =
      "prefix_ns_number";
  @XmlElement(namespace = "http://b.com/schema", name = "prefix_ns_number")
  private BigDecimal prefixNsNumber;

  public static final String JSON_PROPERTY_PREFIX_NS_INTEGER =
      "prefix_ns_integer";
  @XmlElement(namespace = "http://c.com/schema", name = "prefix_ns_integer")
  private Integer prefixNsInteger;

  public static final String JSON_PROPERTY_PREFIX_NS_BOOLEAN =
      "prefix_ns_boolean";
  ...
  // Is a container wrapped=false
  // items.name=prefixNsArray items.baseName=prefixNsArray items.xmlName=
  // items.xmlNamespace=http://e.com/schema items.example= items.type=Integer
  @XmlElement(namespace = "http://e.com/schema", name = "prefixNsArray")
  private List<Integer> prefixNsArray = null;

  public static final String JSON_PROPERTY_PREFIX_NS_WRAPPED_ARRAY =
      "prefix_ns_wrapped_array";
  // Is a container wrapped=true
  // items.name=prefixNsWrappedArray items.baseName=prefixNsWrappedArray
  // items.xmlName= items.xmlNamespace=http://g.com/schema items.example=
  // items.type=Integer
  @XmlElement(namespace = "http://g.com/schema", name = "prefixNsWrappedArray")
  @XmlElementWrapper(namespace = "http://f.com/schema",
                     name = "prefix_ns_wrapped_array")
  ...
  @JacksonXmlElementWrapper(useWrapping = true,
                            localName = "xml_name_wrapped_array_item")
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  @JacksonXmlProperty(namespace = "http://a.com/schema",
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  @JacksonXmlProperty(namespace = "http://b.com/schema",
                      localName = "namespace_number")
  ...
  public XmlItem
  addNamespaceWrappedArrayItem(Integer namespaceWrappedArrayItem) {
  ...
  @JacksonXmlElementWrapper(useWrapping = true,
                            ...
                            localName = "namespaceWrappedArray")
  ...
  @JacksonXmlElementWrapper(useWrapping = true,
                            namespace = "http://f.com/schema",
                            localName = "prefixNsWrappedArray")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.attributeString, xmlItem.attributeString) &&
        ...
        Objects.equals(this.namespaceWrappedArray,
                       xmlItem.namespaceWrappedArray) &&
  ...
  public int hashCode() {
    return Objects.hash(
        attributeString, attributeNumber, attributeInteger, attributeBoolean,
        wrappedArray, nameString, nameNumber, nameInteger, nameBoolean,
        nameArray, nameWrappedArray, prefixString, prefixNumber, prefixInteger,
        prefixBoolean, prefixArray, prefixWrappedArray, namespaceString,
        namespaceNumber, namespaceInteger, namespaceBoolean, namespaceArray,
        namespaceWrappedArray, prefixNsString, prefixNsNumber, prefixNsInteger,
        prefixNsBoolean, prefixNsArray, prefixNsWrappedArray);
  }
  ...
  public String toString() {
    ...
    sb.append("    attributeString: ")
        .append(toIndentedString(attributeString))
        .append("\n");
    sb.append("    attributeNumber: ")
        .append(toIndentedString(attributeNumber))
        .append("\n");
    sb.append("    attributeInteger: ")
        .append(toIndentedString(attributeInteger))
        .append("\n");
    sb.append("    attributeBoolean: ")
        .append(toIndentedString(attributeBoolean))
        .append("\n");
    sb.append("    wrappedArray: ")
        .append(toIndentedString(wrappedArray))
        .append("\n");
    sb.append("    nameString: ")
        .append(toIndentedString(nameString))
        .append("\n");
    sb.append("    nameNumber: ")
        .append(toIndentedString(nameNumber))
        .append("\n");
    sb.append("    nameInteger: ")
        .append(toIndentedString(nameInteger))
        .append("\n");
    sb.append("    nameBoolean: ")
        .append(toIndentedString(nameBoolean))
        .append("\n");
    sb.append("    nameArray: ")
        .append(toIndentedString(nameArray))
        .append("\n");
    sb.append("    nameWrappedArray: ")
        .append(toIndentedString(nameWrappedArray))
        .append("\n");
    sb.append("    prefixString: ")
        .append(toIndentedString(prefixString))
        .append("\n");
    sb.append("    prefixNumber: ")
        .append(toIndentedString(prefixNumber))
        .append("\n");
    sb.append("    prefixInteger: ")
        .append(toIndentedString(prefixInteger))
        .append("\n");
    sb.append("    prefixBoolean: ")
        .append(toIndentedString(prefixBoolean))
        .append("\n");
    sb.append("    prefixArray: ")
        .append(toIndentedString(prefixArray))
        .append("\n");
    sb.append("    prefixWrappedArray: ")
        .append(toIndentedString(prefixWrappedArray))
        .append("\n");
    sb.append("    namespaceString: ")
        .append(toIndentedString(namespaceString))
        .append("\n");
    sb.append("    namespaceNumber: ")
        .append(toIndentedString(namespaceNumber))
        .append("\n");
    sb.append("    namespaceInteger: ")
        .append(toIndentedString(namespaceInteger))
        .append("\n");
    sb.append("    namespaceBoolean: ")
        .append(toIndentedString(namespaceBoolean))
        .append("\n");
    sb.append("    namespaceArray: ")
        .append(toIndentedString(namespaceArray))
        .append("\n");
    sb.append("    namespaceWrappedArray: ")
        .append(toIndentedString(namespaceWrappedArray))
        .append("\n");
    sb.append("    prefixNsString: ")
        .append(toIndentedString(prefixNsString))
        .append("\n");
    sb.append("    prefixNsNumber: ")
        .append(toIndentedString(prefixNsNumber))
        .append("\n");
    sb.append("    prefixNsInteger: ")
        .append(toIndentedString(prefixNsInteger))
        .append("\n");
    sb.append("    prefixNsBoolean: ")
        .append(toIndentedString(prefixNsBoolean))
        .append("\n");
    sb.append("    prefixNsArray: ")
        .append(toIndentedString(prefixNsArray))
        .append("\n");
    sb.append("    prefixNsWrappedArray: ")
        .append(toIndentedString(prefixNsWrappedArray))
        .append("\n");
    sb.append("}");
    return sb.toString();
  }
