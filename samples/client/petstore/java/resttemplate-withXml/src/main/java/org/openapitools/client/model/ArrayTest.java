...
public class ArrayTest {
  ...
  // items.name=arrayOfString items.baseName=arrayOfString items.xmlName=
  // items.xmlNamespace= items.example= items.type=String
  @XmlElement(name = "arrayOfString") private List<String> arrayOfString = null;

  public static final String JSON_PROPERTY_ARRAY_ARRAY_OF_INTEGER =
      "array_array_of_integer";
  // Is a container wrapped=false
  // items.name=arrayArrayOfInteger items.baseName=arrayArrayOfInteger
  // items.xmlName= items.xmlNamespace= items.example=
  // items.type=List&lt;Long&gt;
  ...
  // Is a container wrapped=false
  // items.name=arrayArrayOfModel items.baseName=arrayArrayOfModel
  // items.xmlName= items.xmlNamespace= items.example=
  // items.type=List&lt;ReadOnlyFirst&gt;
