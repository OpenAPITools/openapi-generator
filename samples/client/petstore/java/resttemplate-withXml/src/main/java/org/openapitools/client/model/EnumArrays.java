...
public class EnumArrays {
  ...
  @XmlElement(name = "just_symbol") private JustSymbolEnum justSymbol;
  ...
  // items.name=arrayEnum items.baseName=arrayEnum items.xmlName=
  // items.xmlNamespace= items.example= items.type=String
  @XmlElement(name = "arrayEnum") private List<ArrayEnumEnum> arrayEnum = null;
