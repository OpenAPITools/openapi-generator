...
public class Pig extends AbstractOpenApiSchema {
    ...
    public static class PigSerializer extends StdSerializer<Pig> {
        ...
        @Override
        public void serialize(Pig value, JsonGenerator jgen, SerializerProvider provider) throws JacksonException {
    ...
    public static class PigDeserializer extends StdDeserializer<Pig> {
        ...
        public Pig deserialize(JsonParser jp, DeserializationContext ctxt) throws JacksonException {
            ...
            throw new JsonMappingException(jp, String.format(java.util.Locale.ROOT, "Failed deserialization for Pig: %d classes match result, expected 1", match));
        }
