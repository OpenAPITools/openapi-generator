...
public class Shape extends AbstractOpenApiSchema {
    ...
    public static class ShapeSerializer extends StdSerializer<Shape> {
        ...
        @Override
        public void serialize(Shape value, JsonGenerator jgen, SerializationContext serializationContext) throws JacksonException {
    ...
    public static class ShapeDeserializer extends StdDeserializer<Shape> {
        ...
        public Shape deserialize(JsonParser jp, DeserializationContext ctxt) throws JacksonException {
            ...
            throw DatabindException.from(jp, String.format(java.util.Locale.ROOT, "Failed deserialization for Shape: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public Shape getNullValue(DeserializationContext ctxt) {
            throw DatabindException.from(ctxt.getParser(), "Shape cannot be null");
        }
    }
