...
public class Triangle extends AbstractOpenApiSchema {
    ...
    public static class TriangleSerializer extends StdSerializer<Triangle> {
        ...
        @Override
        public void serialize(Triangle value, JsonGenerator jgen, SerializerProvider provider) throws JacksonException {
    ...
    public static class TriangleDeserializer extends StdDeserializer<Triangle> {
        ...
        public Triangle deserialize(JsonParser jp, DeserializationContext ctxt) throws JacksonException {
            ...
            throw new JsonMappingException(jp, String.format(java.util.Locale.ROOT, "Failed deserialization for Triangle: %d classes match result, expected 1", match));
        }
