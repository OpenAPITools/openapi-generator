...
public class NullableShape extends AbstractOpenApiSchema {
    ...
    public static class NullableShapeSerializer extends StdSerializer<NullableShape> {
        ...
        @Override
        public void serialize(NullableShape value, JsonGenerator jgen, SerializerProvider provider) throws JacksonException {
    ...
    public static class NullableShapeDeserializer extends StdDeserializer<NullableShape> {
        ...
        public NullableShape deserialize(JsonParser jp, DeserializationContext ctxt) throws JacksonException {
            ...
            throw new JsonMappingException(jp, String.format(java.util.Locale.ROOT, "Failed deserialization for NullableShape: %d classes match result, expected 1", match));
        }
