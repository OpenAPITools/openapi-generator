...
public class Quadrilateral extends AbstractOpenApiSchema {
    ...
    public static class QuadrilateralDeserializer extends StdDeserializer<Quadrilateral> {
        ...
        public Quadrilateral deserialize(JsonParser jp, DeserializationContext ctxt) throws JacksonException {
            ...
            throw new JsonMappingException(jp, String.format(java.util.Locale.ROOT, "Failed deserialization for Quadrilateral: %d classes match result, expected 1", match));
        }
