...
public class ArrayOneOf extends AbstractOpenApiSchema {
  ...
  public Object getAdditionalProperty(String key) {
     ...
     */
    private static void collectUnconsumedProperties(ArrayOneOf instance, JsonElement jsonElement, Gson gson) {
     ...
     */
    private static void writeUnconsumedProperties(ArrayOneOf value, JsonObject obj, Gson gson) {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (matches != 1) {
            throw new IOException(String.format("Failed deserialization for ArrayOneOf: %d classes match result, expected 1. %s", matches, errorMessages));
        }
    }
