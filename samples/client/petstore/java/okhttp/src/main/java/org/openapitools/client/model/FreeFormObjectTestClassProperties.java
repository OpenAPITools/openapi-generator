...
public class FreeFormObjectTestClassProperties extends AbstractOpenApiSchema {
  ...
  public Object getAdditionalProperty(String key) {
     ...
     */
    private static void collectUnconsumedProperties(FreeFormObjectTestClassProperties instance, JsonElement jsonElement, Gson gson) {
     ...
     */
    private static void writeUnconsumedProperties(FreeFormObjectTestClassProperties value, JsonObject obj, Gson gson) {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (matches != 1) {
            throw new IOException(String.format("Failed deserialization for FreeFormObjectTestClassProperties: %d classes match result, expected 1. %s", matches, errorMessages));
        }
    }
            ...
            return (TypeAdapter<T>) new TypeAdapter<FreeFormObjectTestClassProperties>() {
                ...
                public void write(JsonWriter out, FreeFormObjectTestClassProperties value) throws IOException {
                    ...
                    if (value.getActualInstance() instanceof Map<?, ?>) {
                        element = adapterMapStringObject.toJsonTree((Map<String, Object>)value.getActualInstance());
                    }
