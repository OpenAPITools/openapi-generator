...
public class NullableShape extends AbstractOpenApiSchema {
  ...
  public Object getAdditionalProperty(String key) {
     ...
     */
    private static void collectUnconsumedProperties(NullableShape instance, JsonElement jsonElement, Gson gson) {
     ...
     */
    private static void writeUnconsumedProperties(NullableShape value, JsonObject obj, Gson gson) {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (matches != 1) {
            throw new IOException(String.format("Failed deserialization for NullableShape: %d classes match result, expected 1. %s", matches, errorMessages));
        }
    }
            ...
            return (TypeAdapter<T>) new TypeAdapter<NullableShape>() {
                ...
                public void write(JsonWriter out, NullableShape value) throws IOException {
                    ...
                    if (value.getActualInstance() instanceof Triangle) {
                        element = adapterTriangle.toJsonTree((Triangle)value.getActualInstance());
                    }
                    // check if the actual instance is of the type `Quadrilateral`
                    if (value.getActualInstance() instanceof Quadrilateral) {
                        element = adapterQuadrilateral.toJsonTree((Quadrilateral)value.getActualInstance());
                    }
                ...
                public NullableShape read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for NullableShape: %d classes match result, expected 1. %s", match, errorMessages));
                }
            };
        }
    }
