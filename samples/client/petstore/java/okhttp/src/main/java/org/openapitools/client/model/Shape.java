...
public class Shape extends AbstractOpenApiSchema {
   ...
   * @return the Shape instance itself
   */
  ...
  public Object getAdditionalProperty(String key) {
     ...
     */
    private static void collectUnconsumedProperties(Shape instance, JsonElement jsonElement, Gson gson) {
     ...
     */
    private static void writeUnconsumedProperties(Shape value, JsonObject obj, Gson gson) {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (matches != 1) {
            throw new IOException(String.format("Failed deserialization for Shape: %d classes match result, expected 1. %s", matches, errorMessages));
        }
    }
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<Shape>() {
                ...
                public Shape read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for Shape: %d classes match result, expected 1. %s", match, errorMessages));
                }
            };
        }
    }
