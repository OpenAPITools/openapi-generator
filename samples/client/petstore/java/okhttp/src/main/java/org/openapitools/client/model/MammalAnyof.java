...
public class MammalAnyof extends AbstractOpenApiSchema {
  ...
  public Object getAdditionalProperty(String key) {
     ...
     */
    private static void collectUnconsumedProperties(MammalAnyof instance, JsonElement jsonElement, Gson gson) {
     ...
     */
    private static void writeUnconsumedProperties(MammalAnyof value, JsonObject obj, Gson gson) {
                        ...
                        if (discriminatorElement == null || !discriminatorElement.isJsonPrimitive()) {
                            ...
                            switch (discriminatorElement.getAsString()) {
                                case "Pig":
                                    ...
                                    collectUnconsumedProperties(newMammalAnyof, jsonElement, gson);
