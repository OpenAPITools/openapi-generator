...
public class FakeRefParameterPetIdParameter extends AbstractOpenApiSchema {
  ...
  public Object getAdditionalProperty(String key) {
     ...
     */
    private static void collectUnconsumedProperties(FakeRefParameterPetIdParameter instance, JsonElement jsonElement, Gson gson) {
     ...
     */
    private static void writeUnconsumedProperties(FakeRefParameterPetIdParameter value, JsonObject obj, Gson gson) {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (matches != 1) {
            throw new IOException(String.format("Failed deserialization for FakeRefParameterPetIdParameter: %d classes match result, expected 1. %s", matches, errorMessages));
        }
    }
