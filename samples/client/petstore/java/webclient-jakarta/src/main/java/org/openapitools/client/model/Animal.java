...
public class Animal {
  ...
  @jakarta.annotation.Nonnull  protected String className;

  public static final String JSON_PROPERTY_COLOR = "color";
  @jakarta.annotation.Nullable  protected String color = "red";
   ...
   * @return className
   */
  @jakarta.annotation.Nonnull  @JsonProperty(JSON_PROPERTY_CLASS_NAME)
