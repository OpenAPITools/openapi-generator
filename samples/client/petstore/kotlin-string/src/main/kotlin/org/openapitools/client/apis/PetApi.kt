...
class PetApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
     ...
     */
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun deletePet(apiKey: String? = null, petId: Long) : Unit {
     ...
     */
    @Throws(IllegalStateException::class, IOException::class)
    fun deletePetWithHttpInfo(apiKey: String?, petId: Long) : ApiResponse<Unit?> {
     ...
     * @return RequestConfig
     */
    fun deletePetRequestConfig(apiKey: String?, petId: Long) : RequestConfig<Unit> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun findPetsByStatusWithHttpInfo(status: kotlin.collections.List<StatusFindPetsByStatus>) : ApiResponse<List<Pet>?> {
    ...
    @Throws(IllegalStateException::class, IOException::class)
    @Deprecated(message = "This operation is deprecated.")
    fun findPetsByTagsWithHttpInfo(tags: List<String>) : ApiResponse<List<Pet>?> {
        @Suppress("DEPRECATION")
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getPetByIdWithHttpInfo(petId: Long) : ApiResponse<Pet?> {
     ...
     */
    @Throws(IllegalStateException::class, IOException::class)
    fun updatePetWithFormWithHttpInfo(petId: Long, name: String?, status: String?) : ApiResponse<Unit?> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun uploadFile(petId: Long, additionalMetadata: String? = null, file: ByteArray? = null) : ModelApiResponse {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun uploadFileWithHttpInfo(petId: Long, additionalMetadata: String?, file: ByteArray?) : ApiResponse<ModelApiResponse?> {
     ...
     * @return RequestConfig
     */
    fun uploadFileRequestConfig(petId: Long, additionalMetadata: String?, file: ByteArray?) : RequestConfig<Map<String, PartConfig<*>>> {
        val localVariableBody = mapOf(
