...
class PetApi(object):
    ...
    def delete_pet_with_http_info(self, pet_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('pet_id' not in local_var_params or
    ...
    def find_pets_by_status_with_http_info(self, status, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('status' not in local_var_params or
    ...
    def find_pets_by_tags_with_http_info(self, tags, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('tags' not in local_var_params or
    ...
    def upload_file_with_required_file_with_http_info(self, pet_id, required_file, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('required_file' not in local_var_params or
