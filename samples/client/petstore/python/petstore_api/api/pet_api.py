...
class PetApi(object):
    ...
    def upload_file_with_required_file(self, pet_id, file, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upload_file_with_required_file(pet_id, file, async_req=True)
        >>> result = thread.get()
    ...
    def upload_file_with_required_file_with_http_info(self, pet_id, file, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upload_file_with_required_file_with_http_info(pet_id, file, async_req=True)
        >>> result = thread.get()
