...
class FakeClassnameTags123Api(object):
    ...
    def test_classname(self, body, _check_type=False, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.test_classname_with_http_info(body, _check_type=_check_type, **kwargs)  # noqa: E501
        else:
            (data) = self.test_classname_with_http_info(body, _check_type=_check_type, **kwargs)  # noqa: E501
            return data

    def test_classname_with_http_info(self, body, _check_type=False, **kwargs):  # noqa: E501
        """To test class name in snake case  # noqa: E501
