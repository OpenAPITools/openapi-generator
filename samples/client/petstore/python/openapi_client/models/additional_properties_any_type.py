...
from openapi_client.utils import model_to_dict, recursive_type, valid_type
...
class AdditionalPropertiesAnyType(object):
    ...
    additional_properties_type = 'set([str, float, int, bool, list, dict])'
