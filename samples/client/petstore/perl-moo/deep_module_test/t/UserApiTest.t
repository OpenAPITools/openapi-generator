...
#my $create_user_body = undef; # replace NULL with a proper value
#my $create_user_result = $api->create_user(body => $create_user_body);

#
# create_users_with_array_input test
#
# uncomment below and update the test
#my $create_users_with_array_input_body = undef; # replace NULL with a proper value
#my $create_users_with_array_input_result = $api->create_users_with_array_input(body => $create_users_with_array_input_body);

#
# create_users_with_list_input test
#
# uncomment below and update the test
#my $create_users_with_list_input_body = undef; # replace NULL with a proper value
#my $create_users_with_list_input_result = $api->create_users_with_list_input(body => $create_users_with_list_input_body);
...
#my $update_user_body = undef; # replace NULL with a proper value
#my $update_user_result = $api->update_user(username => $update_user_username, body => $update_user_body);
