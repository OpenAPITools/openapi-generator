...
#my $add_pet_body = undef; # replace NULL with a proper value
#my $add_pet_result = $api->add_pet(body => $add_pet_body);
...
#
# uncomment below and update the test
#my $update_pet_body = undef; # replace NULL with a proper value
#my $update_pet_result = $api->update_pet(body => $update_pet_body);
