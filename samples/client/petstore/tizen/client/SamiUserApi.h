...
<FNet.h>
    ...
    namespace Swagger {
        ...
        virtual ~SamiUserApi();
            ...
            String* 
            loginUserWithCompletion(String* username
            , String* password, void (* handler)(String*
            , SamiError*));
            ...
            SamiUser* 
            getUserByNameWithCompletion(String* username, void (* handler)(SamiUser*
            , SamiError*));
        
            void 
            updateUserWithCompletion(String* username
            , SamiUser* body, void(* handler)(SamiError*));
