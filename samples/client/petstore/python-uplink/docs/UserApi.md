...
try:
    # Creates list of users with given input array
    api_client.create_users_with_array_input(body)
except ApiException as e:
...
try:
    # Creates list of users with given input array
    api_client.create_users_with_list_input(body)
except ApiException as e:
...
try:
    # Get user by user name
    api_response = api_client.get_user_by_name(username)
    pprint(api_response)
except ApiException as e:
...
try:
    # Updated user
    api_client.update_user(username, body)
except ApiException as e:
