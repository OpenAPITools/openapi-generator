  ...
  class TestInlineFreeformAdditionalPropertiesRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Petstore::TestInlineFreeformAdditionalPropertiesRequest` initialize method"
      end
      ...
      if attributes.key?(:'some_property')
        self.some_property = attributes[:'some_property']
      end
    end
