...
function Invoke-PSFakeOuterCompositeSerialize {
    ...
    Process {
        ...
        $LocalVarBodyParameter = $OuterComposite | ConvertTo-Json
...
function Test-PSBodyWithFileSchema {
    ...
    Process {
        ...
        $LocalVarBodyParameter = $FileSchemaTestClass | ConvertTo-Json
...
function Test-PSJsonFormData {
    ...
    Process {
        ...
        if (!$VarParam) {
            throw "Error! The required parameter `VarParam` missing when calling testJsonFormData."
        }
        $LocalVarFormParameters['param'] = $VarParam
...
function Test-PSQueryParameterCollectionFormat {
    ...
    Process {
        ...
        $Configuration = Get-PSConfiguration
        $LocalVarUri = '/fake/test-query-paramters'
