...
GrandparentAnimal<PSCustomObject>
#>

function Initialize-PSGrandparentAnimal {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSPetstore => PSGrandparentAnimal' | Write-Debug
...
Convert from JSON to GrandparentAnimal<PSCustomObject>
...
function ConvertFrom-PSJsonToGrandparentAnimal {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSPetstore => PSGrandparentAnimal' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
