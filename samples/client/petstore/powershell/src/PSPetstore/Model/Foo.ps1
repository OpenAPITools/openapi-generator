...
function Initialize-PSFoo {
    ...
    Process {
        'Creating PSCustomObject: PSPetstore => PSFoo' | Write-Debug
...
Foo<PSCustomObject>
#>
function ConvertFrom-PSJsonToFoo {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSPetstore => PSFoo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
