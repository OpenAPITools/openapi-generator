...
TriangleInterface<PSCustomObject>
#>

function Initialize-PSTriangleInterface {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSPetstore => PSTriangleInterface' | Write-Debug
...
Convert from JSON to TriangleInterface<PSCustomObject>
...
function ConvertFrom-PSJsonToTriangleInterface {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSPetstore => PSTriangleInterface' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
