...
FunctionsToExport = 'Add-PSPet', 'Remove-Pet', 'Find-PSPetsByStatus', 'Find-PSPetsByTags', 
               ...
               'Create-PSApiResponseFromJson', 'Initialize-PSCategory', 
               'Create-PSCategoryFromJson', 'Initialize-PSInlineObject', 
               'Create-PSInlineObjectFromJson', 'Initialize-PSInlineObject1', 
               'Create-PSInlineObject1FromJson', 'Initialize-PSOrder', 
               'Create-PSOrderFromJson', 'Initialize-PSPet', 'Create-PSPetFromJson', 
               'Initialize-PSTag', 'Create-PSTagFromJson', 'Initialize-PSUser', 
               'Create-PSUserFromJson', 'Get-PSConfiguration', 'Set-PSConfiguration', 
