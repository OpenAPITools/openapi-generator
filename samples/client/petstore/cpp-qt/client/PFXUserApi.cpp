...
void PFXUserApi::createUser(const PFXUser &pfx_user) {
    ...
    connect(worker, &PFXHttpRequestWorker::downloadProgress, this, &PFXUserApi::createUserDownloadProgress);
...
void PFXUserApi::createUsersWithArrayInput(const QList<PFXUser> &pfx_user) {
    ...
    connect(worker, &PFXHttpRequestWorker::downloadProgress, this, &PFXUserApi::createUsersWithArrayInputDownloadProgress);
...
void PFXUserApi::createUsersWithListInput(const QList<PFXUser> &pfx_user) {
    ...
    connect(worker, &PFXHttpRequestWorker::downloadProgress, this, &PFXUserApi::createUsersWithListInputDownloadProgress);
...
void PFXUserApi::deleteUser(const QString &username) {
    ...
    connect(worker, &PFXHttpRequestWorker::downloadProgress, this, &PFXUserApi::deleteUserDownloadProgress);
...
void PFXUserApi::getUserByName(const QString &username) {
    ...
    connect(worker, &PFXHttpRequestWorker::downloadProgress, this, &PFXUserApi::getUserByNameDownloadProgress);
...
void PFXUserApi::loginUser(const QString &username, const QString &password) {
    ...
    connect(worker, &PFXHttpRequestWorker::downloadProgress, this, &PFXUserApi::loginUserDownloadProgress);
...
void PFXUserApi::logoutUser() {
    ...
    connect(worker, &PFXHttpRequestWorker::downloadProgress, this, &PFXUserApi::logoutUserDownloadProgress);
...
void PFXUserApi::updateUser(const QString &username, const PFXUser &pfx_user) {
    ...
    connect(worker, &PFXHttpRequestWorker::downloadProgress, this, &PFXUserApi::updateUserDownloadProgress);
