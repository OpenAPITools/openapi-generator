...
class DefaultApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    fun itemsItemIdSomethingItemSubIdGetWithHttpInfo(itemDollarId: kotlin.String, itemDollarSubId: kotlin.String, filterDollarType: kotlin.String?, filterDollarSubType: kotlin.String?, xCustomHeader: kotlin.String?, xCustomHeaderTwo: kotlin.String?) : ApiResponse<ItemsItemIdSomethingItemSubIdGet200Response?> {
     ...
     */
    fun itemsItemIdSomethingItemSubIdGetRequestConfig(itemDollarId: kotlin.String, itemDollarSubId: kotlin.String, filterDollarType: kotlin.String?, filterDollarSubType: kotlin.String?, xCustomHeader: kotlin.String?, xCustomHeaderTwo: kotlin.String?) : RequestConfig<Unit> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun itemsPostWithHttpInfo(xPostHeader: kotlin.String?, formDollarName: kotlin.String?, formDollarValue: kotlin.String?) : ApiResponse<ItemWithDollarAttributesAndExamples?> {
     ...
     * @return RequestConfig
     */
    fun itemsPostRequestConfig(xPostHeader: kotlin.String?, formDollarName: kotlin.String?, formDollarValue: kotlin.String?) : RequestConfig<Map<String, PartConfig<*>>> {
