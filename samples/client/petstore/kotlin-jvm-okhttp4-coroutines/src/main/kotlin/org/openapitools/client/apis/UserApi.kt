...
class UserApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
     ...
     */
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun createUsersWithArrayInput(body: List<User>) : Unit = withContext(Dispatchers.IO) {
     ...
     */
    @Throws(IllegalStateException::class, IOException::class)
    suspend fun createUsersWithArrayInputWithHttpInfo(body: List<User>) : ApiResponse<Unit?> = withContext(Dispatchers.IO) {
        val localVariableConfig = createUsersWithArrayInputRequestConfig(body = body)

        return@withContext request<List<User>, Unit>(
            localVariableConfig
        )
    }
     ...
     */
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun createUsersWithListInput(body: List<User>) : Unit = withContext(Dispatchers.IO) {
     ...
     */
    @Throws(IllegalStateException::class, IOException::class)
    suspend fun createUsersWithListInputWithHttpInfo(body: List<User>) : ApiResponse<Unit?> = withContext(Dispatchers.IO) {
     ...
     */
    @Throws(IllegalStateException::class, IOException::class)
    suspend fun deleteUserWithHttpInfo(username: String) : ApiResponse<Unit?> = withContext(Dispatchers.IO) {
    ...
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getUserByName(username: String) : User = withContext(Dispatchers.IO) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    suspend fun getUserByNameWithHttpInfo(username: String) : ApiResponse<User?> = withContext(Dispatchers.IO) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    suspend fun loginUserWithHttpInfo(username: String, password: String) : ApiResponse<String?> = withContext(Dispatchers.IO) {
        val localVariableConfig = loginUserRequestConfig(username = username, password = password)

        return@withContext request<Unit, String>(
            localVariableConfig
        )
    }
     ...
     */
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun updateUser(username: String, body: User) : Unit = withContext(Dispatchers.IO) {
     ...
     */
    @Throws(IllegalStateException::class, IOException::class)
    suspend fun updateUserWithHttpInfo(username: String, body: User) : ApiResponse<Unit?> = withContext(Dispatchers.IO) {
