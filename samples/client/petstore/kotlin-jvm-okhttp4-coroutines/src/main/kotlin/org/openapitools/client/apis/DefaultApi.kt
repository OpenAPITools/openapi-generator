...
class DefaultApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    suspend fun itemsItemIdSomethingItemSubIdGetWithHttpInfo(itemDollarId: kotlin.String, itemDollarSubId: kotlin.String, filterDollarType: kotlin.String?, filterDollarSubType: kotlin.String?, xCustomHeader: kotlin.String?, xCustomHeaderTwo: kotlin.String?) : ApiResponse<ItemsItemIdSomethingItemSubIdGet200Response?> = withContext(Dispatchers.IO) {
        ...
        return@withContext request<Unit, ItemsItemIdSomethingItemSubIdGet200Response>(
            localVariableConfig
        )
    }
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    suspend fun itemsPostWithHttpInfo(xPostHeader: kotlin.String?, formDollarName: kotlin.String?, formDollarValue: kotlin.String?) : ApiResponse<ItemWithDollarAttributesAndExamples?> = withContext(Dispatchers.IO) {
        ...
        return@withContext request<Map<String, PartConfig<*>>, ItemWithDollarAttributesAndExamples>(
            localVariableConfig
        )
    }
