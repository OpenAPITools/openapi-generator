...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     */
    this.addPetWithHttpInfo = function() {
      var postBody = body;
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    this.deletePetWithHttpInfo = function() {
      opts = opts || {};
      var postBody = null;
     ...
     */
    this.findPetsByStatusWithHttpInfo = function() {
      var postBody = null;
     ...
     */
    this.findPetsByStatus = function() {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:model/Pet>} and HTTP response
     */
    this.findPetsByTagsWithHttpInfo = function() {
      var postBody = null;
     ...
     */
    this.getPetByIdWithHttpInfo = function() {
      var postBody = null;
      // verify the required parameter 'petId' is set
      if (petId === undefined || petId === null) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    this.updatePetWithHttpInfo = function() {
      var postBody = body;
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    this.updatePetWithFormWithHttpInfo = function() {
      opts = opts || {};
      var postBody = null;
      // verify the required parameter 'petId' is set
      if (petId === undefined || petId === null) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}
     */
    this.updatePetWithForm = function() {
     ...
     */
    this.uploadFileWithHttpInfo = function() {
      opts = opts || {};
      var postBody = null;
      // verify the required parameter 'petId' is set
      if (petId === undefined || petId === null) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ApiResponse} and HTTP response
     */
    this.uploadFileWithRequiredFileWithHttpInfo = function() {
      opts = opts || {};
      var postBody = null;
      // verify the required parameter 'petId' is set
      if (petId === undefined || petId === null) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ApiResponse}
     */
    this.uploadFileWithRequiredFile = function() {
