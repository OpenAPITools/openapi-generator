...
defmodule OpenapiPetstore.Api.Fake do
  ...
  """
  @spec fake_all_of_with_local_single_ref_get(Tesla.Env.client, keyword()) :: {:ok, OpenapiPetstore.Model.any().t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec test_implicit_free_form_object(Tesla.Env.client, %{optional(String.t) => }, keyword()) :: {:ok, nil} | {:error, Tesla.Env.t}
