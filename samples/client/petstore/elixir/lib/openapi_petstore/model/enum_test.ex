...
defmodule OpenapiPetstore.Model.EnumTest do
  ...
  @type t :: %__MODULE__{
          ...
          :outerEnumIntegerDefaultValue =>
            OpenapiPetstore.Model.OuterEnumIntegerDefaultValue.t() | nil
        }
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(
      :outerEnumInteger,
      :struct,
      OpenapiPetstore.Model.OuterEnumInteger
    )
    |> Deserializer.deserialize(
      :outerEnumDefaultValue,
      :struct,
      OpenapiPetstore.Model.OuterEnumDefaultValue
    )
    |> Deserializer.deserialize(
      :outerEnumIntegerDefaultValue,
      :struct,
      OpenapiPetstore.Model.OuterEnumIntegerDefaultValue
    )
  end
end
