...
{ 
    ...
    public partial class Banana : IEquatable<Banana>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((Banana)obj);
        }

        /// <summary>
        /// Returns true if Banana instances are equal
        /// </summary>
        /// <param name="other">Instance of Banana to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Banana other)
        {
        ...
        public static bool operator ==(Banana left, Banana right)
        {
