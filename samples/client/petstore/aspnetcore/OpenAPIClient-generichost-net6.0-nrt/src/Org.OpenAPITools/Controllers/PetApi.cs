...
{ 
    ...
    { 
        ...
        /// <response code="200">successful operation</response>
        [HttpPost]
        [Route("/v2/fake/{petId}/uploadImageWithRequiredFile")]
        [Consumes("multipart/form-data")]
        [ValidateModelState]
        [SwaggerOperation("UploadFileWithRequiredFile")]
        [SwaggerResponse(statusCode: 200, type: typeof(ApiResponse), description: "successful operation")]
        public virtual IActionResult UploadFileWithRequiredFile([FromRoute (Name = "petId")][Required]long petId, [Required()]IFormFile requiredFile, [FromForm (Name = "additionalMetadata")]string? additionalMetadata)
        {
            ...
            string exampleJson = null;
            exampleJson = "{\n  \"code\" : 0,\n  \"type\" : \"type\",\n  \"message\" : \"message\"\n}";
            exampleJson = "Custom MIME type example not yet supported: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
