...
namespace Org.OpenAPITools.Authentication
{
    ...
    public class ApiKeyRequirementHandler : AuthorizationHandler<ApiKeyRequirement>
    {
        ...
        private void SucceedRequirementIfApiKeyPresentAndValid(AuthorizationHandlerContext context, ApiKeyRequirement requirement)
        {
            ...
            if (context.Resource is AuthorizationFilterContext authorizationFilterContext)
            {
                var apiKey = authorizationFilterContext.HttpContext.Request.Query["api_key_query"].FirstOrDefault();
                if (requirement.PolicyName == "api_key_query" && apiKey != null && requirement.ApiKeys.Any(requiredApiKey => apiKey == requiredApiKey))
                {
                    context.Succeed(requirement);
                }
            }
