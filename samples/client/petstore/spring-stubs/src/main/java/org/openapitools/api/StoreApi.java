...
public interface StoreApi {
    ...
    default ResponseEntity<Void> deleteOrder(@Parameter(in = ParameterIn.PATH,description = "ID of the order that needs to be deleted",required=true) @PathVariable("orderId") String orderId) {
    ...
    responses  = { 
        ...
        produces = "application/json", 
        method = RequestMethod.GET)
    default ResponseEntity<Order> getOrderById(@Min(1L) @Max(5L) @Parameter(in = ParameterIn.PATH,description = "ID of pet that needs to be fetched",required=true) @PathVariable("orderId") Long orderId) {
