...
class UpdatePetWithFormBody(object):
    ...
    def __init__(self, name=None, status=None, local_vars_configuration=None):  # noqa: E501
        """UpdatePetWithFormBody - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this UpdatePetWithFormBody.  # noqa: E501

        Updated name of the pet  # noqa: E501

        :return: The name of this UpdatePetWithFormBody.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @property
    def status(self):
        """Gets the status of this UpdatePetWithFormBody.  # noqa: E501

        Updated status of the pet  # noqa: E501

        :return: The status of this UpdatePetWithFormBody.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdatePetWithFormBody):
            return False
