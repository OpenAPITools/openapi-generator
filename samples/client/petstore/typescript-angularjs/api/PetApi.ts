...
export class PetApi {
     ...
     */
    public addPet (pet: models.Pet, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.Pet> {
     ...
     * @param pet Pet object that needs to be added to the store
     */
    public updatePet (pet: models.Pet, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.Pet> {
        const localVarPath = this.basePath + '/pet';
