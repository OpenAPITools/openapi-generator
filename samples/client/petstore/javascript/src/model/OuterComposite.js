  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('my_number')) {
        obj['my_number'] = OuterNumber.constructFromObject(data['null']);
      }
      if (data.hasOwnProperty('my_string')) {
        obj['my_string'] = OuterString.constructFromObject(data['null']);
      }
      if (data.hasOwnProperty('my_boolean')) {
        obj['my_boolean'] = OuterBoolean.constructFromObject(data['null']);
      }
    }
    return obj;
  }
