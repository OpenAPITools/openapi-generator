...
boost::property_tree::ptree User::toPropertyTree() const
{
...
std::string User::toJsonString_internal(bool prettyJson) const
{
	std::stringstream ss;
...
ptree User::toPropertyTree_internal() const
{
	ptree pt;
	ptree tmp_node;
	pt.put("id", m_Id);
