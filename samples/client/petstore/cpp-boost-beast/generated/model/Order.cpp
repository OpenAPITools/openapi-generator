...
boost::json::object Order::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        // Current nullability scope (Phase 2): unset optional → key omitted from JSON object.
        // Full tri-state (unset=omit, present-null→JSON null, present-value→JSON value)
        // is deferred to a future phase. When m_PetId.has_value(), the inner value is
        // serialized; when disengaged, the key is simply not written. This matches the
        // most common OpenAPI use case (optional properties omitted when absent).
        if (m_QuantityIsSet) {
        ...
        // Current nullability scope (Phase 2): unset optional → key omitted from JSON object.
        // Full tri-state (unset=omit, present-null→JSON null, present-value→JSON value)
        // is deferred to a future phase. When m_Quantity.has_value(), the inner value is
        // serialized; when disengaged, the key is simply not written. This matches the
        // most common OpenAPI use case (optional properties omitted when absent).
        if (m_ShipDateIsSet) {
        ...
        // Current nullability scope (Phase 2): unset optional → key omitted from JSON object.
        // Full tri-state (unset=omit, present-null→JSON null, present-value→JSON value)
        // is deferred to a future phase. When m_ShipDate.has_value(), the inner value is
        // serialized; when disengaged, the key is simply not written. This matches the
        // most common OpenAPI use case (optional properties omitted when absent).
        if (m_StatusIsSet) {
        ...
        // Current nullability scope (Phase 2): unset optional → key omitted from JSON object.
        // Full tri-state (unset=omit, present-null→JSON null, present-value→JSON value)
        // is deferred to a future phase. When m_Status.has_value(), the inner value is
        // serialized; when disengaged, the key is simply not written. This matches the
        // most common OpenAPI use case (optional properties omitted when absent).
        if (m_CompleteIsSet) {
        ...
        // Current nullability scope (Phase 2): unset optional → key omitted from JSON object.
        // Full tri-state (unset=omit, present-null→JSON null, present-value→JSON value)
        // is deferred to a future phase. When m_Complete.has_value(), the inner value is
        // serialized; when disengaged, the key is simply not written. This matches the
        // most common OpenAPI use case (optional properties omitted when absent).
    return object;
}
