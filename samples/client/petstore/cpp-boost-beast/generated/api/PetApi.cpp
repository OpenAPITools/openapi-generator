...
PetApi::addPet(
    ...
    std::string path = operationServerPrefix(m_context, "http://petstore.swagger.io/v2") + "/pet";
    ...
    // Security alternatives are OR groups containing AND-required schemes.
    {
        static const std::vector<SecurityRequirementGroup> operationSecurity = {
            SecurityRequirementGroup{ {
                SecuritySchemeUse{"petstore_auth", "oauth2", "", "", "", { "write:pets", "read:pets" }},
            } },
        };
        applyOperationSecurity("addPet", operationSecurity, path, headers);
    }
...
PetApi::updatePet(
    ...
    // Security alternatives are OR groups containing AND-required schemes.
    {
        ...
        applyOperationSecurity("updatePet", operationSecurity, path, headers);
    }
    auto statusCode = boost::beast::http::status::unknown;
    std::string responseBody;
    try {
...
PetApi::deletePet(
    ...
    replacePathParameter(path, "petId", petId, "simple", false);
    // headers
    headers.emplace("api_key", serializeHeaderParameterValue(apiKey, false));
    ...
    // Security alternatives are OR groups containing AND-required schemes.
    {
        ...
        applyOperationSecurity("deletePet", operationSecurity, path, headers);
    }
    auto statusCode = boost::beast::http::status::unknown;
    std::string responseBody;
    try {
...
PetApi::getPetById(
    ...
    // Security alternatives are OR groups containing AND-required schemes.
    {
        ...
        applyOperationSecurity("getPetById", operationSecurity, path, headers);
    }
    auto statusCode = boost::beast::http::status::unknown;
    std::string responseBody;
    try {
...
PetApi::updatePetWithForm(
    ...
    // Security alternatives are OR groups containing AND-required schemes.
    {
        ...
        applyOperationSecurity("updatePetWithForm", operationSecurity, path, headers);
    }
    auto statusCode = boost::beast::http::status::unknown;
    std::string responseBody;
    try {
...
PetApi::findPetsByStatus(
    ...
    std::string serializedRequestBody;
    std::string path = operationServerPrefix(m_context, "http://petstore.swagger.io/v2") + "/pet/findByStatus";
    std::map<std::string, std::string> headers;
    ...
    // Security alternatives are OR groups containing AND-required schemes.
    {
        static const std::vector<SecurityRequirementGroup> operationSecurity = {
            SecurityRequirementGroup{ {
                SecuritySchemeUse{"petstore_auth", "oauth2", "", "", "", { "read:pets" }},
            } },
        };
        applyOperationSecurity("findPetsByStatus", operationSecurity, path, headers);
    }
    auto statusCode = boost::beast::http::status::unknown;
    std::string responseBody;
    try {
...
PetApi::findPetsByTags(
    ...
    std::string serializedRequestBody;
    std::string path = operationServerPrefix(m_context, "http://petstore.swagger.io/v2") + "/pet/findByTags";
    std::map<std::string, std::string> headers;
    // Query parameters preserve style, explode, allowReserved, and allowEmptyValue.
    std::stringstream queryParameterStream;
    const char* queryParameterSeparator = "?";
    ...
    // Security alternatives are OR groups containing AND-required schemes.
    {
        ...
        applyOperationSecurity("findPetsByTags", operationSecurity, path, headers);
    }
    auto statusCode = boost::beast::http::status::unknown;
    std::string responseBody;
    try {
...
PetApi::uploadFile(
    ...
    // Security alternatives are OR groups containing AND-required schemes.
    {
        ...
        applyOperationSecurity("uploadFile", operationSecurity, path, headers);
    }
    auto statusCode = boost::beast::http::status::unknown;
    std::string responseBody;
    try {
