...
struct SseStreamOptions {
    ...
    /// Compatibility mode for non-conforming servers that omit the final blank
    /// line. Default false follows WHATWG framing and discards an incomplete event.
    bool dispatchUnterminatedEventAtEof = false;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_HTTP_CLIENT_H_ */
