...
export function NullableClassFromJSONTyped(json: any, ignoreDiscriminator: boolean): NullableClass {
    ...
    return {
        ...
        'dateProp': !exists(json, 'date_prop') ? undefined : json['date_prop'],
        'datetimeProp': !exists(json, 'datetime_prop') ? undefined : json['datetime_prop'],
...
export function NullableClassToJSON(value?: NullableClass | null): any {
    ...
    return {
        ...
        'date_prop': value.dateProp,
        'datetime_prop': value.datetimeProp,
