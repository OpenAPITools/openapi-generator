...
export class PetApi extends runtime.BaseAPI {
     ...
     */
    async addPetRaw(requestParameters: PetApiAddPetRequest): Promise<runtime.ApiResponse<Pet>> {
     ...
     * Add a new pet to the store
     */
    async addPet(requestParameters: PetApiAddPetRequest): Promise<Pet> {
     ...
     */
    async updatePetRaw(requestParameters: PetApiUpdatePetRequest): Promise<runtime.ApiResponse<Pet>> {
        if (requestParameters.pet === null || requestParameters.pet === undefined) {
     ...
     * Update an existing pet
     */
    async updatePet(requestParameters: PetApiUpdatePetRequest): Promise<Pet> {
