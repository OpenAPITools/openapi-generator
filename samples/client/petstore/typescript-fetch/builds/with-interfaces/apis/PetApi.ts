...
export interface PetApiInterface {
     ...
     */
    addPetRaw(requestParameters: AddPetRequest, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<runtime.ApiResponse<void>>;

    /**
     * Add a new pet to the store
     */
    addPet(requestParameters: AddPetRequest, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<void>;
     ...
     * @memberof PetApiInterface
     */
    deletePetRaw(requestParameters: DeletePetRequest, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<runtime.ApiResponse<void>>;

    /**
     * Deletes a pet
     */
    deletePet(requestParameters: DeletePetRequest, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<void>;
     ...
     * @memberof PetApiInterface
     */
    findPetsByStatusRaw(requestParameters: FindPetsByStatusRequest, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<runtime.ApiResponse<Array<Pet>>>;

    /**
     * Multiple status values can be provided with comma separated strings
     * Finds Pets by status
     */
    findPetsByStatus(requestParameters: FindPetsByStatusRequest, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<Array<Pet>>;
     ...
     * @memberof PetApiInterface
     */
    findPetsByTagsRaw(requestParameters: FindPetsByTagsRequest, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<runtime.ApiResponse<Array<Pet>>>;

    /**
     * Multiple tags can be provided with comma separated strings. Use tag1, tag2, tag3 for testing.
     * Finds Pets by tags
     */
    findPetsByTags(requestParameters: FindPetsByTagsRequest, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<Array<Pet>>;
     ...
     * @memberof PetApiInterface
     */
    getPetByIdRaw(requestParameters: GetPetByIdRequest, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<runtime.ApiResponse<Pet>>;

    /**
     * Returns a single pet
     * Find pet by ID
     */
    getPetById(requestParameters: GetPetByIdRequest, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<Pet>;
     ...
     * @memberof PetApiInterface
     */
    updatePetRaw(requestParameters: UpdatePetRequest, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<runtime.ApiResponse<void>>;

    /**
     * Update an existing pet
     */
    updatePet(requestParameters: UpdatePetRequest, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<void>;
     ...
     * @memberof PetApiInterface
     */
    updatePetWithFormRaw(requestParameters: UpdatePetWithFormRequest, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<runtime.ApiResponse<void>>;

    /**
     * Updates a pet in the store with form data
     */
    updatePetWithForm(requestParameters: UpdatePetWithFormRequest, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<void>;
     ...
     * @memberof PetApiInterface
     */
    uploadFileRaw(requestParameters: UploadFileRequest, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<runtime.ApiResponse<ModelApiResponse>>;

    /**
     * uploads an image
     */
    uploadFile(requestParameters: UploadFileRequest, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<ModelApiResponse>;
