...
export class PetApi extends runtime.BaseAPI {
     ...
     * Add a new pet to the store
     */
    async addPet(dummyCat: Category, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<void> {
     ...
     * Deletes a pet
     */
    async deletePet(petId: number, apiKey?: string, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<void> {
     ...
     * Finds Pets by ids
     */
    async findPetsByIdsRaw(requestParameters: FindPetsByIdsRequest, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<runtime.ApiResponse<Array<Pet>>> {
     ...
     * Finds Pets by ids
     */
    async findPetsByIds(ids: Array<number>, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<Array<Pet>> {
     ...
     */
    async findPetsByStatusRaw(requestParameters: FindPetsByStatusRequest, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<runtime.ApiResponse<FindPetsByStatusResponse>> {
     ...
     * Finds Pets by status
     */
    async findPetsByStatus(status: Array<FindPetsByStatusStatusEnum>, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<FindPetsByStatusResponse> {
     ...
     * Finds Pets by tags
     */
    async findPetsByTagsRaw(requestParameters: FindPetsByTagsRequest, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<runtime.ApiResponse<Array<Pet>>> {
     ...
     * Finds Pets by tags
     */
    async findPetsByTags(tags: Array<string>, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<Array<Pet>> {
     ...
     */
    async findPetsByUserIdsRaw(requestParameters: FindPetsByUserIdsRequest, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<runtime.ApiResponse<FindPetsByUserResponse>> {
        if (requestParameters.ids === null || requestParameters.ids === undefined) {
     ...
     * Finds Pets by user ids
     */
    async findPetsByUserIds(ids: Array<number>, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<FindPetsByUserResponse> {
     ...
     * Find pet by ID
     */
    async getPetById(petId: number, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<Pet> {
     ...
     */
    async getPetRegionsRaw(requestParameters: GetPetRegionsRequest, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<runtime.ApiResponse<PetRegionsResponse>> {
        if (requestParameters.petId === null || requestParameters.petId === undefined) {
     ...
     * Gets regions for a single pet.
     */
    async getPetRegions(petId: number, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<PetRegionsResponse> {
     ...
     * Update an existing pet
     */
    async updatePet(body: Pet, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<void> {
     ...
     */
    async updatePetRegionsRaw(requestParameters: UpdatePetRegionsRequest, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<runtime.ApiResponse<PetRegionsResponse>> {
        if (requestParameters.petId === null || requestParameters.petId === undefined) {
     ...
     * Updates the pet regions.
     */
    async updatePetRegions(petId: number, newRegions: Array<Array<number>>, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<PetRegionsResponse> {
     ...
     * Updates a pet in the store with form data
     */
    async updatePetWithForm(petId: number, name?: string, status?: string, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<void> {
     ...
     * uploads an image
     */
    async uploadFile(petId: number, additionalMetadata?: string, file?: Blob, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<ModelApiResponse> {
