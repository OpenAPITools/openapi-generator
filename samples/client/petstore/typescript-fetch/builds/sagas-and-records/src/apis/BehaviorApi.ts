...
export class BehaviorApi extends runtime.BaseAPI {
     ...
     */
    async getBehaviorPermissionsRaw(requestParameters: GetBehaviorPermissionsRequest, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<runtime.ApiResponse<GetBehaviorPermissionsResponse>> {
     ...
     * Get permissions for the behavior
     */
    async getBehaviorPermissions(behaviorId: number, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<GetBehaviorPermissionsResponse> {
     ...
     */
    async getBehaviorTypeRaw(requestParameters: GetBehaviorTypeRequest, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<runtime.ApiResponse<GetBehaviorTypeResponse>> {
        if (requestParameters.behaviorId === null || requestParameters.behaviorId === undefined) {
     ...
     * Get the type of behavior
     */
    async getBehaviorType(behaviorId: number, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<GetBehaviorTypeResponse> {
