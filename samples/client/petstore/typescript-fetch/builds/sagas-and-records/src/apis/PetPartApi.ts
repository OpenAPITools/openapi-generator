...
export class PetPartApi extends runtime.BaseAPI {
     ...
     */
    async getFakePetPartTypeRaw(requestParameters: GetFakePetPartTypeRequest, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<runtime.ApiResponse<GetPetPartTypeResponse>> {
     ...
     * Returns single pet part type for the petPart id.
     */
    async getFakePetPartType(fakePetPartId: number, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<GetPetPartTypeResponse> {
     ...
     */
    async getMatchingPartsRaw(requestParameters: GetMatchingPartsRequest, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<runtime.ApiResponse<GetMatchingPartsResponse>> {
        if (requestParameters.fakePetPartId === null || requestParameters.fakePetPartId === undefined) {
     ...
     * Get the matching parts for the given pet part.
     */
    async getMatchingParts(fakePetPartId: number, _long: boolean, smooth: boolean, _short: boolean, name?: string, connectedPart?: string, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<GetMatchingPartsResponse> {
