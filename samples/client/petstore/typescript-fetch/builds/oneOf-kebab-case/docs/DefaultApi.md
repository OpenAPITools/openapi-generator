...
import {
  Configuration,
  DefaultApi,
} from '@openapitools/typescript-fetch-oneof-kebab-case';
import type { TestRequest } from '@openapitools/typescript-fetch-oneof-kebab-case';

async function example() {
  console.log("🚀 Testing @openapitools/typescript-fetch-oneof-kebab-case SDK...");
...
import type { TestArrayRequest } from '@openapitools/typescript-fetch-oneof-kebab-case';
...
import type { TestDashedDiscriminatorRequest } from '@openapitools/typescript-fetch-oneof-kebab-case';
...
import type { TestDiscriminatorRequest } from '@openapitools/typescript-fetch-oneof-kebab-case';
...
import type { TestSnakeCaseDiscriminatorRequest } from '@openapitools/typescript-fetch-oneof-kebab-case';
