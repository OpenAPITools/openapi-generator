...
export class PetApi extends runtime.BaseAPI {
     ...
     * Add a new pet to the store
     */
    async addPet(body: Pet, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<void> {
     ...
     * Finds Pets by status
     */
    async findPetsByStatus(status: Array<FindPetsByStatusStatusEnum>, initOverrides?: RequestInit | ((requestContext: { init: runtime.HTTPRequestInit, context: runtime.RequestOpts }) => Promise<RequestInit>)): Promise<Array<Pet>> {
