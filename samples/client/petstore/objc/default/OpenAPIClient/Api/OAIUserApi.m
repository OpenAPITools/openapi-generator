...
@interface OAIUserApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAIUserApi

NSString* kOAIUserApiErrorDomain = @"OAIUserApiErrorDomain";
NSInteger kOAIUserApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) deleteUserWithUsername: (NSString*) username
    ...
    if (username == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAIUserApiErrorDomain code:kOAIUserApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }
