#import "OAIStoreApi.h"
#import "OAIQueryParamCollection.h"
#import "OAIApiClient.h"
#import "OAIOrder.h"


@interface OAIStoreApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAIStoreApi

NSString* kOAIStoreApiErrorDomain = @"OAIStoreApiErrorDomain";
NSInteger kOAIStoreApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) deleteOrderWithOrderId: (NSString*) orderId
    ...
    if (orderId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAIStoreApiErrorDomain code:kOAIStoreApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }
...
-(NSURLSessionTask*) getOrderByIdWithOrderId: (NSString*) orderId
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAIOrder*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIOrder*)data, error);
                                }
                            }];
}
