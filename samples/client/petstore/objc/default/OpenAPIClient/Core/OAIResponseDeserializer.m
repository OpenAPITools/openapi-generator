...
NSString *const OAIDeserializationErrorDomainKey = @"OAIDeserializationErrorDomainKey";

NSInteger const OAITypeMismatchErrorCode = 143553;

NSInteger const OAIEmptyValueOccurredErrorCode = 143509;
...
@implementation OAIResponseDeserializer
