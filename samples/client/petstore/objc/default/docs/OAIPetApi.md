...
# **addPet**
```objc
-(NSURLSessionTask*) addPetWithBody: (OAIPet*) body
...
------------- | ------------- | ------------- | -------------
 **body** | [**OAIPet***](OAIPet.md)| Pet object that needs to be added to the store | 
...
# **updatePet**
```objc
-(NSURLSessionTask*) updatePetWithBody: (OAIPet*) body
        completionHandler: (void (^)(NSError* error)) handler;
```
