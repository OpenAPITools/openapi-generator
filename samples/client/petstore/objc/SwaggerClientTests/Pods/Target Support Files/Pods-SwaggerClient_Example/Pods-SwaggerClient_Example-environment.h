...
// SwaggerClient
#define COCOAPODS_POD_AVAILABLE_SwaggerClient
#define COCOAPODS_VERSION_MAJOR_SwaggerClient 0
#define COCOAPODS_VERSION_MINOR_SwaggerClient 1
#define COCOAPODS_VERSION_PATCH_SwaggerClient 0
