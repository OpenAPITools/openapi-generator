...
public:
    ...
    void addPetResponse(const OAIPet& res);
    ...
    void addPetError(const OAIPet& res, QNetworkReply::NetworkError error_type, QString& error_str);
    ...
    void updatePetError(const OAIPet& res, QNetworkReply::NetworkError error_type, QString& error_str);
