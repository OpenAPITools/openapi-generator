...
void OAIPetApiRequest::addPetResponse(const OAIPet& res){
...
void OAIPetApiRequest::addPetError(const OAIPet& res, QNetworkReply::NetworkError error_type, QString& error_str){
...
void OAIPetApiRequest::updatePetError(const OAIPet& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    writeResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
