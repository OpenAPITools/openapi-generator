...
QString OAIInline_object::getName() const {
    return name;
}
void OAIInline_object::setName(const QString &name) {
    this->name = name;
    this->m_name_isSet = true;
}

bool OAIInline_object::is_name_Set() const{
    return m_name_isSet;
}

bool OAIInline_object::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIInline_object::getStatus() const {
    return status;
}
void OAIInline_object::setStatus(const QString &status) {
    this->status = status;
    this->m_status_isSet = true;
}

bool OAIInline_object::is_status_Set() const{
    return m_status_isSet;
}

bool OAIInline_object::is_status_Valid() const{
