...
QString OAIInline_object_1::getAdditionalMetadata() const {
    return additional_metadata;
}
void OAIInline_object_1::setAdditionalMetadata(const QString &additional_metadata) {
    this->additional_metadata = additional_metadata;
    this->m_additional_metadata_isSet = true;
}

bool OAIInline_object_1::is_additional_metadata_Set() const{
    return m_additional_metadata_isSet;
}

bool OAIInline_object_1::is_additional_metadata_Valid() const{
    return m_additional_metadata_isValid;
}

OAIHttpFileElement OAIInline_object_1::getFile() const {
    return file;
}
void OAIInline_object_1::setFile(const OAIHttpFileElement &file) {
    this->file = file;
    this->m_file_isSet = true;
}

bool OAIInline_object_1::is_file_Set() const{
    return m_file_isSet;
}

bool OAIInline_object_1::is_file_Valid() const{
