...
namespace UseSourceGeneration.Api
{
    ...
    /// </summary>
    public interface IFakeHealthGetApiResponse : UseSourceGeneration.Client.IApiResponse, IOk<UseSourceGeneration.Model.HealthCheckResult?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IFakeOuterBooleanSerializeApiResponse : UseSourceGeneration.Client.IApiResponse, IOk<bool?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IFakeOuterCompositeSerializeApiResponse : UseSourceGeneration.Client.IApiResponse, IOk<UseSourceGeneration.Model.OuterComposite?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IFakeOuterNumberSerializeApiResponse : UseSourceGeneration.Client.IApiResponse, IOk<decimal?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IFakeOuterStringSerializeApiResponse : UseSourceGeneration.Client.IApiResponse, IOk<string?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetMixedAnyOfApiResponse : UseSourceGeneration.Client.IApiResponse, IOk<UseSourceGeneration.Model.MixedAnyOf?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetMixedOneOfApiResponse : UseSourceGeneration.Client.IApiResponse, IOk<UseSourceGeneration.Model.MixedOneOf?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface ITestClientModelApiResponse : UseSourceGeneration.Client.IApiResponse, IOk<UseSourceGeneration.Model.ModelClient?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    public sealed partial class FakeApi : IFakeApi
    {
        ...
        public partial class FakeHealthGetApiResponse : UseSourceGeneration.Client.ApiResponse, IFakeHealthGetApiResponse
        {
            ...
            public UseSourceGeneration.Model.HealthCheckResult? Ok()
            {
                ...
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<UseSourceGeneration.Model.HealthCheckResult>(RawContent, _jsonSerializerOptions)
                    : null;
            }
        ...
        public partial class FakeOuterCompositeSerializeApiResponse : UseSourceGeneration.Client.ApiResponse, IFakeOuterCompositeSerializeApiResponse
        {
            ...
            public UseSourceGeneration.Model.OuterComposite? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<UseSourceGeneration.Model.OuterComposite>(RawContent, _jsonSerializerOptions)
                    : null;
            }
        ...
        /// </summary>
        public partial class GetMixedAnyOfApiResponse : UseSourceGeneration.Client.ApiResponse, IGetMixedAnyOfApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public UseSourceGeneration.Model.MixedAnyOf? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<UseSourceGeneration.Model.MixedAnyOf>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out UseSourceGeneration.Model.MixedAnyOf? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class GetMixedOneOfApiResponse : UseSourceGeneration.Client.ApiResponse, IGetMixedOneOfApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public UseSourceGeneration.Model.MixedOneOf? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<UseSourceGeneration.Model.MixedOneOf>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out UseSourceGeneration.Model.MixedOneOf? result)
            {
                result = null;
