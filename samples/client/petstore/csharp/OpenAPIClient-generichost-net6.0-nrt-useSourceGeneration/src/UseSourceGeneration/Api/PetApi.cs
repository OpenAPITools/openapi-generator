...
namespace UseSourceGeneration.Api
{
    ...
    /// </summary>
    public interface IFindPetsByStatusApiResponse : UseSourceGeneration.Client.IApiResponse, IOk<List<Pet>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IFindPetsByTagsApiResponse : UseSourceGeneration.Client.IApiResponse, IOk<List<Pet>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetPetByIdApiResponse : UseSourceGeneration.Client.IApiResponse, IOk<UseSourceGeneration.Model.Pet?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IUploadFileApiResponse : UseSourceGeneration.Client.IApiResponse, IOk<UseSourceGeneration.Model.ApiResponse?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IUploadFileWithRequiredFileApiResponse : UseSourceGeneration.Client.IApiResponse, IOk<UseSourceGeneration.Model.ApiResponse?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    public sealed partial class PetApi : IPetApi
    {
        ...
        public partial class GetPetByIdApiResponse : UseSourceGeneration.Client.ApiResponse, IGetPetByIdApiResponse
        {
            ...
            public UseSourceGeneration.Model.Pet? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<UseSourceGeneration.Model.Pet>(RawContent, _jsonSerializerOptions)
                    : null;
            }
        ...
        public partial class UploadFileApiResponse : UseSourceGeneration.Client.ApiResponse, IUploadFileApiResponse
        {
            ...
            public UseSourceGeneration.Model.ApiResponse? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<UseSourceGeneration.Model.ApiResponse>(RawContent, _jsonSerializerOptions)
                    : null;
            }
