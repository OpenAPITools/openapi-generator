...
namespace UseSourceGeneration.Model
{
    ...
    public partial class MixedAnyOf : IValidatableObject
    {
        ...
        [JsonConstructor]
        public MixedAnyOf(MixedAnyOfContent content)
        {
            Content = content;
            OnCreated();
        }
    ...
    public class MixedAnyOfJsonConverter : JsonConverter<MixedAnyOf>
    {
        ...
        public override MixedAnyOf Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            MixedAnyOfContent? content = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "content":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                content = JsonSerializer.Deserialize<MixedAnyOfContent>(ref utf8JsonReader, jsonSerializerOptions);
                            break;
                        default:
                            break;
                    }
            ...
            if (content == null)
                throw new ArgumentNullException(nameof(content), "Property is required for class MixedAnyOf.");
        ...
        public override void Write(Utf8JsonWriter writer, MixedAnyOf mixedAnyOf, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(ref writer, mixedAnyOf, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, MixedAnyOf mixedAnyOf, JsonSerializerOptions jsonSerializerOptions)
        {
    ...
    /// <summary>
    /// The MixedAnyOfSerializationContext
    /// </summary>
    [JsonSourceGenerationOptions(WriteIndented = true, GenerationMode = JsonSourceGenerationMode.Metadata | JsonSourceGenerationMode.Serialization)]
    [JsonSerializable(typeof(MixedAnyOf))]
    public partial class MixedAnyOfSerializationContext : JsonSerializerContext { }
}
