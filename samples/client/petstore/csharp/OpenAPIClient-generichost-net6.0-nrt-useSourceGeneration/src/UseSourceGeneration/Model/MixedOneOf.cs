...
namespace UseSourceGeneration.Model
{
    ...
    public partial class MixedOneOf : IValidatableObject
    {
        ...
        [JsonConstructor]
        public MixedOneOf(MixedOneOfContent content)
        {
            Content = content;
            OnCreated();
        }
    ...
    public class MixedOneOfJsonConverter : JsonConverter<MixedOneOf>
    {
        ...
        public override MixedOneOf Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            MixedOneOfContent? content = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "content":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                content = JsonSerializer.Deserialize<MixedOneOfContent>(ref utf8JsonReader, jsonSerializerOptions);
                            break;
                        default:
                            break;
                    }
            ...
            if (content == null)
                throw new ArgumentNullException(nameof(content), "Property is required for class MixedOneOf.");
