...
namespace Org.OpenAPITools.Model
{
    ...
    public class MixedOneOfJsonConverter : JsonConverter<MixedOneOf>
    {
        ...
        public override void Write(Utf8JsonWriter writer, MixedOneOf mixedOneOf, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(ref writer, mixedOneOf, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, MixedOneOf mixedOneOf, JsonSerializerOptions jsonSerializerOptions)
        {
