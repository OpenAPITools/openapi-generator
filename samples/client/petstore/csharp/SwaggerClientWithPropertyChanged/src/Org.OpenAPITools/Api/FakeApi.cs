...
namespace Org.OpenAPITools.Api
{
    ...
    public interface IFakeApi : IApiAccessor
    {
        ...
        /// <exception cref="Org.OpenAPITools.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="param">request body</param>
        /// <returns>ApiResponse of MixedPropertiesAndAdditionalPropertiesClass</returns>
        ApiResponse<MixedPropertiesAndAdditionalPropertiesClass> TestMixedPropertiesAndAdditionalPropertiesWithHttpInfo (MixedPropertiesAndAdditionalPropertiesClass param);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// <exception cref="Org.OpenAPITools.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="param">request body</param>
        /// <returns>Task of MixedPropertiesAndAdditionalPropertiesClass</returns>
        System.Threading.Tasks.Task<MixedPropertiesAndAdditionalPropertiesClass> TestMixedPropertiesAndAdditionalPropertiesAsync (MixedPropertiesAndAdditionalPropertiesClass param);
        ...
        /// <exception cref="Org.OpenAPITools.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="param">request body</param>
        /// <returns>Task of ApiResponse (MixedPropertiesAndAdditionalPropertiesClass)</returns>
        System.Threading.Tasks.Task<ApiResponse<MixedPropertiesAndAdditionalPropertiesClass>> TestMixedPropertiesAndAdditionalPropertiesAsyncWithHttpInfo (MixedPropertiesAndAdditionalPropertiesClass param);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    public partial class FakeApi : IFakeApi
    {
        ...
        {
             ApiResponse<MixedPropertiesAndAdditionalPropertiesClass> localVarResponse = TestMixedPropertiesAndAdditionalPropertiesWithHttpInfo(param);
             return localVarResponse.Data;
        }
        ...
        /// <param name="param">request body</param>
        /// <returns>ApiResponse of MixedPropertiesAndAdditionalPropertiesClass</returns>
        public ApiResponse<MixedPropertiesAndAdditionalPropertiesClass> TestMixedPropertiesAndAdditionalPropertiesWithHttpInfo (MixedPropertiesAndAdditionalPropertiesClass param)
        {
            // verify the required parameter 'param' is set
            if (param == null)
                throw new ApiException(400, "Missing required parameter 'param' when calling FakeApi->TestMixedPropertiesAndAdditionalProperties");

            var localVarPath = "/fake/body-mixedPropertiesAndAdditionalProperties";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("TestMixedPropertiesAndAdditionalProperties", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<MixedPropertiesAndAdditionalPropertiesClass>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (MixedPropertiesAndAdditionalPropertiesClass) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(MixedPropertiesAndAdditionalPropertiesClass)));
        }
        ...
        /// <param name="param">request body</param>
        /// <returns>Task of MixedPropertiesAndAdditionalPropertiesClass</returns>
        public async System.Threading.Tasks.Task<MixedPropertiesAndAdditionalPropertiesClass> TestMixedPropertiesAndAdditionalPropertiesAsync (MixedPropertiesAndAdditionalPropertiesClass param)
        {
             ApiResponse<MixedPropertiesAndAdditionalPropertiesClass> localVarResponse = await TestMixedPropertiesAndAdditionalPropertiesAsyncWithHttpInfo(param);
             return localVarResponse.Data;
        ...
        /// <param name="param">request body</param>
        /// <returns>Task of ApiResponse (MixedPropertiesAndAdditionalPropertiesClass)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<MixedPropertiesAndAdditionalPropertiesClass>> TestMixedPropertiesAndAdditionalPropertiesAsyncWithHttpInfo (MixedPropertiesAndAdditionalPropertiesClass param)
        {
            // verify the required parameter 'param' is set
            if (param == null)
                throw new ApiException(400, "Missing required parameter 'param' when calling FakeApi->TestMixedPropertiesAndAdditionalProperties");
