...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class NullableClass : IEquatable<NullableClass>, IValidatableObject
    {
        ...
        public NullableClass(Option<int?> integerProp = default(Option<int?>), Option<decimal?> numberProp = default(Option<decimal?>), Option<bool?> booleanProp = default(Option<bool?>), Option<string?> stringProp = default(Option<string?>), Option<DateOnly?> dateProp = default(Option<DateOnly?>), Option<DateTime?> datetimeProp = default(Option<DateTime?>), Option<List<Object>?> arrayNullableProp = default(Option<List<Object>?>), Option<List<Object?>?> arrayAndItemsNullableProp = default(Option<List<Object?>?>), Option<List<Object?>> arrayItemsNullable = default(Option<List<Object?>>), Option<Dictionary<string, Object>?> objectNullableProp = default(Option<Dictionary<string, Object>?>), Option<Dictionary<string, Object?>?> objectAndItemsNullableProp = default(Option<Dictionary<string, Object?>?>), Option<Dictionary<string, Object?>> objectItemsNullable = default(Option<Dictionary<string, Object?>>))
        {
