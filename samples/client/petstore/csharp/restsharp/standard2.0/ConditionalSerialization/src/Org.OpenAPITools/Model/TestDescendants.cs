    ...
    public partial class TestDescendants : IEquatable<TestDescendants>, IValidatableObject
    {
        ...
        public string AlternativeName
        {
            ...
            set
            {
                ...
                _flagAlternativeName = true;
            }
        }
        private string _AlternativeName;
        private bool _flagAlternativeName;

        /// <summary>
        /// Returns false as AlternativeName should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeAlternativeName()
        {
            return _flagAlternativeName;
        }
        /// <summary>
