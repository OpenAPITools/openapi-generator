...
namespace Org.OpenAPITools.Api
{
    ...
    public partial class FakeClassnameTags123Api : IDisposable, IFakeClassnameTags123Api
    {
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<Model.ModelClient> localVarResponse = await TestClassnameWithHttpInfoAsync(modelClient, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
