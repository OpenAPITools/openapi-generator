...
namespace Org.OpenAPITools.Api
{
    ...
    public partial class StoreApi : IDisposable, IStoreApi
    {
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<Model.Order> localVarResponse = await GetOrderByIdWithHttpInfoAsync(orderId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<Model.Order> localVarResponse = await PlaceOrderWithHttpInfoAsync(order, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
