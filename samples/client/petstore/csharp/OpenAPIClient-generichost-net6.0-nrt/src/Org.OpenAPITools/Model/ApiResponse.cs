...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ApiResponse : IValidatableObject
    {
        ...
        /// </summary>
        [JsonIgnore]
        public Option<int?> CodeOption { get; private set; } // option d

        /// <summary>
        /// Gets or Sets Code
        /// </summary>
        [JsonPropertyName("code")]
        public int? Code { get { return this. CodeOption; } set { this.CodeOption = new(value); } } // d

        /// <summary>
        /// Used to track the state of Message
        /// </summary>
        [JsonIgnore]
        public Option<string?> MessageOption { get; private set; } // option d

        /// <summary>
        /// Gets or Sets Message
        /// </summary>
        [JsonPropertyName("message")]
        public string? Message { get { return this. MessageOption; } set { this.MessageOption = new(value); } } // d
    ...
    public class ApiResponseJsonConverter : JsonConverter<ApiResponse>
    {
        ...
        public override ApiResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new ApiResponse(code, message, type); // a
        }
        ...
        public void WriteProperties(ref Utf8JsonWriter writer, ApiResponse apiResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (apiResponse.CodeOption.IsSet)
                writer.WriteNumber("code", apiResponse.CodeOption.Value!.Value); // 3

            if (apiResponse.MessageOption.IsSet)
                writer.WriteString("message", apiResponse.Message); // 1

            if (apiResponse.TypeOption.IsSet)
                writer.WriteString("type", apiResponse.Type); // 1
        }
    }
}
