    ...
    public class LiteralStringClassJsonConverter : JsonConverter<LiteralStringClass>
    {
        ...
        public void WriteProperties(ref Utf8JsonWriter writer, LiteralStringClass literalStringClass, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (literalStringClass.EscapedLiteralString.IsSet)
                writer.WriteString("escapedLiteralString", literalStringClass.EscapedLiteralString.Value);// 1            if (literalStringClass.UnescapedLiteralString.IsSet)
                writer.WriteString("unescapedLiteralString", literalStringClass.UnescapedLiteralString.Value);// 1
        }
    }
}
