...
namespace Org.OpenAPITools.Api
{
    ...
    public interface IPetApiSync : IApiAccessor
    {
        ...
        /// <param name="files"></param>
        /// <returns>ApiResponse of ApiResponse</returns>
        ApiResponse<ApiResponse> UploadFilesWithHttpInfo(long petId, List<FileParameter> files);
    ...
    public interface IPetApiAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse> UploadFilesAsync(long petId, List<FileParameter> files, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ApiResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<ApiResponse>> UploadFilesWithHttpInfoAsync(long petId, List<FileParameter> files, System.Threading.CancellationToken cancellationToken = default);
    ...
    public partial class PetApi : IDisposable, IPetApi
    {
        ...
        /// <param name="files"></param>
        /// <returns>ApiResponse</returns>
        public ApiResponse UploadFiles(long petId, List<FileParameter> files)
        {
        ...
        /// <param name="files"></param>
        /// <returns>ApiResponse of ApiResponse</returns>
        public Org.OpenAPITools.Client.ApiResponse<ApiResponse> UploadFilesWithHttpInfo(long petId, List<FileParameter> files)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse> UploadFilesAsync(long petId, List<FileParameter> files, System.Threading.CancellationToken cancellationToken = default)
        {
            Org.OpenAPITools.Client.ApiResponse<ApiResponse> localVarResponse = await UploadFilesWithHttpInfoAsync(petId, files, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ApiResponse)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<ApiResponse>> UploadFilesWithHttpInfoAsync(long petId, List<FileParameter> files, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'files' is set
            if (files == null)
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'files' when calling PetApi->UploadFiles");
