...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class RequiredClass : IEquatable<RequiredClass>, IValidatableObject
    {
        ...
        public RequiredClass(DateTime notRequiredNotnullableDateProp = default, int notRequiredNotnullableintegerProp = default, DateTime? notRequiredNullableDateProp = default, int? notRequiredNullableIntegerProp = default, List<string> notrequiredNotnullableArrayOfString = default, bool notrequiredNotnullableBooleanProp = default, DateTime notrequiredNotnullableDatetimeProp = default, NotrequiredNotnullableEnumIntegerEnum? notrequiredNotnullableEnumInteger = default, NotrequiredNotnullableEnumIntegerOnlyEnum? notrequiredNotnullableEnumIntegerOnly = default, NotrequiredNotnullableEnumStringEnum? notrequiredNotnullableEnumString = default, OuterEnumDefaultValue? notrequiredNotnullableOuterEnumDefaultValue = default, string notrequiredNotnullableStringProp = default, Guid notrequiredNotnullableUuid = default, List<string> notrequiredNullableArrayOfString = default, bool? notrequiredNullableBooleanProp = default, DateTime? notrequiredNullableDatetimeProp = default, NotrequiredNullableEnumIntegerEnum? notrequiredNullableEnumInteger = default, NotrequiredNullableEnumIntegerOnlyEnum? notrequiredNullableEnumIntegerOnly = default, NotrequiredNullableEnumStringEnum? notrequiredNullableEnumString = default, OuterEnumDefaultValue? notrequiredNullableOuterEnumDefaultValue = default, string notrequiredNullableStringProp = default, Guid? notrequiredNullableUuid = default, DateTime requiredNotNullableDateProp = default, List<string> requiredNotnullableArrayOfString = default, bool requiredNotnullableBooleanProp = default, DateTime requiredNotnullableDatetimeProp = default, RequiredNotnullableEnumIntegerEnum requiredNotnullableEnumInteger = default, RequiredNotnullableEnumIntegerOnlyEnum requiredNotnullableEnumIntegerOnly = default, RequiredNotnullableEnumStringEnum requiredNotnullableEnumString = default, OuterEnumDefaultValue requiredNotnullableOuterEnumDefaultValue = default, string requiredNotnullableStringProp = default, Guid requiredNotnullableUuid = default, int requiredNotnullableintegerProp = default, List<string> requiredNullableArrayOfString = default, bool? requiredNullableBooleanProp = default, DateTime? requiredNullableDateProp = default, DateTime? requiredNullableDatetimeProp = default, RequiredNullableEnumIntegerEnum requiredNullableEnumInteger = default, RequiredNullableEnumIntegerOnlyEnum requiredNullableEnumIntegerOnly = default, RequiredNullableEnumStringEnum requiredNullableEnumString = default, int? requiredNullableIntegerProp = default, OuterEnumDefaultValue requiredNullableOuterEnumDefaultValue = default, string requiredNullableStringProp = default, Guid? requiredNullableUuid = default)
        {
