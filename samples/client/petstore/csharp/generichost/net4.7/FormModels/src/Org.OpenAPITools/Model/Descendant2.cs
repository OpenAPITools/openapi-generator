...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Descendant2 : TestDescendants, IEquatable<Descendant2>, IValidatableObject
    {
        ...
        /// <param name="objectType">objectType (required) (default to TestDescendantsObjectType.Descendant2).</param>
        public Descendant2(string alternativeName = default, string confidentiality = default, TestDescendantsObjectType objectType = TestDescendantsObjectType.Descendant2) : base(alternativeName, objectType)
        {
