...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Order : IValidatableObject
    {
        ...
        [JsonConstructor]
        public Order(Option<bool?> complete = default, Option<long?> id = default, Option<long?> petId = default, Option<int?> quantity = default, Option<DateTime?> shipDate = default, Option<OrderStatus?> status = default)
        {
        ...
        public Option<OrderStatus?> StatusOption { get; private set; }

        /// <summary>
        /// Gets or Sets Status
        /// </summary>
        [JsonPropertyName("status")]
        public OrderStatus? Status { get { return this.StatusOption.Value; } set { this.StatusOption = new Option<OrderStatus?>(value); } }
    ...
    public class OrderJsonConverter : JsonConverter<Order>
    {
        ...
        public void WriteProperties(Utf8JsonWriter writer, Order order, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            {
                var statusRawValue = OrderStatusValueConverter.ToJsonValue(order.Status.Value);
