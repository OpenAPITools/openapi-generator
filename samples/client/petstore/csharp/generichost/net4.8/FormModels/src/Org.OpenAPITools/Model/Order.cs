...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Order : IValidatableObject
    {
        ...
        [JsonConstructor]
        public Order(Option<long?> id = default, Option<long?> petId = default, Option<int?> quantity = default, Option<DateTime?> shipDate = default, Option<OrderStatus?> status = default, Option<bool?> complete = default)
        {
            IdOption = id;
            PetIdOption = petId;
