...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class FormatTest : IEquatable<FormatTest>, IValidatableObject
    {
        ...
        public FormatTest(System.IO.Stream binary = default, byte[] varByte = default, DateTime date = default, DateTime dateTime = default, decimal varDecimal = default, double varDouble = default, float varFloat = default, int int32 = default, int int32Range = default, long int64 = default, int int64Negative = default, int int64NegativeExclusive = default, int int64Positive = default, int int64PositiveExclusive = default, int integer = default, decimal number = default, string password = default, string patternWithBackslash = default, string patternWithDigits = default, string patternWithDigitsAndDelimiter = default, string varString = default, decimal stringFormattedAsDecimal = default, decimal stringFormattedAsDecimalRequired = default, uint unsignedInteger = default, ulong unsignedLong = default, Guid uuid = default)
        {
