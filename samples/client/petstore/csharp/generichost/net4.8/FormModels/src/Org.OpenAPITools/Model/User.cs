...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class User : IEquatable<User>, IValidatableObject
    {
        ...
        public User(Object anyTypeProp = default, Object anyTypePropNullable = default, string email = default, string firstName = default, long id = default, string lastName = default, Object objectWithNoDeclaredProps = default, Object objectWithNoDeclaredPropsNullable = default, string password = default, string phone = default, int userStatus = default, string username = default)
        {
