...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Descendant2 : TestDescendants, IEquatable<Descendant2>, IValidatableObject
    {
        ...
        public Descendant2(string alternativeName = default, string confidentiality = default, ObjectTypeEnum objectType = ObjectTypeEnum.Descendant2) : base(alternativeName, objectType)
        {
