    ...
    public static partial class ClientUtils
    {
        ...
        public static string ParameterToString(object obj, string format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is RequiredClassRequiredNotnullableEnumIntegerOnly requiredClassRequiredNotnullableEnumIntegerOnly)
                return RequiredClassRequiredNotnullableEnumIntegerOnlyValueConverter.ToJsonValue(requiredClassRequiredNotnullableEnumIntegerOnly).ToString();
            if (obj is RequiredClassRequiredNotnullableEnumString requiredClassRequiredNotnullableEnumString)
                return RequiredClassRequiredNotnullableEnumStringValueConverter.ToJsonValue(requiredClassRequiredNotnullableEnumString);
            if (obj is RequiredClassRequiredNullableEnumInteger requiredClassRequiredNullableEnumInteger)
                return RequiredClassRequiredNullableEnumIntegerValueConverter.ToJsonValue(requiredClassRequiredNullableEnumInteger).ToString();
            if (obj is RequiredClassRequiredNullableEnumIntegerOnly requiredClassRequiredNullableEnumIntegerOnly)
            ...
            if (obj is ZeroBasedEnumClassZeroBasedEnum zeroBasedEnumClassZeroBasedEnum)
                return ZeroBasedEnumClassZeroBasedEnumValueConverter.ToJsonValue(zeroBasedEnumClassZeroBasedEnum);
