...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Descendant1 : TestDescendants, IEquatable<Descendant1>, IValidatableObject
    {
        ...
        /// <param name="objectType">objectType (required) (default to TestDescendantsObjectType.Descendant1).</param>
        public Descendant1(string alternativeName = default, string descendantName = default, TestDescendantsObjectType objectType = TestDescendantsObjectType.Descendant1) : base(alternativeName, objectType)
        {
