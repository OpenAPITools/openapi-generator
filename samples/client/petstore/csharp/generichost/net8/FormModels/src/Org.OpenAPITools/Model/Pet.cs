...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Pet : IValidatableObject
    {
        ...
        [JsonConstructor]
        public Pet(string name, List<string> photoUrls, Option<long?> id = default, Option<Category> category = default, Option<List<Tag>> tags = default, Option<PetStatus?> status = default)
        {
            Name = name;
            PhotoUrls = photoUrls;
            IdOption = id;
