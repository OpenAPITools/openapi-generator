...
namespace Org.OpenAPITools.Api
{
    ...
    public sealed partial class FakeApi : IFakeApi
    {
        ...
        /// <param name="varFloat"></param>
        /// <param name="varString"></param>
        public virtual void AfterTestEndpointParameters(ref bool suppressDefaultLog, ITestEndpointParametersApiResponse apiResponseLocalVar, decimal number, string patternWithoutDelimiter, byte[] varByte, double varDouble, Option<System.IO.Stream> binary, Option<string> callback, Option<DateOnly> date, Option<DateTime> dateTime, Option<int> int32, Option<long> int64, Option<int> integer, Option<string> password, Option<float> varFloat, Option<string> varString) { }
