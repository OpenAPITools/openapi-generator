...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Descendant1 : TestDescendants, IEquatable<Descendant1>, IValidatableObject
    {
        ...
        public Descendant1(string alternativeName = default, string descendantName = default, ObjectTypeEnum objectType = ObjectTypeEnum.Descendant1) : base(alternativeName, objectType)
        {
