...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Pet : IEquatable<Pet>, IValidatableObject
    {
        ...
        public Pet(Category category = default, long id = default, string name = default, List<string> photoUrls = default, StatusEnum? status = default, List<Tag> tags = default)
        {
