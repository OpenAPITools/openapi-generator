...
namespace Org.OpenAPITools.Api
{
    ...
    /// </summary>
    public interface IRootGetApiResponse : Org.OpenAPITools.Client.IApiResponse, IOk<Org.OpenAPITools.Model.Response?>
    {
        /// <summary>
    ...
    public sealed partial class DefaultApi : IDefaultApi
    {
        ...
        public partial class RootGetApiResponse : Org.OpenAPITools.Client.ApiResponse, IRootGetApiResponse
        {
            ...
            /// </summary>
            /// <returns></returns>
            public Org.OpenAPITools.Model.Response? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<Org.OpenAPITools.Model.Response>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out Org.OpenAPITools.Model.Response? result)
            {
                result = null;
