...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class EnumTest : IEquatable<EnumTest>, IValidatableObject
    {
        ...
        public EnumTest(EnumIntegerEnum? enumInteger = default, EnumIntegerOnlyEnum? enumIntegerOnly = default, EnumNumberEnum? enumNumber = default, EnumStringEnum? enumString = default, EnumStringRequiredEnum enumStringRequired = default, OuterEnum? outerEnum = default, OuterEnumDefaultValue? outerEnumDefaultValue = default, OuterEnumInteger? outerEnumInteger = default, OuterEnumIntegerDefaultValue? outerEnumIntegerDefaultValue = default)
        {
