...
namespace Org.OpenAPITools.Test.Api
{
    ...
    public sealed class DefaultApiTests : ApiTestsBase
    {
        ...
        public async Task HelloWorldPostAsyncTest()
        {
            Client.Option<HelloWorldPostRequest> helloWorldPostRequest = default!;
            await _instance.HelloWorldPostAsync(helloWorldPostRequest);
        }
    }
}
