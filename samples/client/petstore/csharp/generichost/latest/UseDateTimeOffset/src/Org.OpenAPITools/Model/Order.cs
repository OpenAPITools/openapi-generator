...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Order : IValidatableObject
    {
        ...
        [JsonConstructor]
        public Order(Option<bool?> complete = default, Option<long?> id = default, Option<long?> petId = default, Option<int?> quantity = default, Option<DateTimeOffset?> shipDate = default, Option<StatusEnum?> status = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<DateTimeOffset?> ShipDateOption { get; private set; }
    ...
    public class OrderJsonConverter : JsonConverter<Order>
    {
        ...
        public override Order Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<DateTimeOffset?> shipDate = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "quantity":
                            ...
                            break;
                        case "shipDate":
                            shipDate = new Option<DateTimeOffset?>(JsonSerializer.Deserialize<DateTimeOffset>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "status":
