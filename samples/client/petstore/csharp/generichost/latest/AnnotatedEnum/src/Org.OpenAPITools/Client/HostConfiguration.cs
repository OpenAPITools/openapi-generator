...
namespace Org.OpenAPITools.Client
{
    ...
    public partial class HostConfiguration
    {
        ...
        public HostConfiguration(IServiceCollection services)
        {
            ...
            _jsonOptions.Converters.Add(new AnyOfStringArrayOfStringJsonConverter());
            _jsonOptions.Converters.Add(new NumberJsonConverter());
            _jsonOptions.Converters.Add(new NumberNullableJsonConverter());
            _jsonOptions.Converters.Add(new Number2JsonConverter());
            _jsonOptions.Converters.Add(new Number2NullableJsonConverter());
            _jsonOptions.Converters.Add(new OneOfNullAndRefJsonConverter());
            _jsonOptions.Converters.Add(new OneOfNullAndRef2JsonConverter());
            _jsonOptions.Converters.Add(new OneOfNullAndRef3JsonConverter());
            _jsonOptions.Converters.Add(new OneOfNullableTestJsonConverter());
            _jsonOptions.Converters.Add(new ParentJsonConverter());
            _jsonOptions.Converters.Add(new ParentWithOneOfPropertyJsonConverter());
            _jsonOptions.Converters.Add(new ParentWithPluralOneOfPropertyJsonConverter());
            _jsonOptions.Converters.Add(new ParentWithPluralOneOfPropertyNumberJsonConverter());
