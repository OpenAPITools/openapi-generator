...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class OneOfNullableTest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OneOfNullableTest" /> class.
        /// </summary>
        /// <param name="int"></param>
        internal OneOfNullableTest(int @int)
        {
            Int = @int;
            OnCreated();
        }
        ...
        internal OneOfNullableTest(string @string)
        {
            String = @string;
            OnCreated();
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OneOfNullableTest {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    public class OneOfNullableTestJsonConverter : JsonConverter<OneOfNullableTest>
    {
        ...
        public override OneOfNullableTest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (varInt != null)
                return new OneOfNullableTest(varInt.Value);

            if (varString != null)
                return new OneOfNullableTest(varString);

            throw new JsonException();
        }

        /// <summary>
        /// Serializes a <see cref="OneOfNullableTest" />
        /// </summary>
        ...
        /// <summary>
        /// Serializes the properties of <see cref="OneOfNullableTest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="oneOfNullableTest"></param>
        /// <param name="jsonSerializerOptions"></param>
