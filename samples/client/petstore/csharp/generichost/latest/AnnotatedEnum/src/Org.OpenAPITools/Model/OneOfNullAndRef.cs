...
namespace Org.OpenAPITools.Model
{
    ...
    /// OneOfNullAndRef
    /// </summary>
    public partial class OneOfNullAndRef : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OneOfNullAndRef" /> class.
        /// </summary>
        /// <param name="number">number</param>
        [JsonConstructor]
        public OneOfNullAndRef(Option<Number?> number = default)
        {
            NumberOption = number;
            OnCreated();
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OneOfNullAndRef {\n");
    ...
    public partial class OneOfNullAndRefJsonConverter : JsonConverter<OneOfNullAndRef>
    {
        ...
        public override OneOfNullAndRef Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="OneOfNullAndRef" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, OneOfNullAndRef oneOfNullAndRef, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, oneOfNullAndRef, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="OneOfNullAndRef" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="oneOfNullAndRef"></param>
        /// <param name="jsonSerializerOptions"></param>
