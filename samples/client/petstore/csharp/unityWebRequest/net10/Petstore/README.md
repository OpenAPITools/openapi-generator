...
*PetApi* | [**UploadFiles**](PetApi.md#uploadfiles) | **POST** /pet/{petId}/uploadImages | uploads an images
...
## Documentation for Models
 ...
 - [Model.InjectedVendorExtensionsTest](InjectedVendorExtensionsTest.md)
