...
namespace Org.OpenAPITools.Api
{
    ...
    public partial class DefaultApi : IDisposable, IDefaultApi
    {
        ...
        {
            var task = GetCountryWithHttpInfoAsync(country, cancellationToken);
#if UNITY_EDITOR || !UNITY_WEBGL
        ...
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<Object>> GetCountryWithHttpInfoAsync(string country, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var task = this.AsynchronousClient.PostAsync<Object>("/country", localVarRequestOptions, this.Configuration, cancellationToken);
        ...
        {
            var task = OneOfArrayWithHttpInfoAsync(oneOfArrayRequest, cancellationToken);
#if UNITY_EDITOR || !UNITY_WEBGL
            await task.ConfigureAwait(false);
#else
            await task;
        ...
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<Object>> OneOfArrayWithHttpInfoAsync(OneOfArrayRequest oneOfArrayRequest = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var task = this.AsynchronousClient.PostAsync<Object>("/one-of-array", localVarRequestOptions, this.Configuration, cancellationToken);
