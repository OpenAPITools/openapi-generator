...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class DeprecatedObject : IEquatable<DeprecatedObject>
    {
        ...
        public DeprecatedObject(Option<string> name = default(Option<string>))
        {
            // to ensure "name" (not nullable) is not null
            if (name.IsSet && name.Value == null)
            {
                throw new ArgumentNullException("name isn't a nullable property for DeprecatedObject and cannot be null");
            }
            this.Name = name;
        }
