...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Descendant2 : TestDescendants, IEquatable<Descendant2>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as Descendant2);
        }
        ...
        public bool Equals(Descendant2 input)
        {
            ...
            return base.Equals(input) && 
                (
                    this.Confidentiality == input.Confidentiality ||
                    (this.Confidentiality != null &&
                    this.Confidentiality.Equals(input.Confidentiality))
                );
        }
