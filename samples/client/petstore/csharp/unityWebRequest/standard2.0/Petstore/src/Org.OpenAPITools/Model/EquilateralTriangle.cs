...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class EquilateralTriangle : IEquatable<EquilateralTriangle>
    {
        ...
        public EquilateralTriangle(string shapeType = default(string), string triangleType = default(string))
        {
            ...
            if (shapeType == null)
            {
                throw new ArgumentNullException("shapeType isn't a nullable property for EquilateralTriangle and cannot be null");
            }
            // to ensure "triangleType" (not nullable) is not null
            if (triangleType == null)
            {
                throw new ArgumentNullException("triangleType isn't a nullable property for EquilateralTriangle and cannot be null");
            }
