...
export class StoreApi extends BaseAPI {
     ...
     */
    placeOrder({ order }: PlaceOrderRequest): Observable<Order>
    placeOrder({ order }: PlaceOrderRequest, opts?: OperationOpts): Observable<AjaxResponse<Order>>
    placeOrder({ order }: PlaceOrderRequest, opts?: OperationOpts): Observable<Order | AjaxResponse<Order>> {
        throwIfNullOrUndefined(order, 'order', 'placeOrder');
