...
export const PetApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        addPet(pet: Pet, options: RequestOptions): FetchArgs {
            ...
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(pet || {}) : (((pet:any):string) || "");
         ...
         * @throws {RequiredError}
         */
        updatePet(pet: Pet, options: RequestOptions): FetchArgs {
            // verify required parameter 'pet' is not null or undefined
            if (pet === null || pet === undefined) {
...
export type PetApiType = { 
    addPet(pet: Pet, options?: RequestOptions): Promise<Response>,
    ...
    updatePet(pet: Pet, options?: RequestOptions): Promise<Response>,
...
export const StoreApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        placeOrder(order: Order, options: RequestOptions): FetchArgs {
            ...
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(order || {}) : (((order:any):string) || "");
...
export type StoreApiType = { 
    ...
    placeOrder(order: Order, options?: RequestOptions): Promise<Order>,
}
...
export const UserApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createUsersWithArrayInput(user: Array<User>, options: RequestOptions): FetchArgs {
            // verify required parameter 'user' is not null or undefined
            if (user === null || user === undefined) {
         ...
         * @throws {RequiredError}
         */
        createUsersWithListInput(user: Array<User>, options: RequestOptions): FetchArgs {
            // verify required parameter 'user' is not null or undefined
            if (user === null || user === undefined) {
...
export type UserApiType = { 
    createUser(user: User, options?: RequestOptions): Promise<Response>,

    createUsersWithArrayInput(user: Array<User>, options?: RequestOptions): Promise<Response>,

    createUsersWithListInput(user: Array<User>, options?: RequestOptions): Promise<Response>,
    ...
    updateUser(username: string, user: User, options?: RequestOptions): Promise<Response>,
}
