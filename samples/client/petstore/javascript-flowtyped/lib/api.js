...
export var UserApiFetchParamCreator = function UserApiFetchParamCreator(configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createUsersWithArrayInput: function createUsersWithArrayInput(user, options) {
            // verify required parameter 'user' is not null or undefined
            if (user === null || user === undefined) {
...
export var UserApi = function UserApi(configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createUsersWithArrayInput: function createUsersWithArrayInput(user) {
            var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

            var localVarFetchArgs = UserApiFetchParamCreator(configuration).createUsersWithArrayInput(user, options);
            return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then(function (response) {
                if (response.status >= 200 && response.status < 300) {
                    return response;
                } else {
