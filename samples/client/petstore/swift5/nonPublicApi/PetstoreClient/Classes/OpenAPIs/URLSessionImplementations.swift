...
internal class URLSessionRequestBuilder<T>: RequestBuilder<T> {
    ...
    @discardableResult
    override internal func execute(_ apiResponseQueue: DispatchQueue = PetstoreClientAPI.apiResponseQueue, _ completion: @escaping (_ result: Swift.Result<Response<T>, ErrorResponse>) -> Void) -> OpenAPIRequestCancellable {
        ...
        do {
            ...
            requestCancellable.set(task: dataTask)
        } catch {
            apiResponseQueue.async {
