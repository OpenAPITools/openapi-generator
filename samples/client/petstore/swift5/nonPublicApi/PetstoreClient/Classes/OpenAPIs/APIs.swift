...
internal class RequestBuilder<T> {
    ...
    internal let requestCancellable: OpenAPIRequestCancellable = OpenAPIRequestCancellable()
    ...
    @discardableResult
    internal func execute(_ apiResponseQueue: DispatchQueue = PetstoreClientAPI.apiResponseQueue, _ completion: @escaping (_ result: Swift.Result<Response<T>, ErrorResponse>) -> Void) -> OpenAPIRequestCancellable {
