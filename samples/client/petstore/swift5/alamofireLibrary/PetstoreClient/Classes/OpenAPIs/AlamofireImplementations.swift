    ...
    fileprivate func processRequest(request: DataRequest, _ managerId: String, _ apiResponseQueue: DispatchQueue, _ completion: @escaping (_ result: Swift.Result<Response<T>, ErrorResponse>) -> Void) {
        ...
        case is Void.Type:
            validatedRequest.response(queue: apiResponseQueue,
                ...
                case .success:
                    completion(.success(Response(response: voidResponse.response!, decodedResponse: () as! T, body: voidResponse.data)))
    ...
    override fileprivate func processRequest(request: DataRequest, _ managerId: String, _ apiResponseQueue: DispatchQueue, _ completion: @escaping (_ result: Swift.Result<Response<T>, ErrorResponse>) -> Void) {
        ...
        case is String.Type:
            validatedRequest.response(queue: apiResponseQueue,
                ...
                case let .success(value):
                    completion(.success(Response(response: stringResponse.response!, decodedResponse: value as! T, body: stringResponse.data)))
                case let .failure(error):
        ...
        case is URL.Type:
            validatedRequest.response(queue: apiResponseQueue,
                ...
                do {
                    ...
                    completion(.success(Response(response: dataResponse.response!, decodedResponse: filePath as! T, body: data)))
        ...
        case is Data.Type:
            validatedRequest.response(queue: apiResponseQueue,
                ...
                case .success:
                    completion(.success(Response(response: dataResponse.response!, decodedResponse: dataResponse.data as! T, body: dataResponse.data)))
                case let .failure(error):
            ...
            validatedRequest.response(queue: apiResponseQueue,
                ...
                guard let data = dataResponse.data, !data.isEmpty else {
                    if T.self is ExpressibleByNilLiteral.Type {
                        completion(.success(Response(response: httpResponse, decodedResponse: Optional<T>.none as! T, body: dataResponse.data)))
                    } else {
                ...
                case let .success(decodableObj):
                    completion(.success(Response(response: httpResponse, decodedResponse: decodableObj, body: data)))
                case let .failure(error):
