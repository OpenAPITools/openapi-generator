...
# **createUser**
```swift
    internal func createUser(body: User, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
```swift
    internal func createUsersWithArrayInput(body: [User], completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
```swift
    internal func createUsersWithListInput(body: [User], completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
# **deleteUser**
```swift
    internal func deleteUser(username: String, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
# **getUserByName**
```swift
    internal func getUserByName(username: String, completion: @escaping (_ data: User?, _ error: Error?) -> Void)
```
...
# **loginUser**
```swift
    internal func loginUser(username: String, password: String, completion: @escaping (_ data: String?, _ error: Error?) -> Void)
```
...
# **logoutUser**
```swift
    internal func logoutUser(completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
# **updateUser**
```swift
    internal func updateUser(username: String, body: User, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
