...
open class Response<T> {
    ...
    public init(statusCode: Int, header: [String: String], decodedResponse: T, body: Data?) {
    ...
    public convenience init(response: HTTPURLResponse, decodedResponse: T, body: Data?) {
