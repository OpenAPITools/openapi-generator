...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "testEnumParametersBody")]
    public partial class TestEnumParametersBody : IEquatable<TestEnumParametersBody>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TestEnumParametersBody" /> class.
        /// </summary>
        ...
        {
            return OpenAPIClientUtils.compareLogic.Compare(this, input as TestEnumParametersBody).AreEqual;
        }

        /// <summary>
        /// Returns true if TestEnumParametersBody instances are equal
        /// </summary>
        /// <param name="input">Instance of TestEnumParametersBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TestEnumParametersBody input)
        {
