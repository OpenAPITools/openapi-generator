...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ChildCat : IEquatable<ChildCat>, IValidatableObject
    {
        /// <summary>
        /// Defines PetType
        /// </summary>
        ...
        public ChildCat(string name = default(string), PetTypeEnum petType = PetTypeEnum.ChildCat)
        {
