...
namespace Org.OpenAPITools.Model
{
    ...
    [JsonConverter(typeof(NumberOnlyConverter))]
    ...
    /// </summary>
    public class NumberOnlyConverter: JsonConverter
    {
        private readonly Type[] _types;

        /// <summary>
        /// Initializes a new instance of the <see cref="NumberOnlyConverter" /> class.
        /// </summary>
        /// <param name="types">Types.</param>
        public NumberOnlyConverter(params Type[] types)
        {
            _types = types;
        }
        ...
        /// <summary>
        /// Function to convert JSON string into NumberOnly 
        /// </summary>
        /// <param name="reader">Json Reader</param>
        /// <param name="objectType">Object type</param>
        /// <param name="existingValue">Input be serialized</param>
        /// <param name="serializer">Json Serializer</param>
        /// <returns>An instance of NumberOnly serialized from the JSON string</returns>
