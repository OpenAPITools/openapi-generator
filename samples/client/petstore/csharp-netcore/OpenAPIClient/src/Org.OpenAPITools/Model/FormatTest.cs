...
namespace Org.OpenAPITools.Model
{
    ...
    [JsonConverter(typeof(FormatTestConverter))]
    ...
    /// </summary>
    public class FormatTestConverter: JsonConverter
    {
        private readonly Type[] _types;

        /// <summary>
        /// Initializes a new instance of the <see cref="FormatTestConverter" /> class.
        /// </summary>
        /// <param name="types">Types.</param>
        public FormatTestConverter(params Type[] types)
        {
            _types = types;
        }
        ...
        /// <summary>
        /// Function to convert JSON string into FormatTest 
        /// </summary>
        /// <param name="reader">Json Reader</param>
        /// <param name="objectType">Object type</param>
        /// <param name="existingValue">Input be serialized</param>
        /// <param name="serializer">Json Serializer</param>
        /// <returns>An instance of FormatTest serialized from the JSON string</returns>
