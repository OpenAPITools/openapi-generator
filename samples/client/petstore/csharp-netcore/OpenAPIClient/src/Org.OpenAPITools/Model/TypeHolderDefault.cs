...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class TypeHolderDefault :  IEquatable<TypeHolderDefault>, IValidatableObject
    {
        ...
        public TypeHolderDefault(string stringItem = "what", decimal numberItem = default(decimal), int integerItem = default(int), bool boolItem = true, List<int> arrayItem = default(List<int>))
        {
            ...
            this.NumberItem = numberItem ?? throw new ArgumentNullException("numberItem is a required property for TypeHolderDefault and cannot be null");;
            // to ensure "integerItem" is required (not null)
            this.IntegerItem = integerItem ?? throw new ArgumentNullException("integerItem is a required property for TypeHolderDefault and cannot be null");;
            // to ensure "boolItem" is required (not null)
            this.BoolItem = boolItem ?? throw new ArgumentNullException("boolItem is a required property for TypeHolderDefault and cannot be null");;
