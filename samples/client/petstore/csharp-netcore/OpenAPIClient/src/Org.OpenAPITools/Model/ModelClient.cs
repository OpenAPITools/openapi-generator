...
namespace Org.OpenAPITools.Model
{
    ...
    [JsonConverter(typeof(ModelClientConverter))]
    ...
    /// </summary>
    public class ModelClientConverter: JsonConverter
    {
        private readonly Type[] _types;

        /// <summary>
        /// Initializes a new instance of the <see cref="ModelClientConverter" /> class.
        /// </summary>
        /// <param name="types">Types.</param>
        public ModelClientConverter(params Type[] types)
        {
            _types = types;
        }
        ...
        /// <summary>
        /// Function to convert JSON string into ModelClient 
        /// </summary>
        /// <param name="reader">Json Reader</param>
        /// <param name="objectType">Object type</param>
        /// <param name="existingValue">Input be serialized</param>
        /// <param name="serializer">Json Serializer</param>
        /// <returns>An instance of ModelClient serialized from the JSON string</returns>
