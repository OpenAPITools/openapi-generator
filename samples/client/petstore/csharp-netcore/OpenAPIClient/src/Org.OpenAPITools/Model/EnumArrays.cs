...
namespace Org.OpenAPITools.Model
{
    ...
    [JsonConverter(typeof(EnumArraysConverter))]
    ...
    /// </summary>
    public class EnumArraysConverter: JsonConverter
    {
        private readonly Type[] _types;

        /// <summary>
        /// Initializes a new instance of the <see cref="EnumArraysConverter" /> class.
        /// </summary>
        /// <param name="types">Types.</param>
        public EnumArraysConverter(params Type[] types)
        {
            _types = types;
        }
        ...
        /// <summary>
        /// Function to convert JSON string into EnumArrays 
        /// </summary>
        /// <param name="reader">Json Reader</param>
        /// <param name="objectType">Object type</param>
        /// <param name="existingValue">Input be serialized</param>
        /// <param name="serializer">Json Serializer</param>
        /// <returns>An instance of EnumArrays serialized from the JSON string</returns>
