...
namespace Org.OpenAPITools.Model
{
    ...
    [JsonConverter(typeof(DogAllOfConverter))]
    ...
    /// </summary>
    public class DogAllOfConverter: JsonConverter
    {
        private readonly Type[] _types;

        /// <summary>
        /// Initializes a new instance of the <see cref="DogAllOfConverter" /> class.
        /// </summary>
        /// <param name="types">Types.</param>
        public DogAllOfConverter(params Type[] types)
        {
            _types = types;
        }
        ...
        /// <summary>
        /// Function to convert JSON string into DogAllOf 
        /// </summary>
        /// <param name="reader">Json Reader</param>
        /// <param name="objectType">Object type</param>
        /// <param name="existingValue">Input be serialized</param>
        /// <param name="serializer">Json Serializer</param>
        /// <returns>An instance of DogAllOf serialized from the JSON string</returns>
