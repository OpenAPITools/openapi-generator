...
namespace Org.OpenAPITools.Model
{
    ...
    [JsonConverter(typeof(InlineObject3Converter))]
    ...
    /// </summary>
    public class InlineObject3Converter: JsonConverter
    {
        private readonly Type[] _types;

        /// <summary>
        /// Initializes a new instance of the <see cref="InlineObject3Converter" /> class.
        /// </summary>
        /// <param name="types">Types.</param>
        public InlineObject3Converter(params Type[] types)
        {
            _types = types;
        }
        ...
        /// <summary>
        /// Function to convert JSON string into InlineObject3 
        /// </summary>
        /// <param name="reader">Json Reader</param>
        /// <param name="objectType">Object type</param>
        /// <param name="existingValue">Input be serialized</param>
        /// <param name="serializer">Json Serializer</param>
        /// <returns>An instance of InlineObject3 serialized from the JSON string</returns>
