...
namespace Org.OpenAPITools.Api
{
    ...
    public interface IDefaultApiSync : IApiAccessor
    {
        ...
        ApiResponse<InlineResponseDefault> FooGetResponse();
    ...
    public interface IDefaultApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponseDefault>> FooGetResponseAsync(System.Threading.CancellationToken? cancellationToken = null);
    ...
    public partial class DefaultApi : IDefaultApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        public DefaultApi(System.Net.Http.HttpClient httpClient, Newtonsoft.Json.JsonConverter[] jsonConverters) : this((string)null)
        {
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<InlineResponseDefault> localVarResponse = FooGetResponse();
        ...
        /// <exception cref="Org.OpenAPITools.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of InlineResponseDefault</returns>
        public Org.OpenAPITools.Client.ApiResponse<InlineResponseDefault> FooGetResponse()
        {
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<InlineResponseDefault> localVarResponse = await FooGetResponseAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }

        private System.Threading.Tasks.ValueTask ValidateFooGetRequestAsync(System.Threading.CancellationToken? cancellationToken)
        {
            // todo
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InlineResponseDefault)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<InlineResponseDefault>> FooGetResponseAsync(System.Threading.CancellationToken? cancellationToken = null)
        {

            await ValidateFooGetRequestAsync(cancellationToken);
            ...
            if (_httpClient != null)
            {
                ...
                if (!responseMessage.IsSuccessStatusCode)
                    throw new ApiException<InlineResponseDefault>(apiResponse);
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<InlineResponseDefault>("/foo", localVarRequestOptions, this.Configuration, cancellationToken.GetValueOrDefault()).ConfigureAwait(false);
