...
namespace Org.OpenAPITools.Api
{
    ...
    public partial class AnotherFakeApi : IDisposable, IAnotherFakeApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        public AnotherFakeApi(HttpClient client = null, HttpClientHandler handler = null) : this((string)null, client, handler)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public AnotherFakeApi(String basePath, HttpClient client = null, HttpClientHandler handler = null)
        {
        ...
        /// <returns></returns>
        public AnotherFakeApi(Org.OpenAPITools.Client.Configuration configuration, HttpClient client = null, HttpClientHandler handler = null)
        {
