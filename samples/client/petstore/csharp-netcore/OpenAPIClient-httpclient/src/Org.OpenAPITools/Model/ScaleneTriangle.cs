...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ScaleneTriangle : IEquatable<ScaleneTriangle>, IValidatableObject
    {
        ...
        public ScaleneTriangle(string shapeType, string triangleType)
        {
            ...
            ShapeType = shapeType ?? throw new ArgumentNullException("shapeType is a required property for ScaleneTriangle and cannot be null");

            // to ensure "triangleType" is required (not null)
            TriangleType = triangleType ?? throw new ArgumentNullException("triangleType is a required property for ScaleneTriangle and cannot be null");
