...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SimpleQuadrilateral : IEquatable<SimpleQuadrilateral>, IValidatableObject
    {
        ...
        public SimpleQuadrilateral(string shapeType, string quadrilateralType)
        {
            ...
            ShapeType = shapeType ?? throw new ArgumentNullException("shapeType is a required property for SimpleQuadrilateral and cannot be null");

            // to ensure "quadrilateralType" is required (not null)
            QuadrilateralType = quadrilateralType ?? throw new ArgumentNullException("quadrilateralType is a required property for SimpleQuadrilateral and cannot be null");
