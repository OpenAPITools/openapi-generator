...
namespace Org.OpenAPITools.Api
{
    ...
    public partial class AnotherFakeApi : IAnotherFakeApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        public AnotherFakeApi(ILogger<AnotherFakeApi> logger, HttpClient httpClient, IEventHub eventHub, JsonSerializerOptionsProvider jsonSerializerOptionsProvider, 
        ...
        /// <param name="modelClient"></param>
        public virtual void AfterCall123TestSpecialTags(ApiResponse<ModelClient?> apiResponse, ModelClient modelClient)
        {
        }
            ...
            try
            {
                ...
                using (HttpRequestMessage request = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage responseMessage = await HttpClient.SendAsync(request, cancellationToken.GetValueOrDefault()).ConfigureAwait(false))
                    {
                        ...
                        OnApiResponded(new ApiResponseEventArgs(requestedAt, DateTime.UtcNow, responseMessage.StatusCode, "/another-fake/dummy"));
