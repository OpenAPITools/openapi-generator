...
#pragma warning restore CS8073 // The result of the expression is always the same since a value of this type is never equal to 'null'
    ...
    public class QuadrilateralInterfaceJsonConverter : JsonConverter<QuadrilateralInterface>
    {
        ...
        /// <returns></returns>
        public override bool CanConvert(Type typeToConvert) => typeof(QuadrilateralInterface).IsAssignableFrom(typeToConvert);
        ...
        {
            JsonSerializer.Serialize(writer, quadrilateralInterface);
        }
    }
}
