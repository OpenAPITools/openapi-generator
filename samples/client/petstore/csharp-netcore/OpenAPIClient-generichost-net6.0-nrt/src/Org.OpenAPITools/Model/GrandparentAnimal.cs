...
#pragma warning restore CS8073 // The result of the expression is always the same since a value of this type is never equal to 'null'
    ...
    public class GrandparentAnimalJsonConverter : JsonConverter<GrandparentAnimal>
    {
        ...
        /// <returns></returns>
        public override bool CanConvert(Type typeToConvert) => typeof(GrandparentAnimal).IsAssignableFrom(typeToConvert);
        ...
        {
            JsonSerializer.Serialize(writer, grandparentAnimal);
        }
    }
}
