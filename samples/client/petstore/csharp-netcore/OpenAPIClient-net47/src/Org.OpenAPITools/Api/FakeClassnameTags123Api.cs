...
namespace Org.OpenAPITools.Api
{
    ...
    public interface IFakeClassnameTags123ApiSync : IApiAccessor
    {
        ...
        ModelClient TestClassname(ModelClient modelClient, Org.OpenAPITools.Client.RequestOptions localVarRequestOptions = default(Org.OpenAPITools.Client.RequestOptions));
        ...
        ApiResponse<ModelClient> TestClassnameWithHttpInfo(ModelClient modelClient, Org.OpenAPITools.Client.RequestOptions localVarRequestOptions = default(Org.OpenAPITools.Client.RequestOptions));
    ...
    public interface IFakeClassnameTags123ApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ModelClient> TestClassnameAsync(ModelClient modelClient, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), Org.OpenAPITools.Client.RequestOptions localVarRequestOptions = default(Org.OpenAPITools.Client.RequestOptions));
        ...
        System.Threading.Tasks.Task<ApiResponse<ModelClient>> TestClassnameWithHttpInfoAsync(ModelClient modelClient, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), Org.OpenAPITools.Client.RequestOptions localVarRequestOptions = default(Org.OpenAPITools.Client.RequestOptions));
    ...
    public partial class FakeClassnameTags123Api : IFakeClassnameTags123Api
    {
        ...
        /// <param name="localVarRequestOptions"></param>
        /// <returns>ModelClient</returns>
        public ModelClient TestClassname(ModelClient modelClient, Org.OpenAPITools.Client.RequestOptions localVarRequestOptions = default(Org.OpenAPITools.Client.RequestOptions))
        {
            Org.OpenAPITools.Client.ApiResponse<ModelClient> localVarResponse = TestClassnameWithHttpInfo(modelClient, localVarRequestOptions);
        ...
        /// <param name="localVarRequestOptions"></param>
        /// <returns>ApiResponse of ModelClient</returns>
        public Org.OpenAPITools.Client.ApiResponse<ModelClient> TestClassnameWithHttpInfo(ModelClient modelClient, Org.OpenAPITools.Client.RequestOptions localVarRequestOptions = default(Org.OpenAPITools.Client.RequestOptions))
        {
        ...
        /// <param name="localVarRequestOptions"></param>
        /// <returns>Task of ModelClient</returns>
        public async System.Threading.Tasks.Task<ModelClient> TestClassnameAsync(ModelClient modelClient, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), Org.OpenAPITools.Client.RequestOptions localVarRequestOptions = default(Org.OpenAPITools.Client.RequestOptions))
        {
            Org.OpenAPITools.Client.ApiResponse<ModelClient> localVarResponse = await TestClassnameWithHttpInfoAsync(modelClient, cancellationToken, localVarRequestOptions).ConfigureAwait(false);
            return localVarResponse.Data;
        }
