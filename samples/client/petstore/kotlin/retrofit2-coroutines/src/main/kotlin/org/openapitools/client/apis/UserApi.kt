...
interface UserApi {
    ...
    * @return [Unit]
    ...
    suspend fun createUsersWithArrayInput(@Body body: kotlin.Array<User>): Response<Unit>
    ...
    * @return [Unit]
    ...
    suspend fun createUsersWithListInput(@Body body: kotlin.Array<User>): Response<Unit>
