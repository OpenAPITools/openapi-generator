...
class FakeApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    fun getParameterNameMapping(type: kotlin.Long, type2: kotlin.String, type3: kotlin.String, httpDebugOption: kotlin.String) : Unit {
    ...
    fun getParameterNameMappingWithHttpInfo(type: kotlin.Long, type2: kotlin.String, type3: kotlin.String, httpDebugOption: kotlin.String) : ApiResponse<Unit?> {
    ...
    fun getParameterNameMappingRequestConfig(type: kotlin.Long, type2: kotlin.String, type3: kotlin.String, httpDebugOption: kotlin.String) : RequestConfig<Unit> {
        ...
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                put("type", listOf(type2.toString()))
                put("http_debug_option", listOf(httpDebugOption.toString()))
            }
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        type.apply { localVariableHeaders["_type"] = this.toString() }
        type3.apply { localVariableHeaders["type_"] = this.toString() }
