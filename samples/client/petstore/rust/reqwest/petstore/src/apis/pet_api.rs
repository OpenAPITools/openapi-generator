...
#[async_trait]
pub trait PetApi {
    async fn add_pet(&self, body: crate::models::Pet) -> Result<(), Error>;
    async fn delete_pet(&self, pet_id: i64, api_key: Option<&str>) -> Result<(), Error>;
    async fn find_pets_by_status(&self, status: Vec<String>) -> Result<Vec<crate::models::Pet>, Error>;
    ...
    async fn update_pet_with_form(&self, pet_id: i64, name: Option<&str>, status: Option<&str>) -> Result<(), Error>;
    async fn upload_file(&self, pet_id: i64, additional_metadata: Option<&str>, file: Option<std::path::PathBuf>) -> Result<crate::models::ApiResponse, Error>;
}
