...
/// 
pub fn add_pet(configuration: &configuration::Configuration, pet: models::Pet) -> Result<crate::models::Pet, Error<AddPetError>> {
...
/// 
pub fn update_pet(configuration: &configuration::Configuration, pet: models::Pet) -> Result<crate::models::Pet, Error<UpdatePetError>> {
    let local_var_configuration = configuration;
