...
pub async fn tests_deep_object_free_form_query_param_get(configuration: &configuration::Configuration, scope: Option<std::collections::HashMap<String, String>>, filter: Option<std::collections::HashMap<String, String>>, extra: Option<models::serde_json::Value>) -> Result<(), Error<TestsDeepObjectFreeFormQueryParamGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
