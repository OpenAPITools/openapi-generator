# Rust API client for petstore-reqwest-model-prefix
...
Put the package under your project folder in a directory named `petstore-reqwest-model-prefix` and add the following to `Cargo.toml` under `[dependencies]`:

```
petstore-reqwest-model-prefix = { path = "./petstore-reqwest-model-prefix" }
```
