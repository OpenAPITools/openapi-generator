...
pub trait PetApi {
    fn add_pet(&self, pet: crate::models::Pet) -> Pin<Box<dyn Future<Output = Result<models::Pet, Error>>>>;
    ...
    fn update_pet(&self, pet: crate::models::Pet) -> Pin<Box<dyn Future<Output = Result<models::Pet, Error>>>>;
