...
pub trait PetApi {
    fn add_pet(&self, pet: models::Pet) -> Pin<Box<dyn Future<Output = Result<crate::models::Pet, Error>>>>;
    ...
    fn update_pet(&self, pet: models::Pet) -> Pin<Box<dyn Future<Output = Result<crate::models::Pet, Error>>>>;
