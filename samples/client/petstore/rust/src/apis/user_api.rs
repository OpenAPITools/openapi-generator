...
pub trait UserApi {
    fn create_user(&self, user: crate::models::User) -> Box<Future<Item = (), Error = Error<serde_json::Value>>>;
    fn create_users_with_array_input(&self, user: Vec<crate::models::User>) -> Box<Future<Item = (), Error = Error<serde_json::Value>>>;
    fn create_users_with_list_input(&self, user: Vec<crate::models::User>) -> Box<Future<Item = (), Error = Error<serde_json::Value>>>;
    ...
    fn update_user(&self, username: &str, user: crate::models::User) -> Box<Future<Item = (), Error = Error<serde_json::Value>>>;
}
