...
pub trait PetApi {
    fn add_pet(&self, pet: crate::models::Pet) -> Box<dyn Future<Item = (), Error = Error<serde_json::Value>>>;
    ...
    fn update_pet(&self, pet: crate::models::Pet) -> Box<dyn Future<Item = (), Error = Error<serde_json::Value>>>;
