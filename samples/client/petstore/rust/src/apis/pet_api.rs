...
pub trait PetApi {
    fn add_pet(&self, pet: crate::models::Pet) -> Box<dyn Future<Output = Result<(), Error<serde_json::Value>>>+Unpin>;
    fn delete_pet(&self, pet_id: i64, api_key: Option<&str>) -> Box<dyn Future<Output = Result<(), Error<serde_json::Value>>>+Unpin>;
    fn find_pets_by_status(&self, status: Vec<String>) -> Box<dyn Future<Output = Result<Vec<crate::models::Pet>, Error<serde_json::Value>>>+Unpin>;
    fn find_pets_by_tags(&self, tags: Vec<String>) -> Box<dyn Future<Output = Result<Vec<crate::models::Pet>, Error<serde_json::Value>>>+Unpin>;
    fn get_pet_by_id(&self, pet_id: i64) -> Box<dyn Future<Output = Result<crate::models::Pet, Error<serde_json::Value>>>+Unpin>;
    fn update_pet(&self, pet: crate::models::Pet) -> Box<dyn Future<Output = Result<(), Error<serde_json::Value>>>+Unpin>;
    fn update_pet_with_form(&self, pet_id: i64, name: Option<&str>, status: Option<&str>) -> Box<dyn Future<Output = Result<(), Error<serde_json::Value>>>+Unpin>;
    fn upload_file(&self, pet_id: i64, additional_metadata: Option<&str>, file: Option<std::path::PathBuf>) -> Box<dyn Future<Output = Result<crate::models::ApiResponse, Error<serde_json::Value>>>+Unpin>;
}
