...
<dependency>
  ...
  <artifactId>scala-pekko-petstore-client</artifactId>
...
```groovy
compile "org.openapitools:scala-pekko-petstore-client:1.0.0"
```

### SBT users

```scala
libraryDependencies += "org.openapitools" % "scala-pekko-petstore-client" % "1.0.0"
```
