...
class StoreApi
{
     ...
     * @return \OpenAPI\Client\Model\Order
     */
    public function placeOrder($body, string $contentType = self::contentTypes['placeOrder'][0])
    {
        list($response) = $this->placeOrderWithHttpInfo($body, $contentType);
        return $response;
    }
     ...
     * @return array of \OpenAPI\Client\Model\Order, HTTP status code, HTTP response headers (array of strings)
     */
    public function placeOrderWithHttpInfo($body, string $contentType = self::contentTypes['placeOrder'][0])
    {
        $request = $this->placeOrderRequest($body, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function placeOrderAsync($body, string $contentType = self::contentTypes['placeOrder'][0])
    {
        return $this->placeOrderAsyncWithHttpInfo($body, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function placeOrderAsyncWithHttpInfo($body, string $contentType = self::contentTypes['placeOrder'][0])
    {
        $returnType = '\OpenAPI\Client\Model\Order';
        $request = $this->placeOrderRequest($body, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function placeOrderRequest($body, string $contentType = self::contentTypes['placeOrder'][0])
    {
