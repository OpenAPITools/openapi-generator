...
*FakeApi* | [**fakeUnsupportedSchemeTest**](docs/Api/FakeApi.md#fakeunsupportedschemetest) | **GET** /fake/unsupported-scheme-test | test behavior with unsupported http scheme only
