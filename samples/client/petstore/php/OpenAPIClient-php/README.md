...
*FakeApi* | [**testMixedPropertiesAndAdditionalProperties**](docs/Api/FakeApi.md#testmixedpropertiesandadditionalproperties) | **POST** /fake/body-mixedPropertiesAndAdditionalProperties | test mixed properties and additionalProperties
