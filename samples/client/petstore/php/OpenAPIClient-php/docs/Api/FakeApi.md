...
> testEndpointEnumsLengthOne($query_integer, $query_string, $path_string, $path_integer, $header_number)
...
$path_integer = 56; // int | 
$header_number = 3.4; // double | 

try {
    $apiInstance->testEndpointEnumsLengthOne($query_integer, $query_string, $path_string, $path_integer, $header_number);
} catch (Exception $e) {
    echo 'Exception when calling FakeApi->testEndpointEnumsLengthOne: ', $e->getMessage(), PHP_EOL;
}
?>
```
