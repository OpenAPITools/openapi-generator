...
class MapTest implements ModelInterface, ArrayAccess
{
    ...
    {
        return [self::MAP_OF_ENUM_STRING_UPPER, self::MAP_OF_ENUM_STRING_LOWER];
    }
    ...
    {
        $this->container['map_map_of_string'] = isset(
            $data['map_map_of_string']
        )
            ? $data['map_map_of_string']
            : null;
        $this->container['map_of_enum_string'] = isset(
            $data['map_of_enum_string']
        )
            ? $data['map_of_enum_string']
            : null;
        $this->container['direct_map'] = isset($data['direct_map'])
            ? $data['direct_map']
            : null;
        $this->container['indirect_map'] = isset($data['indirect_map'])
            ? $data['indirect_map']
            : null;
    }
    ...
    public function setMapOfEnumString($map_of_enum_string)
    {
        ...
        if (
            !is_null($map_of_enum_string) &&
            array_diff($map_of_enum_string, $allowedValues)
        ) {
