...
class EnumArrays implements ModelInterface, ArrayAccess
{
    ...
    {
        return [self::ARRAY_ENUM_FISH, self::ARRAY_ENUM_CRAB];
    }
    ...
    {
        $this->container['just_symbol'] = isset($data['just_symbol'])
            ? $data['just_symbol']
            : null;
        $this->container['array_enum'] = isset($data['array_enum'])
            ? $data['array_enum']
            : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (
            !is_null($this->container['just_symbol']) &&
            !in_array($this->container['just_symbol'], $allowedValues, true)
        ) {
    ...
    public function setJustSymbol($just_symbol)
    {
        ...
        if (
            !is_null($just_symbol) &&
            !in_array($just_symbol, $allowedValues, true)
        ) {
