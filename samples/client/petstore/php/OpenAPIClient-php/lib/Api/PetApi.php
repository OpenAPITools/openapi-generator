...
class PetApi
{
    ...
    {
        return $this->addPetAsyncWithHttpInfo($pet)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    {
        return $this->deletePetAsyncWithHttpInfo($pet_id, $api_key)->then(
            function ($response) {
                return $response[0];
            }
        );
    ...
    protected function deletePetRequest($pet_id, $api_key = null)
    {
        ...
        // header params
        if ($api_key !== null) {
            $headerParams['api_key'] = ObjectSerializer::toHeaderValue(
                $api_key
            );
        }
    ...
    {
        return $this->findPetsByStatusAsyncWithHttpInfo($status)->then(
            function ($response) {
                return $response[0];
            }
        );
    ...
    protected function findPetsByStatusRequest($status)
    {
        ...
        // query params
        if (is_array($status)) {
            $status = ObjectSerializer::serializeCollection(
                $status,
                'csv',
                true
            );
    ...
    {
        return $this->findPetsByTagsAsyncWithHttpInfo($tags)->then(function (
            $response
        ) {
            return $response[0];
        });
    ...
    {
        return $this->getPetByIdAsyncWithHttpInfo($pet_id)->then(function (
            $response
        ) {
            return $response[0];
        });
    ...
    {
        return $this->updatePetAsyncWithHttpInfo($pet)->then(function (
            $response
        ) {
            return $response[0];
        });
    ...
    public function updatePetWithFormAsync(
        ...
        return $this->updatePetWithFormAsyncWithHttpInfo(
            $pet_id,
            $name,
            $status
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updatePetWithFormRequest(
        $pet_id,
        $name = null,
        $status = null
    ) {
    ...
    public function uploadFile(
        ...
        list($response) = $this->uploadFileWithHttpInfo(
            $pet_id,
            $additional_metadata,
            $file
        );
    ...
    public function uploadFileWithHttpInfo(
        ...
        $request = $this->uploadFileRequest(
            $pet_id,
            $additional_metadata,
            $file
        );
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if (
                        '\OpenAPI\Client\Model\ApiResponse' === '\SplFileObject'
                    ) {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
    ...
    public function uploadFileAsync(
        ...
        return $this->uploadFileAsyncWithHttpInfo(
            $pet_id,
            $additional_metadata,
            $file
        )->then(function ($response) {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function uploadFileRequest(
        $pet_id,
        $additional_metadata = null,
        $file = null
    ) {
        ...
        if ($additional_metadata !== null) {
            $formParams['additionalMetadata'] = ObjectSerializer::toFormValue(
                $additional_metadata
            );
        }
        // form params
    ...
    public function uploadFileWithRequiredFile(
        ...
        list($response) = $this->uploadFileWithRequiredFileWithHttpInfo(
            $pet_id,
            $required_file,
            $additional_metadata
        );
    ...
    public function uploadFileWithRequiredFileWithHttpInfo(
        ...
        $request = $this->uploadFileWithRequiredFileRequest(
            $pet_id,
            $required_file,
            $additional_metadata
        );
    ...
    public function uploadFileWithRequiredFileAsync(
        ...
        return $this->uploadFileWithRequiredFileAsyncWithHttpInfo(
            $pet_id,
            $required_file,
            $additional_metadata
        )->then(function ($response) {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function uploadFileWithRequiredFileRequest(
        $pet_id,
        $required_file,
        $additional_metadata = null
    ) {
        ...
        if (
            $required_file === null ||
            (is_array($required_file) && count($required_file) === 0)
        ) {
            throw new \InvalidArgumentException(
        ...
        if ($required_file !== null) {
            ...
            $formParams['requiredFile'] = \GuzzleHttp\Psr7\try_fopen(
                ObjectSerializer::toFormValue($required_file),
                'rb'
            );
        }
        // body params
