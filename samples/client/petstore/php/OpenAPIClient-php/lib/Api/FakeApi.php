...
/**
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['fakeUnsupportedSchemeTest'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function fakeUnsupportedSchemeTest($pet, $query_1 = null, $header_1 = null, string $contentType = self::contentTypes['fakeUnsupportedSchemeTest'][0])
    {
        $this->fakeUnsupportedSchemeTestWithHttpInfo($pet, $query_1, $header_1, $contentType);
    }

    /**
     * Operation fakeUnsupportedSchemeTestWithHttpInfo
     *
     * test behavior with unsupported http scheme only
     *
     * @param  \OpenAPI\Client\Model\Pet $pet Pet object that needs to be added to the store (required)
     ...
     */
    public function fakeUnsupportedSchemeTestWithHttpInfo($pet, $query_1 = null, $header_1 = null, string $contentType = self::contentTypes['fakeUnsupportedSchemeTest'][0])
    {
        $request = $this->fakeUnsupportedSchemeTestRequest($pet, $query_1, $header_1, $contentType);
    ...
    /**
     * Operation fakeUnsupportedSchemeTestAsync
     *
     * test behavior with unsupported http scheme only
     *
     * @param  \OpenAPI\Client\Model\Pet $pet Pet object that needs to be added to the store (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function fakeUnsupportedSchemeTestAsync($pet, $query_1 = null, $header_1 = null, string $contentType = self::contentTypes['fakeUnsupportedSchemeTest'][0])
    {
        return $this->fakeUnsupportedSchemeTestAsyncWithHttpInfo($pet, $query_1, $header_1, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation fakeUnsupportedSchemeTestAsyncWithHttpInfo
     *
     * test behavior with unsupported http scheme only
     *
     * @param  \OpenAPI\Client\Model\Pet $pet Pet object that needs to be added to the store (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function fakeUnsupportedSchemeTestAsyncWithHttpInfo($pet, $query_1 = null, $header_1 = null, string $contentType = self::contentTypes['fakeUnsupportedSchemeTest'][0])
    {
        $returnType = '';
        $request = $this->fakeUnsupportedSchemeTestRequest($pet, $query_1, $header_1, $contentType);
    ...
    /**
     * Create request for operation 'fakeUnsupportedSchemeTest'
     *
     * @param  \OpenAPI\Client\Model\Pet $pet Pet object that needs to be added to the store (required)
     * @param  string $query_1 query parameter (optional)
     * @param  string $header_1 header parameter (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function fakeUnsupportedSchemeTestRequest($pet, $query_1 = null, $header_1 = null, string $contentType = self::contentTypes['fakeUnsupportedSchemeTest'][0])
    {

        // verify the required parameter 'pet' is set
        if ($pet === null || (is_array($pet) && count($pet) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $pet when calling fakeUnsupportedSchemeTest'
            );
        }
        ...
        $resourcePath = '/fake/unsupported-scheme-test';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
