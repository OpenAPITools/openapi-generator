...
class FakeApi
{
     ...
     *
     * @param  \OpenAPI\Client\Model\MixedPropertiesAndAdditionalPropertiesClass $param request body (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\MixedPropertiesAndAdditionalPropertiesClass
     */
    public function testMixedPropertiesAndAdditionalProperties($param)
    {
        list($response) = $this->testMixedPropertiesAndAdditionalPropertiesWithHttpInfo($param);
        return $response;
    }

    /**
     * Operation testMixedPropertiesAndAdditionalPropertiesWithHttpInfo
     *
     * test mixed properties and additionalProperties
     *
     * @param  \OpenAPI\Client\Model\MixedPropertiesAndAdditionalPropertiesClass $param request body (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\MixedPropertiesAndAdditionalPropertiesClass, HTTP status code, HTTP response headers (array of strings)
     */
    public function testMixedPropertiesAndAdditionalPropertiesWithHttpInfo($param)
    {
        $request = $this->testMixedPropertiesAndAdditionalPropertiesRequest($param);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\MixedPropertiesAndAdditionalPropertiesClass' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\MixedPropertiesAndAdditionalPropertiesClass', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\MixedPropertiesAndAdditionalPropertiesClass';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\MixedPropertiesAndAdditionalPropertiesClass',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation testMixedPropertiesAndAdditionalPropertiesAsync
     *
     * test mixed properties and additionalProperties
     *
     * @param  \OpenAPI\Client\Model\MixedPropertiesAndAdditionalPropertiesClass $param request body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function testMixedPropertiesAndAdditionalPropertiesAsync($param)
    {
        return $this->testMixedPropertiesAndAdditionalPropertiesAsyncWithHttpInfo($param)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation testMixedPropertiesAndAdditionalPropertiesAsyncWithHttpInfo
     *
     * test mixed properties and additionalProperties
     *
     * @param  \OpenAPI\Client\Model\MixedPropertiesAndAdditionalPropertiesClass $param request body (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function testMixedPropertiesAndAdditionalPropertiesAsyncWithHttpInfo($param)
    {
        $returnType = '\OpenAPI\Client\Model\MixedPropertiesAndAdditionalPropertiesClass';
        $request = $this->testMixedPropertiesAndAdditionalPropertiesRequest($param);
    ...
    /**
     * Create request for operation 'testMixedPropertiesAndAdditionalProperties'
     *
     * @param  \OpenAPI\Client\Model\MixedPropertiesAndAdditionalPropertiesClass $param request body (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function testMixedPropertiesAndAdditionalPropertiesRequest($param)
    {
        // verify the required parameter 'param' is set
        if ($param === null || (is_array($param) && count($param) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $param when calling testMixedPropertiesAndAdditionalProperties'
            );
        }

        $resourcePath = '/fake/body-mixedPropertiesAndAdditionalProperties';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
