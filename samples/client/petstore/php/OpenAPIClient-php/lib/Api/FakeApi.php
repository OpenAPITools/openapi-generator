...
class FakeApi
{
    ...
    {
        list($response) = $this->fileResponseTestWithHttpInfo();
        return $response;
    }

    /**
     * Operation fileResponseTestWithHttpInfo
     *
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function fileResponseTestWithHttpInfo()
    {
        $request = $this->fileResponseTestRequest();
    ...
    /**
     * Operation fileResponseTestAsync
     *
     * 
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function fileResponseTestAsync()
    {
        return $this->fileResponseTestAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation fileResponseTestAsyncWithHttpInfo
     *
     * 
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function fileResponseTestAsyncWithHttpInfo()
    {
        $returnType = '\SplFileObject';
        $request = $this->fileResponseTestRequest();
    ...
    /**
     * Create request for operation 'fileResponseTest'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function fileResponseTestRequest()
    {

        $resourcePath = '/fake/fileResponseTest';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->resourceNamedResourceTestWithHttpInfo();
        return $response;
    }

    /**
     * Operation resourceNamedResourceTestWithHttpInfo
     *
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function resourceNamedResourceTestWithHttpInfo()
    {
        $request = $this->resourceNamedResourceTestRequest();
    ...
    /**
     * Operation resourceNamedResourceTestAsync
     *
     * 
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function resourceNamedResourceTestAsync()
    {
        return $this->resourceNamedResourceTestAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation resourceNamedResourceTestAsyncWithHttpInfo
     *
     * 
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function resourceNamedResourceTestAsyncWithHttpInfo()
    {
        $returnType = '\OpenAPI\Client\Model\Resource';
        $request = $this->resourceNamedResourceTestRequest();
    ...
    /**
     * Create request for operation 'resourceNamedResourceTest'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function resourceNamedResourceTestRequest()
    {

        $resourcePath = '/fake/resource-named-resource-test';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
