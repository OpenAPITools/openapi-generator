...
class UserApi
{
    ...
    {
        return $this->createUserAsyncWithHttpInfo($user)->then(function (
            $response
        ) {
            return $response[0];
        });
    ...
    {
        return $this->createUsersWithArrayInputAsyncWithHttpInfo($user)->then(
            function ($response) {
                return $response[0];
            }
        );
    ...
    {
        return $this->createUsersWithListInputAsyncWithHttpInfo($user)->then(
            function ($response) {
                return $response[0];
            }
        );
    ...
    {
        return $this->deleteUserAsyncWithHttpInfo($username)->then(function (
            $response
        ) {
            return $response[0];
        });
    ...
    protected function deleteUserRequest($username)
    {
        ...
        if (
            $username === null ||
            (is_array($username) && count($username) === 0)
        ) {
            throw new \InvalidArgumentException(
    ...
    {
        return $this->getUserByNameAsyncWithHttpInfo($username)->then(function (
            $response
        ) {
            return $response[0];
        });
    ...
    {
        return $this->loginUserAsyncWithHttpInfo($username, $password)->then(
            function ($response) {
                return $response[0];
            }
        );
    ...
    protected function loginUserRequest($username, $password)
    {
        ...
        // query params
        if ($username !== null) {
            $queryParams['username'] = ObjectSerializer::toQueryValue(
                $username
            );
        }
        // query params
        if ($password !== null) {
            $queryParams['password'] = ObjectSerializer::toQueryValue(
                $password
            );
        }
    ...
    {
        return $this->updateUserAsyncWithHttpInfo($username, $user)->then(
            function ($response) {
                return $response[0];
            }
        );
