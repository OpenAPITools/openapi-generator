 ...
 */
public class FakeClassnameTestApiImpl implements FakeClassnameTestApi {
  ...
  /**
   * Creates a new instance of FakeClassnameTestApiImpl initialized with the specified {@link ApiClient}.
   *
   */
  public static FakeClassnameTestApiImpl create(ApiClient apiClient) {
    return new FakeClassnameTestApiImpl(apiClient);
  }

  protected FakeClassnameTestApiImpl(ApiClient apiClient) {
