...
public class FooApiImpl implements FooApi {
  ...
  /**
   * Creates a new instance of FooApiImpl initialized with the specified {@link ApiClient}.
   *
   */
  public static FooApiImpl create(ApiClient apiClient) {
    return new FooApiImpl(apiClient);
  }

  protected FooApiImpl(ApiClient apiClient) {
