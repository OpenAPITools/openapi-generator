    ...
    return {
        ...
        addPet(pet: Pet, header1?: Pet, header2?: Array<Pet>, options: any = {}): RequestArgs {
            ...
            if (header1 !== undefined && header1 !== null) {
                let mapped = (<any>"Pet" !== "string") ? JSON.stringify(header1 || {}) : (header1 || "")
                localVarHeaderParameter['header1'] = String(mapped);
            }
        ...
        deletePet(petId: number, apiKey?: string, options: any = {}): RequestArgs {
            ...
            if (apiKey !== undefined && apiKey !== null) {
                let mapped = (<any>"string" !== "string") ? JSON.stringify(apiKey || {}) : (apiKey || "")
                localVarHeaderParameter['api_key'] = String(mapped);
            }
...
export const PetApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        addPet(pet: Pet, header1?: Pet, header2?: Array<Pet>, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Response> {
