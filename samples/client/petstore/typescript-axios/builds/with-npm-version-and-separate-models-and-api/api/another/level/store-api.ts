...
export const StoreApiFp = function(configuration?: Configuration) {
  return {
    ...
    deleteOrder(
      ...
      const localVarAxiosArgs = StoreApiAxiosParamCreator(
        configuration
...
export const StoreApiFactory = function(
  ...
  return {
    ...
    placeOrder(body: Order, options?: any) {
      return StoreApiFp(configuration).placeOrder(body, options)(
        axios,
        basePath
      );
    }
...
export class StoreApi extends BaseAPI {
  ...
  public placeOrder(body: Order, options?: any) {
    return StoreApiFp(this.configuration).placeOrder(body, options)(
      this.axios,
      this.basePath
    );
  }
