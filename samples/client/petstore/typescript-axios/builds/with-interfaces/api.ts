...
export interface PetApiInterface {
     ...
     */
    addPet(body: Pet, axiosOptions?: AxiosRequestConfig): AxiosPromise<void>;
     ...
     * @memberof PetApiInterface
     */
    deletePet(petId: number, apiKey?: string, axiosOptions?: AxiosRequestConfig): AxiosPromise<void>;
     ...
     * @memberof PetApiInterface
     */
    findPetsByStatus(status: Array<'available' | 'pending' | 'sold'>, axiosOptions?: AxiosRequestConfig): AxiosPromise<Array<Pet>>;
     ...
     * @memberof PetApiInterface
     */
    findPetsByTags(tags: Array<string>, axiosOptions?: AxiosRequestConfig): AxiosPromise<Array<Pet>>;
     ...
     * @memberof PetApiInterface
     */
    getPetById(petId: number, axiosOptions?: AxiosRequestConfig): AxiosPromise<Pet>;
     ...
     * @memberof PetApiInterface
     */
    updatePet(body: Pet, axiosOptions?: AxiosRequestConfig): AxiosPromise<void>;
     ...
     * @memberof PetApiInterface
     */
    updatePetWithForm(petId: number, name?: string, status?: string, axiosOptions?: AxiosRequestConfig): AxiosPromise<void>;
     ...
     * @memberof PetApiInterface
     */
    uploadFile(petId: number, additionalMetadata?: string, file?: any, axiosOptions?: AxiosRequestConfig): AxiosPromise<ApiResponse>;
...
export interface StoreApiInterface {
     ...
     */
    deleteOrder(orderId: string, axiosOptions?: AxiosRequestConfig): AxiosPromise<void>;
     ...
     * @memberof StoreApiInterface
     */
    getInventory(axiosOptions?: AxiosRequestConfig): AxiosPromise<{ [key: string]: number; }>;
     ...
     * @memberof StoreApiInterface
     */
    getOrderById(orderId: number, axiosOptions?: AxiosRequestConfig): AxiosPromise<Order>;
     ...
     * @memberof StoreApiInterface
     */
    placeOrder(body: Order, axiosOptions?: AxiosRequestConfig): AxiosPromise<Order>;
...
export interface UserApiInterface {
     ...
     */
    createUser(body: User, axiosOptions?: AxiosRequestConfig): AxiosPromise<void>;
     ...
     * @memberof UserApiInterface
     */
    createUsersWithArrayInput(body: Array<User>, axiosOptions?: AxiosRequestConfig): AxiosPromise<void>;
     ...
     * @memberof UserApiInterface
     */
    createUsersWithListInput(body: Array<User>, axiosOptions?: AxiosRequestConfig): AxiosPromise<void>;
     ...
     * @memberof UserApiInterface
     */
    deleteUser(username: string, axiosOptions?: AxiosRequestConfig): AxiosPromise<void>;
     ...
     * @memberof UserApiInterface
     */
    getUserByName(username: string, axiosOptions?: AxiosRequestConfig): AxiosPromise<User>;
     ...
     * @memberof UserApiInterface
     */
    loginUser(username: string, password: string, axiosOptions?: AxiosRequestConfig): AxiosPromise<string>;
     ...
     * @memberof UserApiInterface
     */
    logoutUser(axiosOptions?: AxiosRequestConfig): AxiosPromise<void>;
     ...
     * @memberof UserApiInterface
     */
    updateUser(username: string, body: User, axiosOptions?: AxiosRequestConfig): AxiosPromise<void>;
