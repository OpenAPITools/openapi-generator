...
public interface PetApi {
    ...
    CompletableFuture<ResponseEntity<Void>> deletePet( @ApiParam(value = "Pet id to delete", required=true, example="56") @PathVariable("petId") Long petId, @ApiParam(value = "", example="apiKey_example") @RequestHeader(value="api_key", required=false) String apiKey);
    ...
    CompletableFuture<ResponseEntity<List<Pet>>> findPetsByStatus(@NotNull  @ApiParam(value = "Status values that need to be considered for filter", required=true, allowableValues = "\"available\", \"pending\", \"sold\"", example="[\"available\"]") @Valid @RequestParam(value = "status", required = true) List<String> status);
    ...
    CompletableFuture<ResponseEntity<List<Pet>>> findPetsByTags(@NotNull  @ApiParam(value = "Tags to filter by", required=true, example="[]") @Valid @RequestParam(value = "tags", required = true) List<String> tags);
    ...
    CompletableFuture<ResponseEntity<Pet>> getPetById( @ApiParam(value = "ID of pet to return", required=true, example="56") @PathVariable("petId") Long petId);
    ...
    CompletableFuture<ResponseEntity<ModelApiResponse>> uploadFile( @ApiParam(value = "ID of pet to update", required=true, example="56") @PathVariable("petId") Long petId,@ApiParam(value = "Additional data to pass to server" ) @RequestParam(value="additionalMetadata", required=false)  String additionalMetadata,@ApiParam(value = "file to upload") @RequestParam("file") MultipartFile file);
