...
import swagger.client/models.Pet;
import java.io.File;
...
public class PetApi extends SwaggerApi {
    ...
    */
    ...
    public function update_pet (body: Pet): String {
        ...
        var token:AsyncToken = getApiInvoker().invokeAPI(path, "PUT", queryParams, io.swagger.codegen.CodegenParameter@5366f936, headerParams);
