...
api_instance = openapi_client.AnotherFakeApi(openapi_client.ApiClient(configuration))
...
*FakeApi* | [**test_mixed_properties_and_additional_properties**](docs/FakeApi.md#test_mixed_properties_and_additional_properties) | **POST** /fake/body-mixedPropertiesAndAdditionalProperties | test mixed properties and additionalProperties
