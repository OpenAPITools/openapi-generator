...
class FakeApi(object):
    ...
    def test_endpoint_parameters(self, number, double, pattern_without_delimiter, byte, **kwargs):  # noqa: E501
        ...
        Args:
            number (float): None            double (float): None            pattern_without_delimiter (str): None            byte (str): None
    ...
    def test_group_parameters(self, required_string_group, required_boolean_group, required_int64_group, **kwargs):  # noqa: E501
        ...
        Args:
            required_string_group (int): Required String in group parameters            required_boolean_group (bool): Required Boolean in group parameters            required_int64_group (int): Required Integer in group parameters
    ...
    def test_json_form_data(self, param, param2, **kwargs):  # noqa: E501
        ...
        Args:
            param (str): field1            param2 (str): field2
    ...
    def test_mixed_properties_and_additional_properties(self, param, **kwargs):  # noqa: E501
        """test mixed properties and additionalProperties  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.test_mixed_properties_and_additional_properties(param, async_req=True)
        >>> result = thread.get()

        Args:
            param (MixedPropertiesAndAdditionalPropertiesClass): request body
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.test_mixed_properties_and_additional_properties_with_http_info(param, **kwargs)  # noqa: E501
        else:
            (data) = self.test_mixed_properties_and_additional_properties_with_http_info(param, **kwargs)  # noqa: E501
            return data

    def test_mixed_properties_and_additional_properties_with_http_info(self, param, **kwargs):  # noqa: E501
        """test mixed properties and additionalProperties  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.test_mixed_properties_and_additional_properties_with_http_info(param, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method test_mixed_properties_and_additional_properties" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'param' is set
        if ('param' not in local_var_params or
                local_var_params['param'] is None):
            raise ApiValueError("Missing the required parameter `param` when calling `test_mixed_properties_and_additional_properties`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='MixedPropertiesAndAdditionalPropertiesClass',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def test_query_parameter_collection_format(self, pipe, ioutil, http, url, context, **kwargs):  # noqa: E501
        ...
        Args:
            pipe (list[str]):            ioutil (list[str]):            http (list[str]):            url (list[str]):            context (list[str]):
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.test_query_parameter_collection_format_with_http_info(pipe, ioutil, http, url, context, **kwargs)  # noqa: E501
            return data
