...
class ApiClient(object):
    ...
    def files_parameters(self, files=None):
        ...
        :param files: None or a dict with key=param_name and value=file_object
        ...
        params = []
        for param_name, file_instance in six.iteritems(files):
            if file_instance is None:
                # if the file field is nullable, skip None values
                continue
            if file_instance.closed is True:
                raise ApiValueError(
                    "Cannot read a closed file. The passed in file_type for "
                    "%s must be open." % param_name
                )
