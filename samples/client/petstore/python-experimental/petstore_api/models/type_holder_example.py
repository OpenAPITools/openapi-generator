...
class TypeHolderExample(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, bool_item, array_item, string_item='what', number_item=1.234, integer_item=-2, _check_type=True, _json_variable_naming=False, _path_to_item=(), _configuration=None, _visited_composed_classes=(), **kwargs):  # noqa: E501
