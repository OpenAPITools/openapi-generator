...
<a id="getAllPets"></a>
# **getAllPets**
> List&lt;Pet&gt; getAllPets(lastUpdated)
...
val apiInstance = PetApi()
val lastUpdated : OffsetDateTime = 2013-10-20T19:20:30+01:00 // OffsetDateTime | When this endpoint was hit last to help identify if the client already has the latest copy.
try {
    val result : List<Pet> = apiInstance.getAllPets(lastUpdated)
    println(result)
} catch (e: ClientException) {
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **lastUpdated** | **OffsetDateTime**| When this endpoint was hit last to help identify if the client already has the latest copy. | [optional] |
