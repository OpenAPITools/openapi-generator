...
FunctionsToExport = 'Add-PSPet', 'Remove-Pet', 'Find-PSPetsByStatus', 'Find-PSPetsByTags', 
               ...
               'Invoke-PSUploadFile', 'Invoke-PSDeleteOrder', 'Get-PSInventory', 
               'Get-PSOrderById', 'Invoke-PSPlaceOrder', 'Invoke-PSCreateUser', 
               'Invoke-PSCreateUsersWithArrayInput', 
               'Invoke-PSCreateUsersWithListInput', 'Invoke-PSDeleteUser', 
               'Get-PSUserByName', 'Invoke-PSLoginUser', 'Invoke-PSLogoutUser', 
