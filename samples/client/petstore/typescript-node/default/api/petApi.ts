...
export class PetApi {
  ...
  public deletePet(
    ...
    localVarHeaderParams["api_key"] = ObjectSerializer.serialize(
      apiKey,
      "string"
    );
  ...
  public findPetsByStatus(
    ...
    return new Promise<{ response: http.ClientResponse; body: Array<Pet> }>(
      (resolve, reject) => {
        localVarRequest(localVarRequestOptions, (error, response, body) => {
          if (error) {
            reject(error);
  ...
  public updatePetWithForm(
    ...
    if (status !== undefined) {
      localVarFormParams["status"] = ObjectSerializer.serialize(
        status,
        "string"
      );
    }
  ...
  public uploadFile(
    ...
    if (additionalMetadata !== undefined) {
      localVarFormParams["additionalMetadata"] = ObjectSerializer.serialize(
        additionalMetadata,
        "string"
      );
    }
