...
class ApiUserOrPetTest : ShouldSpec() {
    init {
        ...
        should("test custom type adapter") {
            ...
            val petJsonMissignRequiredFields = "{\"id\":123,\"category\":{\"id\":456,\"name\":\"pet category\"},\"tags\":[{\"id\":678,\"name\":\"pet tag\"}],\"status\":\"available\"}"
            assertThrows(IllegalArgumentException::class.java) {
                val failedPet = gson.fromJson(petJsonMissignRequiredFields, ApiPet::class.java)
