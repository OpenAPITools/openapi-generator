...
# **findPetsByStatus**
> kotlin.collections.List&lt;ApiPet&gt; findPetsByStatus(status)
...
# **findPetsByTags**
> kotlin.collections.List&lt;ApiPet&gt; findPetsByTags(tags)
...
<a id="uploadFile"></a>
# **uploadFile**
> ApiApiResponse uploadFile(petId, additionalMetadata, file)
