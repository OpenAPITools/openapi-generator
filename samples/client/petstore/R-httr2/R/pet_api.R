...
PetApi <- R6::R6Class(
  ...
  public = list(
    ...
    add_pet = function(pet, data_file = NULL, ...) {
      api_response <- self$add_pet_with_http_info(pet, data_file = data_file, ...)
    ...
    delete_pet = function(pet_id, api_key = NULL, ...) {
      api_response <- self$delete_pet_with_http_info(pet_id, api_key, ...)
      local_var_response <- api_response$response
      if (httr::status_code(local_var_response) >= 200 && httr::status_code(local_var_response) <= 299) {
        api_response$content
      } else if (httr::status_code(local_var_response) >= 300 && httr::status_code(local_var_response) <= 399) {
    ...
    find_pets_by_status = function(status, data_file = NULL, ...) {
      api_response <- self$find_pets_by_status_with_http_info(status, data_file = data_file, ...)
      local_var_response <- api_response$response
      if (httr::status_code(local_var_response) >= 200 && httr::status_code(local_var_response) <= 299) {
        api_response$content
      } else if (httr::status_code(local_var_response) >= 300 && httr::status_code(local_var_response) <= 399) {
    ...
    find_pets_by_tags = function(tags, data_file = NULL, ...) {
      api_response <- self$find_pets_by_tags_with_http_info(tags, data_file = data_file, ...)
      local_var_response <- api_response$response
      if (httr::status_code(local_var_response) >= 200 && httr::status_code(local_var_response) <= 299) {
        api_response$content
      } else if (httr::status_code(local_var_response) >= 300 && httr::status_code(local_var_response) <= 399) {
    ...
    get_pet_by_id = function(pet_id, data_file = NULL, ...) {
      api_response <- self$get_pet_by_id_with_http_info(pet_id, data_file = data_file, ...)
      local_var_response <- api_response$response
      if (httr::status_code(local_var_response) >= 200 && httr::status_code(local_var_response) <= 299) {
        api_response$content
      } else if (httr::status_code(local_var_response) >= 300 && httr::status_code(local_var_response) <= 399) {
    ...
    get_pet_by_id_streaming = function(pet_id, stream_callback = NULL, data_file = NULL, ...) {
      api_response <- self$get_pet_by_id_streaming_with_http_info(pet_id, stream_callback = stream_callback, data_file = data_file, ...)
    ...
    update_pet = function(pet, data_file = NULL, ...) {
      api_response <- self$update_pet_with_http_info(pet, data_file = data_file, ...)
      local_var_response <- api_response$response
      if (httr::status_code(local_var_response) >= 200 && httr::status_code(local_var_response) <= 299) {
        api_response$content
      } else if (httr::status_code(local_var_response) >= 300 && httr::status_code(local_var_response) <= 399) {
    ...
    update_pet_with_form = function(pet_id, name = NULL, status = NULL, ...) {
      api_response <- self$update_pet_with_form_with_http_info(pet_id, name, status, ...)
      local_var_response <- api_response$response
      if (httr::status_code(local_var_response) >= 200 && httr::status_code(local_var_response) <= 299) {
        api_response$content
      } else if (httr::status_code(local_var_response) >= 300 && httr::status_code(local_var_response) <= 399) {
    ...
    upload_file = function(pet_id, additional_metadata = NULL, file = NULL, data_file = NULL, ...) {
      api_response <- self$upload_file_with_http_info(pet_id, additional_metadata, file, data_file = data_file, ...)
      local_var_response <- api_response$response
      if (httr::status_code(local_var_response) >= 200 && httr::status_code(local_var_response) <= 299) {
        api_response$content
      } else if (httr::status_code(local_var_response) >= 300 && httr::status_code(local_var_response) <= 399) {
