...
UserApi <- R6::R6Class(
  ...
  public = list(
    ...
    create_user = function(user, ...) {
      api_response <- self$create_user_with_http_info(user, ...)
    ...
    create_users_with_array_input = function(user, ...) {
      api_response <- self$create_users_with_array_input_with_http_info(user, ...)
      local_var_response <- api_response$response
      if (httr::status_code(local_var_response) >= 200 && httr::status_code(local_var_response) <= 299) {
        api_response$content
      } else if (httr::status_code(local_var_response) >= 300 && httr::status_code(local_var_response) <= 399) {
    ...
    create_users_with_list_input = function(user, ...) {
      api_response <- self$create_users_with_list_input_with_http_info(user, ...)
      local_var_response <- api_response$response
      if (httr::status_code(local_var_response) >= 200 && httr::status_code(local_var_response) <= 299) {
        api_response$content
      } else if (httr::status_code(local_var_response) >= 300 && httr::status_code(local_var_response) <= 399) {
    ...
    delete_user = function(username, ...) {
      api_response <- self$delete_user_with_http_info(username, ...)
      local_var_response <- api_response$response
      if (httr::status_code(local_var_response) >= 200 && httr::status_code(local_var_response) <= 299) {
        api_response$content
      } else if (httr::status_code(local_var_response) >= 300 && httr::status_code(local_var_response) <= 399) {
    ...
    get_user_by_name = function(username, data_file = NULL, ...) {
      api_response <- self$get_user_by_name_with_http_info(username, data_file = data_file, ...)
      local_var_response <- api_response$response
      if (httr::status_code(local_var_response) >= 200 && httr::status_code(local_var_response) <= 299) {
        api_response$content
      } else if (httr::status_code(local_var_response) >= 300 && httr::status_code(local_var_response) <= 399) {
    ...
    login_user = function(username, password, data_file = NULL, ...) {
      api_response <- self$login_user_with_http_info(username, password, data_file = data_file, ...)
      local_var_response <- api_response$response
      if (httr::status_code(local_var_response) >= 200 && httr::status_code(local_var_response) <= 299) {
        api_response$content
      } else if (httr::status_code(local_var_response) >= 300 && httr::status_code(local_var_response) <= 399) {
    ...
    logout_user = function(...) {
      api_response <- self$logout_user_with_http_info(...)
      local_var_response <- api_response$response
      if (httr::status_code(local_var_response) >= 200 && httr::status_code(local_var_response) <= 299) {
        api_response$content
      } else if (httr::status_code(local_var_response) >= 300 && httr::status_code(local_var_response) <= 399) {
    ...
    update_user = function(username, user, ...) {
      api_response <- self$update_user_with_http_info(username, user, ...)
      local_var_response <- api_response$response
      if (httr::status_code(local_var_response) >= 200 && httr::status_code(local_var_response) <= 299) {
        api_response$content
      } else if (httr::status_code(local_var_response) >= 300 && httr::status_code(local_var_response) <= 399) {
