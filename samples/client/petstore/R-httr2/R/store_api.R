...
StoreApi <- R6::R6Class(
  ...
  public = list(
    ...
    delete_order = function(order_id, ...) {
      api_response <- self$delete_order_with_http_info(order_id, ...)
    ...
    get_inventory = function(data_file = NULL, ...) {
      api_response <- self$get_inventory_with_http_info(data_file = data_file, ...)
      resp <- api_response$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        api_response$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    get_order_by_id = function(order_id, data_file = NULL, ...) {
      api_response <- self$get_order_by_id_with_http_info(order_id, data_file = data_file, ...)
      resp <- api_response$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        api_response$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    place_order = function(order, data_file = NULL, ...) {
      api_response <- self$place_order_with_http_info(order, data_file = data_file, ...)
      resp <- api_response$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        api_response$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
