...
public interface FakeApi {
    ...
    Mono<ResponseEntity<Void>> testEnumParameters(
         ...
         @RequestParam(value = "enum_query_string_array", required = false) List<EnumQueryStringArrayEnum> enumQueryStringArray,
         @RequestParam(value = "enum_query_string", required = false, defaultValue = "-efg") EnumQueryStringEnum enumQueryString,
         @RequestParam(value = "enum_query_integer", required = false) EnumQueryIntegerEnum enumQueryInteger,
         @RequestParam(value = "enum_query_double", required = false) EnumQueryDoubleEnum enumQueryDouble,
         @RequestPart(value = "enum_form_string_array", required = false) List<InnerEnum> enumFormStringArray,
         @RequestPart(value = "enum_form_string", required = false) EnumFormStringEnum enumFormString
    );
