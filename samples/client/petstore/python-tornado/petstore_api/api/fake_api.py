...
class FakeApi(object):
    ...
    def file_response_test(self, **kwargs):  # noqa: E501
        """file_response_test  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.file_response_test(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.file_response_test_with_http_info(**kwargs)  # noqa: E501

    def file_response_test_with_http_info(self, **kwargs):  # noqa: E501
        """file_response_test  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.file_response_test_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method file_response_test" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
    ...
    def resource_named_resource_test(self, **kwargs):  # noqa: E501
        """resource_named_resource_test  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.resource_named_resource_test(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.resource_named_resource_test_with_http_info(**kwargs)  # noqa: E501

    def resource_named_resource_test_with_http_info(self, **kwargs):  # noqa: E501
        """resource_named_resource_test  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.resource_named_resource_test_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method resource_named_resource_test" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
