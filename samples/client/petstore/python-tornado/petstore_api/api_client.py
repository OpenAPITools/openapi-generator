...
class ApiClient(object):
    ...
    def __call_api(
        ...
        if multipart_header_params:
            multipart_header_params = self.sanitize_for_serialization(multipart_header_params)  # noqa: E501
            multipart_header_params = self.parameters_to_tuples(multipart_header_params, collection_formats)  # noqa: E501
            multipart_header_params = dict(multipart_header_params)  # noqa: E501
    ...
    def call_api(self, resource_path, method,
        ...
        :param multipart_header_params: list of parameters that
            will be passed in the headers of each multipart item
    ...
    def treat_multipart(self, params, content_types, multipart_header_params):
        """ builds the multipart fields,
        adding Content-Type and headers where appropriate
