...
open class DefaultApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
     ...
     * 
     * 
     * @return ApiResponse<ArrayWithNullableItemsModel?>
     * @throws IllegalStateException If the request is not correctly configured
     * @throws IOException Rethrows the OkHttp execute method exception
     */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getModelWithHttpInfo() : ApiResponse<ArrayWithNullableItemsModel?> {
        val localVariableConfig = getModelRequestConfig()

        return request<Unit, ArrayWithNullableItemsModel>(
            localVariableConfig
        )
    }
     ...
     */
    fun getModelRequestConfig() : RequestConfig<Unit> {
