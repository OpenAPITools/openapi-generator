...
void main() {
  ...
  group('Store API with faked client', () {
    test('places an order and gets it by id', () async {
      ...
      //   expectedPostRequestBody: await storeApi.apiClient.serialize(newOrder),
      //   postResponseBody: await storeApi.apiClient.serialize(newOrder),
      ...
      //   getResponseBody: await storeApi.apiClient.serialize(newOrder),
      // );
