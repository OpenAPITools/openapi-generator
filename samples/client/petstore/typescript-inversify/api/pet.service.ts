...
export class PetService {
     ...
     */
    public addPet(pet: Pet, observe?: 'body', headers?: Headers): Observable<Pet>;
    public addPet(pet: Pet, observe?: 'response', headers?: Headers): Observable<HttpResponse<Pet>>;
    public addPet(pet: Pet, observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        const response: Observable<HttpResponse<Pet>> = this.httpClient.post(`${this.basePath}/pet`, pet , headers);
        if (observe == 'body') {
     ...
     */
    public updatePet(pet: Pet, observe?: 'body', headers?: Headers): Observable<Pet>;
    public updatePet(pet: Pet, observe?: 'response', headers?: Headers): Observable<HttpResponse<Pet>>;
    public updatePet(pet: Pet, observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        const response: Observable<HttpResponse<Pet>> = this.httpClient.put(`${this.basePath}/pet`, pet , headers);
        if (observe == 'body') {
               return response.pipe(
                   map(httpResponse => <Pet>(httpResponse.response))
               );
