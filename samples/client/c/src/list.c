...
void list_removeElement(list_t* list, listEntry_t* elementToRemove) {
    listEntry_t* elementBeforeElementToRemove = elementToRemove->prevListEntry;
    listEntry_t* elementAfterElementToRemove = elementToRemove->nextListEntry;

    if(elementBeforeElementToRemove != NULL) {
        elementBeforeElementToRemove->nextListEntry = elementAfterElementToRemove;
    }
    else {
    ...
    if(elementAfterElementToRemove != NULL)  {
        elementAfterElementToRemove->prevListEntry = elementBeforeElementToRemove;
    }
    else {
