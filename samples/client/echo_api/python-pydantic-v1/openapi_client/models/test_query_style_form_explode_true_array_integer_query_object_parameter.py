...
class TestQueryStyleFormExplodeTrueArrayIntegerQueryObjectParameter(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestQueryStyleFormExplodeTrueArrayIntegerQueryObjectParameter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TestQueryStyleFormExplodeTrueArrayIntegerQueryObjectParameter:
        """Create an instance of TestQueryStyleFormExplodeTrueArrayIntegerQueryObjectParameter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestQueryStyleFormExplodeTrueArrayIntegerQueryObjectParameter.parse_obj(obj)

        _obj = TestQueryStyleFormExplodeTrueArrayIntegerQueryObjectParameter.parse_obj({
