...
class QueryApi:
    ...
    @validate_arguments
    def test_query_style_form_explode_false_array_integer(self, query_object : Optional[conlist(StrictInt)] = None, **kwargs) -> str:  # noqa: E501
        """Test query parameter(s)  # noqa: E501
        ...
        >>> thread = api.test_query_style_form_explode_false_array_integer(query_object, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the test_query_style_form_explode_false_array_integer_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.test_query_style_form_explode_false_array_integer_with_http_info(query_object, **kwargs)  # noqa: E501

    @validate_arguments
    def test_query_style_form_explode_false_array_integer_with_http_info(self, query_object : Optional[conlist(StrictInt)] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Test query parameter(s)  # noqa: E501
        ...
        >>> thread = api.test_query_style_form_explode_false_array_integer_with_http_info(query_object, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method test_query_style_form_explode_false_array_integer" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params.get('query_object') is not None:  # noqa: E501
            _query_params.append(('query_object', _params['query_object']))
            _collection_formats['query_object'] = 'csv'
        ...
        return self.api_client.call_api(
            '/query/style_form/explode_false/array_integer', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def test_query_style_form_explode_false_array_string(self, query_object : Optional[conlist(StrictStr)] = None, **kwargs) -> str:  # noqa: E501
        """Test query parameter(s)  # noqa: E501
        ...
        >>> thread = api.test_query_style_form_explode_false_array_string(query_object, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the test_query_style_form_explode_false_array_string_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.test_query_style_form_explode_false_array_string_with_http_info(query_object, **kwargs)  # noqa: E501

    @validate_arguments
    def test_query_style_form_explode_false_array_string_with_http_info(self, query_object : Optional[conlist(StrictStr)] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Test query parameter(s)  # noqa: E501
        ...
        >>> thread = api.test_query_style_form_explode_false_array_string_with_http_info(query_object, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method test_query_style_form_explode_false_array_string" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/query/style_form/explode_false/array_string', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
