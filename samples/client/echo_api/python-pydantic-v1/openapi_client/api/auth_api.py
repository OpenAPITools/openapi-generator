...
class AuthApi:
    ...
    @validate_arguments
    def test_auth_http_bearer(self, **kwargs) -> str:  # noqa: E501
        ...
        >>> thread = api.test_auth_http_bearer(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the test_auth_http_bearer_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.test_auth_http_bearer_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def test_auth_http_bearer_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """To test HTTP bearer authentication  # noqa: E501
        ...
        >>> thread = api.test_auth_http_bearer_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method test_auth_http_bearer" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # authentication setting
        _auth_settings = ['http_bearer_auth']  # noqa: E501
