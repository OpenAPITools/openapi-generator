# echo_client_disallow_additional_properties_if_not_present.BodyApi
...
with echo_client_disallow_additional_properties_if_not_present.ApiClient(configuration) as api_client:
    ...
    api_instance = echo_client_disallow_additional_properties_if_not_present.BodyApi(api_client)
...
with echo_client_disallow_additional_properties_if_not_present.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = echo_client_disallow_additional_properties_if_not_present.BodyApi(api_client)
    pet = echo_client_disallow_additional_properties_if_not_present.Pet() # Pet | Pet object that needs to be added to the store (optional)
...
with echo_client_disallow_additional_properties_if_not_present.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = echo_client_disallow_additional_properties_if_not_present.BodyApi(api_client)
    tag = echo_client_disallow_additional_properties_if_not_present.Tag() # Tag | Tag object (optional)
