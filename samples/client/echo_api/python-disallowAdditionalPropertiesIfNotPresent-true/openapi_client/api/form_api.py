...
class FormApi:
    ...
    def test_form_integer_boolean_string(
        ...
        **kwargs,
        ...
        response = self.test_form_integer_boolean_string_with_http_info.raw_function(
            integer_form,
            boolean_form,
            string_form,
            **kwargs,
    ...
    def test_form_integer_boolean_string_async(
        self,
        integer_form: Optional[StrictInt] = None,
        boolean_form: Optional[StrictBool] = None,
        string_form: Optional[StrictStr] = None,
        **kwargs,
        ...
        >>> thread = api.test_form_integer_boolean_string(integer_form, boolean_form, string_form, )
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the test_form_integer_boolean_string_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        response = self.test_form_integer_boolean_string_with_http_info_async(
            integer_form,
            boolean_form,
            string_form,
            **kwargs,
    ...
    @validate_call
    def test_form_integer_boolean_string_with_http_info_async(self, integer_form : Optional[StrictInt] = None, boolean_form : Optional[StrictBool] = None, string_form : Optional[StrictStr] = None, **kwargs) -> AsyncApiResponse:  # noqa: E501
        """Test form parameter(s)  # noqa: E501

        Test form parameter(s)  # noqa: E501
        This method makes a asynchronous HTTP request:

        >>> thread = api.test_form_integer_boolean_string_with_http_info_async(integer_form, boolean_form, string_form, )
        >>> result = thread.get()
    ...
    def test_form_oneof(
        ...
        **kwargs,
        ...
        response = self.test_form_oneof_with_http_info.raw_function(
            form1,
            form2,
            form3,
            form4,
    ...
    def test_form_oneof_async(
        ...
        **kwargs,
        ...
        >>> thread = api.test_form_oneof(form1, form2, form3, form4, id, name, )
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the test_form_oneof_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        response = self.test_form_oneof_with_http_info_async(
            form1,
            form2,
            form3,
            form4,
    ...
    @validate_call
    def test_form_oneof_with_http_info_async(self, form1 : Optional[StrictStr] = None, form2 : Optional[StrictInt] = None, form3 : Optional[StrictStr] = None, form4 : Optional[StrictBool] = None, id : Optional[StrictInt] = None, name : Optional[StrictStr] = None, **kwargs) -> AsyncApiResponse:  # noqa: E501
        """Test form parameter(s) for oneOf schema  # noqa: E501

        Test form parameter(s) for oneOf schema  # noqa: E501
        This method makes a asynchronous HTTP request:

        >>> thread = api.test_form_oneof_with_http_info_async(form1, form2, form3, form4, id, name, )
        >>> result = thread.get()
