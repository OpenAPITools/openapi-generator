...
from echo_client_disallow_additional_properties_if_not_present.models.tag import Tag  # noqa: E501
...
class TestTag(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = echo_client_disallow_additional_properties_if_not_present.models.tag.Tag()  # noqa: E501
        if include_optional :
            return Tag(
                id = 56, 
                name = ''
