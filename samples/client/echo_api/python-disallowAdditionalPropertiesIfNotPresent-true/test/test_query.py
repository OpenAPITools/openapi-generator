...
from echo_client_disallow_additional_properties_if_not_present.models.query import Query  # noqa: E501
...
class TestQuery(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = echo_client_disallow_additional_properties_if_not_present.models.query.Query()  # noqa: E501
        if include_optional :
            return Query(
                id = 56, 
                outcomes = [
