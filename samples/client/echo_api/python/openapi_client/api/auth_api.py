...
class AuthApi:
    ...
    def test_auth_http_basic(
        ...
        **kwargs,
        ...
        response = self.test_auth_http_basic_with_http_info.raw_function(
            **kwargs,
        )
    ...
    def test_auth_http_basic_async(
        self,
        **kwargs,
    ) -> AsyncResponse[str]:
        """To test HTTP basic authentication  # noqa: E501
        ...
        >>> thread = api.test_auth_http_basic()
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the test_auth_http_basic_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        response = self.test_auth_http_basic_with_http_info_async(
            **kwargs,
        )
    ...
    @validate_call
    def test_auth_http_basic_with_http_info_async(self, **kwargs) -> AsyncApiResponse:  # noqa: E501
        """To test HTTP basic authentication  # noqa: E501

        To test HTTP basic authentication  # noqa: E501
        This method makes a asynchronous HTTP request:

        >>> thread = api.test_auth_http_basic_with_http_info_async()
        >>> result = thread.get()
