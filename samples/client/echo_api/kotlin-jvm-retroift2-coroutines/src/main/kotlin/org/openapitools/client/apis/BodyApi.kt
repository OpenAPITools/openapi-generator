...
interface BodyApi {
    ...
    suspend fun testBodyApplicationOctetstreamBinary(@Body body: java.io.File? = null): Response<kotlin.String>
     ...
     */
    @POST("echo/body/Pet")
    suspend fun testEchoBodyPet(@Body pet: Pet? = null): Response<Pet>
    ...
    suspend fun testEchoBodyPetResponseString(@Body pet: Pet? = null): Response<kotlin.String>
    ...
    suspend fun testEchoBodyTagResponseString(@Body tag: Tag? = null): Response<kotlin.String>
