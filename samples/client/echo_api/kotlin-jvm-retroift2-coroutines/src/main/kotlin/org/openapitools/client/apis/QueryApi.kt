...
interface QueryApi {
    ...
    */
    ...
    suspend fun testEnumRefString(@Query("enum_nonref_string_query") enumNonrefStringQuery: EnumNonrefStringQueryTestEnumRefString? = null, @Query("enum_ref_string_query") enumRefStringQuery: StringEnumRef? = null): Response<kotlin.String>
    ...
    suspend fun testQueryStyleDeepObjectExplodeTrueObject(@Query("query_object") queryObject: Pet? = null): Response<kotlin.String>
    ...
    suspend fun testQueryStyleFormExplodeTrueObject(@Query("id") id: kotlin.Long? = null, @Query("name") name: kotlin.String, @Query("category") category: Category? = null, @Query("photoUrls") photoUrls: kotlin.collections.List<kotlin.String>, @Query("tags") tags: kotlin.collections.List<Tag>? = null, @Query("status") status: kotlin.String? = null): Response<kotlin.String>
