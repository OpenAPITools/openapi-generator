...
public class AuthApi {
    ...
    /**
     * Build call for testAuthHttpBearer
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call testAuthHttpBearerCall(final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call testAuthHttpBearerValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return testAuthHttpBearerCall(_callback);
    ...
    public String testAuthHttpBearer() throws ApiException {
        ApiResponse<String> localVarResp = testAuthHttpBearerWithHttpInfo();
        return localVarResp.getData();
    }
    ...
    public ApiResponse<String> testAuthHttpBearerWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = testAuthHttpBearerValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * To test HTTP bearer authentication (asynchronously)
     * To test HTTP bearer authentication
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    public okhttp3.Call testAuthHttpBearerAsync(final ApiCallback<String> _callback) throws ApiException {

        okhttp3.Call localVarCall = testAuthHttpBearerValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
