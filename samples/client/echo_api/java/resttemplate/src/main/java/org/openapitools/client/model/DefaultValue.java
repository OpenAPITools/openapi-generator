...
public class DefaultValue {
  ...
  **/
  ...
  public static class Builder {
    ...
    public Builder() {
      this(new DefaultValue());
    }

    protected Builder(DefaultValue instance) {
      this.instance = instance;
    }

    public DefaultValue.Builder arrayStringEnumRefDefault(List<StringEnumRef> arrayStringEnumRefDefault) {
      this.instance.arrayStringEnumRefDefault = arrayStringEnumRefDefault;
      return this;
    }

    public DefaultValue.Builder arrayStringEnumDefault(List<ArrayStringEnumDefaultEnum> arrayStringEnumDefault) {
      this.instance.arrayStringEnumDefault = arrayStringEnumDefault;
      return this;
    }

    public DefaultValue.Builder arrayStringDefault(List<String> arrayStringDefault) {
      this.instance.arrayStringDefault = arrayStringDefault;
      return this;
    }

    public DefaultValue.Builder arrayIntegerDefault(List<Integer> arrayIntegerDefault) {
      this.instance.arrayIntegerDefault = arrayIntegerDefault;
      return this;
    }

    public DefaultValue.Builder arrayString(List<String> arrayString) {
      this.instance.arrayString = arrayString;
      return this;
    }

    public DefaultValue.Builder arrayStringNullable(List<String> arrayStringNullable) {
      this.instance.arrayStringNullable = JsonNullable.<List<String>>of(arrayStringNullable);
      return this;
    }

    public DefaultValue.Builder arrayStringExtensionNullable(List<String> arrayStringExtensionNullable) {
      this.instance.arrayStringExtensionNullable = JsonNullable.<List<String>>of(arrayStringExtensionNullable);
      return this;
    }

    public DefaultValue.Builder stringNullable(String stringNullable) {
      this.instance.stringNullable = JsonNullable.<String>of(stringNullable);
      return this;
    }


    /**
    * returns a built DefaultValue instance.
    *
  ...
  */
  public static DefaultValue.Builder builder() {
    return new DefaultValue.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public DefaultValue.Builder toBuilder() {
    return new DefaultValue.Builder()
      .arrayStringEnumRefDefault(getArrayStringEnumRefDefault())
      .arrayStringEnumDefault(getArrayStringEnumDefault())
      .arrayStringDefault(getArrayStringDefault())
      .arrayIntegerDefault(getArrayIntegerDefault())
      .arrayString(getArrayString())
      .arrayStringNullable(getArrayStringNullable())
      .arrayStringExtensionNullable(getArrayStringExtensionNullable())
      .stringNullable(getStringNullable());
  }
