# echo-api-okhttp-user-defined-templates
...
<dependency>
  ...
  <artifactId>echo-api-okhttp-user-defined-templates</artifactId>
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'echo-api-okhttp-user-defined-templates' jar has been published to maven central.
    mavenLocal()       // Needed if the 'echo-api-okhttp-user-defined-templates' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "org.openapitools:echo-api-okhttp-user-defined-templates:0.1.0"
  }
```
...
* `target/echo-api-okhttp-user-defined-templates-0.1.0.jar`
* `target/lib/*.jar`
