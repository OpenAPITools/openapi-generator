...
public class DataQuery extends Query {
  ...
  **/
  ...
  public static class Builder extends Query.Builder {
    ...
    protected Builder(DataQuery instance) {
      super(instance);
      this.instance = instance;
    }

    public DataQuery.Builder suffix(String suffix) {
      this.instance.suffix = suffix;
      return this;
    }

    public DataQuery.Builder text(String text) {
      this.instance.text = text;
      return this;
    }

    public DataQuery.Builder date(OffsetDateTime date) {
    ...
    /**
    * returns a built DataQuery instance.
    *
