...
public class Bird {
  ...
  **/
  ...
  public static class Builder {
    ...
    protected Builder(Bird instance) {
      this.instance = instance;
    }

    public Bird.Builder size(String size) {
      this.instance.size = size;
      return this;
    }

    public Bird.Builder color(String color) {
  ...
  */
  public static Bird.Builder builder() {
