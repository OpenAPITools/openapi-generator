...
<dependency>
  ...
  <artifactId>echo-api-okhttp</artifactId>
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'echo-api-okhttp' jar has been published to maven central.
    mavenLocal()       // Needed if the 'echo-api-okhttp' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "org.openapitools:echo-api-okhttp:0.1.0"
  }
```
...
* `target/echo-api-okhttp-0.1.0.jar`
* `target/lib/*.jar`
