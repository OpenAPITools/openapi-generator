...
public class Bird {
   ...
   * @return the Bird instance itself
   */
  public Bird putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.size, bird.size) &&
        ...
        Objects.equals(this.additionalProperties, bird.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(size, color, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Bird>() {
           ...
           public Bird read(JsonReader in) throws IOException {
             ...
             Bird instance = thisAdapter.fromJsonTree(jsonObj);
