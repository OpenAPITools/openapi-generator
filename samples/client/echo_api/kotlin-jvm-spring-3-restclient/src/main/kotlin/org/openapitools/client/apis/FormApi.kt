...
class FormApi(client: RestClient) : ApiClient(client) {
    ...
    fun testFormIntegerBooleanString(integerForm: Int? = null, booleanForm: Boolean? = null, stringForm: String? = null): String {
    ...
    @Throws(RestClientResponseException::class)
    fun testFormIntegerBooleanStringWithHttpInfo(integerForm: Int? = null, booleanForm: Boolean? = null, stringForm: String? = null): ResponseEntity<String> {
    ...
    @Throws(RestClientResponseException::class)
    fun testFormOneof(form1: String? = null, form2: Int? = null, form3: String? = null, form4: Boolean? = null, id: Long? = null, name: String? = null): String {
        val result = testFormOneofWithHttpInfo(form1 = form1, form2 = form2, form3 = form3, form4 = form4, id = id, name = name)
        return result.body!!
    }

    @Throws(RestClientResponseException::class)
    fun testFormOneofWithHttpInfo(form1: String? = null, form2: Int? = null, form3: String? = null, form4: Boolean? = null, id: Long? = null, name: String? = null): ResponseEntity<String> {
