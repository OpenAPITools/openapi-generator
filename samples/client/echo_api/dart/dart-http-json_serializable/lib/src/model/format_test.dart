...
class FormatTest {
  ...
  // minimum: 10
  // maximum: 100
  @JsonKey(name: r'integer', required: false, includeIfNull: false)
  final int? integer;

  // minimum: 20
  // maximum: 200
  @JsonKey(name: r'int32', required: false, includeIfNull: false)
  final int? int32;

  @JsonKey(name: r'int64', required: false, includeIfNull: false)
  final int? int64;
  ...
  // minimum: 54.3
  // maximum: 987.6
  @JsonKey(name: r'float', required: false, includeIfNull: false)
  final double? float;

  // minimum: 67.8
  // maximum: 123.4
  @JsonKey(name: r'double', required: false, includeIfNull: false)
  final double? double_;

  @JsonKey(name: r'decimal', required: false, includeIfNull: false)
  final double? decimal;

  @JsonKey(name: r'string', required: false, includeIfNull: false)
  final String? string;

  @JsonKey(name: r'byte', required: true, includeIfNull: false)
  final String byte;
  ...
  @JsonKey(name: r'pattern_with_digits', required: false, includeIfNull: false)
  ...
  factory FormatTest.fromJson(Map<String, dynamic> json) =>
      _$FormatTestFromJson(json);
