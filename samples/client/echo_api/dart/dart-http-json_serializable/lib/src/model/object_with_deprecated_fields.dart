...
class ObjectWithDeprecatedFields {
  ...
  @JsonKey(name: r'uuid', required: false, includeIfNull: false)
  final String? uuid;

  @JsonKey(name: r'id', required: false, includeIfNull: false)
  final num? id;

  @JsonKey(name: r'deprecatedRef', required: false, includeIfNull: false)
  final DeprecatedObject? deprecatedRef;

  @JsonKey(name: r'bars', required: false, includeIfNull: false)
  final List<Bar>? bars;
  ...
  @override
  int get hashCode =>
      uuid.hashCode + id.hashCode + deprecatedRef.hashCode + bars.hashCode;

  factory ObjectWithDeprecatedFields.fromJson(Map<String, dynamic> json) =>
      _$ObjectWithDeprecatedFieldsFromJson(json);
