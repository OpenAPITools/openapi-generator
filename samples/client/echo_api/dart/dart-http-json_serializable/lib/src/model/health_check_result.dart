...
class HealthCheckResult {
  ...
  @JsonKey(name: r'NullableMessage', required: false, includeIfNull: false)
  final String? nullableMessage;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is HealthCheckResult && other.nullableMessage == nullableMessage;

  @override
  int get hashCode => (nullableMessage == null ? 0 : nullableMessage.hashCode);
