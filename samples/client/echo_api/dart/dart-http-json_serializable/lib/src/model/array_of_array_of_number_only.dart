...
class ArrayOfArrayOfNumberOnly {
  ...
  @JsonKey(name: r'ArrayArrayNumber', required: false, includeIfNull: false)
  ...
  @override
  int get hashCode => arrayArrayNumber.hashCode;

  factory ArrayOfArrayOfNumberOnly.fromJson(Map<String, dynamic> json) =>
      _$ArrayOfArrayOfNumberOnlyFromJson(json);
