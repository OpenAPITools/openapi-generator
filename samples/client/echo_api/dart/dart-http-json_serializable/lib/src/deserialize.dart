...
import 'package:openapi/src/model/example_non_primitive.dart';
...
ReturnType deserialize<ReturnType, BaseType>(dynamic value, String targetType,
  ...
  switch (targetType) {
    ...
    case 'BarRefOrValue':
      return BarRefOrValue.fromJson(value as Map<String, dynamic>)
          as ReturnType;
    case 'Capitalization':
    ...
    case 'Child':
      return Child.fromJson(value as Map<String, dynamic>) as ReturnType;
    case 'ClassModel':
    ...
    case 'Example':
      return Example.fromJson(value as Map<String, dynamic>) as ReturnType;
    case 'ExampleNonPrimitive':
      return ExampleNonPrimitive.fromJson(value as Map<String, dynamic>)
          as ReturnType;
    case 'Extensible':
    ...
    case 'FooRefOrValue':
      return FooRefOrValue.fromJson(value as Map<String, dynamic>)
          as ReturnType;
    case 'FormatTest':
    ...
    case 'PizzaSpeziale':
      return PizzaSpeziale.fromJson(value as Map<String, dynamic>)
          as ReturnType;
    case 'ReadOnlyFirst':
    ...
    case 'TestQueryStyleFormExplodeTrueArrayStringQueryObjectParameter':
