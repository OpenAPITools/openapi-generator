...
class AdditionalPropertiesClass {
  ...
  @JsonKey(name: r'map_property', required: false, includeIfNull: false)
  final Map<String, String>? mapProperty;

  @JsonKey(name: r'map_of_map_property', required: false, includeIfNull: false)
  ...
  @override
  int get hashCode => mapProperty.hashCode + mapOfMapProperty.hashCode;

  factory AdditionalPropertiesClass.fromJson(Map<String, dynamic> json) =>
      _$AdditionalPropertiesClassFromJson(json);
