...
class AppleGrandparentDisc {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AppleGrandparentDisc &&
     other.seeds == seeds &&
  ...
  factory AppleGrandparentDisc.fromJson(Map<String, dynamic> json) => _$AppleGrandparentDiscFromJson(json);
