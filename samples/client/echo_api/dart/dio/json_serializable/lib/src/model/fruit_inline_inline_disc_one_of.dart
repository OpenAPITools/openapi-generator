...
class FruitInlineInlineDiscOneOf {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FruitInlineInlineDiscOneOf &&
     other.seeds == seeds &&
  ...
  factory FruitInlineInlineDiscOneOf.fromJson(Map<String, dynamic> json) => _$FruitInlineInlineDiscOneOfFromJson(json);
