...
class FruitInlineDiscOneOf {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FruitInlineDiscOneOf &&
     other.seeds == seeds &&
  ...
  factory FruitInlineDiscOneOf.fromJson(Map<String, dynamic> json) => _$FruitInlineDiscOneOfFromJson(json);
