...
class BarRefOrValue {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is BarRefOrValue &&
     other.href == href &&
     other.id == id &&
  ...
  factory BarRefOrValue.fromJson(Map<String, dynamic> json) => _$BarRefOrValueFromJson(json);
