...
class FooBasicGetDefaultResponse {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FooBasicGetDefaultResponse &&
     other.string == string;
  ...
  factory FooBasicGetDefaultResponse.fromJson(Map<String, dynamic> json) => _$FooBasicGetDefaultResponseFromJson(json);
