...
class DiscOptionalTypeCorrect {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is DiscOptionalTypeCorrect &&
  ...
  factory DiscOptionalTypeCorrect.fromJson(Map<String, dynamic> json) => _$DiscOptionalTypeCorrectFromJson(json);
