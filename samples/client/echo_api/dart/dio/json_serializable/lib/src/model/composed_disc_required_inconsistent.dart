...
class ComposedDiscRequiredInconsistent {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ComposedDiscRequiredInconsistent &&
  ...
  factory ComposedDiscRequiredInconsistent.fromJson(Map<String, dynamic> json) => _$ComposedDiscRequiredInconsistentFromJson(json);

  Map<String, dynamic> toJson() => _$ComposedDiscRequiredInconsistentToJson(this);
