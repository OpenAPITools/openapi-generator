...
class BananaOneOfDisc {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is BananaOneOfDisc &&
     other.length == length &&
  ...
  factory BananaOneOfDisc.fromJson(Map<String, dynamic> json) => _$BananaOneOfDiscFromJson(json);
