...
class FooRefOrValue {
  /// Returns a new [FooRefOrValue] instance.
  FooRefOrValue({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FooRefOrValue &&
     other.href == href &&
     other.id == id &&
  ...
  factory FooRefOrValue.fromJson(Map<String, dynamic> json) => _$FooRefOrValueFromJson(json);

  Map<String, dynamic> toJson() => _$FooRefOrValueToJson(this);
