...
class FruitInlineInlineDiscOneOf1 {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FruitInlineInlineDiscOneOf1 &&
     other.length == length &&
  ...
  factory FruitInlineInlineDiscOneOf1.fromJson(Map<String, dynamic> json) => _$FruitInlineInlineDiscOneOf1FromJson(json);
