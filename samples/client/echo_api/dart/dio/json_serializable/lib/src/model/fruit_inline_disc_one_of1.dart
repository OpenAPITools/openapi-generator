...
class FruitInlineDiscOneOf1 {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FruitInlineDiscOneOf1 &&
     other.length == length &&
  ...
  factory FruitInlineDiscOneOf1.fromJson(Map<String, dynamic> json) => _$FruitInlineDiscOneOf1FromJson(json);
