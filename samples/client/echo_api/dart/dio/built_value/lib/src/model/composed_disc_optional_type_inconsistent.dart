...
/// * [fruitType] 
@BuiltValue()
abstract class ComposedDiscOptionalTypeInconsistent implements Built<ComposedDiscOptionalTypeInconsistent, ComposedDiscOptionalTypeInconsistentBuilder> {
  ...
  factory ComposedDiscOptionalTypeInconsistent([void updates(ComposedDiscOptionalTypeInconsistentBuilder b)]) = _$ComposedDiscOptionalTypeInconsistent;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ComposedDiscOptionalTypeInconsistentBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ComposedDiscOptionalTypeInconsistent> get serializer => _$ComposedDiscOptionalTypeInconsistentSerializer();
}

extension ComposedDiscOptionalTypeInconsistentDiscriminatorExt on ComposedDiscOptionalTypeInconsistent {
...
extension ComposedDiscOptionalTypeInconsistentBuilderDiscriminatorExt on ComposedDiscOptionalTypeInconsistentBuilder {
    String? get discriminatorValue {
...
class _$ComposedDiscOptionalTypeInconsistentSerializer implements PrimitiveSerializer<ComposedDiscOptionalTypeInconsistent> {
  @override
  final Iterable<Type> types = const [ComposedDiscOptionalTypeInconsistent, _$ComposedDiscOptionalTypeInconsistent];
  ...
  ComposedDiscOptionalTypeInconsistent deserialize(
    ...
    final discIndex = serializedList.indexOf(ComposedDiscOptionalTypeInconsistent.discriminatorFieldName) + 1;
    final discValue = serializers.deserialize(serializedList[discIndex], specifiedType: FullType(String)) as String;
    oneOfDataSrc = serialized;
    final oneOfTypes = [DiscOptionalTypeCorrect, DiscOptionalTypeIncorrect, ];
    Object oneOfResult;
    Type oneOfType;
    switch (discValue) {
