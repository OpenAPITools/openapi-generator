...
public class UserApi {
  ...
  * # Get user features    Gets a list of application features the user is allowed to access  
   * @return GetFeatures
  */
  public GetFeatures getCurrentUserEnabledFeatures () throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;

    // create path and map variables
    String path = "/v1/users/me/features";
  ...
  */
  public void getCurrentUserEnabledFeatures (final Response.Listener<GetFeatures> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;


    // create path and map variables
    String path = "/v1/users/me/features".replaceAll("\\{format\\}","json");
