...
public class LumenservercodegenGenerator extends DefaultCodegen implements CodegenConfig {
    ...
    public LumenservercodegenGenerator() {
        super();
         ...
         */
        templateDir = "LumenServerCodegen";
